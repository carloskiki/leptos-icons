    ...
    match icon {
        ...
        ImIcon::Im500px => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "Im500px"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAccessibility => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAccessibility"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAddressBook => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAddressBook"
                .to_owned()) } < / title > < path fill = "#000000" d =
                ...
                /> < path fill = "#000000" d = "M1 1h1.5v3h-1.5v-3z" /> < path fill =
                "#000000" d = "M1 5h1.5v3h-1.5v-3z" /> < path fill = "#000000" d =
                "M1 9h1.5v3h-1.5v-3z" /> < path fill = "#000000" d =
                "M1 13h1.5v3h-1.5v-3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImAidKit")]
        ImIcon::ImAidKit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAidKit"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAirplane => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAirplane"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAlarm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAlarm"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAmazon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAmazon"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAndroid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAndroid"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAngry => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAngry"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAngry2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAngry2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAppleinc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAppleinc"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowDown"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDown2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowDown2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDownLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowDownLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDownLeft2 => {
            view! {
                ...
                "ImArrowDownLeft2".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDownRight => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImArrowDownRight".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowDownRight2 => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImArrowDownRight2".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowLeft2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowLeft2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowRight"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowRight2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowRight2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUp2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUp2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUpLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUpLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUpLeft2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUpLeft2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUpRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUpRight"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImArrowUpRight2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImArrowUpRight2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImAttachment => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImAttachment"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBackward => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBackward"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBackward2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBackward2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBaffled => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBaffled"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBaffled2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBaffled2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBarcode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBarcode"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBasecamp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBasecamp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBehance => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBehance"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBehance2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBehance2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBell => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBell"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBin"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBin2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBin2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBinoculars => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBinoculars"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBlocked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBlocked"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBlog => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBlog"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBlogger => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBlogger"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBlogger2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBlogger2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBold => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBold"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBook => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBook"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBookmark => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBookmark"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M3 0v16l5-5 5 5v-16z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImBookmarks")]
        ImIcon::ImBookmarks => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBookmarks"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBooks => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBooks"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBoxAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBoxAdd"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBoxRemove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBoxRemove"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBriefcase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBriefcase"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBrightnessContrast => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImBrightnessContrast".to_owned()) } < / title > < path fill = "#000000"
                d =
        ...
        ImIcon::ImBubble => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubble"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBubble2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubble2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBubbles => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubbles"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBubbles2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubbles2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBubbles3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubbles3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBubbles4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBubbles4"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBug => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBug"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImBullhorn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImBullhorn"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCalculator => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCalculator"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCalendar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCalendar"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCamera => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCamera"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCancelCircle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCancelCircle"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCart"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCheckboxChecked => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImCheckboxChecked".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCheckboxUnchecked => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImCheckboxUnchecked".to_owned()) } < / title > < path fill = "#000000" d
                =
        ...
        ImIcon::ImCheckmark => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCheckmark"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCheckmark2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCheckmark2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImChrome => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImChrome"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCircleDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCircleDown"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCircleLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCircleLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImCircleRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCircleRight"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImCircleUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCircleUp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImClearFormatting => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImClearFormatting".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImClipboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImClipboard"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImClock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImClock"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImClock2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImClock2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCloud => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCloud"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCloudCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCloudCheck"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCloudDownload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCloudDownload"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCloudUpload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCloudUpload"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImClubs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImClubs"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCodepen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCodepen"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCog => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCog"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCogs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCogs"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCoinDollar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCoinDollar"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCoinEuro => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCoinEuro"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCoinPound => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCoinPound"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M7.5 1c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5zM7.5 14.5c-3.314 0-6-2.686-6-6s2.686-6 6-6c3.314 0 6 2.686 6 6s-2.686 6-6 6z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImCoinYen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCoinYen"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M7.5 1c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5zM7.5 14.5c-3.314 0-6-2.686-6-6s2.686-6 6-6c3.314 0 6 2.686 6 6s-2.686 6-6 6z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImCommand => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCommand"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCompass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCompass"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCompass2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCompass2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImConfused => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImConfused"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImConfused2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImConfused2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImConnection => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImConnection"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImContrast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImContrast"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCool => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCool"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCool2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCool2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCopy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCopy"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCreditCard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCreditCard"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCrop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCrop"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCross => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCross"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCrying => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCrying"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImCrying2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCrying2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCss3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCss3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImCtrl => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImCtrl"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDatabase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDatabase"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDelicious => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDelicious"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDeviantart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDeviantart"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDiamonds => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDiamonds"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 0l-5 8 5 8 5-8z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImDice")]
        ImIcon::ImDice => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDice"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDisplay => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDisplay"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 1v10h16v-10h-16zM15 10h-14v-8h14v8zM10.5 12h-5l-0.5 2-1 1h8l-1-1z" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImDownload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDownload"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDownload2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDownload2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDownload3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDownload3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDrawer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDrawer"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDrawer2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDrawer2"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M15.89 10.188l-4-5c-0.095-0.119-0.239-0.188-0.39-0.188h-7c-0.152 0-0.296 0.069-0.39 0.188l-4 5c-0.071 0.089-0.11 0.199-0.11 0.312v4.5c0 0.552 0.448 1 1 1h14c0.552 0 1-0.448 1-1v-4.5c0-0.114-0.039-0.224-0.11-0.312zM15 11h-3.5l-2 2h-3l-2-2h-3.5v-0.325l3.74-4.675h6.519l3.74 4.675v0.325z"
                /> < / svg >
            }
        ...
        ImIcon::ImDribbble => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDribbble"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDrive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDrive"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDropbox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDropbox"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImDroplet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImDroplet"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEarth => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEarth"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEdge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEdge"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEject => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEject"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEllo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEllo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEmbed => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEmbed"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEmbed2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 20 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEmbed2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEnlarge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEnlarge"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M16 0h-6.5l2.5 2.5-3 3 1.5 1.5 3-3 2.5 2.5z" /> < path fill = "#000000"
                d = "M16 16v-6.5l-2.5 2.5-3-3-1.5 1.5 3 3-2.5 2.5z" /> < path fill =
                "#000000" d = "M0 16h6.5l-2.5-2.5 3-3-1.5-1.5-3 3-2.5-2.5z" /> < path
                fill = "#000000" d = "M0 0v6.5l2.5-2.5 3 3 1.5-1.5-3-3 2.5-2.5z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImEnlarge2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEnlarge2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEnter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEnter"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEnvelop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEnvelop"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEqualizer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEqualizer"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEqualizer2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEqualizer2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEvil => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEvil"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEvil2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEvil2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImExit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImExit"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEye => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEye"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEyeBlocked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEyeBlocked"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEyeMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEyeMinus"
                .to_owned()) } < / title > < path fill = "#000000" d = "M10 2h6v2h-6v-2z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImEyePlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEyePlus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImEyedropper => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImEyedropper"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFacebook => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFacebook"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFacebook2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFacebook2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFeed => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFeed"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFileEmpty => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileEmpty"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFileExcel => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileExcel"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFileMusic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileMusic"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImFileOpenoffice => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImFileOpenoffice".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFilePdf => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilePdf"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFilePicture => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilePicture"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFilePlay => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilePlay"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M6 6l5 3.5-5 3.5v-7z" /> < path fill = "#000000" d =
                "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
                /> < / svg >
            }
                .into_view(cx)
        ...
        ImIcon::ImFileText => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileText"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFileText2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileText2"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImFileVideo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileVideo"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0 0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0 0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
                /> < path fill = "#000000" d = "M4 8h5v5h-5v-5z" /> < path fill =
                "#000000" d = "M9 10l3-2v5l-3-2z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImFileWord")]
        ImIcon::ImFileWord => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileWord"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFileZip => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFileZip"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0 0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0 0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
                /> < path fill = "#000000" d = "M4 1h2v1h-2v-1z" /> < path fill =
                "#000000" d = "M6 2h2v1h-2v-1z" /> < path fill = "#000000" d =
                "M4 3h2v1h-2v-1z" /> < path fill = "#000000" d = "M6 4h2v1h-2v-1z" /> <
                path fill = "#000000" d = "M4 5h2v1h-2v-1z" /> < path fill = "#000000" d
                = "M6 6h2v1h-2v-1z" /> < path fill = "#000000" d = "M4 7h2v1h-2v-1z" /> <
                path fill = "#000000" d = "M6 8h2v1h-2v-1z" /> < path fill = "#000000" d
                =
        ...
        ImIcon::ImFilesEmpty => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilesEmpty"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFilm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilm"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFilter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFilter"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFinder => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFinder"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8.894 12.16c-0-0.001-0-0.001-0-0.002 0 0.001 0 0.001 0 0.002z" /> <
                path fill = "#000000" d =
                "M8.916 12.727c-0-0.004-0-0.007-0.001-0.011 0 0.004 0 0.007 0.001 0.011z"
                /> < path fill = "#000000" d =
                "M8.903 12.442c-0-0.003-0-0.006-0-0.008 0 0.003 0 0.006 0 0.008z" /> <
                path fill = "#000000" d =
        ...
        ImIcon::ImFire => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFire"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFirefox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFirefox"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFirst => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFirst"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFlag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlag"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 0h2v16h-2v-16z" /> < path fill = "#000000" d =
        ...
        ImIcon::ImFlattr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlattr"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFlickr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlickr"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFlickr2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlickr2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFlickr3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlickr3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFlickr4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFlickr4"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFloppyDisk => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFloppyDisk"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFolder => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFolder"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFolderDownload => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImFolderDownload".to_owned()) } < / title > < path fill = "#000000" d =
                "M9 4l-2-2h-7v13h16v-11h-7zM8 13.5l-3.5-3.5h2.5v-4h2v4h2.5l-3.5 3.5z" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImFolderMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFolderMinus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFolderOpen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFolderOpen"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFolderPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFolderPlus"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M9 4l-2-2h-7v13h16v-11h-7zM11 11h-2v2h-2v-2h-2v-2h2v-2h2v2h2v2z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImFolderUpload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFolderUpload"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M9 4l-2-2h-7v13h16v-11h-7zM8 7.5l3.5 3.5h-2.5v4h-2v-4h-2.5l3.5-3.5z" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImFont => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFont"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFontSize => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFontSize"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M1 8h6v2h-2v6h-2v-6h-2zM15 4h-3.934v12h-2.133v-12h-3.934v-2h10z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImForward => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImForward"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImForward2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImForward2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImForward3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImForward3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFoursquare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFoursquare"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFrustrated => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFrustrated"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImFrustrated2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImFrustrated2"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M4 10.25v1.5c0 0.136 0.114 0.25 0.25 0.25h1.75v-2h-1.75c-0.136 0-0.25 0.114-0.25 0.25z"
                /> < path fill = "#000000" d = "M7 10h2v2h-2v-2z" /> < path fill =
                "#000000" d =
        ...
        ImIcon::ImGift => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGift"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGit"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGithub => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGithub"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGlass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGlass"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGlass2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGlass2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGoogle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGoogle"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGoogle2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGoogle2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGoogle3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGoogle3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGoogleDrive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGoogleDrive"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGooglePlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGooglePlus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGooglePlus2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGooglePlus2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGooglePlus3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGooglePlus3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGrin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGrin"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImGrin2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImGrin2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHackernews => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHackernews"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHammer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHammer"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHammer2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHammer2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHangouts => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHangouts"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHappy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHappy"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHappy2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHappy2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHeadphones => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHeadphones"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M4.5 9h-1v7h1c0.275 0 0.5-0.225 0.5-0.5v-6c0-0.275-0.225-0.5-0.5-0.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImHeart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHeart"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHeartBroken => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHeartBroken"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHipster => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHipster"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHipster2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHipster2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHistory => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHistory"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHome => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHome"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHome2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHome2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHome3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHome3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHourGlass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHourGlass"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHtmlFive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHtmlFive"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImHtmlFive2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImHtmlFive2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImIcoMoon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImIcoMoon"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImIe => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImIe"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImImage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImImage"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImImages => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImImages"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImIndentDecrease => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImIndentDecrease".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImIndentIncrease => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImIndentIncrease".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImInfinite => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImInfinite"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImInfo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImInfo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImInsertTemplate => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImInsertTemplate".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImInstagram => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImInstagram"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImItalic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImItalic"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImJoomla => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImJoomla"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImKey => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImKey"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImKey2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImKey2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImKeyboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImKeyboard"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLab => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLab"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLanyrd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLanyrd"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLaptop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLaptop"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLast"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLastfm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLastfm"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLastfm2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLastfm2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLeaf => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLeaf"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLibrary => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 17 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLibrary"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLibreoffice => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLibreoffice"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLifebuoy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLifebuoy"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLigature => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLigature"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLigature2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLigature2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLink => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLink"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLinkedin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLinkedin"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLinkedin2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLinkedin2"
                .to_owned()) } < / title > < path fill = "#000000" d =
                ...
                /> < path fill = "#000000" d = "M1 6h3v9h-3v-9z" /> < path fill =
                "#000000" d =
        ...
        ImIcon::ImList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImList"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImList2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImList2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImListNumbered => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImListNumbered"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLocation => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLocation"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLocation2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLocation2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLock"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLoop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLoop"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M2 5h10v3l4-4-4-4v3h-12v6h2zM14 11h-10v-3l-4 4 4 4v-3h12v-6h-2z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImLoop2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLoop2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImLtr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImLtr"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMagicWand => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMagicWand"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMagnet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMagnet"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMail => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMail"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMail2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMail2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMail3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMail3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMail4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMail4"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMakeGroup => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMakeGroup"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMan => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMan"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImManWoman => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImManWoman"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMap => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMap"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 3l5-2v12l-5 2z" /> < path fill = "#000000" d =
                "M6 0.5l5 3v11.5l-5-2.5z" /> < path fill = "#000000" d =
                "M12 3.5l4-3v12l-4 3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImMap2")]
        ImIcon::ImMap2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMap2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMenu => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMenu"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMenu2 => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMenu2"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 3h14v3h-14v-3zM0 7h14v3h-14v-3zM0 11h14v3h-14v-3z" /> < path fill =
                "#000000" d = "M15.5 9l3 3 3-3z" /> < path fill = "#000000" d =
                "M21.5 8l-3-3-3 3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImMenu3")]
        ImIcon::ImMenu3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 22 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMenu3"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 3h14v3h-14v-3zM0 7h14v3h-14v-3zM0 11h14v3h-14v-3z" /> < path fill =
                "#000000" d = "M15.5 7l3 3 3-3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImMenu4")]
        ImIcon::ImMenu4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 22 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMenu4"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 3h14v3h-14v-3zM0 7h14v3h-14v-3zM0 11h14v3h-14v-3z" /> < path fill =
                "#000000" d = "M15.5 10l3-3 3 3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImMeter")]
        ImIcon::ImMeter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMeter"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMeter2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMeter2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMic"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMinus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMobile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMobile"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMobile2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMobile2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMoveDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMoveDown"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M12 11v-6h-1v6h-2.5l3 3 3-3z" /> < path fill = "#000000" d =
                "M5 4v3h-3v-3h3zM6 3h-5v5h5v-5z" /> < path fill = "#000000" d =
                "M1 10h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M3 10h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M5 10h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
                "M1 13.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
                "M2.5 14h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M4.5 14h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M1 11.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
        ...
        ImIcon::ImMoveUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMoveUp"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M11 8v6h1v-6h2.5l-3-3-3 3z" /> < path fill = "#000000" d =
                "M1 3h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M3 3h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M5 3h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
                "M1 6.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
                "M2.5 7h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M4.5 7h1.5v1h-1.5v-1z" /> < path fill = "#000000" d =
                "M1 4.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
                "M5 5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
        ...
        ImIcon::ImMug => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMug"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImMusic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImMusic"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNeutral => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNeutral"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNeutral2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNeutral2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNewTab => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNewTab"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M3 1v12h12v-12h-12zM14 12h-10v-10h10v10zM2 14v-10.5l-1-1v12.5h12.5l-1-1h-10.5z"
                /> < path fill = "#000000" d =
                "M5.5 4l2.5 2.5-3 3 1.5 1.5 3-3 2.5 2.5v-6.5z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImNewspaper")]
        ImIcon::ImNewspaper => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNewspaper"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNext => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNext"
                .to_owned()) } < / title > < path fill = "#000000" d =
                ...
                /> < path fill = "#000000" d = "M9 8l-4-3v6z" /> < path fill = "#000000"
                d = "M11 5h-2v6h2v-6z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImNext2")]
        ImIcon::ImNext2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNext2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNotification => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNotification"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImNpm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImNpm"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImOffice => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImOffice"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImOmega => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImOmega"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImOnedrive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImOnedrive"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImOpera => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImOpera"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImOpt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImOpt"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPacman => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPacman"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPageBreak => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPageBreak"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPaintFormat => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPaintFormat"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImParagraphCenter => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImParagraphCenter".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImParagraphJustify => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImParagraphJustify".to_owned()) } < / title > < path fill = "#000000" d
                =
        ...
        ImIcon::ImParagraphLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImParagraphLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImParagraphRight => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImParagraphRight".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPaste => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPaste"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPause => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPause"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPause2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPause2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPaypal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPaypal"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPen"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPencil => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPencil"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPencil2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPencil2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPhone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPhone"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPhoneHangUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPhoneHangUp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPieChart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPieChart"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPilcrow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPilcrow"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M6 0h8v2h-2v14h-2v-14h-2v14h-2v-8c-2.209 0-4-1.791-4-4s1.791-4 4-4z" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImPinterest => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPinterest"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPinterest2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPinterest2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPlay => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPlay"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPlay2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPlay2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPlay3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPlay3"
                .to_owned()) } < / title > < path fill = "#000000" d = "M3 2l10 6-10 6z"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPlus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPodcast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPodcast"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPointDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPointDown"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPointLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPointLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPointRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPointRight"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPointUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPointUp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPower => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPower"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPowerCord => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPowerCord"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPrevious => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPrevious"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5z"
        ...
        ImIcon::ImPrevious2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPrevious2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPriceTag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPriceTag"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPriceTags => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 20 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPriceTags"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPrinter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPrinter"
                .to_owned()) } < / title > < path fill = "#000000" d = "M4 1h8v2h-8v-2z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImProfile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImProfile"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImPushpin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImPushpin"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImQrcode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImQrcode"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImQuestion => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImQuestion"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImQuill => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImQuill"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M0 16c2-6 7.234-16 16-16-4.109 3.297-6 11-9 11s-3 0-3 0l-3 5h-1z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImQuotesLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImQuotesLeft"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImQuotesRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImQuotesRight"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRadioChecked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRadioChecked"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRadioChecked2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRadioChecked2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRadioUnchecked => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImRadioUnchecked".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImReddit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImReddit"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRedo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRedo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRedo2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRedo2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRenren => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRenren"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImReply => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImReply"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRoad => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRoad"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRocket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRocket"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRss => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRss"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRss2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRss2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImRtl => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImRtl"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSad => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSad"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSad2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSad2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSafari => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSafari"
                .to_owned()) } < / title > < path fill = "#000000" d =
                ...
                /> < path fill = "#000000" d =
                "M6.758 1.111l0.293 1.471-0.245 0.049-0.293-1.471 0.245-0.049z" /> < path
                fill = "#000000" d =
                "M9.245 14.89l-0.293-1.471 0.245-0.049 0.293 1.471-0.245 0.049z" /> <
                path fill = "#000000" d =
                "M6.088 1.264l0.218 0.718-0.239 0.073-0.218-0.718 0.239-0.073z" /> < path
                fill = "#000000" d =
                "M9.913 14.733l-0.218-0.718 0.239-0.073 0.218 0.718-0.239 0.073z" /> <
                path fill = "#000000" d =
                "M5.438 1.486l0.574 1.386-0.231 0.096-0.574-1.386 0.231-0.096z" /> < path
                fill = "#000000" d =
                "M10.564 14.515l-0.574-1.386 0.231-0.096 0.574 1.386-0.231 0.096z" /> <
                path fill = "#000000" d =
                "M4.588 1.885l0.22-0.118 0.354 0.661-0.22 0.118-0.354-0.661z" /> < path
                fill = "#000000" d =
                "M11.408 14.114l-0.22 0.118-0.354-0.661 0.22-0.118 0.354 0.661z" /> <
                path fill = "#000000" d =
                "M1.884 4.591l0.662 0.353-0.118 0.221-0.661-0.353 0.118-0.221z" /> < path
                fill = "#000000" d =
                "M14.113 11.409l-0.662-0.353 0.118-0.22 0.662 0.353-0.118 0.22z" /> <
                path fill = "#000000" d =
                "M2.872 6.010l-1.386-0.574 0.096-0.231 1.386 0.574-0.096 0.231z" /> <
                path fill = "#000000" d =
                "M13.13 9.989l1.386 0.574-0.096 0.231-1.386-0.574 0.096-0.231z" /> < path
                fill = "#000000" d =
                "M1.337 5.85l0.718 0.218-0.073 0.239-0.718-0.218 0.073-0.239z" /> < path
                fill = "#000000" d =
                "M14.661 10.151l-0.718-0.218 0.073-0.239 0.718 0.218-0.073 0.239z" /> <
                path fill = "#000000" d =
                "M1.157 6.512l1.471 0.293-0.049 0.245-1.471-0.293 0.049-0.245z" /> < path
                fill = "#000000" d =
                "M14.84 9.488l-1.471-0.293 0.049-0.245 1.471 0.293-0.049 0.245z" /> <
                path fill = "#000000" d =
                "M1.109 9.243l1.471-0.293 0.049 0.245-1.471 0.293-0.049-0.245z" /> < path
                fill = "#000000" d =
                "M14.888 6.757l-1.471 0.293-0.049-0.245 1.471-0.293 0.049 0.245z" /> <
                path fill = "#000000" d =
                "M1.265 9.914l0.718-0.218 0.073 0.239-0.718 0.218-0.073-0.239z" /> < path
                fill = "#000000" d =
                "M14.734 6.089l-0.718 0.218-0.073-0.239 0.718-0.218 0.073 0.239z" /> <
                path fill = "#000000" d =
                "M1.58 10.796l-0.096-0.231 1.386-0.574 0.096 0.231-1.386 0.574z" /> <
                path fill = "#000000" d =
                "M14.419 5.207l0.096 0.231-1.386 0.574-0.096-0.231 1.386-0.574z" /> <
                path fill = "#000000" d =
                "M1.888 11.41l-0.118-0.22 0.661-0.354 0.118 0.22-0.661 0.354z" /> < path
                fill = "#000000" d =
                "M14.116 4.59l0.118 0.22-0.661 0.354-0.118-0.22 0.661-0.354z" /> < path
                fill = "#000000" d =
                "M4.811 14.232l-0.22-0.118 0.354-0.661 0.22 0.118-0.354 0.661z" /> < path
                fill = "#000000" d =
                "M11.189 1.767l0.22 0.118-0.353 0.661-0.22-0.118 0.353-0.661z" /> < path
                fill = "#000000" d =
                "M5.207 14.419l0.574-1.386 0.231 0.096-0.574 1.386-0.231-0.096z" /> <
                path fill = "#000000" d =
                "M10.795 1.58l-0.574 1.386-0.231-0.096 0.574-1.386 0.231 0.096z" /> <
                path fill = "#000000" d =
                "M6.088 14.735l-0.239-0.073 0.218-0.718 0.239 0.073-0.218 0.718z" /> <
                path fill = "#000000" d =
                "M9.912 1.264l0.239 0.073-0.218 0.718-0.239-0.073 0.218-0.718z" /> < path
                fill = "#000000" d =
                "M6.757 14.888l-0.245-0.049 0.293-1.471 0.245 0.049-0.293 1.471z" /> <
                path fill = "#000000" d =
                "M9.243 1.109l0.245 0.049-0.293 1.471-0.245-0.049 0.293-1.471z" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImScissors => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImScissors"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSearch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSearch"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSection => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSection"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShare"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShare2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShare2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShield => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShield"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShift => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShift"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShocked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShocked"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShocked2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShocked2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShrink => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShrink"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M9 7h6.5l-2.5-2.5 3-3-1.5-1.5-3 3-2.5-2.5z" /> < path fill = "#000000" d
                = "M9 9v6.5l2.5-2.5 3 3 1.5-1.5-3-3 2.5-2.5z" /> < path fill = "#000000"
                d = "M7 9h-6.5l2.5 2.5-3 3 1.5 1.5 3-3 2.5 2.5z" /> < path fill =
                "#000000" d = "M7 7v-6.5l-2.5 2.5-3-3-1.5 1.5 3 3-2.5 2.5z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImShrink2")]
        ImIcon::ImShrink2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShrink2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImShuffle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImShuffle"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSigma => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSigma"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSinaWeibo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSinaWeibo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSkype => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSkype"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSleepy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSleepy"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImSleepy2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSleepy2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSmile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSmile"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSmile2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSmile2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSortAlphaAsc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSortAlphaAsc"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSortAlphaDesc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSortAlphaDesc"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d
                =
        ...
        ImIcon::ImSortAmountAsc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSortAmountAsc"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d
                = "M7 9h9v2h-9v-2z" /> < path fill = "#000000" d = "M7 6h7v2h-7v-2z" /> <
                path fill = "#000000" d = "M7 3h5v2h-5v-2z" /> < path fill = "#000000" d
                = "M7 0h3v2h-3v-2z" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImSortAmountDesc => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImSortAmountDesc".to_owned()) } < / title > < path fill = "#000000" d =
                "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d
                = "M7 0h9v2h-9v-2z" /> < path fill = "#000000" d = "M7 3h7v2h-7v-2z" /> <
                path fill = "#000000" d = "M7 6h5v2h-5v-2z" /> < path fill = "#000000" d
                = "M7 9h3v2h-3v-2z" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImSortNumbericDesc => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImSortNumbericDesc".to_owned()) } < / title > < path fill = "#000000" d
                = "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000"
                d =
        ...
        ImIcon::ImSortNumericAsc => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImSortNumericAsc".to_owned()) } < / title > < path fill = "#000000" d =
                "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d
                =
        ...
        ImIcon::ImSoundcloud => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSoundcloud"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSoundcloud2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSoundcloud2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpades => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpades"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpellCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpellCheck"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSphere => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSphere"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner10 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner10"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner11 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner11"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner4"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner5 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner5"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner6 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner6"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner7 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner7"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner8 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner8"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpinner9 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpinner9"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpoonKnife => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpoonKnife"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSpotify => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSpotify"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStack"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStackoverflow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStackoverflow"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStarEmpty => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStarEmpty"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStarFull => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStarFull"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStarHalf => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStarHalf"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStatsBars => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStatsBars"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStatsBars2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStatsBars2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStatsDots => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStatsDots"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSteam => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSteam"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSteam2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSteam2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStop"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStop2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStop2"
                .to_owned()) } < / title > < path fill = "#000000" d = "M2 2h12v12h-12z"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        ImIcon::ImStopwatch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStopwatch"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStrikethrough => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStrikethrough"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStumbleupon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStumbleupon"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImStumbleupon2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImStumbleupon2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSubscript => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSubscript"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSubscript2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSubscript2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSun => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSun"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSuperscript => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSuperscript"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSuperscript2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSuperscript2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSvg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSvg"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImSwitch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImSwitch"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTab => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTab"
                .to_owned()) } < / title > < path fill = "#000000" d = "M15 0h1v8h-1v-8z"
                /> < path fill = "#000000" d = "M0 8h1v8h-1v-8z" /> < path fill =
                "#000000" d = "M5 11h11v2h-11v2.5l-3.5-3.5 3.5-3.5v2.5z" /> < path fill =
                "#000000" d = "M11 5h-11v-2h11v-2.5l3.5 3.5-3.5 3.5z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImTable")]
        ImIcon::ImTable => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTable"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTable2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTable2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTablet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTablet"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTarget => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTarget"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTelegram => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTelegram"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTerminal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTerminal"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTextColor => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTextColor"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTextHeight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTextHeight"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTextWidth => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTextWidth"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTicket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTicket"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTongue => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTongue"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTongue2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTongue2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTree => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTree"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTrello => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTrello"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTrophy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTrophy"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTruck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTruck"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTumblr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTumblr"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTumblr2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTumblr2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTux => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTux"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTv => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTv"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImTwitch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTwitch"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M1.5 0l-1.5 2.5v11.5h4v2h2l2-2h2.5l4.5-4.5v-9.5h-13.5zM13 8.5l-2.5 2.5h-2.5l-2 2v-2h-3v-9h10v6.5z"
                /> < path fill = "#000000" d = "M9.5 4h1.5v4h-1.5v-4z" /> < path fill =
                "#000000" d = "M6.5 4h1.5v4h-1.5v-4z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "ImTwitter")]
        ImIcon::ImTwitter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImTwitter"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUnderline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUnderline"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUndo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUndo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUndo2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUndo2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUngroup => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUngroup"
                .to_owned()) } < / title > < path fill = "#000000" d =
                ...
                /> < path fill = "#000000" d = "M0 12h1v2h-1v-2z" /> < path fill =
                "#000000" d = "M0 9h1v2h-1v-2z" /> < path fill = "#000000" d =
                "M13 7h1v2h-1v-2z" /> < path fill = "#000000" d = "M13 13h1v2h-1v-2z" />
                < path fill = "#000000" d = "M13 10h1v2h-1v-2z" /> < path fill =
                "#000000" d = "M0 6h1v2h-1v-2z" /> < path fill = "#000000" d =
                "M0 3h1v2h-1v-2z" /> < path fill = "#000000" d = "M8 2h2v1h-2v-1z" /> <
                path fill = "#000000" d = "M5 2h2v1h-2v-1z" /> < path fill = "#000000" d
                = "M2 2h2v1h-2v-1z" /> < path fill = "#000000" d = "M7 15h2v1h-2v-1z" />
                < path fill = "#000000" d = "M10 15h2v1h-2v-1z" /> < path fill =
                "#000000" d = "M4 15h2v1h-2v-1z" /> < path fill = "#000000" d =
        ...
        ImIcon::ImUnlocked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUnlocked"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUpload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUpload"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUpload2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUpload2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUpload3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUpload3"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUser => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUser"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUserCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUserCheck"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M15 9.5l-4.5 4.5-1.5-1.5-1 1 2.5 2.5 5.5-5.5z" /> < path fill =
                "#000000" d =
        ...
        ImIcon::ImUserMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUserMinus"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUserPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUserPlus"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M6 11.5c0-2.363 1.498-4.383 3.594-5.159 0.254-0.571 0.406-1.206 0.406-1.841 0-2.485 0-4.5-3-4.5s-3 2.015-3 4.5c0 1.548 0.898 3.095 2 3.716v0.825c-3.392 0.277-6 1.944-6 3.959h6.208c-0.135-0.477-0.208-0.98-0.208-1.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImUserTie => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUserTie"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImUsers => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 18 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImUsers"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVideoCamera => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVideoCamera"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVimeo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVimeo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVimeo2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVimeo2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVine => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVine"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVk => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVk"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeDecrease => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImVolumeDecrease".to_owned()) } < / title > < path fill = "#000000" d =
                "M8 7h8v2h-8v-2z" /> < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeHigh => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 17 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVolumeHigh"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeIncrease => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "ImVolumeIncrease".to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeLow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVolumeLow"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeMedium => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVolumeMedium"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImVolumeMute => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVolumeMute"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M6.5 15c-0.13 0-0.258-0.051-0.354-0.146l-3.854-3.854h-1.793c-0.276 0-0.5-0.224-0.5-0.5v-5c0-0.276 0.224-0.5 0.5-0.5h1.793l3.854-3.854c0.143-0.143 0.358-0.186 0.545-0.108s0.309 0.26 0.309 0.462v13c0 0.202-0.122 0.385-0.309 0.462-0.062 0.026-0.127 0.038-0.191 0.038z"
                /> < / svg >
            }
        ...
        ImIcon::ImVolumeMute2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImVolumeMute2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWarning => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWarning"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWhatsapp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWhatsapp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWikipedia => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWikipedia"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWindows => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWindows"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWindows8 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWindows8"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWink => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWink"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWink2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWink2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWoman => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWoman"
                .to_owned()) } < / title > < path fill = "#000000" d =
                "M9 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5z"
                /> < path fill = "#000000" d =
        ...
        ImIcon::ImWondering => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWondering"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWondering2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWondering2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWordpress => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWordpress"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImWrench => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImWrench"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImXing => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImXing"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImXing2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImXing2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImYahoo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImYahoo"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImYahoo2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImYahoo2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImYelp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImYelp"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImYoutube => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImYoutube"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImYoutube2 => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImYoutube2"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImZoomIn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImZoomIn"
                .to_owned()) } < / title > < path fill = "#000000" d =
        ...
        ImIcon::ImZoomOut => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "ImZoomOut"
                .to_owned()) } < / title > < path fill = "#000000" d =
