    ...
    match icon {
        ...
        TiIcon::TiAdjustBrightness => {
            view! {
                ...
                "TiAdjustBrightness".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiAdjustContrast => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiAdjustContrast".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiAnchor => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiAnchor"
        ...
        TiIcon::TiAnchorOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiAnchorOutline"
                .to_owned()) } < / title > < g > < circle cx = "12" cy = "6" r = "1" /> <
                path d =
        ...
        TiIcon::TiArchive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArchive"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiArrowBack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowBack"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowBackOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowBackOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowDown"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowDownOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowDownOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowDownThick => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowDownThick".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowForward => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowForward"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowForwardOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowForwardOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowLeft"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowLeftOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowLeftOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowLeftThick => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowLeftThick".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowLoop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowLoop"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowLoopOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowLoopOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMaximise => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowMaximise"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMaximiseOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowMaximiseOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMinimise => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowMinimise"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMinimiseOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowMinimiseOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowMove"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowMoveOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowMoveOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowRepeat => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowRepeat"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowRepeatOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowRepeatOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowRight"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowRightOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowRightOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowRightThick => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowRightThick".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowShuffle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowShuffle"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowSortedDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowSortedDown".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowSortedUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowSortedUp"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowSync => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowSync"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowSyncOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowSyncOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowUnsorted => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowUnsorted"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowUp"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowUpOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiArrowUpOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiArrowUpThick => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiArrowUpThick"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiAt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiAt"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiAttachment => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiAttachment"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiAttachmentOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiAttachmentOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBackspace => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBackspace"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBackspaceOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiBackspaceOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBatteryCharge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBatteryCharge"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBatteryFull => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBatteryFull"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBatteryHigh => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBatteryHigh"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBatteryLow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBatteryLow"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBatteryMid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBatteryMid"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBeaker => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBeaker"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBeer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBeer"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiBell => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBell"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBook => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBook"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBookmark => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBookmark"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBriefcase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBriefcase"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiBrush => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBrush"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiBusinessCard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiBusinessCard"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCalculator => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCalculator"
                .to_owned()) } < / title > < path d =
                ...
                /> < circle cx = "10" cy = "11" r = "1" /> < circle cx = "13" cy = "11" r
                = "1" /> < circle cx = "16" cy = "11" r = "1" /> < circle cx = "10" cy =
                "14" r = "1" /> < circle cx = "13" cy = "14" r = "1" /> < circle cx =
                "16" cy = "14" r = "1" /> < circle cx = "10" cy = "17" r = "1" /> <
                circle cx = "13" cy = "17" r = "1" /> < circle cx = "16" cy = "17" r =
                "1" /> < path d = "M16 7v1h-6v-1h6m1-1h-8v3h8v-3z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "TiCalendar")]
        TiIcon::TiCalendar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCalendar"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCalendarOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiCalendarOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCamera => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCamera"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCameraOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCameraOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCancel => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCancel"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCancelOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCancelOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartArea => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChartArea"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartAreaOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChartAreaOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartBar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChartBar"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartBarOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChartBarOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartLine => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChartLine"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartLineOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChartLineOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartPie => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChartPie"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChartPieOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChartPieOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChevronLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChevronLeft"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChevronLeftOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChevronLeftOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChevronRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiChevronRight"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiChevronRightOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiChevronRightOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiClipboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiClipboard"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCloudStorage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCloudStorage"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCloudStorageOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiCloudStorageOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCode"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCodeOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCodeOutline"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCoffee => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCoffee"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCog => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCog"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCogOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCogOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiCompass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCompass"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiContacts => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiContacts"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCreditCard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCreditCard"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiCss3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiCss3"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDatabase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDatabase"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDelete => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDelete"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDeleteOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDeleteOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDeviceDesktop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDeviceDesktop"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiDeviceLaptop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDeviceLaptop"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDevicePhone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDevicePhone"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiDeviceTablet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDeviceTablet"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiDirections => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDirections"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDivide => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDivide"
                .to_owned()) } < / title > < circle cx = "12" cy = "6" r = "2.25" /> <
                circle cx = "12" cy = "18" r = "2.25" /> < path d =
        ...
        TiIcon::TiDivideOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDivideOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDocument => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDocument"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDocumentAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDocumentAdd"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDocumentDelete => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiDocumentDelete".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDocumentText => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDocumentText"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiDownload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDownload"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDownloadOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiDownloadOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiDropbox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiDropbox"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEdit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEdit"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEject => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEject"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEjectOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEjectOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEquals => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEquals"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEqualsOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEqualsOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiExport => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiExport"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiExportOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiExportOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEye => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEye"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiEyeOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiEyeOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFeather => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFeather"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFilm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFilm"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiFilter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFilter"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlag"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlagOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlagOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlash"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlashOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlashOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlowChildren => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlowChildren"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlowMerge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlowMerge"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFlowParallel => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlowParallel"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiFlowSwitch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFlowSwitch"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiFolder => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFolder"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFolderAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFolderAdd"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFolderDelete => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFolderDelete"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiFolderOpen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiFolderOpen"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiGift => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiGift"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiGlobe => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiGlobe"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiGlobeOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiGlobeOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiGroup => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiGroup"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiGroupOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiGroupOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHeadphones => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHeadphones"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHeart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHeart"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHeartFullOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiHeartFullOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHeartHalfOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiHeartHalfOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHeartOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHeartOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHome => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHome"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHomeOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHomeOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiHtml5 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiHtml5"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiImage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiImage"
                .to_owned()) } < / title > < circle cx = "8.5" cy = "8.5" r = "2.5" /> <
                path d =
        ...
        TiIcon::TiImageOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiImageOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInfinity => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiInfinity"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInfinityOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiInfinityOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInfo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiInfo"
                .to_owned()) } < / title > < path d =
	...
	c0.11-0.06,0.23-0.03,0.31,0.07C13.77,16.69,13.77,16.82,13.69,16.91z"
        ...
        TiIcon::TiInfoLarge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiInfoLarge"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInfoLargeOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiInfoLargeOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInfoOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiInfoOutline"
                .to_owned()) } < / title > < path d =
	...
	c0.36,0.18,0.43,0.54,0.23,1.15l-0.41,1.22c-0.4,1.22,0.12,2.07,1.08,2.13C12.74,17.64,13.5,16.75,13.5,16.75z"
        ...
        TiIcon::TiInputChecked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiInputChecked"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiInputCheckedOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiInputCheckedOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiKey => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiKey"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiKeyOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiKeyOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiKeyboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiKeyboard"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLeaf => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLeaf"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLightbulb => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLightbulb"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiLink => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLink"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLinkOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLinkOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLocation => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLocation"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLocationArrow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLocationArrow"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLocationArrowOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiLocationArrowOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLocationOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiLocationOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLockClosed => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLockClosed"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLockClosedOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiLockClosedOutline".to_owned()) } < / title > < circle cx = "12" cy =
                "17" r = "1.3" /> < path d =
        ...
        TiIcon::TiLockOpen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiLockOpen"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiLockOpenOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiLockOpenOutline".to_owned()) } < / title > < circle cx = "12" cy =
                "17" r = "1.3" /> < path d =
        ...
        TiIcon::TiMail => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMail"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMap => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMap"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaEject => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaEject"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaEjectOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaEjectOutline".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiMediaFastForward => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaFastForward".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaFastForwardOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaFastForwardOutline".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiMediaPause => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaPause"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaPauseOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaPauseOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaPlay => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaPlay"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaPlayOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaPlayOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaPlayReverse => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaPlayReverse".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaPlayReverseOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaPlayReverseOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaRecord => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaRecord"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaRecordOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaRecordOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaRewind => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaRewind"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaRewindOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaRewindOutline".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiMediaStop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMediaStop"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMediaStopOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMediaStopOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMessage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMessage"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMessageTyping => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMessageTyping"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMessages => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMessages"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMicrophone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMicrophone"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMicrophoneOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiMicrophoneOutline".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMinus"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMinusOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMinusOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiMortarBoard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiMortarBoard"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiNews => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiNews"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiNotes => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiNotes"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiNotesOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiNotesOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPen"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPencil => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPencil"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPhone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPhone"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPhoneOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPhoneOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPi => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPi"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPiOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPiOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPin"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPinOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPinOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPipette => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPipette"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPlane => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPlane"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPlaneOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPlaneOutline"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiPlug => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPlug"
                .to_owned()) } < / title > < path d =
	...
	C16.1,14,14.2,15.5,12,15.5z M17,10.5c0,0.2,0,0.3-0.1,0.5H7.1C7,10.8,7,10.7,7,10.5V8h10V10.5z"
        ...
        TiIcon::TiPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPlus"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPlusOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPlusOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPointOfInterest => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiPointOfInterest".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPointOfInterestOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiPointOfInterestOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPower => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPower"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPowerOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPowerOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPrinter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPrinter"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiPuzzle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPuzzle"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiPuzzleOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiPuzzleOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRadar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiRadar"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRadarOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiRadarOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRefresh => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiRefresh"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRefreshOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiRefreshOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRss => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiRss"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiRssOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiRssOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiScissors => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiScissors"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiScissorsOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiScissorsOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiShoppingBag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiShoppingBag"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiShoppingCart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiShoppingCart"
                .to_owned()) } < / title > < g > < path d =
                ...
                /> < circle cx = "8.5" cy = "19.5" r = "1.5" /> < circle cx = "17.5" cy =
                "19.5" r = "1.5" /> </ g > < / svg >
            }
                .into_view(cx)
        }
        ...
        TiIcon::TiSocialAtCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialAtCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialDribbble => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialDribbble".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialDribbbleCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialDribbbleCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialFacebook => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialFacebook".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialFacebookCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialFacebookCircular".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialFlickr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialFlickr"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialFlickrCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialFlickrCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialGithub => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialGithub"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialGithubCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialGithubCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialGooglePlus => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialGooglePlus".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialGooglePlusCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialGooglePlusCircular".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialInstagram => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialInstagram".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialInstagramCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialInstagramCircular".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialLastFm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialLastFm"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialLastFmCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialLastFmCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialLinkedin => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialLinkedin".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialLinkedinCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialLinkedinCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialPinterest => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialPinterest".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialPinterestCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialPinterestCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialSkype => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialSkype"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialSkypeOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialSkypeOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialTumbler => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialTumbler"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialTumblerCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialTumblerCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialTwitter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialTwitter"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialTwitterCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialTwitterCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialVimeo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialVimeo"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialVimeoCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialVimeoCircular".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSocialYoutube => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSocialYoutube"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSocialYoutubeCircular => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSocialYoutubeCircular".to_owned()) } < / title > < polygon points =
	...
	C12.74,9.24,12.81,9.34,12.98,9.35z"
        ...
        TiIcon::TiSortAlphabetically => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSortAlphabetically".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSortAlphabeticallyOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSortAlphabeticallyOutline".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSortNumerically => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSortNumerically".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSortNumericallyOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSortNumericallyOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSpanner => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSpanner"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiSpannerOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiSpannerOutline".to_owned()) } < / title > < g > < circle cx = "8" cy =
                "16" r = "1" /> < path d =
        ...
        TiIcon::TiSpiral => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSpiral"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiStar"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarFullOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiStarFullOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarHalf => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiStarHalf"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarHalfOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiStarHalfOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiStarOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarburst => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiStarburst"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStarburstOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiStarburstOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiStopwatch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiStopwatch"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiSupport => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiSupport"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTabsOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTabsOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTag"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTags => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTags"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiThLarge => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThLarge"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThLargeOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiThLargeOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThList"
                .to_owned()) } < / title > < path d =
                ...
                /> < circle cx = "5" cy = "19" r = "2.5" /> < circle cx = "5" cy = "12" r
                = "2.5" /> < circle cx = "5" cy = "5" r = "2.5" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "TiThListOutline")]
        TiIcon::TiThListOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThListOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThMenu => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThMenu"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThMenuOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThMenuOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThSmall => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThSmall"
                .to_owned()) } < / title > < circle cx = "5" cy = "19" r = "2.5" /> <
                circle cx = "5" cy = "12" r = "2.5" /> < circle cx = "5" cy = "5" r =
                "2.5" /> < circle cx = "12" cy = "19" r = "2.5" /> < circle cx = "12" cy
                = "12" r = "2.5" /> < circle cx = "12" cy = "5" r = "2.5" /> < circle cx
                = "19" cy = "19" r = "2.5" /> < circle cx = "19" cy = "12" r = "2.5" /> <
                circle cx = "19" cy = "5" r = "2.5" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "TiThSmallOutline")]
        TiIcon::TiThSmallOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiThSmallOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThermometer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThermometer"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiThumbsDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThumbsDown"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThumbsOk => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThumbsOk"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiThumbsUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiThumbsUp"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTick => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTick"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTickOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTickOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTicket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTicket"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiTime => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTime"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTimes => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTimes"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTimesOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTimesOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTrash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTrash"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiTree => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiTree"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUpload => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUpload"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUploadOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUploadOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUser => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUser"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUserAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUserAdd"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUserAddOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiUserAddOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUserDelete => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUserDelete"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUserDeleteOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiUserDeleteOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiUserOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiUserOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVendorAndroid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVendorAndroid"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVendorApple => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVendorApple"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVendorMicrosoft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiVendorMicrosoft".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVideo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVideo"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVideoOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVideoOutline"
                .to_owned()) } < / title > < circle cx = "7" cy = "11" r = "1" /> < path
                d =
        ...
        TiIcon::TiVolume => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVolume"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVolumeDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVolumeDown"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiVolumeMute => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVolumeMute"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiVolumeUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiVolumeUp"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWarning => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWarning"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWarningOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiWarningOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWatch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWatch"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWaves => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWaves"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWavesOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWavesOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWeatherCloudy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherCloudy"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWeatherDownpour => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiWeatherDownpour".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWeatherNight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherNight"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWeatherPartlySunny => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiWeatherPartlySunny".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWeatherShower => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherShower"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWeatherSnow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherSnow"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWeatherStormy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherStormy"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWeatherSunny => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherSunny"
                .to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWeatherWindy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWeatherWindy"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWeatherWindyCloudy => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiWeatherWindyCloudy".to_owned()) } < / title > < g > < path d =
        ...
        TiIcon::TiWiFi => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWiFi"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWiFiOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWiFiOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWine => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWine"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWorld => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWorld"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiWorldOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiWorldOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoom => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiZoom"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoomIn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiZoomIn"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoomInOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiZoomInOutline"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoomOut => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiZoomOut"
                .to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoomOutOutline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "TiZoomOutOutline".to_owned()) } < / title > < path d =
        ...
        TiIcon::TiZoomOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "TiZoomOutline"
                .to_owned()) } < / title > < path d =
