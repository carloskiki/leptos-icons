...
#[cfg(feature = "TiAdjustBrightness")]
const TI_ADJUST_BRIGHTNESS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 6.934l1-2.934c.072-.213.078-.452 0-.682-.188-.553-.789-.848-1.341-.659-.553.189-.847.788-.659 1.341l1 2.934zM4 11c-.213-.072-.452-.078-.682 0-.553.188-.848.789-.659 1.341.189.553.788.847 1.341.659l2.934-1-2.934-1zM12 17.066l-1 2.934c-.072.213-.078.452 0 .682.188.553.789.848 1.341.659.553-.189.847-.788.659-1.341l-1-2.934zM21.341 11.657c-.188-.553-.788-.848-1.341-.659l-2.934 1 2.934 1c.213.072.452.078.682 0 .552-.188.847-.789.659-1.341zM5.636 7.05l2.781 1.367-1.367-2.781c-.1-.202-.265-.375-.482-.482-.524-.258-1.157-.042-1.415.482-.257.523-.041 1.157.483 1.414zM5.153 17.432c-.257.523-.041 1.156.482 1.414.523.257 1.157.041 1.414-.482l1.367-2.781-2.781 1.367c-.201.099-.374.263-.482.482zM18.363 16.949l-2.781-1.367 1.367 2.781c.1.202.264.375.482.482.523.257 1.156.041 1.414-.482s.042-1.157-.482-1.414zM18.844 6.566c.258-.524.042-1.157-.481-1.415-.523-.257-1.157-.041-1.414.482l-1.369 2.783 2.782-1.368c.202-.1.375-.264.482-.482zM12 7.5c-2.481 0-4.5 2.019-4.5 4.5s2.019 4.5 4.5 4.5 4.5-2.019 4.5-4.5-2.019-4.5-4.5-4.5z\" />",
};
#[cfg(feature = "TiAdjustContrast")]
const TI_ADJUST_CONTRAST: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiAnchor")]
const TI_ANCHOR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiArchive")]
const TI_ARCHIVE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiArrowBack")]
const TI_ARROW_BACK: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 9.059v-2.559c0-.256-.098-.512-.293-.708-.195-.195-.451-.292-.707-.292s-.512.097-.707.292l-6.293 6.208 6.293 6.207c.195.195.451.293.707.293s.512-.098.707-.293.293-.452.293-.707v-2.489c2.75.068 5.755.566 8 3.989v-1c0-4.633-3.5-8.443-8-8.941z\" />",
};
#[cfg(feature = "TiArrowBackOutline")]
const TI_ARROW_BACK_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19.164 19.547c-1.641-2.5-3.669-3.285-6.164-3.484v1.437c0 .534-.208 1.036-.586 1.414-.756.756-2.077.751-2.823.005l-6.293-6.207c-.191-.189-.298-.444-.298-.713s.107-.524.298-.712l6.288-6.203c.754-.755 2.073-.756 2.829.001.377.378.585.88.585 1.414v1.704c4.619.933 8 4.997 8 9.796v1c0 .442-.29.832-.714.958-.095.027-.19.042-.286.042-.331 0-.646-.165-.836-.452zm-7.141-5.536c2.207.056 4.638.394 6.758 2.121-.768-3.216-3.477-5.702-6.893-6.08-.504-.056-.888-.052-.888-.052v-3.497l-5.576 5.496 5.576 5.5v-3.499l1.023.011z\" />",
};
#[cfg(feature = "TiArrowDown")]
const TI_ARROW_DOWN: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16.707 13.293c-.391-.391-1.023-.391-1.414 0l-2.293 2.293v-7.586c0-.552-.447-1-1-1s-1 .448-1 1v7.586l-2.293-2.293c-.391-.391-1.023-.391-1.414 0s-.391 1.023 0 1.414l4.707 4.707 4.707-4.707c.391-.391.391-1.023 0-1.414z\" />",
};
#[cfg(feature = "TiArrowDownOutline")]
const TI_ARROW_DOWN_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ARROW_DOWN_THICK: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.414 10.656c-.781-.781-2.047-.781-2.828 0l-1.586 1.586v-7.242c0-1.105-.896-2-2-2-1.105 0-2 .895-2 2v7.242l-1.586-1.586c-.781-.781-2.047-.781-2.828 0s-.781 2.047 0 2.828l6.414 6.414 6.414-6.414c.781-.781.781-2.046 0-2.828z\" />",
};
#[cfg(feature = "TiArrowForward")]
const TI_ARROW_FORWARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M13 5.499c-.256 0-.512.097-.707.292-.195.196-.293.452-.293.708v2.559c-4.5.498-8 4.309-8 8.941v1c2.245-3.423 5.25-3.92 8-3.989v2.489c0 .255.098.512.293.707s.451.293.707.293.512-.098.707-.293l6.293-6.207-6.293-6.208c-.195-.195-.451-.292-.707-.292z\" />",
};
#[cfg(feature = "TiArrowForwardOutline")]
const TI_ARROW_FORWARD_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ARROW_LEFT: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 11h-7.586l2.293-2.293c.391-.391.391-1.023 0-1.414s-1.023-.391-1.414 0l-4.707 4.707 4.707 4.707c.195.195.451.293.707.293s.512-.098.707-.293c.391-.391.391-1.023 0-1.414l-2.293-2.293h7.586c.552 0 1-.448 1-1s-.448-1-1-1z\" />",
};
#[cfg(feature = "TiArrowLeftOutline")]
const TI_ARROW_LEFT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ARROW_LEFT_THICK: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 11h-7.244l1.586-1.586c.781-.781.781-2.049 0-2.828-.781-.781-2.047-.781-2.828 0l-6.414 6.414 6.414 6.414c.39.391.902.586 1.414.586s1.023-.195 1.414-.586c.781-.781.781-2.049 0-2.828l-1.586-1.586h7.244c1.104 0 2-.896 2-2 0-1.105-.896-2-2-2z\" />",
};
#[cfg(feature = "TiArrowLoop")]
const TI_ARROW_LOOP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ARROW_RIGHT: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M13.293 7.293c-.391.391-.391 1.023 0 1.414l2.293 2.293h-7.586c-.552 0-1 .448-1 1s.448 1 1 1h7.586l-2.293 2.293c-.391.391-.391 1.023 0 1.414.195.195.451.293.707.293s.512-.098.707-.293l4.707-4.707-4.707-4.707c-.391-.391-1.023-.391-1.414 0z\" />",
};
#[cfg(feature = "TiArrowRightOutline")]
const TI_ARROW_RIGHT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiArrowRightThick")]
const TI_ARROW_RIGHT_THICK: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10.586 6.586c-.781.779-.781 2.047 0 2.828l1.586 1.586h-7.244c-1.104 0-2 .895-2 2 0 1.104.896 2 2 2h7.244l-1.586 1.586c-.781.779-.781 2.047 0 2.828.391.391.902.586 1.414.586s1.023-.195 1.414-.586l6.414-6.414-6.414-6.414c-.781-.781-2.047-.781-2.828 0z\" />",
};
#[cfg(feature = "TiArrowShuffle")]
const TI_ARROW_SHUFFLE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M4 9h3.5c.736 0 1.393.391 1.851 1.001.325-.604.729-1.163 1.191-1.662-.803-.823-1.866-1.339-3.042-1.339h-3.5c-.553 0-1 .448-1 1s.447 1 1 1zM11.685 12.111c.551-1.657 2.256-3.111 3.649-3.111h1.838l-1.293 1.293c-.391.391-.391 1.023 0 1.414.195.195.451.293.707.293s.512-.098.707-.293l3.707-3.707-3.707-3.707c-.391-.391-1.023-.391-1.414 0s-.391 1.023 0 1.414l1.293 1.293h-1.838c-2.274 0-4.711 1.967-5.547 4.479l-.472 1.411c-.641 1.926-2.072 3.11-2.815 3.11h-2.5c-.553 0-1 .448-1 1s.447 1 1 1h2.5c1.837 0 3.863-1.925 4.713-4.479l.472-1.41zM15.879 13.293c-.391.391-.391 1.023 0 1.414l1.293 1.293h-2.338c-1.268 0-2.33-.891-2.691-2.108-.256.75-.627 1.499-1.09 2.185.886 1.162 2.243 1.923 3.781 1.923h2.338l-1.293 1.293c-.391.391-.391 1.023 0 1.414.195.195.451.293.707.293s.512-.098.707-.293l3.707-3.707-3.707-3.707c-.391-.391-1.023-.391-1.414 0z\" />",
};
#[cfg(feature = "TiArrowSortedDown")]
const TI_ARROW_SORTED_DOWN: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M5.8 9.7l6.2 6.3 6.2-6.3c.2-.2.3-.5.3-.7s-.1-.5-.3-.7c-.2-.2-.4-.3-.7-.3h-11c-.3 0-.5.1-.7.3-.2.2-.3.4-.3.7s.1.5.3.7z\" />",
};
#[cfg(feature = "TiArrowSortedUp")]
const TI_ARROW_SORTED_UP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.2 13.3l-6.2-6.3-6.2 6.3c-.2.2-.3.5-.3.7s.1.5.3.7c.2.2.4.3.7.3h11c.3 0 .5-.1.7-.3.2-.2.3-.5.3-.7s-.1-.5-.3-.7z\" />",
};
#[cfg(feature = "TiArrowSync")]
const TI_ARROW_SYNC: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ARROW_UNSORTED: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.2 9.3l-6.2-6.3-6.2 6.3c-.2.2-.3.4-.3.7s.1.5.3.7c.2.2.4.3.7.3h11c.3 0 .5-.1.7-.3.2-.2.3-.5.3-.7s-.1-.5-.3-.7zM5.8 14.7l6.2 6.3 6.2-6.3c.2-.2.3-.5.3-.7s-.1-.5-.3-.7c-.2-.2-.4-.3-.7-.3h-11c-.3 0-.5.1-.7.3-.2.2-.3.5-.3.7s.1.5.3.7z\" />",
};
#[cfg(feature = "TiArrowUp")]
const TI_ARROW_UP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M13 5.586l-4.707 4.707c-.391.391-.391 1.023 0 1.414s1.023.391 1.414 0l2.293-2.293v7.586c0 .552.447 1 1 1s1-.448 1-1v-7.586l2.293 2.293c.195.195.451.293.707.293s.512-.098.707-.293c.391-.391.391-1.023 0-1.414l-4.707-4.707z\" />",
};
#[cfg(feature = "TiArrowUpOutline")]
const TI_ARROW_UP_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiArrowUpThick")]
const TI_ARROW_UP_THICK: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 3.172l-6.414 6.414c-.781.781-.781 2.047 0 2.828s2.047.781 2.828 0l1.586-1.586v7.242c0 1.104.895 2 2 2 1.104 0 2-.896 2-2v-7.242l1.586 1.586c.391.391.902.586 1.414.586s1.023-.195 1.414-.586c.781-.781.781-2.047 0-2.828l-6.414-6.414z\" />",
};
#[cfg(feature = "TiAt")]
const TI_AT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_BACKSPACE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19.5 5h-10c-1.266 0-2.834.807-3.57 1.837l-2.61 3.653-1.199 1.679c-.121.175-.122.492.003.664l1.188 1.664 2.619 3.667c.735 1.029 2.302 1.836 3.569 1.836h10c1.379 0 2.5-1.122 2.5-2.5v-10c0-1.378-1.121-2.5-2.5-2.5zm-2.293 9.793c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-2.293-2.293-2.293 2.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023 0-1.414l2.293-2.293-2.293-2.293c-.391-.391-.391-1.023 0-1.414s1.023-.391 1.414 0l2.293 2.293 2.293-2.293c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414l-2.293 2.293 2.293 2.293z\" />",
};
#[cfg(feature = "TiBackspaceOutline")]
const TI_BACKSPACE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiBatteryCharge")]
const TI_BATTERY_CHARGE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_BATTERY_FULL: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M9 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM15 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM12 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z\" />",
};
#[cfg(feature = "TiBatteryHigh")]
const TI_BATTERY_HIGH: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M9 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM12 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z\" />",
};
#[cfg(feature = "TiBatteryLow")]
const TI_BATTERY_LOW: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z\" />",
};
#[cfg(feature = "TiBatteryMid")]
const TI_BATTERY_MID: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M9 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z\" />",
};
#[cfg(feature = "TiBeaker")]
const TI_BEAKER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiBeer")]
const TI_BEER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiBell")]
const TI_BELL: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiBrush")]
const TI_BRUSH: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCalculator")]
const TI_CALCULATOR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 21h-8c-1.7 0-3-1.3-3-3v-12c0-1.7 1.3-3 3-3h8c1.7 0 3 1.3 3 3v12c0 1.7-1.3 3-3 3zm-8-16c-.6 0-1 .4-1 1v12c0 .6.4 1 1 1h8c.6 0 1-.4 1-1v-12c0-.6-.4-1-1-1h-8z\" />\n<circle cx=\"10\" cy=\"11\" r=\"1\" />\n<circle cx=\"13\" cy=\"11\" r=\"1\" />\n<circle cx=\"16\" cy=\"11\" r=\"1\" />\n<circle cx=\"10\" cy=\"14\" r=\"1\" />\n<circle cx=\"13\" cy=\"14\" r=\"1\" />\n<circle cx=\"16\" cy=\"14\" r=\"1\" />\n<circle cx=\"10\" cy=\"17\" r=\"1\" />\n<circle cx=\"13\" cy=\"17\" r=\"1\" />\n<circle cx=\"16\" cy=\"17\" r=\"1\" />\n<path d=\"M16 7v1h-6v-1h6m1-1h-8v3h8v-3z\" />",
};
#[cfg(feature = "TiCalendar")]
const TI_CALENDAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCamera")]
const TI_CAMERA: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 6h-1.586l-1-1c-.579-.579-1.595-1-2.414-1h-4c-.819 0-1.835.421-2.414 1l-1 1h-1.586c-1.654 0-3 1.346-3 3v8c0 1.654 1.346 3 3 3h14c1.654 0 3-1.346 3-3v-8c0-1.654-1.346-3-3-3zm-7 10c-1.933 0-3.5-1.568-3.5-3.5 0-1.934 1.567-3.5 3.5-3.5s3.5 1.566 3.5 3.5c0 1.932-1.567 3.5-3.5 3.5zm6-4.701c-.719 0-1.3-.58-1.3-1.299s.581-1.301 1.3-1.301 1.3.582 1.3 1.301-.581 1.299-1.3 1.299z\" />",
};
#[cfg(feature = "TiCameraOutline")]
const TI_CAMERA_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_CANCEL: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 4c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm-5 8c0-.832.224-1.604.584-2.295l6.711 6.711c-.691.36-1.463.584-2.295.584-2.757 0-5-2.243-5-5zm9.416 2.295l-6.711-6.711c.691-.36 1.463-.584 2.295-.584 2.757 0 5 2.243 5 5 0 .832-.224 1.604-.584 2.295z\" />",
};
#[cfg(feature = "TiCancelOutline")]
const TI_CANCEL_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 20.5c-4.688 0-8.5-3.812-8.5-8.5s3.812-8.5 8.497-8.5c4.69 0 8.503 3.812 8.503 8.5s-3.812 8.5-8.5 8.5zm0-15c-3.586 0-6.5 2.916-6.5 6.5s2.916 6.5 6.5 6.5 6.5-2.916 6.5-6.5-2.916-6.5-6.5-6.5zM12.003 8.5c1.929 0 3.497 1.57 3.497 3.5 0 .206-.02.412-.057.615l-4.057-4.059c.203-.036.408-.056.614-.056m.003-1c-.882 0-1.696.262-2.39.697l6.188 6.188c.438-.692.699-1.508.699-2.387 0-2.48-2.014-4.498-4.497-4.498zM8.557 11.384l4.059 4.06c-.204.036-.409.056-.616.056-1.93 0-3.5-1.57-3.5-3.502 0-.206.02-.412.057-.614m-.358-1.773c-.435.694-.699 1.508-.699 2.387 0 2.486 2.016 4.502 4.5 4.502.879 0 1.693-.264 2.387-.699l-6.188-6.19z\" />",
};
#[cfg(feature = "TiChartArea")]
const TI_CHART_AREA: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M20 6c0-.587-.257-1.167-.75-1.562-.863-.69-2.121-.551-2.812.312l-2.789 3.486-2.449-1.836c-.864-.648-2.087-.493-2.762.351l-4 5c-.294.368-.438.811-.438 1.249v3h16v-10zM20 19h-16c-.552 0-1 .447-1 1s.448 1 1 1h16c.552 0 1-.447 1-1s-.448-1-1-1z\" />",
};
#[cfg(feature = "TiChartAreaOutline")]
const TI_CHART_AREA_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_CHART_BAR: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M14 4c0-1.105-.896-2-2-2s-2 .895-2 2v12h4v-12zM19 8c0-1.105-.896-2-2-2s-2 .895-2 2v8h4v-8zM9 11c0-1.105-.896-2-2-2s-2 .895-2 2v5h4v-5zM19 19h-14c-.553 0-1 .447-1 1s.447 1 1 1h14c.553 0 1-.447 1-1s-.447-1-1-1z\" />",
};
#[cfg(feature = "TiChartBarOutline")]
const TI_CHART_BAR_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 5c-.771 0-1.468.301-2 .779v-1.779c0-1.654-1.346-3-3-3s-3 1.346-3 3v4.779c-.532-.478-1.229-.779-2-.779-1.654 0-3 1.346-3 3v6h16v-9c0-1.654-1.346-3-3-3zm-5-2c.551 0 1 .448 1 1v11h-2v-11c0-.552.449-1 1-1zm-4 12h-2v-4c0-.552.449-1 1-1s1 .448 1 1v4zm10 0h-2v-7c0-.552.449-1 1-1s1 .448 1 1v7zM19 21h-14c-.552 0-1-.447-1-1s.448-1 1-1h14c.552 0 1 .447 1 1s-.448 1-1 1z\" />",
};
#[cfg(feature = "TiChartLine")]
const TI_CHART_LINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_CHEVRON_LEFT: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M14.414 5.586c-.78-.781-2.048-.781-2.828 0l-6.415 6.414 6.415 6.414c.39.391.902.586 1.414.586s1.024-.195 1.414-.586c.781-.781.781-2.047 0-2.828l-3.585-3.586 3.585-3.586c.781-.781.781-2.047 0-2.828z\" />",
};
#[cfg(feature = "TiChevronLeftOutline")]
const TI_CHEVRON_LEFT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_CHEVRON_RIGHT: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8.586 5.586c-.781.781-.781 2.047 0 2.828l3.585 3.586-3.585 3.586c-.781.781-.781 2.047 0 2.828.39.391.902.586 1.414.586s1.024-.195 1.414-.586l6.415-6.414-6.415-6.414c-.78-.781-2.048-.781-2.828 0z\" />",
};
#[cfg(feature = "TiChevronRightOutline")]
const TI_CHEVRON_RIGHT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10 20c-.802 0-1.555-.312-2.122-.879-.566-.566-.878-1.32-.878-2.121s.312-1.555.879-2.122l2.878-2.878-2.878-2.879c-.567-.566-.879-1.32-.879-2.121s.312-1.555.879-2.122c1.133-1.132 3.109-1.133 4.243.001l7.121 7.121-7.122 7.121c-.566.567-1.319.879-2.121.879zm0-14c-.268 0-.518.104-.707.292-.189.19-.293.441-.293.708s.104.518.293.707l4.292 4.293-4.292 4.293c-.189.189-.293.439-.293.707s.104.518.293.707c.378.379 1.037.378 1.414.001l5.708-5.708-5.708-5.707c-.189-.189-.439-.293-.707-.293z\" />",
};
#[cfg(feature = "TiClipboard")]
const TI_CLIPBOARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCloudStorage")]
const TI_CLOUD_STORAGE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 9l-.351.015c-.825-2.377-3.062-4.015-5.649-4.015-3.309 0-6 2.691-6 6l.001.126c-1.724.445-3.001 2.013-3.001 3.874 0 2.206 1.794 4 4 4h5v-4.586l-1.293 1.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023 0-1.414l2.999-2.999c.093-.093.203-.166.326-.217.244-.101.52-.101.764 0 .123.051.233.124.326.217l2.999 2.999c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-1.293-1.293v4.586h4c2.757 0 5-2.243 5-5s-2.243-5-5-5z\" />",
};
#[cfg(feature = "TiCloudStorageOutline")]
const TI_CLOUD_STORAGE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCoffee")]
const TI_COFFEE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCog")]
const TI_COG: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiContacts")]
const TI_CONTACTS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCreditCard")]
const TI_CREDIT_CARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiCss3")]
const TI_CSS3: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M5.7 3.4l-.6 3.2h12.3l-.4 2.1h-12.3l-.6 3.2h12.3l-.7 3.6-5 1.7-4.3-1.7.3-1.6h-3l-.7 3.8 7.1 2.9 8.2-2.9 1.1-5.8.2-1.2 1.4-7.3h-15.3z\" />",
};
#[cfg(feature = "TiDatabase")]
const TI_DATABASE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.983 8.791c-.176-3.704-3.236-6.666-6.983-6.666s-6.807 2.962-6.983 6.666l-.017.084v6.25c0 3.86 3.141 7 7 7s7-3.14 7-7v-6.25l-.017-.084zm-6.983 8.834c-2.22 0-4.132-1.324-5-3.222v-.388c1.271 1.3 3.042 2.11 5 2.11s3.729-.811 5-2.11v.388c-.868 1.898-2.78 3.222-5 3.222zm0-13.5c2.757 0 5 2.243 5 5s-2.243 5-5 5-5-2.243-5-5 2.243-5 5-5zm0 16c-2.271 0-4.172-1.532-4.778-3.609 1.188 1.293 2.888 2.109 4.778 2.109s3.59-.816 4.778-2.109c-.606 2.077-2.507 3.609-4.778 3.609z\" />",
};
#[cfg(feature = "TiDelete")]
const TI_DELETE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 4c-4.419 0-8 3.582-8 8s3.581 8 8 8 8-3.582 8-8-3.581-8-8-8zm3.707 10.293c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-2.293-2.293-2.293 2.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023 0-1.414l2.293-2.293-2.293-2.293c-.391-.391-.391-1.023 0-1.414s1.023-.391 1.414 0l2.293 2.293 2.293-2.293c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414l-2.293 2.293 2.293 2.293z\" />",
};
#[cfg(feature = "TiDeleteOutline")]
const TI_DELETE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 3c-4.963 0-9 4.038-9 9s4.037 9 9 9 9-4.038 9-9-4.037-9-9-9zm0 16c-3.859 0-7-3.14-7-7s3.141-7 7-7 7 3.14 7 7-3.141 7-7 7zM12.707 12l2.646-2.646c.194-.194.194-.512 0-.707-.195-.194-.513-.194-.707 0l-2.646 2.646-2.646-2.647c-.195-.194-.513-.194-.707 0-.195.195-.195.513 0 .707l2.646 2.647-2.646 2.646c-.195.195-.195.513 0 .707.097.098.225.147.353.147s.256-.049.354-.146l2.646-2.647 2.646 2.646c.098.098.226.147.354.147s.256-.049.354-.146c.194-.194.194-.512 0-.707l-2.647-2.647z\" />",
};
#[cfg(feature = "TiDeviceDesktop")]
const TI_DEVICE_DESKTOP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDeviceLaptop")]
const TI_DEVICE_LAPTOP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDeviceTablet")]
const TI_DEVICE_TABLET: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDirections")]
const TI_DIRECTIONS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_DIVIDE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<circle cx=\"12\" cy=\"6\" r=\"2.25\" />\n<circle cx=\"12\" cy=\"18\" r=\"2.25\" />\n<path d=\"M18 10h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2z\" />",
};
#[cfg(feature = "TiDivideOutline")]
const TI_DIVIDE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDocument")]
const TI_DOCUMENT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19.707 7.293l-4-4c-.187-.188-.441-.293-.707-.293h-8c-1.654 0-3 1.346-3 3v12c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3v-10c0-.266-.105-.52-.293-.707zm-2.121.707h-1.086c-.827 0-1.5-.673-1.5-1.5v-1.086l2.586 2.586zm-.586 11h-10c-.552 0-1-.448-1-1v-12c0-.552.448-1 1-1h7v1.5c0 1.379 1.121 2.5 2.5 2.5h1.5v9c0 .552-.448 1-1 1z\" />",
};
#[cfg(feature = "TiDocumentAdd")]
const TI_DOCUMENT_ADD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDocumentText")]
const TI_DOCUMENT_TEXT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiDownload")]
const TI_DOWNLOAD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_DROPBOX: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M3 12.9l5.3 3.5 3.7-3.1-5.3-3.3zM8.3 3.6l-5.3 3.5 3.7 2.9 5.3-3.3zM21 7.1l-5.3-3.5-3.7 3.1 5.3 3.3zM12 13.3l3.7 3.1 5.3-3.5-3.7-2.9zM12 14.5l-3.7 3.1-1.6-1.1v1.2l5.3 3.2 5.3-3.2v-1.2l-1.6 1.1z\" />",
};
#[cfg(feature = "TiEdit")]
const TI_EDIT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_EJECT: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M13 17.5c-2.481 0-4.5-2.019-4.5-4.5 0-.553-.447-1-1-1s-1 .447-1 1c0 3.584 2.916 6.5 6.5 6.5s6.5-2.916 6.5-6.5-2.916-6.5-6.5-6.5c-.553 0-1 .447-1 1s.447 1 1 1c2.481 0 4.5 2.019 4.5 4.5s-2.019 4.5-4.5 4.5zM10.656 4c.552 0 1 .448 1 1s-.448 1-1 1h-3.243l1.708 1.707 4.093 4.092c.391.391.391 1.025.001 1.415-.189.188-.44.292-.708.292s-.519-.104-.707-.291l-4.093-4.094-1.707-1.708v3.243c0 .552-.448 1-1 1s-1-.448-1-1v-6.656h6.656\" />",
};
#[cfg(feature = "TiEjectOutline")]
const TI_EJECT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_EQUALS: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 7h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2zM18 14h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2z\" />",
};
#[cfg(feature = "TiEqualsOutline")]
const TI_EQUALS_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 12h-12c-1.654 0-3-1.346-3-3s1.346-3 3-3h12c1.654 0 3 1.346 3 3s-1.346 3-3 3zm-12-4c-.552 0-1 .449-1 1s.448 1 1 1h12c.552 0 1-.449 1-1s-.448-1-1-1h-12zM18 19h-12c-1.654 0-3-1.346-3-3s1.346-3 3-3h12c1.654 0 3 1.346 3 3s-1.346 3-3 3zm-12-4c-.552 0-1 .449-1 1s.448 1 1 1h12c.552 0 1-.449 1-1s-.448-1-1-1h-12z\" />",
};
#[cfg(feature = "TiExport")]
const TI_EXPORT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiFilter")]
const TI_FILTER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 6h-14c-1.1 0-1.4.6-.6 1.4l4.2 4.2c.8.8 1.4 2.3 1.4 3.4v5l4-2v-3.5c0-.8.6-2.1 1.4-2.9l4.2-4.2c.8-.8.5-1.4-.6-1.4z\" />",
};
#[cfg(feature = "TiFlag")]
const TI_FLAG: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.383 4.318c-.374-.155-.804-.069-1.09.217-1.264 1.263-3.321 1.264-4.586 0-2.045-2.043-5.37-2.043-7.414 0-.188.187-.293.442-.293.707v13c0 .552.447 1 1 1s1-.448 1-1v-4.553c1.271-.997 3.121-.911 4.293.26 2.045 2.043 5.371 2.043 7.414 0 .188-.188.293-.442.293-.707v-8c0-.405-.244-.769-.617-.924z\" />",
};
#[cfg(feature = "TiFlagOutline")]
const TI_FLAG_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_FLASH: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17.502 12.033l-4.241-2.458 2.138-5.131c.066-.134.103-.285.103-.444 0-.552-.445-1-.997-1-.249.004-.457.083-.622.214l-.07.06-7.5 7.1c-.229.217-.342.529-.306.842.036.313.219.591.491.75l4.242 2.46-2.163 5.19c-.183.436-.034.94.354 1.208.173.118.372.176.569.176.248 0 .496-.093.688-.274l7.5-7.102c.229-.217.342-.529.306-.842-.037-.313-.22-.591-.492-.749z\" />",
};
#[cfg(feature = "TiFlashOutline")]
const TI_FLASH_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_FLOW_CHILDREN: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 16c-1.305 0-2.403.837-2.816 2h-3.184c-1.654 0-3-1.346-3-3v-3.025c.838.634 1.87 1.025 3 1.025h3.184c.413 1.163 1.512 2 2.816 2 1.657 0 3-1.343 3-3s-1.343-3-3-3c-1.305 0-2.403.837-2.816 2h-3.184c-1.654 0-3-1.346-3-3v-.184c1.163-.413 2-1.512 2-2.816 0-1.657-1.343-3-3-3s-3 1.343-3 3c0 1.304.837 2.403 2 2.816v7.184c0 2.757 2.243 5 5 5h3.184c.413 1.163 1.512 2 2.816 2 1.657 0 3-1.343 3-3s-1.343-3-3-3zm0-5c.552 0 1 .449 1 1s-.448 1-1 1-1-.449-1-1 .448-1 1-1zm-10-7c.552 0 1 .449 1 1s-.448 1-1 1-1-.449-1-1 .448-1 1-1zm10 16c-.552 0-1-.449-1-1s.448-1 1-1 1 .449 1 1-.448 1-1 1z\" />",
};
#[cfg(feature = "TiFlowMerge")]
const TI_FLOW_MERGE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiFlowSwitch")]
const TI_FLOW_SWITCH: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiFolder")]
const TI_FOLDER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 6h-6c0-1.104-.896-2-2-2h-4c-1.654 0-3 1.346-3 3v10c0 1.654 1.346 3 3 3h12c1.654 0 3-1.346 3-3v-8c0-1.654-1.346-3-3-3zm-12 0h4c0 1.104.896 2 2 2h6c.552 0 1 .448 1 1h-14v-2c0-.552.448-1 1-1zm12 12h-12c-.552 0-1-.448-1-1v-7h14v7c0 .552-.448 1-1 1z\" />",
};
#[cfg(feature = "TiFolderAdd")]
const TI_FOLDER_ADD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiFolderOpen")]
const TI_FOLDER_OPEN: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M22.3 8h-2.4c-.4-1.2-1.5-2-2.8-2h-6c0-1.1-.9-2-2-2h-4.1c-1.7 0-3 1.3-3 3v10c0 1.7 1.3 3 3 3h12c1.7 0 3.4-1.3 3.8-3l2.2-8c.1-.6-.2-1-.7-1zm-18.3 1v-2c0-.6.4-1 1-1h4c0 1.1.9 2 2 2h6c.6 0 1 .4 1 1h-11.1c-.6 0-1.1.4-1.3 1l-1.6 6.3v-7.3zm14.9 7.5c-.2.8-1.1 1.5-1.9 1.5h-12s-.4-.2-.2-.8l1.9-7c0-.1.2-.2.3-.2h13.7l-1.8 6.5z\" />",
};
#[cfg(feature = "TiGift")]
const TI_GIFT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 8h-2.352c.219-.457.352-.961.352-1.5 0-1.93-1.57-3.5-3.5-3.5-.979 0-1.864.407-2.5 1.058-.636-.651-1.521-1.058-2.5-1.058-1.93 0-3.5 1.57-3.5 3.5 0 .539.133 1.043.352 1.5h-2.352c-.553 0-1 .448-1 1v4c0 .552.447 1 1 1v5c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3v-5c.553 0 1-.448 1-1v-4c0-.552-.447-1-1-1zm-1 4h-5v-2h5v2zm-8-5h2v1h-2v-1zm2 3v2h-2v-2h2zm1.5-5c.827 0 1.5.673 1.5 1.5s-.673 1.5-1.5 1.5c-.177 0-.344-.039-.5-.097v-.903c0-.521-.404-.937-.913-.982.202-.59.756-1.018 1.413-1.018zm-6.5 1.5c0-.827.673-1.5 1.5-1.5.657 0 1.211.428 1.413 1.018-.509.045-.913.461-.913.982v.903c-.156.058-.323.097-.5.097-.827 0-1.5-.673-1.5-1.5zm2 3.5v2h-5v-2h5zm-3 10c-.551 0-1-.449-1-1v-6h4v7h-3zm4 0v-7h2v7h-2zm6 0h-3v-7h4v6c0 .551-.449 1-1 1z\" />",
};
#[cfg(feature = "TiGlobe")]
const TI_GLOBE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M11 20h-4c-.553 0-1 .447-1 1s.447 1 1 1h10c.553 0 1-.447 1-1s-.447-1-1-1h-4v-1.23c1.64-.371 3.146-1.188 4.363-2.406 1.7-1.7 2.637-3.96 2.637-6.364 0-2.067-.692-4.029-1.968-5.619l.675-.673c.391-.391.391-1.023.001-1.415-.391-.391-1.024-.39-1.415-.001l-2.052 2.049.708.708c1.322 1.322 2.051 3.081 2.051 4.951s-.729 3.627-2.051 4.949-3.079 2.051-4.949 2.051-3.627-.729-4.949-2.051c-.391-.391-1.023-.391-1.414 0-.391.39-.391 1.023 0 1.414 1.699 1.7 3.959 2.637 6.363 2.637v1zM11 4c1.657 0 3.157.672 4.243 1.757 1.085 1.086 1.757 2.586 1.757 4.243 0 1.656-.672 3.156-1.757 4.242-1.086 1.086-2.586 1.758-4.243 1.758-1.658 0-3.157-.672-4.242-1.757-1.085-1.086-1.756-2.586-1.756-4.243s.671-3.157 1.756-4.243c1.085-1.085 2.584-1.757 4.242-1.757z\" />",
};
#[cfg(feature = "TiGlobeOutline")]
const TI_GLOBE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_HEART: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 10.375c0-2.416-1.959-4.375-4.375-4.375s-4.375 1.959-4.375 4.375c0 1.127.159 2.784 1.75 4.375l7 5.25s5.409-3.659 7-5.25 1.75-3.248 1.75-4.375c0-2.416-1.959-4.375-4.375-4.375s-4.375 1.959-4.375 4.375\" />",
};
#[cfg(feature = "TiHeartFullOutline")]
const TI_HEART_FULL_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M2.2 9.4c0 1.3.2 3.3 2 5.1 1.6 1.6 6.9 5.2 7.1 5.4.2.1.4.2.6.2s.4-.1.6-.2c.2-.2 5.5-3.7 7.1-5.4 1.8-1.8 2-3.8 2-5.1 0-3-2.4-5.4-5.4-5.4-1.6 0-3.2.9-4.2 2.3-1-1.4-2.6-2.3-4.4-2.3-2.9 0-5.4 2.4-5.4 5.4z\" />",
};
#[cfg(feature = "TiHeartHalfOutline")]
const TI_HEART_HALF_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M2.2 9.4c0 1.3.2 3.3 2 5.1 1.6 1.6 6.9 5.2 7.1 5.4.2.1.4.2.6.2s.4-.1.6-.2c.2-.2 5.5-3.7 7.1-5.4 1.8-1.8 2-3.8 2-5.1 0-3-2.4-5.4-5.4-5.4-1.6 0-3.2.9-4.2 2.3-1-1.4-2.6-2.3-4.4-2.3-2.9 0-5.4 2.4-5.4 5.4zm9.8 1c.6 0 1-.4 1-1 0-1.9 1.5-3.4 3.4-3.4s3.4 1.5 3.4 3.4c0 1.1-.2 2.4-1.5 3.7-1.2 1.2-4.9 3.8-6.3 4.7v-7.4z\" />",
};
#[cfg(feature = "TiHeartOutline")]
const TI_HEART_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_HOME: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 3s-6.186 5.34-9.643 8.232c-.203.184-.357.452-.357.768 0 .553.447 1 1 1h2v7c0 .553.447 1 1 1h3c.553 0 1-.448 1-1v-4h4v4c0 .552.447 1 1 1h3c.553 0 1-.447 1-1v-7h2c.553 0 1-.447 1-1 0-.316-.154-.584-.383-.768-3.433-2.892-9.617-8.232-9.617-8.232z\" />",
};
#[cfg(feature = "TiHomeOutline")]
const TI_HOME_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_INPUT_CHECKED: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16 19h-8c-1.654 0-3-1.346-3-3v-8c0-1.654 1.346-3 3-3h5c.553 0 1 .448 1 1s-.447 1-1 1h-5c-.552 0-1 .449-1 1v8c0 .551.448 1 1 1h8c.552 0 1-.449 1-1v-3c0-.552.447-1 1-1s1 .448 1 1v3c0 1.654-1.346 3-3 3zM13.166 14.833c-.35 0-.689-.139-.941-.391l-2.668-2.667c-.52-.521-.52-1.365 0-1.885.521-.521 1.365-.521 1.887 0l1.416 1.417 3.475-5.455c.357-.644 1.17-.877 1.814-.519.643.358.875 1.17.518 1.813l-4.334 7c-.203.366-.566.615-.98.673l-.187.014z\" />",
};
#[cfg(feature = "TiInputCheckedOutline")]
const TI_INPUT_CHECKED_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19.885 6.177c-.221-.771-.728-1.409-1.427-1.798-.445-.248-.949-.379-1.457-.379-.862 0-1.661.381-2.219 1h-6.782c-1.654 0-3 1.346-3 3v8c0 1.654 1.346 3 3 3h8c1.654 0 3-1.346 3-3v-6.454l.622-1.088c.39-.7.482-1.51.263-2.281zm-3.758.338c.104-.189.27-.328.459-.416.301-.113.623-.127.9.027.232.13.402.343.476.6.033.117.039.236.03.353-.012.115-.043.227-.092.332l-.021.065-4.006 7.011c-.151.273-.427.461-.742.506l-.132.009c-.267 0-.518-.104-.707-.293l-3-3c-.39-.39-.39-1.024 0-1.414.189-.189.44-.293.707-.293s.518.104.707.293l1.125 1.125.92.92.652-1.125 2.724-4.7zm-.127 10.485h-8c-.552 0-1-.449-1-1v-8c0-.551.448-1 1-1h6.689l-2.15 3.712-1.125-1.125c-.391-.391-.902-.586-1.414-.586s-1.023.195-1.414.586c-.781.781-.781 2.047 0 2.828l3 3c.378.378.888.586 1.414.586l.277-.02c.621-.087 1.166-.461 1.471-1.01l2.252-3.94v4.969c0 .551-.448 1-1 1z\" />",
};
#[cfg(feature = "TiKey")]
const TI_KEY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8.5 11c0 .732.166 1.424.449 2.051l-3.949 3.949v1.5s.896 1.5 2 1.5h2v-2h2v-2h2.5c2.762 0 5-2.238 5-5s-2.238-5-5-5-5 2.238-5 5zm5 2c-1.104 0-2-.896-2-2 0-1.105.896-2.002 2-2.002 1.105 0 2 .896 2 2.002 0 1.104-.895 2-2 2z\" />",
};
#[cfg(feature = "TiKeyOutline")]
const TI_KEY_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10 21h-6v-4.414l3.783-3.783c-.187-.587-.283-1.192-.283-1.803 0-3.309 2.691-6 6-6s6 2.691 6 6-2.691 6-6 6h-1.5v2h-2v2zm-4-2h2v-2h2v-2h3.5c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4c0 .559.121 1.109.359 1.639l.285.631-4.144 4.144v1.586zM13.5 9.998c.551 0 1 .449 1 1.002 0 .552-.449 1-1 1s-1-.448-1-1c0-.553.449-1.002 1-1.002m0-1c-1.104 0-2 .896-2 2.002 0 1.104.896 2 2 2 1.105 0 2-.896 2-2 0-1.105-.895-2.002-2-2.002z\" />",
};
#[cfg(feature = "TiKeyboard")]
const TI_KEYBOARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8 13h7v2h-7zM5 13h2v2h-2zM5 9h2v1h-2zM8 12v-1h-3v1h2zM8 9h1v1h-1zM9 11h1v1h-1zM10 9h1v1h-1zM11 11h1v1h-1zM12 9h1v1h-1zM13 11h1v1h-1zM14 9h1v1h-1zM15 11h1v1h-1zM16 9h1v1h-1zM17 12h2v-3h-1v2h-1zM18 13h-1v1h-1v1h3v-1h-1zM20 6h-16c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zm0 10h-16v-8h16v8z\" />",
};
#[cfg(feature = "TiLeaf")]
const TI_LEAF: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiLink")]
const TI_LINK: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.277 6.321c-.43-.43-1.126-.43-1.556 0l-1.721 1.722-.308-.308c-1.168-1.168-3.216-1.168-4.384 0l-4.172 4.172c-.584.584-.906 1.363-.906 2.192s.322 1.608.906 2.192l.308.308-1.722 1.722c-.43.43-.43 1.126 0 1.556.215.215.496.322.778.322s.563-.107.778-.322l1.722-1.722.308.308c.584.584 1.362.906 2.192.906s1.608-.322 2.192-.906l4.172-4.172c.584-.584.906-1.362.906-2.192s-.322-1.608-.906-2.192l-.308-.308 1.722-1.722c.429-.43.429-1.126-.001-1.556zm-2.969 6.414l-4.172 4.172c-.168.168-.402.253-.636.253s-.468-.084-.636-.253l-.308-.308.722-.722c.43-.43.43-1.126 0-1.556-.215-.215-.496-.322-.778-.322s-.563.107-.778.322l-.722.722-.308-.308c-.168-.168-.261-.395-.261-.636s.093-.468.261-.636l4.172-4.172c.168-.168.394-.261.636-.261s.468.093.636.261l.308.308-.722.722c-.43.43-.43 1.126 0 1.556.215.215.496.322.778.322s.563-.107.778-.322l.722-.722.308.308c.168.168.261.395.261.636s-.093.468-.261.636z\" />",
};
#[cfg(feature = "TiLinkOutline")]
const TI_LINK_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_LOCATION: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17.657 5.304c-3.124-3.073-8.189-3.073-11.313 0-3.124 3.074-3.124 8.057 0 11.13l5.656 5.565 5.657-5.565c3.124-3.073 3.124-8.056 0-11.13zm-5.657 8.195c-.668 0-1.295-.26-1.768-.732-.975-.975-.975-2.561 0-3.536.472-.472 1.1-.732 1.768-.732s1.296.26 1.768.732c.975.975.975 2.562 0 3.536-.472.472-1.1.732-1.768.732z\" />",
};
#[cfg(feature = "TiLocationArrow")]
const TI_LOCATION_ARROW: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10.368 19.102c.349 1.049 1.011 1.086 1.478.086l5.309-11.375c.467-1.002.034-1.434-.967-.967l-11.376 5.308c-1.001.467-.963 1.129.085 1.479l4.103 1.367 1.368 4.102z\" />",
};
#[cfg(feature = "TiLocationArrowOutline")]
const TI_LOCATION_ARROW_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M11.087 20.914c-.353 0-1.219-.146-1.668-1.496l-1.209-3.627-3.628-1.209c-1.244-.415-1.469-1.172-1.493-1.587s.114-1.193 1.302-1.747l11.375-5.309c1.031-.479 1.922-.309 2.348.362.224.351.396.97-.053 1.933l-5.309 11.375c-.529 1.135-1.272 1.305-1.665 1.305zm-5.39-8.068l4.094 1.363 1.365 4.093 4.775-10.233-10.234 4.777z\" />",
};
#[cfg(feature = "TiLocationOutline")]
const TI_LOCATION_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_LOCK_CLOSED: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 10h-1v-2c0-2.205-1.794-4-4-4s-4 1.795-4 4v2h-1c-1.103 0-2 .896-2 2v7c0 1.104.897 2 2 2h10c1.103 0 2-.896 2-2v-7c0-1.104-.897-2-2-2zm-5 8.299c-.719 0-1.3-.58-1.3-1.299s.581-1.301 1.3-1.301 1.3.582 1.3 1.301-.581 1.299-1.3 1.299zm2-7.299h-4v-3c0-1.104.897-2 2-2s2 .896 2 2v3z\" />",
};
#[cfg(feature = "TiLockClosedOutline")]
const TI_LOCK_CLOSED_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiMail")]
const TI_MAIL: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 7h-14c-1.104 0-2 .896-2 2v9c0 1.104.896 2 2 2h14c1.104 0 2-.896 2-2v-9c0-1.104-.896-2-2-2zm-9.684 7.316l1.602 1.4c.305.266.691.398 1.082.398s.777-.133 1.082-.398l1.602-1.4-.037.037 3.646 3.646h-12.586l3.646-3.646-.037-.037zm-4.316 2.977v-6.753l3.602 3.151-3.602 3.602zm10.398-3.602l3.602-3.151v6.75l-3.602-3.599zm3.602-4.691v.21l-6.576 5.754c-.227.198-.621.198-.848 0l-6.576-5.754v-.21h14z\" />",
};
#[cfg(feature = "TiMap")]
const TI_MAP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M20.383 3.076c-.373-.155-.804-.069-1.09.217l-3.867 3.867-4.301-3.441c-.396-.316-.973-.287-1.332.074l-4.5 4.5c-.188.187-.293.441-.293.707v10c0 .404.243.77.617.924.124.053.254.076.383.076.26 0 .516-.102.707-.293l3.867-3.867 4.301 3.441c.396.316.971.285 1.332-.074l4.5-4.5c.188-.187.293-.441.293-.707v-10c0-.404-.243-.77-.617-.924zm-13.383 13.51v-7.172l3-3v7.24c-.07.043-3 2.932-3 2.932zm4.125-2.867l-.125-.068v-7.469s3.959 3.143 4 3.166v7.473l-3.875-3.102zm7.875-.133l-3 3v-7.236c.07-.043 3-2.936 3-2.936v7.172z\" />",
};
#[cfg(feature = "TiMediaEject")]
const TI_MEDIA_EJECT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 16h-10c-1.104 0-2 .895-2 2 0 1.104.896 2 2 2h10c1.104 0 2-.896 2-2 0-1.105-.896-2-2-2zM18.433 10.604c-2.574-2.641-6.433-6.604-6.433-6.604s-3.859 3.963-6.433 6.604c-.349.363-.567.853-.567 1.396 0 1.104.896 2 2 2h10c1.104 0 2-.896 2-2 0-.543-.218-1.033-.567-1.396z\" />",
};
#[cfg(feature = "TiMediaEjectOutline")]
const TI_MEDIA_EJECT_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiMediaFastForward")]
const TI_MEDIA_FAST_FORWARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiMediaPause")]
const TI_MEDIA_PAUSE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8 6c-1.104 0-2 .896-2 2v8c0 1.104.896 2 2 2s2-.896 2-2v-8c0-1.104-.896-2-2-2zM15 6c-1.104 0-2 .896-2 2v8c0 1.104.896 2 2 2s2-.896 2-2v-8c0-1.104-.896-2-2-2z\" />",
};
#[cfg(feature = "TiMediaPauseOutline")]
const TI_MEDIA_PAUSE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8 20c-1.654 0-3-1.346-3-3v-9c0-1.654 1.346-3 3-3s3 1.346 3 3v9c0 1.654-1.346 3-3 3zm0-13c-.552 0-1 .449-1 1v9c0 .551.448 1 1 1s1-.449 1-1v-9c0-.551-.448-1-1-1zM15 20c-1.654 0-3-1.346-3-3v-9c0-1.654 1.346-3 3-3s3 1.346 3 3v9c0 1.654-1.346 3-3 3zm0-13c-.552 0-1 .449-1 1v9c0 .551.448 1 1 1s1-.449 1-1v-9c0-.551-.448-1-1-1z\" />",
};
#[cfg(feature = "TiMediaPlay")]
const TI_MEDIA_PLAY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10.396 18.433c2.641-2.574 6.604-6.433 6.604-6.433s-3.963-3.859-6.604-6.433c-.363-.349-.853-.567-1.396-.567-1.104 0-2 .896-2 2v10c0 1.104.896 2 2 2 .543 0 1.033-.218 1.396-.567z\" />",
};
#[cfg(feature = "TiMediaPlayOutline")]
const TI_MEDIA_PLAY_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8.998 7.002l.085.078 5.051 4.92-5.096 4.964-.038.036-.002-9.998m.002-2.002c-1.104 0-2 .896-2 2v10c0 1.104.896 2 2 2 .543 0 1.033-.218 1.393-.568 2.644-2.573 6.607-6.432 6.607-6.432s-3.963-3.859-6.604-6.433c-.363-.349-.853-.567-1.396-.567z\" />",
};
#[cfg(feature = "TiMediaPlayReverse")]
const TI_MEDIA_PLAY_REVERSE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M14 19c1.1 0 2-.9 2-2v-10c0-1.1-.9-2-2-2-.5 0-1 .2-1.4.6-2.6 2.5-6.6 6.4-6.6 6.4s4 3.9 6.6 6.4c.4.4.9.6 1.4.6z\" />",
};
#[cfg(feature = "TiMediaPlayReverseOutline")]
const TI_MEDIA_PLAY_REVERSE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M14 7v10l-5.1-5 5.1-5m-1.4-1.4c-2.6 2.5-6.6 6.4-6.6 6.4s4 3.9 6.6 6.4c.4.4.9.6 1.4.6 1.1 0 2-.9 2-2v-10c0-1.1-.9-2-2-2-.5 0-1 .2-1.4.6z\" />",
};
#[cfg(feature = "TiMediaRecord")]
const TI_MEDIA_RECORD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 12c0-1.657-.672-3.157-1.757-4.243-1.086-1.085-2.586-1.757-4.243-1.757-1.656 0-3.156.672-4.242 1.757-1.086 1.086-1.758 2.586-1.758 4.243 0 1.656.672 3.156 1.758 4.242s2.586 1.758 4.242 1.758c1.657 0 3.157-.672 4.243-1.758 1.085-1.086 1.757-2.586 1.757-4.242z\" />",
};
#[cfg(feature = "TiMediaRecordOutline")]
const TI_MEDIA_RECORD_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 8c2.205 0 4 1.794 4 4s-1.795 4-4 4-4-1.794-4-4 1.795-4 4-4m0-2c-3.314 0-6 2.686-6 6 0 3.312 2.686 6 6 6 3.312 0 6-2.688 6-6 0-3.314-2.688-6-6-6z\" />",
};
#[cfg(feature = "TiMediaRewind")]
const TI_MEDIA_REWIND: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10.2 6.4c-.488 0-.931.197-1.253.512-2.381 2.315-5.947 5.789-5.947 5.789l5.944 5.789c.326.315.768.51 1.256.51.994 0 1.8-.805 1.8-1.799v-9c0-.994-.806-1.801-1.8-1.801zM19.2 6.4c-.488 0-.931.197-1.253.512-2.381 2.315-5.947 5.789-5.947 5.789l5.944 5.789c.326.315.768.51 1.256.51.994 0 1.8-.805 1.8-1.799v-9c0-.994-.806-1.801-1.8-1.801z\" />",
};
#[cfg(feature = "TiMediaRewindOutline")]
const TI_MEDIA_REWIND_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiMediaStop")]
const TI_MEDIA_STOP: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16 6h-8c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z\" />",
};
#[cfg(feature = "TiMediaStopOutline")]
const TI_MEDIA_STOP_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16 8v8h-8v-8h8m0-2h-8c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z\" />",
};
#[cfg(feature = "TiMessage")]
const TI_MESSAGE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 7c.542 0 1 .458 1 1v7c0 .542-.458 1-1 1h-8.829l-.171.171v-.171h-3c-.542 0-1-.458-1-1v-7c0-.542.458-1 1-1h12m0-2h-12c-1.65 0-3 1.35-3 3v7c0 1.65 1.35 3 3 3h1v3l3-3h8c1.65 0 3-1.35 3-3v-7c0-1.65-1.35-3-3-3z\" />",
};
#[cfg(feature = "TiMessageTyping")]
const TI_MESSAGE_TYPING: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 6h-13c-1.65 0-3 1.35-3 3v7c0 1.65 1.35 3 3 3h1v3l3-3h9c1.65 0 3-1.35 3-3v-7c0-1.65-1.35-3-3-3zm1 10c0 .542-.458 1-1 1h-13c-.542 0-1-.458-1-1v-7c0-.542.458-1 1-1h13c.542 0 1 .458 1 1v7zM7 14.5c-1.104 0-2-.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1zM11.5 14.5c-1.104 0-2-.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1zM16 14.5c-1.104 0-2-.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1z\" />",
};
#[cfg(feature = "TiMessages")]
const TI_MESSAGES: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 7h-3c0-1.65-1.35-3-3-3h-12c-1.65 0-3 1.35-3 3v7c0 1.65 1.35 3 3 3v3l3-3c0 1.65 1.35 3 3 3h8l3 3v-3h1c1.65 0 3-1.35 3-3v-7c0-1.65-1.35-3-3-3zm-18 8c-.542 0-1-.458-1-1v-7c0-.542.458-1 1-1h12c.542 0 1 .458 1 1v1h-6.5c-1.379 0-2.5 1.121-2.5 2.5v4.5h-4zm19 2c0 .542-.458 1-1 1h-12c-.542 0-1-.458-1-1v-6.5c0-.827.673-1.5 1.5-1.5h11.5c.542 0 1 .458 1 1v7z\" />",
};
#[cfg(feature = "TiMicrophone")]
const TI_MICROPHONE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 16c2.206 0 4-1.795 4-4v-6c0-2.206-1.794-4-4-4s-4 1.794-4 4v6c0 2.205 1.794 4 4 4zM19 12v-2c0-.552-.447-1-1-1s-1 .448-1 1v2c0 2.757-2.243 5-5 5s-5-2.243-5-5v-2c0-.552-.447-1-1-1s-1 .448-1 1v2c0 3.52 2.613 6.432 6 6.92v1.08h-3c-.553 0-1 .447-1 1s.447 1 1 1h8c.553 0 1-.447 1-1s-.447-1-1-1h-3v-1.08c3.387-.488 6-3.4 6-6.92z\" />",
};
#[cfg(feature = "TiMicrophoneOutline")]
const TI_MICROPHONE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiMinus")]
const TI_MINUS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 11h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2z\" />",
};
#[cfg(feature = "TiMinusOutline")]
const TI_MINUS_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 16h-12c-1.654 0-3-1.346-3-3s1.346-3 3-3h12c1.654 0 3 1.346 3 3s-1.346 3-3 3zm-12-4c-.551 0-1 .449-1 1s.449 1 1 1h12c.551 0 1-.449 1-1s-.449-1-1-1h-12z\" />",
};
#[cfg(feature = "TiMortarBoard")]
const TI_MORTAR_BOARD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_NEWS: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 4h-18c-1.104 0-2 .896-2 2v12c0 1.104.896 2 2 2h18c1.104 0 2-.896 2-2v-12c0-1.104-.896-2-2-2zm-18 2h8v12h-8v-12zm18 12h-9v-12h9.003l-.003 12zM20 13.5c0-.275-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5v3c0 .275.225.5.5.5h1c.275 0 .5-.225.5-.5v-3zM17 7.5c0-.275-.225-.5-.5-.5h-3c-.275 0-.5.225-.5.5v5c0 .275.225.5.5.5h3c.275 0 .5-.225.5-.5v-5zM18.5 10h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM18.5 12h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM13.5 15h3c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-3c-.275 0-.5.225-.5.5s.225.5.5.5zM16.5 16h-3c-.275 0-.5.225-.5.5s.225.5.5.5h3c.275 0 .5-.225.5-.5s-.225-.5-.5-.5zM18.5 8h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM10 7.5c0-.275-.225-.5-.5-.5h-5c-.275 0-.5.225-.5.5v3c0 .275.225.5.5.5h5c.275 0 .5-.225.5-.5v-3zM9.501 14h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5zM9.501 12h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5zM9.501 16h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5z\" />",
};
#[cfg(feature = "TiNotes")]
const TI_NOTES: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.831 4.059c-.107-.095-.243-.139-.394-.121l-11 1.25c-.249.031-.437.244-.437.496v10.316c-1.654 0-3 1.122-3 2.5s1.346 2.5 3 2.5 3-1.122 3-2.5v-7.609l6-.625v3.734c-1.654 0-3 1.122-3 2.5s1.346 2.5 3 2.5 3-1.122 3-2.5v-12.066c0-.144-.062-.28-.169-.375z\" />",
};
#[cfg(feature = "TiNotesOutline")]
const TI_NOTES_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_PENCIL: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 6.879l-3.879-3.879c-.293-.293-.678-.439-1.061-.439-.384 0-.767.146-1.06.439l-10.939 10.939c-.293.293-.558.727-.75 1.188-.192.463-.311.959-.311 1.373v4.5h4.5c.414 0 .908-.119 1.371-.311.463-.192.896-.457 1.189-.75l10.94-10.939c.293-.293.439-.678.439-1.061 0-.384-.146-.767-.439-1.06zm-15.232 8.182l8.293-8.293 1.232 1.232-8.293 8.293-1.232-1.232zm1.732 3.939h-1.5l-1-1v-1.5c0-.077.033-.305.158-.605.01-.02 2.967 2.938 2.967 2.938-.322.134-.548.167-.625.167zm1.439-.768l-1.232-1.232 8.293-8.293 1.232 1.232-8.293 8.293zm9-9l-3.172-3.172 1.293-1.293 3.17 3.172-1.291 1.293z\" />",
};
#[cfg(feature = "TiPhone")]
const TI_PHONE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiPlug")]
const TI_PLUG: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_PLUS: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 10h-4v-4c0-1.104-.896-2-2-2s-2 .896-2 2l.071 4h-4.071c-1.104 0-2 .896-2 2s.896 2 2 2l4.071-.071-.071 4.071c0 1.104.896 2 2 2s2-.896 2-2v-4.071l4 .071c1.104 0 2-.896 2-2s-.896-2-2-2z\" />",
};
#[cfg(feature = "TiPlusOutline")]
const TI_PLUS_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiPointOfInterest")]
const TI_POINT_OF_INTEREST: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16.5 11c1.93 0 3.5-1.57 3.5-3.5s-1.57-3.5-3.5-3.5-3.5 1.57-3.5 3.5v1.5h-2v-1.5c0-1.93-1.57-3.5-3.5-3.5s-3.5 1.57-3.5 3.5 1.57 3.5 3.5 3.5h1.5v2h-1.5c-1.93 0-3.5 1.57-3.5 3.5s1.57 3.5 3.5 3.5 3.5-1.57 3.5-3.5v-1.5h2v1.5c0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5-1.57-3.5-3.5-3.5h-1.5v-2h1.5zm-1.5-3.5c0-.828.673-1.5 1.5-1.5s1.5.672 1.5 1.5c0 .826-.673 1.5-1.5 1.5h-1.5v-1.5zm-6 9c0 .826-.673 1.5-1.5 1.5s-1.5-.674-1.5-1.5c0-.828.673-1.5 1.5-1.5h1.5v1.5zm0-7.5h-1.5c-.827 0-1.5-.674-1.5-1.5 0-.828.673-1.5 1.5-1.5s1.5.672 1.5 1.5v1.5zm4 4h-2v-2h2v2zm3.5 2c.827 0 1.5.672 1.5 1.5 0 .826-.673 1.5-1.5 1.5s-1.5-.674-1.5-1.5v-1.5h1.5z\" />",
};
#[cfg(feature = "TiPointOfInterestOutline")]
const TI_POINT_OF_INTEREST_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiPuzzle")]
const TI_PUZZLE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_RADAR_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M11.997 4.5c-4.685 0-8.497 3.812-8.497 8.5s3.813 8.5 8.5 8.5c4.688 0 8.5-3.812 8.5-8.5s-3.812-8.5-8.503-8.5zm.003 15c-3.584 0-6.5-2.916-6.5-6.5s2.914-6.5 6.5-6.5c3.584 0 6.5 2.916 6.5 6.5s-2.916 6.5-6.5 6.5zM15.348 12.031l.152-.031h.879c-.383-1.677-1.699-2.995-3.379-3.378v.878c0 .551-.449 1-1 1-.497 0-.892-.371-.969-.846l-.031-.154v-.88c-1.678.382-2.997 1.702-3.38 3.38h.88l.153.031c.476.076.847.472.847.969s-.371.893-.846.969l-.154.031h-.878c.384 1.677 1.702 2.995 3.378 3.379v-.879l.031-.154c.077-.476.472-.846.969-.846s.893.371.969.848l.031.152v.879c1.677-.383 2.996-1.702 3.379-3.379h-.879l-.152-.031c-.477-.076-.848-.472-.848-.969s.371-.893.848-.969zm-.446 2.867c-.264.399-.604.74-1.004 1.002-.256-.81-1.004-1.401-1.897-1.401s-1.642.592-1.898 1.401c-.4-.262-.74-.603-1.003-1.002.81-.256 1.401-1.006 1.401-1.898 0-.895-.592-1.643-1.402-1.898.263-.399.603-.74 1.004-1.002.256.81 1.005 1.401 1.898 1.401.894 0 1.644-.593 1.899-1.403.399.264.74.604 1.002 1.004-.81.256-1.401 1.006-1.401 1.898-.001.893.591 1.643 1.401 1.898z\" />",
};
#[cfg(feature = "TiRefresh")]
const TI_REFRESH: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_RSS_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8 4.999c-1.657 0-3.011 1.344-3.011 3l.005 9c0 2.209 1.793 4 4.002 4l9.003.001c1.655 0 3-1.346 3-3.001.001-7.179-5.819-13-12.999-13zm1.001 14c-1.105.002-2.001-.894-2.001-1.999-.002-1.105.894-2.001 2.001-2.001 1.105-.002 2.001.894 1.999 2.001.002 1.105-.894 2.001-1.999 1.999zm4.499 0c-.829 0-1.5-.671-1.5-1.5 0-1.931-1.57-3.5-3.5-3.5-.829 0-1.5-.671-1.5-1.5s.671-1.5 1.5-1.5c3.584 0 6.5 2.916 6.5 6.5 0 .829-.671 1.5-1.5 1.5zm4 0c-.829 0-1.5-.671-1.5-1.5 0-4.136-3.364-7.5-7.5-7.5-.829 0-1.5-.671-1.5-1.5s.671-1.5 1.5-1.5c5.79 0 10.5 4.71 10.5 10.5 0 .829-.671 1.5-1.5 1.5z\" />",
};
#[cfg(feature = "TiScissors")]
const TI_SCISSORS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_SHOPPING_BAG: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 4h-10c-1.654 0-3 1.346-3 3v11c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3v-11c0-1.654-1.346-3-3-3zm1 14c0 .551-.448 1-1 1h-10c-.552 0-1-.449-1-1v-7.28c.296.174.635.28 1 .28h1.5c0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5h1.5c.365 0 .704-.106 1-.279v7.279zm-8.5-7h5c0 1.378-1.121 2.5-2.5 2.5s-2.5-1.122-2.5-2.5zm8.5-2c0 .551-.448 1-1 1h-10c-.552 0-1-.449-1-1v-2c0-.551.448-1 1-1h10c.552 0 1 .449 1 1v2z\" />",
};
#[cfg(feature = "TiShoppingCart")]
const TI_SHOPPING_CART: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialAtCircular")]
const TI_SOCIAL_AT_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialDribbble")]
const TI_SOCIAL_DRIBBBLE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialFacebook")]
const TI_SOCIAL_FACEBOOK: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M13 10h3v3h-3v7h-3v-7h-3v-3h3v-1.255c0-1.189.374-2.691 1.118-3.512.744-.823 1.673-1.233 2.786-1.233h2.096v3h-2.1c-.498 0-.9.402-.9.899v2.101z\" />",
};
#[cfg(feature = "TiSocialFacebookCircular")]
const TI_SOCIAL_FACEBOOK_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18.354 5.624c-1.75-1.741-3.888-2.624-6.354-2.624-2.489 0-4.633.884-6.373 2.625-1.743 1.741-2.627 3.887-2.627 6.375 0 2.465.883 4.603 2.624 6.354 1.741 1.756 3.886 2.646 6.376 2.646 2.467 0 4.605-.89 6.356-2.643 1.755-1.753 2.644-3.892 2.644-6.357 0-2.488-.89-4.634-2.646-6.376zm-1.412 11.319c-1.137 1.139-2.436 1.788-3.942 1.985v-4.928h2v-2h-2v-1.4c0-.331.269-.6.601-.6h1.399v-2h-1.397c-.742 0-1.361.273-1.857.822-.496.547-.746 1.215-.746 2.008v1.17h-2v2h2v4.93c-1.522-.195-2.826-.845-3.957-1.984-1.375-1.384-2.043-3.002-2.043-4.946 0-1.966.667-3.588 2.042-4.96 1.37-1.373 2.992-2.04 4.958-2.04 1.945 0 3.562.668 4.945 2.043 1.383 1.372 2.055 2.994 2.055 4.957 0 1.941-.673 3.559-2.058 4.943z\" />",
};
#[cfg(feature = "TiSocialFlickr")]
const TI_SOCIAL_FLICKR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M7.5 16c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2zM16.5 8c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z\" />",
};
#[cfg(feature = "TiSocialFlickrCircular")]
const TI_SOCIAL_FLICKR_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialGithub")]
const TI_SOCIAL_GITHUB: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialGooglePlus")]
const TI_SOCIAL_GOOGLE_PLUS: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialInstagram")]
const TI_SOCIAL_INSTAGRAM: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 3h-12c-1.7 0-3 1.3-3 3v12c0 1.7 1.3 3 3 3h12c1.7 0 3-1.3 3-3v-12c0-1.7-1.3-3-3-3zm-6 6c1.7 0 3 1.3 3 3s-1.3 3-3 3-3-1.3-3-3 1.3-3 3-3zm3.8-2c0-.7.6-1.2 1.2-1.2s1.2.6 1.2 1.2-.5 1.2-1.2 1.2-1.2-.5-1.2-1.2zm2.2 12h-12c-.6 0-1-.4-1-1v-6h2c0 2.8 2.2 5 5 5s5-2.2 5-5h2v6c0 .6-.4 1-1 1z\" />",
};
#[cfg(feature = "TiSocialInstagramCircular")]
const TI_SOCIAL_INSTAGRAM_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 3c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 7c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm2.8-2c0-.7.6-1.2 1.2-1.2s1.2.6 1.2 1.2-.5 1.2-1.2 1.2-1.2-.5-1.2-1.2zm-2.8 11c-3.9 0-7-3.1-7-7h3c0 2.2 1.8 4 4 4s4-1.8 4-4h3c0 3.9-3.1 7-7 7z\" />",
};
#[cfg(feature = "TiSocialLastFm")]
const TI_SOCIAL_LAST_FM: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialLinkedin")]
const TI_SOCIAL_LINKEDIN: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M8 19h-3v-10h3v10zm11 0h-3v-5.342c0-1.392-.496-2.085-1.479-2.085-.779 0-1.273.388-1.521 1.165v6.262h-3s.04-9 0-10h2.368l.183 2h.062c.615-1 1.598-1.678 2.946-1.678 1.025 0 1.854.285 2.487 1.001.637.717.954 1.679.954 3.03v5.647z\" />\n<ellipse cx=\"6.5\" cy=\"6.5\" rx=\"1.55\" ry=\"1.5\" />",
};
#[cfg(feature = "TiSocialLinkedinCircular")]
const TI_SOCIAL_LINKEDIN_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialPinterest")]
const TI_SOCIAL_PINTEREST: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialSkype")]
const TI_SOCIAL_SKYPE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialTwitter")]
const TI_SOCIAL_TWITTER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialTwitterCircular")]
const TI_SOCIAL_TWITTER_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialVimeo")]
const TI_SOCIAL_VIMEO: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSocialYoutube")]
const TI_SOCIAL_YOUTUBE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M22.8 8.6c-.2-1.5-.4-2.6-1-3-.6-.5-5.8-.6-9.8-.6s-9.2.1-9.8.6c-.6.4-.8 1.5-1 3s-.2 2.4-.2 3.4 0 1.9.2 3.4.4 2.6 1 3c.6.5 5.8.6 9.8.6 4 0 9.2-.1 9.8-.6.6-.4.8-1.5 1-3s.2-2.4.2-3.4 0-1.9-.2-3.4zm-12.8 7v-7.2l6 3.6-6 3.6z\" />",
};
#[cfg(feature = "TiSocialYoutubeCircular")]
const TI_SOCIAL_YOUTUBE_CIRCULAR: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24px"),
...
#[cfg(feature = "TiSortNumerically")]
const TI_SORT_NUMERICALLY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSpiral")]
const TI_SPIRAL: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_STAR: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M9.362 9.158l-5.268.584c-.19.023-.358.15-.421.343s0 .394.14.521c1.566 1.429 3.919 3.569 3.919 3.569-.002 0-.646 3.113-1.074 5.19-.036.188.032.387.196.506.163.119.373.121.538.028 1.844-1.048 4.606-2.624 4.606-2.624l4.604 2.625c.168.092.378.09.541-.029.164-.119.232-.318.195-.505l-1.071-5.191 3.919-3.566c.14-.131.202-.332.14-.524s-.23-.319-.42-.341c-2.108-.236-5.269-.586-5.269-.586l-2.183-4.83c-.082-.173-.254-.294-.456-.294s-.375.122-.453.294l-2.183 4.83z\" />",
};
#[cfg(feature = "TiStarFullOutline")]
const TI_STAR_FULL_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M3.1 11.3l3.6 3.3-1 4.6c-.1.6.1 1.2.6 1.5.2.2.5.3.8.3.2 0 .4 0 .6-.1 0 0 .1 0 .1-.1l4.1-2.3 4.1 2.3s.1 0 .1.1c.5.2 1.1.2 1.5-.1.5-.3.7-.9.6-1.5l-1-4.6c.4-.3 1-.9 1.6-1.5l1.9-1.7.1-.1c.4-.4.5-1 .3-1.5s-.6-.9-1.2-1h-.1l-4.7-.5-1.9-4.3s0-.1-.1-.1c-.1-.7-.6-1-1.1-1-.5 0-1 .3-1.3.8 0 0 0 .1-.1.1l-1.9 4.3-4.7.5h-.1c-.5.1-1 .5-1.2 1-.1.6 0 1.2.4 1.6z\" />",
};
#[cfg(feature = "TiStarHalf")]
const TI_STAR_HALF: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M11.5 4.3c-.9 1.9-2.2 4.8-2.2 4.8s-3.1.4-5.2.6c-.2 0-.4.2-.4.3-.1.2 0 .4.1.5 1.6 1.4 3.9 3.6 3.9 3.6s-.6 3.1-1.1 5.2c0 .2 0 .4.2.5.2.2.4.2.6.1 1.8-1 4.6-2.6 4.6-2.6v-13.3c-.2 0-.4.2-.5.3z\" />",
};
#[cfg(feature = "TiStarHalfOutline")]
const TI_STAR_HALF_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M3.1 11.3l3.6 3.3-1 4.6c-.1.6.1 1.2.6 1.5.2.2.5.3.8.3.2 0 .4 0 .6-.1 0 0 .1 0 .1-.1l4.1-2.3 4.1 2.3s.1 0 .1.1c.5.2 1.1.2 1.5-.1.5-.3.7-.9.6-1.5l-1-4.6c.4-.3 1-.9 1.6-1.5l1.9-1.7.1-.1c.4-.4.5-1 .3-1.5s-.6-.9-1.2-1h-.1l-4.7-.5-1.9-4.3s0-.1-.1-.1c-.1-.7-.6-1-1.1-1-.5 0-1 .3-1.3.8 0 0 0 .1-.1.1l-1.9 4.3-4.7.5h-.1c-.5.1-1 .5-1.2 1-.1.6 0 1.2.4 1.6zm8.9 5v-10.5l1.7 3.8c.1.3.5.5.8.6l4.2.5-3.1 2.8c-.3.2-.4.6-.3 1 0 .2.5 2.2.8 4.1l-3.6-2.1c-.2-.2-.3-.2-.5-.2z\" />",
};
#[cfg(feature = "TiStarOutline")]
const TI_STAR_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiSupport")]
const TI_SUPPORT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_TABS_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 4h-10c-1.104 0-2 .896-2 2v2h-1c-1.104 0-2 .896-2 2v9c0 1.104.896 2 2 2h9c1.104 0 2-.896 2-2v-1h2c1.104 0 2-.896 2-2v-10c0-1.104-.896-2-2-2zm-13 15v-9h8.5c.275 0 .5.225.5.5v8.5h-9zm13-3h-3v-5.5c0-.827-.673-1.5-1.5-1.5h-5.5v-3h10v10z\" />",
};
#[cfg(feature = "TiTag")]
const TI_TAG: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiThLarge")]
const TI_TH_LARGE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_TH_LIST: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 17h-7c-1.103 0-2 .897-2 2s.897 2 2 2h7c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-7c-1.103 0-2 .897-2 2s.897 2 2 2h7c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-7c-1.103 0-2 .897-2 2s.897 2 2 2h7c1.103 0 2-.897 2-2s-.897-2-2-2z\" />\n<circle cx=\"5\" cy=\"19\" r=\"2.5\" />\n<circle cx=\"5\" cy=\"12\" r=\"2.5\" />\n<circle cx=\"5\" cy=\"5\" r=\"2.5\" />",
};
#[cfg(feature = "TiThListOutline")]
const TI_TH_LIST_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_TH_MENU: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M19 17h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2z\" />",
};
#[cfg(feature = "TiThMenuOutline")]
const TI_TH_MENU_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiThSmall")]
const TI_TH_SMALL: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<circle cx=\"5\" cy=\"19\" r=\"2.5\" />\n<circle cx=\"5\" cy=\"12\" r=\"2.5\" />\n<circle cx=\"5\" cy=\"5\" r=\"2.5\" />\n<circle cx=\"12\" cy=\"19\" r=\"2.5\" />\n<circle cx=\"12\" cy=\"12\" r=\"2.5\" />\n<circle cx=\"12\" cy=\"5\" r=\"2.5\" />\n<circle cx=\"19\" cy=\"19\" r=\"2.5\" />\n<circle cx=\"19\" cy=\"12\" r=\"2.5\" />\n<circle cx=\"19\" cy=\"5\" r=\"2.5\" />",
};
#[cfg(feature = "TiThSmallOutline")]
const TI_TH_SMALL_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M6 16h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM6 9h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM6 2h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM13 16h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM13 9h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM13 2h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM20 16h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM20 9h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2zM20 2h-2c-1.104 0-2 .896-2 2v2c0 1.104.896 2 2 2h2c1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm0 4h-2v-2h2v2z\" />",
};
#[cfg(feature = "TiThermometer")]
const TI_THERMOMETER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiThumbsDown")]
const TI_THUMBS_DOWN: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_TICK: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M16.972 6.251c-.967-.538-2.185-.188-2.72.777l-3.713 6.682-2.125-2.125c-.781-.781-2.047-.781-2.828 0-.781.781-.781 2.047 0 2.828l4 4c.378.379.888.587 1.414.587l.277-.02c.621-.087 1.166-.46 1.471-1.009l5-9c.537-.966.189-2.183-.776-2.72z\" />",
};
#[cfg(feature = "TiTickOutline")]
const TI_TICK_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiTime")]
const TI_TIME: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_TRASH: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M18 7h-1v-1c0-1.104-.896-2-2-2h-7c-1.104 0-2 .896-2 2v1h-1c-.552 0-1 .448-1 1s.448 1 1 1v8c0 2.206 1.794 4 4 4h5c2.206 0 4-1.794 4-4v-8c.552 0 1-.448 1-1s-.448-1-1-1zm-10-1h7v1h-7v-1zm8 11c0 1.104-.896 2-2 2h-5c-1.104 0-2-.896-2-2v-8h9v8zM8.5 10.5c-.275 0-.5.225-.5.5v6c0 .275.225.5.5.5s.5-.225.5-.5v-6c0-.275-.225-.5-.5-.5zM10.5 10.5c-.275 0-.5.225-.5.5v6c0 .275.225.5.5.5s.5-.225.5-.5v-6c0-.275-.225-.5-.5-.5zM12.5 10.5c-.275 0-.5.225-.5.5v6c0 .275.225.5.5.5s.5-.225.5-.5v-6c0-.275-.225-.5-.5-.5zM14.5 10.5c-.275 0-.5.225-.5.5v6c0 .275.225.5.5.5s.5-.225.5-.5v-6c0-.275-.225-.5-.5-.5z\" />",
};
#[cfg(feature = "TiTree")]
const TI_TREE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_UPLOAD_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M20.986 17c0-.105-.004-.211-.038-.316l-2-6c-.093-.276-.302-.483-.56-.594.881-1.175.799-2.847-.269-3.914l-6.119-6.121-6.121 6.121c-1.067 1.067-1.149 2.739-.27 3.914-.256.109-.467.316-.559.594l-2 6c-.034.105-.038.211-.038.316-.012 0-.012 5-.012 5 0 .553.447 1 1 1h16c.553 0 1-.447 1-1 0 0 0-5-.014-5zm-13.693-9.41l4.707-4.707 4.707 4.707c.391.391.391 1.023 0 1.414-.379.377-1.035.377-1.414 0l-2.293-2.293v5.789c0 .552-.448 1-1 1s-1-.448-1-1v-5.789l-2.293 2.293c-.379.377-1.035.377-1.414 0-.391-.391-.391-1.025 0-1.414zm-.572 4.41h2.279v.5c0 1.654 1.346 3 3 3s3-1.346 3-3v-.5h2.279l1.666 5h-13.892l1.668-5zm-1.721 9v-3h14v3h-14z\" />",
};
#[cfg(feature = "TiUser")]
const TI_USER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M17 9c0-1.381-.56-2.631-1.464-3.535-.905-.905-2.155-1.465-3.536-1.465s-2.631.56-3.536 1.465c-.904.904-1.464 2.154-1.464 3.535s.56 2.631 1.464 3.535c.905.905 2.155 1.465 3.536 1.465s2.631-.56 3.536-1.465c.904-.904 1.464-2.154 1.464-3.535zM6 19c0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4-3.75 0-6 2-6 4z\" />",
};
#[cfg(feature = "TiUserAdd")]
const TI_USER_ADD: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_USER_ADD_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 14h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1zM18 17c-.553 0-1-.448-1-1v-6c0-.552.447-1 1-1s1 .448 1 1v6c0 .552-.447 1-1 1zM9 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM9 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z\" />",
};
#[cfg(feature = "TiUserDelete")]
const TI_USER_DELETE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 14h-6c-.553 0-1-.447-1-1s.447-1 1-1h6c.553 0 1 .447 1 1s-.447 1-1 1zM14 9c0 1.381-.56 2.631-1.464 3.535-.905.905-2.155 1.465-3.536 1.465s-2.631-.56-3.536-1.465c-.904-.904-1.464-2.154-1.464-3.535s.56-2.631 1.464-3.535c.905-.905 2.155-1.465 3.536-1.465s2.631.56 3.536 1.465c.904.904 1.464 2.154 1.464 3.535zM9 15c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z\" />",
};
#[cfg(feature = "TiUserDeleteOutline")]
const TI_USER_DELETE_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M21 14h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1zM9 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM9 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z\" />",
};
#[cfg(feature = "TiUserOutline")]
const TI_USER_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM12 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z\" />",
};
#[cfg(feature = "TiVendorAndroid")]
const TI_VENDOR_ANDROID: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M7.1 8h9.799999999999999c.1 0 .1 0 .1-.1-.1-.5-.2-.9-.4-1.3-.4-.9-1.1-1.5-1.9-2l-.4-.2s0-.1.1-.1c.3-.4.6-.8.9-1.3.1-.1.1-.2 0-.3-.1-.1-.2 0-.3.1l-.9 1.3s-.1.1-.1 0c-.8-.3-1.6-.4-2.4-.4-.6 0-1.1.2-1.6.4h-.1l-.9-1.2s0-.1-.1-.1c-.1-.1-.2-.1-.2 0-.1 0-.1.1 0 .2 0 0 0 .1.1.1.2.4.5.8.8 1.2l.1.1h-.1c-.6.3-1.1.7-1.5 1.2-.6.6-1 1.4-1.1 2.3 0 .1 0 .1.1.1zm7.1-2.8c.4 0 .8.3.8.8 0 .4-.3.8-.7.8-.4 0-.8-.3-.8-.8-.1-.4.3-.8.7-.8zm-4.3 0c.4 0 .8.3.8.8 0 .4-.3.8-.7.8-.5 0-.9-.4-.9-.8s.4-.8.8-.8zM5 9c-.5 0-1 .5-1 1v5c0 .5.5 1 1 1s1-.5 1-1v-5c0-.5-.5-1-1-1zM19 9c-.5 0-1 .5-1 1v5c0 .5.5 1 1 1s1-.5 1-1v-5c0-.5-.5-1-1-1zM7 17c0 .5.5 1 1 1h1v3c0 .5.5 1 1 1s1-.5 1-1v-3h2v3c0 .5.5 1 1 1s1-.5 1-1v-3h1c.5 0 1-.5 1-1v-8h-10v8z\" />",
};
#[cfg(feature = "TiVendorApple")]
const TI_VENDOR_APPLE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M11.9 6.6s-.1-1.6.9-3l2.8-1.6s.1 1.6-.9 3l-2.8 1.6zM17.3 12.2c0-1.5.8-2.8 2-3.6l-.9-.9c-.5-.3-1.1-.7-2.4-.7-1.4 0-2.4.9-3.7.9-1.3 0-2.2-.8-3.1-.9-.7 0-1.4 0-2.1.3-.5.2-1.2.7-1.6 1.2-.6.6-1.2 1.9-1.3 3.1-.1 1.2-.1 2.1.2 3.2.2.9.6 1.8 1 2.6.3.6.6 1.2 1 1.8.3.4.7.8 1.1 1.1.3.2.6.4 1 .6.2 0 .5.1.8.1.6-.1 1.6-.9 2.4-1.1.4-.1.8-.1 1.3 0 .7.1 1.4.9 2.2 1 .6.1 1.2 0 1.7-.3.4-.2.7-.5 1-.9.4-.4.7-.9 1-1.3.4-.7.9-1.5 1.1-2.3-1.6-.6-2.7-2.1-2.7-3.9z\" />",
};
#[cfg(feature = "TiVendorMicrosoft")]
const TI_VENDOR_MICROSOFT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10 12.5c0-.3-.2-.5-.5-.5h-6c-.3 0-.5.2-.5.5v5c0 .3.2.5.5.6l6 .7c.3 0 .5-.2.5-.4v-5.9zM11.5 12c-.3 0-.5.2-.5.5v5.9c0 .3.2.5.5.6l9 1c.3 0 .5-.2.5-.4v-7c0-.3-.2-.5-.5-.5l-9-.1zM10 4.7c0-.3-.2-.5-.5-.4l-6 .7c-.3 0-.5.2-.5.5v5c0 .3.2.5.5.5h6c.3 0 .5-.2.5-.5v-5.8zM11.5 4.1c-.3 0-.5.3-.5.6v5.9c0 .3.2.5.5.5h9c.3 0 .5-.2.5-.5v-7c0-.3-.2-.5-.5-.4l-9 .9z\" />",
};
#[cfg(feature = "TiVideo")]
const TI_VIDEO: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiVolumeMute")]
const TI_VOLUME_MUTE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWarning")]
const TI_WARNING: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWeatherNight")]
const TI_WEATHER_NIGHT: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M10.5 20c-.861 0-1.71-.151-2.523-.451l-1.317-.485.89-1.087c1.275-1.56 1.95-3.454 1.95-5.477s-.675-3.917-1.951-5.477l-.89-1.087 1.317-.485c.814-.3 1.663-.451 2.524-.451 4.136 0 7.5 3.364 7.5 7.5s-3.364 7.5-7.5 7.5zm-.509-2.024c.169.016.339.024.509.024 3.032 0 5.5-2.468 5.5-5.5s-2.468-5.5-5.5-5.5c-.17 0-.34.008-.509.024.991 1.645 1.509 3.511 1.509 5.476s-.518 3.831-1.509 5.476z\" />",
};
#[cfg(feature = "TiWeatherPartlySunny")]
const TI_WEATHER_PARTLY_SUNNY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWeatherShower")]
const TI_WEATHER_SHOWER: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWeatherSnow")]
const TI_WEATHER_SNOW: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWeatherSunny")]
const TI_WEATHER_SUNNY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWeatherWindy")]
const TI_WEATHER_WINDY: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
#[cfg(feature = "TiWiFi")]
const TI_WI_FI: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_WORLD: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M12 2c-4.971 0-9 4.029-9 9s4.029 9 9 9 9-4.029 9-9-4.029-9-9-9zm2 2c0 1-.5 2-1.5 2s-1.5 1-1.5 2v3s1 0 1-3c0-.553.447-1 1-1s1 .447 1 1v3c-.552 0-1 .448-1 1s.448 1 1 1c.553 0 1-.448 1-1h1v-2l1 1-1 1c0 3 0 3-2 4 0-1-1-1-3-1v-2l-2-2v-2c-1 0-1 1-1 1l-.561-.561-2.39-2.39c.11-.192.225-.382.35-.564l.523-.678c1.468-1.716 3.644-2.807 6.078-2.807.691 0 1.359.098 2 .262v.738z\" />",
};
#[cfg(feature = "TiWorldOutline")]
const TI_WORLD_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    style: None,
    x: None,
    y: None,
    width: Some("24"),
...
const TI_ZOOM_OUTLINE: icondata_core::IconData = icondata_core::IconData {
    ...
    stroke: None,
    fill: None,
    data: "<path d=\"M14 8c1.656 0 3 1.344 3 3s-1.344 3-3 3-3-1.344-3-3 1.344-3 3-3m0-1c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zM4.195 17.674c0 1.727 1.404 3.131 3.131 3.131.756 0 1.503-.277 2.104-.783l2.397-2.386c.685.227 1.412.364 2.173.364 3.86 0 7-3.141 7-7s-3.14-7-7-7c-3.859 0-7 3.141-7 7 0 .761.136 1.486.364 2.173l-2.245 2.283c-.596.59-.924 1.378-.924 2.218zm6.459-1.694l-2.512 2.511c-.223.187-.504.313-.816.313-.624 0-1.131-.506-1.131-1.131 0-.311.127-.594.332-.797l2.492-2.531c.435.645.99 1.2 1.635 1.635zm3.346.02c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z\" />",
};
impl From<TiIcon> for icondata_core::IconData {
    fn from(icon: TiIcon) -> icondata_core::IconData {
        match icon {
            #[cfg(feature = "TiAdjustBrightness")]
            TiIcon::TiAdjustBrightness => TI_ADJUST_BRIGHTNESS,
            #[cfg(feature = "TiAdjustContrast")]
            TiIcon::TiAdjustContrast => TI_ADJUST_CONTRAST,
            #[cfg(feature = "TiAnchor")]
            TiIcon::TiAnchor => TI_ANCHOR,
            #[cfg(feature = "TiAnchorOutline")]
            TiIcon::TiAnchorOutline => TI_ANCHOR_OUTLINE,
            #[cfg(feature = "TiArchive")]
            TiIcon::TiArchive => TI_ARCHIVE,
            #[cfg(feature = "TiArrowBack")]
            TiIcon::TiArrowBack => TI_ARROW_BACK,
            #[cfg(feature = "TiArrowBackOutline")]
            TiIcon::TiArrowBackOutline => TI_ARROW_BACK_OUTLINE,
            #[cfg(feature = "TiArrowDown")]
            TiIcon::TiArrowDown => TI_ARROW_DOWN,
            #[cfg(feature = "TiArrowDownOutline")]
            TiIcon::TiArrowDownOutline => TI_ARROW_DOWN_OUTLINE,
            #[cfg(feature = "TiArrowDownThick")]
            TiIcon::TiArrowDownThick => TI_ARROW_DOWN_THICK,
            #[cfg(feature = "TiArrowForward")]
            TiIcon::TiArrowForward => TI_ARROW_FORWARD,
            #[cfg(feature = "TiArrowForwardOutline")]
            TiIcon::TiArrowForwardOutline => TI_ARROW_FORWARD_OUTLINE,
            #[cfg(feature = "TiArrowLeft")]
            TiIcon::TiArrowLeft => TI_ARROW_LEFT,
            #[cfg(feature = "TiArrowLeftOutline")]
            TiIcon::TiArrowLeftOutline => TI_ARROW_LEFT_OUTLINE,
            #[cfg(feature = "TiArrowLeftThick")]
            TiIcon::TiArrowLeftThick => TI_ARROW_LEFT_THICK,
            #[cfg(feature = "TiArrowLoop")]
            TiIcon::TiArrowLoop => TI_ARROW_LOOP,
            #[cfg(feature = "TiArrowLoopOutline")]
            TiIcon::TiArrowLoopOutline => TI_ARROW_LOOP_OUTLINE,
            #[cfg(feature = "TiArrowMaximise")]
            TiIcon::TiArrowMaximise => TI_ARROW_MAXIMISE,
            #[cfg(feature = "TiArrowMaximiseOutline")]
            TiIcon::TiArrowMaximiseOutline => TI_ARROW_MAXIMISE_OUTLINE,
            #[cfg(feature = "TiArrowMinimise")]
            TiIcon::TiArrowMinimise => TI_ARROW_MINIMISE,
            #[cfg(feature = "TiArrowMinimiseOutline")]
            TiIcon::TiArrowMinimiseOutline => TI_ARROW_MINIMISE_OUTLINE,
            #[cfg(feature = "TiArrowMove")]
            TiIcon::TiArrowMove => TI_ARROW_MOVE,
            #[cfg(feature = "TiArrowMoveOutline")]
            TiIcon::TiArrowMoveOutline => TI_ARROW_MOVE_OUTLINE,
            #[cfg(feature = "TiArrowRepeat")]
            TiIcon::TiArrowRepeat => TI_ARROW_REPEAT,
            #[cfg(feature = "TiArrowRepeatOutline")]
            TiIcon::TiArrowRepeatOutline => TI_ARROW_REPEAT_OUTLINE,
            #[cfg(feature = "TiArrowRight")]
            TiIcon::TiArrowRight => TI_ARROW_RIGHT,
            #[cfg(feature = "TiArrowRightOutline")]
            TiIcon::TiArrowRightOutline => TI_ARROW_RIGHT_OUTLINE,
            #[cfg(feature = "TiArrowRightThick")]
            TiIcon::TiArrowRightThick => TI_ARROW_RIGHT_THICK,
            #[cfg(feature = "TiArrowShuffle")]
            TiIcon::TiArrowShuffle => TI_ARROW_SHUFFLE,
            #[cfg(feature = "TiArrowSortedDown")]
            TiIcon::TiArrowSortedDown => TI_ARROW_SORTED_DOWN,
            #[cfg(feature = "TiArrowSortedUp")]
            TiIcon::TiArrowSortedUp => TI_ARROW_SORTED_UP,
            #[cfg(feature = "TiArrowSync")]
            TiIcon::TiArrowSync => TI_ARROW_SYNC,
            #[cfg(feature = "TiArrowSyncOutline")]
            TiIcon::TiArrowSyncOutline => TI_ARROW_SYNC_OUTLINE,
            #[cfg(feature = "TiArrowUnsorted")]
            TiIcon::TiArrowUnsorted => TI_ARROW_UNSORTED,
            #[cfg(feature = "TiArrowUp")]
            TiIcon::TiArrowUp => TI_ARROW_UP,
            #[cfg(feature = "TiArrowUpOutline")]
            TiIcon::TiArrowUpOutline => TI_ARROW_UP_OUTLINE,
            #[cfg(feature = "TiArrowUpThick")]
            TiIcon::TiArrowUpThick => TI_ARROW_UP_THICK,
            #[cfg(feature = "TiAt")]
            TiIcon::TiAt => TI_AT,
            #[cfg(feature = "TiAttachment")]
            TiIcon::TiAttachment => TI_ATTACHMENT,
            #[cfg(feature = "TiAttachmentOutline")]
            TiIcon::TiAttachmentOutline => TI_ATTACHMENT_OUTLINE,
            #[cfg(feature = "TiBackspace")]
            TiIcon::TiBackspace => TI_BACKSPACE,
            #[cfg(feature = "TiBackspaceOutline")]
            TiIcon::TiBackspaceOutline => TI_BACKSPACE_OUTLINE,
            #[cfg(feature = "TiBatteryCharge")]
            TiIcon::TiBatteryCharge => TI_BATTERY_CHARGE,
            #[cfg(feature = "TiBatteryFull")]
            TiIcon::TiBatteryFull => TI_BATTERY_FULL,
            #[cfg(feature = "TiBatteryHigh")]
            TiIcon::TiBatteryHigh => TI_BATTERY_HIGH,
            #[cfg(feature = "TiBatteryLow")]
            TiIcon::TiBatteryLow => TI_BATTERY_LOW,
            #[cfg(feature = "TiBatteryMid")]
            TiIcon::TiBatteryMid => TI_BATTERY_MID,
            #[cfg(feature = "TiBeaker")]
            TiIcon::TiBeaker => TI_BEAKER,
            #[cfg(feature = "TiBeer")]
            TiIcon::TiBeer => TI_BEER,
            #[cfg(feature = "TiBell")]
            TiIcon::TiBell => TI_BELL,
            #[cfg(feature = "TiBook")]
            TiIcon::TiBook => TI_BOOK,
            #[cfg(feature = "TiBookmark")]
            TiIcon::TiBookmark => TI_BOOKMARK,
            #[cfg(feature = "TiBriefcase")]
            TiIcon::TiBriefcase => TI_BRIEFCASE,
            #[cfg(feature = "TiBrush")]
            TiIcon::TiBrush => TI_BRUSH,
            #[cfg(feature = "TiBusinessCard")]
            TiIcon::TiBusinessCard => TI_BUSINESS_CARD,
            #[cfg(feature = "TiCalculator")]
            TiIcon::TiCalculator => TI_CALCULATOR,
            #[cfg(feature = "TiCalendar")]
            TiIcon::TiCalendar => TI_CALENDAR,
            #[cfg(feature = "TiCalendarOutline")]
            TiIcon::TiCalendarOutline => TI_CALENDAR_OUTLINE,
            #[cfg(feature = "TiCamera")]
            TiIcon::TiCamera => TI_CAMERA,
            #[cfg(feature = "TiCameraOutline")]
            TiIcon::TiCameraOutline => TI_CAMERA_OUTLINE,
            #[cfg(feature = "TiCancel")]
            TiIcon::TiCancel => TI_CANCEL,
            #[cfg(feature = "TiCancelOutline")]
            TiIcon::TiCancelOutline => TI_CANCEL_OUTLINE,
            #[cfg(feature = "TiChartArea")]
            TiIcon::TiChartArea => TI_CHART_AREA,
            #[cfg(feature = "TiChartAreaOutline")]
            TiIcon::TiChartAreaOutline => TI_CHART_AREA_OUTLINE,
            #[cfg(feature = "TiChartBar")]
            TiIcon::TiChartBar => TI_CHART_BAR,
            #[cfg(feature = "TiChartBarOutline")]
            TiIcon::TiChartBarOutline => TI_CHART_BAR_OUTLINE,
            #[cfg(feature = "TiChartLine")]
            TiIcon::TiChartLine => TI_CHART_LINE,
            #[cfg(feature = "TiChartLineOutline")]
            TiIcon::TiChartLineOutline => TI_CHART_LINE_OUTLINE,
            #[cfg(feature = "TiChartPie")]
            TiIcon::TiChartPie => TI_CHART_PIE,
            #[cfg(feature = "TiChartPieOutline")]
            TiIcon::TiChartPieOutline => TI_CHART_PIE_OUTLINE,
            #[cfg(feature = "TiChevronLeft")]
            TiIcon::TiChevronLeft => TI_CHEVRON_LEFT,
            #[cfg(feature = "TiChevronLeftOutline")]
            TiIcon::TiChevronLeftOutline => TI_CHEVRON_LEFT_OUTLINE,
            #[cfg(feature = "TiChevronRight")]
            TiIcon::TiChevronRight => TI_CHEVRON_RIGHT,
            #[cfg(feature = "TiChevronRightOutline")]
            TiIcon::TiChevronRightOutline => TI_CHEVRON_RIGHT_OUTLINE,
            #[cfg(feature = "TiClipboard")]
            TiIcon::TiClipboard => TI_CLIPBOARD,
            #[cfg(feature = "TiCloudStorage")]
            TiIcon::TiCloudStorage => TI_CLOUD_STORAGE,
            #[cfg(feature = "TiCloudStorageOutline")]
            TiIcon::TiCloudStorageOutline => TI_CLOUD_STORAGE_OUTLINE,
            #[cfg(feature = "TiCode")]
            TiIcon::TiCode => TI_CODE,
            #[cfg(feature = "TiCodeOutline")]
            TiIcon::TiCodeOutline => TI_CODE_OUTLINE,
            #[cfg(feature = "TiCoffee")]
            TiIcon::TiCoffee => TI_COFFEE,
            #[cfg(feature = "TiCog")]
            TiIcon::TiCog => TI_COG,
            #[cfg(feature = "TiCogOutline")]
            TiIcon::TiCogOutline => TI_COG_OUTLINE,
            #[cfg(feature = "TiCompass")]
            TiIcon::TiCompass => TI_COMPASS,
            #[cfg(feature = "TiContacts")]
            TiIcon::TiContacts => TI_CONTACTS,
            #[cfg(feature = "TiCreditCard")]
            TiIcon::TiCreditCard => TI_CREDIT_CARD,
            #[cfg(feature = "TiCss3")]
            TiIcon::TiCss3 => TI_CSS3,
            #[cfg(feature = "TiDatabase")]
            TiIcon::TiDatabase => TI_DATABASE,
            #[cfg(feature = "TiDelete")]
            TiIcon::TiDelete => TI_DELETE,
            #[cfg(feature = "TiDeleteOutline")]
            TiIcon::TiDeleteOutline => TI_DELETE_OUTLINE,
            #[cfg(feature = "TiDeviceDesktop")]
            TiIcon::TiDeviceDesktop => TI_DEVICE_DESKTOP,
            #[cfg(feature = "TiDeviceLaptop")]
            TiIcon::TiDeviceLaptop => TI_DEVICE_LAPTOP,
            #[cfg(feature = "TiDevicePhone")]
            TiIcon::TiDevicePhone => TI_DEVICE_PHONE,
            #[cfg(feature = "TiDeviceTablet")]
            TiIcon::TiDeviceTablet => TI_DEVICE_TABLET,
            #[cfg(feature = "TiDirections")]
            TiIcon::TiDirections => TI_DIRECTIONS,
            #[cfg(feature = "TiDivide")]
            TiIcon::TiDivide => TI_DIVIDE,
            #[cfg(feature = "TiDivideOutline")]
            TiIcon::TiDivideOutline => TI_DIVIDE_OUTLINE,
            #[cfg(feature = "TiDocument")]
            TiIcon::TiDocument => TI_DOCUMENT,
            #[cfg(feature = "TiDocumentAdd")]
            TiIcon::TiDocumentAdd => TI_DOCUMENT_ADD,
            #[cfg(feature = "TiDocumentDelete")]
            TiIcon::TiDocumentDelete => TI_DOCUMENT_DELETE,
            #[cfg(feature = "TiDocumentText")]
            TiIcon::TiDocumentText => TI_DOCUMENT_TEXT,
            #[cfg(feature = "TiDownload")]
            TiIcon::TiDownload => TI_DOWNLOAD,
            #[cfg(feature = "TiDownloadOutline")]
            TiIcon::TiDownloadOutline => TI_DOWNLOAD_OUTLINE,
            #[cfg(feature = "TiDropbox")]
            TiIcon::TiDropbox => TI_DROPBOX,
            #[cfg(feature = "TiEdit")]
            TiIcon::TiEdit => TI_EDIT,
            #[cfg(feature = "TiEject")]
            TiIcon::TiEject => TI_EJECT,
            #[cfg(feature = "TiEjectOutline")]
            TiIcon::TiEjectOutline => TI_EJECT_OUTLINE,
            #[cfg(feature = "TiEquals")]
            TiIcon::TiEquals => TI_EQUALS,
            #[cfg(feature = "TiEqualsOutline")]
            TiIcon::TiEqualsOutline => TI_EQUALS_OUTLINE,
            #[cfg(feature = "TiExport")]
            TiIcon::TiExport => TI_EXPORT,
            #[cfg(feature = "TiExportOutline")]
            TiIcon::TiExportOutline => TI_EXPORT_OUTLINE,
            #[cfg(feature = "TiEye")]
            TiIcon::TiEye => TI_EYE,
            #[cfg(feature = "TiEyeOutline")]
            TiIcon::TiEyeOutline => TI_EYE_OUTLINE,
            #[cfg(feature = "TiFeather")]
            TiIcon::TiFeather => TI_FEATHER,
            #[cfg(feature = "TiFilm")]
            TiIcon::TiFilm => TI_FILM,
            #[cfg(feature = "TiFilter")]
            TiIcon::TiFilter => TI_FILTER,
            #[cfg(feature = "TiFlag")]
            TiIcon::TiFlag => TI_FLAG,
            #[cfg(feature = "TiFlagOutline")]
            TiIcon::TiFlagOutline => TI_FLAG_OUTLINE,
            #[cfg(feature = "TiFlash")]
            TiIcon::TiFlash => TI_FLASH,
            #[cfg(feature = "TiFlashOutline")]
            TiIcon::TiFlashOutline => TI_FLASH_OUTLINE,
            #[cfg(feature = "TiFlowChildren")]
            TiIcon::TiFlowChildren => TI_FLOW_CHILDREN,
            #[cfg(feature = "TiFlowMerge")]
            TiIcon::TiFlowMerge => TI_FLOW_MERGE,
            #[cfg(feature = "TiFlowParallel")]
            TiIcon::TiFlowParallel => TI_FLOW_PARALLEL,
            #[cfg(feature = "TiFlowSwitch")]
            TiIcon::TiFlowSwitch => TI_FLOW_SWITCH,
            #[cfg(feature = "TiFolder")]
            TiIcon::TiFolder => TI_FOLDER,
            #[cfg(feature = "TiFolderAdd")]
            TiIcon::TiFolderAdd => TI_FOLDER_ADD,
            #[cfg(feature = "TiFolderDelete")]
            TiIcon::TiFolderDelete => TI_FOLDER_DELETE,
            #[cfg(feature = "TiFolderOpen")]
            TiIcon::TiFolderOpen => TI_FOLDER_OPEN,
            #[cfg(feature = "TiGift")]
            TiIcon::TiGift => TI_GIFT,
            #[cfg(feature = "TiGlobe")]
            TiIcon::TiGlobe => TI_GLOBE,
            #[cfg(feature = "TiGlobeOutline")]
            TiIcon::TiGlobeOutline => TI_GLOBE_OUTLINE,
            #[cfg(feature = "TiGroup")]
            TiIcon::TiGroup => TI_GROUP,
            #[cfg(feature = "TiGroupOutline")]
            TiIcon::TiGroupOutline => TI_GROUP_OUTLINE,
            #[cfg(feature = "TiHeadphones")]
            TiIcon::TiHeadphones => TI_HEADPHONES,
            #[cfg(feature = "TiHeart")]
            TiIcon::TiHeart => TI_HEART,
            #[cfg(feature = "TiHeartFullOutline")]
            TiIcon::TiHeartFullOutline => TI_HEART_FULL_OUTLINE,
            #[cfg(feature = "TiHeartHalfOutline")]
            TiIcon::TiHeartHalfOutline => TI_HEART_HALF_OUTLINE,
            #[cfg(feature = "TiHeartOutline")]
            TiIcon::TiHeartOutline => TI_HEART_OUTLINE,
            #[cfg(feature = "TiHome")]
            TiIcon::TiHome => TI_HOME,
            #[cfg(feature = "TiHomeOutline")]
            TiIcon::TiHomeOutline => TI_HOME_OUTLINE,
            #[cfg(feature = "TiHtml5")]
            TiIcon::TiHtml5 => TI_HTML5,
            #[cfg(feature = "TiImage")]
            TiIcon::TiImage => TI_IMAGE,
            #[cfg(feature = "TiImageOutline")]
            TiIcon::TiImageOutline => TI_IMAGE_OUTLINE,
            #[cfg(feature = "TiInfinity")]
            TiIcon::TiInfinity => TI_INFINITY,
            #[cfg(feature = "TiInfinityOutline")]
            TiIcon::TiInfinityOutline => TI_INFINITY_OUTLINE,
            #[cfg(feature = "TiInfo")]
            TiIcon::TiInfo => TI_INFO,
            #[cfg(feature = "TiInfoLarge")]
            TiIcon::TiInfoLarge => TI_INFO_LARGE,
            #[cfg(feature = "TiInfoLargeOutline")]
            TiIcon::TiInfoLargeOutline => TI_INFO_LARGE_OUTLINE,
            #[cfg(feature = "TiInfoOutline")]
            TiIcon::TiInfoOutline => TI_INFO_OUTLINE,
            #[cfg(feature = "TiInputChecked")]
            TiIcon::TiInputChecked => TI_INPUT_CHECKED,
            #[cfg(feature = "TiInputCheckedOutline")]
            TiIcon::TiInputCheckedOutline => TI_INPUT_CHECKED_OUTLINE,
            #[cfg(feature = "TiKey")]
            TiIcon::TiKey => TI_KEY,
            #[cfg(feature = "TiKeyOutline")]
            TiIcon::TiKeyOutline => TI_KEY_OUTLINE,
            #[cfg(feature = "TiKeyboard")]
            TiIcon::TiKeyboard => TI_KEYBOARD,
            #[cfg(feature = "TiLeaf")]
            TiIcon::TiLeaf => TI_LEAF,
            #[cfg(feature = "TiLightbulb")]
            TiIcon::TiLightbulb => TI_LIGHTBULB,
            #[cfg(feature = "TiLink")]
            TiIcon::TiLink => TI_LINK,
            #[cfg(feature = "TiLinkOutline")]
            TiIcon::TiLinkOutline => TI_LINK_OUTLINE,
            #[cfg(feature = "TiLocation")]
            TiIcon::TiLocation => TI_LOCATION,
            #[cfg(feature = "TiLocationArrow")]
            TiIcon::TiLocationArrow => TI_LOCATION_ARROW,
            #[cfg(feature = "TiLocationArrowOutline")]
            TiIcon::TiLocationArrowOutline => TI_LOCATION_ARROW_OUTLINE,
            #[cfg(feature = "TiLocationOutline")]
            TiIcon::TiLocationOutline => TI_LOCATION_OUTLINE,
            #[cfg(feature = "TiLockClosed")]
            TiIcon::TiLockClosed => TI_LOCK_CLOSED,
            #[cfg(feature = "TiLockClosedOutline")]
            TiIcon::TiLockClosedOutline => TI_LOCK_CLOSED_OUTLINE,
            #[cfg(feature = "TiLockOpen")]
            TiIcon::TiLockOpen => TI_LOCK_OPEN,
            #[cfg(feature = "TiLockOpenOutline")]
            TiIcon::TiLockOpenOutline => TI_LOCK_OPEN_OUTLINE,
            #[cfg(feature = "TiMail")]
            TiIcon::TiMail => TI_MAIL,
            #[cfg(feature = "TiMap")]
            TiIcon::TiMap => TI_MAP,
            #[cfg(feature = "TiMediaEject")]
            TiIcon::TiMediaEject => TI_MEDIA_EJECT,
            #[cfg(feature = "TiMediaEjectOutline")]
            TiIcon::TiMediaEjectOutline => TI_MEDIA_EJECT_OUTLINE,
            #[cfg(feature = "TiMediaFastForward")]
            TiIcon::TiMediaFastForward => TI_MEDIA_FAST_FORWARD,
            #[cfg(feature = "TiMediaFastForwardOutline")]
            TiIcon::TiMediaFastForwardOutline => TI_MEDIA_FAST_FORWARD_OUTLINE,
            #[cfg(feature = "TiMediaPause")]
            TiIcon::TiMediaPause => TI_MEDIA_PAUSE,
            #[cfg(feature = "TiMediaPauseOutline")]
            TiIcon::TiMediaPauseOutline => TI_MEDIA_PAUSE_OUTLINE,
            #[cfg(feature = "TiMediaPlay")]
            TiIcon::TiMediaPlay => TI_MEDIA_PLAY,
            #[cfg(feature = "TiMediaPlayOutline")]
            TiIcon::TiMediaPlayOutline => TI_MEDIA_PLAY_OUTLINE,
            #[cfg(feature = "TiMediaPlayReverse")]
            TiIcon::TiMediaPlayReverse => TI_MEDIA_PLAY_REVERSE,
            #[cfg(feature = "TiMediaPlayReverseOutline")]
            TiIcon::TiMediaPlayReverseOutline => TI_MEDIA_PLAY_REVERSE_OUTLINE,
            #[cfg(feature = "TiMediaRecord")]
            TiIcon::TiMediaRecord => TI_MEDIA_RECORD,
            #[cfg(feature = "TiMediaRecordOutline")]
            TiIcon::TiMediaRecordOutline => TI_MEDIA_RECORD_OUTLINE,
            #[cfg(feature = "TiMediaRewind")]
            TiIcon::TiMediaRewind => TI_MEDIA_REWIND,
            #[cfg(feature = "TiMediaRewindOutline")]
            TiIcon::TiMediaRewindOutline => TI_MEDIA_REWIND_OUTLINE,
            #[cfg(feature = "TiMediaStop")]
            TiIcon::TiMediaStop => TI_MEDIA_STOP,
            #[cfg(feature = "TiMediaStopOutline")]
            TiIcon::TiMediaStopOutline => TI_MEDIA_STOP_OUTLINE,
            #[cfg(feature = "TiMessage")]
            TiIcon::TiMessage => TI_MESSAGE,
            #[cfg(feature = "TiMessageTyping")]
            TiIcon::TiMessageTyping => TI_MESSAGE_TYPING,
            #[cfg(feature = "TiMessages")]
            TiIcon::TiMessages => TI_MESSAGES,
            #[cfg(feature = "TiMicrophone")]
            TiIcon::TiMicrophone => TI_MICROPHONE,
            #[cfg(feature = "TiMicrophoneOutline")]
            TiIcon::TiMicrophoneOutline => TI_MICROPHONE_OUTLINE,
            #[cfg(feature = "TiMinus")]
            TiIcon::TiMinus => TI_MINUS,
            #[cfg(feature = "TiMinusOutline")]
            TiIcon::TiMinusOutline => TI_MINUS_OUTLINE,
            #[cfg(feature = "TiMortarBoard")]
            TiIcon::TiMortarBoard => TI_MORTAR_BOARD,
            #[cfg(feature = "TiNews")]
            TiIcon::TiNews => TI_NEWS,
            #[cfg(feature = "TiNotes")]
            TiIcon::TiNotes => TI_NOTES,
            #[cfg(feature = "TiNotesOutline")]
            TiIcon::TiNotesOutline => TI_NOTES_OUTLINE,
            #[cfg(feature = "TiPen")]
            TiIcon::TiPen => TI_PEN,
            #[cfg(feature = "TiPencil")]
            TiIcon::TiPencil => TI_PENCIL,
            #[cfg(feature = "TiPhone")]
            TiIcon::TiPhone => TI_PHONE,
            #[cfg(feature = "TiPhoneOutline")]
            TiIcon::TiPhoneOutline => TI_PHONE_OUTLINE,
            #[cfg(feature = "TiPi")]
            TiIcon::TiPi => TI_PI,
            #[cfg(feature = "TiPiOutline")]
            TiIcon::TiPiOutline => TI_PI_OUTLINE,
            #[cfg(feature = "TiPin")]
            TiIcon::TiPin => TI_PIN,
            #[cfg(feature = "TiPinOutline")]
            TiIcon::TiPinOutline => TI_PIN_OUTLINE,
            #[cfg(feature = "TiPipette")]
            TiIcon::TiPipette => TI_PIPETTE,
            #[cfg(feature = "TiPlane")]
            TiIcon::TiPlane => TI_PLANE,
            #[cfg(feature = "TiPlaneOutline")]
            TiIcon::TiPlaneOutline => TI_PLANE_OUTLINE,
            #[cfg(feature = "TiPlug")]
            TiIcon::TiPlug => TI_PLUG,
            #[cfg(feature = "TiPlus")]
            TiIcon::TiPlus => TI_PLUS,
            #[cfg(feature = "TiPlusOutline")]
            TiIcon::TiPlusOutline => TI_PLUS_OUTLINE,
            #[cfg(feature = "TiPointOfInterest")]
            TiIcon::TiPointOfInterest => TI_POINT_OF_INTEREST,
            #[cfg(feature = "TiPointOfInterestOutline")]
            TiIcon::TiPointOfInterestOutline => TI_POINT_OF_INTEREST_OUTLINE,
            #[cfg(feature = "TiPower")]
            TiIcon::TiPower => TI_POWER,
            #[cfg(feature = "TiPowerOutline")]
            TiIcon::TiPowerOutline => TI_POWER_OUTLINE,
            #[cfg(feature = "TiPrinter")]
            TiIcon::TiPrinter => TI_PRINTER,
            #[cfg(feature = "TiPuzzle")]
            TiIcon::TiPuzzle => TI_PUZZLE,
            #[cfg(feature = "TiPuzzleOutline")]
            TiIcon::TiPuzzleOutline => TI_PUZZLE_OUTLINE,
            #[cfg(feature = "TiRadar")]
            TiIcon::TiRadar => TI_RADAR,
            #[cfg(feature = "TiRadarOutline")]
            TiIcon::TiRadarOutline => TI_RADAR_OUTLINE,
            #[cfg(feature = "TiRefresh")]
            TiIcon::TiRefresh => TI_REFRESH,
            #[cfg(feature = "TiRefreshOutline")]
            TiIcon::TiRefreshOutline => TI_REFRESH_OUTLINE,
            #[cfg(feature = "TiRss")]
            TiIcon::TiRss => TI_RSS,
            #[cfg(feature = "TiRssOutline")]
            TiIcon::TiRssOutline => TI_RSS_OUTLINE,
            #[cfg(feature = "TiScissors")]
            TiIcon::TiScissors => TI_SCISSORS,
            #[cfg(feature = "TiScissorsOutline")]
            TiIcon::TiScissorsOutline => TI_SCISSORS_OUTLINE,
            #[cfg(feature = "TiShoppingBag")]
            TiIcon::TiShoppingBag => TI_SHOPPING_BAG,
            #[cfg(feature = "TiShoppingCart")]
            TiIcon::TiShoppingCart => TI_SHOPPING_CART,
            #[cfg(feature = "TiSocialAtCircular")]
            TiIcon::TiSocialAtCircular => TI_SOCIAL_AT_CIRCULAR,
            #[cfg(feature = "TiSocialDribbble")]
            TiIcon::TiSocialDribbble => TI_SOCIAL_DRIBBBLE,
            #[cfg(feature = "TiSocialDribbbleCircular")]
            TiIcon::TiSocialDribbbleCircular => TI_SOCIAL_DRIBBBLE_CIRCULAR,
            #[cfg(feature = "TiSocialFacebook")]
            TiIcon::TiSocialFacebook => TI_SOCIAL_FACEBOOK,
            #[cfg(feature = "TiSocialFacebookCircular")]
            TiIcon::TiSocialFacebookCircular => TI_SOCIAL_FACEBOOK_CIRCULAR,
            #[cfg(feature = "TiSocialFlickr")]
            TiIcon::TiSocialFlickr => TI_SOCIAL_FLICKR,
            #[cfg(feature = "TiSocialFlickrCircular")]
            TiIcon::TiSocialFlickrCircular => TI_SOCIAL_FLICKR_CIRCULAR,
            #[cfg(feature = "TiSocialGithub")]
            TiIcon::TiSocialGithub => TI_SOCIAL_GITHUB,
            #[cfg(feature = "TiSocialGithubCircular")]
            TiIcon::TiSocialGithubCircular => TI_SOCIAL_GITHUB_CIRCULAR,
            #[cfg(feature = "TiSocialGooglePlus")]
            TiIcon::TiSocialGooglePlus => TI_SOCIAL_GOOGLE_PLUS,
            #[cfg(feature = "TiSocialGooglePlusCircular")]
            TiIcon::TiSocialGooglePlusCircular => TI_SOCIAL_GOOGLE_PLUS_CIRCULAR,
            #[cfg(feature = "TiSocialInstagram")]
            TiIcon::TiSocialInstagram => TI_SOCIAL_INSTAGRAM,
            #[cfg(feature = "TiSocialInstagramCircular")]
            TiIcon::TiSocialInstagramCircular => TI_SOCIAL_INSTAGRAM_CIRCULAR,
            #[cfg(feature = "TiSocialLastFm")]
            TiIcon::TiSocialLastFm => TI_SOCIAL_LAST_FM,
            #[cfg(feature = "TiSocialLastFmCircular")]
            TiIcon::TiSocialLastFmCircular => TI_SOCIAL_LAST_FM_CIRCULAR,
            #[cfg(feature = "TiSocialLinkedin")]
            TiIcon::TiSocialLinkedin => TI_SOCIAL_LINKEDIN,
            #[cfg(feature = "TiSocialLinkedinCircular")]
            TiIcon::TiSocialLinkedinCircular => TI_SOCIAL_LINKEDIN_CIRCULAR,
            #[cfg(feature = "TiSocialPinterest")]
            TiIcon::TiSocialPinterest => TI_SOCIAL_PINTEREST,
            #[cfg(feature = "TiSocialPinterestCircular")]
            TiIcon::TiSocialPinterestCircular => TI_SOCIAL_PINTEREST_CIRCULAR,
            #[cfg(feature = "TiSocialSkype")]
            TiIcon::TiSocialSkype => TI_SOCIAL_SKYPE,
            #[cfg(feature = "TiSocialSkypeOutline")]
            TiIcon::TiSocialSkypeOutline => TI_SOCIAL_SKYPE_OUTLINE,
            #[cfg(feature = "TiSocialTumbler")]
            TiIcon::TiSocialTumbler => TI_SOCIAL_TUMBLER,
            #[cfg(feature = "TiSocialTumblerCircular")]
            TiIcon::TiSocialTumblerCircular => TI_SOCIAL_TUMBLER_CIRCULAR,
            #[cfg(feature = "TiSocialTwitter")]
            TiIcon::TiSocialTwitter => TI_SOCIAL_TWITTER,
            #[cfg(feature = "TiSocialTwitterCircular")]
            TiIcon::TiSocialTwitterCircular => TI_SOCIAL_TWITTER_CIRCULAR,
            #[cfg(feature = "TiSocialVimeo")]
            TiIcon::TiSocialVimeo => TI_SOCIAL_VIMEO,
            #[cfg(feature = "TiSocialVimeoCircular")]
            TiIcon::TiSocialVimeoCircular => TI_SOCIAL_VIMEO_CIRCULAR,
            #[cfg(feature = "TiSocialYoutube")]
            TiIcon::TiSocialYoutube => TI_SOCIAL_YOUTUBE,
            #[cfg(feature = "TiSocialYoutubeCircular")]
            TiIcon::TiSocialYoutubeCircular => TI_SOCIAL_YOUTUBE_CIRCULAR,
            #[cfg(feature = "TiSortAlphabetically")]
            TiIcon::TiSortAlphabetically => TI_SORT_ALPHABETICALLY,
            #[cfg(feature = "TiSortAlphabeticallyOutline")]
            TiIcon::TiSortAlphabeticallyOutline => TI_SORT_ALPHABETICALLY_OUTLINE,
            #[cfg(feature = "TiSortNumerically")]
            TiIcon::TiSortNumerically => TI_SORT_NUMERICALLY,
            #[cfg(feature = "TiSortNumericallyOutline")]
            TiIcon::TiSortNumericallyOutline => TI_SORT_NUMERICALLY_OUTLINE,
            #[cfg(feature = "TiSpanner")]
            TiIcon::TiSpanner => TI_SPANNER,
            #[cfg(feature = "TiSpannerOutline")]
            TiIcon::TiSpannerOutline => TI_SPANNER_OUTLINE,
            #[cfg(feature = "TiSpiral")]
            TiIcon::TiSpiral => TI_SPIRAL,
            #[cfg(feature = "TiStar")]
            TiIcon::TiStar => TI_STAR,
            #[cfg(feature = "TiStarFullOutline")]
            TiIcon::TiStarFullOutline => TI_STAR_FULL_OUTLINE,
            #[cfg(feature = "TiStarHalf")]
            TiIcon::TiStarHalf => TI_STAR_HALF,
            #[cfg(feature = "TiStarHalfOutline")]
            TiIcon::TiStarHalfOutline => TI_STAR_HALF_OUTLINE,
            #[cfg(feature = "TiStarOutline")]
            TiIcon::TiStarOutline => TI_STAR_OUTLINE,
            #[cfg(feature = "TiStarburst")]
            TiIcon::TiStarburst => TI_STARBURST,
            #[cfg(feature = "TiStarburstOutline")]
            TiIcon::TiStarburstOutline => TI_STARBURST_OUTLINE,
            #[cfg(feature = "TiStopwatch")]
            TiIcon::TiStopwatch => TI_STOPWATCH,
            #[cfg(feature = "TiSupport")]
            TiIcon::TiSupport => TI_SUPPORT,
            #[cfg(feature = "TiTabsOutline")]
            TiIcon::TiTabsOutline => TI_TABS_OUTLINE,
            #[cfg(feature = "TiTag")]
            TiIcon::TiTag => TI_TAG,
            #[cfg(feature = "TiTags")]
            TiIcon::TiTags => TI_TAGS,
            #[cfg(feature = "TiThLarge")]
            TiIcon::TiThLarge => TI_TH_LARGE,
            #[cfg(feature = "TiThLargeOutline")]
            TiIcon::TiThLargeOutline => TI_TH_LARGE_OUTLINE,
            #[cfg(feature = "TiThList")]
            TiIcon::TiThList => TI_TH_LIST,
            #[cfg(feature = "TiThListOutline")]
            TiIcon::TiThListOutline => TI_TH_LIST_OUTLINE,
            #[cfg(feature = "TiThMenu")]
            TiIcon::TiThMenu => TI_TH_MENU,
            #[cfg(feature = "TiThMenuOutline")]
            TiIcon::TiThMenuOutline => TI_TH_MENU_OUTLINE,
            #[cfg(feature = "TiThSmall")]
            TiIcon::TiThSmall => TI_TH_SMALL,
            #[cfg(feature = "TiThSmallOutline")]
            TiIcon::TiThSmallOutline => TI_TH_SMALL_OUTLINE,
            #[cfg(feature = "TiThermometer")]
            TiIcon::TiThermometer => TI_THERMOMETER,
            #[cfg(feature = "TiThumbsDown")]
            TiIcon::TiThumbsDown => TI_THUMBS_DOWN,
            #[cfg(feature = "TiThumbsOk")]
            TiIcon::TiThumbsOk => TI_THUMBS_OK,
            #[cfg(feature = "TiThumbsUp")]
            TiIcon::TiThumbsUp => TI_THUMBS_UP,
            #[cfg(feature = "TiTick")]
            TiIcon::TiTick => TI_TICK,
            #[cfg(feature = "TiTickOutline")]
            TiIcon::TiTickOutline => TI_TICK_OUTLINE,
            #[cfg(feature = "TiTicket")]
            TiIcon::TiTicket => TI_TICKET,
            #[cfg(feature = "TiTime")]
            TiIcon::TiTime => TI_TIME,
            #[cfg(feature = "TiTimes")]
            TiIcon::TiTimes => TI_TIMES,
            #[cfg(feature = "TiTimesOutline")]
            TiIcon::TiTimesOutline => TI_TIMES_OUTLINE,
            #[cfg(feature = "TiTrash")]
            TiIcon::TiTrash => TI_TRASH,
            #[cfg(feature = "TiTree")]
            TiIcon::TiTree => TI_TREE,
            #[cfg(feature = "TiUpload")]
            TiIcon::TiUpload => TI_UPLOAD,
            #[cfg(feature = "TiUploadOutline")]
            TiIcon::TiUploadOutline => TI_UPLOAD_OUTLINE,
            #[cfg(feature = "TiUser")]
            TiIcon::TiUser => TI_USER,
            #[cfg(feature = "TiUserAdd")]
            TiIcon::TiUserAdd => TI_USER_ADD,
            #[cfg(feature = "TiUserAddOutline")]
            TiIcon::TiUserAddOutline => TI_USER_ADD_OUTLINE,
            #[cfg(feature = "TiUserDelete")]
            TiIcon::TiUserDelete => TI_USER_DELETE,
            #[cfg(feature = "TiUserDeleteOutline")]
            TiIcon::TiUserDeleteOutline => TI_USER_DELETE_OUTLINE,
            #[cfg(feature = "TiUserOutline")]
            TiIcon::TiUserOutline => TI_USER_OUTLINE,
            #[cfg(feature = "TiVendorAndroid")]
            TiIcon::TiVendorAndroid => TI_VENDOR_ANDROID,
            #[cfg(feature = "TiVendorApple")]
            TiIcon::TiVendorApple => TI_VENDOR_APPLE,
            #[cfg(feature = "TiVendorMicrosoft")]
            TiIcon::TiVendorMicrosoft => TI_VENDOR_MICROSOFT,
            #[cfg(feature = "TiVideo")]
            TiIcon::TiVideo => TI_VIDEO,
            #[cfg(feature = "TiVideoOutline")]
            TiIcon::TiVideoOutline => TI_VIDEO_OUTLINE,
            #[cfg(feature = "TiVolume")]
            TiIcon::TiVolume => TI_VOLUME,
            #[cfg(feature = "TiVolumeDown")]
            TiIcon::TiVolumeDown => TI_VOLUME_DOWN,
            #[cfg(feature = "TiVolumeMute")]
            TiIcon::TiVolumeMute => TI_VOLUME_MUTE,
            #[cfg(feature = "TiVolumeUp")]
            TiIcon::TiVolumeUp => TI_VOLUME_UP,
            #[cfg(feature = "TiWarning")]
            TiIcon::TiWarning => TI_WARNING,
            #[cfg(feature = "TiWarningOutline")]
            TiIcon::TiWarningOutline => TI_WARNING_OUTLINE,
            #[cfg(feature = "TiWatch")]
            TiIcon::TiWatch => TI_WATCH,
            #[cfg(feature = "TiWaves")]
            TiIcon::TiWaves => TI_WAVES,
            #[cfg(feature = "TiWavesOutline")]
            TiIcon::TiWavesOutline => TI_WAVES_OUTLINE,
            #[cfg(feature = "TiWeatherCloudy")]
            TiIcon::TiWeatherCloudy => TI_WEATHER_CLOUDY,
            #[cfg(feature = "TiWeatherDownpour")]
            TiIcon::TiWeatherDownpour => TI_WEATHER_DOWNPOUR,
            #[cfg(feature = "TiWeatherNight")]
            TiIcon::TiWeatherNight => TI_WEATHER_NIGHT,
            #[cfg(feature = "TiWeatherPartlySunny")]
            TiIcon::TiWeatherPartlySunny => TI_WEATHER_PARTLY_SUNNY,
            #[cfg(feature = "TiWeatherShower")]
            TiIcon::TiWeatherShower => TI_WEATHER_SHOWER,
            #[cfg(feature = "TiWeatherSnow")]
            TiIcon::TiWeatherSnow => TI_WEATHER_SNOW,
            #[cfg(feature = "TiWeatherStormy")]
            TiIcon::TiWeatherStormy => TI_WEATHER_STORMY,
            #[cfg(feature = "TiWeatherSunny")]
            TiIcon::TiWeatherSunny => TI_WEATHER_SUNNY,
            #[cfg(feature = "TiWeatherWindy")]
            TiIcon::TiWeatherWindy => TI_WEATHER_WINDY,
            #[cfg(feature = "TiWeatherWindyCloudy")]
            TiIcon::TiWeatherWindyCloudy => TI_WEATHER_WINDY_CLOUDY,
            #[cfg(feature = "TiWiFi")]
            TiIcon::TiWiFi => TI_WI_FI,
            #[cfg(feature = "TiWiFiOutline")]
            TiIcon::TiWiFiOutline => TI_WI_FI_OUTLINE,
            #[cfg(feature = "TiWine")]
            TiIcon::TiWine => TI_WINE,
            #[cfg(feature = "TiWorld")]
            TiIcon::TiWorld => TI_WORLD,
            #[cfg(feature = "TiWorldOutline")]
            TiIcon::TiWorldOutline => TI_WORLD_OUTLINE,
            #[cfg(feature = "TiZoom")]
            TiIcon::TiZoom => TI_ZOOM,
            #[cfg(feature = "TiZoomIn")]
            TiIcon::TiZoomIn => TI_ZOOM_IN,
            #[cfg(feature = "TiZoomInOutline")]
            TiIcon::TiZoomInOutline => TI_ZOOM_IN_OUTLINE,
            #[cfg(feature = "TiZoomOut")]
            TiIcon::TiZoomOut => TI_ZOOM_OUT,
            #[cfg(feature = "TiZoomOutOutline")]
            TiIcon::TiZoomOutOutline => TI_ZOOM_OUT_OUTLINE,
            #[cfg(feature = "TiZoomOutline")]
            TiIcon::TiZoomOutline => TI_ZOOM_OUTLINE,
        }
    }
}
