    ...
    match icon {
        ...
        Icon::CgAbstract => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAbstract"
                .to_owned()) } < / title > < path d = "M5 5H19V19H16L16 8H5V5Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M10 19C12.7614 19 15 16.7614 15 14C15 11.2386 12.7614 9 10 9C7.23858 9 5 11.2386 5 14C5 16.7614 7.23858 19 10 19ZM10 16C11.1046 16 12 15.1046 12 14C12 12.8954 11.1046 12 10 12C8.89543 12 8 12.8954 8 14C8 15.1046 8.89543 16 10 16Z"
        ...
        Icon::CgAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAdd"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgAddR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAddR"
                .to_owned()) } < / title > < path d =
                "M12 6C12.5523 6 13 6.44772 13 7V11H17C17.5523 11 18 11.4477 18 12C18 12.5523 17.5523 13 17 13H13V17C13 17.5523 12.5523 18 12 18C11.4477 18 11 17.5523 11 17V13H7C6.44772 13 6 12.5523 6 12C6 11.4477 6.44772 11 7 11H11V7C11 6.44772 11.4477 6 12 6Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 22C3.34315 22 2 20.6569 2 19V5C2 3.34315 3.34315 2 5 2H19C20.6569 2 22 3.34315 22 5V19C22 20.6569 20.6569 22 19 22H5ZM4 19C4 19.5523 4.44772 20 5 20H19C19.5523 20 20 19.5523 20 19V5C20 4.44772 19.5523 4 19 4H5C4.44772 4 4 4.44772 4 5V19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAdidas => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAdidas"
                .to_owned()) } < / title > < path d =
                ...
                "currentColor" /> < path d =
                "M23.2687 19H17.4952L10.8557 7.5L15.1858 5L23.2687 19Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAirplane => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAirplane"
                .to_owned()) } < / title > < path d =
                "M9.00967 5.12761H11.0097C12.1142 5.12761 13.468 5.89682 14.0335 6.8457L16.5089 11H21.0097C21.562 11 22.0097 11.4477 22.0097 12C22.0097 12.5523 21.562 13 21.0097 13H16.4138L13.9383 17.1543C13.3729 18.1032 12.0191 18.8724 10.9145 18.8724H8.91454L12.4138 13H5.42485L3.99036 15.4529H1.99036L4.00967 12L4.00967 11.967L2.00967 8.54712H4.00967L5.44417 11H12.5089L9.00967 5.12761Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlarm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlarm"
                .to_owned()) } < / title > < path d =
                "M5.45887 2L1 6.01478L2.33826 7.50107L6.79713 3.48629L5.45887 2Z" fill =
                "currentColor" /> < path d = "M11 8H13V12H16V14H11V8Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgAlbum => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlbum"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 19C2 20.6569 3.34315 22 5 22H19C20.6569 22 22 20.6569 22 19V5C22 3.34315 20.6569 2 19 2H5C3.34315 2 2 3.34315 2 5V19ZM20 19C20 19.5523 19.5523 20 19 20H5C4.44772 20 4 19.5523 4 19V5C4 4.44772 4.44772 4 5 4H10V12.0111L12.395 12.0112L14.0001 9.86419L15.6051 12.0112H18.0001L18 4H19C19.5523 4 20 4.44772 20 5V19ZM16 4H12V9.33585L14.0001 6.66046L16 9.33571V4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlignBottom => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignBottom"
                .to_owned()) } < / title > < path d = "M13 10H17V16H13V10Z" fill =
                "currentColor" fill - opacity = "0.5" /> < path d = "M11 4H7V16H11V4Z"
                fill = "currentColor" /> < path d = "M18 18H6V20H18V18Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlignCenter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignCenter"
                .to_owned()) } < / title > < path d = "M9 13H15V17H9V13Z" fill =
                "currentColor" fill - opacity = "0.5" /> < path d = "M6 7H18V11H6V7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlignLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignLeft"
                .to_owned()) } < / title > < path d = "M8 13H14V17H8V13Z" fill =
                "currentColor" fill - opacity = "0.5" /> < path d = "M6 6H4V18H6V6Z" fill
                = "currentColor" /> < path d = "M20 7H8V11H20V7Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlignMiddle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignMiddle"
                .to_owned()) } < / title > < path d = "M13 9H17V15H13V9Z" fill =
                "currentColor" fill - opacity = "0.5" /> < path d = "M7 6H11V18H7V6Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgAlignRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignRight"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M15.9991 13.0039L9.99907 12.9911L9.99054 16.9911L15.9905 17.0039L15.9991 13.0039Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path fill - rule =
        ...
        Icon::CgAlignTop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAlignTop"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgAnchor => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAnchor"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrangeBack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrangeBack"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 3H11V7H17V13H21V21H13V17H7V11H3V3ZM15 13H13V15H9V11H11V9H15V13Z" fill
                = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrangeFront => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrangeFront"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 3H11V7H17V13H21V21H13V17H7V11H3V3ZM15 9H9V15H15V9Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowAlignH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowAlignH"
                .to_owned()) } < / title > < path d = "M13 7H11V17H13V7Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgArrowAlignV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowAlignV"
                .to_owned()) } < / title > < path d = "M7 11L7 13H17V11H7Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgArrowBottomLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowBottomLeftO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomLeftO".to_owned()) } < / title > < path d =
                "M10 10.0367L8.00002 10.0367L8 16.0367L14 16.0367L14 14.0367L11.4143 14.0366L16.7438 8.7071L15.3296 7.29289L10 12.6224L10 10.0367Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowBottomLeftR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomLeftR".to_owned()) } < / title > < path d =
                "M10 10.0367H8V16.0367H14V14.0367H11.4142L16.7438 8.70712L15.3296 7.2929L10 12.6225V10.0367Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowBottomRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowBottomRightO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomRightO".to_owned()) } < / title > < path d =
                "M14.0367 10.0367H16.0367V16.0367H10.0367V14.0367H12.6225L7.29297 8.70713L8.70718 7.29291L14.0367 12.6225L14.0367 10.0367Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgArrowBottomRightR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowBottomRightR".to_owned()) } < / title > < path d =
                "M14.0367 10.0367H16.0367V16.0367H10.0367V14.0367H12.6225L7.29297 8.70713L8.70718 7.29292L14.0367 12.6225L14.0367 10.0367Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgArrowDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowDown"
                .to_owned()) } < / title > < path d =
                "M11.0001 3.67157L13.0001 3.67157L13.0001 16.4999L16.2426 13.2574L17.6568 14.6716L12 20.3284L6.34314 14.6716L7.75735 13.2574L11.0001 16.5001L11.0001 3.67157Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowDownO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowDownO"
                .to_owned()) } < / title > < path d =
                "M14.8285 12.0259L16.2427 13.4402L12 17.6828L7.7574 13.4402L9.17161 12.0259L11 13.8544V6.31724H13V13.8544L14.8285 12.0259Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M19.7782 19.7782C15.4824 24.0739 8.51759 24.0739 4.22183 19.7782C-0.0739417 15.4824 -0.0739417 8.51759 4.22183 4.22183C8.51759 -0.0739419 15.4824 -0.0739419 19.7782 4.22183C24.0739 8.51759 24.0739 15.4824 19.7782 19.7782ZM18.364 18.364C14.8492 21.8787 9.15076 21.8787 5.63604 18.364C2.12132 14.8492 2.12132 9.15076 5.63604 5.63604C9.15076 2.12132 14.8492 2.12132 18.364 5.63604C21.8787 9.15076 21.8787 14.8492 18.364 18.364Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowDownR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowDownR"
                .to_owned()) } < / title > < path d =
                "M14.8284 12.0259L16.2426 13.4402L12 17.6828L7.75733 13.4402L9.17155 12.0259L11 13.8544V6.31724H13V13.8544L14.8284 12.0259Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgArrowLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLeft"
                .to_owned()) } < / title > < path d =
                "M20.3284 11.0001V13.0001L7.50011 13.0001L10.7426 16.2426L9.32842 17.6568L3.67157 12L9.32842 6.34314L10.7426 7.75735L7.49988 11.0001L20.3284 11.0001Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowLeftO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLeftO"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLeftR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLeftR"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongDown"
                .to_owned()) } < / title > < path d =
                "M13.0125 19.162L14.8246 17.3398L16.2427 18.7501L12.012 23.0046L7.75726 18.7739L9.16751 17.3557L11.0126 19.1905L10.998 0.997021L12.998 0.995422L13.0125 19.162Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowLongDownC => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongDownC".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongDownE => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongDownE".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongDownL => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongDownL".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongDownR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongDownR".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongLeft"
                .to_owned()) } < / title > < path d =
                "M1.02698 11.9929L5.26242 16.2426L6.67902 14.8308L4.85766 13.0033L22.9731 13.0012L22.9728 11.0012L4.85309 11.0033L6.6886 9.17398L5.27677 7.75739L1.02698 11.9929Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowLongLeftC => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongLeftC".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongLeftE => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongLeftE".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongLeftL => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongLeftL".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongLeftR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongLeftR".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M4.64872 7.72528L0.398926 11.9608L4.63443 16.2105L6.05103 14.7987L4.23673 12.9783L16.1027 13.019L19.3585 16.2747L23.6011 12.0321L19.3585 7.78945L16.1289 11.019L4.21801 10.9782L6.06055 9.14188L4.64872 7.72528ZM17.9443 12.0321L19.3585 10.6179L20.7727 12.0321L19.3585 13.4463L17.9443 12.0321Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowLongRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongRightC => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongRightC".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongRightE => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongRightE".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongRightL => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongRightL".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongRightR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowLongRightR".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowLongUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongUp"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongUpC => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongUpC"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowLongUpE => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongUpE"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowLongUpL => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongUpL"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowLongUpR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowLongUpR"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowRight"
                .to_owned()) } < / title > < path d =
                "M15.0378 6.34317L13.6269 7.76069L16.8972 11.0157L3.29211 11.0293L3.29413 13.0293L16.8619 13.0157L13.6467 16.2459L15.0643 17.6568L20.7079 11.9868L15.0378 6.34317Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowRightO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowRightO"
                .to_owned()) } < / title > < path d =
                "M12.0519 14.8285L13.4661 16.2427L17.7088 12L13.4661 7.7574L12.0519 9.17161L13.8804 11H6.34321V13H13.8803L12.0519 14.8285Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M19.7782 19.7782C24.0739 15.4824 24.0739 8.51759 19.7782 4.22183C15.4824 -0.0739417 8.51759 -0.0739417 4.22183 4.22183C-0.0739417 8.51759 -0.0739417 15.4824 4.22183 19.7782C8.51759 24.0739 15.4824 24.0739 19.7782 19.7782ZM18.364 18.364C21.8787 14.8492 21.8787 9.15076 18.364 5.63604C14.8492 2.12132 9.15076 2.12132 5.63604 5.63604C2.12132 9.15076 2.12132 14.8492 5.63604 18.364C9.15076 21.8787 14.8492 21.8787 18.364 18.364Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowRightR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowRightR"
                .to_owned()) } < / title > < path d =
                "M12.0519 14.8285L13.4661 16.2427L17.7087 12L13.4661 7.7574L12.0519 9.17161L13.8803 11H6.34318V13H13.8803L12.0519 14.8285Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowTopLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowTopLeft"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowTopLeftO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowTopLeftO"
                .to_owned()) } < / title > < path d =
                "M10 13.9633H8V7.96331H14V9.96331H11.4142L16.7438 15.2929L15.3296 16.7071L10 11.3775L10 13.9633Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowTopLeftR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowTopLeftR"
                .to_owned()) } < / title > < path d =
                "M10 13.9633H8V7.96331H14V9.96331H11.4142L16.7438 15.2929L15.3296 16.7071L10 11.3775L10 13.9633Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgArrowTopRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowTopRight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowTopRightO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowTopRightO".to_owned()) } < / title > < path d =
                "M14 13.9633H16V7.96331H10V9.96331H12.5858L7.25623 15.2929L8.67044 16.7071L14 11.3775L14 13.9633Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12ZM3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowTopRightR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowTopRightR".to_owned()) } < / title > < path d =
                "M14 13.9633H16V7.96331H10V9.96331H12.5858L7.25623 15.2929L8.67044 16.7071L14 11.3775V13.9633Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M23 19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19ZM19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgArrowUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowUp"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowUpO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowUpO"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowUpR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowUpR"
                .to_owned()) } < / title > < path d =
                "M14.8543 11.9741L16.2686 10.5599L12.0259 6.31724L7.78327 10.5599L9.19749 11.9741L11.0259 10.1457V17.6828H13.0259V10.1457L14.8543 11.9741Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 19C1 21.2091 2.79086 23 5 23H19C21.2091 23 23 21.2091 23 19V5C23 2.79086 21.2091 1 19 1H5C2.79086 1 1 2.79086 1 5V19ZM5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgArrowsBreakeH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsBreakeH"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsBreakeV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsBreakeV"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExchange => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExchange".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExchangeAlt => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExchangeAlt".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExchangeAltV => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExchangeAltV".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExchangeV => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExchangeV".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExpandDownLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandDownLeft".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowsExpandDownRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandDownRight".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgArrowsExpandLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExpandLeftAlt => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandLeftAlt".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExpandRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandRight".to_owned()) } < / title > < path d =
                "M13.8995 4.10052V2.10052H21.8995V10.1005H19.8995V5.51477L14.1213 11.293L12.7071 9.87878L18.4854 4.10052H13.8995Z"
                fill = "currentColor" /> < path d =
                "M4.10046 13.8995H2.10046V21.8995H10.1005V19.8995H5.51468L11.2929 14.1212L9.87872 12.707L4.10046 18.4853V13.8995Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsExpandRightAlt => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandRightAlt".to_owned()) } < / title > < path d =
                "M13.8995 2.10052V4.10052H18.4852L12.707 9.87878L14.1212 11.293L19.8995 5.51471V10.1005H21.8995V2.10052H13.8995Z"
                fill = "currentColor" /> < path d =
                "M5.51468 19.8995H10.1005V21.8995H2.10046V13.8995H4.10046V18.4853L9.87872 12.707L11.2929 14.1213L5.51468 19.8995Z"
                fill = "currentColor" /> < path d =
                "M9.17154 7.75739L7.75732 9.1716L14.8284 16.2427L16.2426 14.8285L9.17154 7.75739Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsExpandUpLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandUpLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsExpandUpRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsExpandUpRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsH"
                .to_owned()) } < / title > < path d =
                "M5.65698 9.17157L4.24276 7.75735L0.00012207 12L4.24276 16.2426L5.65698 14.8284L3.82858 13H10.0001V11H3.82851L5.65698 9.17157Z"
                fill = "currentColor" /> < path d =
                "M14.0001 11V13H20.1716L18.3432 14.8284L19.7574 16.2426L24.0001 12L19.7574 7.75735L18.3432 9.17157L20.1717 11H14.0001Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsHAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsHAlt"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsMergeAltH => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsMergeAltH".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsMergeAltV => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgArrowsMergeAltV".to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsScrollH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsScrollH"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsScrollV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsScrollV"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgArrowsShrinkH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsShrinkH"
                .to_owned()) } < / title > < path d = "M1 7H3V17H1V7Z" fill =
                "currentColor" /> < path d =
                ...
                fill = "currentColor" /> < path d = "M23 7H21V17H23V7Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsShrinkV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsShrinkV"
                .to_owned()) } < / title > < path d = "M17 1V3L7 3V1L17 1Z" fill =
                "currentColor" /> < path d =
                ...
                fill = "currentColor" /> < path d = "M17 23V21H7V23H17Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsV"
                .to_owned()) } < / title > < path d =
                "M7.75739 5.04077L9.1716 6.45498L11.0001 4.62652V10H13.0001V4.62661L14.8284 6.45498L16.2426 5.04077L12 0.798126L7.75739 5.04077Z"
                fill = "currentColor" /> < path d =
                "M16.2426 18.9593L14.8284 17.545L13.0001 19.3734V14H11.0001V19.3735L9.1716 17.545L7.75739 18.9593L12 23.2019L16.2426 18.9593Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgArrowsVAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgArrowsVAlt"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgAssign => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAssign"
                .to_owned()) } < / title > < path d = "M6 6H10V4H4V10H6V6Z" fill =
                "currentColor" /> < path d = "M10 18H6V14H4V20H10V18Z" fill =
                "currentColor" /> < path d = "M14 6H18V10H20V4H14V6Z" fill =
                "currentColor" /> < path d = "M14 18H18V14H20V20H14V18Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgAsterisk => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAsterisk"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgAtlasian => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAtlasian"
                .to_owned()) } < / title > < path opacity = "0.8" d =
        ...
        Icon::CgAttachment => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAttachment"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgAttribution => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAttribution"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgAwards => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgAwards"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBackspace => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBackspace"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgBandAid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBandAid"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M13.8737 15.0805C13.6403 15.581 13.0453 15.7976 12.5447 15.5642C12.0442 15.3308 11.8276 14.7358 12.061 14.2352C12.2944 13.7347 12.8894 13.5181 13.39 13.7516C13.8905 13.985 14.1071 14.5799 13.8737 15.0805Z"
                fill = "currentColor" /> < path d =
                "M14.2352 11.9389C14.7357 12.1723 15.3307 11.9558 15.5641 11.4552C15.7975 10.9547 15.581 10.3597 15.0804 10.1263C14.5799 9.89292 13.9849 10.1095 13.7515 10.61C13.5181 11.1106 13.7347 11.7055 14.2352 11.9389Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M17.0714 1.12432C14.0682 -0.276119 10.4983 1.02321 9.09783 4.02645L4.02641 14.9021C2.62598 17.9054 3.92531 21.4753 6.92855 22.8757C9.93179 24.2761 13.5017 22.9768 14.9021 19.9736L19.9735 9.09787C21.374 6.09463 20.0746 2.52475 17.0714 1.12432ZM13.9347 17.3157L17.3157 10.0653L10.0652 6.6843L6.68427 13.9348L13.9347 17.3157ZM13.0895 19.1283L5.83903 15.7474C4.90541 17.7495 5.77163 20.1295 7.77379 21.0631C9.77595 21.9967 12.1559 21.1305 13.0895 19.1283ZM16.2262 2.93693C18.2283 3.87055 19.0945 6.25047 18.1609 8.25264L10.9104 4.87169C11.8441 2.86953 14.224 2.00331 16.2262 2.93693Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBattery => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBattery"
                .to_owned()) } < / title > < path d =
                "M6 15C5.44772 15 5 14.5523 5 14V10C5 9.44772 5.44772 9 6 9H12V15H6Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBatteryEmpty => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBatteryEmpty"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M18 6H5C3.34315 6 2 7.34315 2 9V15C2 16.6569 3.34315 18 5 18H18C19.6569 18 21 16.6569 21 15C21.5523 15 22 14.5523 22 14V10C22 9.44772 21.5523 9 21 9C21 7.34315 19.6569 6 18 6ZM18 8H5C4.44772 8 4 8.44772 4 9V15C4 15.5523 4.44772 16 5 16H18C18.5523 16 19 15.5523 19 15V9C19 8.44772 18.5523 8 18 8Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgBatteryFull => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBatteryFull"
                .to_owned()) } < / title > < path d =
                "M6 15C5.44772 15 5 14.5523 5 14V10C5 9.44772 5.44772 9 6 9H17C17.5523 9 18 9.44772 18 10V14C18 14.5523 17.5523 15 17 15H6Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M18 6H5C3.34315 6 2 7.34315 2 9V15C2 16.6569 3.34315 18 5 18H18C19.6569 18 21 16.6569 21 15C21.5523 15 22 14.5523 22 14V10C22 9.44772 21.5523 9 21 9C21 7.34315 19.6569 6 18 6ZM18 8H5C4.44772 8 4 8.44772 4 9V15C4 15.5523 4.44772 16 5 16H18C18.5523 16 19 15.5523 19 15V9C19 8.44772 18.5523 8 18 8Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgBell => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBell"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBitbucket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBitbucket"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBlock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBlock"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgBmw => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBmw"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12ZM5 12C5 15.866 8.13401 19 12 19V12H19C19 8.13401 15.866 5 12 5V12H5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBoard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBoard"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBolt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBolt"
                .to_owned()) } < / title > < path d =
                "M9 21.5L17.5 13L13 10L15 2.5L6.5 11L11 14L9 21.5Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBookmark => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBookmark"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M19 20H17.1717L12.7072 15.5354C12.3166 15.1449 11.6835 15.1449 11.2929 15.5354L6.82843 20L5 20V7C5 5.34315 6.34315 4 8 4H16C17.6569 4 19 5.34314 19 7V20ZM17 7C17 6.44772 16.5523 6 16 6H8C7.44772 6 7 6.44772 7 7V17L9.87873 14.1212C11.0503 12.9497 12.9498 12.9497 14.1214 14.1212L17 16.9999V7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBorderAll => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBorderAll"
                .to_owned()) } < / title > < path d = "M6.5 6.5H17.5V17.5H6.5V6.5Z"
        ...
        Icon::CgBorderBottom => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBorderBottom"
                .to_owned()) } < / title > < path d = "M8 8H16V15H19V5H5V15H8V8Z" fill =
                "currentColor" fill - opacity = "0.3" /> < path d = "M5 17H19V20H5V17Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBorderLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBorderLeft"
                .to_owned()) } < / title > < path d = "M16 8V16H9L9 19H19L19 5L9 5V8H16Z"
                fill = "currentColor" fill - opacity = "0.3" /> < path d =
                "M7 5L7 19H4L4 5L7 5Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgBorderRight")]
        Icon::CgBorderRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBorderRight"
                .to_owned()) } < / title > < path d = "M8 16V8H15V5L5 5L5 19H15L15 16H8Z"
                fill = "currentColor" fill - opacity = "0.3" /> < path d =
                "M17 19L17 5L20 5L20 19H17Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgBorderStyleDashed")]
        Icon::CgBorderStyleDashed => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgBorderStyleDashed".to_owned()) } < / title > < path d =
                "M4 11H8V13H4V11Z" fill = "currentColor" /> < path d =
                "M10 11H14V13H10V11Z" fill = "currentColor" /> < path d =
                "M20 11H16V13H20V11Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgBorderStyleDotted")]
        Icon::CgBorderStyleDotted => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgBorderStyleDotted".to_owned()) } < / title > < path d =
                "M3 11H1V13H3V11Z" fill = "currentColor" /> < path d = "M7 11H5V13H7V11Z"
                fill = "currentColor" /> < path d = "M9 11H11V13H9V11Z" fill =
                "currentColor" /> < path d = "M15 11H13V13H15V11Z" fill = "currentColor"
                /> < path d = "M17 11H19V13H17V11Z" fill = "currentColor" /> < path d =
                "M23 11H21V13H23V11Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgBorderStyleSolid")]
        Icon::CgBorderStyleSolid => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgBorderStyleSolid".to_owned()) } < / title > < path d =
                "M2 11H22V13H2V11Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgBorderTop")]
        Icon::CgBorderTop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBorderTop"
                .to_owned()) } < / title > < path d =
                "M8 16H16V9L19 9L19 19L5 19L5 9L8 9V16Z" fill = "currentColor" fill -
                opacity = "0.3" /> < path d = "M5 7L19 7V4L5 4L5 7Z" fill = "#110000" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBot => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBot"
                .to_owned()) } < / title > < path d =
                "M14.1254 13H10.1254V15H14.1254V13Z" fill = "currentColor" /> < path fill
                ...
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2.74884 14.6663C3.73056 16.6421 5.76939 18 8.12537 18H16.1254C18.5654 18 20.6652 16.5435 21.6029 14.4525C22.3722 13.9093 22.8746 13.0133 22.8746 12C22.8746 10.9867 22.3722 10.0907 21.6029 9.54753C20.6652 7.45651 18.5654 6 16.1254 6H8.12537C5.76939 6 3.73056 7.3579 2.74884 9.33375C1.78448 9.83263 1.12537 10.8393 1.12537 12C1.12537 13.1607 1.78448 14.1674 2.74884 14.6663ZM8.12537 8H16.1254C17.5088 8 18.7282 8.70234 19.4465 9.76991C19.7227 10.4593 19.8746 11.2119 19.8746 12C19.8746 12.7881 19.7227 13.5407 19.4465 14.2301C18.7282 15.2977 17.5088 16 16.1254 16H8.12537C5.91623 16 4.12537 14.2091 4.12537 12C4.12537 9.79086 5.91623 8 8.12537 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBox"
                .to_owned()) } < / title > < path d =
                "M10 12C9.44769 12 9 12.4477 9 13C9 13.5523 9.44769 14 10 14H14C14.5522 14 15 13.5523 15 13C15 12.4477 14.5522 12 14 12H10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 2C2.34314 2 1 3.34314 1 5V19C1 20.6569 2.34314 22 4 22H20C21.6569 22 23 20.6569 23 19V5C23 3.34314 21.6569 2 20 2H4ZM20 4H4C3.44769 4 3 4.44769 3 5V8H21V5C21 4.44769 20.5522 4 20 4ZM3 19V10H21V19C21 19.5523 20.5522 20 20 20H4C3.44769 20 3 19.5523 3 19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBoy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBoy"
                .to_owned()) } < / title > < path d =
                "M9 14C9.55228 14 10 13.5523 10 13C10 12.4477 9.55228 12 9 12C8.44771 12 8 12.4477 8 13C8 13.5523 8.44771 14 9 14Z"
                fill = "currentColor" /> < path d =
                "M16 13C16 13.5523 15.5523 14 15 14C14.4477 14 14 13.5523 14 13C14 12.4477 14.4477 12 15 12C15.5523 12 16 12.4477 16 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBrackets => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBrackets"
                .to_owned()) } < / title > < path d = "M11 7V9H9V15H11V17H7V7H11Z" fill =
                "currentColor" /> < path d = "M15 15H13V17H17V7H13V9H15V15Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM6 5H18C18.5523 5 19 5.44772 19 6V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18V6C5 5.44772 5.44772 5 6 5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBriefcase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBriefcase"
                .to_owned()) } < / title > < path d = "M14 11H10V13H14V11Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgBrowse => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBrowse"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M14.364 13.1214C15.2876 14.045 15.4831 15.4211 14.9504 16.5362L16.4853 18.0711C16.8758 18.4616 16.8758 19.0948 16.4853 19.4853C16.0948 19.8758 15.4616 19.8758 15.0711 19.4853L13.5361 17.9504C12.421 18.4831 11.045 18.2876 10.1213 17.364C8.94975 16.1924 8.94975 14.2929 10.1213 13.1214C11.2929 11.9498 13.1924 11.9498 14.364 13.1214ZM12.9497 15.9498C13.3403 15.5593 13.3403 14.9261 12.9497 14.5356C12.5592 14.145 11.9261 14.145 11.5355 14.5356C11.145 14.9261 11.145 15.5593 11.5355 15.9498C11.9261 16.3403 12.5592 16.3403 12.9497 15.9498Z"
                fill = "currentColor" /> < path d = "M8 5H16V7H8V5Z" fill =
                "currentColor" /> < path d = "M16 9H8V11H16V9Z" fill = "currentColor" />
                < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M4 4C4 2.34315 5.34315 1 7 1H17C18.6569 1 20 2.34315 20 4V20C20 21.6569 18.6569 23 17 23H7C5.34315 23 4 21.6569 4 20V4ZM7 3H17C17.5523 3 18 3.44772 18 4V20C18 20.5523 17.5523 21 17 21H7C6.44772 21 6 20.5523 6 20V4C6 3.44772 6.44771 3 7 3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgBrowser => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBrowser"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgBrush => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBrush"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgBulb => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgBulb"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 9C4 11.9611 5.60879 14.5465 8 15.9297V15.9999C8 18.2091 9.79086 19.9999 12 19.9999C14.2091 19.9999 16 18.2091 16 15.9999V15.9297C18.3912 14.5465 20 11.9611 20 9C20 4.58172 16.4183 1 12 1C7.58172 1 4 4.58172 4 9ZM16 13.4722C17.2275 12.3736 18 10.777 18 9C18 5.68629 15.3137 3 12 3C8.68629 3 6 5.68629 6 9C6 10.777 6.7725 12.3736 8 13.4722L10 13.4713V16C10 17.1045 10.8954 17.9999 12 17.9999C13.1045 17.9999 14 17.1045 14 15.9999V13.4713L16 13.4722Z"
                fill = "currentColor" /> < path d =
                "M10 21.0064V21C10.5883 21.3403 11.2714 21.5351 12 21.5351C12.7286 21.5351 13.4117 21.3403 14 21V21.0064C14 22.111 13.1046 23.0064 12 23.0064C10.8954 23.0064 10 22.111 10 21.0064Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCPlusPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCPlusPlus"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M15 9H13V11H11V13H13V15H15V13H17V11H15V9Z" fill = "currentColor" /> <
                path d = "M20 9H22V11H24V13H22V15H20V13H18V11H20V9Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCalculator => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalculator"
                .to_owned()) } < / title > < path d = "M17 5H7V7H17V5Z" fill =
                "currentColor" /> < path d = "M7 9H9V11H7V9Z" fill = "currentColor" /> <
                path d = "M9 13H7V15H9V13Z" fill = "currentColor" /> < path d =
                "M7 17H9V19H7V17Z" fill = "currentColor" /> < path d =
                "M13 9H11V11H13V9Z" fill = "currentColor" /> < path d =
                "M11 13H13V15H11V13Z" fill = "currentColor" /> < path d =
                "M13 17H11V19H13V17Z" fill = "currentColor" /> < path d =
                "M15 9H17V11H15V9Z" fill = "currentColor" /> < path d =
                "M17 13H15V19H17V13Z" fill = "currentColor" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgCalendar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendar"
                .to_owned()) } < / title > < path d =
                "M8 9C7.44772 9 7 9.44771 7 10C7 10.5523 7.44772 11 8 11H16C16.5523 11 17 10.5523 17 10C17 9.44771 16.5523 9 16 9H8Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M6 3C4.34315 3 3 4.34315 3 6V18C3 19.6569 4.34315 21 6 21H18C19.6569 21 21 19.6569 21 18V6C21 4.34315 19.6569 3 18 3H6ZM5 18V7H19V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCalendarDates => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendarDates"
                .to_owned()) } < / title > < path d =
                "M8 13C7.44772 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11C8.55228 11 9 11.4477 9 12C9 12.5523 8.55228 13 8 13Z"
                fill = "currentColor" /> < path d =
                "M8 17C7.44772 17 7 16.5523 7 16C7 15.4477 7.44772 15 8 15C8.55228 15 9 15.4477 9 16C9 16.5523 8.55228 17 8 17Z"
                fill = "currentColor" /> < path d =
                "M11 16C11 16.5523 11.4477 17 12 17C12.5523 17 13 16.5523 13 16C13 15.4477 12.5523 15 12 15C11.4477 15 11 15.4477 11 16Z"
                fill = "currentColor" /> < path d =
                "M16 17C15.4477 17 15 16.5523 15 16C15 15.4477 15.4477 15 16 15C16.5523 15 17 15.4477 17 16C17 16.5523 16.5523 17 16 17Z"
                fill = "currentColor" /> < path d =
                "M11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z"
                fill = "currentColor" /> < path d =
                "M16 13C15.4477 13 15 12.5523 15 12C15 11.4477 15.4477 11 16 11C16.5523 11 17 11.4477 17 12C17 12.5523 16.5523 13 16 13Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgCalendarDue => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendarDue"
                .to_owned()) } < / title > < path d =
                "M7 8C7 7.44772 7.44772 7 8 7H16C16.5523 7 17 7.44772 17 8C17 8.55228 16.5523 9 16 9H8C7.44772 9 7 8.55228 7 8Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgCalendarNext => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendarNext"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCalendarToday => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendarToday"
                .to_owned()) } < / title > < path d =
                "M15 17C16.1046 17 17 16.1046 17 15C17 13.8954 16.1046 13 15 13C13.8954 13 13 13.8954 13 15C13 16.1046 13.8954 17 15 17Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M6 3C4.34315 3 3 4.34315 3 6V18C3 19.6569 4.34315 21 6 21H18C19.6569 21 21 19.6569 21 18V6C21 4.34315 19.6569 3 18 3H6ZM5 18V7H19V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgCalendarTwo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalendarTwo"
                .to_owned()) } < / title > < path d =
                "M8 7C7.44772 7 7 7.44772 7 8C7 8.55228 7.44772 9 8 9H16C16.5523 9 17 8.55228 17 8C17 7.44772 16.5523 7 16 7H8Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCalibrate => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCalibrate"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCamera => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCamera"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCap => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCap"
                .to_owned()) } < / title > < path d = "M8 18V20H16V18H8Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgCaptions => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCaptions"
                .to_owned()) } < / title > < path d = "M11 8V10H8V14H11V16H6V8H11Z" fill
                = "currentColor" /> < path d = "M18 8V10H15V14H18V16H13V8H18Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M2 5C2 4.44772 2.44772 4 3 4H21C21.5523 4 22 4.44772 22 5V19C22 19.5523 21.5523 20 21 20H3C2.44772 20 2 19.5523 2 19V5ZM4 18V6H20V18H4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCardClubs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCardClubs"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCardDiamonds => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCardDiamonds"
                .to_owned()) } < / title > < path d =
                "M12 7.75736L7.75736 12L12 16.2426L16.2426 12L12 7.75736Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M3 4C3 2.34315 4.34315 1 6 1H18C19.6569 1 21 2.34315 21 4V20C21 21.6569 19.6569 23 18 23H6C4.34315 23 3 21.6569 3 20V4ZM6 3H18C18.5523 3 19 3.44772 19 4V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V4C5 3.44772 5.44772 3 6 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgCardHearts => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCardHearts"
                .to_owned()) } < / title > < path d =
                "M9.14648 12.2929C8.36544 11.5118 8.36544 10.2455 9.14648 9.46444C9.92753 8.68339 11.1939 8.68339 11.9749 9.46444L12 9.48955L12.0251 9.46449C12.8061 8.68345 14.0725 8.68345 14.8535 9.46449C15.6346 10.2455 15.6346 11.5119 14.8535 12.2929L12.0251 15.1213L12 15.0962L11.9749 15.1213L9.14648 12.2929Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 4C3 2.34315 4.34315 1 6 1H18C19.6569 1 21 2.34315 21 4V20C21 21.6569 19.6569 23 18 23H6C4.34315 23 3 21.6569 3 20V4ZM6 3H18C18.5523 3 19 3.44772 19 4V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V4C5 3.44772 5.44772 3 6 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgCardSpades => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCardSpades"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCarousel => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCarousel"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 3C2.34315 3 1 4.34315 1 6V10C1 11.6569 2.34315 13 4 13H20C21.6569 13 23 11.6569 23 10V6C23 4.34315 21.6569 3 20 3H4ZM20 5H4C3.44772 5 3 5.44772 3 6V10C3 10.5523 3.44772 11 4 11H20C20.5523 11 21 10.5523 21 10V6C21 5.44771 20.5523 5 20 5Z"
                fill = "currentColor" /> < path d =
                "M7 20C7 19.4477 7.44772 19 8 19H16C16.5523 19 17 19.4477 17 20C17 20.5523 16.5523 21 16 21H8C7.44772 21 7 20.5523 7 20Z"
                fill = "currentColor" /> < path d =
                "M5 15C4.44772 15 4 15.4477 4 16C4 16.5523 4.44772 17 5 17H19C19.5523 17 20 16.5523 20 16C20 15.4477 19.5523 15 19 15H5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCast"
                .to_owned()) } < / title > < path d =
                ...
                "currentColor" /> < path d = "M2 17C3.65685 17 5 18.3431 5 20H2V17Z" fill
                = "currentColor" /> < path d =
        ...
        Icon::CgChanel => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChanel"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgChart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChart"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCheck"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCheckO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCheckO"
                .to_owned()) } < / title > < path d =
                "M10.2426 16.3137L6 12.071L7.41421 10.6568L10.2426 13.4853L15.8995 7.8284L17.3137 9.24262L10.2426 16.3137Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12ZM12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCheckR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCheckR"
                .to_owned()) } < / title > < path d =
                "M10.2426 16.3137L6 12.071L7.41421 10.6568L10.2426 13.4853L15.8995 7.8284L17.3137 9.24262L10.2426 16.3137Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgChevronDoubleDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleDown".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleDownO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleDownO".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleDownR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleDownR".to_owned()) } < / title > < path d =
                "M7.75732 8.46448L9.17154 7.05026L12 9.87869L14.8284 7.05029L16.2426 8.46451L12 12.7071L7.75732 8.46448Z"
                fill = "currentColor" /> < path d =
                "M9.17154 11.2929L7.75732 12.7071L11.9999 16.9498L16.2426 12.7071L14.8284 11.2929L12 14.1213L9.17154 11.2929Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
        ...
        Icon::CgChevronDoubleLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleLeft".to_owned()) } < / title > < path d =
                "M18.3639 7.75735L16.9497 6.34314L11.2929 12L16.9497 17.6568L18.3639 16.2426L14.1213 12L18.3639 7.75735Z"
                fill = "currentColor" /> < path d =
                "M11.2929 6.34314L12.7071 7.75735L8.46447 12L12.7071 16.2426L11.2929 17.6568L5.63605 12L11.2929 6.34314Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgChevronDoubleLeftO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleLeftO".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleLeftR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleLeftR".to_owned()) } < / title > < path d =
                "M12.7071 9.1716L11.2929 7.75739L7.05024 12L11.2929 16.2426L12.7071 14.8284L9.87869 12L12.7071 9.1716Z"
                fill = "currentColor" /> < path d =
                "M15.5355 7.75739L16.9497 9.1716L14.1213 12L16.9497 14.8284L15.5355 16.2426L11.2929 12L15.5355 7.75739Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
        ...
        Icon::CgChevronDoubleRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleRightO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleRightO".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleRightR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleRightR".to_owned()) } < / title > < path d =
                "M8.46448 7.75739L7.05026 9.1716L9.87869 12L7.05029 14.8284L8.46451 16.2426L12.7071 12L8.46448 7.75739Z"
                fill = "currentColor" /> < path d =
                "M11.2929 9.1716L12.7071 7.75739L16.9498 12L12.7071 16.2426L11.2929 14.8284L14.1213 12L11.2929 9.1716Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M23 5C23 2.79086 21.2091 1 19 1H5C2.79086 1 1 2.79086 1 5V19C1 21.2091 2.79086 23 5 23H19C21.2091 23 23 21.2091 23 19V5ZM19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgChevronDoubleUp => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleUp".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleUpO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleUpO".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDoubleUpR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgChevronDoubleUpR".to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronDown"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronDownO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronDownO"
                .to_owned()) } < / title > < path d =
                "M7.75745 10.5858L9.17166 9.17154L12.0001 12L14.8285 9.17157L16.2427 10.5858L12.0001 14.8284L7.75745 10.5858Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12ZM12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgChevronDownR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronDownR"
                .to_owned()) } < / title > < path d =
                "M7.75739 10.5858L9.1716 9.17154L12 12L14.8284 9.17157L16.2426 10.5858L12 14.8284L7.75739 10.5858Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgChevronLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronLeft"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronLeftO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronLeftO"
                .to_owned()) } < / title > < path d =
                "M12 7.75739L13.4142 9.1716L10.5858 12L13.4142 14.8285L12 16.2427L7.75736 12L12 7.75739Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1ZM3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgChevronLeftR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronLeftR"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronRight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronRightO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronRightO"
                .to_owned()) } < / title > < path d =
                "M11.0858 7.75739L15.3284 12L11.0858 16.2427L9.67157 14.8285L12.5 12L9.67157 9.1716L11.0858 7.75739Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1ZM21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgChevronRightR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronRightR"
                .to_owned()) } < / title > < path d =
                "M16.4853 12.0451L12.2426 7.80249L10.8284 9.2167L13.6568 12.0451L10.8284 14.8736L12.2426 16.2878L16.4853 12.0451Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgChevronUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronUp"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronUpO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronUpO"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgChevronUpR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgChevronUpR"
                .to_owned()) } < / title > < path d =
                "M14.8285 14.8284L16.2427 13.4142L12.0001 9.17161L7.75745 13.4142L9.17166 14.8285L12.0001 12L14.8285 14.8284Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCircleci => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCircleci"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgClapperBoard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgClapperBoard"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgClipboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgClipboard"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgClose => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgClose"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCloseR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCloseR"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCloud => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCloud"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCode"
                .to_owned()) } < / title > < path d =
                "M9.95263 16.9123L8.59323 18.3608L2.03082 12.2016L8.18994 5.63922L9.64826 7.00791L4.85783 12.112L9.95212 16.8932L9.95263 16.9123Z"
                fill = "currentColor" /> < path d =
                "M14.0474 16.9123L15.4068 18.3608L21.9692 12.2016L15.8101 5.63922L14.3517 7.00791L19.1422 12.112L14.0479 16.8932L14.0474 16.9123Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCodeClimate => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCodeClimate"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCodeSlash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCodeSlash"
                .to_owned()) } < / title > < path d =
                "M13.325 3.05011L8.66741 20.4323L10.5993 20.9499L15.2568 3.56775L13.325 3.05011Z"
                fill = "currentColor" /> < path d =
                "M7.61197 18.3608L8.97136 16.9124L8.97086 16.8933L3.87657 12.1121L8.66699 7.00798L7.20868 5.63928L1.04956 12.2017L7.61197 18.3608Z"
                fill = "currentColor" /> < path d =
                "M16.388 18.3608L15.0286 16.9124L15.0291 16.8933L20.1234 12.1121L15.333 7.00798L16.7913 5.63928L22.9504 12.2017L16.388 18.3608Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCoffee => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCoffee"
                .to_owned()) } < / title > < path d =
                "M6 2.5C5.44772 2.5 5 2.94772 5 3.5V5.5C5 6.05228 5.44772 6.5 6 6.5C6.55228 6.5 7 6.05228 7 5.5V3.5C7 2.94772 6.55228 2.5 6 2.5Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M13 21.5C15.973 21.5 18.441 19.3377 18.917 16.5H19C21.2091 16.5 23 14.7091 23 12.5C23 10.2909 21.2091 8.5 19 8.5V7.5H1V15.5C1 18.8137 3.68629 21.5 7 21.5H13ZM3 9.5V15.5C3 17.7091 4.79086 19.5 7 19.5H13C15.2091 19.5 17 17.7091 17 15.5V9.5H3ZM21 12.5C21 13.6046 20.1046 14.5 19 14.5V10.5C20.1046 10.5 21 11.3954 21 12.5Z"
                fill = "currentColor" /> < path d =
                "M9 3.5C9 2.94772 9.44771 2.5 10 2.5C10.5523 2.5 11 2.94772 11 3.5V5.5C11 6.05228 10.5523 6.5 10 6.5C9.44771 6.5 9 6.05228 9 5.5V3.5Z"
                fill = "currentColor" /> < path d =
                "M14 2.5C13.4477 2.5 13 2.94772 13 3.5V5.5C13 6.05228 13.4477 6.5 14 6.5C14.5523 6.5 15 6.05228 15 5.5V3.5C15 2.94772 14.5523 2.5 14 2.5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCollage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCollage"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgColorBucket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgColorBucket"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgColorPicker => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgColorPicker"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgComedyCentral => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgComedyCentral"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgComment => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgComment"
                .to_owned()) } < / title > < path d = "M17 9H7V7H17V9Z" fill =
                "currentColor" /> < path d = "M7 13H17V11H7V13Z" fill = "currentColor" />
                < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgComponents => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgComponents"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCompress => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCompress"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCompressLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCompressLeft"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCompressRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCompressRight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCompressV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCompressV"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgController => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgController"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCopy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCopy"
                .to_owned()) } < / title > < path d = "M13 7H7V5H13V7Z" fill =
                "currentColor" /> < path d = "M13 11H7V9H13V11Z" fill = "currentColor" />
                < path d = "M7 15H13V13H7V15Z" fill = "currentColor" /> < path fill -
                rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgCopyright => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCopyright"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleDownLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleDownLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleDownRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleDownRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleLeftDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleLeftDown".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleLeftUp => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleLeftUp".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleRightDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleRightDown".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleRightUp => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleRightUp".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleUpLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleUpLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDoubleUpRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDoubleUpRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDownLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDownLeft".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerDownRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerDownRight".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerLeftDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerLeftDown".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerLeftUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCornerLeftUp"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerRightDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgCornerRightDown".to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerRightUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCornerRightUp"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerUpLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCornerUpLeft"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCornerUpRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCornerUpRight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCreditCard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCreditCard"
                .to_owned()) } < / title > < path d =
                "M4 9C4 8.44772 4.44772 8 5 8H9C9.55228 8 10 8.44772 10 9C10 9.55228 9.55228 10 9 10H5C4.44772 10 4 9.55228 4 9Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 3C1.79086 3 0 4.79086 0 7V17C0 19.2091 1.79086 21 4 21H20C22.2091 21 24 19.2091 24 17V7C24 4.79086 22.2091 3 20 3H4ZM20 5H4C2.89543 5 2 5.89543 2 7V14H22V7C22 5.89543 21.1046 5 20 5ZM22 16H2V17C2 18.1046 2.89543 19 4 19H20C21.1046 19 22 18.1046 22 17V16Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgCrop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCrop"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCross => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCross"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgCrowdfire => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCrowdfire"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgCrown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgCrown"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgDanger => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDanger"
                .to_owned()) } < / title > < path d =
                "M12 6C12.5523 6 13 6.44772 13 7V13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13V7C11 6.44772 11.4477 6 12 6Z"
                fill = "currentColor" /> < path d =
                "M12 16C11.4477 16 11 16.4477 11 17C11 17.5523 11.4477 18 12 18C12.5523 18 13 17.5523 13 17C13 16.4477 12.5523 16 12 16Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDarkMode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDarkMode"
                .to_owned()) } < / title > < path d =
                "M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8V16Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM12 4V8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16V20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgData => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgData"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d =
                "M7.05019 6.93938C5.78348 8.20612 5 9.9561 5 11.8891C5 14.0666 5.99426 16.0119 7.55355 17.2957L8.97712 15.8721C7.7757 14.9589 7 13.5146 7 11.8891C7 10.5084 7.55962 9.25841 8.46441 8.35359L7.05019 6.93938Z"
                fill = "currentColor" /> < path d =
                "M15.5355 8.35348C16.4403 9.25831 17 10.5083 17 11.8891C17 13.5146 16.2243 14.959 15.0228 15.8722L16.4463 17.2958C18.0057 16.012 19 14.0666 19 11.8891C19 9.95604 18.2165 8.20602 16.9497 6.93927L15.5355 8.35348Z"
                fill = "currentColor" /> < path d =
                "M1 11.8891C1 8.85152 2.23119 6.10155 4.22176 4.11095L5.63598 5.52516C4.00733 7.15383 3 9.40381 3 11.8891C3 14.3743 4.00733 16.6243 5.63597 18.2529L4.22175 19.6672C2.23119 17.6766 1 14.9266 1 11.8891Z"
                fill = "currentColor" /> < path d =
                "M19.7781 19.6673C21.7688 17.6767 23 14.9266 23 11.8891C23 8.85147 21.7688 6.10145 19.7781 4.11084L18.3639 5.52505C19.9926 7.15374 21 9.40376 21 11.8891C21 14.3744 19.9926 16.6244 18.3639 18.2531L19.7781 19.6673Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDatabase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDatabase"
                .to_owned()) } < / title > < path d = "M5 9V7H7V9H5Z" fill =
                "currentColor" /> < path d = "M9 9H19V7H9V9Z" fill = "currentColor" /> <
                path d = "M5 15V17H7V15H5Z" fill = "currentColor" /> < path d =
                "M19 17H9V15H19V17Z" fill = "currentColor" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M1 6C1 4.34315 2.34315 3 4 3H20C21.6569 3 23 4.34315 23 6V18C23 19.6569 21.6569 21 20 21H4C2.34315 21 1 19.6569 1 18V6ZM4 5H20C20.5523 5 21 5.44772 21 6V11H3V6C3 5.44772 3.44772 5 4 5ZM3 13V18C3 18.5523 3.44772 19 4 19H20C20.5523 19 21 18.5523 21 18V13H3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDebug => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDebug"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDesignmodo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDesignmodo"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M22 10.5544H17V7.55444H22V10.5544Z"
                fill = "currentColor" /> < path d =
                "M11.5503 16.9457C12.6786 16.9457 13.6977 16.4786 14.4249 15.7272C14.4097 15.7429 14.3943 15.7585 14.3788 15.774L16.5001 17.8954C15.2334 19.1621 13.4834 19.9457 11.5503 19.9457C9.61734 19.9457 7.86734 19.1622 6.60059 17.8954L8.72191 15.7741C9.44576 16.498 10.4458 16.9457 11.5503 16.9457Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDesktop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDesktop"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDetailsLess => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDetailsLess"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDetailsMore => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDetailsMore"
                .to_owned()) } < / title > < path d =
                "M2 8C2 7.44772 2.44772 7 3 7H21C21.5523 7 22 7.44772 22 8C22 8.55228 21.5523 9 21 9H3C2.44772 9 2 8.55228 2 8Z"
                fill = "currentColor" /> < path d =
                "M2 12C2 11.4477 2.44772 11 3 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H3C2.44772 13 2 12.5523 2 12Z"
                fill = "currentColor" /> < path d =
                "M3 15C2.44772 15 2 15.4477 2 16C2 16.5523 2.44772 17 3 17H15C15.5523 17 16 16.5523 16 16C16 15.4477 15.5523 15 15 15H3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDialpad => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDialpad"
                .to_owned()) } < / title > < path d = "M5.5 3H8.5V6H5.5V3Z" fill =
                "currentColor" /> < path d = "M5.5 8H8.5V11H5.5V8Z" fill = "currentColor"
                /> < path d = "M5.5 13V16H8.5V13H5.5Z" fill = "currentColor" /> < path d
                = "M10.5 3H13.5V6H10.5V3Z" fill = "currentColor" /> < path d =
                "M10.5 8V11H13.5V8H10.5Z" fill = "currentColor" /> < path d =
                "M10.5 13H13.5V16H10.5V13Z" fill = "currentColor" /> < path d =
                "M10.5 18V21H13.5V18H10.5Z" fill = "currentColor" /> < path d =
                "M15.5 3H18.5V6H15.5V3Z" fill = "currentColor" /> < path d =
                "M15.5 8V11H18.5V8H15.5Z" fill = "currentColor" /> < path d =
                "M15.5 13H18.5V16H15.5V13Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgDice1")]
        Icon::CgDice1 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice1"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDice2 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice2"
                .to_owned()) } < / title > < path d =
                "M17.2 14.9431C16.0954 14.9431 15.2 15.8385 15.2 16.9431C15.2 18.0477 16.0954 18.9431 17.2 18.9431C18.3045 18.9431 19.2 18.0477 19.2 16.9431C19.2 15.8385 18.3045 14.9431 17.2 14.9431Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgDice3 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice3"
                .to_owned()) } < / title > < path d =
                "M10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgDice4 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice4"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDice5 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice5"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDice6 => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDice6"
                .to_owned()) } < / title > < path d =
                "M16.9451 5.05518C15.8405 5.05518 14.9451 5.95061 14.9451 7.05518C14.9451 8.15975 15.8405 9.05518 16.9451 9.05518C18.0496 9.05518 18.9451 8.15975 18.9451 7.05518C18.9451 5.95061 18.0496 5.05518 16.9451 5.05518Z"
                fill = "currentColor" /> < path d =
                "M14.9451 16.8921C14.9451 15.7875 15.8405 14.8921 16.9451 14.8921C18.0496 14.8921 18.9451 15.7875 18.9451 16.8921C18.9451 17.9967 18.0496 18.8921 16.9451 18.8921C15.8405 18.8921 14.9451 17.9967 14.9451 16.8921Z"
        ...
        Icon::CgDigitalocean => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDigitalocean"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d = "M7 18V13H12V18H7Z" fill =
                "currentColor" /> < path d = "M3 18V22H7V18H3Z" fill = "currentColor" />
                < path d = "M3 18H1V16H3V18Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgDisc")]
        Icon::CgDisc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDisc"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9ZM11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z"
                fill = "currentColor" /> < path d =
                "M5 12C5 8.13401 8.13401 5 12 5V7C9.23858 7 7 9.23858 7 12H5Z" fill =
                "currentColor" /> < path d =
                "M12 17C14.7614 17 17 14.7614 17 12H19C19 15.866 15.866 19 12 19V17Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1ZM3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDisplayFlex => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDisplayFlex"
                .to_owned()) } < / title > < path d = "M6 17V7H8V17H6Z" fill =
                "currentColor" /> < path d = "M16 7V17H18V7H16Z" fill = "currentColor" />
                < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M2 3H22V21H2V3ZM4 5V19H20V5H4Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgDisplayFullwidth")]
        Icon::CgDisplayFullwidth => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgDisplayFullwidth".to_owned()) } < / title > < path d =
                "M2 5H22V3H2V5Z" fill = "currentColor" /> < path d = "M2 21H22V19H2V21Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M2 7V17H22V7H2ZM4 9H20V15H4V9Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDisplayGrid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDisplayGrid"
                .to_owned()) } < / title > < path d = "M7 7V11H11V7H7Z" fill =
                "currentColor" /> < path d = "M13 7H17V11H13V7Z" fill = "currentColor" />
                < path d = "M13 13V17H17V13H13Z" fill = "currentColor" /> < path d =
                "M7 13H11V17H7V13Z" fill = "currentColor" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d = "M3 3H21V21H3V3ZM5 5V19H19V5H5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDisplaySpacing => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgDisplaySpacing".to_owned()) } < / title > < path d = "M3 21V3H5V21H3Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M7 3H17V21H7V3ZM9 5V19H15V5H9Z" fill = "currentColor" /> <
        ...
        Icon::CgDistributeHorizontal => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgDistributeHorizontal".to_owned()) } < / title > < path d =
                "M11 9H13V15H11V9Z" stroke = "currentColor" stroke - opacity = "0.5"
                stroke - width = "2" /> < path d = "M5 5V19H7V5H5Z" fill = "currentColor"
        ...
        Icon::CgDistributeVertical => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgDistributeVertical".to_owned()) } < / title > < path d =
                "M9 11H15V13H9V11Z" stroke = "currentColor" stroke - opacity = "0.5"
                stroke - width = "2" /> < path d = "M19 7H5V5H19V7Z" fill =
                "currentColor" /> < path d = "M19 19H5V17H19V19Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDockBottom => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDockBottom"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M2 20V4H22V20H2ZM4 6H20V14H4V6Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDockLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDockLeft"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M2 4H22V20H2V4ZM8 6H20V18H8V6Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDockRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDockRight"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M2 4H22V20H2V4ZM16 18V6H4V18H16Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDockWindow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDockWindow"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M2 20V4H22V20H2ZM20 6H6V16L20 16V6Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgDolby => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDolby"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgDollar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDollar"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgDrive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDrive"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDrop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDrop"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgDropInvert => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDropInvert"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgDropOpacity => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDropOpacity"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgDuplicate => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgDuplicate"
                .to_owned()) } < / title > < path d = "M19 5H7V3H21V17H19V5Z" fill =
                "currentColor" /> < path d = "M9 13V11H11V13H13V15H11V17H9V15H7V13H9Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 7H17V21H3V7ZM5 9H15V19H5V9Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditBlackPoint => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgEditBlackPoint".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12ZM12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12C13 12.5523 12.5523 13 12 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12ZM12 19C8.13401 19 5 15.866 5 12C5 8.13401 8.13401 5 12 5C15.866 5 19 8.13401 19 12C19 15.866 15.866 19 12 19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditContrast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditContrast"
                .to_owned()) } < / title > < path d =
                "M12 18C10.4633 18 9.06151 17.4223 8 16.4722C6.7725 15.3736 6 13.777 6 12C6 10.223 6.7725 8.62643 8 7.52779C9.06151 6.57771 10.4633 6 12 6V18Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditExposure => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditExposure"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM11 7V9H9V11H11V13H13V11H15V9H13V7H11ZM9 15V17H15V15H9Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditFlipH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditFlipH"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M13 3H11V21H13V3Z" fill = "currentColor" /> < path d =
        ...
        Icon::CgEditFlipV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditFlipV"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d = "M21 13V11L3 11V13H21Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditHighlight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditHighlight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEditMarkup => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditMarkup"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgEditMask => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditMask"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEditNoise => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditNoise"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M6.37104 13.6475C6.59701 13.8735 6.64864 14.2077 6.52594 14.4832C6.38527 14.1723 6.27034 13.8472 6.18387 13.5107C6.25129 13.5454 6.31455 13.591 6.37104 13.6475Z"
                fill = "currentColor" /> < path d =
                "M6.37104 10.6753C6.29401 10.7523 6.2044 10.8091 6.10883 10.8456C6.18637 10.4523 6.30234 10.0728 6.45268 9.71119C6.66079 10.004 6.63357 10.4128 6.37104 10.6753Z"
                fill = "currentColor" /> < path d =
                "M7.37508 8.70669C7.28995 8.62156 7.22957 8.52106 7.19392 8.41413C7.45907 8.06093 7.76228 7.73793 8.09747 7.45124C8.22139 7.48394 8.33858 7.54887 8.43574 7.64603C8.72863 7.93892 8.72863 8.41379 8.43574 8.70669C8.14285 8.99958 7.66797 8.99958 7.37508 8.70669Z"
                fill = "currentColor" /> < path d =
                "M9.34371 6.76662C9.31335 6.73627 9.28614 6.70396 9.26208 6.6701C9.6881 6.45171 10.1437 6.28277 10.6212 6.17088C10.6397 6.38399 10.5675 6.60352 10.4044 6.76662C10.1115 7.05952 9.6366 7.05952 9.34371 6.76662Z"
                fill = "currentColor" /> < path d =
                "M13.2872 17.8734C13.5967 17.8055 13.8973 17.7136 14.1868 17.6C13.9165 17.4914 13.5957 17.5466 13.3766 17.7657C13.3429 17.7993 13.3131 17.8354 13.2872 17.8734Z"
                fill = "currentColor" /> < path d =
                "M15.5312 16.8608C15.935 16.5658 16.3005 16.2216 16.619 15.8369C16.6005 15.8133 16.5803 15.7906 16.5586 15.7688C16.2657 15.4759 15.7908 15.4759 15.4979 15.7688C15.205 16.0617 15.205 16.5366 15.4979 16.8295C15.5088 16.8403 15.5199 16.8508 15.5312 16.8608Z"
                fill = "currentColor" /> < path d =
                "M17.3654 14.6921C17.5637 14.2953 17.7194 13.8735 17.8264 13.4326C17.6636 13.451 17.5058 13.5227 17.3809 13.6475C17.0933 13.9351 17.0881 14.3982 17.3654 14.6921Z"
                fill = "currentColor" /> < path d =
                "M17.8911 10.8934C17.8032 10.4272 17.6613 9.98016 17.4722 9.55885C17.4507 9.57609 17.4299 9.59469 17.4099 9.61465C17.117 9.90755 17.117 10.3824 17.4099 10.6753C17.5439 10.8093 17.7159 10.882 17.8911 10.8934Z"
                fill = "currentColor" /> < path d =
                "M16.7556 8.35985C16.4971 8.02355 16.2038 7.71542 15.8811 7.44086C15.7407 7.46881 15.6068 7.5372 15.4979 7.64603C15.205 7.93892 15.205 8.41379 15.4979 8.70669C15.7908 8.99958 16.2657 8.99958 16.5586 8.70669C16.658 8.60729 16.7237 8.48694 16.7556 8.35985Z"
                fill = "currentColor" /> < path d =
                "M14.4373 6.76662C14.4906 6.71331 14.5342 6.65397 14.5681 6.59079C14.1273 6.38127 13.6569 6.22392 13.1649 6.12671C13.1317 6.35331 13.2022 6.59223 13.3766 6.76662C13.6695 7.05952 14.1444 7.05952 14.4373 6.76662Z"
                fill = "currentColor" /> < path d =
                "M12.5257 7.64603C12.8186 7.93892 12.8186 8.41379 12.5257 8.70669C12.2328 8.99958 11.7579 8.99958 11.465 8.70669C11.1721 8.41379 11.1721 7.93892 11.465 7.64603C11.7579 7.35313 12.2328 7.35313 12.5257 7.64603Z"
                fill = "currentColor" /> < path d =
                "M10.4044 9.61465C10.6973 9.90755 10.6973 10.3824 10.4044 10.6753C10.1115 10.9682 9.6366 10.9682 9.34371 10.6753C9.05081 10.3824 9.05081 9.90755 9.34371 9.61465C9.6366 9.32176 10.1115 9.32176 10.4044 9.61465Z"
                fill = "currentColor" /> < path d =
                "M8.43574 12.7967C8.72863 12.5038 8.72863 12.0289 8.43574 11.736C8.14285 11.4431 7.66797 11.4431 7.37508 11.736C7.08218 12.0289 7.08218 12.5038 7.37508 12.7967C7.66797 13.0895 8.14285 13.0895 8.43574 12.7967Z"
                fill = "currentColor" /> < path d =
                "M10.4044 13.6475C10.6973 13.9404 10.6973 14.4153 10.4044 14.7082C10.1115 15.001 9.6366 15.001 9.34371 14.7082C9.05081 14.4153 9.05081 13.9404 9.34371 13.6475C9.6366 13.3546 10.1115 13.3546 10.4044 13.6475Z"
                fill = "currentColor" /> < path d =
                "M12.5257 12.7967C12.8186 12.5038 12.8186 12.0289 12.5257 11.736C12.2328 11.4431 11.7579 11.4431 11.465 11.736C11.1721 12.0289 11.1721 12.5038 11.465 12.7967C11.7579 13.0895 12.2328 13.0895 12.5257 12.7967Z"
                fill = "currentColor" /> < path d =
                "M14.4373 9.61465C14.7302 9.90755 14.7302 10.3824 14.4373 10.6753C14.1444 10.9682 13.6695 10.9682 13.3766 10.6753C13.0837 10.3824 13.0837 9.90755 13.3766 9.61465C13.6695 9.32176 14.1444 9.32176 14.4373 9.61465Z"
                fill = "currentColor" /> < path d =
                "M16.5586 12.7681C16.8515 12.4752 16.8515 12.0003 16.5586 11.7074C16.2657 11.4145 15.7908 11.4145 15.4979 11.7074C15.205 12.0003 15.205 12.4752 15.4979 12.7681C15.7908 13.061 16.2657 13.061 16.5586 12.7681Z"
                fill = "currentColor" /> < path d =
                "M14.423 13.6902C14.7159 13.9831 14.7159 14.458 14.423 14.7509C14.1301 15.0438 13.6552 15.0438 13.3623 14.7509C13.0694 14.458 13.0694 13.9831 13.3623 13.6902C13.6552 13.3973 14.1301 13.3973 14.423 13.6902Z"
                fill = "currentColor" /> < path d =
                "M12.3159 16.705C12.6088 16.4121 12.6088 15.9372 12.3159 15.6443C12.023 15.3514 11.5482 15.3514 11.2553 15.6443C10.9624 15.9372 10.9624 16.4121 11.2553 16.705C11.5482 16.9979 12.023 16.9979 12.3159 16.705Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditShadows => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditShadows"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditStraight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditStraight"
                .to_owned()) } < / title > < path d =
                "M12 4C15.866 4 19 7.13401 19 11H5C5 7.13401 8.13401 4 12 4Z" fill =
                "currentColor" /> < path d = "M5 13H1V11H5V13Z" fill = "currentColor" />
                < path d =
                "M19 13C19 16.866 15.866 20 12 20C8.13401 20 5 16.866 5 13H19Z" fill =
                "currentColor" /> < path d = "M19 13V11H23V13H19Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEditUnmask => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEditUnmask"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M12 22C13.6569 22 15 20.6569 15 19C15 17.3431 13.6569 16 12 16C10.3431 16 9 17.3431 9 19C9 20.6569 10.3431 22 12 22Z"
                fill = "currentColor" /> < path d =
                "M22 12C22 13.6569 20.6569 15 19 15C17.3431 15 16 13.6569 16 12C16 10.3431 17.3431 9 19 9C20.6569 9 22 10.3431 22 12Z"
                fill = "currentColor" /> < path d =
                "M5 15C6.65685 15 8 13.6569 8 12C8 10.3431 6.65685 9 5 9C3.34315 9 2 10.3431 2 12C2 13.6569 3.34315 15 5 15Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEject => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEject"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEnter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEnter"
                .to_owned()) } < / title > < path d =
                "M20 5H8V9H6V3H22V21H6V15H8V19H20V5Z" fill = "currentColor" /> < path d =
        ...
        Icon::CgErase => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgErase"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgEreader => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEreader"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEricsson => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEricsson"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEthernet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEthernet"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgEuro => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEuro"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgEventbrite => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEventbrite"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgExpand => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExpand"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgExport => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExport"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M5 20.9819V10.9819H9V8.98193H3V22.9819H21V8.98193H15V10.9819H19V20.9819H5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgExtension => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExtension"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M13 3H21V11H13V3ZM15 5H19V9H15V5Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M17 21V13H11V7H3V21H17ZM9 9H5V13H9V9ZM5 19L5 15H9V19H5ZM11 19V15H15V19H11Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgExtensionAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExtensionAdd"
                .to_owned()) } < / title > < path d =
                "M16 4H18V6H20V8H18V10H16V8H14V6H16V4Z" fill = "currentColor" /> < path
                fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M12 12V6H4V20H18V12H12ZM6 8H10V12H6V8ZM10 14V18H6V14H10ZM16 14V18H12V14H16Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgExtensionAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExtensionAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 5V19H13V13H19V5H5ZM11 7H7V11H11V7ZM11 13H7V17H11V13ZM13 11H17V7H13V11Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgExtensionRemove => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgExtensionRemove".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M12 11V5H4V19H18V11H12ZM6 7H10V11H6V7ZM10 13V17H6V13H10ZM16 13V17H12V13H16Z"
                fill = "currentColor" /> < path d = "M20 7H14V9H20V7Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgExternal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgExternal"
                .to_owned()) } < / title > < path d =
                "M15.6396 7.02527H12.0181V5.02527H19.0181V12.0253H17.0181V8.47528L12.1042 13.3892L10.6899 11.975L15.6396 7.02527Z"
                fill = "currentColor" /> < path d =
                "M10.9819 6.97473H4.98193V18.9747H16.9819V12.9747H14.9819V16.9747H6.98193V8.97473H10.9819V6.97473Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEye => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEye"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12ZM14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 3C17.5915 3 22.2898 6.82432 23.6219 12C22.2898 17.1757 17.5915 21 12 21C6.40848 21 1.71018 17.1757 0.378052 12C1.71018 6.82432 6.40848 3 12 3ZM12 19C7.52443 19 3.73132 16.0581 2.45723 12C3.73132 7.94186 7.52443 5 12 5C16.4756 5 20.2687 7.94186 21.5428 12C20.2687 16.0581 16.4756 19 12 19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgEyeAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgEyeAlt"
                .to_owned()) } < / title > < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 3C6.40848 3 1.71018 6.82432 0.378052 12C1.71018 17.1757 6.40848 21 12 21C17.5915 21 22.2898 17.1757 23.6219 12C22.2898 6.82432 17.5915 3 12 3ZM16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFacebook => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFacebook"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFeed => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFeed"
                .to_owned()) } < / title > < path d =
                "M12.552 8C11.9997 8 11.552 8.44772 11.552 9C11.552 9.55228 11.9997 10 12.552 10H16.552C17.1043 10 17.552 9.55228 17.552 9C17.552 8.44772 17.1043 8 16.552 8H12.552Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M12.552 17C11.9997 17 11.552 17.4477 11.552 18C11.552 18.5523 11.9997 19 12.552 19H16.552C17.1043 19 17.552 18.5523 17.552 18C17.552 17.4477 17.1043 17 16.552 17H12.552Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M12.552 5C11.9997 5 11.552 5.44772 11.552 6C11.552 6.55228 11.9997 7 12.552 7H20.552C21.1043 7 21.552 6.55228 21.552 6C21.552 5.44772 21.1043 5 20.552 5H12.552Z"
                fill = "currentColor" fill - opacity = "0.8" /> < path d =
                "M12.552 14C11.9997 14 11.552 14.4477 11.552 15C11.552 15.5523 11.9997 16 12.552 16H20.552C21.1043 16 21.552 15.5523 21.552 15C21.552 14.4477 21.1043 14 20.552 14H12.552Z"
                fill = "currentColor" fill - opacity = "0.8" /> < path d =
                "M3.448 4.00208C2.89571 4.00208 2.448 4.44979 2.448 5.00208V10.0021C2.448 10.5544 2.89571 11.0021 3.448 11.0021H8.448C9.00028 11.0021 9.448 10.5544 9.448 10.0021V5.00208C9.448 4.44979 9.00028 4.00208 8.448 4.00208H3.448Z"
                fill = "currentColor" /> < path d =
                "M3.448 12.9979C2.89571 12.9979 2.448 13.4456 2.448 13.9979V18.9979C2.448 19.5502 2.89571 19.9979 3.448 19.9979H8.448C9.00028 19.9979 9.448 19.5502 9.448 18.9979V13.9979C9.448 13.4456 9.00028 12.9979 8.448 12.9979H3.448Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFigma => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFigma"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFile"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgFileAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFileAdd"
                .to_owned()) } < / title > < path d =
                "M10 18V16H8V14H10V12H12V14H14V16H12V18H10Z" fill = "currentColor" /> <
                path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M6 2C4.34315 2 3 3.34315 3 5V19C3 20.6569 4.34315 22 6 22H18C19.6569 22 21 20.6569 21 19V9C21 5.13401 17.866 2 14 2H6ZM6 4H13V9H19V19C19 19.5523 18.5523 20 18 20H6C5.44772 20 5 19.5523 5 19V5C5 4.44772 5.44772 4 6 4ZM15 4.10002C16.6113 4.4271 17.9413 5.52906 18.584 7H15V4.10002Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFileDocument => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFileDocument"
                .to_owned()) } < / title > < path d = "M7 18H17V16H7V18Z" fill =
                "currentColor" /> < path d = "M17 14H7V12H17V14Z" fill = "currentColor"
                /> < path d = "M7 10H11V8H7V10Z" fill = "currentColor" /> < path fill -
                rule = "evenodd" clip - rule = "evenodd" d =
                "M6 2C4.34315 2 3 3.34315 3 5V19C3 20.6569 4.34315 22 6 22H18C19.6569 22 21 20.6569 21 19V9C21 5.13401 17.866 2 14 2H6ZM6 4H13V9H19V19C19 19.5523 18.5523 20 18 20H6C5.44772 20 5 19.5523 5 19V5C5 4.44772 5.44772 4 6 4ZM15 4.10002C16.6113 4.4271 17.9413 5.52906 18.584 7H15V4.10002Z"
                fill = "currentColor" /> < / svg >
            }
        ...
        Icon::CgFileRemove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFileRemove"
                .to_owned()) } < / title > < path d = "M9 15H15V13H9V15Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M6 2C4.34315 2 3 3.34315 3 5V19C3 20.6569 4.34315 22 6 22H18C19.6569 22 21 20.6569 21 19V9C21 5.13401 17.866 2 14 2H6ZM6 4H13V9H19V19C19 19.5523 18.5523 20 18 20H6C5.44772 20 5 19.5523 5 19V5C5 4.44772 5.44772 4 6 4ZM15 4.10002C16.6113 4.4271 17.9413 5.52906 18.584 7H15V4.10002Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgFilm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFilm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFlag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFlag"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 21H6V11H12V13H20V5H13V3H4V21ZM12 5H6V9H13V11H18V7H12V5Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFlagAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFlagAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12.4388 7L14.8387 4H7V10H14.8387L12.4388 7ZM19 12H7V22H5V2H19L15 7L19 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFolder => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFolder"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgFolderAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFolderAdd"
                .to_owned()) } < / title > < path d =
                "M11 14.5V16.5H13V14.5H15V12.5H13V10.5H11V12.5H9V14.5H11Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M4 1.5C2.89543 1.5 2 2.39543 2 3.5V4.5C2 4.55666 2.00236 4.61278 2.00698 4.66825C0.838141 5.07811 0 6.19118 0 7.5V19.5C0 21.1569 1.34315 22.5 3 22.5H21C22.6569 22.5 24 21.1569 24 19.5V7.5C24 5.84315 22.6569 4.5 21 4.5H11.874C11.4299 2.77477 9.86384 1.5 8 1.5H4ZM9.73244 4.5C9.38663 3.9022 8.74028 3.5 8 3.5H4V4.5H9.73244ZM3 6.5C2.44772 6.5 2 6.94772 2 7.5V19.5C2 20.0523 2.44772 20.5 3 20.5H21C21.5523 20.5 22 20.0523 22 19.5V7.5C22 6.94772 21.5523 6.5 21 6.5H3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgFolderRemove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFolderRemove"
                .to_owned()) } < / title > < path d = "M9 14.5V12.5H15V14.5H9Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M4 1.5C2.89543 1.5 2 2.39543 2 3.5V4.5C2 4.55666 2.00236 4.61278 2.00698 4.66825C0.838141 5.07811 0 6.19118 0 7.5V19.5C0 21.1569 1.34315 22.5 3 22.5H21C22.6569 22.5 24 21.1569 24 19.5V7.5C24 5.84315 22.6569 4.5 21 4.5H11.874C11.4299 2.77477 9.86384 1.5 8 1.5H4ZM9.73244 4.5C9.38663 3.9022 8.74028 3.5 8 3.5H4V4.5H9.73244ZM3 6.5C2.44772 6.5 2 6.94772 2 7.5V19.5C2 20.0523 2.44772 20.5 3 20.5H21C21.5523 20.5 22 20.0523 22 19.5V7.5C22 6.94772 21.5523 6.5 21 6.5H3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgFontHeight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFontHeight"
                .to_owned()) } < / title > < path d = "M21 5V3H3V5H21Z" fill =
                "currentColor" /> < path d = "M21 19V21H3V19H21Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgFontSpacing => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFontSpacing"
                .to_owned()) } < / title > < path d = "M19 21H21V3H19L19 21Z" fill =
                "currentColor" /> < path d = "M5 21H3V3H5L5 21Z" fill = "currentColor" />
                < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M9.46416 16.0479L9.95281 14.9999H14.0473L14.5359 16.0478C14.7693 16.5484 15.3643 16.7649 15.8649 16.5315C16.3654 16.2981 16.582 15.7031 16.3485 15.2026L12.9676 7.95213C12.7888 7.56877 12.398 7.35199 11.9999 7.37637C11.6019 7.35214 11.2112 7.5689 11.0325 7.95216L7.65155 15.2026C7.41814 15.7032 7.6347 16.2981 8.13524 16.5315C8.63578 16.7649 9.23076 16.5484 9.46416 16.0479ZM12.0001 10.6096L10.8854 12.9999H13.1147L12.0001 10.6096Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatBold => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatBold"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFormatCenter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatCenter"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFormatColor => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatColor"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgFormatHeading => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatHeading"
                .to_owned()) } < / title > < path d =
                "M6 19V5H8V11H16V5H18V19H16V13H8V19H6Z" fill = "currentColor" /> < / svg
                >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatIndentDecrease => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatIndentDecrease".to_owned()) } < / title > < path d =
                "M20 7H4V5H20V7Z" fill = "currentColor" /> < path d =
                "M20 11H12V9H20V11Z" fill = "currentColor" /> < path d =
                "M12 15H20V13H12V15Z" fill = "currentColor" /> < path d =
                "M9 9L4 12L9 15V9Z" fill = "currentColor" /> < path d =
                "M4 17V19H20V17H4Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgFormatIndentIncrease")]
        Icon::CgFormatIndentIncrease => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatIndentIncrease".to_owned()) } < / title > < path d =
                "M20 7H4V5H20V7Z" fill = "currentColor" /> < path d =
                "M20 11H12V9H20V11Z" fill = "currentColor" /> < path d =
                "M12 15H20V13H12V15Z" fill = "currentColor" /> < path d =
                "M4 15L9 12L4 9V15Z" fill = "currentColor" /> < path d =
                "M4 17V19H20V17H4Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatItalic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatItalic"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFormatJustify => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatJustify"
                .to_owned()) } < / title > < path d =
                "M4 5C3.44772 5 3 5.44772 3 6C3 6.55228 3.44772 7 4 7H20C20.5523 7 21 6.55228 21 6C21 5.44772 20.5523 5 20 5H4Z"
                fill = "currentColor" /> < path d =
                "M4 9C3.44772 9 3 9.44772 3 10C3 10.5523 3.44772 11 4 11H20C20.5523 11 21 10.5523 21 10C21 9.44772 20.5523 9 20 9H4Z"
                fill = "currentColor" /> < path d =
                "M3 14C3 13.4477 3.44772 13 4 13H20C20.5523 13 21 13.4477 21 14C21 14.5523 20.5523 15 20 15H4C3.44772 15 3 14.5523 3 14Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgFormatLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatLeft"
                .to_owned()) } < / title > < path d =
                "M4 5C3.44772 5 3 5.44772 3 6C3 6.55228 3.44772 7 4 7H20C20.5523 7 21 6.55228 21 6C21 5.44772 20.5523 5 20 5H4Z"
                fill = "currentColor" /> < path d =
                "M4 9C3.44772 9 3 9.44772 3 10C3 10.5523 3.44772 11 4 11H12C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9H4Z"
                fill = "currentColor" /> < path d =
                "M3 14C3 13.4477 3.44772 13 4 13H20C20.5523 13 21 13.4477 21 14C21 14.5523 20.5523 15 20 15H4C3.44772 15 3 14.5523 3 14Z"
                fill = "currentColor" /> < path d =
                "M4 17C3.44772 17 3 17.4477 3 18C3 18.5523 3.44772 19 4 19H12C12.5523 19 13 18.5523 13 18C13 17.4477 12.5523 17 12 17H4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatLineHeight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatLineHeight".to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d = "M22.8412 7H8.84119V5H22.8412V7Z"
                fill = "currentColor" /> < path d = "M22.8412 11H8.84119V9H22.8412V11Z"
                fill = "currentColor" /> < path d = "M8.84119 15H22.8412V13H8.84119V15Z"
                fill = "currentColor" /> < path d = "M22.8412 19H8.84119V17H22.8412V19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatRight"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgFormatSeparator => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatSeparator".to_owned()) } < / title > < g opacity = "0.5" > <
                path d =
                ...
                fill = "currentColor" /> </ g > < path fill - rule = "evenodd" clip -
                rule = "evenodd" d =
        ...
        Icon::CgFormatSlash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatSlash"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M14.526 6.10576C15.0265 6.33917 15.2667 6.88343 15.0625 7.3214L9.88541 18.4237C9.68118 18.8616 9.10985 19.0275 8.60931 18.7941C8.10877 18.5607 7.86857 18.0164 8.0728 17.5784L13.2499 6.47616C13.4541 6.03819 14.0254 5.87235 14.526 6.10576Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFormatStrike => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatStrike"
                .to_owned()) } < / title > < path d = "M13 7H17V5H7V7H11V10H13V7Z" fill =
                "currentColor" /> < path d = "M11 19V14H13V19H11Z" fill = "currentColor"
        ...
        Icon::CgFormatText => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFormatText"
                .to_owned()) } < / title > < path d = "M6.5 3H3V6.5H4V4H6.5V3Z" fill =
                "currentColor" /> < path d = "M8.5 4V3H11V4H8.5Z" fill = "currentColor"
                /> < path d = "M13 4H15.5V3H13V4Z" fill = "currentColor" /> < path d =
                "M17.5 3V4H20V6.5H21V3H17.5Z" fill = "currentColor" /> < path d =
                "M21 8.5H20V11H21V8.5Z" fill = "currentColor" /> < path d =
                "M21 13H20V15.5H21V13Z" fill = "currentColor" /> < path d =
                "M21 17.5H20V20H17.5V21H21V17.5Z" fill = "currentColor" /> < path d =
                "M15.5 21V20H13V21H15.5Z" fill = "currentColor" /> < path d =
                "M11 21V20H8.5V21H11Z" fill = "currentColor" /> < path d =
                "M6.5 21V20H4V17.5H3V21H6.5Z" fill = "currentColor" /> < path d =
                "M3 15.5H4V13H3V15.5Z" fill = "currentColor" /> < path d =
                "M3 11H4V8.5H3V11Z" fill = "currentColor" /> < path d =
                "M11 9.5H7V7.5H17V9.5H13V16.5H11V9.5Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgFormatUnderline")]
        Icon::CgFormatUnderline => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatUnderline".to_owned()) } < / title > < path d =
        ...
        Icon::CgFormatUppercase => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgFormatUppercase".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M13 9H10V17H8V9H5V7H13V9ZM18 13H16V17H14V13H12V11H18V13Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgFramer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgFramer"
                .to_owned()) } < / title > < path d = "M12 21L12 9L6 9L6 15L12 21Z" fill
                = "currentColor" fill - opacity = "0.5" /> < path d =
                "M18 9V3H6L12 9H6V15H18L12 9H18Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgGames")]
        Icon::CgGames => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGames"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M6 13H4V11H6V9H8V11H10V13H8V15H6V13Z" fill = "currentColor" /> < path
                fill - rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgGenderFemale => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGenderFemale"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 3C9.23858 3 7 5.23858 7 8C7 10.419 8.71776 12.4367 11 12.9V15H8V17H11V21H13V17H16V15H13V12.9C15.2822 12.4367 17 10.419 17 8C17 5.23858 14.7614 3 12 3ZM9 8C9 9.65685 10.3431 11 12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgGenderMale => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGenderMale"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGhost => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGhost"
                .to_owned()) } < / title > < path d = "M3 4H15V8H3V4Z" fill =
                "currentColor" /> < path d = "M21 8H17V4H21V8Z" fill = "currentColor" />
                < path d = "M3 10H21V14H3V10Z" fill = "currentColor" /> < path d =
                "M11 16H3V20H11V16Z" fill = "currentColor" /> < path d =
                "M13 16V20H21V16H13Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgGhostCharacter")]
        Icon::CgGhostCharacter => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgGhostCharacter".to_owned()) } < / title > < path d =
                "M10.9759 9C10.9759 9.55228 10.5282 10 9.97589 10C9.42361 10 8.97589 9.55228 8.97589 9C8.97589 8.44771 9.42361 8 9.97589 8C10.5282 8 10.9759 8.44771 10.9759 9Z"
                fill = "currentColor" /> < path d =
                "M13.9712 10C14.5235 10 14.9712 9.55228 14.9712 9C14.9712 8.44771 14.5235 8 13.9712 8C13.4189 8 12.9712 8.44771 12.9712 9C12.9712 9.55228 13.4189 10 13.9712 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M19 20.9999V10C19 6.13401 15.866 3 12 3C8.13401 3 5 6.13401 5 10V21L7.82846 21L9.24264 19.5858L10.6569 21L13.3433 21L14.7574 19.5858L16.1717 21L19 20.9999ZM17 10C17 7.23858 14.7614 5 12 5C9.23858 5 7 7.23858 7 10V19L9.24264 16.7573L12 19.5147L14.7574 16.7573L17 18.9999V10Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgGirl => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGirl"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGitBranch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGitBranch"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGitCommit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGitCommit"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGitFork => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGitFork"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGitPull => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGitPull"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGitter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGitter"
                .to_owned()) } < / title > < path d = "M5 1.5H7V14.5H5V1.5Z" fill =
                "currentColor" /> < path d = "M9 4.5H11V22.5H9V4.5Z" fill =
                "currentColor" /> < path d = "M15 4.5H13V22.5H15V4.5Z" fill =
                "currentColor" /> < path d = "M17 4.5H19V14.5H17V4.5Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgGlass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGlass"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGlassAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGlassAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGlobe => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGlobe"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGlobeAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGlobeAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgGoogle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGoogle"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGoogleTasks => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGoogleTasks"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgGym => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgGym"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgHashtag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHashtag"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgHeadset => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHeadset"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgHeart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHeart"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12.0122 5.57169L10.9252 4.48469C8.77734 2.33681 5.29493 2.33681 3.14705 4.48469C0.999162 6.63258 0.999162 10.115 3.14705 12.2629L11.9859 21.1017L11.9877 21.0999L12.014 21.1262L20.8528 12.2874C23.0007 10.1395 23.0007 6.65711 20.8528 4.50923C18.705 2.36134 15.2226 2.36134 13.0747 4.50923L12.0122 5.57169ZM11.9877 18.2715L16.9239 13.3352L18.3747 11.9342L18.3762 11.9356L19.4386 10.8732C20.8055 9.50635 20.8055 7.29028 19.4386 5.92344C18.0718 4.55661 15.8557 4.55661 14.4889 5.92344L12.0133 8.39904L12.006 8.3918L12.005 8.39287L9.51101 5.89891C8.14417 4.53207 5.92809 4.53207 4.56126 5.89891C3.19442 7.26574 3.19442 9.48182 4.56126 10.8487L7.10068 13.3881L7.10248 13.3863L11.9877 18.2715Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgHello => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHello"
                .to_owned()) } < / title > < path d =
                "M17.5 12C17.5 13.576 16.8371 14.9972 15.7749 16C14.7899 16.9299 13.4615 17.5 12 17.5C10.5385 17.5 9.21007 16.9299 8.22506 16C7.16289 14.9972 6.5 13.576 6.5 12H17.5Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 7C1 3.68629 3.68629 1 7 1H17C20.3137 1 23 3.68629 23 7V17C23 20.3137 20.3137 23 17 23H1V7ZM3.75 12C3.75 7.44365 7.44365 3.75 12 3.75C16.5563 3.75 20.25 7.44365 20.25 12C20.25 16.5563 16.5563 20.25 12 20.25C7.44365 20.25 3.75 16.5563 3.75 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgHome => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHome"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M21 8.77217L14.0208 1.79299C12.8492 0.621414 10.9497 0.621413 9.77817 1.79299L3 8.57116V23.0858H10V17.0858C10 15.9812 10.8954 15.0858 12 15.0858C13.1046 15.0858 14 15.9812 14 17.0858V23.0858H21V8.77217ZM11.1924 3.2072L5 9.39959V21.0858H8V17.0858C8 14.8767 9.79086 13.0858 12 13.0858C14.2091 13.0858 16 14.8767 16 17.0858V21.0858H19V9.6006L12.6066 3.2072C12.2161 2.81668 11.5829 2.81668 11.1924 3.2072Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgHomeAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHomeAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M6 22.8787C4.34315 22.8787 3 21.5355 3 19.8787V9.87866C3 9.84477 3.00169 9.81126 3.00498 9.77823H3C3 9.20227 3.2288 8.64989 3.63607 8.24262L9.87868 2.00002C11.0502 0.828445 12.9497 0.828445 14.1213 2.00002L20.3639 8.24264C20.7712 8.6499 21 9.20227 21 9.77823H20.995C20.9983 9.81126 21 9.84477 21 9.87866V19.8787C21 21.5355 19.6569 22.8787 18 22.8787H6ZM12.7071 3.41423L19 9.70713V19.8787C19 20.4309 18.5523 20.8787 18 20.8787H15V15.8787C15 14.2218 13.6569 12.8787 12 12.8787C10.3431 12.8787 9 14.2218 9 15.8787V20.8787H6C5.44772 20.8787 5 20.4309 5 19.8787V9.7072L11.2929 3.41423C11.6834 3.02371 12.3166 3.02371 12.7071 3.41423Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgHomeScreen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgHomeScreen"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgIcecream => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgIcecream"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgIfDesign => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgIfDesign"
                .to_owned()) } < / title > < path d = "M10 5H14V19H10V5Z" fill =
                "currentColor" /> < path d = "M5 19V10H9V19H5Z" fill = "currentColor" />
                < path d =
                "M7 5C5.89543 5 5 5.89543 5 7C5 8.10457 5.89543 9 7 9C8.10457 9 9 8.10457 9 7C9 5.89543 8.10457 5 7 5Z"
                fill = "currentColor" /> < path d = "M15 5H19V9H15V5Z" fill =
                "currentColor" /> < path d = "M19 10H15V14H19V10Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgImage => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgImage"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M7 7C5.34315 7 4 8.34315 4 10C4 11.6569 5.34315 13 7 13C8.65685 13 10 11.6569 10 10C10 8.34315 8.65685 7 7 7ZM6 10C6 9.44772 6.44772 9 7 9C7.55228 9 8 9.44772 8 10C8 10.5523 7.55228 11 7 11C6.44772 11 6 10.5523 6 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 3C1.34315 3 0 4.34315 0 6V18C0 19.6569 1.34315 21 3 21H21C22.6569 21 24 19.6569 24 18V6C24 4.34315 22.6569 3 21 3H3ZM21 5H3C2.44772 5 2 5.44772 2 6V18C2 18.5523 2.44772 19 3 19H7.31374L14.1924 12.1214C15.364 10.9498 17.2635 10.9498 18.435 12.1214L22 15.6863V6C22 5.44772 21.5523 5 21 5ZM21 19H10.1422L15.6066 13.5356C15.9971 13.145 16.6303 13.145 17.0208 13.5356L21.907 18.4217C21.7479 18.7633 21.4016 19 21 19Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgImport => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgImport"
                .to_owned()) } < / title > < path d =
                "M5 9.98193V19.9819H19V9.98193H15V7.98193H21V21.9819H3V7.98193H9V9.98193H5Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgInbox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInbox"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgIndieHackers => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgIndieHackers"
                .to_owned()) } < / title > < path d = "M4 6H7V18H4V6Z" fill =
                "currentColor" /> < path d =
                "M10 6H13V10.5H17V6H20V18H17V13.5H13V18H10V6Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgInfo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInfo"
                .to_owned()) } < / title > < path d =
                "M11 10.9794C11 10.4271 11.4477 9.97937 12 9.97937C12.5523 9.97937 13 10.4271 13 10.9794V16.9794C13 17.5317 12.5523 17.9794 12 17.9794C11.4477 17.9794 11 17.5317 11 16.9794V10.9794Z"
                fill = "currentColor" /> < path d =
                "M12 6.05115C11.4477 6.05115 11 6.49886 11 7.05115C11 7.60343 11.4477 8.05115 12 8.05115C12.5523 8.05115 13 7.60343 13 7.05115C13 6.49886 12.5523 6.05115 12 6.05115Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgInpicture => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInpicture"
                .to_owned()) } < / title > < path d = "M20 12H14V17H20V12Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgInsertAfter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertAfter"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgInsertAfterO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertAfterO"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 9C4 4.58172 7.58172 1 12 1C16.4183 1 20 4.58172 20 9C20 13.4183 16.4183 17 12 17C7.58172 17 4 13.4183 4 9ZM12 15C8.68629 15 6 12.3137 6 9C6 5.68629 8.68629 3 12 3C15.3137 3 18 5.68629 18 9C18 12.3137 15.3137 15 12 15Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgInsertAfterR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertAfterR"
                .to_owned()) } < / title > < path d =
                "M9 8C8.44772 8 8 8.44772 8 9C8 9.55229 8.44772 10 9 10H11V12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12V10H15C15.5523 10 16 9.55229 16 9C16 8.44772 15.5523 8 15 8H13V6C13 5.44772 12.5523 5 12 5C11.4477 5 11 5.44772 11 6V8H9Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgInsertBefore => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertBefore"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgInsertBeforeO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertBeforeO"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgInsertBeforeR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsertBeforeR"
                .to_owned()) } < / title > < path d =
                "M5 3C4.44772 3 4 2.55228 4 2C4 1.44772 4.44772 1 5 1H19C19.5523 1 20 1.44772 20 2C20 2.55228 19.5523 3 19 3H5Z"
                fill = "currentColor" /> < path d =
                "M9 15C8.44772 15 8 14.5523 8 14C8 13.4477 8.44772 13 9 13H11V11C11 10.4477 11.4477 10 12 10C12.5523 10 13 10.4477 13 11V13H15C15.5523 13 16 13.4477 16 14C16 14.5523 15.5523 15 15 15H13V17C13 17.5523 12.5523 18 12 18C11.4477 18 11 17.5523 11 17V15H9Z"
        ...
        Icon::CgInsights => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInsights"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M15 8H19V20H5V10H9V4H15V8ZM13 6H11V18H13V6ZM15 10V18H17V10H15ZM9 12V18H7V12H9Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgInstagram => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInstagram"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 7C9.23858 7 7 9.23858 7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7ZM9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12Z"
                fill = "currentColor" /> < path d =
                "M18 5C17.4477 5 17 5.44772 17 6C17 6.55228 17.4477 7 18 7C18.5523 7 19 6.55228 19 6C19 5.44772 18.5523 5 18 5Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 1C2.79086 1 1 2.79086 1 5V19C1 21.2091 2.79086 23 5 23H19C21.2091 23 23 21.2091 23 19V5C23 2.79086 21.2091 1 19 1H5ZM19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgInternal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgInternal"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgKey => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgKey"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgKeyboard => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgKeyboard"
                .to_owned()) } < / title > < path d =
                "M8 9C8.55228 9 9 8.55228 9 8C9 7.44772 8.55228 7 8 7C7.44772 7 7 7.44772 7 8C7 8.55228 7.44772 9 8 9Z"
                fill = "currentColor" /> < path d =
                "M9 15C8.44772 15 8 15.4477 8 16C8 16.5523 8.44772 17 9 17H15C15.5523 17 16 16.5523 16 16C16 15.4477 15.5523 15 15 15H9Z"
                fill = "currentColor" /> < path d =
                "M9 12C9 12.5523 8.55228 13 8 13C7.44772 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11C8.55228 11 9 11.4477 9 12Z"
                fill = "currentColor" /> < path d =
                "M12 9C12.5523 9 13 8.55228 13 8C13 7.44772 12.5523 7 12 7C11.4477 7 11 7.44772 11 8C11 8.55228 11.4477 9 12 9Z"
                fill = "currentColor" /> < path d =
                ...
                fill = "currentColor" /> < path d =
                "M17 12C17 12.5523 16.5523 13 16 13C15.4477 13 15 12.5523 15 12C15 11.4477 15.4477 11 16 11C16.5523 11 17 11.4477 17 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM6 5H18C18.5523 5 19 5.44772 19 6V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18V6C5 5.44772 5.44772 5 6 5Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgKeyhole => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgKeyhole"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M13 12.8293C14.1652 12.4175 15 11.3062 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.3062 9.83481 12.4175 11 12.8293V16C11 16.5523 11.4477 17 12 17C12.5523 17 13 16.5523 13 16V12.8293ZM11 10C11 10.5523 11.4477 11 12 11C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9C11.4477 9 11 9.44772 11 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgLaptop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLaptop"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 6C3 4.89543 3.89543 4 5 4H19C20.1046 4 21 4.89543 21 6V14C21 15.1046 20.1046 16 19 16H5C3.89543 16 3 15.1046 3 14V6ZM5 6H19V14H5V6Z"
                fill = "currentColor" /> < path d =
                "M2 18C1.44772 18 1 18.4477 1 19C1 19.5523 1.44772 20 2 20H22C22.5523 20 23 19.5523 23 19C23 18.4477 22.5523 18 22 18H2Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLastpass => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLastpass"
                .to_owned()) } < / title > < path d =
                "M21 6C20.4477 6 20 6.44771 20 7V17C20 17.5523 20.4477 18 21 18C21.5523 18 22 17.5523 22 17V7C22 6.44772 21.5523 6 21 6Z"
                fill = "currentColor" /> < path d =
                "M4 14C5.10457 14 6 13.1046 6 12C6 10.8954 5.10457 10 4 10C2.89543 10 2 10.8954 2 12C2 13.1046 2.89543 14 4 14Z"
                fill = "currentColor" /> < path d =
                "M12 12C12 13.1046 11.1046 14 10 14C8.89543 14 8 13.1046 8 12C8 10.8954 8.89543 10 10 10C11.1046 10 12 10.8954 12 12Z"
                fill = "currentColor" /> < path d =
                "M16 14C17.1046 14 18 13.1046 18 12C18 10.8954 17.1046 10 16 10C14.8954 10 14 10.8954 14 12C14 13.1046 14.8954 14 16 14Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLayoutGrid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLayoutGrid"
                .to_owned()) } < / title > < path d = "M11 7H7V11H11V7Z" fill =
                "currentColor" /> < path d = "M11 13H7V17H11V13Z" fill = "currentColor"
                /> < path d = "M13 13H17V17H13V13Z" fill = "currentColor" /> < path d =
                "M17 7H13V11H17V7Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgLayoutGridSmall")]
        Icon::CgLayoutGridSmall => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgLayoutGridSmall".to_owned()) } < / title > < path d = "M7 7H9V9H7V7Z"
                fill = "currentColor" /> < path d = "M11 7H13V9H11V7Z" fill =
                "currentColor" /> < path d = "M17 7H15V9H17V7Z" fill = "currentColor" />
                < path d = "M7 11H9V13H7V11Z" fill = "currentColor" /> < path d =
                "M13 11H11V13H13V11Z" fill = "currentColor" /> < path d =
                "M15 11H17V13H15V11Z" fill = "currentColor" /> < path d =
                "M9 15H7V17H9V15Z" fill = "currentColor" /> < path d =
                "M11 15H13V17H11V15Z" fill = "currentColor" /> < path d =
                "M17 15H15V17H17V15Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgLayoutList")]
        Icon::CgLayoutList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLayoutList"
                .to_owned()) } < / title > < path d = "M9 7H7V9H9V7Z" fill =
                "currentColor" /> < path d = "M7 13V11H9V13H7Z" fill = "currentColor" />
                < path d = "M7 15V17H9V15H7Z" fill = "currentColor" /> < path d =
                "M11 15V17H17V15H11Z" fill = "currentColor" /> < path d =
                "M17 13V11H11V13H17Z" fill = "currentColor" /> < path d =
                "M17 7V9H11V7H17Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgLayoutPin")]
        ...
        Icon::CgLinear => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLinear"
                .to_owned()) } < / title > < path d =
                "M3.03509 12.9431C3.24245 14.9227 4.10472 16.8468 5.62188 18.364C7.13904 19.8811 9.0631 20.7434 11.0428 20.9508L3.03509 12.9431Z"
                fill = "currentColor" /> < path d =
                "M3 11.4938L12.4921 20.9858C13.2976 20.9407 14.0981 20.7879 14.8704 20.5273L3.4585 9.11548C3.19793 9.88771 3.0451 10.6883 3 11.4938Z"
                fill = "currentColor" /> < path d =
                "M3.86722 8.10999L15.8758 20.1186C16.4988 19.8201 17.0946 19.4458 17.6493 18.9956L4.99021 6.33659C4.54006 6.89125 4.16573 7.487 3.86722 8.10999Z"
                fill = "currentColor" /> < path d =
                "M5.66301 5.59517C9.18091 2.12137 14.8488 2.135 18.3498 5.63604C21.8508 9.13708 21.8645 14.8049 18.3907 18.3228L5.66301 5.59517Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLink => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLink"
                .to_owned()) } < / title > < path d =
                "M14.8284 12L16.2426 13.4142L19.071 10.5858C20.6331 9.02365 20.6331 6.49099 19.071 4.9289C17.509 3.3668 14.9763 3.3668 13.4142 4.9289L10.5858 7.75732L12 9.17154L14.8284 6.34311C15.6095 5.56206 16.8758 5.56206 17.6568 6.34311C18.4379 7.12416 18.4379 8.39049 17.6568 9.17154L14.8284 12Z"
                fill = "currentColor" /> < path d =
                "M12 14.8285L13.4142 16.2427L10.5858 19.0711C9.02372 20.6332 6.49106 20.6332 4.92896 19.0711C3.36686 17.509 3.36686 14.9764 4.92896 13.4143L7.75739 10.5858L9.1716 12L6.34317 14.8285C5.56212 15.6095 5.56212 16.8758 6.34317 17.6569C7.12422 18.4379 8.39055 18.4379 9.1716 17.6569L12 14.8285Z"
                fill = "currentColor" /> < path d =
                "M14.8285 10.5857C15.219 10.1952 15.219 9.56199 14.8285 9.17147C14.4379 8.78094 13.8048 8.78094 13.4142 9.17147L9.1716 13.4141C8.78107 13.8046 8.78107 14.4378 9.1716 14.8283C9.56212 15.2188 10.1953 15.2188 10.5858 14.8283L14.8285 10.5857Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgList"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M20 4H4C3.44771 4 3 4.44772 3 5V19C3 19.5523 3.44772 20 4 20H20C20.5523 20 21 19.5523 21 19V5C21 4.44771 20.5523 4 20 4ZM4 2C2.34315 2 1 3.34315 1 5V19C1 20.6569 2.34315 22 4 22H20C21.6569 22 23 20.6569 23 19V5C23 3.34315 21.6569 2 20 2H4ZM6 7H8V9H6V7ZM11 7C10.4477 7 10 7.44772 10 8C10 8.55228 10.4477 9 11 9H17C17.5523 9 18 8.55228 18 8C18 7.44772 17.5523 7 17 7H11ZM8 11H6V13H8V11ZM10 12C10 11.4477 10.4477 11 11 11H17C17.5523 11 18 11.4477 18 12C18 12.5523 17.5523 13 17 13H11C10.4477 13 10 12.5523 10 12ZM8 15H6V17H8V15ZM10 16C10 15.4477 10.4477 15 11 15H17C17.5523 15 18 15.4477 18 16C18 16.5523 17.5523 17 17 17H11C10.4477 17 10 16.5523 10 16Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgListTree => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgListTree"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M9 1H1V9H9V6H11V20H15V23H23V15H15V18H13V6H15V9H23V1H15V4H9V1ZM21 3H17V7H21V3ZM17 17H21V21H17V17Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLivePhoto => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLivePhoto"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M5.65597 19.7304L6.92562 18.1851C6.5202 17.852 6.14801 17.4798 5.81491 17.0744L4.2696 18.344C4.68539 18.8501 5.1499 19.3146 5.65597 19.7304Z"
                fill = "currentColor" /> < path d =
                "M3.17901 16.7148L4.94204 15.7705C4.69686 15.3127 4.49516 14.8288 4.34221 14.3239L2.42813 14.9038C2.61974 15.5363 2.87231 16.1422 3.17901 16.7148Z"
                fill = "currentColor" /> < path d =
                "M2.04746 12.9805L4.03806 12.7868C4.01292 12.5285 4 12.2661 4 12C4 11.7339 4.01292 11.4715 4.03806 11.2132L2.04746 11.0195C2.01607 11.3421 2 11.6692 2 12C2 12.3308 2.01607 12.6579 2.04746 12.9805Z"
                fill = "currentColor" /> < path d =
                "M2.42813 9.09617L4.34221 9.67608C4.49517 9.17124 4.69686 8.68725 4.94204 8.22951L3.17901 7.28519C2.87231 7.8578 2.61974 8.46374 2.42813 9.09617Z"
                fill = "currentColor" /> < path d =
                "M4.2696 5.65597L5.81491 6.92562C6.14801 6.5202 6.5202 6.14801 6.92562 5.81491L5.65597 4.2696C5.14991 4.68539 4.68539 5.1499 4.2696 5.65597Z"
                fill = "currentColor" /> < path d =
                "M7.2852 3.17901L8.22951 4.94204C8.68726 4.69686 9.17124 4.49516 9.67608 4.34221L9.09617 2.42813C8.46374 2.61974 7.8578 2.87231 7.2852 3.17901Z"
                fill = "currentColor" /> < path d =
                "M11.0195 2.04746C11.3421 2.01607 11.6692 2 12 2C12.3308 2 12.6579 2.01607 12.9805 2.04746L12.7868 4.03806C12.5285 4.01292 12.2661 4 12 4C11.7339 4 11.4715 4.01292 11.2132 4.03806L11.0195 2.04746Z"
                fill = "currentColor" /> < path d =
                "M14.9038 2.42813L14.3239 4.34221C14.8288 4.49517 15.3127 4.69686 15.7705 4.94204L16.7148 3.17901C16.1422 2.87231 15.5363 2.61974 14.9038 2.42813Z"
                fill = "currentColor" /> < path d =
                "M18.344 4.2696L17.0744 5.81491C17.4798 6.14801 17.852 6.5202 18.1851 6.92562L19.7304 5.65597C19.3146 5.14991 18.8501 4.68539 18.344 4.2696Z"
                fill = "currentColor" /> < path d =
                "M20.821 7.2852L19.058 8.22951C19.3031 8.68726 19.5048 9.17124 19.6578 9.67608L21.5719 9.09617C21.3803 8.46374 21.1277 7.8578 20.821 7.2852Z"
                fill = "currentColor" /> < path d =
                "M21.9525 11.0195L19.9619 11.2132C19.9871 11.4715 20 11.7339 20 12C20 12.2661 19.9871 12.5285 19.9619 12.7868L21.9525 12.9806C21.9839 12.6579 22 12.3308 22 12C22 11.6692 21.9839 11.3421 21.9525 11.0195Z"
                fill = "currentColor" /> < path d =
                "M21.5719 14.9038L19.6578 14.3239C19.5048 14.8288 19.3031 15.3127 19.058 15.7705L20.821 16.7148C21.1277 16.1422 21.3803 15.5363 21.5719 14.9038Z"
                fill = "currentColor" /> < path d =
                "M19.7304 18.344L18.1851 17.0744C17.852 17.4798 17.4798 17.852 17.0744 18.1851L18.344 19.7304C18.8501 19.3146 19.3146 18.8501 19.7304 18.344Z"
                fill = "currentColor" /> < path d =
                "M16.7148 20.821L15.7705 19.058C15.3127 19.3031 14.8288 19.5048 14.3239 19.6578L14.9038 21.5719C15.5363 21.3803 16.1422 21.1277 16.7148 20.821Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12ZM12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12C13 12.5523 12.5523 13 12 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6ZM8 12C8 14.2091 9.79086 16 12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLoadbar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLoadbar"
                .to_owned()) } < / title > < rect x = "3" y = "10" width = "18" height =
        ...
        Icon::CgLoadbarAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLoadbarAlt"
                .to_owned()) } < / title > < rect opacity = "0.3" x = "3" y = "10" width
                = "18" height = "4" rx = "2" fill = "currentColor" /> < rect x = "7" y =
                "10" width = "10" height = "4" rx = "2" fill = "currentColor" /> < / svg
                >
            }
                .into_view(cx)
        }
        ...
        Icon::CgLoadbarDoc => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLoadbarDoc"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M8 7H16V9H8V7Z" fill =
                "currentColor" /> < path d = "M8 11H16V13H8V11Z" fill = "currentColor" />
                < path d = "M8 15H13V17H8V15Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgLoadbarSound")]
        Icon::CgLoadbarSound => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLoadbarSound"
                .to_owned()) } < / title > < path d = "M11 6H13V18H11V6Z" fill =
                "currentColor" /> < path d = "M7 13H9V18H7V13Z" fill = "currentColor" />
        ...
        Icon::CgLock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLock"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgLockUnlock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLockUnlock"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgLogIn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLogIn"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgLogOff => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLogOff"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgLogOut => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLogOut"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgLoupe => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgLoupe"
                .to_owned()) } < / title > < path d =
                "M11 11V8H13V11H16V13H13V16H11V13H8V11H11Z" fill = "currentColor" /> <
                path fill - rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgMagnet => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMagnet"
                .to_owned()) } < / title > < path d = "M8 2.5H4V5.5H8V2.5Z" fill =
                "currentColor" fill - opacity = "0.5" /> < path d =
                "M20 2.5H16V5.5H20V2.5Z" fill = "currentColor" fill - opacity = "0.5" />
                < path d =
        ...
        Icon::CgMail => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMail"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3.00977 5.83789C3.00977 5.28561 3.45748 4.83789 4.00977 4.83789H20C20.5523 4.83789 21 5.28561 21 5.83789V17.1621C21 18.2667 20.1046 19.1621 19 19.1621H5C3.89543 19.1621 3 18.2667 3 17.1621V6.16211C3 6.11449 3.00333 6.06765 3.00977 6.0218V5.83789ZM5 8.06165V17.1621H19V8.06199L14.1215 12.9405C12.9499 14.1121 11.0504 14.1121 9.87885 12.9405L5 8.06165ZM6.57232 6.80554H17.428L12.7073 11.5263C12.3168 11.9168 11.6836 11.9168 11.2931 11.5263L6.57232 6.80554Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMailForward => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMailForward"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMailOpen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMailOpen"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgMailReply => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMailReply"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMathDivide => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMathDivide"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMathEqual => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMathEqual"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMathMinus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMathMinus"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMathPercent => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMathPercent"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMathPlus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMathPlus"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMaximize => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMaximize"
                .to_owned()) } < / title > < path d = "M3 3H9V5H5V9H3V3Z" fill =
                "currentColor" /> < path d = "M3 21H9V19H5V15H3V21Z" fill =
                "currentColor" /> < path d = "M15 21H21V15H19V19H15V21Z" fill =
                "currentColor" /> < path d = "M21 3H15V5H19V9H21V3Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMaximizeAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMaximizeAlt"
                .to_owned()) } < / title > < path d =
                "M3 3H9V5H6.46173L11.3047 9.84298L9.8905 11.2572L5 6.3667V9H3V3Z" fill =
                "currentColor" /> < path d =
                "M3 21H9V19H6.3764L11.3046 14.0718L9.89038 12.6576L5 17.548V15H3V21Z"
                fill = "currentColor" /> < path d =
                "M15 21H21V15H19V17.5244L14.1332 12.6576L12.719 14.0718L17.6472 19H15V21Z"
                fill = "currentColor" /> < path d =
                "M21 3H15V5H17.5619L12.7189 9.84301L14.1331 11.2572L19 6.39032V9H21V3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMaze => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMaze"
                .to_owned()) } < / title > < path d =
                "M11.3709 9.59273L8.77816 7L1 14.7782L3.59272 17.3709L11.3709 9.59273Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgMediaLive => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMediaLive"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12ZM13 12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 19C15.866 19 19 15.866 19 12C19 8.13401 15.866 5 12 5C8.13401 5 5 8.13401 5 12C5 15.866 8.13401 19 12 19ZM12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7C9.23858 7 7 9.23858 7 12C7 14.7614 9.23858 17 12 17Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMediaPodcast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMediaPodcast"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenu => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenu"
                .to_owned()) } < / title > < path d =
                "M2 6C2 5.44772 2.44772 5 3 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H3C2.44772 7 2 6.55228 2 6Z"
                fill = "currentColor" /> < path d =
                "M2 12.0322C2 11.4799 2.44772 11.0322 3 11.0322H21C21.5523 11.0322 22 11.4799 22 12.0322C22 12.5845 21.5523 13.0322 21 13.0322H3C2.44772 13.0322 2 12.5845 2 12.0322Z"
                fill = "currentColor" /> < path d =
                "M3 17.0645C2.44772 17.0645 2 17.5122 2 18.0645C2 18.6167 2.44772 19.0645 3 19.0645H21C21.5523 19.0645 22 18.6167 22 18.0645C22 17.5122 21.5523 17.0645 21 17.0645H3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMenuBoxed => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuBoxed"
                .to_owned()) } < / title > < path d =
                "M8.01562 6.98193C7.46334 6.98193 7.01562 7.43285 7.01562 7.98513C7.01562 8.53742 7.46334 8.98833 8.01563 8.98833H15.9659C16.5182 8.98833 16.9659 8.53742 16.9659 7.98513C16.9659 7.43285 16.5182 6.98193 15.9659 6.98193H8.01562Z"
                fill = "currentColor" /> < path d =
                "M7.01562 12C7.01562 11.4477 7.46334 10.9968 8.01562 10.9968H15.9659C16.5182 10.9968 16.9659 11.4477 16.9659 12C16.9659 12.5523 16.5182 13.0032 15.9659 13.0032H8.01563C7.46334 13.0032 7.01562 12.5523 7.01562 12Z"
                fill = "currentColor" /> < path d =
                "M8.0249 15.0122C7.47262 15.0122 7.0249 15.4631 7.0249 16.0154C7.0249 16.5677 7.47262 17.0186 8.0249 17.0186H15.9752C16.5275 17.0186 16.9752 16.5677 16.9752 16.0154C16.9752 15.4631 16.5275 15.0122 15.9752 15.0122H8.0249Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM6 5H18C18.5523 5 19 5.44772 19 6V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18V6C5 5.44772 5.44772 5 6 5Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgMenuCake => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuCake"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuCheese => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuCheese"
                .to_owned()) } < / title > < path d =
                "M3 6C3 5.44772 3.44772 5 4 5H20C20.5523 5 21 5.44772 21 6C21 6.55228 20.5523 7 20 7H4C3.44772 7 3 6.55228 3 6Z"
                fill = "currentColor" /> < path d =
                "M3 18C3 17.4477 3.44772 17 4 17H20C20.5523 17 21 17.4477 21 18C21 18.5523 20.5523 19 20 19H4C3.44772 19 3 18.5523 3 18Z"
                fill = "currentColor" /> < path d =
                "M3 12C3 11.4477 3.44772 11 4 11H20C20.5523 11 21 11.4477 21 12C21 12.5523 20.5523 13 20 13H10.2625L7.61456 15.6479L4.96662 13H4C3.44772 13 3 12.5523 3 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMenuGridO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuGridO"
                .to_owned()) } < / title > < path d =
                "M8 6C8 7.10457 7.10457 8 6 8C4.89543 8 4 7.10457 4 6C4 4.89543 4.89543 4 6 4C7.10457 4 8 4.89543 8 6Z"
                fill = "currentColor" /> < path d =
                "M8 12C8 13.1046 7.10457 14 6 14C4.89543 14 4 13.1046 4 12C4 10.8954 4.89543 10 6 10C7.10457 10 8 10.8954 8 12Z"
                fill = "currentColor" /> < path d =
                ...
                fill = "currentColor" /> < path d =
                "M20 12C20 13.1046 19.1046 14 18 14C16.8954 14 16 13.1046 16 12C16 10.8954 16.8954 10 18 10C19.1046 10 20 10.8954 20 12Z"
                fill = "currentColor" /> < path d =
                "M18 20C19.1046 20 20 19.1046 20 18C20 16.8954 19.1046 16 18 16C16.8954 16 16 16.8954 16 18C16 19.1046 16.8954 20 18 20Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMenuGridR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuGridR"
                .to_owned()) } < / title > < path d = "M4 4H8V8H4V4Z" fill =
                "currentColor" /> < path d = "M4 10H8V14H4V10Z" fill = "currentColor" />
                < path d = "M8 16H4V20H8V16Z" fill = "currentColor" /> < path d =
                "M10 4H14V8H10V4Z" fill = "currentColor" /> < path d =
                "M14 10H10V14H14V10Z" fill = "currentColor" /> < path d =
                "M10 16H14V20H10V16Z" fill = "currentColor" /> < path d =
                "M20 4H16V8H20V4Z" fill = "currentColor" /> < path d =
                "M16 10H20V14H16V10Z" fill = "currentColor" /> < path d =
                "M20 16H16V20H20V16Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgMenuHotdog")]
        Icon::CgMenuHotdog => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuHotdog"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuLeft"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuLeftAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuLeftAlt"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuMotion => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuMotion"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuOreos => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuOreos"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMenuRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuRight"
                .to_owned()) } < / title > < path d =
                "M22 18.0048C22 18.5544 21.5544 19 21.0048 19H12.9952C12.4456 19 12 18.5544 12 18.0048C12 17.4552 12.4456 17.0096 12.9952 17.0096H21.0048C21.5544 17.0096 22 17.4552 22 18.0048Z"
                fill = "currentColor" /> < path d =
                "M22 12.0002C22 12.5499 21.5544 12.9954 21.0048 12.9954H2.99519C2.44556 12.9954 2 12.5499 2 12.0002C2 11.4506 2.44556 11.0051 2.99519 11.0051H21.0048C21.5544 11.0051 22 11.4506 22 12.0002Z"
                fill = "currentColor" /> < path d =
                "M21.0048 6.99039C21.5544 6.99039 22 6.54482 22 5.99519C22 5.44556 21.5544 5 21.0048 5H8.99519C8.44556 5 8 5.44556 8 5.99519C8 6.54482 8.44556 6.99039 8.99519 6.99039H21.0048Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMenuRightAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuRightAlt"
                .to_owned()) } < / title > < path d =
                "M4 6C4 5.44772 4.44772 5 5 5H19C19.5523 5 20 5.44772 20 6C20 6.55228 19.5523 7 19 7H5C4.44772 7 4 6.55228 4 6Z"
                fill = "currentColor" /> < path d =
                "M4 18C4 17.4477 4.44772 17 5 17H19C19.5523 17 20 17.4477 20 18C20 18.5523 19.5523 19 19 19H5C4.44772 19 4 18.5523 4 18Z"
        ...
        Icon::CgMenuRound => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMenuRound"
                .to_owned()) } < / title > < path d =
                "M8 6.9834C7.44772 6.9834 7 7.43111 7 7.9834C7 8.53568 7.44772 8.9834 8 8.9834H16C16.5523 8.9834 17 8.53568 17 7.9834C17 7.43111 16.5523 6.9834 16 6.9834H8Z"
                fill = "currentColor" /> < path d =
                "M7 12C7 11.4477 7.44772 11 8 11H16C16.5523 11 17 11.4477 17 12C17 12.5523 16.5523 13 16 13H8C7.44772 13 7 12.5523 7 12Z"
                fill = "currentColor" /> < path d =
                "M8 15.017C7.44772 15.017 7 15.4647 7 16.017C7 16.5693 7.44772 17.017 8 17.017H16C16.5523 17.017 17 16.5693 17 16.017C17 15.4647 16.5523 15.017 16 15.017H8Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgMergeHorizontal => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgMergeHorizontal".to_owned()) } < / title > < path d =
        ...
        Icon::CgMergeVertical => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMergeVertical"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMic"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M9 4C9 2.34315 10.3431 1 12 1C13.6569 1 15 2.34315 15 4V12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12V4ZM13 4V12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12V4C11 3.44772 11.4477 3 12 3C12.5523 3 13 3.44772 13 4Z"
                fill = "currentColor" /> < path d =
                "M18 12C18 14.973 15.8377 17.441 13 17.917V21H17V23H7V21H11V17.917C8.16229 17.441 6 14.973 6 12V9H8V12C8 14.2091 9.79086 16 12 16C14.2091 16 16 14.2091 16 12V9H18V12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMicrobit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMicrobit"
                .to_owned()) } < / title > < path d =
                "M7 14C8.10457 14 9 13.1046 9 12C9 10.8954 8.10457 10 7 10C5.89543 10 5 10.8954 5 12C5 13.1046 5.89543 14 7 14Z"
                fill = "currentColor" /> < path d =
                "M19 12C19 13.1046 18.1046 14 17 14C15.8954 14 15 13.1046 15 12C15 10.8954 15.8954 10 17 10C18.1046 10 19 10.8954 19 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M7 5C3.13401 5 0 8.13401 0 12C0 15.866 3.13401 19 7 19H17C20.866 19 24 15.866 24 12C24 8.13401 20.866 5 17 5H7ZM17 8H7C4.79086 8 3 9.79086 3 12C3 14.2091 4.79086 16 7 16H17C19.2091 16 21 14.2091 21 12C21 9.79086 19.2091 8 17 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMicrosoft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMicrosoft"
                .to_owned()) } < / title > < path d = "M3 3H11V11H3V3Z" fill =
                "currentColor" /> < path d = "M3 13H11V21H3V13Z" fill = "currentColor" />
                < path d = "M13 3H21V11H13V3Z" fill = "currentColor" /> < path d =
                "M13 13H21V21H13V13Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgMiniPlayer")]
        Icon::CgMiniPlayer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMiniPlayer"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM6 5H18C18.5523 5 19 5.44772 19 6V12.2676C18.7058 12.0974 18.3643 12 18 12H14C12.8954 12 12 12.8954 12 14V18C12 18.3643 12.0974 18.7058 12.2676 19H6C5.44772 19 5 18.5523 5 18V6C5 5.44772 5.44772 5 6 5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMinimize => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMinimize"
                .to_owned()) } < / title > < path d = "M9 9H3V7H7V3H9V9Z" fill =
                "currentColor" /> < path d = "M9 15H3V17H7V21H9V15Z" fill =
                "currentColor" /> < path d = "M21 15H15V21H17V17H21V15Z" fill =
                "currentColor" /> < path d =
                "M15 9.00012H21V7.00012H17V3.00012H15V9.00012Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMinimizeAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMinimizeAlt"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgModem => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgModem"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMonday => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMonday"
                .to_owned()) } < / title > < path d =
                "M6.77857 6.13915C7.7289 4.78193 9.59953 4.45209 10.9568 5.40242C12.314 6.35275 12.6438 8.22339 11.6935 9.58061L5.95771 17.7721C5.00738 19.1293 3.13674 19.4592 1.77953 18.5089C0.422312 17.5585 0.0924684 15.6879 1.0428 14.3307L6.77857 6.13915Z"
                fill = "currentColor" /> < path d =
                "M15.2678 6.22811C16.2182 4.8709 18.0888 4.54105 19.446 5.49138C20.8032 6.44172 21.1331 8.31235 20.1827 9.66957L14.447 17.8611C13.4966 19.2183 11.626 19.5481 10.2688 18.5978C8.91158 17.6475 8.58173 15.7768 9.53207 14.4196L15.2678 6.22811Z"
                fill = "currentColor" /> < path d =
                "M20.5 18.8596C22.1569 18.8596 23.5 17.5165 23.5 15.8596C23.5 14.2028 22.1569 12.8596 20.5 12.8596C18.8431 12.8596 17.5 14.2028 17.5 15.8596C17.5 17.5165 18.8431 18.8596 20.5 18.8596Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMoon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoon"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgMore => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMore"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 15C6.65685 15 8 13.6569 8 12C8 10.3431 6.65685 9 5 9C3.34315 9 2 10.3431 2 12C2 13.6569 3.34315 15 5 15ZM5 13C5.55228 13 6 12.5523 6 12C6 11.4477 5.55228 11 5 11C4.44772 11 4 11.4477 4 12C4 12.5523 4.44772 13 5 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15ZM12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 13.6569 20.6569 15 19 15C17.3431 15 16 13.6569 16 12C16 10.3431 17.3431 9 19 9C20.6569 9 22 10.3431 22 12ZM20 12C20 12.5523 19.5523 13 19 13C18.4477 13 18 12.5523 18 12C18 11.4477 18.4477 11 19 11C19.5523 11 20 11.4477 20 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMoreAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoreAlt"
                .to_owned()) } < / title > < path d =
                "M8 12C8 13.1046 7.10457 14 6 14C4.89543 14 4 13.1046 4 12C4 10.8954 4.89543 10 6 10C7.10457 10 8 10.8954 8 12Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
        ...
        Icon::CgMoreO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoreO"
                .to_owned()) } < / title > < path d =
                "M7 14C8.10457 14 9 13.1046 9 12C9 10.8954 8.10457 10 7 10C5.89543 10 5 10.8954 5 12C5 13.1046 5.89543 14 7 14Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
        ...
        Icon::CgMoreR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoreR"
                .to_owned()) } < / title > < path d =
                "M7 14C8.10457 14 9 13.1046 9 12C9 10.8954 8.10457 10 7 10C5.89543 10 5 10.8954 5 12C5 13.1046 5.89543 14 7 14Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
                ...
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M0 5C0 3.34315 1.34315 2 3 2H21C22.6569 2 24 3.34315 24 5V19C24 20.6569 22.6569 22 21 22H3C1.34315 22 0 20.6569 0 19V5ZM3 4H21C21.5523 4 22 4.44772 22 5V19C22 19.5523 21.5523 20 21 20H3C2.44772 20 2 19.5523 2 19V5C2 4.44772 2.44771 4 3 4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMoreVerticalAlt => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgMoreVerticalAlt".to_owned()) } < / title > < path d =
                "M14 6C14 7.10457 13.1046 8 12 8C10.8954 8 10 7.10457 10 6C10 4.89543 10.8954 4 12 4C13.1046 4 14 4.89543 14 6Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgMoreVerticalO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoreVerticalO"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMoreVerticalR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoreVerticalR"
                .to_owned()) } < / title > < path d =
                "M12 9C13.1046 9 14 8.10457 14 7C14 5.89543 13.1046 5 12 5C10.8954 5 10 5.89543 10 7C10 8.10457 10.8954 9 12 9Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z"
                ...
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 3C2 1.34315 3.34315 0 5 0H19C20.6569 0 22 1.34315 22 3V21C22 22.6569 20.6569 24 19 24H5C3.34315 24 2 22.6569 2 21V3ZM5 2H19C19.5523 2 20 2.44771 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V3C4 2.44772 4.44772 2 5 2Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMouse => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMouse"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgMoveDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoveDown"
                .to_owned()) } < / title > < path d = "M7 5H9V13H7V5Z" fill =
                "currentColor" /> < path d = "M15 5H17V13H15V5Z" fill = "currentColor" />
                < path d =
        ...
        Icon::CgMoveLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoveLeft"
                .to_owned()) } < / title > < path d = "M19.071 17V15H11.071V17H19.071Z"
                fill = "currentColor" /> < path d = "M19.071 9V7H11.071V9H19.071Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgMoveRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoveRight"
                .to_owned()) } < / title > < path d = "M5 17V15H13V17H5Z" fill =
                "currentColor" /> < path d = "M5 9V7H13V9H5Z" fill = "currentColor" /> <
                path d =
        ...
        Icon::CgMoveTask => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoveTask"
                .to_owned()) } < / title > < path d = "M18.9641 7H10.9641V9H18.9641V7Z"
                fill = "currentColor" /> < path d =
                "M6 8.82864V15.1714L9.9642 12L6 8.82864Z" fill = "currentColor" /> < path
                d = "M18.9641 11H10.9641V13H18.9641V11Z" fill = "currentColor" /> < path
                d = "M10.9641 15H18.9641V17H10.9641V15Z" fill = "currentColor" /> < / svg
                >
            }
                .into_view(cx)
        }
        ...
        Icon::CgMoveUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMoveUp"
                .to_owned()) } < / title > < path d = "M17 19.071H15V11.071H17V19.071Z"
                fill = "currentColor" /> < path d = "M9 19.071H7V11.071H9V19.071Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgMusic => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMusic"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgMusicNote => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMusicNote"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgMusicSpeaker => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgMusicSpeaker"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgNametag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgNametag"
                .to_owned()) } < / title > < path d = "M4 14V20H10V18H6V14H4Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d = "M9 9V15H15V9H9ZM13 11H11V13H13V11Z" fill = "currentColor" /> < path
                d = "M4 10V4H10V6H6V10H4Z" fill = "currentColor" /> < path d =
                "M20 10V4H14V6H18V10H20Z" fill = "currentColor" /> < path d =
                "M20 14V20H14V18H18V14H20Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgNotes")]
        Icon::CgNotes => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgNotes"
                .to_owned()) } < / title > < path d =
                "M6 6C6 5.44772 6.44772 5 7 5H17C17.5523 5 18 5.44772 18 6C18 6.55228 17.5523 7 17 7H7C6.44771 7 6 6.55228 6 6Z"
                fill = "currentColor" /> < path d =
                "M6 10C6 9.44771 6.44772 9 7 9H17C17.5523 9 18 9.44771 18 10C18 10.5523 17.5523 11 17 11H7C6.44771 11 6 10.5523 6 10Z"
                fill = "currentColor" /> < path d =
                "M7 13C6.44772 13 6 13.4477 6 14C6 14.5523 6.44771 15 7 15H17C17.5523 15 18 14.5523 18 14C18 13.4477 17.5523 13 17 13H7Z"
                fill = "currentColor" /> < path d =
                "M6 18C6 17.4477 6.44772 17 7 17H11C11.5523 17 12 17.4477 12 18C12 18.5523 11.5523 19 11 19H7C6.44772 19 6 18.5523 6 18Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 4C2 2.34315 3.34315 1 5 1H19C20.6569 1 22 2.34315 22 4V20C22 21.6569 20.6569 23 19 23H5C3.34315 23 2 21.6569 2 20V4ZM5 3H19C19.5523 3 20 3.44771 20 4V20C20 20.5523 19.5523 21 19 21H5C4.44772 21 4 20.5523 4 20V4C4 3.44772 4.44771 3 5 3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgNotifications => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgNotifications"
                .to_owned()) } < / title > < path d =
                "M20 7C20 8.65685 18.6569 10 17 10C15.3431 10 14 8.65685 14 7C14 5.34315 15.3431 4 17 4C18.6569 4 20 5.34315 20 7Z"
                fill = "currentColor" /> < path d = "M12 6H4V20H18V12H16V18H6V8H12V6Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgNpm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgNpm"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 21C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5ZM6 18V6H18V18H15V9H12V18H6Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgOculus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgOculus"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16 10H8C6.89543 10 6 10.8954 6 12C6 13.1046 6.89543 14 8 14H16C17.1046 14 18 13.1046 18 12C18 10.8954 17.1046 10 16 10ZM8 6C4.68629 6 2 8.68629 2 12C2 15.3137 4.68629 18 8 18H16C19.3137 18 22 15.3137 22 12C22 8.68629 19.3137 6 16 6H8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgOpenCollective => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgOpenCollective".to_owned()) } < / title > < path d =
        ...
        Icon::CgOptions => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgOptions"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgOrganisation => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgOrganisation"
                .to_owned()) } < / title > < path d = "M17 15H19V17H17V15Z" fill =
                "currentColor" /> < path d = "M19 11H17V13H19V11Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgOverflow => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgOverflow"
                .to_owned()) } < / title > < path opacity = "0.2" d =
                ...
                fill = "currentColor" /> < path opacity = "0.3" d =
        ...
        Icon::CgPacman => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPacman"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgPassword => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPassword"
                .to_owned()) } < / title > < path d =
                "M6 12C6 12.5523 5.55228 13 5 13C4.44772 13 4 12.5523 4 12C4 11.4477 4.44772 11 5 11C5.55228 11 6 11.4477 6 12Z"
                fill = "currentColor" /> < path d =
                "M9 13C9.55228 13 10 12.5523 10 12C10 11.4477 9.55228 11 9 11C8.44771 11 8 11.4477 8 12C8 12.5523 8.44771 13 9 13Z"
                fill = "currentColor" /> < path d =
                "M14 12C14 12.5523 13.5523 13 13 13C12.4477 13 12 12.5523 12 12C12 11.4477 12.4477 11 13 11C13.5523 11 14 11.4477 14 12Z"
                fill = "currentColor" /> < path d = "M20 11H16V13H20V11Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M2 6C0.895431 6 0 6.89543 0 8V16C0 17.1046 0.89543 18 2 18H22C23.1046 18 24 17.1046 24 16V8C24 6.89543 23.1046 6 22 6H2ZM22 8H2L2 16H22V8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathBack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathBack"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M9 14H4V4H14V9H19V19H9V14ZM6 6H12V12H6V6Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathCrop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathCrop"
                .to_owned()) } < / title > < rect opacity = "0.5" x = "6" y = "6" width =
                "8" height = "8" stroke = "currentColor" stroke - width = "2" /> < path
                fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M9 9H19V19H9V9ZM15 11H17V17H11V15H15V11Z" fill = "currentColor" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathDivide => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathDivide"
                .to_owned()) } < / title > < path d = "M5 5H15V9H9V15H5V5Z" fill =
                "currentColor" /> < path d = "M9 15V19H19V9H15V15H9Z" fill =
                "currentColor" /> < path d = "M10 10H14V14H10V10Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathExclude => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathExclude"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M5 5H15V9H9V15H5V5ZM9 15V19H19V9H15V15H9Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathFront => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathFront"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M5 5H15V9H19V19H9V15H5V5ZM11 11V17H17V11H11Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathIntersect => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathIntersect"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M15 5H5V15H9V19H19V9H15V5ZM13 7H7V13H9V9H13V7ZM17 17H11V15H15V11H17V17Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathOutline => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathOutline"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 5H15V9H19V19H9V15H5V5ZM7 7H13V9H9V13H7V7ZM11 17H17V11H15V15H11V17ZM13 11H11V13H13V11Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathTrim => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathTrim"
                .to_owned()) } < / title > < path d = "M5 5H15V8H8V15H5V5Z" fill =
                "currentColor" /> < path d = "M19 9H9V19H19V9Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPathUnite => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPathUnite"
                .to_owned()) } < / title > < path d = "M15 5H5V15H9V19H19V9H15V5Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPatreon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPatreon"
                .to_owned()) } < / title > < path opacity = "0.5" d =
                "M21 10C21 13.3137 18.3137 16 15 16C11.6863 16 9 13.3137 9 10C9 6.68629 11.6863 4 15 4C18.3137 4 21 6.68629 21 10Z"
                fill = "currentColor" /> < path d = "M3 4H7V20H3V4Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPaypal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPaypal"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M6.47005 3.54443H14.4701C16.1089 3.54443 17.4146 4.31866 18.0963 5.51496C19.3165 6.38743 19.9427 7.91487 19.6082 9.65332C19.0865 12.365 16.425 14.5633 13.6636 14.5633H11.6636L10.5301 20.4553H6.39824L6.62891 19.2563H3.44727L6.47005 3.54443ZM8.0922 5.50842H14.0922C15.7491 5.50842 16.8385 6.82737 16.5254 8.45439C16.2124 10.0814 14.6155 11.4004 12.9587 11.4004H8.95866L7.82511 17.2923H5.82511L8.0922 5.50842Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPen"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M21.2635 2.29289C20.873 1.90237 20.2398 1.90237 19.8493 2.29289L18.9769 3.16525C17.8618 2.63254 16.4857 2.82801 15.5621 3.75165L4.95549 14.3582L10.6123 20.0151L21.2189 9.4085C22.1426 8.48486 22.338 7.1088 21.8053 5.99367L22.6777 5.12132C23.0682 4.7308 23.0682 4.09763 22.6777 3.70711L21.2635 2.29289ZM16.9955 10.8035L10.6123 17.1867L7.78392 14.3582L14.1671 7.9751L16.9955 10.8035ZM18.8138 8.98525L19.8047 7.99429C20.1953 7.60376 20.1953 6.9706 19.8047 6.58007L18.3905 5.16586C18 4.77534 17.3668 4.77534 16.9763 5.16586L15.9853 6.15683L18.8138 8.98525Z"
                fill = "currentColor" /> < path d =
                "M2 22.9502L4.12171 15.1717L9.77817 20.8289L2 22.9502Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPentagonBottomLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPentagonBottomLeft".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgPentagonBottomRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPentagonBottomRight".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgPentagonDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPentagonDown"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPentagonLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPentagonLeft"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPentagonRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPentagonRight"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M8 12L6 7H16L18 12L16 17H6L8 12ZM8.95407 15L10.1541 12L8.95407 9H14.6459L15.8459 12L14.6459 15H8.95407Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPentagonTopLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPentagonTopLeft".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgPentagonTopRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPentagonTopRight".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgPentagonUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPentagonUp"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPerformance => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPerformance"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M11 9V13.1707C9.83481 13.5825 9 14.6938 9 16C9 17.6569 10.3431 19 12 19C13.6569 19 15 17.6569 15 16C15 14.6938 14.1652 13.5825 13 13.1707V9H11ZM11 16C11 15.4477 11.4477 15 12 15C12.5523 15 13 15.4477 13 16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16Z"
                fill = "currentColor" /> < path d =
                "M12 5C15.866 5 19 8.13401 19 12V13H17V12C17 9.23858 14.7614 7 12 7C9.23858 7 7 9.23858 7 12V13H5V12C5 8.13401 8.13401 5 12 5Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgPexels => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPexels"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPhone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPhone"
                .to_owned()) } < / title > < path d =
                "M22 12C22 10.6868 21.7413 9.38647 21.2388 8.1731C20.7362 6.95996 19.9997 5.85742 19.0711 4.92896C18.1425 4.00024 17.0401 3.26367 15.8268 2.76123C14.6136 2.25854 13.3132 2 12 2V4C13.0506 4 14.0909 4.20703 15.0615 4.60889C16.0321 5.01099 16.914 5.60034 17.6569 6.34326C18.3997 7.08594 18.989 7.96802 19.391 8.93848C19.7931 9.90918 20 10.9495 20 12H22Z"
                fill = "currentColor" /> < path d =
                "M2 10V5C2 4.44775 2.44772 4 3 4H8C8.55228 4 9 4.44775 9 5V9C9 9.55225 8.55228 10 8 10H6C6 14.4182 9.58173 18 14 18V16C14 15.4478 14.4477 15 15 15H19C19.5523 15 20 15.4478 20 16V21C20 21.5522 19.5523 22 19 22H14C7.37259 22 2 16.6274 2 10Z"
                fill = "currentColor" /> < path d =
                "M17.5433 9.70386C17.8448 10.4319 18 11.2122 18 12H16.2C16.2 11.4485 16.0914 10.9023 15.8803 10.3928C15.6692 9.88306 15.3599 9.42017 14.9698 9.03027C14.5798 8.64014 14.1169 8.33081 13.6073 8.11963C13.0977 7.90869 12.5515 7.80005 12 7.80005V6C12.7879 6 13.5681 6.15527 14.2961 6.45679C15.024 6.7583 15.6855 7.2002 16.2426 7.75732C16.7998 8.31445 17.2418 8.97583 17.5433 9.70386Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPhotoscan => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPhotoscan"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgPiano => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPiano"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 21C23.1046 21 24 20.1046 24 19V5C24 3.89543 23.1046 3 22 3H3C1.89543 3 1 3.89543 1 5V19C1 20.1046 1.89543 21 3 21H22ZM11 5H8.98486V13H7.98511V19H12V13H11V5ZM18.0151 19H22V5H19.0151V13H18.0151V19ZM17.0151 13H16.0151V5H14V13H13V19H17.0151V13ZM6.98511 19V13H5.98486V5H3L3 19H6.98511Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPill => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPill"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPin => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPin"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.06298 10.063 6.27212 12.2721 6.27212C14.4813 6.27212 16.2721 8.06298 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16755 11.1676 8.27212 12.2721 8.27212C13.3767 8.27212 14.2721 9.16755 14.2721 10.2721Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5.79417 16.5183C2.19424 13.0909 2.05438 7.39409 5.48178 3.79417C8.90918 0.194243 14.6059 0.054383 18.2059 3.48178C21.8058 6.90918 21.9457 12.6059 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.97318 6.93028 5.17324C9.59603 2.3733 14.0268 2.26452 16.8268 4.93028C19.6267 7.59603 19.7355 12.0268 17.0698 14.8268Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPinAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPinAlt"
                .to_owned()) } < / title > < path d =
                "M12 11C13.1046 11 14 10.1046 14 9C14 7.89543 13.1046 7 12 7C10.8954 7 10 7.89543 10 9C10 10.1046 10.8954 11 12 11Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M18 9C18 11.973 15.8377 14.441 13 14.917V20C13 20.5523 12.5523 21 12 21C11.4477 21 11 20.5523 11 20V14.917C8.16229 14.441 6 11.973 6 9C6 5.68629 8.68629 3 12 3C15.3137 3 18 5.68629 18 9ZM12 13C14.2091 13 16 11.2091 16 9C16 6.79086 14.2091 5 12 5C9.79086 5 8 6.79086 8 9C8 11.2091 9.79086 13 12 13Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPinTop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPinTop"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgPlayBackwards => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayBackwards"
                .to_owned()) } < / title > < path d = "M2 7H5V17H2V7Z" fill =
                "currentColor" /> < path d = "M6 12L13.0023 7.00003V17L6 12Z" fill =
                "currentColor" /> < path d = "M21.0023 7.00003L14 12L21.0023 17V7.00003Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayButton => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayButton"
                .to_owned()) } < / title > < path d =
                "M15 12.3301L9 16.6603L9 8L15 12.3301Z" fill = "currentColor" /> < / svg
                >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayButtonO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayButtonO"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21ZM12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23Z"
                fill = "currentColor" /> < path d = "M16 12L10 16.3301V7.66987L16 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayButtonR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayButtonR"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3ZM5 1C2.79086 1 1 2.79086 1 5V19C1 21.2091 2.79086 23 5 23H19C21.2091 23 23 21.2091 23 19V5C23 2.79086 21.2091 1 19 1H5Z"
                fill = "currentColor" /> < path d = "M16 12L10 16.3301V7.66987L16 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        ...
        Icon::CgPlayForwards => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayForwards"
                .to_owned()) } < / title > < path d = "M21.0023 17H18.0023V7H21.0023V17Z"
                fill = "currentColor" /> < path d = "M17.0023 12L10 17V7L17.0023 12Z"
                fill = "currentColor" /> < path d = "M2 17L9.00232 12L2 7V17Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayList"
                .to_owned()) } < / title > < path d = "M16 5H4V7H16V5Z" fill =
                "currentColor" /> < path d = "M16 9H4V11H16V9Z" fill = "currentColor" />
                < path d = "M4 13H12V15H4V13Z" fill = "currentColor" /> < path d =
                "M20 16L14 13V19L20 16Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgPlayListAdd")]
        Icon::CgPlayListAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayListAdd"
                .to_owned()) } < / title > < path d = "M2 5H14V7H2V5Z" fill =
                "currentColor" /> < path d = "M2 9H14V11H2V9Z" fill = "currentColor" /> <
                path d = "M10 13H2V15H10V13Z" fill = "currentColor" /> < path d =
                "M16 9H18V13H22V15H18V19H16V15H12V13H16V9Z" fill = "currentColor" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayListCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayListCheck"
                .to_owned()) } < / title > < path d = "M15 6H3V8H15V6Z" fill =
                "currentColor" /> < path d = "M15 10H3V12H15V10Z" fill = "currentColor"
                /> < path d = "M3 14H11V16H3V14Z" fill = "currentColor" /> < path d =
        ...
        Icon::CgPlayListRemove => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayListRemove".to_owned()) } < / title > < path d =
                "M15.9644 4.63379H3.96442V6.63379H15.9644V4.63379Z" fill = "currentColor"
                /> < path d = "M15.9644 8.63379H3.96442V10.6338H15.9644V8.63379Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgPlayListSearch => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayListSearch".to_owned()) } < / title > < path d =
                "M15.8787 4.87866H3.87872V6.87866H15.8787V4.87866Z" fill = "currentColor"
                /> < path d = "M15.8787 8.87866H3.87872V10.8787H15.8787V8.87866Z" fill =
                "currentColor" /> < path d =
                "M3.87872 12.8787H11.8787V14.8787H3.87872V12.8787Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M13.7574 12.7573C12.5858 13.9289 12.5858 15.8284 13.7574 17C14.681 17.9236 16.0571 18.1191 17.1722 17.5864L18.7071 19.1213L20.1213 17.7071L18.5864 16.1722C19.1191 15.057 18.9236 13.681 18 12.7573C16.8284 11.5858 14.9289 11.5858 13.7574 12.7573ZM15.1716 15.5858C15.5621 15.9763 16.1953 15.9763 16.5858 15.5858C16.9763 15.1952 16.9763 14.5621 16.5858 14.1716C16.1953 13.781 15.5621 13.781 15.1716 14.1716C14.7811 14.5621 14.7811 15.1952 15.1716 15.5858Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayPause => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayPause"
                .to_owned()) } < / title > < path d = "M11 7H8V17H11V7Z" fill =
                "currentColor" /> < path d = "M13 17H16V7H13V17Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayPauseO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayPauseO"
                .to_owned()) } < / title > < path d = "M9 9H11V15H9V9Z" fill =
                "currentColor" /> < path d = "M15 15H13V9H15V15Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
            }
        ...
        Icon::CgPlayPauseR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayPauseR"
                .to_owned()) } < / title > < path d = "M9 9H11V15H9V9Z" fill =
                "currentColor" /> < path d = "M15 15H13V9H15V15Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
        ...
        Icon::CgPlayStop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayStop"
                .to_owned()) } < / title > < path d = "M7 7H17V17H7V7Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayStopO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayStopO"
                .to_owned()) } < / title > < path d = "M15 9H9V15H15V9Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgPlayStopR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayStopR"
                .to_owned()) } < / title > < path d = "M15 9H9V15H15V9Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
        ...
        Icon::CgPlayTrackNext => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayTrackNext"
                .to_owned()) } < / title > < path d = "M6 17L14 12L6 7V17Z" fill =
                "currentColor" /> < path d = "M18 7H15V12V17H18V7Z" fill = "currentColor"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayTrackNextO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayTrackNextO".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21ZM1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12ZM14 9C14 8.44772 14.4477 8 15 8C15.5523 8 16 8.44772 16 9V15C16 15.5523 15.5523 16 15 16C14.4477 16 14 15.5523 14 15V9ZM13 12L7 15.4641V8.5359L13 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayTrackNextR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayTrackNextR".to_owned()) } < / title > < path d =
                "M15 9C15 8.44772 15.4477 8 16 8C16.5523 8 17 8.44772 17 9V15C17 15.5523 16.5523 16 16 16C15.4477 16 15 15.5523 15 15V9Z"
                fill = "currentColor" /> < path d = "M14 12L8 15.4641V8.5359L14 12Z" fill
                = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
            }
        ...
        Icon::CgPlayTrackPrev => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlayTrackPrev"
                .to_owned()) } < / title > < path d = "M18 17L10 12L18 7V17Z" fill =
                "currentColor" /> < path d = "M6 7H9V17H6V7Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayTrackPrevO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayTrackPrevO".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M8 8C8.55228 8 9 8.44772 9 9V15C9 15.5523 8.55228 16 8 16C7.44771 16 7 15.5523 7 15V9C7 8.44772 7.44771 8 8 8ZM16 15.4641L10 12L16 8.5359V15.4641Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12ZM12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPlayTrackPrevR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPlayTrackPrevR".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M8 8C8.55228 8 9 8.44772 9 9V15C9 15.5523 8.55228 16 8 16C7.44771 16 7 15.5523 7 15V9C7 8.44772 7.44771 8 8 8ZM16 15.4641L10 12L16 8.5359V15.4641Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPlug => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPlug"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPocket => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPocket"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPokemon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPokemon"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPolaroid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPolaroid"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 4C3 2.89543 3.89543 2 5 2H19C20.1046 2 21 2.89543 21 4V20C21 21.1046 20.1046 22 19 22H5C3.89543 22 3 21.1046 3 20V4ZM5 4H19V15H5V4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPoll => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPoll"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M11 7H13V17H11V7Z" fill =
                "currentColor" /> < path d = "M15 13H17V17H15V13Z" fill = "currentColor"
                /> < path d = "M7 10H9V17H7V10Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgPresentation")]
        Icon::CgPresentation => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPresentation"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPrinter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPrinter"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgProductHunt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgProductHunt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgProfile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgProfile"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16 9C16 11.2091 14.2091 13 12 13C9.79086 13 8 11.2091 8 9C8 6.79086 9.79086 5 12 5C14.2091 5 16 6.79086 16 9ZM14 9C14 10.1046 13.1046 11 12 11C10.8954 11 10 10.1046 10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgPullClear => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPullClear"
                .to_owned()) } < / title > < path d =
                "M4 6H2V16C2 17.1046 2.89543 18 4 18H20C21.1046 18 22 17.1046 22 16V6H20V16H4V6Z"
                fill = "currentColor" /> < path d = "M6 12H18V14H6V12Z" fill =
                "currentColor" /> < path d = "M18 8H6V10H18V8Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushChevronDown => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronDown".to_owned()) } < / title > < path d =
                "M5 7.41421L6.41421 6L12.0711 11.6569L17.7279 6L19.1421 7.41421L12.0711 14.4853L5 7.41421Z"
                fill = "currentColor" /> < path d = "M19 16.3432H5V18.3432H19V16.3432Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushChevronDownO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronDownO".to_owned()) } < / title > < path d =
                "M16 14V16H8V14H16Z" fill = "currentColor" /> < path d =
                "M7.75732 8.70261L9.17153 7.2884L12 10.1168L14.8284 7.28842L16.2426 8.70264L11.9999 12.9453L7.75732 8.70261Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgPushChevronDownR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronDownR".to_owned()) } < / title > < path d =
                "M9.17154 7.28839L7.75732 8.7026L11.9999 12.9453L16.2426 8.70263L14.8284 7.28842L12 10.1168L9.17154 7.28839Z"
                fill = "currentColor" /> < path d = "M8.00001 14H16V16H8.00001V14Z" fill
                = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgPushChevronLeft => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronLeft".to_owned()) } < / title > < path d =
                "M16.929 5L18.3432 6.41421L12.6863 12.0711L18.3432 17.7279L16.929 19.1421L9.85789 12.0711L16.929 5Z"
                fill = "currentColor" /> < path d = "M8 19V5H6V19H8Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushChevronLeftO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronLeftO".to_owned()) } < / title > < path d =
                "M10 16H8V8H10V16Z" fill = "currentColor" /> < path d =
                "M15.2974 7.75732L16.7116 9.17153L13.8832 12L16.7116 14.8284L15.2974 16.2426L11.0547 11.9999L15.2974 7.75732Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12ZM3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgPushChevronLeftR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronLeftR".to_owned()) } < / title > < path d =
        ...
        Icon::CgPushChevronRight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronRight".to_owned()) } < / title > < path d =
                "M7.41421 5L6 6.41421L11.6569 12.0711L6 17.7279L7.41421 19.1421L14.4853 12.0711L7.41421 5Z"
                fill = "currentColor" /> < path d = "M16.3432 19V5H18.3432V19H16.3432Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushChevronRightO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronRightO".to_owned()) } < / title > < path d =
                "M14 8H16V16H14V8Z" fill = "currentColor" /> < path d =
        ...
        Icon::CgPushChevronRightR => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronRightR".to_owned()) } < / title > < path d =
                "M7.64429 14.8284L9.0585 16.2426L13.3012 12L9.05853 7.75739L7.64432 9.1716L10.4727 12L7.64429 14.8284Z"
                fill = "currentColor" /> < path d =
                "M14.3559 16L14.3559 7.99996H16.3559V16H14.3559Z" fill = "currentColor"
                /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z"
                fill = "currentColor" /> < / svg >
            }
        ...
        Icon::CgPushChevronUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPushChevronUp"
                .to_owned()) } < / title > < path d =
                "M5 16.929L6.41421 18.3432L12.0711 12.6863L17.7279 18.3432L19.1421 16.929L12.0711 9.85789L5 16.929Z"
                fill = "currentColor" /> < path d = "M19 8H5V6H19V8Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushChevronUpO => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgPushChevronUpO".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgPushDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPushDown"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d = "M18 20.2877H6V22.2877H18V20.2877Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPushLeft"
                .to_owned()) } < / title > < path d =
                "M22.2877 11.0001V13.0001H7.80237L11.045 16.2428L9.63079 17.657L3.97394 12.0001L9.63079 6.34326L11.045 7.75748L7.80236 11.0001H22.2877Z"
                fill = "currentColor" /> < path d = "M3 18V6H1V18H3Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPushRight"
                .to_owned()) } < / title > < path d =
                "M1 12.9999V10.9999H15.4853L12.2427 7.75724L13.6569 6.34303L19.3137 11.9999L13.6569 17.6567L12.2427 16.2425L15.4853 12.9999H1Z"
                fill = "currentColor" /> < path d = "M20.2877 6V18H22.2877V6H20.2877Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgPushUp => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgPushUp"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M11.0001 22.2877H13.0001V7.80237L16.2428 11.045L17.657 9.63079L12.0001 3.97394L6.34326 9.63079L7.75748 11.045L11.0001 7.80236V22.2877ZM18 3H6V1H18V3Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgQr => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgQr"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M9 3H3V9H5V5H9V3ZM3 21V15H5V19H9V21H3ZM15 3V5H19V9H21V3H15ZM19 15H21V21H15V19H19V15ZM7 7H11V11H7V7ZM7 13H11V17H7V13ZM17 7H13V11H17V7ZM13 13H17V17H13V13Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgQuote => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgQuote"
                .to_owned()) } < / title > < path d =
                "M9.13456 9H12.1346L10 14.6075H7L9.13456 9Z" fill = "currentColor" /> <
                path d = "M14.1346 9H17.1346L15 14.6075H12L14.1346 9Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgQuoteO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgQuoteO"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgRadioCheck => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRadioCheck"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgRadioChecked => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRadioChecked"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgRatio => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRatio"
                .to_owned()) } < / title > < path d = "M4 6V12H6V8L10 8V6H4Z" fill =
                "currentColor" /> < path d = "M20 18H14V16H18V12H20V18Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgRead => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRead"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgReadme => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgReadme"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgRecord => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRecord"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgRedo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRedo"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgRemote => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRemote"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgRemove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRemove"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgRemoveR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRemoveR"
                .to_owned()) } < / title > < path d =
                "M8 11C7.44772 11 7 11.4477 7 12C7 12.5523 7.44772 13 8 13H16C16.5523 13 17 12.5523 17 12C17 11.4477 16.5523 11 16 11H8Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgRename => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRename"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgReorder => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgReorder"
                .to_owned()) } < / title > < path d =
                "M3 4C3 3.44772 3.44772 3 4 3H12C12.5523 3 13 3.44772 13 4C13 4.55228 12.5523 5 12 5H4C3.44772 5 3 4.55228 3 4Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M3 12C3 11.4477 3.44772 11 4 11H12C12.5523 11 13 11.4477 13 12C13 12.5523 12.5523 13 12 13H4C3.44772 13 3 12.5523 3 12Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M3 16C3 15.4477 3.44772 15 4 15H12C12.5523 15 13 15.4477 13 16C13 16.5523 12.5523 17 12 17H4C3.44772 17 3 16.5523 3 16Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path d =
                "M3 20C3 19.4477 3.44772 19 4 19H12C12.5523 19 13 19.4477 13 20C13 20.5523 12.5523 21 12 21H4C3.44772 21 3 20.5523 3 20Z"
                fill = "currentColor" fill - opacity = "0.5" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M15.1707 9C15.5825 10.1652 16.6938 11 18 11C19.6569 11 21 9.65685 21 8C21 6.34315 19.6569 5 18 5C16.6938 5 15.5825 5.83481 15.1707 7H4C3.44772 7 3 7.44772 3 8C3 8.55228 3.44772 9 4 9H15.1707ZM19 8C19 8.55228 18.5523 9 18 9C17.4477 9 17 8.55228 17 8C17 7.44772 17.4477 7 18 7C18.5523 7 19 7.44772 19 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgRepeat => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRepeat"
                .to_owned()) } < / title > < path d =
                "M18.3701 7.99993L13.8701 10.598V8.99993H6.88989V12.9999H4.88989V6.99993H13.8701V5.40186L18.3701 7.99993Z"
                fill = "currentColor" /> < path d =
                "M10.1299 16.9999H19.1101V10.9999H17.1101V14.9999H10.1299V13.4019L5.62988 15.9999L10.1299 18.598V16.9999Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgRing => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRing"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgRowFirst => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRowFirst"
                .to_owned()) } < / title > < g opacity = "0.5" > < path d =
                "M6 11C5.44772 11 5 11.4477 5 12C5 12.5523 5.44772 13 6 13H14C14.5523 13 15 12.5523 15 12C15 11.4477 14.5523 11 14 11H6Z"
                fill = "currentColor" /> < path d =
                "M6 15C5.44772 15 5 15.4477 5 16C5 16.5523 5.44772 17 6 17H14C14.5523 17 15 16.5523 15 16C15 15.4477 14.5523 15 14 15H6Z"
                fill = "currentColor" /> </ g > < path d =
                "M5 8C5 7.44772 5.44772 7 6 7H18C18.5523 7 19 7.44772 19 8C19 8.55228 18.5523 9 18 9H6C5.44772 9 5 8.55228 5 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgRowLast => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRowLast"
                .to_owned()) } < / title > < g opacity = "0.5" > < path d =
        ...
        Icon::CgRuler => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgRuler"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSandClock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSandClock"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgScan => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScan"
                .to_owned()) } < / title > < path d = "M11 3H13V21H11V3Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgScreen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScreen"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgScreenMirror => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScreenMirror"
                .to_owned()) } < / title > < path d =
                "M5 8H19V14H16V16H21V6H3V16H8V14H5V8Z" fill = "currentColor" /> < path d
                = "M16.3301 19L12 13L7.66987 19H16.3301Z" fill = "currentColor" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgScreenShot => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScreenShot"
                .to_owned()) } < / title > < path d = "M12 8V6H8V10H10V8H12Z" fill =
                "currentColor" /> < path d = "M14 14H16V18H12V16H14V14Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M4 3C4 2.44772 4.44772 2 5 2H19C19.5523 2 20 2.44772 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V3ZM6 20V4H18V20H6Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgScreenWide => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScreenWide"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgScrollH => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScrollH"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgScrollV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgScrollV"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSearch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSearch"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M18.319 14.4326C20.7628 11.2941 20.542 6.75347 17.6569 3.86829C14.5327 0.744098 9.46734 0.744098 6.34315 3.86829C3.21895 6.99249 3.21895 12.0578 6.34315 15.182C9.22833 18.0672 13.769 18.2879 16.9075 15.8442C16.921 15.8595 16.9351 15.8745 16.9497 15.8891L21.1924 20.1317C21.5829 20.5223 22.2161 20.5223 22.6066 20.1317C22.9971 19.7412 22.9971 19.1081 22.6066 18.7175L18.364 14.4749C18.3493 14.4603 18.3343 14.4462 18.319 14.4326ZM16.2426 5.28251C18.5858 7.62565 18.5858 11.4246 16.2426 13.7678C13.8995 16.1109 10.1005 16.1109 7.75736 13.7678C5.41421 11.4246 5.41421 7.62565 7.75736 5.28251C10.1005 2.93936 13.8995 2.93936 16.2426 5.28251Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSearchFound => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSearchFound"
                .to_owned()) } < / title > < path d =
                "M7.66542 10.2366L9.19751 8.951L10.4831 10.4831L13.5473 7.91194L14.8328 9.44402L10.2366 13.3007L7.66542 10.2366Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16.2071 4.89344C19.0923 7.77862 19.3131 12.3193 16.8693 15.4578C16.8846 15.4713 16.8996 15.4854 16.9143 15.5L21.1569 19.7427C21.5474 20.1332 21.5474 20.7664 21.1569 21.1569C20.7664 21.5474 20.1332 21.5474 19.7427 21.1569L15.5 16.9143C15.4854 16.8996 15.4713 16.8846 15.4578 16.8693C12.3193 19.3131 7.77862 19.0923 4.89344 16.2071C1.76924 13.083 1.76924 8.01763 4.89344 4.89344C8.01763 1.76924 13.083 1.76924 16.2071 4.89344ZM14.7929 14.7929C17.1361 12.4498 17.1361 8.6508 14.7929 6.30765C12.4498 3.96451 8.6508 3.96451 6.30765 6.30765C3.96451 8.6508 3.96451 12.4498 6.30765 14.7929C8.6508 17.1361 12.4498 17.1361 14.7929 14.7929Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSearchLoading => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSearchLoading"
                .to_owned()) } < / title > < path d =
                "M8.55024 10.5503C8.55024 11.1026 8.10253 11.5503 7.55024 11.5503C6.99796 11.5503 6.55024 11.1026 6.55024 10.5503C6.55024 9.99801 6.99796 9.55029 7.55024 9.55029C8.10253 9.55029 8.55024 9.99801 8.55024 10.5503Z"
                fill = "currentColor" /> < path d =
                "M10.5502 11.5503C11.1025 11.5503 11.5502 11.1026 11.5502 10.5503C11.5502 9.99801 11.1025 9.55029 10.5502 9.55029C9.99796 9.55029 9.55024 9.99801 9.55024 10.5503C9.55024 11.1026 9.99796 11.5503 10.5502 11.5503Z"
                fill = "currentColor" /> < path d =
                "M13.5502 11.5503C14.1025 11.5503 14.5502 11.1026 14.5502 10.5503C14.5502 9.99801 14.1025 9.55029 13.5502 9.55029C12.998 9.55029 12.5502 9.99801 12.5502 10.5503C12.5502 11.1026 12.998 11.5503 13.5502 11.5503Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M16.2071 4.89344C19.0922 7.7786 19.313 12.3192 16.8693 15.4577C16.8846 15.4712 16.8996 15.4853 16.9142 15.4999L21.1568 19.7426C21.5473 20.1331 21.5473 20.7663 21.1568 21.1568C20.7663 21.5473 20.1331 21.5473 19.7426 21.1568L15.5 16.9141C15.4853 16.8995 15.4713 16.8846 15.4578 16.8693C12.3193 19.3131 7.77858 19.0923 4.89338 16.2071C1.76918 13.083 1.76918 8.01763 4.89338 4.89344C8.01757 1.76924 13.0829 1.76924 16.2071 4.89344ZM6.30759 14.7929C8.65074 17.1361 12.4497 17.1361 14.7929 14.7929C17.136 12.4498 17.136 8.6508 14.7929 6.30765C12.4497 3.96451 8.65074 3.96451 6.30759 6.30765C3.96445 8.6508 3.96445 12.4498 6.30759 14.7929Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSelect => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSelect"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSelectO => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSelectO"
                .to_owned()) } < / title > < path d =
                "M9.17154 11.508L7.75732 10.0938L12 5.85114L16.2426 10.0938L14.8284 11.508L12 8.67956L9.17154 11.508Z"
                fill = "currentColor" /> < path d =
                "M9.17154 12.492L7.75732 13.9062L12 18.1489L16.2426 13.9062L14.8284 12.492L12 15.3204L9.17154 12.492Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgSelectR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSelectR"
                .to_owned()) } < / title > < path d =
                "M9.17154 11.508L7.75732 10.0938L12 5.85113L16.2426 10.0938L14.8284 11.508L12 8.67956L9.17154 11.508Z"
                fill = "currentColor" /> < path d =
                "M9.17154 12.492L7.75732 13.9062L12 18.1489L16.2426 13.9062L14.8284 12.492L12 15.3204L9.17154 12.492Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgServer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgServer"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgServerless => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgServerless"
                .to_owned()) } < / title > < path d = "M11.7872 6H5V9H10.6953L11.7872 6Z"
                fill = "currentColor" /> < path d =
                "M9.96735 11H5V14H8.87544L9.96735 11Z" fill = "currentColor" /> < path d
                = "M11.0038 14L12.0957 11H20V14H11.0038Z" fill = "currentColor" /> < path
                d = "M8.1475 16H5V19H7.05559L8.1475 16Z" fill = "currentColor" /> < path
                d = "M9.18394 19L10.2759 16H20V19H9.18394Z" fill = "currentColor" /> <
        ...
        Icon::CgShapeCircle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeCircle"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7C9.23858 7 7 9.23858 7 12C7 14.7614 9.23858 17 12 17ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgShapeHalfCircle => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgShapeHalfCircle".to_owned()) } < / title > < path d =
        ...
        Icon::CgShapeHexagon => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeHexagon"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgShapeRhombus => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeRhombus"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgShapeSquare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeSquare"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M17 7H7V17H17V7ZM4 4V20H20V4H4Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgShapeTriangle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeTriangle"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M11.6603 5L3 20H20.3205L11.6603 5ZM11.6603 11L8.19615 17H15.1244L11.6603 11Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgShapeZigzag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShapeZigzag"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgShare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShare"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgShield => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShield"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M7 8V13C7 15.7614 9.23858 18 12 18C14.7614 18 17 15.7614 17 13V8H7ZM5 4H19V13C19 16.866 15.866 20 12 20C8.13401 20 5 16.866 5 13V4Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgShoppingBag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShoppingBag"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 4H19C19.5523 4 20 4.44771 20 5V19C20 19.5523 19.5523 20 19 20H5C4.44772 20 4 19.5523 4 19V5C4 4.44772 4.44771 4 5 4ZM2 5C2 3.34315 3.34315 2 5 2H19C20.6569 2 22 3.34315 22 5V19C22 20.6569 20.6569 22 19 22H5C3.34315 22 2 20.6569 2 19V5ZM12 12C9.23858 12 7 9.31371 7 6H9C9 8.56606 10.6691 10 12 10C13.3309 10 15 8.56606 15 6H17C17 9.31371 14.7614 12 12 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgShoppingCart => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShoppingCart"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5.79166 2H1V4H4.2184L6.9872 16.6776H7V17H20V16.7519L22.1932 7.09095L22.5308 6H6.6552L6.08485 3.38852L5.79166 2ZM19.9869 8H7.092L8.62081 15H18.3978L19.9869 8Z"
                fill = "currentColor" /> < path d =
                "M10 22C11.1046 22 12 21.1046 12 20C12 18.8954 11.1046 18 10 18C8.89543 18 8 18.8954 8 20C8 21.1046 8.89543 22 10 22Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgShortcut => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShortcut"
                .to_owned()) } < / title > < path d =
                "M16.1925 7.70711C15.8019 7.31658 15.1688 7.31658 14.7782 7.70711L7.70718 14.7782C7.31665 15.1687 7.31665 15.8019 7.70718 16.1924C8.0977 16.5829 8.73087 16.5829 9.12139 16.1924L16.1925 9.12132C16.583 8.7308 16.583 8.09763 16.1925 7.70711Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM6 5H18C18.5523 5 19 5.44772 19 6V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18V6C5 5.44772 5.44772 5 6 5Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgShutterstock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgShutterstock"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSidebar => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSidebar"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M21 20H7V4H21V20ZM19 18H9V6H19V18Z" fill = "currentColor"
        ...
        Icon::CgSidebarOpen => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSidebarOpen"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 4H21V20H3V4ZM9 6H19V18H9V6Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSidebarRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSidebarRight"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 4H17V20H3V4ZM5 6H15V18H5V6Z" fill = "currentColor" /> <
                path d = "M21 4H19V20H21V4Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgSignal")]
        Icon::CgSignal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSignal"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSize => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSize"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 6V4H20V20H12V18H8V16H4V8H8V6H12ZM14 6H18V18H14V6ZM12 8H10V16H12V8ZM8 10V14H6V10H8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSketch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSketch"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M8.05592 8H16.0559V10H8.05592V8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSlack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSlack"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSleep => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSleep"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSmartHomeBoiler => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartHomeBoiler".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgSmartHomeCooker => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartHomeCooker".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgSmartHomeHeat => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmartHomeHeat"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSmartHomeLight => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartHomeLight".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgSmartHomeRefrigerator => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartHomeRefrigerator".to_owned()) } < / title > < path d =
                "M9 6C9 5.44772 9.44772 5 10 5C10.5523 5 11 5.44772 11 6V8C11 8.55228 10.5523 9 10 9C9.44772 9 9 8.55228 9 8V6Z"
                fill = "currentColor" /> < path d =
                "M10 13C9.44772 13 9 13.4477 9 14V16C9 16.5523 9.44772 17 10 17C10.5523 17 11 16.5523 11 16V14C11 13.4477 10.5523 13 10 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 4C5 2.34315 6.34315 1 8 1H16C17.6569 1 19 2.34315 19 4V20C19 21.6569 17.6569 23 16 23H8C6.34315 23 5 21.6569 5 20V4ZM8 3H16C16.5523 3 17 3.44772 17 4V10H7V4C7 3.44772 7.44772 3 8 3ZM7 12H17V20C17 20.5523 16.5523 21 16 21H8C7.44772 21 7 20.5523 7 20V12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSmartphone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmartphone"
                .to_owned()) } < / title > < path d = "M13 16H11V18H13V16Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgSmartphoneChip => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartphoneChip".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgSmartphoneRam => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmartphoneRam"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSmartphoneShake => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmartphoneShake".to_owned()) } < / title > < path d =
                "M13 14H11V16H13V14Z" fill = "currentColor" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M18 9H20V15H18V9Z" fill =
                "currentColor" /> < path d = "M0 14H2V10H0V14Z" fill = "currentColor" />
                < path d = "M6 15H4V9H6V15Z" fill = "currentColor" /> < path d =
                "M24 10H22V14H24V10Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgSmile")]
        Icon::CgSmile => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmile"
                .to_owned()) } < / title > < path d =
                "M16 13H14C14 14.1046 13.1046 15 12 15C10.8954 15 10 14.1046 10 13H8C8 15.2091 9.79086 17 12 17C14.2091 17 16 15.2091 16 13Z"
                fill = "currentColor" /> < path d =
                "M10 10C10 10.5523 9.55228 11 9 11C8.44772 11 8 10.5523 8 10C8 9.44771 8.44772 9 9 9C9.55228 9 10 9.44771 10 10Z"
                fill = "currentColor" /> < path d =
                "M15 11C15.5523 11 16 10.5523 16 10C16 9.44771 15.5523 9 15 9C14.4477 9 14 9.44771 14 10C14 10.5523 14.4477 11 15 11Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgSmileMouthOpen => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSmileMouthOpen".to_owned()) } < / title > < path d =
                "M12 17C14.2091 17 16 15.2091 16 13H8C8 15.2091 9.79086 17 12 17Z" fill =
                "currentColor" /> < path d =
                "M10 10C10 10.5523 9.55228 11 9 11C8.44772 11 8 10.5523 8 10C8 9.44772 8.44772 9 9 9C9.55228 9 10 9.44772 10 10Z"
                fill = "currentColor" /> < path d =
                "M15 11C15.5523 11 16 10.5523 16 10C16 9.44772 15.5523 9 15 9C14.4477 9 14 9.44772 14 10C14 10.5523 14.4477 11 15 11Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgSmileNeutral => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmileNeutral"
                .to_owned()) } < / title > < path d =
                "M9 11C9.55228 11 10 10.5523 10 10C10 9.44772 9.55228 9 9 9C8.44772 9 8 9.44772 8 10C8 10.5523 8.44772 11 9 11Z"
                fill = "currentColor" /> < path d =
                "M9 15C8.44772 15 8 15.4477 8 16C8 16.5523 8.44772 17 9 17H15C15.5523 17 16 16.5523 16 16C16 15.4477 15.5523 15 15 15H9Z"
                fill = "currentColor" /> < path d =
                "M16 10C16 10.5523 15.5523 11 15 11C14.4477 11 14 10.5523 14 10C14 9.44772 14.4477 9 15 9C15.5523 9 16 9.44772 16 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgSmileNoMouth => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmileNoMouth"
                .to_owned()) } < / title > < path d =
                "M10 10C10 10.5523 9.55228 11 9 11C8.44772 11 8 10.5523 8 10C8 9.44772 8.44772 9 9 9C9.55228 9 10 9.44772 10 10Z"
                fill = "currentColor" /> < path d =
                "M15 11C15.5523 11 16 10.5523 16 10C16 9.44772 15.5523 9 15 9C14.4477 9 14 9.44772 14 10C14 10.5523 14.4477 11 15 11Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSmileNone => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmileNone"
                .to_owned()) } < / title > < path d =
                "M8 9C7.44772 9 7 9.44772 7 10C7 10.5523 7.44772 11 8 11H9C9.55228 11 10 10.5523 10 10C10 9.44772 9.55228 9 9 9H8Z"
                fill = "currentColor" /> < path d =
                "M15 9C14.4477 9 14 9.44772 14 10C14 10.5523 14.4477 11 15 11H16C16.5523 11 17 10.5523 17 10C17 9.44772 16.5523 9 16 9H15Z"
                fill = "currentColor" /> < path d =
                "M9 15C8.44772 15 8 15.4477 8 16C8 16.5523 8.44772 17 9 17H15C15.5523 17 16 16.5523 16 16C16 15.4477 15.5523 15 15 15H9Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSmileSad => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmileSad"
                .to_owned()) } < / title > < path d =
                "M9 11C9.55228 11 10 10.5523 10 10C10 9.44772 9.55228 9 9 9C8.44772 9 8 9.44772 8 10C8 10.5523 8.44772 11 9 11Z"
                fill = "currentColor" /> < path d =
                "M14 17C14 15.8954 13.1046 15 12 15C10.8954 15 10 15.8954 10 17H8C8 14.7909 9.79086 13 12 13C14.2091 13 16 14.7909 16 17H14Z"
                fill = "currentColor" /> < path d =
                "M16 10C16 10.5523 15.5523 11 15 11C14.4477 11 14 10.5523 14 10C14 9.44772 14.4477 9 15 9C15.5523 9 16 9.44772 16 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSmileUpside => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSmileUpside"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSoftwareDownload => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSoftwareDownload".to_owned()) } < / title > < path d =
                "M11 5C11 4.44772 11.4477 4 12 4C12.5523 4 13 4.44772 13 5V12.1578L16.2428 8.91501L17.657 10.3292L12.0001 15.9861L6.34326 10.3292L7.75748 8.91501L11 12.1575V5Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgSoftwareUpload => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgSoftwareUpload".to_owned()) } < / title > < path d =
        ...
        Icon::CgSortAz => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSortAz"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSortZa => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSortZa"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgSpaceBetween => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpaceBetween"
                .to_owned()) } < / title > < path d =
                "M19 5L15 5L15 19H19V17H17L17 7L19 7V5Z" fill = "currentColor" /> < path
                d = "M5 5L9 5L9 19H5L5 17H7L7 7H5L5 5Z" fill = "currentColor" /> < path d
                = "M13 7V17H11L11 7H13Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgSpaceBetweenV")]
        Icon::CgSpaceBetweenV => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpaceBetweenV"
                .to_owned()) } < / title > < path d = "M5 5V9H19V5H17V7H7V5H5Z" fill =
                "currentColor" /> < path d = "M5 19V15H19V19H17V17H7V19H5Z" fill =
                "currentColor" /> < path d = "M7 11H17V13H7V11Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSpectrum => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpectrum"
                .to_owned()) } < / title > < path d =
                "M12 16H16C16 11.5817 12.4183 8 8 8V12C10.2091 12 12 13.7909 12 16Z" fill
                = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSpinner => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpinner"
                .to_owned()) } < / title > < path opacity = "0.2" fill - rule = "evenodd"
                clip - rule = "evenodd" d =
        ...
        Icon::CgSpinnerAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpinnerAlt"
                .to_owned()) } < / title > < path d =
                "M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z" fill =
                "currentColor" /> < / svg >
            }
        ...
        Icon::CgSpinnerTwo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpinnerTwo"
                .to_owned()) } < / title > < path opacity = "0.2" fill - rule = "evenodd"
                clip - rule = "evenodd" d =
                "M12 19C15.866 19 19 15.866 19 12C19 8.13401 15.866 5 12 5C8.13401 5 5 8.13401 5 12C5 15.866 8.13401 19 12 19ZM12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                fill = "currentColor" /> < path d =
        ...
        Icon::CgSpinnerTwoAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSpinnerTwoAlt"
                .to_owned()) } < / title > < path d =
                "M12 22C17.5228 22 22 17.5228 22 12H19C19 15.866 15.866 19 12 19V22Z"
                fill = "currentColor" /> < path d =
                "M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z" fill =
        ...
        Icon::CgSquare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSquare"
                .to_owned()) } < / title > < path d = "M14 10H10V14H14V10Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgStack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgStack"
                .to_owned()) } < / title > < path d = "M20 4V16H22V2H8V4H20Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d = "M2 8V22H16V8H2ZM14 10H4V20H14V10Z" fill = "currentColor" /> < path d
                = "M17 7H5V5H19V19H17V7Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgStark")]
        ...
        Icon::CgStopwatch => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgStopwatch"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgStories => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgStories"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgStudio => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgStudio"
                .to_owned()) } < / title > < path d = "M17 13H13V17H17V13Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d = "M3 3H21V21H3V3ZM5 5H19V19H5V5Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgStyle")]
        Icon::CgStyle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgStyle"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M13 21V13H21V21H13ZM15 15H19L19 19H15V15Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d = "M3 11L3 3L11 3V11H3ZM5 5L9 5V9L5 9L5 5Z" fill = "currentColor" /> <
                path d = "M18 6V12H16V8L12 8V6L18 6Z" fill = "currentColor" /> < path d =
                "M12 18H6L6 12H8L8 16H12V18Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgSun")]
        Icon::CgSun => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSun"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSupport => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSupport"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgSwap => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSwap"
                .to_owned()) } < / title > < path d =
                "M16 13V11.5H10V9.5H16V8L19 10.5L16 13Z" fill = "currentColor" /> < path
                d = "M8 17V15.5H14V13.5H8V12L5 14.5L8 17Z" fill = "currentColor" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSwapVertical => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSwapVertical"
                .to_owned()) } < / title > < path d =
                "M12 16H13.5L13.5 10H15.5L15.5 16H17L14.5 19L12 16Z" fill =
                "currentColor" /> < path d = "M8 8H9.5L9.5 14H11.5L11.5 8H13L10.5 5L8 8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSweden => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSweden"
                .to_owned()) } < / title > < path d = "M23 4H10V11H23V4Z" fill =
                "currentColor" /> < path d = "M23 13V20H10V13H23Z" fill = "currentColor"
                /> < path d = "M8 13V20H1V13H8Z" fill = "currentColor" /> < path d =
                "M1 11V4H8V11H1Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgSwiss")]
        Icon::CgSwiss => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSwiss"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 3V21H21V3H3ZM14 7H10V10H7V14H10V17H14V14H17V10H14V7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgSync => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgSync"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTab => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTab"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTag => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTag"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTally => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTally"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTapDouble => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTapDouble"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d =
                "M11.9235 1C14.7023 1 17.2164 2.13339 19.0286 3.96311L17.6144 5.37735C16.1641 3.90955 14.15 3 11.9235 3C9.77436 3 7.82311 3.84749 6.38577 5.22651L4.97131 3.81205C6.7708 2.07122 9.22207 1 11.9235 1Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M11.9233 5C13.5809 5 15.1038 5.5761 16.3029 6.53898L14.8768 7.9651C14.0493 7.35833 13.0281 7 11.9233 7C10.848 7 9.85204 7.33943 9.03662 7.91699L7.60779 6.48816C8.79686 5.55586 10.2952 5 11.9233 5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgTapSingle => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTapSingle"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTemplate => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTemplate"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M3 3V9H21V3H3ZM19 5H5V7H19V5Z" fill = "currentColor" /> <
                path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M3 11V21H11V11H3ZM9 13H5V19H9V13Z" fill = "currentColor" /> < path d =
                "M21 11H13V13H21V11Z" fill = "currentColor" /> < path d =
                "M13 15H21V17H13V15Z" fill = "currentColor" /> < path d =
                "M21 19H13V21H21V19Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgTennis")]
        Icon::CgTennis => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTennis"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTerminal => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTerminal"
                .to_owned()) } < / title > < path d =
                "M5.0333 14.8284L6.44751 16.2426L10.6902 12L6.44751 7.75733L5.0333 9.17155L7.86172 12L5.0333 14.8284Z"
                fill = "currentColor" /> < path d = "M15 14H11V16H15V14Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgTerrain => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTerrain"
                .to_owned()) } < / title > < path d = "M8 10L3 18H13L8 10Z" fill =
                "currentColor" /> < path d =
                "M10.5286 10.7543L13.5 6L21 18H15.0572L10.5286 10.7543Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgThermometer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgThermometer"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTikcode => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTikcode"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d = "M9 5H5V9H9V5ZM3 3V11H11V3H3Z" fill = "currentColor" /> <
                path fill - rule = "evenodd" clip - rule = "evenodd" d =
                "M19 5H15V9H19V5ZM13 3V11H21V3H13Z" fill = "currentColor" /> < path fill
                - rule = "evenodd" clip - rule = "evenodd" d =
                "M9 15H5V19H9V15ZM3 13V21H11V13H3Z" fill = "currentColor" /> < path d =
                "M13 13H15V21H13V13Z" fill = "currentColor" /> < path d =
                "M16 13H18V21H16V13Z" fill = "currentColor" /> < path d =
                "M19 13H21V21H19V13Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgTime")]
        Icon::CgTime => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTime"
                .to_owned()) } < / title > < path d = "M9 7H11V12H16V14H9V7Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgTimelapse => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTimelapse"
                .to_owned()) } < / title > < path d =
                "M12 19C10.067 19 8.31704 18.2165 7.05029 16.9498L12 12L12 5C15.866 5 19 8.13401 19 12C19 15.866 15.866 19 12 19Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgTimer => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTimer"
                .to_owned()) } < / title > < path d =
                ...
                fill = "currentColor" /> < path d =
                "M7.70711 8.70708C7.31658 9.0976 7.31658 9.73077 7.70711 10.1213L10.5355 12.9497C10.9261 13.3402 11.5592 13.3402 11.9497 12.9497C12.3403 12.5592 12.3403 11.926 11.9497 11.5355L9.12132 8.70708C8.7308 8.31655 8.09763 8.31655 7.70711 8.70708Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgToday => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToday"
                .to_owned()) } < / title > < rect opacity = "0.5" x = "7" y = "9" width =
                "10" height = "10" rx = "1" fill = "currentColor" /> < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
        ...
        Icon::CgToggleOff => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToggleOff"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgToggleOn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToggleOn"
                .to_owned()) } < / title > < path d =
                "M7 15C5.34315 15 4 13.6569 4 12C4 10.3431 5.34315 9 7 9C8.65685 9 10 10.3431 10 12C10 13.6569 8.65685 15 7 15Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M24 12C24 8.13401 20.866 5 17 5H7C3.13401 5 0 8.13401 0 12C0 15.866 3.13401 19 7 19H17C20.866 19 24 15.866 24 12ZM17 7H7C4.23858 7 2 9.23858 2 12C2 14.7614 4.23858 17 7 17H17C19.7614 17 22 14.7614 22 12C22 9.23858 19.7614 7 17 7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgToggleSquare => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToggleSquare"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgToggleSquareOff => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgToggleSquareOff".to_owned()) } < / title > < path d =
        ...
        Icon::CgToolbarBottom => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToolbarBottom"
                .to_owned()) } < / title > < path d = "M18 13H6V15H18V13Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M2 8C2 6.34315 3.34315 5 5 5H19C20.6569 5 22 6.34315 22 8V16C22 17.6569 20.6569 19 19 19H5C3.34315 19 2 17.6569 2 16V8ZM5 7H19C19.5523 7 20 7.44771 20 8V16C20 16.5523 19.5523 17 19 17H5C4.44772 17 4 16.5523 4 16V8C4 7.44772 4.44772 7 5 7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgToolbarLeft => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToolbarLeft"
                .to_owned()) } < / title > < path d = "M8 9H6V15H8V9Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M2 8C2 6.34315 3.34315 5 5 5H19C20.6569 5 22 6.34315 22 8V16C22 17.6569 20.6569 19 19 19H5C3.34315 19 2 17.6569 2 16V8ZM5 7H19C19.5523 7 20 7.44771 20 8V16C20 16.5523 19.5523 17 19 17H5C4.44772 17 4 16.5523 4 16V8C4 7.44772 4.44772 7 5 7Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgToolbarRight => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToolbarRight"
                .to_owned()) } < / title > < path d = "M16 9H18V15H16V9Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
                "M22 8C22 6.34315 20.6569 5 19 5H5C3.34315 5 2 6.34315 2 8V16C2 17.6569 3.34315 19 5 19H19C20.6569 19 22 17.6569 22 16V8ZM19 7H5C4.44772 7 4 7.44771 4 8V16C4 16.5523 4.44772 17 5 17H19C19.5523 17 20 16.5523 20 16V8C20 7.44772 19.5523 7 19 7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgToolbarTop => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToolbarTop"
                .to_owned()) } < / title > < path d = "M18 11H6V9H18V11Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgToolbox => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgToolbox"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTouchpad => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTouchpad"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTrack => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrack"
                .to_owned()) } < / title > < path d =
                "M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTranscript => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTranscript"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTrash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrash"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M17 5V4C17 2.89543 16.1046 2 15 2H9C7.89543 2 7 2.89543 7 4V5H4C3.44772 5 3 5.44772 3 6C3 6.55228 3.44772 7 4 7H5V18C5 19.6569 6.34315 21 8 21H16C17.6569 21 19 19.6569 19 18V7H20C20.5523 7 21 6.55228 21 6C21 5.44772 20.5523 5 20 5H17ZM15 4H9V5H15V4ZM17 7H7V18C7 18.5523 7.44772 19 8 19H16C16.5523 19 17 18.5523 17 18V7Z"
                fill = "currentColor" /> < path d = "M9 9H11V17H9V9Z" fill =
                "currentColor" /> < path d = "M13 9H15V17H13V9Z" fill = "currentColor" />
                < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgTree => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTree"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgTrello => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrello"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTrending => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrending"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTrendingDown => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrendingDown"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgTrophy => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTrophy"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M18 6H20V11H18V6Z" fill =
                "currentColor" /> < path d = "M6 6H4V11H6V6Z" fill = "currentColor" /> <
                / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgTv => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTv"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                ...
                fill = "currentColor" /> < path d = "M8 19.876H16V20.876H8V19.876Z" fill
                = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgTwilio => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTwilio"
                .to_owned()) } < / title > < path d =
                "M11 9C11 10.1046 10.1046 11 9 11C7.89543 11 7 10.1046 7 9C7 7.89543 7.89543 7 9 7C10.1046 7 11 7.89543 11 9Z"
                fill = "currentColor" /> < path d =
                "M17 9C17 10.1046 16.1046 11 15 11C13.8954 11 13 10.1046 13 9C13 7.89543 13.8954 7 15 7C16.1046 7 17 7.89543 17 9Z"
                fill = "currentColor" /> < path d =
                "M15 17C16.1046 17 17 16.1046 17 15C17 13.8954 16.1046 13 15 13C13.8954 13 13 13.8954 13 15C13 16.1046 13.8954 17 15 17Z"
                fill = "currentColor" /> < path d =
                "M11 15C11 16.1046 10.1046 17 9 17C7.89543 17 7 16.1046 7 15C7 13.8954 7.89543 13 9 13C10.1046 13 11 13.8954 11 15Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12ZM21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgTwitter => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgTwitter"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUiKit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUiKit"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUmbrella => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUmbrella"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUnavailable => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUnavailable"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUnblock => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUnblock"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUndo => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUndo"
                .to_owned()) } < / title > < path d =
                "M5.33929 4.46777H7.33929V7.02487C8.52931 6.08978 10.0299 5.53207 11.6607 5.53207C15.5267 5.53207 18.6607 8.66608 18.6607 12.5321C18.6607 16.3981 15.5267 19.5321 11.6607 19.5321C9.51025 19.5321 7.58625 18.5623 6.30219 17.0363L7.92151 15.8515C8.83741 16.8825 10.1732 17.5321 11.6607 17.5321C14.4222 17.5321 16.6607 15.2935 16.6607 12.5321C16.6607 9.77065 14.4222 7.53207 11.6607 7.53207C10.5739 7.53207 9.56805 7.87884 8.74779 8.46777L11.3393 8.46777V10.4678H5.33929V4.46777Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgUnfold => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUnfold"
                .to_owned()) } < / title > < path d =
                "M2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12H2Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgUnsplash => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUnsplash"
                .to_owned()) } < / title > < path d = "M15 4.5H9V8.5H15V4.5Z" fill =
                "currentColor" /> < path d = "M4 10.5H9V14.5H15V10.5H20V19.5H4V10.5Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgUsb => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUsb"
                .to_owned()) } < / title > < path d = "M10 4.5H11V6.5H10V4.5Z" fill =
                "currentColor" /> < path d = "M14 4.5H13V6.5H14V4.5Z" fill =
                "currentColor" /> < path fill - rule = "evenodd" clip - rule = "evenodd"
                d =
        ...
        Icon::CgUsbC => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUsbC"
                .to_owned()) } < / title > < path d =
                "M8 11C7.44772 11 7 11.4477 7 12C7 12.5523 7.44772 13 8 13H16C16.5523 13 17 12.5523 17 12C17 11.4477 16.5523 11 16 11H8Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUser => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUser"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgUserAdd => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUserAdd"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M8 11C10.2091 11 12 9.20914 12 7C12 4.79086 10.2091 3 8 3C5.79086 3 4 4.79086 4 7C4 9.20914 5.79086 11 8 11ZM8 9C9.10457 9 10 8.10457 10 7C10 5.89543 9.10457 5 8 5C6.89543 5 6 5.89543 6 7C6 8.10457 6.89543 9 8 9Z"
                fill = "currentColor" /> < path d =
                "M11 14C11.5523 14 12 14.4477 12 15V21H14V15C14 13.3431 12.6569 12 11 12H5C3.34315 12 2 13.3431 2 15V21H4V15C4 14.4477 4.44772 14 5 14H11Z"
                fill = "currentColor" /> < path d =
                "M18 7H20V9H22V11H20V13H18V11H16V9H18V7Z" fill = "currentColor" /> < /
                svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgUserList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUserList"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M8 11C10.2091 11 12 9.20914 12 7C12 4.79086 10.2091 3 8 3C5.79086 3 4 4.79086 4 7C4 9.20914 5.79086 11 8 11ZM8 9C9.10457 9 10 8.10457 10 7C10 5.89543 9.10457 5 8 5C6.89543 5 6 5.89543 6 7C6 8.10457 6.89543 9 8 9Z"
                fill = "currentColor" /> < path d =
                "M11 14C11.5523 14 12 14.4477 12 15V21H14V15C14 13.3431 12.6569 12 11 12H5C3.34315 12 2 13.3431 2 15V21H4V15C4 14.4477 4.44772 14 5 14H11Z"
                fill = "currentColor" /> < path d = "M22 11H16V13H22V11Z" fill =
                "currentColor" /> < path d = "M16 15H22V17H16V15Z" fill = "currentColor"
                /> < path d = "M22 7H16V9H22V7Z" fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "CgUserRemove")]
        Icon::CgUserRemove => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUserRemove"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M8 11C10.2091 11 12 9.20914 12 7C12 4.79086 10.2091 3 8 3C5.79086 3 4 4.79086 4 7C4 9.20914 5.79086 11 8 11ZM8 9C9.10457 9 10 8.10457 10 7C10 5.89543 9.10457 5 8 5C6.89543 5 6 5.89543 6 7C6 8.10457 6.89543 9 8 9Z"
                fill = "currentColor" /> < path d =
                "M11 14C11.5523 14 12 14.4477 12 15V21H14V15C14 13.3431 12.6569 12 11 12H5C3.34315 12 2 13.3431 2 15V21H4V15C4 14.4477 4.44772 14 5 14H11Z"
                fill = "currentColor" /> < path d = "M22 9H16V11H22V9Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgUserlane => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgUserlane"
                .to_owned()) } < / title > < path d = "M15 4H21V10H15V4Z" fill =
                "currentColor" /> < path d =
        ...
        Icon::CgViewCols => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewCols"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M2 8C2 6.34315 3.34315 5 5 5H19C20.6569 5 22 6.34315 22 8V16C22 17.6569 20.6569 19 19 19H5C3.34315 19 2 17.6569 2 16V8ZM16 7H19C19.5523 7 20 7.44771 20 8V16C20 16.5523 19.5523 17 19 17H16V7ZM14 7H10V17H14V7ZM8 17V7H5C4.44772 7 4 7.44772 4 8V16C4 16.5523 4.44772 17 5 17H8Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgViewComfortable => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "CgViewComfortable".to_owned()) } < / title > < path fill - rule =
                "evenodd" clip - rule = "evenodd" d =
                "M2 8C2 6.34315 3.34315 5 5 5H19C20.6569 5 22 6.34315 22 8V16C22 17.6569 20.6569 19 19 19H5C3.34315 19 2 17.6569 2 16V8ZM5 7H19C19.5523 7 20 7.44771 20 8V11H4V8C4 7.44772 4.44772 7 5 7ZM4 13V16C4 16.5523 4.44772 17 5 17H8V13H4ZM10 17H19C19.5523 17 20 16.5523 20 16V13H10V17Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgViewDay => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewDay"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgViewGrid => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewGrid"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgViewList => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewList"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgViewMonth => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewMonth"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgViewSplit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgViewSplit"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgVinyl => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgVinyl"
                .to_owned()) } < / title > < path d =
                "M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12ZM16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgVoicemail => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgVoicemail"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgVoicemailR => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgVoicemailR"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M11.5 12C11.5 12.3506 11.4398 12.6872 11.3293 13H13.6707C13.5602 12.6872 13.5 12.3506 13.5 12C13.5 10.3431 14.8431 9 16.5 9C18.1569 9 19.5 10.3431 19.5 12C19.5 13.6569 18.1569 15 16.5 15H8.5C6.84315 15 5.5 13.6569 5.5 12C5.5 10.3431 6.84315 9 8.5 9C10.1569 9 11.5 10.3431 11.5 12ZM9.5 12C9.5 12.5523 9.05228 13 8.5 13C7.94772 13 7.5 12.5523 7.5 12C7.5 11.4477 7.94772 11 8.5 11C9.05228 11 9.5 11.4477 9.5 12ZM17.5 12C17.5 12.5523 17.0523 13 16.5 13C15.9477 13 15.5 12.5523 15.5 12C15.5 11.4477 15.9477 11 16.5 11C17.0523 11 17.5 11.4477 17.5 12Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M1.5 8C1.5 6.34315 2.84315 5 4.5 5H19.5C21.1569 5 22.5 6.34315 22.5 8V16C22.5 17.6569 21.1569 19 19.5 19H4.5C2.84315 19 1.5 17.6569 1.5 16V8ZM4.5 7H19.5C20.0523 7 20.5 7.44772 20.5 8V16C20.5 16.5523 20.0523 17 19.5 17H4.5C3.94772 17 3.5 16.5523 3.5 16V8C3.5 7.44772 3.94772 7 4.5 7Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgVolume => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgVolume"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgWebcam => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgWebcam"
                .to_owned()) } < / title > < path d =
                "M13 10C13 10.5523 12.5523 11 12 11C11.4477 11 11 10.5523 11 10C11 9.44772 11.4477 9 12 9C12.5523 9 13 9.44772 13 10Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M13 14.9C15.2822 14.4367 17 12.419 17 10C17 7.23858 14.7614 5 12 5C9.23858 5 7 7.23858 7 10C7 12.419 8.71776 14.4367 11 14.9V17H7V19H17V17H13V14.9ZM12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgWebsite => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgWebsite"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M14 7C13.4477 7 13 7.44772 13 8V16C13 16.5523 13.4477 17 14 17H18C18.5523 17 19 16.5523 19 16V8C19 7.44772 18.5523 7 18 7H14ZM17 9H15V15H17V9Z"
                fill = "currentColor" /> < path d =
                "M6 7C5.44772 7 5 7.44772 5 8C5 8.55228 5.44772 9 6 9H10C10.5523 9 11 8.55228 11 8C11 7.44772 10.5523 7 10 7H6Z"
                fill = "currentColor" /> < path d =
                "M6 11C5.44772 11 5 11.4477 5 12C5 12.5523 5.44772 13 6 13H10C10.5523 13 11 12.5523 11 12C11 11.4477 10.5523 11 10 11H6Z"
                fill = "currentColor" /> < path d =
                "M5 16C5 15.4477 5.44772 15 6 15H10C10.5523 15 11 15.4477 11 16C11 16.5523 10.5523 17 10 17H6C5.44772 17 5 16.5523 5 16Z"
                fill = "currentColor" /> < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M4 3C2.34315 3 1 4.34315 1 6V18C1 19.6569 2.34315 21 4 21H20C21.6569 21 23 19.6569 23 18V6C23 4.34315 21.6569 3 20 3H4ZM20 5H4C3.44772 5 3 5.44772 3 6V18C3 18.5523 3.44772 19 4 19H20C20.5523 19 21 18.5523 21 18V6C21 5.44772 20.5523 5 20 5Z"
                fill = "currentColor" /> < / svg >
        ...
        Icon::CgWindows => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgWindows"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgWorkAlt => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgWorkAlt"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgYinyang => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgYinyang"
                .to_owned()) } < / title > < path d =
        ...
        Icon::CgYoutube => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgYoutube"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
                "M5 7H19C19.5523 7 20 7.44771 20 8V16C20 16.5523 19.5523 17 19 17H5C4.44772 17 4 16.5523 4 16V8C4 7.44772 4.44772 7 5 7ZM2 8C2 6.34315 3.34315 5 5 5H19C20.6569 5 22 6.34315 22 8V16C22 17.6569 20.6569 19 19 19H5C3.34315 19 2 17.6569 2 16V8ZM10 9L14 12L10 15V9Z"
                fill = "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgZeit => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgZeit"
                .to_owned()) } < / title > < path d =
                "M17.9923 17.0225L11.9806 6.97729L6.00775 17.0225H17.9923Z" fill =
                "currentColor" /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::CgZoomIn => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgZoomIn"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
        ...
        Icon::CgZoomOut => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "none" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "CgZoomOut"
                .to_owned()) } < / title > < path fill - rule = "evenodd" clip - rule =
                "evenodd" d =
