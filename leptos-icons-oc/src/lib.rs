    ...
    match icon {
        ...
        Icon::OcAccessibilityInsetSm => {
            view! {
                ...
                "OcAccessibilityInsetSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcAccessibilitySm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcAccessibilitySm".to_owned()) } < / title > < path d =
        ...
        Icon::OcAlertFillLg => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAlertFillLg"
        ...
        Icon::OcAlertFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAlertFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcAlertFillXs => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAlertFillXs"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcAlertLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAlertLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcAlertSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAlertSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcAppsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcAppsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArchiveLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArchiveLg"
                .to_owned()) } < / title > < path d =
                ...
                /> < path d =
                "M9.75 11.5a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "OcArchiveSm")]
        Icon::OcArchiveSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArchiveSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowBothLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowBothLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowBothSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowBothSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownLeftLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowDownLeftLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownLeftSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowDownLeftSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowDownLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownRightLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowDownRightLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownRightSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowDownRightSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowDownSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowDownSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowLeftLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowLeftLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowLeftSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowLeftSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowRightLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowRightLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowRightSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowRightSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowSwitchLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowSwitchLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowSwitchSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowSwitchSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpLeftLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowUpLeftLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpLeftSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowUpLeftSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowUpLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpRightLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowUpRightLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpRightSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcArrowUpRightSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcArrowUpSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcArrowUpSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBeakerLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBeakerLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBeakerSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBeakerSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellSlashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellSlashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellSlashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellSlashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBellSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBellSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBlockedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBlockedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBlockedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBlockedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBoldLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBoldLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBoldSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBoldSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBookLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBookLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBookSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBookSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkFillLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcBookmarkFillLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBookmarkLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkSlashFillLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcBookmarkSlashFillLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkSlashLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcBookmarkSlashLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkSlashSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcBookmarkSlashSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcBookmarkSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBookmarkSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBriefcaseLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBriefcaseLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBriefcaseSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBriefcaseSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBroadcastLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBroadcastLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBroadcastSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBroadcastSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBrowserLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBrowserLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBrowserSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBrowserSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBugLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBugLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcBugSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcBugSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCacheSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCacheSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCalendarLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCalendarLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCalendarSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCalendarSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckCircleFillLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCheckCircleFillLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckCircleFillSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCheckCircleFillSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckCircleFillXs => {
            view! {
                ...
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCheckCircleFillXs".to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckCircleLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckCircleLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckCircleSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckCircleSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCheckboxLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckboxLg"
                .to_owned()) } < / title > < path d =
                "M17.28 9.28a.75.75 0 0 0-1.06-1.06l-5.97 5.97-2.47-2.47a.75.75 0 0 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l6.5-6.5Z"
                /> < path d =
        ...
        Icon::OcCheckboxSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCheckboxSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChecklistLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChecklistLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChecklistSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChecklistSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronDownLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronDownLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronDownSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronDownSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronDownXs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronDownXs"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronLeftLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronLeftLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronLeftSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronLeftSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronRightLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcChevronRightLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronRightSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcChevronRightSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronRightXs => {
            view! {
                ...
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcChevronRightXs".to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronUpLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronUpLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronUpSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronUpSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcChevronUpXs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcChevronUpXs"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCircleLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCircleLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCircleSlashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCircleSlashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCircleSlashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCircleSlashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCircleSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCircleSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcClockFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcClockFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcClockFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcClockFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcClockLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcClockLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcClockSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcClockSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCloudLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCloudLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCloudOfflineLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCloudOfflineLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCloudOfflineSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCloudOfflineSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCloudSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCloudSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeOfConductLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCodeOfConductLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeOfConductSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCodeOfConductSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeReviewLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeReviewLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeReviewSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeReviewSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeSquareLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeSquareLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodeSquareSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodeSquareSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodescanCheckmarkLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCodescanCheckmarkLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCodescanCheckmarkSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCodescanCheckmarkSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCodescanLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodescanLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodescanSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodescanSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodespacesLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodespacesLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCodespacesSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCodespacesSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcColumnsLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcColumnsLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcColumnsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcColumnsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCommandPaletteLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCommandPaletteLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCommandPaletteSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCommandPaletteSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCommentDiscussionLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCommentDiscussionLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCommentDiscussionSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCommentDiscussionSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCommentLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCommentLg"
                .to_owned()) } < / title > < path d =
                "M1.5 4.25c0-.966.784-1.75 1.75-1.75h17.5c.966 0 1.75.784 1.75 1.75v12.5a1.75 1.75 0 0 1-1.75 1.75h-9.69l-3.573 3.573A1.458 1.458 0 0 1 5 21.043V18.5H3.25a1.75 1.75 0 0 1-1.75-1.75ZM3.25 4a.25.25 0 0 0-.25.25v12.5c0 .138.112.25.25.25h2.5a.75.75 0 0 1 .75.75v3.19l3.72-3.72a.749.749 0 0 1 .53-.22h10a.25.25 0 0 0 .25-.25V4.25a.25.25 0 0 0-.25-.25Z"
                /> < / svg >
            }
        ...
        Icon::OcCommentSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCommentSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCommitLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCommitLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcContainerLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcContainerLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcContainerSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcContainerSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotErrorSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCopilotErrorSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopilotLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopilotSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotWarningSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCopilotWarningSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotXl => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopilotXl"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopilotXxl => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopilotXxl"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCopySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCopySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCpuLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCpuLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCpuSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCpuSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcCreditCardLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCreditCardLg"
                .to_owned()) } < / title > < path d =
                "M15.25 14a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5h-3.5Z" /> < path d =
        ...
        Icon::OcCreditCardSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcCreditCardSm"
                .to_owned()) } < / title > < path d =
                "M10.75 9a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5Z" /> < path d =
        ...
        Icon::OcCrossReferenceLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCrossReferenceLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcCrossReferenceSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcCrossReferenceSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDatabaseLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDatabaseLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDatabaseSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDatabaseSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDependabotLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDependabotLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDependabotSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDependabotSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDesktopDownloadLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDesktopDownloadLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDesktopDownloadSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDesktopDownloadSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceCameraSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceCameraSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceCameraVideoLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceCameraVideoLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceCameraVideoSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceCameraVideoSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceDesktopLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceDesktopLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceDesktopSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceDesktopSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceMobileLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceMobileLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDeviceMobileSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDeviceMobileSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiamondLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiamondLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiamondSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiamondSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffAddedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffAddedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffIgnoredSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffIgnoredSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffModifiedSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiffModifiedSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffRemovedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffRemovedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffRenamedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffRenamedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiffSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDiffSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionClosedLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionClosedLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionClosedSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionClosedSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionDuplicateLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionDuplicateLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionDuplicateSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionDuplicateSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionOutdatedLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionOutdatedLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcDiscussionOutdatedSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcDiscussionOutdatedSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcDotFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDotFillLg"
                .to_owned()) } < / title > < path d =
                "M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "OcDotFillSm")]
        Icon::OcDotFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDotFillSm"
                .to_owned()) } < / title > < path d = "M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z"
                /> < / svg >
            }
                .into_view(cx)
        }
        ...
        Icon::OcDotLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDotLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDotSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDotSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDownloadLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDownloadLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDownloadSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDownloadSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDuplicateLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDuplicateLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcDuplicateSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcDuplicateSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcEllipsisSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcEllipsisSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcEyeClosedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcEyeClosedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcEyeClosedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcEyeClosedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcEyeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcEyeLg"
                .to_owned()) } < / title > < path d =
                "M15.5 12a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" /> < path d =
        ...
        Icon::OcEyeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcEyeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedDiscussionSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFeedDiscussionSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedForkedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedForkedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedHeartSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedHeartSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedMergedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedMergedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedPersonSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedPersonSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedRepoSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedRepoSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedRocketSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedRocketSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedStarSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedStarSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFeedTagSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedTagSm"
                .to_owned()) } < / title > < path d =
                "M7.22 6.5a.72.72 0 1 1-1.44 0 .72.72 0 0 1 1.44 0Z" /> < path d =
        ...
        Icon::OcFeedTrophySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFeedTrophySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileAddedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileAddedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileBadgeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileBadgeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileBinaryLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileBinaryLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileBinarySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileBinarySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileCodeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileCodeLg"
                .to_owned()) } < / title > < path d =
                "M3 3a2 2 0 0 1 2-2h9.982a2 2 0 0 1 1.414.586l4.018 4.018A2 2 0 0 1 21 7.018V21a2 2 0 0 1-2 2H4.75a.75.75 0 0 1 0-1.5H19a.5.5 0 0 0 .5-.5V8.5h-4a2 2 0 0 1-2-2v-4H5a.5.5 0 0 0-.5.5v6.25a.75.75 0 0 1-1.5 0Zm12-.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 0-.146-.336l-4.018-4.018A.5.5 0 0 0 15 2.5Z"
                /> < path d =
        ...
        Icon::OcFileCodeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileCodeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDiffLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileDiffLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDiffSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileDiffSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDirectoryFillLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileDirectoryFillLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDirectoryFillSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileDirectoryFillSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDirectoryLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileDirectoryLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDirectoryOpenFillSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileDirectoryOpenFillSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileDirectorySm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileDirectorySm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileMediaLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileMediaLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileMovedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileMovedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileRemovedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileRemovedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileSubmoduleLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileSubmoduleLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileSubmoduleSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileSubmoduleSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileSymlinkFileLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileSymlinkFileLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileSymlinkFileSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcFileSymlinkFileSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcFileZipLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileZipLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFileZipSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFileZipSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFilterLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFilterLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFilterSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFilterSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFiscalHostSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFiscalHostSm"
                .to_owned()) } < / title > < path d =
                "M10 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" /> < path d =
        ...
        Icon::OcFlameLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFlameLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFlameSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFlameSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldDownLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldDownLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldDownSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldDownSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldUpLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldUpLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcFoldUpSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcFoldUpSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGearLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGearLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGearSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGearSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGiftLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGiftLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGiftSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGiftSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitBranchLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitBranchLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitBranchSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitBranchSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitCommitLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitCommitLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitCommitSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitCommitSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitCompareLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitCompareLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitCompareSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitCompareSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitMergeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitMergeLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitMergeQueueLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitMergeQueueLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitMergeQueueSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitMergeQueueSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitMergeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGitMergeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestClosedLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestClosedLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestClosedSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestClosedSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestDraftLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestDraftLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestDraftSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestDraftSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcGitPullRequestSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcGitPullRequestSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcGlobeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGlobeLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGlobeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGlobeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGoalLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGoalLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGoalSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGoalSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGrabberLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGrabberLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGrabberSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGrabberSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGraphLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGraphLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcGraphSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcGraphSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeadingLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeadingLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeadingSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeadingSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeartFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeartFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeartFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeartFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeartLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeartLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHeartSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHeartSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHistoryLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHistoryLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHistorySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHistorySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHomeFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHomeFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHomeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHomeLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHomeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHomeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHorizontalRuleLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcHorizontalRuleLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcHorizontalRuleSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcHorizontalRuleSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcHourglassLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHourglassLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHourglassSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHourglassSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHubotLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHubotLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcHubotSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcHubotSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIdBadgeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIdBadgeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcImageLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcImageLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcImageSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcImageSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInboxLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInboxLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInboxSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInboxSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInfinityLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInfinityLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInfinitySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInfinitySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInfoLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInfoLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcInfoSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcInfoSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueClosedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueClosedLg"
                .to_owned()) } < / title > < path d =
                "M17.28 9.28a.75.75 0 0 0-1.06-1.06l-5.97 5.97-2.47-2.47a.75.75 0 0 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l6.5-6.5Z"
                /> < path d =
                "M12 1c6.075 0 11 4.925 11 11s-4.925 11-11 11S1 18.075 1 12 5.925 1 12 1ZM2.5 12a9.5 9.5 0 0 0 9.5 9.5 9.5 9.5 0 0 0 9.5-9.5A9.5 9.5 0 0 0 12 2.5 9.5 9.5 0 0 0 2.5 12Z"
        ...
        Icon::OcIssueClosedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueClosedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueDraftLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueDraftLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueDraftSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueDraftSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueOpenedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueOpenedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueOpenedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueOpenedSm"
                .to_owned()) } < / title > < path d =
                "M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" /> < path d =
        ...
        Icon::OcIssueReopenedLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcIssueReopenedLg".to_owned()) } < / title > < path d =
                ...
                /> < path d =
                "M13.414 13.414a2 2 0 1 1-2.828-2.828 2 2 0 0 1 2.828 2.828Z" /> < / svg
                >
            }
                .into_view(cx)
        }
        ...
        Icon::OcIssueTrackedByLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcIssueTrackedByLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueTrackedBySm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcIssueTrackedBySm".to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueTracksLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueTracksLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIssueTracksSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIssueTracksSm"
                .to_owned()) } < / title > < path d =
                "M1.5 8a6.5 6.5 0 0 1 13 0A.75.75 0 0 0 16 8a8 8 0 1 0-8 8 .75.75 0 0 0 0-1.5A6.5 6.5 0 0 1 1.5 8Z"
                /> < path d =
        ...
        Icon::OcItalicLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcItalicLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcItalicSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcItalicSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIterationsLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIterationsLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcIterationsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcIterationsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcKebabHorizontalLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcKebabHorizontalLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcKebabHorizontalSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcKebabHorizontalSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcKeyAsteriskSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcKeyAsteriskSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcKeyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcKeyLg"
                .to_owned()) } < / title > < path d =
                "M16.75 8.5a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5Z" /> < path d =
        ...
        Icon::OcKeySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcKeySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLawLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLawLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLawSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLawSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLightBulbLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLightBulbLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLightBulbSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLightBulbSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLinkExternalLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcLinkExternalLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcLinkExternalSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcLinkExternalSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcLinkLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLinkLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLinkSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLinkSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcListOrderedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcListOrderedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcListOrderedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcListOrderedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcListUnorderedLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcListUnorderedLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcListUnorderedSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcListUnorderedSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcLocationLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLocationLg"
                .to_owned()) } < / title > < path d =
                "M12 13.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" /> < path d =
        ...
        Icon::OcLocationSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLocationSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLockLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLockLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLockSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLockSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLogLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLogLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLogSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLogSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLogoGistSm => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLogoGistSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcLogoGithubSm => {
            view! {
                ...
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcLogoGithubSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMailLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMailLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMailSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMailSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMarkGithubSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMarkGithubSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMarkdownSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMarkdownSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMegaphoneLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMegaphoneLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMegaphoneSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMegaphoneSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMentionLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMentionLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMentionSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMentionSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMeterSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMeterSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMilestoneLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMilestoneLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMilestoneSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMilestoneSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMirrorLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMirrorLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMirrorSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMirrorSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoonLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoonLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoonSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoonSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMortarBoardLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMortarBoardLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMortarBoardSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMortarBoardSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToBottomLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcMoveToBottomLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToBottomSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcMoveToBottomSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToEndLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToEndLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToEndSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToEndSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToStartLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToStartLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToStartSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToStartSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToTopLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToTopLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMoveToTopSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMoveToTopSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMultiSelectLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMultiSelectLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMultiSelectSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMultiSelectSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMuteLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMuteLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcMuteSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcMuteSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNoEntryFillXs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNoEntryFillXs"
                .to_owned()) } < / title > < path d =
                "M6 0a6 6 0 1 1 0 12A6 6 0 0 1 6 0Zm3 5H3v2h6Z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "OcNoEntryLg")]
        Icon::OcNoEntryLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNoEntryLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNoEntrySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNoEntrySm"
                .to_owned()) } < / title > < path d =
                "M4.25 7.25a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Z" /> < path d
                =
                "M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 1 0-13 0 6.5 6.5 0 0 0 13 0Z"
                /> < / svg >
            }
        ...
        Icon::OcNorthStarLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNorthStarLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNorthStarSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNorthStarSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNoteLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNoteLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNoteSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNoteSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNumberLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNumberLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcNumberSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcNumberSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcOrganizationLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcOrganizationLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcOrganizationSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcOrganizationSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcPackageDependenciesLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPackageDependenciesLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcPackageDependenciesSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPackageDependenciesSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcPackageDependentsLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPackageDependentsLg".to_owned()) } < / title > < path d =
                "M9.126.64a1.748 1.748 0 0 1 1.75 0l8.25 4.762c.103.06.199.128.286.206a.75.75 0 0 1 .554.96c.023.113.035.23.035.35v3.332a.75.75 0 0 1-1.5 0V7.64l-7.75 4.474V22.36a.75.75 0 0 1-1.125.65l-8.75-5.052a1.75 1.75 0 0 1-.875-1.515V6.917c0-.119.012-.236.035-.35a.749.749 0 0 1 .554-.96c.088-.078.184-.146.286-.205L9.126.639Zm.875 10.173v.001l7.75-4.474-7.625-4.402a.248.248 0 0 0-.25 0L2.251 6.34Zm-8.5-3.175v8.803c0 .09.048.172.125.216l7.625 4.402v-8.947Z"
                /> < path d =
        ...
        Icon::OcPackageDependentsSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPackageDependentsSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcPackageLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPackageLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPackageSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPackageSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPaintbrushSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPaintbrushSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPaperAirplaneLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPaperAirplaneLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcPaperAirplaneSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcPaperAirplaneSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcPaperclipLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPaperclipLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPaperclipSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPaperclipSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPasskeyFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPasskeyFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPasskeyFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPasskeyFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPasteLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPasteLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPasteSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPasteSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPencilLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPencilLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPencilSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPencilSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPeopleLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPeopleLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPeopleSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPeopleSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonAddLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonAddLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonAddSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonAddSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPersonSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPersonSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPinLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPinLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPinSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPinSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlayLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlayLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlaySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlaySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlugLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlugLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlugSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlugSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlusCircleLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlusCircleLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlusCircleSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlusCircleSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlusLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlusLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPlusSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPlusSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcProjectLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectRoadmapLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectRoadmapLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectRoadmapSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectRoadmapSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcProjectSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectSymlinkLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectSymlinkLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectSymlinkSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectSymlinkSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectTemplateLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectTemplateLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcProjectTemplateSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcProjectTemplateSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcPulseLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPulseLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcPulseSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcPulseSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcQuestionLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcQuestionLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcQuestionSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcQuestionSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcQuoteLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcQuoteLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcQuoteSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcQuoteSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcReadLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReadLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcReadSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReadSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRelFilePathLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRelFilePathLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRelFilePathSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRelFilePathSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcReplyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReplyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcReplySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReplySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoCloneSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoCloneSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoDeletedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoDeletedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoForkedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoForkedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoForkedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoForkedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoLockedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoLockedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoLockedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoLockedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoPullSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoPullSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoPushLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoPushLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoPushSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoPushSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRepoSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoTemplateLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcRepoTemplateLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcRepoTemplateSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcRepoTemplateSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcReportLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReportLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcReportSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcReportSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRocketLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRocketLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRocketSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRocketSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRowsLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRowsLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRowsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRowsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRssLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRssLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRssSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRssSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRubyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRubyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcRubySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcRubySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcScreenFullLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcScreenFullLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcScreenFullSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcScreenFullSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcScreenNormalLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcScreenNormalLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcScreenNormalSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcScreenNormalSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSearchLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSearchLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSearchSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSearchSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcServerLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcServerLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcServerSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcServerSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShareAndroidLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcShareAndroidLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcShareAndroidSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcShareAndroidSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcShareLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShareLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShareSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShareSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldCheckLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldCheckLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldCheckSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldCheckSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldLockLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldLockLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldLockSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldLockSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldSlashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldSlashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldSlashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldSlashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldXLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldXLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcShieldXSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcShieldXSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSidebarCollapseLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSidebarCollapseLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcSidebarCollapseSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSidebarCollapseSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSidebarExpandLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSidebarExpandLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcSidebarExpandSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSidebarExpandSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSignInLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSignInLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSignInSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSignInSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSignOutLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSignOutLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSignOutSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSignOutSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSingleSelectLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSingleSelectLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcSingleSelectSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSingleSelectSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSkipFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSkipFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSkipFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSkipFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSkipLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSkipLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSkipSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSkipSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSlidersSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSlidersSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSmileyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSmileyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSmileySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSmileySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSortAscLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSortAscLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSortAscSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSortAscSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSortDescLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSortDescLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSortDescSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSortDescSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSparkleFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSparkleFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSponsorTiersLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSponsorTiersLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcSponsorTiersSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcSponsorTiersSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSquareFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquareFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSquareFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquareFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSquareLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquareLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSquareSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquareSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSquirrelLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquirrelLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSquirrelSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSquirrelSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStackLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStackLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStackSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStackSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStarFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStarFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStarFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStarFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStarLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStarLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStarSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStarSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStopLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStopLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStopSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStopSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStopwatchLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStopwatchLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStopwatchSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcStopwatchSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcStrikethroughLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcStrikethroughLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcStrikethroughSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcStrikethroughSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcSunLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSunLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSunSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSunSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcSyncLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSyncLg"
                .to_owned()) } < / title > < path d =
                "M3.38 8A9.502 9.502 0 0 1 12 2.5a9.502 9.502 0 0 1 9.215 7.182.75.75 0 1 0 1.456-.364C21.473 4.539 17.15 1 12 1a10.995 10.995 0 0 0-9.5 5.452V4.75a.75.75 0 0 0-1.5 0V8.5a1 1 0 0 0 1 1h3.75a.75.75 0 0 0 0-1.5H3.38Zm-.595 6.318a.75.75 0 0 0-1.455.364C2.527 19.461 6.85 23 12 23c4.052 0 7.592-2.191 9.5-5.451v1.701a.75.75 0 0 0 1.5 0V15.5a1 1 0 0 0-1-1h-3.75a.75.75 0 0 0 0 1.5h2.37A9.502 9.502 0 0 1 12 21.5c-4.446 0-8.181-3.055-9.215-7.182Z"
                /> < / svg >
            }
        ...
        Icon::OcSyncSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcSyncSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTabExternalSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTabExternalSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTabLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTabLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTableLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTableLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTableSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTableSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTagLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTagLg"
                .to_owned()) } < / title > < path d =
                "M7.75 6.5a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5Z" /> < path d =
        ...
        Icon::OcTagSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTagSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTasklistLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTasklistLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTasklistSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTasklistSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTelescopeFillLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTelescopeFillLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcTelescopeFillSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTelescopeFillSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcTelescopeLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTelescopeLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTelescopeSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTelescopeSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTerminalLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTerminalLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTerminalSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTerminalSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcThreeBarsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcThreeBarsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcThumbsdownLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcThumbsdownLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcThumbsdownSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcThumbsdownSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcThumbsupLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcThumbsupLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcThumbsupSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcThumbsupSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcToolsLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcToolsLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcToolsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcToolsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTrashLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTrashLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTrashSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTrashSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleDownLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleDownLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleDownSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleDownSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleLeftLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleLeftLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleLeftSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleLeftSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleRightLg => {
            view! {
                ...
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleRightLg".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleRightSm => {
            view! {
                ...
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(||
                "OcTriangleRightSm".to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleUpLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTriangleUpLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTriangleUpSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTriangleUpSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTrophyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTrophyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTrophySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTrophySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTypographyLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTypographyLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcTypographySm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcTypographySm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnfoldLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnfoldLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnfoldSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnfoldSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnlinkLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnlinkLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnlinkSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnlinkSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnlockLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnlockLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnlockSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnlockSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnmuteLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnmuteLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnmuteSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnmuteSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnreadSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnreadSm"
                .to_owned()) } < / title > < path d =
                ...
                /> < path d = "M14 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" /> < / svg >
            }
                .into_view(cx)
        }
        #[cfg(feature = "OcUnverifiedLg")]
        Icon::OcUnverifiedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnverifiedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUnverifiedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUnverifiedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUploadLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUploadLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcUploadSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcUploadSm"
                .to_owned()) } < / title > < path d =
                "M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"
                /> < path d =
        ...
        Icon::OcVerifiedLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVerifiedLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcVerifiedSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVerifiedSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcVersionsLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVersionsLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcVersionsSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVersionsSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcVideoLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVideoLg"
                .to_owned()) } < / title > < path d =
                "M0 4.75C0 3.784.784 3 1.75 3h20.5c.966 0 1.75.784 1.75 1.75v14.5A1.75 1.75 0 0 1 22.25 21H1.75A1.75 1.75 0 0 1 0 19.25Zm1.75-.25a.25.25 0 0 0-.25.25v14.5c0 .138.112.25.25.25h20.5a.25.25 0 0 0 .25-.25V4.75a.25.25 0 0 0-.25-.25Z"
                /> < path d =
        ...
        Icon::OcVideoSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcVideoSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcWebhookSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcWebhookSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcWorkflowLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcWorkflowLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcWorkflowSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcWorkflowSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXCircleFillLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXCircleFillLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXCircleFillSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXCircleFillSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXCircleFillXs => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 12 12" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXCircleFillXs"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXCircleLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXCircleLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXCircleSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXCircleSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcXSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcXSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcZapLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZapLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcZapSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZapSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcZoomInLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZoomInLg"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcZoomInSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZoomInSm"
                .to_owned()) } < / title > < path d =
        ...
        Icon::OcZoomOutLg => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 24 24" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZoomOutLg"
                .to_owned()) } < / title > < path d =
                "M14.5 11.25a.75.75 0 0 0 0-1.5h-8a.75.75 0 0 0 0 1.5h8Z" /> < path d =
                "M0 10.5C0 4.701 4.701 0 10.5 0S21 4.701 21 10.5c0 2.63-.967 5.033-2.564 6.875l4.344 4.345a.749.749 0 1 1-1.06 1.06l-4.345-4.344A10.459 10.459 0 0 1 10.5 21C4.701 21 0 16.299 0 10.5Zm10.5-9a9 9 0 0 0-9 9 9 9 0 0 0 9 9 9 9 0 0 0 9-9 9 9 0 0 0-9-9Z"
                /> < / svg >
            }
                .into_view(cx)
        ...
        Icon::OcZoomOutSm => {
            view! {
                cx, < svg class = class style = format!(" {}", style) width = width
                height = height viewBox = "0 0 16 16" fill = "currentColor" role =
                "graphics-symbol" > < title > { title.unwrap_or_else(|| "OcZoomOutSm"
                .to_owned()) } < / title > < path d =
                "M4.5 6.75h6a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1 0-1.5Z" /> < path d =
                "M0 7.5a7.5 7.5 0 1 1 13.307 4.747l2.473 2.473a.749.749 0 1 1-1.06 1.06l-2.473-2.473A7.5 7.5 0 0 1 0 7.5Zm7.5-6a6 6 0 1 0 0 12 6 6 0 0 0 0-12Z"
                /> < / svg >
            }
                .into_view(cx)
        }
