...
pub fn VsAdd(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M14 7v1H8v6H7V8H1V7h6V1h1v6h6z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsBlank(
    ...
    view! {
        ...
        stroke_width = "0" style = format!("{} color: {};", style, color) width = "16"
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < title > { title } < /
        title > < / svg >
    }
}
#[cfg(feature = "VsBold")]
...
pub fn VsChromeMaximize(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M3 3v10h10V3H3zm9 9H4V4h8v8z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsChromeMinimize(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M14 8v1H3V8h11z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsCircleSmallFilled(
    ...
    view! {
        ...
        "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsCollapseAll(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M9 9H4v1h5V9z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M5 3l1-1h7l1 1v7l-1 1h-2v2l-1 1H3l-1-1V6l1-1h2V3zm1 2h4l1 1v4h2V3H6v2zm4 1H3v7h7V6z"
        /> < title > { title } < / title > < / svg >
    }
...
pub fn VsColorMode(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 13V2a6 6 0 1 1 0 12z" /> < title > { title
        } < / title > < / svg >
    }
}
...
pub fn VsCopy(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M4 4l1-1h5.414L14 6.586V14l-1 1H5l-1-1V4zm9 3l-3-3H5v10h8V7z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M3 1L2 2v10l1 1V2h6.414l-1-1H3z" /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsDash(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M5 8h6v1H5z" /> < title > { title } < / title >
        < / svg >
    }
}
...
pub fn VsDebugAltSmall(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule
        = "evenodd" d = "M5 2.41L5.78 2l9 6v.83L9 12.683v-1.2l4.6-3.063L6 3.35V7H5V2.41z"
        /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsDebugBreakpointConditional(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M8 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm2 5v1H6V9h4zm0-3v1H6V6h4z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsDebugBreakpointFunction(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M8 4l4 6.905H4L8 4z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsDebugBreakpointFunctionUnverified(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M4 11h8L8 4l-4 7zm2.154-1.25h3.692L8 6.52 6.154 9.75z" /> < title > { title } <
        / title > < / svg >
    }
}
...
pub fn VsDebugBreakpointLog(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M8 3l5 5-5 5-5-5 5-5z" /> < title > { title } <
        / title > < / svg >
    }
}
...
pub fn VsDebugPause(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M4.5 3H6v10H4.5V3zm7 0v10H10V3h1.5z" /> < title
        > { title } < / title > < / svg >
    }
}
...
pub fn VsDebugRerun(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule
        = "evenodd" d =
        "M5 2.41L5.78 2l9 6v.83L10 12.017v-1.2l3.6-2.397L6 3.35V7H5V2.41z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsDebugStackframeActive(
    ...
    view! {
        ...
        height = "16" fill = "currentColor" width = size.clone() height = size xmlns =
        "http://www.w3.org/2000/svg" > < path xmlns = "http://www.w3.org/2000/svg" d =
        "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M14.5 7.15l-4.26-4.74L9.31 2H4.25L3 3.25v9.48l1.25 1.25h5.06l.93-.42 4.26-4.74V7.15zm-5.19 5.58H4.25V3.25h5.06l4.26 4.73-4.26 4.75z"
        /> < title > { title } < / title > < / svg >
    }
...
pub fn VsDebugStop(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M2 2v12h12V2H2zm10.75 10.75h-9.5v-9.5h9.5v9.5z"
        /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsDiffAdded(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M1.5 1h12l.5.5v12l-.5.5h-12l-.5-.5v-12l.5-.5zM2 13h11V2H2v11z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M8 4H7v3H4v1h3v3h1V8h3V7H8V4z" /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsDiffRemoved(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M10 7v1H5V7h5z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M1.5 1h12l.5.5v12l-.5.5h-12l-.5-.5v-12l.5-.5zM2 13h11V2H2v11z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsExpandAll(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M9 9H4v1h5V9z" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M7 12V7H6v5h1z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M5 3l1-1h7l1 1v7l-1 1h-2v2l-1 1H3l-1-1V6l1-1h2V3zm1 2h4l1 1v4h2V3H6v2zm4 1H3v7h7V6z"
        /> < title > { title } < / title > < / svg >
    }
...
pub fn VsFilterFilled(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M15 2v1.67l-5 4.759V14H6V8.429l-5-4.76V2h14z" /> < title > { title } < / title >
        < / svg >
    }
}
#[cfg(feature = "VsFlame")]
...
pub fn VsGitPullRequestDraft(
    ...
    view! {
        ...
        />< circle xmlns = "http://www.w3.org/2000/svg" cx = "12.5543" cy = "7.75073" r =
        "1" />< circle xmlns = "http://www.w3.org/2000/svg" cx = "12.5543" cy = "3.50146"
        r = "1" /> < title > { title } < / title > < / svg >
    }
}
...
pub fn VsGrabber(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M15 6H1v1h14V6zm0 3H1v1h14V9z" /> < title > { title } < / title > < / svg >
    }
}
#[cfg(feature = "VsGraph")]
...
pub fn VsGraphLine(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M15 13V14H1.5L1 13.5V0H2V13H15Z" />< path xmlns
        = "http://www.w3.org/2000/svg" d =
...
pub fn VsGripper(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M5 3h2v2H5zm0 4h2v2H5zm0 4h2v2H5zm4-8h2v2H9zm0 4h2v2H9zm0 4h2v2H9z" /> < title >
        { title } < / title > < / svg >
    }
}
...
pub fn VsLayoutActivitybarLeft(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM14 14H4V2H14V14Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsLayoutActivitybarRight(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H12V14H2Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsLayoutCentered(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H6V14H2ZM10 14V2H14V14H10Z" /> < title
        > { title } < / title > < / svg >
    }
}
...
pub fn VsLayoutMenubar(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 3H3V4H6V3Z" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M3 5H6V6H3V5Z" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 7H3V8H6V7Z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H14V14H2Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsLayoutPanel(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 10V2H14V10H2Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsLayoutPanelLeft(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M1 2L2 1H14L15 2V14L14 15H2L1 14V2ZM2 2V10H10V2H2ZM11 2V14H14V2H11Z" /> < title
        > { title } < / title > < / svg >
    }
}
...
pub fn VsLayoutPanelRight(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M1 2L2 1H14L15 2V14L14 15H2L1 14V2ZM2 2V14H5V2H2ZM6 2V10H14V2H6Z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsLayoutSidebarLeft(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM14 14H7V2H14V14Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsLayoutSidebarRight(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H9V14H2Z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsListFilter(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 12v-1h4v1H6zM4 7h8v1H4V7zm10-4v1H2V3h12z" />
        < title > { title } < / title > < / svg >
    }
}
...
pub fn VsListFlat(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M2 10V9h12v1H2zm0-4h12v1H2V6zm12-3v1H2V3h12zM2 12v1h12v-1H2z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsListTree(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M14 3v1H2V3h12zm-1 3v1H6V6h7zm0 3v1H5V9h8zm0 3v1H5v-1h8z" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M5 4h1v9H5z" /> < title > { title } < / title >
        < / svg >
    }
}
...
pub fn VsMenu(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M16 5H0V4h16v1zm0 8H0v-1h16v1zm0-4.008H0V8h16v.992z" /> < title > { title } < /
        title > < / svg >
    }
}
#[cfg(feature = "VsMerge")]
...
pub fn VsPlay(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M3.78 2L3 2.41v12l.78.42 9-6V8l-9-6zM4 13.48V3.35l7.6 5.07L4 13.48z" /> < title
        > { title } < / title > < / svg >
    }
}
...
pub fn VsPrimitiveSquare(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M3.5 4l.5-.5h8l.5.5v8l-.5.5H4l-.5-.5V4zm1 .5v7h7v-7h-7z" /> < title > { title }
        < / title > < / svg >
    }
}
...
pub fn VsRecord(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />< path
        xmlns = "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6z"
        /> < title > { title } < / title > < / svg >
...
pub fn VsRemove(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M15 8H1V7h14v1z" /> < title > { title } < /
        title > < / svg >
    }
}
...
pub fn VsSplitHorizontal(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zM8 13H3V2h5v11zm6 0H9V2h5v11z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsSplitVertical(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zm0 12H3V8h11v5zm0-6H3V2h11v5z" /> < title > {
        title } < / title > < / svg >
    }
}
...
pub fn VsStopCircle(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 6h4v4H6z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6z"
        /> < title > { title } < / title > < / svg >
    }
...
pub fn VsThreeBars(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M14 5H2V3h12v2zm0 4H2V7h12v2zM2 13h12v-2H2v2z" /> < title > { title } < / title
        > < / svg >
    }
}
...
pub fn VsTriangleDown(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M2 5.56L2.413 5h11.194l.393.54L8.373 11h-.827L2 5.56z" /> < title > { title } <
        / title > < / svg >
    }
}
...
pub fn VsTriangleLeft(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M10.44 2l.56.413v11.194l-.54.393L5 8.373v-.827L10.44 2z" /> < title > { title }
        < / title > < / svg >
    }
}
...
pub fn VsTriangleRight(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M5.56 14L5 13.587V2.393L5.54 2 11 7.627v.827L5.56 14z" /> < title > { title } <
        / title > < / svg >
    }
}
...
pub fn VsWatch(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M7.5 9h2V8H8V5.5H7v3l.5.5z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
...
pub fn VsWholeWord(
    ...
    view! {
        ...
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M0 11H1V13H15V11H16V14H15H1H0V11Z" />< path xmlns = "http://www.w3.org/2000/svg"
        d =
