...
pub fn VsActivateBreakpoints(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsActivateBreakpoints"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M15 5.5a4.394 4.394 0 0 1-4 4.5 2.955 2.955 0 0 0-.2-1A3.565 3.565 0 0 0 14 5.5a3.507 3.507 0 0 0-7-.3A3.552 3.552 0 0 0 6 5a4.622 4.622 0 0 1 4.5-4A4.481 4.481 0 0 1 15 5.5zM5.5 6a4.5 4.5 0 1 0 0 9.001 4.5 4.5 0 0 0 0-9z"
        /> < / svg >
    }
}
#[cfg(feature = "VsAdd")]
...
pub fn VsAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M14 7v1H8v6H7V8H1V7h6V1h1v6h6z" /> < /
        svg >
    }
}
...
pub fn VsArchive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArchive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M14.5 1h-13l-.5.5v3l.5.5H2v8.5l.5.5h11l.5-.5V5h.5l.5-.5v-3l-.5-.5zm-1 3H2V2h12v2h-.5zM3 13V5h10v8H3zm8-6H5v1h6V7z"
        /> < / svg >
    }
}
...
pub fn VsArrowBoth(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowBoth"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowCircleDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowCircleDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M5.36891 8.08074L7.50833 10.2202V4.46802H8.50833V10.1473L10.5749 8.08074L11.282 8.78784L8.32545 11.7444H7.61835L4.6618 8.78784L5.36891 8.08074Z"
        /> < path d =
        "M14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14C11.3137 14 14 11.3137 14 8ZM13 8C13 10.7614 10.7614 13 8 13C5.23858 13 3 10.7614 3 8C3 5.23858 5.23858 3 8 3C10.7614 3 13 5.23858 13 8Z"
        /> < / svg >
    }
}
...
pub fn VsArrowCircleLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowCircleLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowCircleRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowCircleRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowCircleUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowCircleUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M3.147 9l5 5h.707l5-5-.707-.707L9 12.439V2H8v10.44L3.854 8.292 3.147 9z" /> < /
        svg >
    }
}
...
pub fn VsArrowLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowSmallDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowSmallDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M10.7 8.64l-2.5 2.5h-.7L5 8.64l.7-.71 1.65 1.64V4h1v5.57L10 7.92l.7.72z" /> < /
        svg >
    }
}
...
pub fn VsArrowSmallLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowSmallLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M6.5 10.7L4 8.2v-.7L6.5 5l.71.7-1.64 1.65h5.57v1H5.57L7.22 10l-.72.7z" /> < /
        svg >
    }
}
...
pub fn VsArrowSmallRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowSmallRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M8.64 5l2.5 2.5v.7l-2.5 2.5-.71-.7 1.64-1.65H4v-1h5.57L7.92 5.7l.72-.7z" /> < /
        svg >
    }
}
...
pub fn VsArrowSmallUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowSmallUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M5 6.5L7.5 4h.7l2.5 2.5-.7.71-1.65-1.64v5.57h-1V5.57L5.7 7.22 5 6.5z" /> < / svg
        >
    }
}
...
pub fn VsArrowSwap(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowSwap"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsArrowUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsArrowUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M13.854 7l-5-5h-.707l-5 5 .707.707L8 3.561V14h1V3.56l4.146 4.147.708-.707z" /> <
        / svg >
    }
}
#[cfg(feature = "VsAzure")]
...
pub fn VsAzure(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsAzure"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsAzureDevops(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsAzureDevops"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBeaker(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBeaker"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBeakerStop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBeakerStop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBell(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBell"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBellDot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBellDot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBellSlash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBellSlash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < rect x = "1" y = "14.5" width = "20" height = "1" transform =
        "rotate(-45 1 14.5)" /> < / svg >
    }
}
...
pub fn VsBellSlashDot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBellSlashDot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBlank(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBlank"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBold(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBold"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBookmark(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBookmark"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBracketDot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBracketDot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBracketError(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBracketError"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBriefcase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBriefcase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsBroadcast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBroadcast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path d = "M9 7a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" /> < / svg >
    }
}
...
pub fn VsBrowser(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBrowser"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 1h13l.5.5v12l-.5.5h-13l-.5-.5v-12l.5-.5zM2 5v8h12V5H2zm0-1h12V2H2v2z" /> <
        / svg >
    }
}
#[cfg(feature = "VsBug")]
...
pub fn VsBug(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsBug"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCalendar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCalendar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCallIncoming(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCallIncoming"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCallOutgoing(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCallOutgoing"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCaseSensitive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCaseSensitive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCheck(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCheck"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCheckAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCheckAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChecklist(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChecklist"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChevronDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChevronDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChevronLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChevronLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChevronRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChevronRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChevronUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChevronUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChromeClose(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChromeClose"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsChromeMaximize(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChromeMaximize"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M3 3v10h10V3H3zm9 9H4V4h8v8z" /> < /
        svg >
    }
}
...
pub fn VsChromeMinimize(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChromeMinimize"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M14 8v1H3V8h11z" /> < / svg >
    }
}
...
pub fn VsChromeRestore(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsChromeRestore"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M3 5v9h9V5H3zm8 8H4V6h7v7z" /> < path
        fill - rule = "evenodd" clip - rule = "evenodd" d = "M5 5h1V4h7v7h-1v1h2V3H5v2z"
        /> < / svg >
    }
}
...
pub fn VsCircleFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleLargeFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleLargeFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleLargeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleLargeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleSlash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleSlash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCircleSmallFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircleSmallFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height fill = "currentColor" role = "graphics-symbol" > < title > { title } < /
        title > < path d = "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" /> < / svg >
    }
}
...
pub fn VsCircuitBoard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCircuitBoard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsClearAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsClearAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsClippy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsClippy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M7 13.992H4v-9h8v2h1v-2.5l-.5-.5H11v-1h-1a2 2 0 0 0-4 0H4.94v1H3.5l-.5.5v10l.5.5H7v-1zm0-11.2a1 1 0 0 1 .8-.8 1 1 0 0 1 .58.06.94.94 0 0 1 .45.36 1 1 0 1 1-1.75.94 1 1 0 0 1-.08-.56zm7.08 9.46L13 13.342v-5.35h-1v5.34l-1.08-1.08-.71.71 1.94 1.93h.71l1.93-1.93-.71-.71zm-5.92-4.16h.71l1.93 1.93-.71.71-1.08-1.08v5.34h-1v-5.35l-1.08 1.09-.71-.71 1.94-1.93z"
        /> < / svg >
    }
}
#[cfg(feature = "VsClose")]
...
pub fn VsClose(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsClose"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCloseAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCloseAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCloud(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCloud"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCloudDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCloudDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M11.957 6h.05a2.99 2.99 0 0 1 2.116.879 3.003 3.003 0 0 1 0 4.242 2.99 2.99 0 0 1-2.117.879v-1a2.002 2.002 0 0 0 0-4h-.914l-.123-.857a2.49 2.49 0 0 0-2.126-2.122A2.478 2.478 0 0 0 6.231 5.5l-.333.762-.809-.189A2.49 2.49 0 0 0 4.523 6c-.662 0-1.297.263-1.764.732A2.503 2.503 0 0 0 4.523 11h.498v1h-.498a3.486 3.486 0 0 1-2.628-1.16 3.502 3.502 0 0 1 1.958-5.78 3.462 3.462 0 0 1 1.468.04 3.486 3.486 0 0 1 3.657-2.06A3.479 3.479 0 0 1 11.957 6zm-5.25 5.121l1.314 1.314V7h.994v5.4l1.278-1.279.707.707-2.146 2.147h-.708L6 11.829l.707-.708z"
        /> < / svg >
    }
}
...
pub fn VsCloudUpload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCloudUpload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M4.708 5.578L2.061 8.224l2.647 2.646-.708.708-3-3V7.87l3-3 .708.708zm7-.708L11 5.578l2.647 2.646L11 10.87l.708.708 3-3V7.87l-3-3zM4.908 13l.894.448 5-10L9.908 3l-5 10z"
        /> < / svg >
    }
}
...
pub fn VsCollapseAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCollapseAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M9 9H4v1h5V9z" /> < path fill - rule =
...
pub fn VsColorMode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsColorMode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 13V2a6 6 0 1 1 0 12z" /> < / svg >
    }
}
...
pub fn VsCombine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCombine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsComment(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsComment"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCommentDiscussion(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCommentDiscussion"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCommentUnresolved(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCommentUnresolved"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCompass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCompass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCompassActive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCompassActive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCompassDot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCompassDot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsCopy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCopy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M4 4l1-1h5.414L14 6.586V14l-1 1H5l-1-1V4zm9 3l-3-3H5v10h8V7z" /> <
        path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M3 1L2 2v10l1 1V2h6.414l-1-1H3z" /> < / svg >
    }
}
...
pub fn VsCreditCard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsCreditCard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M5 8h6v1H5z" /> < / svg >
    }
}
...
pub fn VsDashboard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDashboard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDatabase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDatabase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugAlt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugAlt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugAltSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugAltSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugBreakpointConditional(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointConditional"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M8 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm2 5v1H6V9h4zm0-3v1H6V6h4z" /> <
        / svg >
    }
}
...
pub fn VsDebugBreakpointConditionalUnverified(
    ...
    #[prop(
        into,
        optional,
        default = String::from("VsDebugBreakpointConditionalUnverified")
    )]
    title: String,
) -> impl IntoView {
    view! {
...
pub fn VsDebugBreakpointData(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointData"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12.238 8l-2.31 4H5.31L3 8l2.31-4h4.618l2.31 4z" /> < / svg >
    }
}
...
pub fn VsDebugBreakpointDataUnverified(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointDataUnverified"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugBreakpointFunction(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointFunction"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M8 4l4 6.905H4L8 4z" /> < / svg >
    }
}
...
pub fn VsDebugBreakpointFunctionUnverified(
    ...
    #[prop(
        into,
        optional,
        default = String::from("VsDebugBreakpointFunctionUnverified")
    )]
    title: String,
) -> impl IntoView {
    view! {
        ...
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M4 11h8L8 4l-4 7zm2.154-1.25h3.692L8 6.52 6.154 9.75z" /> < / svg
        >
    }
}
...
pub fn VsDebugBreakpointLog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointLog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M8 3l5 5-5 5-5-5 5-5z" /> < / svg >
    }
}
...
pub fn VsDebugBreakpointLogUnverified(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointLogUnverified"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugBreakpointUnsupported(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugBreakpointUnsupported"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugConsole(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugConsole"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugContinue(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugContinue"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugContinueSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugContinueSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugCoverage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugCoverage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugDisconnect(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugDisconnect"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugLineByLine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugLineByLine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M6 10V9h9v1H6zm4-4h5v1h-5V6zm5-3v1H6V3h9zm-9 9v1h9v-1H6z" /> < path fill - rule
        = "evenodd" clip - rule = "evenodd" d =
...
pub fn VsDebugPause(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugPause"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M4.5 3H6v10H4.5V3zm7 0v10H10V3h1.5z" />
        < / svg >
    }
}
...
pub fn VsDebugRerun(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugRerun"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M7.167 12a3 3 0 0 1-5.74 1.223l-.928.376A4.001 4.001 0 1 0 1 9.556V8.333H0V11l.5.5h2.333v-1H1.568A3 3 0 0 1 7.167 12z"
        /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M5 2.41L5.78 2l9 6v.83L10 12.017v-1.2l3.6-2.397L6 3.35V7H5V2.41z" /> < / svg >
    }
}
...
pub fn VsDebugRestart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugRestart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugRestartFrame(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugRestartFrame"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugReverseContinue(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugReverseContinue"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStackframe(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStackframe"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStackframeActive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStackframeActive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height fill = "currentColor" role = "graphics-symbol" > < title > { title } < /
        title > < path d = "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" /> < path d =
        "M14.5 7.15l-4.26-4.74L9.31 2H4.25L3 3.25v9.48l1.25 1.25h5.06l.93-.42 4.26-4.74V7.15zm-5.19 5.58H4.25V3.25h5.06l4.26 4.73-4.26 4.75z"
        /> < / svg >
    }
}
...
pub fn VsDebugStart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStepBack(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStepBack"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.75 5.75v-4h1.5v2.542c1.145-1.359 2.911-2.209 4.84-2.209 3.177 0 5.92 2.307 6.16 5.398l.02.269h-1.5l-.022-.226c-.212-2.195-2.202-3.94-4.656-3.94-1.736 0-3.244.875-4.05 2.166h2.83v1.5H2.707l-.961-.975V5.75h.003zM8 14a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"
        /> < / svg >
    }
}
...
pub fn VsDebugStepInto(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStepInto"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStepOut(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStepOut"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStepOver(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStepOver"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDebugStop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDebugStop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2 2v12h12V2H2zm10.75 10.75h-9.5v-9.5h9.5v9.5z" /> < / svg >
    }
}
...
pub fn VsDesktopDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDesktopDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDeviceCamera(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDeviceCamera"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDeviceCameraVideo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDeviceCameraVideo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDeviceMobile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDeviceMobile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M4.5 1h8l.5.5v13l-.5.5h-8l-.5-.5v-13l.5-.5zM5 14h7V2H5v12zm2.5-2h2v1h-2v-1z" />
        < / svg >
    }
}
#[cfg(feature = "VsDiff")]
...
pub fn VsDiff(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiff"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDiffAdded(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiffAdded"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M1.5 1h12l.5.5v12l-.5.5h-12l-.5-.5v-12l.5-.5zM2 13h11V2H2v11z" />
        < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M8 4H7v3H4v1h3v3h1V8h3V7H8V4z" /> < / svg >
    }
}
...
pub fn VsDiffIgnored(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiffIgnored"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsDiffModified(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiffModified"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 1h13l.5.5v13l-.5.5h-13l-.5-.5v-13l.5-.5zM2 2v12h12V2H2zm6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"
        /> < / svg >
    }
}
...
pub fn VsDiffRemoved(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiffRemoved"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M10 7v1H5V7h5z" /> < path fill - rule =
        "evenodd" clip - rule = "evenodd" d =
        "M1.5 1h12l.5.5v12l-.5.5h-12l-.5-.5v-12l.5-.5zM2 13h11V2H2v11z" /> < / svg >
    }
}
...
pub fn VsDiffRenamed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiffRenamed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 1h13l.5.5v13l-.5.5h-13l-.5-.5v-13l.5-.5zM2 14h12V2H2v12zm2-5h3v3l5-4-5-4v3H4v2z"
        /> < / svg >
    }
}
...
pub fn VsDiscard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsDiscard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsEdit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEdit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13.23 1h-1.46L3.52 9.25l-.16.22L1 13.59 2.41 15l4.12-2.36.22-.16L15 4.23V2.77L13.23 1zM2.41 13.59l1.51-3 1.45 1.45-2.96 1.55zm3.83-2.06L4.47 9.76l8-8 1.77 1.77-8 8z"
        /> < / svg >
    }
}
...
pub fn VsEditorLayout(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEditorLayout"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsEllipsis(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEllipsis"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsEmptyWindow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEmptyWindow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M4 4h3v1H4v3H3V5H0V4h3V1h1v3zM1 14.5V9h1v5h12V7H8V6h6V4H8V3h6.5l.5.5v11l-.5.5h-13l-.5-.5z"
        /> < / svg >
    }
}
#[cfg(feature = "VsError")]
...
pub fn VsError(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsError"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6zM7.9 7.5L10.3 5l.7.7-2.4 2.5 2.4 2.5-.7.7-2.4-2.5-2.4 2.5-.7-.7 2.4-2.5-2.4-2.5.7-.7 2.4 2.5z"
        /> < / svg >
    }
}
...
pub fn VsErrorSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsErrorSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsExclude(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsExclude"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsExpandAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsExpandAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M9 9H4v1h5V9z" /> < path d =
        "M7 12V7H6v5h1z" /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M5 3l1-1h7l1 1v7l-1 1h-2v2l-1 1H3l-1-1V6l1-1h2V3zm1 2h4l1 1v4h2V3H6v2zm4 1H3v7h7V6z"
        /> < / svg >
    }
}
...
pub fn VsExport(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsExport"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsExtensions(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsExtensions"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M13.5 1.5L15 0h7.5L24 1.5V9l-1.5 1.5H15L13.5 9V1.5zm1.5 0V9h7.5V1.5H15zM0 15V6l1.5-1.5H9L10.5 6v7.5H18l1.5 1.5v7.5L18 24H1.5L0 22.5V15zm9-1.5V6H1.5v7.5H9zM9 15H1.5v7.5H9V15zm1.5 7.5H18V15h-7.5v7.5z"
        /> < / svg >
    }
}
#[cfg(feature = "VsEye")]
...
pub fn VsEye(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEye"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsEyeClosed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsEyeClosed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFeedback(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFeedback"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileBinary(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileBinary"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileCode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileCode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileMedia(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileMedia"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFilePdf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFilePdf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileSubmodule(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileSubmodule"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M2 11h1V6.99H2V11zm1-5.01V5.5l.5-.5h4.43l.43.25.43.75h5.71l.5.5v8l-.5.5h-11l-.5-.5V12H1.5l-.5-.5v-9l.5-.5h4.42l.44.25.43.75h5.71l.5.5V6l-1-.03V4H6.5l-.43-.25L5.64 3H2v2.99h1zm5.07.76L7.64 6H4v3h3.15l.41-.74L8 8h6V7H8.5l-.43-.25zM7.45 10H4v4h10V9H8.3l-.41.74-.44.26z"
        /> < / svg >
    }
}
...
pub fn VsFileSymlinkDirectory(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileSymlinkDirectory"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileSymlinkFile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileSymlinkFile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFileZip(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFileZip"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFiles(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFiles"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFilter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFilter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M15 2v1.67l-5 4.759V14H6V8.429l-5-4.76V2h14zM7 8v5h2V8l5-4.76V3H2v.24L7 8z" /> <
        / svg >
    }
}
...
pub fn VsFilterFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFilterFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M15 2v1.67l-5 4.759V14H6V8.429l-5-4.76V2h14z" /> < / svg >
    }
}
#[cfg(feature = "VsFlame")]
...
pub fn VsFlame(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFlame"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFold(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFold"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFoldDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFoldDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFoldUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFoldUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFolder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFolder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFolderActive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFolderActive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsFolderLibrary(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFolderLibrary"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < rect x = "8" y = "8" width = "1" height = "6" /> < rect x = "10" y = "8"
        width = "1" height = "6" /> < rect x = "12.0041" y = "8.35193" width = "1" height
        = "6" transform = "rotate(-20 12.0041 8.35193)" /> < / svg >
    }
}
...
pub fn VsFolderOpened(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsFolderOpened"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGear(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGear"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGift(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGift"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGist(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGist"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGistSecret(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGistSecret"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitCommit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitCommit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitCompare(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitCompare"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitMerge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitMerge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitPullRequest(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequest"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitPullRequestClosed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequestClosed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitPullRequestCreate(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequestCreate"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitPullRequestDraft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequestDraft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGitPullRequestGoToChanges(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequestGoToChanges"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M7.06065 3.85356L4.91421 6L4.2071 5.29289L5.49999 4H2.5C2.10218 4 1.72064 4.15804 1.43934 4.43934C1.15804 4.72065 1 5.10218 1 5.5C1 5.89783 1.15804 6.27936 1.43934 6.56066C1.72064 6.84197 2.10218 7 2.5 7H3V8H2.5C1.83696 8 1.20107 7.73661 0.732233 7.26777C0.263392 6.79893 0 6.16305 0 5.5C0 4.83696 0.263392 4.20108 0.732233 3.73224C1.20107 3.2634 1.83696 3 2.5 3H5.49999L4.2071 1.70711L4.91421 1L7.06065 3.14645L7.06065 3.85356Z"
        /> < / svg >
    }
}
...
pub fn VsGitPullRequestNewChanges(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGitPullRequestNewChanges"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGithub(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGithub"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24zm3.163 21.783h-.093a.513.513 0 0 1-.382-.14.513.513 0 0 1-.14-.372v-1.406c.006-.467.01-.94.01-1.416a3.693 3.693 0 0 0-.151-1.028 1.832 1.832 0 0 0-.542-.875 8.014 8.014 0 0 0 2.038-.471 4.051 4.051 0 0 0 1.466-.964c.407-.427.71-.943.885-1.506a6.77 6.77 0 0 0 .3-2.13 4.138 4.138 0 0 0-.26-1.476 3.892 3.892 0 0 0-.795-1.284 2.81 2.81 0 0 0 .162-.582c.033-.2.05-.402.05-.604 0-.26-.03-.52-.09-.773a5.309 5.309 0 0 0-.221-.763.293.293 0 0 0-.111-.02h-.11c-.23.002-.456.04-.674.111a5.34 5.34 0 0 0-.703.26 6.503 6.503 0 0 0-.661.343c-.215.127-.405.249-.573.362a9.578 9.578 0 0 0-5.143 0 13.507 13.507 0 0 0-.572-.362 6.022 6.022 0 0 0-.672-.342 4.516 4.516 0 0 0-.705-.261 2.203 2.203 0 0 0-.662-.111h-.11a.29.29 0 0 0-.11.02 5.844 5.844 0 0 0-.23.763c-.054.254-.08.513-.081.773 0 .202.017.404.051.604.033.199.086.394.16.582A3.888 3.888 0 0 0 5.702 10a4.142 4.142 0 0 0-.263 1.476 6.871 6.871 0 0 0 .292 2.12c.181.563.483 1.08.884 1.516.415.422.915.75 1.466.964.653.25 1.337.41 2.033.476a1.828 1.828 0 0 0-.452.633 2.99 2.99 0 0 0-.2.744 2.754 2.754 0 0 1-1.175.27 1.788 1.788 0 0 1-1.065-.3 2.904 2.904 0 0 1-.752-.824 3.1 3.1 0 0 0-.292-.382 2.693 2.693 0 0 0-.372-.343 1.841 1.841 0 0 0-.432-.24 1.2 1.2 0 0 0-.481-.101c-.04.001-.08.005-.12.01a.649.649 0 0 0-.162.02.408.408 0 0 0-.13.06.116.116 0 0 0-.06.1.33.33 0 0 0 .14.242c.093.074.17.131.232.171l.03.021c.133.103.261.214.382.333.112.098.213.209.3.33.09.119.168.246.231.381.073.134.15.288.231.463.188.474.522.875.954 1.145.453.243.961.364 1.476.351.174 0 .349-.01.522-.03.172-.028.343-.057.515-.091v1.743a.5.5 0 0 1-.533.521h-.062a10.286 10.286 0 1 1 6.324 0v.005z"
        /> < / svg >
    }
}
...
pub fn VsGithubAction(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGithubAction"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGithubAlt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGithubAlt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGithubInverted(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGithubInverted"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGlobe(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGlobe"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGoToFile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGoToFile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGrabber(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGrabber"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M15 6H1v1h14V6zm0 3H1v1h14V9z" /> < / svg >
    }
}
#[cfg(feature = "VsGraph")]
...
pub fn VsGraph(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGraph"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 14H15v-1H2V0H1v13.5l.5.5zM3 11.5v-8l.5-.5h2l.5.5v8l-.5.5h-2l-.5-.5zm2-.5V4H4v7h1zm6-9.5v10l.5.5h2l.5-.5v-10l-.5-.5h-2l-.5.5zm2 .5v9h-1V2h1zm-6 9.5v-6l.5-.5h2l.5.5v6l-.5.5h-2l-.5-.5zm2-.5V6H8v5h1z"
        /> < / svg >
    }
}
...
pub fn VsGraphLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGraphLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsGraphLine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGraphLine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M15 13V14H1.5L1 13.5V0H2V13H15Z" /> <
        path d =
...
pub fn VsGraphScatter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGraphScatter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M15 13V14H1.5L1 13.5V0H2V13H15Z" /> <
        rect x = "5" y = "2" width = "2" height = "2" /> < rect x = "12" y = "1" width =
        "2" height = "2" /> < rect x = "8" y = "5" width = "2" height = "2" /> < rect x =
        "5" y = "9" width = "2" height = "2" /> < rect x = "12" y = "8" width = "2"
        height = "2" /> < / svg >
    }
}
...
pub fn VsGripper(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGripper"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M5 3h2v2H5zm0 4h2v2H5zm0 4h2v2H5zm4-8h2v2H9zm0 4h2v2H9zm0 4h2v2H9z" /> < / svg >
    }
}
...
pub fn VsGroupByRefType(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsGroupByRefType"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsHeart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHeart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsHeartFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHeartFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsHistory(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHistory"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsHome(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHome"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8.36 1.37l6.36 5.8-.71.71L13 6.964v6.526l-.5.5h-3l-.5-.5v-3.5H7v3.5l-.5.5h-3l-.5-.5V6.972L2 7.88l-.71-.71 6.35-5.8h.72zM4 6.063v6.927h2v-3.5l.5-.5h3l.5.5v3.5h2V6.057L8 2.43 4 6.063z"
        /> < / svg >
    }
}
...
pub fn VsHorizontalRule(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHorizontalRule"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsHubot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsHubot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsInbox(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsInbox"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsIndent(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsIndent"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsInfo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsInfo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8.568 1.031A6.8 6.8 0 0 1 12.76 3.05a7.06 7.06 0 0 1 .46 9.39 6.85 6.85 0 0 1-8.58 1.74 7 7 0 0 1-3.12-3.5 7.12 7.12 0 0 1-.23-4.71 7 7 0 0 1 2.77-3.79 6.8 6.8 0 0 1 4.508-1.149zM9.04 13.88a5.89 5.89 0 0 0 3.41-2.07 6.07 6.07 0 0 0-.4-8.06 5.82 5.82 0 0 0-7.43-.74 6.06 6.06 0 0 0 .5 10.29 5.81 5.81 0 0 0 3.92.58zM7.375 6h1.25V5h-1.25v1zm1.25 1v4h-1.25V7h1.25z"
        /> < / svg >
    }
}
...
pub fn VsInspect(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsInspect"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsIssueDraft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsIssueDraft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsIssueReopened(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsIssueReopened"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "7.74001" cy = "7.53955" r = "1" /> < / svg >
    }
}
...
pub fn VsIssues(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsIssues"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "7.50002" cy = "7.5" r = "1" /> < / svg >
    }
}
...
pub fn VsItalic(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsItalic"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsJersey(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsJersey"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsJson(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsJson"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsKebabVertical(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsKebabVertical"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height fill = "currentColor" role = "graphics-symbol" > < title > { title } < /
        title > < path fill - rule = "evenodd" clip - rule = "evenodd" d =
...
pub fn VsKey(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsKey"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLaw(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLaw"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayersActive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayersActive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayersDot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayersDot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayout(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayout"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M3 2L2 3V13L3 14H7L8 13V3L7 2H3ZM3 13V3H7V13H3Z" /> < path d =
        "M10 3L11 2H14L15 3V6L14 7H11L10 6V3ZM11 3V6H14V3H11Z" /> < path d =
        "M10 10L11 9H14L15 10V13L14 14H11L10 13V10ZM11 10V13H14V10H11Z" /> < / svg >
    }
}
...
pub fn VsLayoutActivitybarLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutActivitybarLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM14 14H4V2H14V14Z" /> < / svg >
    }
}
...
pub fn VsLayoutActivitybarRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutActivitybarRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H12V14H2Z" /> < / svg >
    }
}
...
pub fn VsLayoutCentered(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutCentered"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H6V14H2ZM10 14V2H14V14H10Z" /> < / svg
        >
    }
}
...
pub fn VsLayoutMenubar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutMenubar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M6 3H3V4H6V3Z" /> < path d =
        "M3 5H6V6H3V5Z" /> < path d = "M6 7H3V8H6V7Z" /> < path d =
        "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H14V14H2Z" /> < / svg >
    }
}
...
pub fn VsLayoutPanel(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanel"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 10V2H14V10H2Z" /> < / svg >
    }
}
...
pub fn VsLayoutPanelCenter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanelCenter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayoutPanelJustify(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanelJustify"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayoutPanelLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanelLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M1 2L2 1H14L15 2V14L14 15H2L1 14V2ZM2 2V10H10V2H2ZM11 2V14H14V2H11Z" /> < / svg
        >
    }
}
...
pub fn VsLayoutPanelOff(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanelOff"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayoutPanelRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutPanelRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M1 2L2 1H14L15 2V14L14 15H2L1 14V2ZM2 2V14H5V2H2ZM6 2V10H14V2H6Z" /> < / svg >
    }
}
...
pub fn VsLayoutSidebarLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutSidebarLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM14 14H7V2H14V14Z" /> < / svg >
    }
}
...
pub fn VsLayoutSidebarLeftOff(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutSidebarLeftOff"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2 1.00073L1 2.00073V14.0007L2 15.0007H14L15 14.0007V2.00073L14 1.00073H2ZM2 14.0007V2.00073H6V14.0007H2ZM7 14.0007V2.00073H14V14.0007H7Z"
        /> < / svg >
    }
}
...
pub fn VsLayoutSidebarRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutSidebarRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H9V14H2Z" /> < / svg >
    }
}
...
pub fn VsLayoutSidebarRightOff(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutSidebarRightOff"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLayoutStatusbar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLayoutStatusbar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M2 1.00073L1 2.00073V14.0007L2 15.0007H14L15 14.0007V2.00073L14 1.00073H2ZM2 13.0007V2.00073H14V13.0007H2Z"
        /> < / svg >
    }
}
...
pub fn VsLibrary(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLibrary"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLightbulb(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLightbulb"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLightbulbAutofix(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLightbulbAutofix"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLink(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLink"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLinkExternal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLinkExternal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M1.5 1H6v1H2v12h12v-4h1v4.5l-.5.5h-13l-.5-.5v-13l.5-.5z" /> < path d =
        "M15 1.5V8h-1V2.707L7.243 9.465l-.707-.708L13.293 2H8V1h6.5l.5.5z" /> < / svg >
    }
}
...
pub fn VsListFilter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListFilter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M6 12v-1h4v1H6zM4 7h8v1H4V7zm10-4v1H2V3h12z" /> < / svg >
    }
}
...
pub fn VsListFlat(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListFlat"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2 10V9h12v1H2zm0-4h12v1H2V6zm12-3v1H2V3h12zM2 12v1h12v-1H2z" /> < / svg >
    }
}
...
pub fn VsListOrdered(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListOrdered"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsListSelection(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListSelection"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M1 12v-1h9v1H1zm0-5h14v1H1V7zm11-4v1H1V3h11z" /> < / svg >
    }
}
...
pub fn VsListTree(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListTree"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M14 3v1H2V3h12zm-1 3v1H6V6h7zm0 3v1H5V9h8zm0 3v1H5v-1h8z" /> < path d =
        "M5 4h1v9H5z" /> < / svg >
    }
}
...
pub fn VsListUnordered(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsListUnordered"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLiveShare(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLiveShare"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLoading(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLoading"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLocation(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLocation"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLock(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLock"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsLockSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsLockSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M3 8L4 7H12L13 8V13L12 14H4L3 13V8ZM4 8V13H12V8H4Z" /> < path d =
...
pub fn VsMagnet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMagnet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMailRead(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMailRead"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMap(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMap"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMapFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMapFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M2 5.5V13L5.5 10.8125V3.3125L2 5.5Z" />
        < path d = "M9.5 12.6875V5.1875L6.5 3.3125V10.8125L9.5 12.6875Z" /> < path d =
        "M10.5 12.6875V5.1875L14 3V10.5L10.5 12.6875Z" /> < / svg >
    }
}
...
pub fn VsMarkdown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMarkdown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMegaphone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMegaphone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMention(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMention"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMenu(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMenu"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16 5H0V4h16v1zm0 8H0v-1h16v1zm0-4.008H0V8h16v.992z" /> < / svg >
    }
}
#[cfg(feature = "VsMerge")]
...
pub fn VsMerge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMerge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMilestone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMilestone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMirror(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMirror"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMortarBoard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMortarBoard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMove(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMove"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMultipleWindows(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMultipleWindows"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsMute(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsMute"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNewFile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNewFile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNewFolder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNewFolder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M14.5 2H7.71l-.85-.85L6.51 1h-5l-.5.5v11l.5.5H7v-1H1.99V6h4.49l.35-.15.86-.86H14v1.5l-.001.51h1.011V2.5L14.5 2zm-.51 2h-6.5l-.35.15-.86.86H2v-3h4.29l.85.85.36.15H14l-.01.99zM13 16h-1v-3H9v-1h3V9h1v3h3v1h-3v3z"
        /> < / svg >
    }
}
...
pub fn VsNewline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNewline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNoNewline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNoNewline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNote(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNote"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNotebook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNotebook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsNotebookTemplate(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsNotebookTemplate"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M5 6l1-1h7l1 1v9l-1 1H6l-1-1V6zm1 0v9h7V6H6z" /> < path d =
        "M15 7h1v2h-1V7zm0 3h1v2h-1v-2zm0 3h1v2h-1v-2zM7 8h5v1H7z" /> < / svg >
    }
}
...
pub fn VsOctoface(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsOctoface"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsOpenPreview(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsOpenPreview"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsOrganization(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsOrganization"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsOutput(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsOutput"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPackage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPackage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPaintcan(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPaintcan"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M6.27 10.87h.71l4.56-4.56-.71-.71-4.2 4.21-1.92-1.92L4 8.6l2.27 2.27z" /> < path
...
pub fn VsPassFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPassFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm-1.02-4.13h-.71L4 8.6l.71-.71 1.92 1.92 4.2-4.21.71.71-4.56 4.56z"
        /> < / svg >
    }
}
...
pub fn VsPerson(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPerson"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPersonAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPersonAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPieChart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPieChart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPinned(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPinned"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPinnedDirty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPinnedDirty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPlay(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPlay"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M3.78 2L3 2.41v12l.78.42 9-6V8l-9-6zM4 13.48V3.35l7.6 5.07L4 13.48z" /> < / svg
        >
    }
}
...
pub fn VsPlayCircle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPlayCircle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6z"
        /> < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M6 5l.777-.416 4.5 3v.832l-4.5 3L6 11V5zm1 .934v4.132L10.099 8 7 5.934z" /> < /
        svg >
    }
}
#[cfg(feature = "VsPlug")]
...
pub fn VsPlug(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPlug"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M7 1H6v3H4.5l-.5.5V8a4 4 0 0 0 3.5 3.969V15h1v-3.031A4 4 0 0 0 12 8V4.5l-.5-.5H10V1H9v3H7V1zm3.121 9.121A3 3 0 0 1 5 8V5h6v3a3 3 0 0 1-.879 2.121z"
        /> < / svg >
    }
}
...
pub fn VsPreserveCase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPreserveCase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPreview(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPreview"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsPrimitiveSquare(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPrimitiveSquare"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M3.5 4l.5-.5h8l.5.5v8l-.5.5H4l-.5-.5V4zm1 .5v7h7v-7h-7z" /> < /
        svg >
    }
}
...
pub fn VsProject(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsProject"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 1h13l.5.5v13l-.5.5h-13l-.5-.5v-13l.5-.5zM2 14h12V2H2v12zM3 3h2v10H3V3zm6 0H7v6h2V3zm2 0h2v8h-2V3z"
        /> < / svg >
    }
}
#[cfg(feature = "VsPulse")]
...
pub fn VsPulse(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsPulse"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsQuestion(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsQuestion"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsQuote(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsQuote"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRadioTower(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRadioTower"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsReactions(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReactions"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M12 7.5c0 .169-.01.336-.027.5h1.005A5.5 5.5 0 1 0 8 12.978v-1.005A4.5 4.5 0 1 1 12 7.5zM5.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm2 2.5c.712 0 1.355-.298 1.81-.776l.707.708A3.49 3.49 0 0 1 7.5 10.5a3.49 3.49 0 0 1-2.555-1.108l.707-.708A2.494 2.494 0 0 0 7.5 9.5zm2-2.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm2.5 3h1v2h2v1h-2v2h-1v-2h-2v-1h2v-2z"
        /> < / svg >
    }
}
...
pub fn VsRecord(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRecord"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
        < path fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6z"
        /> < / svg >
    }
...
pub fn VsRecordKeys(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRecordKeys"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRecordSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRecordSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M8.00024 9C8.55253 9 9.00024 8.55228 9.00024 8C9.00024 7.44772 8.55253 7 8.00024 7C7.44796 7 7.00024 7.44772 7.00024 8C7.00024 8.55228 7.44796 9 8.00024 9Z"
        /> < path d =
        "M12.0002 8C12.0002 10.2091 10.2094 12 8.00024 12C5.79111 12 4.00024 10.2091 4.00024 8C4.00024 5.79086 5.79111 4 8.00024 4C10.2094 4 12.0002 5.79086 12.0002 8ZM11.0002 8C11.0002 6.34315 9.6571 5 8.00024 5C6.34339 5 5.00024 6.34315 5.00024 8C5.00024 9.65685 6.34339 11 8.00024 11C9.6571 11 11.0002 9.65685 11.0002 8Z"
        /> < / svg >
    }
...
pub fn VsRedo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRedo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsReferences(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReferences"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRefresh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRefresh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M4.681 3H2V2h3.5l.5.5V6H5V4a5 5 0 1 0 4.53-.761l.302-.954A6 6 0 1 1 4.681 3z" />
        < / svg >
    }
}
#[cfg(feature = "VsRegex")]
...
pub fn VsRegex(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRegex"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRemote(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRemote"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRemoteExplorer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRemoteExplorer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRemove(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRemove"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M15 8H1V7h14v1z" /> < / svg >
    }
}
...
pub fn VsReplace(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReplace"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsReplaceAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReplaceAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsReply(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReply"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepoClone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepoClone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepoForcePush(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepoForcePush"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepoForked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepoForked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepoPull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepoPull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRepoPush(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRepoPush"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsReport(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsReport"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRequestChanges(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRequestChanges"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M14.5 1h-13l-.5.5v10l.5.5H4v2.5l.854.354L7.707 12H14.5l.5-.5v-10l-.5-.5zM14 11H7.5l-.354.146L5 13.293V11.5l-.5-.5H2V2h12v9zm-4-1H6V8.979h4V10zM7.5 3h1v2h2v1h-2v2h-1V6h-2V5h2V3z"
        /> < / svg >
    }
}
...
pub fn VsRocket(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRocket"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRootFolder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRootFolder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path d = "M6 10.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" /> < path fill -
...
pub fn VsRootFolderOpened(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRootFolderOpened"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRss(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRss"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRuby(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRuby"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1 7.19l6.64 6.64h.72L15 7.19v-.72l-3.32-3.32-.36-.15H4.68l-.36.15L1 6.47v.72zm7 5.56L2.08 6.83 4.89 4h6.22l2.81 2.83L8 12.75zm0-7.73h2.69l1.81 1.81-4.5 4.4V5.02z"
        /> < / svg >
    }
}
...
pub fn VsRunAbove(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRunAbove"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRunAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRunAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        fill - rule = "evenodd" clip - rule = "evenodd" d =
        "M6 14.683l8.78-5.853V8L6 2.147V3.35l7.6 5.07L6 13.48v1.203z" /> < / svg >
    }
}
...
pub fn VsRunBelow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRunBelow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsRunErrors(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsRunErrors"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSave(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSave"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M13.353 1.146l1.5 1.5L15 3v11.5l-.5.5h-13l-.5-.5v-13l.5-.5H13l.353.146zM2 2v12h12V3.208L12.793 2H11v4H4V2H2zm6 0v3h2V2H8z"
        /> < / svg >
    }
}
...
pub fn VsSaveAll(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSaveAll"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSaveAs(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSaveAs"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M11.04 1.33L12.71 3l.29.71v.33h-.5l-.5.5v-.83l-1.67-1.67H10v4H4v-4H2v10h3l-.5 1H2l-1-1v-10l1-1h8.33l.71.29zM7 5h2V2H7v3zm6.5 0L15 6.5l-.02.69-5.5 5.5-.13.12-.37.37-.1.09-3 1.5-.67-.67 1.5-3 .09-.1.37-.37.12-.13 5.5-5.5h.71zm-6.22 7.24l-.52 1 1.04-.48-.52-.52zm.69-1.03l.79.79 5.15-5.15-.79-.79-5.15 5.15z"
        /> < / svg >
    }
}
...
pub fn VsScreenFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsScreenFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsScreenNormal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsScreenNormal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSearch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSearch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSearchStop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSearchStop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsServer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsServer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M2.5 5L2 4.5v-3l.5-.5h11l.5.5v3l-.5.5h-11zM10 2H9v1H8V2H7v1H6V2H5v1H4V2H3v2h10V2h-2v1h-1V2zm-7.5 8L2 9.5v-3l.5-.5h11l.5.5v3l-.5.5h-11zM6 7H5v1H4V7H3v2h10V7h-2v1h-1V7H9v1H8V7H7v1H6V7zm7.5 8l.5-.5v-3l-.5-.5h-11l-.5.5v3l.5.5h11zM3 14v-2h1v1h1v-1h1v1h1v-1h1v1h1v-1h1v1h1v-1h2v2H3z"
        /> < / svg >
    }
}
...
pub fn VsServerEnvironment(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsServerEnvironment"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsServerProcess(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsServerProcess"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSettings(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSettings"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M3.5 2h-1v5h1V2zm6.1 5H6.4L6 6.45v-1L6.4 5h3.2l.4.5v1l-.4.5zm-5 3H1.4L1 9.5v-1l.4-.5h3.2l.4.5v1l-.4.5zm3.9-8h-1v2h1V2zm-1 6h1v6h-1V8zm-4 3h-1v3h1v-3zm7.9 0h3.19l.4-.5v-.95l-.4-.5H11.4l-.4.5v.95l.4.5zm2.1-9h-1v6h1V2zm-1 10h1v2h-1v-2z"
        /> < / svg >
    }
}
...
pub fn VsSettingsGear(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSettingsGear"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsShield(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsShield"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSignIn(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSignIn"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M11.02 3.77l.01-.01.99.99V2.5l-.5-.5h-9l-.51.5v.493L2 3v10.29l.36.46 5 1.72L8 15v-1h3.52l.5-.5v-2.25l-1 1V13H8V4.71l-.33-.46L4.036 3h6.984v.77zM7 14.28l-4-1.34V3.72l4 1.34v9.22zm3.09-6.75h4.97v1h-4.93l1.59 1.6-.71.7-2.47-2.46v-.71l2.49-2.48.7.7-1.64 1.65z"
        /> < / svg >
    }
}
...
pub fn VsSignOut(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSignOut"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSmiley(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSmiley"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSortPrecedence(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSortPrecedence"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSourceControl(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSourceControl"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSplitHorizontal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSplitHorizontal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zM8 13H3V2h5v11zm6 0H9V2h5v11z" /> < / svg >
    }
}
...
pub fn VsSplitVertical(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSplitVertical"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zm0 12H3V8h11v5zm0-6H3V2h11v5z" /> < / svg >
    }
}
...
pub fn VsSquirrel(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSquirrel"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsStarEmpty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsStarEmpty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsStarFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsStarFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M9.595 6.252L8 1 6.405 6.252H1l4.373 3.4L3.75 15 8 11.695 12.25 15l-1.623-5.348L15 6.252H9.595z"
        /> < / svg >
    }
}
...
pub fn VsStarHalf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsStarHalf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsStopCircle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsStopCircle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M6 6h4v4H6z" /> < path fill - rule =
        "evenodd" clip - rule = "evenodd" d =
        "M8.6 1c1.6.1 3.1.9 4.2 2 1.3 1.4 2 3.1 2 5.1 0 1.6-.6 3.1-1.6 4.4-1 1.2-2.4 2.1-4 2.4-1.6.3-3.2.1-4.6-.7-1.4-.8-2.5-2-3.1-3.5C.9 9.2.8 7.5 1.3 6c.5-1.6 1.4-2.9 2.8-3.8C5.4 1.3 7 .9 8.6 1zm.5 12.9c1.3-.3 2.5-1 3.4-2.1.8-1.1 1.3-2.4 1.2-3.8 0-1.6-.6-3.2-1.7-4.3-1-1-2.2-1.6-3.6-1.7-1.3-.1-2.7.2-3.8 1-1.1.8-1.9 1.9-2.3 3.3-.4 1.3-.4 2.7.2 4 .6 1.3 1.5 2.3 2.7 3 1.2.7 2.6.9 3.9.6z"
        /> < / svg >
    }
...
pub fn VsSymbolArray(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolArray"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M1.5 2l-.5.5v11l.5.5H4v-1H2V3h2V2H1.5zm13 12l.5-.5v-11l-.5-.5H12v1h2v10h-2v1h2.5z"
        /> < / svg >
    }
}
...
pub fn VsSymbolBoolean(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolBoolean"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolClass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolClass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolColor(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolColor"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolConstant(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolConstant"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M4 6h8v1H4V6zm8 3H4v1h8V9z" /> < path fill - rule = "evenodd" clip
        - rule = "evenodd" d = "M1 4l1-1h12l1 1v8l-1 1H2l-1-1V4zm1 0v8h12V4H2z" /> < /
        svg >
    }
}
...
pub fn VsSymbolEnum(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolEnum"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolEnumMember(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolEnumMember"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolEvent(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolEvent"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolField(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolField"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolFile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolFile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolInterface(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolInterface"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolKey(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolKey"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolKeyword(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolKeyword"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolMethod(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolMethod"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13.51 4l-5-3h-1l-5 3-.49.86v6l.49.85 5 3h1l5-3 .49-.85v-6L13.51 4zm-6 9.56l-4.5-2.7V5.7l4.5 2.45v5.41zM3.27 4.7l4.74-2.84 4.74 2.84-4.74 2.59L3.27 4.7zm9.74 6.16l-4.5 2.7V8.15l4.5-2.45v5.16z"
        /> < / svg >
    }
}
...
pub fn VsSymbolMisc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolMisc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolNamespace(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolNamespace"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolNumeric(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolNumeric"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M11 1v4h4v1h-4v4h4v1h-4v4h-1v-4H6v4H5v-4H1v-1h4V6H1V5h4V1h1v4h4V1h1zM6 6v4h4V6H6z"
        /> < / svg >
    }
}
...
pub fn VsSymbolOperator(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolOperator"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolParameter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolParameter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolProperty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolProperty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolRuler(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolRuler"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolSnippet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolSnippet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolString(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolString"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSymbolStructure(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolStructure"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M2 2L1 3v3l1 1h12l1-1V3l-1-1H2zm0 1h12v3H2V3zm-1 7l1-1h3l1 1v3l-1 1H2l-1-1v-3zm2 0H2v3h3v-3H3zm7 0l1-1h3l1 1v3l-1 1h-3l-1-1v-3zm2 0h-1v3h3v-3h-2z"
        /> < / svg >
    }
}
...
pub fn VsSymbolVariable(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSymbolVariable"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSync(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSync"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsSyncIgnored(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsSyncIgnored"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path d = "M1.123 2.949l.682-.732L13.72 13.328l-.682.732z" /> < / svg >
    }
}
#[cfg(feature = "VsTable")]
...
pub fn VsTable(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTable"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTarget(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTarget"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path d =
        "M12 8C12 10.2091 10.2091 12 8 12C5.79086 12 4 10.2091 4 8C4 5.79086 5.79086 4 8 4C10.2091 4 12 5.79086 12 8ZM8 11C9.65685 11 11 9.65685 11 8C11 6.34315 9.65685 5 8 5C6.34315 5 5 6.34315 5 8C5 9.65685 6.34315 11 8 11Z"
        /> < path d =
        "M15 8C15 11.866 11.866 15 8 15C4.13401 15 1 11.866 1 8C1 4.13401 4.13401 1 8 1C11.866 1 15 4.13401 15 8ZM8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z"
        /> < / svg >
    }
}
...
pub fn VsTasklist(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTasklist"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M3.57 6.699l5.693-4.936L8.585 1 3.273 5.596l-1.51-1.832L1 4.442l1.85 2.214.72.043zM15 5H6.824l2.307-2H15v2zM6 7h9v2H6V7zm9 4H6v2h9v-2z"
        /> < / svg >
    }
}
...
pub fn VsTelescope(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTelescope"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalBash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalBash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalCmd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalCmd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalDebian(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalDebian"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalLinux(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalLinux"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalPowershell(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalPowershell"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalTmux(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalTmux"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTerminalUbuntu(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTerminalUbuntu"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTextSize(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTextSize"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsThreeBars(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsThreeBars"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d = "M14 5H2V3h12v2zm0 4H2V7h12v2zM2 13h12v-2H2v2z" /> < / svg >
    }
}
...
pub fn VsThumbsdown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsThumbsdown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsThumbsup(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsThumbsup"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTools(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTools"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTrash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTrash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTriangleDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTriangleDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2 5.56L2.413 5h11.194l.393.54L8.373 11h-.827L2 5.56z" /> < / svg >
    }
}
...
pub fn VsTriangleLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTriangleLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M10.44 2l.56.413v11.194l-.54.393L5 8.373v-.827L10.44 2z" /> < / svg >
    }
}
...
pub fn VsTriangleRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTriangleRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M5.56 14L5 13.587V2.393L5.54 2 11 7.627v.827L5.56 14z" /> < / svg >
    }
}
...
pub fn VsTriangleUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTriangleUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M14 10.44l-.413.56H2.393L2 10.46 7.627 5h.827L14 10.44z" /> < / svg >
    }
}
...
pub fn VsTwitter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTwitter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M15 3.784a5.63 5.63 0 0 1-.65.803 6.058 6.058 0 0 1-.786.68 5.442 5.442 0 0 1 .014.377c0 .574-.061 1.141-.184 1.702a8.467 8.467 0 0 1-.534 1.627 8.444 8.444 0 0 1-1.264 2.04 7.768 7.768 0 0 1-1.72 1.521 7.835 7.835 0 0 1-2.095.95 8.524 8.524 0 0 1-2.379.329 8.178 8.178 0 0 1-2.293-.325A7.921 7.921 0 0 1 1 12.52a5.762 5.762 0 0 0 4.252-1.19 2.842 2.842 0 0 1-2.273-1.19 2.878 2.878 0 0 1-.407-.8c.091.014.181.026.27.035a2.797 2.797 0 0 0 1.022-.089 2.808 2.808 0 0 1-.926-.362 2.942 2.942 0 0 1-.728-.633 2.839 2.839 0 0 1-.65-1.822v-.033c.402.227.837.348 1.306.362a2.943 2.943 0 0 1-.936-1.04 2.955 2.955 0 0 1-.253-.649 2.945 2.945 0 0 1 .007-1.453c.063-.243.161-.474.294-.693.364.451.77.856 1.216 1.213a8.215 8.215 0 0 0 3.008 1.525 7.965 7.965 0 0 0 1.695.263 2.15 2.15 0 0 1-.058-.325 3.265 3.265 0 0 1-.017-.331c0-.397.075-.77.226-1.118a2.892 2.892 0 0 1 1.528-1.528 2.79 2.79 0 0 1 1.117-.225 2.846 2.846 0 0 1 2.099.909 5.7 5.7 0 0 0 1.818-.698 2.815 2.815 0 0 1-1.258 1.586A5.704 5.704 0 0 0 15 3.785z"
        /> < / svg >
    }
}
...
pub fn VsTypeHierarchy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTypeHierarchy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsTypeHierarchySub(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTypeHierarchySub"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13.5 11h-1.729L8.438 6H9.5l.5-.5v-4L9.5 1h-4l-.5.5v4l.5.5h1.062l-3.333 5H1.5l-.5.5v3l.5.5h3l.5-.5v-3l-.5-.5h-.068L7.5 6.4l3.068 4.6H10.5l-.5.5v3l.5.5h3l.5-.5v-3l-.5-.5zM6 5V2h3v3H6zm-2 7v2H2v-2h2zm9 2h-2v-2h2v2z"
        /> < / svg >
    }
}
...
pub fn VsTypeHierarchySuper(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsTypeHierarchySuper"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsUnfold(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsUnfold"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsUngroupByRefType(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsUngroupByRefType"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsUnlock(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsUnlock"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M5 7V5a3 3 0 0 1 5.83-1h1.044A4.002 4.002 0 0 0 4 5v2H3L2 8v6l1 1h10l1-1V8l-1-1H5zm6 1h2v6H3V8h8z"
        /> < / svg >
    }
}
...
pub fn VsUnmute(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsUnmute"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsUnverified(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsUnverified"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVariableGroup(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVariableGroup"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVerified(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVerified"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVerifiedFilled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVerifiedFilled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVersions(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVersions"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill - rule = "evenodd" clip - rule =
        "evenodd" d =
        "M8 3L7 4v8l1 1h6l1-1V4l-1-1H8zm6 9H8V4h6v8zM5 9V5h1V4H4.5l-.5.5v7l.5.5H6v-1H5V9zM2 8V6h1V5H1.5l-.5.5v5l.5.5H3v-1H2V8z"
        /> < / svg >
    }
}
#[cfg(feature = "VsVm")]
...
pub fn VsVm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVmActive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVmActive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVmConnect(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVmConnect"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVmOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVmOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsVmRunning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsVmRunning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWand(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWand"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M4.38 5h1V4h1V3h-1V2h-1v1h-1v1h1v1zm8 4h-1v1h-1v1h1v1h1v-1h1v-1h-1V9zM14 2V1h-1v1h-1v1h1v1h1V3h1V2h-1zm-2.947 2.442a1.49 1.49 0 0 0-2.12 0l-7.49 7.49a1.49 1.49 0 0 0 0 2.12c.59.59 1.54.59 2.12 0l7.49-7.49c.58-.58.58-1.53 0-2.12zm-8.2 8.9c-.2.2-.51.2-.71 0-.2-.2-.2-.51 0-.71l6.46-6.46.71.71-6.46 6.46zm7.49-7.49l-.32.32-.71-.71.32-.32c.2-.2.51-.2.71 0 .19.2.19.52 0 .71z"
        /> < / svg >
    }
}
...
pub fn VsWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWatch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWatch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d = "M7.5 9h2V8H8V5.5H7v3l.5.5z" /> < path
        fill - rule = "evenodd" clip - rule = "evenodd" d =
...
pub fn VsWhitespace(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWhitespace"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWholeWord(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWholeWord"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWindow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWindow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWordWrap(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWordWrap"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWorkspaceTrusted(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWorkspaceTrusted"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn VsWorkspaceUnknown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("VsWorkspaceUnknown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
