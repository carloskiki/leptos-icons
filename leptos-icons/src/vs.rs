...
pub fn VsAccount(
    ...
    view! {
        ...
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" inner_html =
...
pub fn VsBlank(
    ...
    view! {
        ...
        stroke_width = "0" style = format!("{} color: {};", style, color) width = "16"
        height = "16" viewBox = "0 0 16 16" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" inner_html = "" > < title > {
        title } < / title > < / svg >
    }
}
#[cfg(feature = "VsBold")]
...
pub fn VsCircleSmallFilled(
    ...
    view! {
        cx, < svg class = class stroke = "currentColor" fill = "currentColor"
        stroke_width = "0" style = format!("{} color: {};", style, color) width = "16"
        height = "16" fill = "currentColor" width = size.clone() height = size xmlns =
...
pub fn VsDebug(
    ...
    view! {
        ...
        height = "24" viewBox = "0 0 24 24" fill = "currentColor" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" inner_html =
