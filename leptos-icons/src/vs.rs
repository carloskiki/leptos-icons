...
pub fn VsAccount(
    ...
    view! {
        ...
        width = "16" height = "16" viewBox = "0 0 16 16" fill = "currentColor" class =
        class style = format!("color: {}; {}", color, style) width = size.clone() height
...
pub fn VsCircleSmallFilled(
    ...
    view! {
        cx, < svg stroke = "currentColor" fill = "currentColor" stroke - width = "0"
        width = "16" height = "16" fill = "currentColor" class = class style =
...
pub fn VsDebug(
    ...
    view! {
        cx, < svg stroke = "currentColor" fill = "currentColor" stroke - width = "0"
        width = "24" height = "24" viewBox = "0 0 24 24" fill = "currentColor" class =
        class style = format!("color: {}; {}", color, style) width = size.clone() height
        = size xmlns = "http://www.w3.org/2000/svg" inner_html =
