...
pub fn FiActivity(
    ...
    view! {
        ...
        "24" viewBox = "0 0 24 24" fill = "none" stroke = "currentColor" stroke - width =
        "2" stroke - linecap = "round" stroke - linejoin = "round" width = size.clone()
...
pub fn FiCoffee(
    ...
    view! {
        cx, < svg class = class stroke = "currentColor" fill = "currentColor" stroke -
        width = "0" style = format!("color: {}; {}", color, style) viewBox = "0 0 24 24"
        width = "24" height = "24" fill = "none" stroke = "currentColor" stroke - width =
        "2" stroke - linecap = "round" stroke - linejoin = "round" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" inner_html =
