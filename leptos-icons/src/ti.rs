...
#[component]
pub fn TiAdjustBrightness(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAdjustContrast(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAnchor(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAnchorOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArchive(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowBack(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowBackOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowDown(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowDownOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowDownThick(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowForward(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowForwardOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowLeft(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowLeftOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowLeftThick(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowLoop(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowLoopOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMaximise(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMaximiseOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMinimise(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMinimiseOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMove(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowMoveOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowRepeat(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowRepeatOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowRight(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowRightOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowRightThick(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowShuffle(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowSortedDown(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowSortedUp(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowSync(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowSyncOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowUnsorted(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowUp(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowUpOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiArrowUpThick(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAt(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAttachment(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiAttachmentOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBackspace(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBackspaceOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBatteryCharge(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBatteryFull(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBatteryHigh(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBatteryLow(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBatteryMid(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBeaker(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBeer(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBell(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBook(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBookmark(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBriefcase(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBrush(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiBusinessCard(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCalculator(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCalendar(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCalendarOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCamera(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCameraOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCancel(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCancelOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartArea(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartAreaOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartBar(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartBarOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartLine(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartLineOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartPie(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChartPieOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChevronLeft(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChevronLeftOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChevronRight(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiChevronRightOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiClipboard(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCloudStorage(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCloudStorageOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCode(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCodeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCoffee(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCog(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCogOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCompass(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiContacts(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCreditCard(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiCss3(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDatabase(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDelete(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDeleteOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDeviceDesktop(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDeviceLaptop(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDevicePhone(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDeviceTablet(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDirections(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDivide(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDivideOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDocument(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDocumentAdd(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDocumentDelete(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDocumentText(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDownload(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDownloadOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiDropbox(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEdit(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEject(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEjectOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEquals(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEqualsOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiExport(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiExportOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEye(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiEyeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFeather(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFilm(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFilter(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlag(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlagOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlash(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlashOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlowChildren(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlowMerge(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlowParallel(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFlowSwitch(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFolder(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFolderAdd(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFolderDelete(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiFolderOpen(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiGift(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiGlobe(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiGlobeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiGroup(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiGroupOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHeadphones(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHeart(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHeartFullOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHeartHalfOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHeartOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHome(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHomeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiHtml5(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiImage(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiImageOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfinity(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfinityOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfo(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfoLarge(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfoLargeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInfoOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInputChecked(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiInputCheckedOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiKey(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiKeyOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiKeyboard(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLeaf(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLightbulb(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLink(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLinkOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLocation(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLocationArrow(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLocationArrowOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLocationOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLockClosed(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLockClosedOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLockOpen(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiLockOpenOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMail(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMap(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaEject(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaEjectOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaFastForward(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaFastForwardOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPause(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPauseOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPlay(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPlayOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPlayReverse(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaPlayReverseOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaRecord(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaRecordOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaRewind(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaRewindOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaStop(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMediaStopOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMessage(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMessageTyping(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMessages(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMicrophone(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMicrophoneOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMinus(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMinusOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiMortarBoard(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiNews(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiNotes(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiNotesOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPen(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPencil(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPhone(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPhoneOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPi(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPiOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPin(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPinOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPipette(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPlane(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPlaneOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPlug(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPlus(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPlusOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPointOfInterest(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPointOfInterestOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPower(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPowerOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPrinter(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPuzzle(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiPuzzleOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRadar(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRadarOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRefresh(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRefreshOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRss(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiRssOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiScissors(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiScissorsOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiShoppingBag(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiShoppingCart(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialAtCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialDribbble(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialDribbbleCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialFacebook(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialFacebookCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialFlickr(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialFlickrCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialGithub(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialGithubCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialGooglePlus(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialGooglePlusCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialInstagram(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialInstagramCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialLastFm(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialLastFmCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialLinkedin(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialLinkedinCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialPinterest(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialPinterestCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialSkype(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialSkypeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialTumbler(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialTumblerCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialTwitter(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialTwitterCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialVimeo(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialVimeoCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialYoutube(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSocialYoutubeCircular(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSortAlphabetically(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSortAlphabeticallyOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSortNumerically(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSortNumericallyOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSpanner(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSpannerOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSpiral(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStar(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarFullOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarHalf(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarHalfOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarburst(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStarburstOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiStopwatch(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiSupport(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTabsOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTag(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTags(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThLarge(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThLargeOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThList(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThListOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThMenu(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThMenuOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThSmall(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThSmallOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThermometer(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThumbsDown(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThumbsOk(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiThumbsUp(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTick(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTickOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTicket(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTime(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTimes(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTimesOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTrash(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiTree(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUpload(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUploadOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUser(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUserAdd(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUserAddOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUserDelete(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUserDeleteOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiUserOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVendorAndroid(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVendorApple(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVendorMicrosoft(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVideo(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVideoOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVolume(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVolumeDown(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVolumeMute(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiVolumeUp(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWarning(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWarningOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWatch(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWaves(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWavesOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherCloudy(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherDownpour(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherNight(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherPartlySunny(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherShower(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherSnow(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherStormy(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherSunny(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherWindy(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWeatherWindyCloudy(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWiFi(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWiFiOutline(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWine(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWorld(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiWorldOutline(cx: Scope) -> impl IntoView {
    view! { cx,
        <svg xmlns="http://www.w3.org/2000/svg" version="1.2" baseProfile="tiny" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2c-4.971 0-9 4.029-9 9s4.029 9 9 9 9-4.029 9-9-4.029-9-9-9zm0 6c0-.553.447-1 1-1s1 .447 1 1v3c-.552 0-1 .448-1 1s.448 1 1 1c.553 0 1-.448 1-1h1v-2l1 1-1 1c0 3 0 3-2 4 0-1-1-1-3-1v-2l-2-2v-2c-1 0-1 1-1 1l-.561-.561-1.652-1.651c1.167-2.247 3.512-3.788 6.213-3.788.688 0 1.353.104 1.981.29-.086.895-.579 1.71-1.481 1.71-1 0-1.5 1-1.5 2v3s1 0 1-3zm0 10c-3.859 0-7-3.14-7-7 0-.776.133-1.521.367-2.219l1.926 1.926 1 1 1.707 1.707v1.586c0 .552.447 1 1 1 .779 0 1.651 0 2.006.091.038.301.209.582.468.742.168.104.36.16.552.16.145 0 .289-.032.422-.098 2.348-1.174 2.539-1.644 2.552-4.479l.708-.708c.391-.391.391-1.023 0-1.414l-1-1c-.192-.192-.448-.294-.708-.294-.129 0-.259.025-.383.076-.373.155-.617.52-.617.924v-2c0-.689-.351-1.298-.883-1.658.421-.411.712-.995.826-1.685 2.392 1.115 4.057 3.535 4.057 6.343 0 3.86-3.141 7-7 7z" /></svg>
    }
}
...
#[component]
pub fn TiZoom(cx: Scope) -> impl IntoView {
    view! { cx,
...
#[component]
pub fn TiZoomIn(cx: Scope) -> impl IntoView {
    view! { cx,
