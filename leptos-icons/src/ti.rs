...
pub fn TiAdjustBrightness(
    ...
    view! {
        ...
        version = "1.2" baseProfile = "tiny" width = "24" height = "24" viewBox =
        "0 0 24 24" class = class style = format!("color: {}; {}", color, style) width =
...
pub fn TiCss3(
    ...
    view! {
        cx, < svg stroke = "currentColor" fill = "currentColor" stroke - width = "0"
        version = "1" width = "24" height = "24" viewBox = "0 0 24 24" class = class
...
pub fn TiSocialYoutubeCircular(
    ...
    view! {
        cx, < svg stroke = "currentColor" fill = "currentColor" stroke - width = "0"
        version = "1.1" id = "Layer_1" width = "24px" height = "24px" viewBox =
        "0 0 24 24" class = class style = format!("color: {}; {}", color, style) width =
        size.clone() height = size xmlns = "http://www.w3.org/2000/svg" inner_html =
