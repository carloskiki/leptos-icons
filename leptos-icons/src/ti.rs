...
pub fn TiAdjustBrightness(
    ...
    #[prop(into, optional, default = String::from("TiAdjustBrightness"))]
    title: String,
) -> impl IntoView {
    view! {
        ...
        "M12 6.934l1-2.934c.072-.213.078-.452 0-.682-.188-.553-.789-.848-1.341-.659-.553.189-.847.788-.659 1.341l1 2.934zM4 11c-.213-.072-.452-.078-.682 0-.553.188-.848.789-.659 1.341.189.553.788.847 1.341.659l2.934-1-2.934-1zM12 17.066l-1 2.934c-.072.213-.078.452 0 .682.188.553.789.848 1.341.659.553-.189.847-.788.659-1.341l-1-2.934zM21.341 11.657c-.188-.553-.788-.848-1.341-.659l-2.934 1 2.934 1c.213.072.452.078.682 0 .552-.188.847-.789.659-1.341zM5.636 7.05l2.781 1.367-1.367-2.781c-.1-.202-.265-.375-.482-.482-.524-.258-1.157-.042-1.415.482-.257.523-.041 1.157.483 1.414zM5.153 17.432c-.257.523-.041 1.156.482 1.414.523.257 1.157.041 1.414-.482l1.367-2.781-2.781 1.367c-.201.099-.374.263-.482.482zM18.363 16.949l-2.781-1.367 1.367 2.781c.1.202.264.375.482.482.523.257 1.156.041 1.414-.482s.042-1.157-.482-1.414zM18.844 6.566c.258-.524.042-1.157-.481-1.415-.523-.257-1.157-.041-1.414.482l-1.369 2.783 2.782-1.368c.202-.1.375-.264.482-.482zM12 7.5c-2.481 0-4.5 2.019-4.5 4.5s2.019 4.5 4.5 4.5 4.5-2.019 4.5-4.5-2.019-4.5-4.5-4.5z"
        /> < / svg >
    }
}
...
pub fn TiAdjustContrast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAdjustContrast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < g > < path d =
...
pub fn TiAnchor(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAnchor"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiAnchorOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAnchorOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < g > < circle cx = "12" cy = "6" r = "1" /> < path
        d =
...
pub fn TiArchive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArchive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowBack(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowBack"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowBackOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowBackOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16.707 13.293c-.391-.391-1.023-.391-1.414 0l-2.293 2.293v-7.586c0-.552-.447-1-1-1s-1 .448-1 1v7.586l-2.293-2.293c-.391-.391-1.023-.391-1.414 0s-.391 1.023 0 1.414l4.707 4.707 4.707-4.707c.391-.391.391-1.023 0-1.414z"
        /> < / svg >
    }
}
...
pub fn TiArrowDownOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowDownOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowDownThick(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowDownThick"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowForward(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowForward"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13 5.499c-.256 0-.512.097-.707.292-.195.196-.293.452-.293.708v2.559c-4.5.498-8 4.309-8 8.941v1c2.245-3.423 5.25-3.92 8-3.989v2.489c0 .255.098.512.293.707s.451.293.707.293.512-.098.707-.293l6.293-6.207-6.293-6.208c-.195-.195-.451-.292-.707-.292z"
        /> < / svg >
    }
}
...
pub fn TiArrowForwardOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowForwardOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M17 11h-7.586l2.293-2.293c.391-.391.391-1.023 0-1.414s-1.023-.391-1.414 0l-4.707 4.707 4.707 4.707c.195.195.451.293.707.293s.512-.098.707-.293c.391-.391.391-1.023 0-1.414l-2.293-2.293h7.586c.552 0 1-.448 1-1s-.448-1-1-1z"
        /> < / svg >
    }
}
...
pub fn TiArrowLeftOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowLeftOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowLeftThick(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowLeftThick"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowLoop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowLoop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowLoopOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowLoopOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMaximise(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMaximise"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMaximiseOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMaximiseOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMinimise(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMinimise"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMinimiseOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMinimiseOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMove(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMove"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowMoveOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowMoveOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowRepeat(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowRepeat"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowRepeatOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowRepeatOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowRightOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowRightOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowRightThick(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowRightThick"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowShuffle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowShuffle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowSortedDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowSortedDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M5.8 9.7l6.2 6.3 6.2-6.3c.2-.2.3-.5.3-.7s-.1-.5-.3-.7c-.2-.2-.4-.3-.7-.3h-11c-.3 0-.5.1-.7.3-.2.2-.3.4-.3.7s.1.5.3.7z"
        /> < / svg >
    }
}
...
pub fn TiArrowSortedUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowSortedUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M18.2 13.3l-6.2-6.3-6.2 6.3c-.2.2-.3.5-.3.7s.1.5.3.7c.2.2.4.3.7.3h11c.3 0 .5-.1.7-.3.2-.2.3-.5.3-.7s-.1-.5-.3-.7z"
        /> < / svg >
    }
}
...
pub fn TiArrowSync(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowSync"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowSyncOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowSyncOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowUnsorted(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowUnsorted"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M18.2 9.3l-6.2-6.3-6.2 6.3c-.2.2-.3.4-.3.7s.1.5.3.7c.2.2.4.3.7.3h11c.3 0 .5-.1.7-.3.2-.2.3-.5.3-.7s-.1-.5-.3-.7zM5.8 14.7l6.2 6.3 6.2-6.3c.2-.2.3-.5.3-.7s-.1-.5-.3-.7c-.2-.2-.4-.3-.7-.3h-11c-.3 0-.5.1-.7.3-.2.2-.3.5-.3.7s.1.5.3.7z"
        /> < / svg >
    }
}
...
pub fn TiArrowUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13 5.586l-4.707 4.707c-.391.391-.391 1.023 0 1.414s1.023.391 1.414 0l2.293-2.293v7.586c0 .552.447 1 1 1s1-.448 1-1v-7.586l2.293 2.293c.195.195.451.293.707.293s.512-.098.707-.293c.391-.391.391-1.023 0-1.414l-4.707-4.707z"
        /> < / svg >
    }
}
...
pub fn TiArrowUpOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowUpOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiArrowUpThick(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiArrowUpThick"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiAt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiAttachment(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAttachment"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiAttachmentOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiAttachmentOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBackspace(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBackspace"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M19.5 5h-10c-1.266 0-2.834.807-3.57 1.837l-2.61 3.653-1.199 1.679c-.121.175-.122.492.003.664l1.188 1.664 2.619 3.667c.735 1.029 2.302 1.836 3.569 1.836h10c1.379 0 2.5-1.122 2.5-2.5v-10c0-1.378-1.121-2.5-2.5-2.5zm-2.293 9.793c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-2.293-2.293-2.293 2.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023 0-1.414l2.293-2.293-2.293-2.293c-.391-.391-.391-1.023 0-1.414s1.023-.391 1.414 0l2.293 2.293 2.293-2.293c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414l-2.293 2.293 2.293 2.293z"
        /> < / svg >
    }
}
...
pub fn TiBackspaceOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBackspaceOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBatteryCharge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBatteryCharge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBatteryFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBatteryFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBatteryHigh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBatteryHigh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M9 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM12 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z"
        /> < / svg >
    }
}
...
pub fn TiBatteryLow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBatteryLow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z"
        /> < / svg >
    }
}
...
pub fn TiBatteryMid(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBatteryMid"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M9 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM6 16c-.552 0-1-.447-1-1v-4c0-.553.448-1 1-1s1 .447 1 1v4c0 .553-.448 1-1 1zM19 10c0-1.654-1.346-3-3-3h-11c-1.654 0-3 1.346-3 3v6c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3 1.104 0 2-.896 2-2v-2c0-1.104-.896-2-2-2zm-2 6c0 .552-.449 1-1 1h-11c-.551 0-1-.448-1-1v-6c0-.552.449-1 1-1h11c.551 0 1 .448 1 1v6z"
        /> < / svg >
    }
}
...
pub fn TiBeaker(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBeaker"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBeer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBeer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBell(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBell"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBookmark(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBookmark"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBriefcase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBriefcase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBrush(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBrush"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiBusinessCard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiBusinessCard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCalculator(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCalculator"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "10" cy = "11" r = "1" /> < circle cx = "13" cy = "11" r = "1"
        /> < circle cx = "16" cy = "11" r = "1" /> < circle cx = "10" cy = "14" r = "1"
        /> < circle cx = "13" cy = "14" r = "1" /> < circle cx = "16" cy = "14" r = "1"
        /> < circle cx = "10" cy = "17" r = "1" /> < circle cx = "13" cy = "17" r = "1"
        /> < circle cx = "16" cy = "17" r = "1" /> < path d =
        "M16 7v1h-6v-1h6m1-1h-8v3h8v-3z" /> < / svg >
    }
}
...
pub fn TiCalendar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCalendar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCalendarOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCalendarOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCamera(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCamera"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M19 6h-1.586l-1-1c-.579-.579-1.595-1-2.414-1h-4c-.819 0-1.835.421-2.414 1l-1 1h-1.586c-1.654 0-3 1.346-3 3v8c0 1.654 1.346 3 3 3h14c1.654 0 3-1.346 3-3v-8c0-1.654-1.346-3-3-3zm-7 10c-1.933 0-3.5-1.568-3.5-3.5 0-1.934 1.567-3.5 3.5-3.5s3.5 1.566 3.5 3.5c0 1.932-1.567 3.5-3.5 3.5zm6-4.701c-.719 0-1.3-.58-1.3-1.299s.581-1.301 1.3-1.301 1.3.582 1.3 1.301-.581 1.299-1.3 1.299z"
        /> < / svg >
    }
}
...
pub fn TiCameraOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCameraOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCancel(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCancel"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCancelOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCancelOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartArea(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartArea"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartAreaOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartAreaOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartBar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartBar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartBarOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartBarOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartLine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartLine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartLineOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartLineOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartPie(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartPie"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChartPieOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChartPieOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChevronLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChevronLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChevronLeftOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChevronLeftOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiChevronRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChevronRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M8.586 5.586c-.781.781-.781 2.047 0 2.828l3.585 3.586-3.585 3.586c-.781.781-.781 2.047 0 2.828.39.391.902.586 1.414.586s1.024-.195 1.414-.586l6.415-6.414-6.415-6.414c-.78-.781-2.048-.781-2.828 0z"
        /> < / svg >
    }
}
...
pub fn TiChevronRightOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiChevronRightOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiClipboard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiClipboard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < g > < path d =
        "M17 3h-10c-1.654 0-3 1.346-3 3v12c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3v-12c0-1.654-1.346-3-3-3zm-8 2h6v1c0 .551-.449 1-1 1h-4c-.551 0-1-.449-1-1v-1zm9 13c0 .551-.449 1-1 1h-10c-.551 0-1-.449-1-1v-12c0-.551.449-1 1-1h1v1c0 1.1.9 2 2 2h4c1.1 0 2-.9 2-2v-1h1c.551 0 1 .449 1 1v12zM16 17h-8c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h8c.276 0 .5.224.5.5s-.224.5-.5.5zM16 14h-8c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h8c.276 0 .5.224.5.5s-.224.5-.5.5zM16 11h-8c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h8c.276 0 .5.224.5.5s-.224.5-.5.5z"
        /> </ g > < / svg >
    }
}
...
pub fn TiCloudStorage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCloudStorage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCloudStorageOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCloudStorageOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCodeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCodeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCoffee(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCoffee"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCogOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCogOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCompass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCompass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiContacts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiContacts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < g > < path d =
        "M19 3h-11c-1.654 0-3 1.346-3 3v1h-1c-.553 0-1 .448-1 1s.447 1 1 1h1v2h-1c-.553 0-1 .448-1 1s.447 1 1 1h1v2h-1c-.553 0-1 .448-1 1s.447 1 1 1h1v1c0 1.654 1.346 3 3 3h11c1.654 0 3-1.346 3-3v-12c0-1.654-1.346-3-3-3zm-12 3c0-.551.449-1 1-1v2h-1v-1zm0 3h1v2h-1v-2zm0 4h1v2h-1v-2zm0 5v-1h1v2c-.551 0-1-.449-1-1zm13 0c0 .551-.449 1-1 1h-10v-14h10c.551 0 1 .449 1 1v12z"
        /> < circle cx = "14" cy = "10.5" r = "2" /> < path d =
        "M14 13.356c-1.562 0-2.5.715-2.5 1.429 0 .357.938.715 2.5.715 1.466 0 2.5-.357 2.5-.715 0-.714-.98-1.429-2.5-1.429z"
        /> </ g > < / svg >
    }
}
...
pub fn TiCreditCard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCreditCard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiCss3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiCss3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDatabase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDatabase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDelete(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDelete"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12 4c-4.419 0-8 3.582-8 8s3.581 8 8 8 8-3.582 8-8-3.581-8-8-8zm3.707 10.293c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293s-.512-.098-.707-.293l-2.293-2.293-2.293 2.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023 0-1.414l2.293-2.293-2.293-2.293c-.391-.391-.391-1.023 0-1.414s1.023-.391 1.414 0l2.293 2.293 2.293-2.293c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414l-2.293 2.293 2.293 2.293z"
        /> < / svg >
    }
}
...
pub fn TiDeleteOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDeleteOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDeviceDesktop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDeviceDesktop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDeviceLaptop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDeviceLaptop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDevicePhone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDevicePhone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDeviceTablet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDeviceTablet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDirections(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDirections"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDivide(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDivide"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < circle cx = "12" cy = "6" r = "2.25" /> < circle
        cx = "12" cy = "18" r = "2.25" /> < path d =
        "M18 10h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2z" />
        < / svg >
    }
}
...
pub fn TiDivideOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDivideOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDocument(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDocument"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M19.707 7.293l-4-4c-.187-.188-.441-.293-.707-.293h-8c-1.654 0-3 1.346-3 3v12c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3v-10c0-.266-.105-.52-.293-.707zm-2.121.707h-1.086c-.827 0-1.5-.673-1.5-1.5v-1.086l2.586 2.586zm-.586 11h-10c-.552 0-1-.448-1-1v-12c0-.552.448-1 1-1h7v1.5c0 1.379 1.121 2.5 2.5 2.5h1.5v9c0 .552-.448 1-1 1z"
        /> < / svg >
    }
}
...
pub fn TiDocumentAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDocumentAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDocumentDelete(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDocumentDelete"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDocumentText(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDocumentText"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDownloadOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDownloadOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiDropbox(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiDropbox"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEdit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEdit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEject(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEject"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEjectOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEjectOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEquals(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEquals"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M18 7h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2zM18 14h-12c-1.104 0-2 .896-2 2s.896 2 2 2h12c1.104 0 2-.896 2-2s-.896-2-2-2z"
        /> < / svg >
    }
}
...
pub fn TiEqualsOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEqualsOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M18 12h-12c-1.654 0-3-1.346-3-3s1.346-3 3-3h12c1.654 0 3 1.346 3 3s-1.346 3-3 3zm-12-4c-.552 0-1 .449-1 1s.448 1 1 1h12c.552 0 1-.449 1-1s-.448-1-1-1h-12zM18 19h-12c-1.654 0-3-1.346-3-3s1.346-3 3-3h12c1.654 0 3 1.346 3 3s-1.346 3-3 3zm-12-4c-.552 0-1 .449-1 1s.448 1 1 1h12c.552 0 1-.449 1-1s-.448-1-1-1h-12z"
        /> < / svg >
    }
}
...
pub fn TiExport(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiExport"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiExportOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiExportOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEye(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEye"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiEyeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiEyeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFeather(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFeather"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFilm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFilm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFilter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFilter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlagOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlagOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlashOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlashOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlowChildren(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlowChildren"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlowMerge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlowMerge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlowParallel(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlowParallel"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFlowSwitch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFlowSwitch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFolder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFolder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFolderAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFolderAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFolderDelete(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFolderDelete"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiFolderOpen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiFolderOpen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M22.3 8h-2.4c-.4-1.2-1.5-2-2.8-2h-6c0-1.1-.9-2-2-2h-4.1c-1.7 0-3 1.3-3 3v10c0 1.7 1.3 3 3 3h12c1.7 0 3.4-1.3 3.8-3l2.2-8c.1-.6-.2-1-.7-1zm-18.3 1v-2c0-.6.4-1 1-1h4c0 1.1.9 2 2 2h6c.6 0 1 .4 1 1h-11.1c-.6 0-1.1.4-1.3 1l-1.6 6.3v-7.3zm14.9 7.5c-.2.8-1.1 1.5-1.9 1.5h-12s-.4-.2-.2-.8l1.9-7c0-.1.2-.2.3-.2h13.7l-1.8 6.5z"
        /> < / svg >
    }
}
#[cfg(feature = "TiGift")]
...
pub fn TiGift(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiGift"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiGlobe(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiGlobe"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiGlobeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiGlobeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiGroup(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiGroup"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiGroupOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiGroupOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHeadphones(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHeadphones"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHeart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHeart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHeartFullOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHeartFullOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M2.2 9.4c0 1.3.2 3.3 2 5.1 1.6 1.6 6.9 5.2 7.1 5.4.2.1.4.2.6.2s.4-.1.6-.2c.2-.2 5.5-3.7 7.1-5.4 1.8-1.8 2-3.8 2-5.1 0-3-2.4-5.4-5.4-5.4-1.6 0-3.2.9-4.2 2.3-1-1.4-2.6-2.3-4.4-2.3-2.9 0-5.4 2.4-5.4 5.4z"
        /> < / svg >
    }
}
...
pub fn TiHeartHalfOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHeartHalfOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHeartOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHeartOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHome(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHome"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12 3s-6.186 5.34-9.643 8.232c-.203.184-.357.452-.357.768 0 .553.447 1 1 1h2v7c0 .553.447 1 1 1h3c.553 0 1-.448 1-1v-4h4v4c0 .552.447 1 1 1h3c.553 0 1-.447 1-1v-7h2c.553 0 1-.447 1-1 0-.316-.154-.584-.383-.768-3.433-2.892-9.617-8.232-9.617-8.232z"
        /> < / svg >
    }
}
...
pub fn TiHomeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHomeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiHtml5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiHtml5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiImage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiImage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < circle cx = "8.5" cy = "8.5" r = "2.5" /> < path
        d =
...
pub fn TiImageOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiImageOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInfinity(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfinity"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInfinityOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfinityOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInfo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21.17,15.4l-5.91-9.85C14.48,4.25,13.3,3.51,12,3.51S9.52,4.25,8.74,5.54L2.83,15.4c-0.44,0.73-0.66,1.49-0.66,2.21
...
pub fn TiInfoLarge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfoLarge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInfoLargeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfoLargeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInfoOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInfoOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiInputChecked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInputChecked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16 19h-8c-1.654 0-3-1.346-3-3v-8c0-1.654 1.346-3 3-3h5c.553 0 1 .448 1 1s-.447 1-1 1h-5c-.552 0-1 .449-1 1v8c0 .551.448 1 1 1h8c.552 0 1-.449 1-1v-3c0-.552.447-1 1-1s1 .448 1 1v3c0 1.654-1.346 3-3 3zM13.166 14.833c-.35 0-.689-.139-.941-.391l-2.668-2.667c-.52-.521-.52-1.365 0-1.885.521-.521 1.365-.521 1.887 0l1.416 1.417 3.475-5.455c.357-.644 1.17-.877 1.814-.519.643.358.875 1.17.518 1.813l-4.334 7c-.203.366-.566.615-.98.673l-.187.014z"
        /> < / svg >
    }
}
...
pub fn TiInputCheckedOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiInputCheckedOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiKey(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiKey"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M8.5 11c0 .732.166 1.424.449 2.051l-3.949 3.949v1.5s.896 1.5 2 1.5h2v-2h2v-2h2.5c2.762 0 5-2.238 5-5s-2.238-5-5-5-5 2.238-5 5zm5 2c-1.104 0-2-.896-2-2 0-1.105.896-2.002 2-2.002 1.105 0 2 .896 2 2.002 0 1.104-.895 2-2 2z"
        /> < / svg >
    }
}
...
pub fn TiKeyOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiKeyOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiKeyboard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiKeyboard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLeaf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLeaf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLightbulb(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLightbulb"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLink(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLink"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLinkOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLinkOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLocation(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLocation"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLocationArrow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLocationArrow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLocationArrowOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLocationArrowOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M11.087 20.914c-.353 0-1.219-.146-1.668-1.496l-1.209-3.627-3.628-1.209c-1.244-.415-1.469-1.172-1.493-1.587s.114-1.193 1.302-1.747l11.375-5.309c1.031-.479 1.922-.309 2.348.362.224.351.396.97-.053 1.933l-5.309 11.375c-.529 1.135-1.272 1.305-1.665 1.305zm-5.39-8.068l4.094 1.363 1.365 4.093 4.775-10.233-10.234 4.777z"
        /> < / svg >
    }
}
...
pub fn TiLocationOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLocationOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLockClosed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLockClosed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M17 10h-1v-2c0-2.205-1.794-4-4-4s-4 1.795-4 4v2h-1c-1.103 0-2 .896-2 2v7c0 1.104.897 2 2 2h10c1.103 0 2-.896 2-2v-7c0-1.104-.897-2-2-2zm-5 8.299c-.719 0-1.3-.58-1.3-1.299s.581-1.301 1.3-1.301 1.3.582 1.3 1.301-.581 1.299-1.3 1.299zm2-7.299h-4v-3c0-1.104.897-2 2-2s2 .896 2 2v3z"
        /> < / svg >
    }
}
...
pub fn TiLockClosedOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLockClosedOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < circle cx = "12" cy = "17" r = "1.3" /> < path d
        =
...
pub fn TiLockOpen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLockOpen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiLockOpenOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiLockOpenOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMap(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMap"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaEject(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaEject"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaEjectOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaEjectOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaFastForward(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaFastForward"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaFastForwardOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaFastForwardOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPause(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPause"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPauseOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPauseOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPlay(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPlay"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPlayOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPlayOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPlayReverse(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPlayReverse"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaPlayReverseOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaPlayReverseOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaRecord(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaRecord"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaRecordOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaRecordOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaRewind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaRewind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaRewindOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaRewindOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMediaStop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaStop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16 6h-8c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z" />
        < / svg >
    }
}
...
pub fn TiMediaStopOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMediaStopOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16 8v8h-8v-8h8m0-2h-8c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2z"
        /> < / svg >
    }
}
...
pub fn TiMessage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMessage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMessageTyping(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMessageTyping"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMessages(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMessages"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21 7h-3c0-1.65-1.35-3-3-3h-12c-1.65 0-3 1.35-3 3v7c0 1.65 1.35 3 3 3v3l3-3c0 1.65 1.35 3 3 3h8l3 3v-3h1c1.65 0 3-1.35 3-3v-7c0-1.65-1.35-3-3-3zm-18 8c-.542 0-1-.458-1-1v-7c0-.542.458-1 1-1h12c.542 0 1 .458 1 1v1h-6.5c-1.379 0-2.5 1.121-2.5 2.5v4.5h-4zm19 2c0 .542-.458 1-1 1h-12c-.542 0-1-.458-1-1v-6.5c0-.827.673-1.5 1.5-1.5h11.5c.542 0 1 .458 1 1v7z"
        /> < / svg >
    }
}
...
pub fn TiMicrophone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMicrophone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMicrophoneOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMicrophoneOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMinus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMinus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMinusOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMinusOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiMortarBoard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiMortarBoard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiNews(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiNews"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21 4h-18c-1.104 0-2 .896-2 2v12c0 1.104.896 2 2 2h18c1.104 0 2-.896 2-2v-12c0-1.104-.896-2-2-2zm-18 2h8v12h-8v-12zm18 12h-9v-12h9.003l-.003 12zM20 13.5c0-.275-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5v3c0 .275.225.5.5.5h1c.275 0 .5-.225.5-.5v-3zM17 7.5c0-.275-.225-.5-.5-.5h-3c-.275 0-.5.225-.5.5v5c0 .275.225.5.5.5h3c.275 0 .5-.225.5-.5v-5zM18.5 10h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM18.5 12h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM13.5 15h3c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-3c-.275 0-.5.225-.5.5s.225.5.5.5zM16.5 16h-3c-.275 0-.5.225-.5.5s.225.5.5.5h3c.275 0 .5-.225.5-.5s-.225-.5-.5-.5zM18.5 8h1c.275 0 .5-.225.5-.5s-.225-.5-.5-.5h-1c-.275 0-.5.225-.5.5s.225.5.5.5zM10 7.5c0-.275-.225-.5-.5-.5h-5c-.275 0-.5.225-.5.5v3c0 .275.225.5.5.5h5c.275 0 .5-.225.5-.5v-3zM9.501 14h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5zM9.501 12h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5zM9.501 16h-5c-.274 0-.5.225-.5.5s.226.5.5.5h5c.274 0 .499-.225.499-.5s-.225-.5-.499-.5z"
        /> < / svg >
    }
}
#[cfg(feature = "TiNotes")]
...
pub fn TiNotes(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiNotes"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiNotesOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiNotesOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPencil(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPencil"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21 6.879l-3.879-3.879c-.293-.293-.678-.439-1.061-.439-.384 0-.767.146-1.06.439l-10.939 10.939c-.293.293-.558.727-.75 1.188-.192.463-.311.959-.311 1.373v4.5h4.5c.414 0 .908-.119 1.371-.311.463-.192.896-.457 1.189-.75l10.94-10.939c.293-.293.439-.678.439-1.061 0-.384-.146-.767-.439-1.06zm-15.232 8.182l8.293-8.293 1.232 1.232-8.293 8.293-1.232-1.232zm1.732 3.939h-1.5l-1-1v-1.5c0-.077.033-.305.158-.605.01-.02 2.967 2.938 2.967 2.938-.322.134-.548.167-.625.167zm1.439-.768l-1.232-1.232 8.293-8.293 1.232 1.232-8.293 8.293zm9-9l-3.172-3.172 1.293-1.293 3.17 3.172-1.291 1.293z"
        /> < / svg >
    }
}
#[cfg(feature = "TiPhone")]
...
pub fn TiPhone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPhone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPhoneOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPhoneOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPi(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPi"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPiOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPiOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPinOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPinOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPipette(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPipette"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPlane(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPlane"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPlaneOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPlaneOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPlug(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPlug"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M18,6h-1V3c0-0.6-0.4-1-1-1h-2c-0.6,0-1,0.4-1,1v3h-2V3c0-0.6-0.4-1-1-1H8C7.4,2,7,2.4,7,3v3H6C5.4,6,5,6.4,5,7v4
...
pub fn TiPlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPlusOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPlusOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPointOfInterest(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPointOfInterest"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPointOfInterestOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPointOfInterestOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPower(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPower"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPowerOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPowerOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPrinter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPrinter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPuzzle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPuzzle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiPuzzleOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiPuzzleOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRadar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRadar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRadarOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRadarOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRefresh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRefresh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRefreshOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRefreshOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRss(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRss"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiRssOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiRssOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiScissors(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiScissors"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiScissorsOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiScissorsOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiShoppingBag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiShoppingBag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiShoppingCart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiShoppingCart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "8.5" cy = "19.5" r = "1.5" /> < circle cx = "17.5" cy = "19.5"
        r = "1.5" /> </ g > < / svg >
    }
}
...
pub fn TiSocialAtCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialAtCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialDribbble(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialDribbble"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialDribbbleCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialDribbbleCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialFacebook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialFacebook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M13 10h3v3h-3v7h-3v-7h-3v-3h3v-1.255c0-1.189.374-2.691 1.118-3.512.744-.823 1.673-1.233 2.786-1.233h2.096v3h-2.1c-.498 0-.9.402-.9.899v2.101z"
        /> < / svg >
    }
}
...
pub fn TiSocialFacebookCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialFacebookCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialFlickr(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialFlickr"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M7.5 16c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2zM16.5 8c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z"
        /> < / svg >
    }
}
...
pub fn TiSocialFlickrCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialFlickrCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialGithub(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialGithub"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialGithubCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialGithubCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialGooglePlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialGooglePlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialGooglePlusCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialGooglePlusCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialInstagram(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialInstagram"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialInstagramCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialInstagramCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12 3c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 7c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm2.8-2c0-.7.6-1.2 1.2-1.2s1.2.6 1.2 1.2-.5 1.2-1.2 1.2-1.2-.5-1.2-1.2zm-2.8 11c-3.9 0-7-3.1-7-7h3c0 2.2 1.8 4 4 4s4-1.8 4-4h3c0 3.9-3.1 7-7 7z"
        /> < / svg >
    }
}
...
pub fn TiSocialLastFm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialLastFm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialLastFmCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialLastFmCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialLinkedin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialLinkedin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < ellipse cx = "6.5" cy = "6.5" rx = "1.55" ry = "1.5" /> < / svg >
    }
}
...
pub fn TiSocialLinkedinCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialLinkedinCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialPinterest(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialPinterest"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialPinterestCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialPinterestCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialSkype(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialSkype"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialSkypeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialSkypeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialTumbler(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialTumbler"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialTumblerCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialTumblerCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialTwitter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialTwitter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialTwitterCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialTwitterCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialVimeo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialVimeo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialVimeoCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialVimeoCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialYoutube(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialYoutube"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSocialYoutubeCircular(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSocialYoutubeCircular"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < polygon points =
...
pub fn TiSortAlphabetically(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSortAlphabetically"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSortAlphabeticallyOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSortAlphabeticallyOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSortNumerically(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSortNumerically"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSortNumericallyOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSortNumericallyOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSpanner(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSpanner"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSpannerOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSpannerOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < g > < circle cx = "8" cy = "16" r = "1" /> < path
        d =
...
pub fn TiSpiral(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSpiral"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStarFullOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarFullOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M3.1 11.3l3.6 3.3-1 4.6c-.1.6.1 1.2.6 1.5.2.2.5.3.8.3.2 0 .4 0 .6-.1 0 0 .1 0 .1-.1l4.1-2.3 4.1 2.3s.1 0 .1.1c.5.2 1.1.2 1.5-.1.5-.3.7-.9.6-1.5l-1-4.6c.4-.3 1-.9 1.6-1.5l1.9-1.7.1-.1c.4-.4.5-1 .3-1.5s-.6-.9-1.2-1h-.1l-4.7-.5-1.9-4.3s0-.1-.1-.1c-.1-.7-.6-1-1.1-1-.5 0-1 .3-1.3.8 0 0 0 .1-.1.1l-1.9 4.3-4.7.5h-.1c-.5.1-1 .5-1.2 1-.1.6 0 1.2.4 1.6z"
        /> < / svg >
    }
}
...
pub fn TiStarHalf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarHalf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStarHalfOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarHalfOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M3.1 11.3l3.6 3.3-1 4.6c-.1.6.1 1.2.6 1.5.2.2.5.3.8.3.2 0 .4 0 .6-.1 0 0 .1 0 .1-.1l4.1-2.3 4.1 2.3s.1 0 .1.1c.5.2 1.1.2 1.5-.1.5-.3.7-.9.6-1.5l-1-4.6c.4-.3 1-.9 1.6-1.5l1.9-1.7.1-.1c.4-.4.5-1 .3-1.5s-.6-.9-1.2-1h-.1l-4.7-.5-1.9-4.3s0-.1-.1-.1c-.1-.7-.6-1-1.1-1-.5 0-1 .3-1.3.8 0 0 0 .1-.1.1l-1.9 4.3-4.7.5h-.1c-.5.1-1 .5-1.2 1-.1.6 0 1.2.4 1.6zm8.9 5v-10.5l1.7 3.8c.1.3.5.5.8.6l4.2.5-3.1 2.8c-.3.2-.4.6-.3 1 0 .2.5 2.2.8 4.1l-3.6-2.1c-.2-.2-.3-.2-.5-.2z"
        /> < / svg >
    }
}
...
pub fn TiStarOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStarburst(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarburst"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStarburstOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStarburstOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiStopwatch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiStopwatch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiSupport(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiSupport"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTabsOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTabsOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTags(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTags"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThLarge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThLarge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThLargeOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThLargeOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThList(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThList"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "5" cy = "19" r = "2.5" /> < circle cx = "5" cy = "12" r = "2.5"
        /> < circle cx = "5" cy = "5" r = "2.5" /> < / svg >
    }
}
...
pub fn TiThListOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThListOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThMenu(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThMenu"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThMenuOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThMenuOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThSmall(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThSmall"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < circle cx = "5" cy = "19" r = "2.5" /> < circle
        cx = "5" cy = "12" r = "2.5" /> < circle cx = "5" cy = "5" r = "2.5" /> < circle
        cx = "12" cy = "19" r = "2.5" /> < circle cx = "12" cy = "12" r = "2.5" /> <
        circle cx = "12" cy = "5" r = "2.5" /> < circle cx = "19" cy = "19" r = "2.5" />
        < circle cx = "19" cy = "12" r = "2.5" /> < circle cx = "19" cy = "5" r = "2.5"
        /> < / svg >
    }
}
...
pub fn TiThSmallOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThSmallOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThermometer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThermometer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThumbsDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThumbsDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThumbsOk(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThumbsOk"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiThumbsUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiThumbsUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTick(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTick"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M16.972 6.251c-.967-.538-2.185-.188-2.72.777l-3.713 6.682-2.125-2.125c-.781-.781-2.047-.781-2.828 0-.781.781-.781 2.047 0 2.828l4 4c.378.379.888.587 1.414.587l.277-.02c.621-.087 1.166-.46 1.471-1.009l5-9c.537-.966.189-2.183-.776-2.72z"
        /> < / svg >
    }
}
...
pub fn TiTickOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTickOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTicket(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTicket"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTime(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTime"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTimes(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTimes"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTimesOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTimesOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTrash(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTrash"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiTree(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiTree"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiUpload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUpload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiUploadOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUploadOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiUser(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUser"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M17 9c0-1.381-.56-2.631-1.464-3.535-.905-.905-2.155-1.465-3.536-1.465s-2.631.56-3.536 1.465c-.904.904-1.464 2.154-1.464 3.535s.56 2.631 1.464 3.535c.905.905 2.155 1.465 3.536 1.465s2.631-.56 3.536-1.465c.904-.904 1.464-2.154 1.464-3.535zM6 19c0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4-3.75 0-6 2-6 4z"
        /> < / svg >
    }
}
...
pub fn TiUserAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUserAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiUserAddOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUserAddOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21 14h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1zM18 17c-.553 0-1-.448-1-1v-6c0-.552.447-1 1-1s1 .448 1 1v6c0 .552-.447 1-1 1zM9 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM9 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z"
        /> < / svg >
    }
}
...
pub fn TiUserDelete(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUserDelete"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiUserDeleteOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUserDeleteOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M21 14h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1zM9 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM9 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z"
        /> < / svg >
    }
}
...
pub fn TiUserOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiUserOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M12 6c1.654 0 3 1.346 3 3s-1.346 3-3 3-3-1.346-3-3 1.346-3 3-3m0-2c-2.764 0-5 2.238-5 5s2.236 5 5 5 5-2.238 5-5-2.236-5-5-5zM12 17c2.021 0 3.301.771 3.783 1.445-.683.26-1.969.555-3.783.555-1.984 0-3.206-.305-3.818-.542.459-.715 1.777-1.458 3.818-1.458m0-2c-3.75 0-6 2-6 4 0 1 2.25 2 6 2 3.518 0 6-1 6-2 0-2-2.354-4-6-4z"
        /> < / svg >
    }
}
...
pub fn TiVendorAndroid(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVendorAndroid"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 24 24" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path d =
        "M7.1 8h9.799999999999999c.1 0 .1 0 .1-.1-.1-.5-.2-.9-.4-1.3-.4-.9-1.1-1.5-1.9-2l-.4-.2s0-.1.1-.1c.3-.4.6-.8.9-1.3.1-.1.1-.2 0-.3-.1-.1-.2 0-.3.1l-.9 1.3s-.1.1-.1 0c-.8-.3-1.6-.4-2.4-.4-.6 0-1.1.2-1.6.4h-.1l-.9-1.2s0-.1-.1-.1c-.1-.1-.2-.1-.2 0-.1 0-.1.1 0 .2 0 0 0 .1.1.1.2.4.5.8.8 1.2l.1.1h-.1c-.6.3-1.1.7-1.5 1.2-.6.6-1 1.4-1.1 2.3 0 .1 0 .1.1.1zm7.1-2.8c.4 0 .8.3.8.8 0 .4-.3.8-.7.8-.4 0-.8-.3-.8-.8-.1-.4.3-.8.7-.8zm-4.3 0c.4 0 .8.3.8.8 0 .4-.3.8-.7.8-.5 0-.9-.4-.9-.8s.4-.8.8-.8zM5 9c-.5 0-1 .5-1 1v5c0 .5.5 1 1 1s1-.5 1-1v-5c0-.5-.5-1-1-1zM19 9c-.5 0-1 .5-1 1v5c0 .5.5 1 1 1s1-.5 1-1v-5c0-.5-.5-1-1-1zM7 17c0 .5.5 1 1 1h1v3c0 .5.5 1 1 1s1-.5 1-1v-3h2v3c0 .5.5 1 1 1s1-.5 1-1v-3h1c.5 0 1-.5 1-1v-8h-10v8z"
        /> < / svg >
    }
}
...
pub fn TiVendorApple(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVendorApple"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVendorMicrosoft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVendorMicrosoft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVideo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVideo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVolume(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVolume"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVolumeDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVolumeDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVolumeMute(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVolumeMute"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiVolumeUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiVolumeUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWarningOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWarningOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < circle cx = "12" cy = "16" r = "1.3" /> < path d =
...
pub fn TiWatch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWatch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWaves(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWaves"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWavesOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWavesOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherDownpour(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherDownpour"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherNight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherNight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherPartlySunny(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherPartlySunny"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherShower(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherShower"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherSnow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherSnow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherStormy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherStormy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherSunny(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherSunny"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWeatherWindyCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWeatherWindyCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWiFi(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWiFi"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWiFiOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWiFiOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWorld(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWorld"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiWorldOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiWorldOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiZoom(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiZoom"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiZoomIn(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiZoomIn"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiZoomInOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiZoomInOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiZoomOut(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiZoomOut"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn TiZoomOutOutline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("TiZoomOutOutline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
