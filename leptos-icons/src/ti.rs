...
pub fn TiAdjustBrightness(
    ...
    view! {
        ...
        stroke_width = "0" style = format!("{} color: {};", style, color) version = "1.2"
...
pub fn TiCss3(
    ...
    view! {
        cx, < svg class = class stroke = "currentColor" fill = "currentColor"
        stroke_width = "0" style = format!("{} color: {};", style, color) version = "1"
        width = "24" height = "24" viewBox = "0 0 24 24" width = size.clone() height =
...
pub fn TiSocialYoutubeCircular(
    ...
    view! {
        ...
        id = "Layer_1" width = "24px" height = "24px" viewBox = "0 0 24 24" width = size
