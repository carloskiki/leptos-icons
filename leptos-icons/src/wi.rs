...
pub fn WiAlien(
    ...
    #[prop(into, optional, default = String::from("WiAlien"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        style) x = "0px" y = "0px" width = width height = height viewBox = "0 0 30 30"
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
...
pub fn WiBarometer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiBarometer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCelsius(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCelsius"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCloud(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloud"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCloudDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCloudRefresh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudRefresh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.63,16.91c0,0.66,0.12,1.28,0.38,1.88c0.25,0.6,0.59,1.11,1.02,1.55c0.43,0.43,0.94,0.79,1.53,1.05
...
pub fn WiCloudUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiCloudyGusts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudyGusts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.62,21.01c0-0.25,0.08-0.46,0.25-0.63c0.17-0.16,0.37-0.24,0.6-0.24h5.42c0.74,0,1.37,0.26,1.89,0.79
...
pub fn WiCloudyWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiCloudyWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.1,21.04c0-0.24,0.08-0.45,0.25-0.61s0.38-0.24,0.63-0.24h8.97c0.24,0,0.43,0.08,0.59,0.24c0.16,0.16,0.23,0.36,0.23,0.61
...
pub fn WiDayCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDayCloudyGusts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayCloudyGusts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M0.35,21.01c0,0.24,0.09,0.44,0.27,0.6c0.17,0.17,0.37,0.25,0.61,0.25h5.88c0.26,0,0.48,0.09,0.68,0.28
...
pub fn WiDayCloudyHigh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayCloudyHigh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDayCloudyWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayCloudyWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M0.45,20.97c0,0.24,0.08,0.45,0.24,0.61c0.44,0.18,0.73,0.27,0.88,0.27h7.88c0.24,0,0.44-0.09,0.6-0.26
...
pub fn WiDayFog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayFog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M0.32,21.06c0,0.23,0.08,0.43,0.25,0.59c0.17,0.16,0.38,0.24,0.63,0.24h18.71c0.24,0,0.44-0.08,0.61-0.24
...
pub fn WiDayHail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayHail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.48,16.88c0,1.34,0.47,2.49,1.4,3.45s2.07,1.47,3.4,1.53c0.12,0,0.18-0.06,0.18-0.17v-1.34c0-0.12-0.06-0.18-0.18-0.18
...
pub fn WiDayHaze(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayHaze"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDayLightWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayLightWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDayLightning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayLightning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.56,16.9c0,1.33,0.46,2.47,1.39,3.43c0.93,0.96,2.06,1.47,3.4,1.53c0.11,0,0.17-0.06,0.17-0.17v-1.37
...
pub fn WiDayRain(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayRain"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.51,16.89c0,1.33,0.46,2.48,1.39,3.44s2.06,1.47,3.41,1.53c0.11,0,0.17-0.06,0.17-0.17v-1.34c0-0.11-0.06-0.17-0.17-0.17
...
pub fn WiDayRainMix(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayRainMix"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.48,16.95c0,1.32,0.46,2.46,1.37,3.4c0.91,0.94,2.04,1.45,3.38,1.51c0.12,0,0.18-0.06,0.18-0.17v-1.33
...
pub fn WiDayRainWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayRainWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.48,16.91c0,1.12,0.33,2.13,1,3.01c0.67,0.88,1.53,1.47,2.58,1.77c0.09,0.01,0.17-0.01,0.24-0.08l1.17-1.41
...
pub fn WiDayShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.56,16.88c0,1.33,0.46,2.47,1.39,3.43s2.06,1.46,3.4,1.53c0.11,0,0.17-0.06,0.17-0.17v-1.34c0-0.12-0.06-0.18-0.17-0.18
...
pub fn WiDaySleet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySleet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.49,16.92L1.49,16.92c0-1.17,0.36-2.19,1.08-3.09s1.64-1.48,2.74-1.74c0.31-1.37,1.01-2.49,2.1-3.38
...
pub fn WiDaySleetStorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySleetStorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.49,16.88c0,1.12,0.33,2.12,1,3s1.53,1.47,2.58,1.76l-0.66,1.7c-0.05,0.14,0,0.22,0.14,0.22h2.13l-1.43,4.21h0.29
...
pub fn WiDaySnow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySnow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.58,16.93c0,0.86,0.21,1.67,0.64,2.41c0.42,0.74,1,1.34,1.74,1.79c0.73,0.45,1.54,0.69,2.4,0.71
...
pub fn WiDaySnowThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySnowThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDaySnowWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySnowWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDaySprinkle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySprinkle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.58,16.89c0,0.87,0.21,1.68,0.64,2.42c0.42,0.75,1,1.35,1.73,1.8c0.73,0.45,1.53,0.69,2.4,0.73
...
pub fn WiDayStormShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayStormShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDaySunny(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySunny"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDaySunnyOvercast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDaySunnyOvercast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.09,13.43c0,0.27,0.09,0.49,0.28,0.67s0.43,0.26,0.72,0.26h1.69c0.27,0,0.5-0.09,0.69-0.27s0.29-0.4,0.29-0.66
...
pub fn WiDayThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.52,16.9c0,1.11,0.33,2.09,0.98,2.96s1.51,1.46,2.57,1.78l-0.64,1.7c-0.04,0.14,0,0.21,0.14,0.21H6.7L5.45,27.5h0.29
...
pub fn WiDayWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDayWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M1.48,21.1c0,0.24,0.09,0.44,0.27,0.6c0.17,0.17,0.37,0.25,0.61,0.25h5.88c0.26,0,0.48,0.09,0.68,0.28
	c0.2,0.19,0.3,0.42,0.3,0.68s-0.1,0.5-0.3,0.69c-0.2,0.19-0.42,0.29-0.68,0.29c-0.26,0-0.48-0.1-0.68-0.3
	c-0.18-0.16-0.38-0.24-0.61-0.24c-0.24,0-0.44,0.08-0.6,0.24c-0.16,0.16-0.24,0.36-0.24,0.6c0,0.24,0.08,0.44,0.24,0.6
...
pub fn WiDegrees(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDegrees"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionDownLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionDownLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionDownRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionDownRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M9.95,10.87c-0.01,0.35,0.1,0.65,0.34,0.9s0.53,0.37,0.89,0.36c0.34,0.02,0.63-0.1,0.88-0.37l1.66-1.64v10.3
...
pub fn WiDirectionUpLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionUpLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDirectionUpRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDirectionUpRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiDust(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiDust"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M7.33,16.58c0-0.23,0.08-0.41,0.23-0.56c0.16-0.15,0.37-0.22,0.64-0.22h5.71c0.27,0,0.48,0.07,0.64,0.22
...
pub fn WiEarthquake(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiEarthquake"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiFahrenheit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiFahrenheit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M9.67,11.01c0-0.5,0.18-0.93,0.53-1.28s0.78-0.53,1.28-0.53c0.49,0,0.92,0.18,1.27,0.53c0.35,0.36,0.53,0.78,0.53,1.28
...
pub fn WiFire(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiFire"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiFlood(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiFlood"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M6.72,20.76c0-0.05,0.01-0.12,0.02-0.21v-4.76c0.28,0.49,0.66,0.89,1.15,1.19c0.49,0.3,1.03,0.45,1.61,0.45
...
pub fn WiFog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiFog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiGaleWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiGaleWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M10.67,24.6V7.45h1.03V24.6H10.67z M12.4,22.44v-7.41l8.65,3.69L12.4,22.44z M12.4,14.86V7.45l8.65,3.69L12.4,14.86z"
        /> < / svg >
    }
}
#[cfg(feature = "WiHail")]
...
pub fn WiHail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiHorizon(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHorizon"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiHorizonAlt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHorizonAlt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.11,15.9c0-0.26,0.09-0.47,0.27-0.62c0.14-0.15,0.35-0.23,0.62-0.23h2.08c0.24,0,0.45,0.08,0.6,0.24
...
pub fn WiHot(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHot"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.14,14.76c0-0.24,0.09-0.44,0.27-0.61c0.17-0.17,0.38-0.25,0.62-0.25h2.06c0.24,0,0.44,0.08,0.6,0.25
...
pub fn WiHumidity(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHumidity"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M7.56,17.19c0-0.88,0.24-1.89,0.72-3.03s1.1-2.25,1.86-3.31c1.56-2.06,2.92-3.62,4.06-4.67l0.75-0.72
...
pub fn WiHurricane(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHurricane"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiHurricaneWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiHurricaneWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiLightning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiLightning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiLunarEclipse(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiLunarEclipse"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMeteor(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMeteor"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltFirstQuarter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltFirstQuarter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltNew(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltNew"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltThirdQuarter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltThirdQuarter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningCrescent6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningCrescent6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaningGibbous6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaningGibbous6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingCrescent6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingCrescent6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonAltWaxingGibbous6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonAltWaxingGibbous6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonFirstQuarter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonFirstQuarter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonNew(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonNew"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonThirdQuarter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonThirdQuarter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningCrescent1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-1-3.14-1.49-6.9-1.49-11.26
...
pub fn WiMoonWaningCrescent2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.1,4.1s3.61,1.51,5.65,1.51c-2.01-2.74-3.02-6.5-3.02-11.26
...
pub fn WiMoonWaningCrescent3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningCrescent4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningCrescent5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningCrescent6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningCrescent6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-1.46-0.56-2.72-1.18-3.79-1.88
...
pub fn WiMoonWaningGibbous1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningGibbous2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningGibbous3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningGibbous4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningGibbous5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaningGibbous6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaningGibbous6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.74,14.46c0,2.04,0.5,3.92,1.51,5.65s2.37,3.09,4.09,4.09s3.61,1.51,5.65,1.51c1.44-3.08,2.15-6.83,2.15-11.25
...
pub fn WiMoonWaxingCrescent1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingCrescent2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingCrescent3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingCrescent4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingCrescent5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingCrescent6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingCrescent6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonWaxingGibbous6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonWaxingGibbous6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonrise(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonrise"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiMoonset(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiMoonset"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNa(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNa"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltCloudyGusts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltCloudyGusts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M2.98,21.02c0,0.23,0.09,0.43,0.27,0.6c0.17,0.17,0.37,0.25,0.61,0.25H9.6c0.26,0,0.49,0.1,0.69,0.29
...
pub fn WiNightAltCloudyHigh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltCloudyHigh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltCloudyWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltCloudyWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M2.35,21.05c0,0.24,0.08,0.43,0.25,0.59c0.17,0.16,0.38,0.23,0.63,0.23h9.4c0.24,0,0.43-0.08,0.59-0.23
...
pub fn WiNightAltHail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltHail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.1,16.91c0,1.33,0.46,2.48,1.39,3.43s2.06,1.47,3.4,1.53c0.12,0,0.18-0.06,0.18-0.17v-1.34c0-0.11-0.06-0.17-0.18-0.17
...
pub fn WiNightAltLightning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltLightning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.12,16.91c0,1.33,0.46,2.48,1.39,3.43s2.06,1.47,3.4,1.53c0.11,0,0.17-0.06,0.17-0.17v-1.37c0-0.12-0.06-0.18-0.17-0.18
...
pub fn WiNightAltPartlyCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltPartlyCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltRain(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltRain"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.07,16.9c0,1.33,0.47,2.48,1.4,3.44s2.07,1.47,3.4,1.53c0.12,0,0.18-0.06,0.18-0.17v-1.34c0-0.11-0.06-0.17-0.18-0.17
...
pub fn WiNightAltRainMix(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltRainMix"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.07,16.93c0,1.33,0.47,2.47,1.4,3.43s2.07,1.47,3.4,1.51c0.12,0,0.18-0.06,0.18-0.17v-1.34c0-0.11-0.06-0.17-0.18-0.17
...
pub fn WiNightAltRainWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltRainWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltSleet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSleet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.09,17.13v-0.37c0.04-1.12,0.42-2.11,1.13-2.97c0.71-0.86,1.61-1.42,2.68-1.67c0.31-1.36,1.02-2.48,2.11-3.36
...
pub fn WiNightAltSleetStorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSleetStorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.09,16.89c0,1.11,0.33,2.1,0.99,2.97c0.66,0.87,1.52,1.47,2.58,1.79l-0.65,1.7c-0.04,0.14,0,0.21,0.14,0.21h2.12
...
pub fn WiNightAltSnow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSnow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltSnowThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSnowThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltSnowWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSnowWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltSprinkle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltSprinkle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.11,16.89c0,1.33,0.46,2.48,1.39,3.43c0.93,0.96,2.06,1.47,3.4,1.54c0.12,0,0.18-0.06,0.18-0.18v-1.33
...
pub fn WiNightAltStormShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltStormShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightAltThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightAltThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.08,16.88c0,1.11,0.33,2.1,0.99,2.98s1.52,1.47,2.58,1.79l-0.66,1.69c-0.03,0.14,0.02,0.21,0.15,0.21h2.12l-0.97,3.51
...
pub fn WiNightClear(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightClear"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightCloudyGusts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightCloudyGusts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.06,20.98c0,0.24,0.09,0.44,0.27,0.6c0.18,0.18,0.38,0.27,0.61,0.27h5.88c0.26,0,0.49,0.09,0.69,0.28
...
pub fn WiNightCloudyHigh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightCloudyHigh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightCloudyWindy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightCloudyWindy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightFog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightFog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M2.66,20.92c0,0.23,0.08,0.42,0.25,0.57c0.17,0.16,0.38,0.23,0.62,0.23h18.61c0.24,0,0.44-0.08,0.6-0.23
...
pub fn WiNightHail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightHail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.25,16.89c0,1.33,0.46,2.48,1.39,3.43c0.93,0.96,2.06,1.47,3.4,1.54c0.12,0,0.18-0.06,0.18-0.18v-1.33
	c0-0.12-0.06-0.18-0.18-0.18c-0.86-0.04-1.58-0.38-2.18-1.02c-0.6-0.64-0.9-1.39-0.9-2.26c0-0.83,0.28-1.55,0.84-2.17
...
pub fn WiNightLightning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightLightning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.29,16.93c0,0.66,0.12,1.28,0.38,1.88s0.59,1.11,1.02,1.55s0.94,0.79,1.52,1.05s1.21,0.42,1.87,0.45
...
pub fn WiNightPartlyCloudy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightPartlyCloudy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightRain(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightRain"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.26,16.93c0,0.66,0.12,1.28,0.38,1.88s0.59,1.11,1.02,1.55c0.43,0.43,0.94,0.79,1.53,1.05s1.21,0.42,1.87,0.45
...
pub fn WiNightRainMix(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightRainMix"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightRainWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightRainWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.11,17.02c0,1.13,0.33,2.13,1,3.01c0.67,0.88,1.54,1.48,2.62,1.8c0.1,0.01,0.18-0.01,0.25-0.08l1.13-1.46
...
pub fn WiNightShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.25,16.92c0,0.66,0.12,1.28,0.38,1.88c0.25,0.6,0.59,1.11,1.02,1.55c0.43,0.44,0.94,0.79,1.53,1.06s1.22,0.42,1.88,0.45
...
pub fn WiNightSleet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSleet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.23,16.99v-0.02c0-1.16,0.36-2.19,1.08-3.09s1.64-1.49,2.74-1.74c0.31-1.37,1.01-2.49,2.1-3.37s2.35-1.32,3.77-1.32
...
pub fn WiNightSleetStorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSleetStorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.19,16.88c0,1.12,0.33,2.12,1,3s1.53,1.47,2.58,1.76l-0.66,1.7c-0.05,0.14,0,0.22,0.14,0.22h2.13l-1.43,4.21h0.29
...
pub fn WiNightSnow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSnow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.23,16.89c0,1.33,0.47,2.48,1.4,3.44s2.07,1.47,3.4,1.53c0.12,0,0.18-0.06,0.18-0.17v-1.34c0-0.11-0.06-0.17-0.18-0.17
...
pub fn WiNightSnowThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSnowThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightSnowWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSnowWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiNightSprinkle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightSprinkle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.22,16.89c0,1.33,0.46,2.48,1.39,3.44s2.06,1.47,3.41,1.53c0.11,0,0.17-0.06,0.17-0.17v-1.37c0-0.13-0.06-0.19-0.17-0.19
...
pub fn WiNightStormShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightStormShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.25,16.86c0,1.1,0.33,2.09,1,2.98c0.67,0.88,1.52,1.48,2.57,1.8l-0.65,1.66c-0.04,0.14,0,0.21,0.14,0.21h2.12l-1.14,4.09
...
pub fn WiNightThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiNightThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRain(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRain"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRainMix(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRainMix"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRainWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRainWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.63,16.93c0,1.12,0.33,2.11,0.98,2.99c0.65,0.87,1.5,1.47,2.55,1.79c0.09,0.02,0.17-0.01,0.24-0.08l1.16-1.43
...
pub fn WiRaindrop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRaindrop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRaindrops(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRaindrops"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRefresh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRefresh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiRefreshAlt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiRefreshAlt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSandstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSandstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.6,16.93c0-1.16,0.36-2.18,1.09-3.08c0.72-0.9,1.65-1.48,2.78-1.73c0.29-1.38,0.98-2.5,2.07-3.39S12.88,7.4,14.3,7.4
...
pub fn WiSleet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSleet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSmallCraftAdvisory(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSmallCraftAdvisory"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M9.81,24.6V7.45h1.03V24.6H9.81z M11.54,14.86V7.45l8.65,3.69L11.54,14.86z" /> < /
        svg >
    }
}
#[cfg(feature = "WiSmog")]
...
pub fn WiSmog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSmog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M6.35,12.46c0-0.94,0.3-1.77,0.9-2.5s1.37-1.21,2.31-1.43c0.23-1.11,0.79-2.03,1.7-2.75c0.91-0.72,1.95-1.08,3.12-1.08
...
pub fn WiSmoke(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSmoke"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSnow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSnow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSnowWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSnowWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSnowflakeCold(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSnowflakeCold"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSolarEclipse(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSolarEclipse"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSprinkle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSprinkle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.64,16.91c0-1.15,0.36-2.17,1.08-3.07c0.72-0.9,1.63-1.47,2.73-1.73c0.31-1.36,1.01-2.48,2.1-3.35s2.35-1.31,3.76-1.31
...
pub fn WiStars(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiStars"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiStormShowers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiStormShowers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.63,16.91c0,1.11,0.33,2.1,0.99,2.97s1.51,1.47,2.56,1.79l-0.65,1.68c-0.03,0.14,0.02,0.22,0.14,0.22h2.13l-1.04,3.78
...
pub fn WiStormWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiStormWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiStrongWind(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiStrongWind"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiSunrise(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSunrise"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M2.75,15.36c0-0.25,0.1-0.48,0.3-0.69c0.22-0.19,0.46-0.29,0.7-0.29h2.33c0.27,0,0.49,0.1,0.67,0.29
...
pub fn WiSunset(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiSunset"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M2.88,15.47c0-0.28,0.1-0.5,0.3-0.68c0.17-0.18,0.4-0.26,0.68-0.26h2.31c0.27,0,0.49,0.09,0.67,0.27
...
pub fn WiThermometer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiThermometer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiThermometerExterior(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiThermometerExterior"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiThermometerInternal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiThermometerInternal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiThunderstorm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiThunderstorm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.74,14.47c0-2.04,0.51-3.93,1.52-5.66s2.38-3.1,4.11-4.11s3.61-1.51,5.64-1.51c1.52,0,2.98,0.3,4.37,0.89
...
pub fn WiTime10(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime10"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime11(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime11"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime12(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime12"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime7(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime7"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime8(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime8"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTime9(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTime9"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTornado(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTornado"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiTrain(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTrain"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.25,12.68v-0.32c0-0.1,0.03-0.18,0.1-0.25c0.07-0.07,0.15-0.1,0.25-0.1h7.58c0.1,0,0.18,0.03,0.25,0.1
...
pub fn WiTsunami(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiTsunami"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M5.07,21.24c0-0.16,0.06-0.3,0.17-0.42c0.12-0.12,0.25-0.18,0.41-0.18h0.4c-0.21-0.66-0.39-1.35-0.53-2.07
...
pub fn WiUmbrella(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiUmbrella"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.64,14.65c0.01-0.34,0.18-0.86,0.5-1.58c0.32-0.72,0.76-1.48,1.33-2.3c1.86-2.61,4.49-3.98,7.88-4.13V6.21
...
pub fn WiVolcano(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiVolcano"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M7.39,22.61c-0.12-0.27-0.09-0.54,0.09-0.81l1.4-2.67c0.01-0.04,0.05-0.09,0.11-0.15c0.04-0.04,0.17-0.14,0.38-0.29
...
pub fn WiWindBeaufort0(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort0"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M5.01,13.5c0,0.18,0.06,0.31,0.17,0.4c0.12,0.11,0.26,0.17,0.42,0.17H16c0.17,0,0.33,0.06,0.46,0.19
...
pub fn WiWindBeaufort1(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort1"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort10(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort10"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort11(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort11"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort12(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort12"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M3.07,13.5c0,0.18,0.06,0.31,0.17,0.4c0.12,0.11,0.26,0.17,0.42,0.17h10.4c0.17,0,0.33,0.06,0.46,0.19
	c0.13,0.12,0.2,0.28,0.2,0.46s-0.07,0.34-0.2,0.47c-0.13,0.13-0.28,0.2-0.46,0.2c-0.18,0-0.34-0.07-0.47-0.21
	c-0.13-0.11-0.26-0.16-0.4-0.16c-0.16,0-0.3,0.05-0.41,0.16c-0.11,0.11-0.16,0.24-0.16,0.39c0,0.16,0.06,0.3,0.17,0.41
	c0.36,0.36,0.78,0.53,1.28,0.53s0.91-0.17,1.26-0.52c0.35-0.35,0.52-0.77,0.52-1.27c0-0.49-0.17-0.92-0.52-1.27
...
pub fn WiWindBeaufort2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
...
pub fn WiWindBeaufort6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.92,13.5c0,0.18,0.06,0.31,0.17,0.4c0.12,0.11,0.26,0.17,0.42,0.17h10.4c0.18,0,0.33,0.06,0.46,0.19
	c0.13,0.12,0.2,0.28,0.2,0.46s-0.07,0.34-0.2,0.47s-0.28,0.2-0.46,0.2c-0.18,0-0.34-0.07-0.47-0.21c-0.13-0.11-0.26-0.16-0.4-0.16
	c-0.16,0-0.3,0.05-0.41,0.16c-0.11,0.11-0.16,0.24-0.16,0.39c0,0.16,0.06,0.3,0.17,0.41c0.36,0.36,0.78,0.53,1.28,0.53
...
pub fn WiWindBeaufort7(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort7"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
        ...
        fill = "currentColor" role = "graphics-symbol" > < title > { title } < / title >
        < path d =
        "M4.83,13.5c0,0.18,0.06,0.31,0.17,0.4c0.12,0.11,0.26,0.17,0.42,0.17h10.4c0.17,0,0.33,0.06,0.46,0.19
	c0.13,0.12,0.2,0.28,0.2,0.46s-0.07,0.34-0.2,0.47s-0.28,0.2-0.46,0.2c-0.18,0-0.34-0.07-0.47-0.21c-0.12-0.11-0.26-0.16-0.4-0.16
	c-0.16,0-0.3,0.05-0.41,0.16c-0.11,0.11-0.16,0.24-0.16,0.39c0,0.16,0.06,0.3,0.17,0.41c0.36,0.36,0.78,0.53,1.27,0.53
...
pub fn WiWindBeaufort8(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("WiWindBeaufort8"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!("enable-background:new 0 0 30 30; {}",
