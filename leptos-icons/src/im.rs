...
pub fn ImAccessibility(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAccessibility"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAddressBook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAddressBook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M1 1h1.5v3h-1.5v-3z" /> < path fill = "#000000" d
        = "M1 5h1.5v3h-1.5v-3z" /> < path fill = "#000000" d = "M1 9h1.5v3h-1.5v-3z" /> <
...
pub fn ImAidKit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAidKit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAirplane(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAirplane"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAlarm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAlarm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M8 9v-4h-1v5h4v-1z" /> < / svg >
    }
}
...
pub fn ImAmazon(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAmazon"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAndroid(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAndroid"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAngry(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAngry"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAngry2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAngry2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAppleinc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAppleinc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 15.5l7.5-7.5h-4.5v-8h-6v8h-4.5z" /> < / svg >
    }
}
...
pub fn ImArrowDown2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDown2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowDownLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDownLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.5 16l-4-4 8.5-8.5-3.5-3.5-8.5 8.5-4-4v11.5h11.5z" /> < / svg >
    }
}
...
pub fn ImArrowDownLeft2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDownLeft2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowDownRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDownRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 4.5l-4 4-8.5-8.5-3.5 3.5 8.5 8.5-4 4h11.5v-11.5z" /> < / svg >
    }
}
...
pub fn ImArrowDownRight2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowDownRight2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0.5 8l7.5 7.5v-4.5h8v-6h-8v-4.5z" /> < / svg >
    }
}
...
pub fn ImArrowLeft2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowLeft2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15.5 8l-7.5-7.5v4.5h-8v6h8v4.5z" /> < / svg >
    }
}
...
pub fn ImArrowRight2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowRight2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9.707 13.707l5-5c0.391-0.39 0.391-1.024 0-1.414l-5-5c-0.391-0.391-1.024-0.391-1.414 0s-0.391 1.024 0 1.414l3.293 3.293h-9.586c-0.552 0-1 0.448-1 1s0.448 1 1 1h9.586l-3.293 3.293c-0.195 0.195-0.293 0.451-0.293 0.707s0.098 0.512 0.293 0.707c0.391 0.391 1.024 0.391 1.414 0z"
        /> < / svg >
    }
}
...
pub fn ImArrowUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0.5l-7.5 7.5h4.5v8h6v-8h4.5z" /> < / svg >
    }
}
...
pub fn ImArrowUp2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUp2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowUpLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUpLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 11.5l4-4 8.5 8.5 3.5-3.5-8.5-8.5 4-4h-11.5v11.5z" /> < / svg >
    }
}
...
pub fn ImArrowUpLeft2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUpLeft2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImArrowUpRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUpRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4.5 0l4 4-8.5 8.5 3.5 3.5 8.5-8.5 4 4v-11.5h-11.5z" /> < / svg >
    }
}
...
pub fn ImArrowUpRight2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImArrowUpRight2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImAttachment(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImAttachment"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBackward(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBackward"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5zM11 10.5l-3.5-2.5 3.5-2.5zM7 10.5l-3.5-2.5 3.5-2.5z"
        /> < / svg >
    }
}
...
pub fn ImBackward2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBackward2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 2.5v5l5-5v11l-5-5v5l-5.5-5.5z" /> < / svg >
    }
}
...
pub fn ImBaffled(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBaffled"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d =
        "M6 6.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5z"
        /> < path fill = "#000000" d =
        "M5.5 5c0.828 0 1.5 0.672 1.5 1.5s-0.672 1.5-1.5 1.5-1.5-0.672-1.5-1.5 0.672-1.5 1.5-1.5zM5.5 4c-1.378 0-2.5 1.122-2.5 2.5s1.122 2.5 2.5 2.5 2.5-1.122 2.5-2.5-1.122-2.5-2.5-2.5v0z"
        /> < path fill = "#000000" d =
        "M11 6.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5z"
        /> < path fill = "#000000" d =
        "M10.5 5c0.828 0 1.5 0.672 1.5 1.5s-0.672 1.5-1.5 1.5-1.5-0.672-1.5-1.5 0.672-1.5 1.5-1.5zM10.5 4c-1.379 0-2.5 1.122-2.5 2.5s1.121 2.5 2.5 2.5 2.5-1.122 2.5-2.5-1.121-2.5-2.5-2.5v0z"
        /> < path fill = "#000000" d = "M6 11h4v1h-4v-1z" /> < / svg >
    }
}
...
pub fn ImBaffled2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBaffled2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6 6.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5 0.224-0.5 0.5-0.5 0.5 0.224 0.5 0.5z"
        /> < path fill = "#000000" d =
        "M11 6.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5 0.224-0.5 0.5-0.5 0.5 0.224 0.5 0.5z"
        /> < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM4 6.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5-0.672 1.5-1.5 1.5-1.5-0.672-1.5-1.5zM10 12h-4v-1h4v1zM10.5 8c-0.828 0-1.5-0.672-1.5-1.5s0.672-1.5 1.5-1.5 1.5 0.672 1.5 1.5-0.672 1.5-1.5 1.5z"
        /> < / svg >
    }
}
...
pub fn ImBarcode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBarcode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBasecamp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBasecamp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBehance(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBehance"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M10.444 4h3.991v0.972h-3.991v-0.972z" /> < / svg
        >
    }
}
...
pub fn ImBehance2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBehance2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBell(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBell"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBin2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBin2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M3 16h10l1-11h-12zM10 2v-2h-4v2h-5v3l1-1h12l1 1v-3h-5zM9 2h-2v-1h2v1z" /> < /
        svg >
    }
}
...
pub fn ImBinoculars(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBinoculars"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBlocked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBlocked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBlog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBlog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBlogger(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBlogger"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBlogger2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBlogger2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBold(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBold"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBookmark(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBookmark"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M3 0v16l5-5 5 5v-16z"
        /> < / svg >
    }
}
...
pub fn ImBookmarks(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBookmarks"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4 2v14l5-5 5 5v-14zM12 0h-10v14l1-1v-12h9z" /> < / svg >
    }
}
#[cfg(feature = "ImBooks")]
...
pub fn ImBooks(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBooks"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 18 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M3.5 2h-3c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h3c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM3 5h-2v-1h2v1z"
        /> < path fill = "#000000" d =
        "M8.5 2h-3c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h3c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM8 5h-2v-1h2v1z"
        /> < path fill = "#000000" d =
        "M11.954 2.773l-2.679 1.35c-0.246 0.124-0.345 0.426-0.222 0.671l4.5 8.93c0.124 0.246 0.426 0.345 0.671 0.222l2.679-1.35c0.246-0.124 0.345-0.426 0.222-0.671l-4.5-8.93c-0.124-0.246-0.426-0.345-0.671-0.222z"
        /> < path fill = "#000000" d =
...
pub fn ImBoxAdd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBoxAdd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBoxRemove(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBoxRemove"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBriefcase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBriefcase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBrightnessContrast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBrightnessContrast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubble(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubble"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubble2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubble2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubbles(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubbles"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubbles2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubbles2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubbles3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubbles3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBubbles4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBubbles4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBug(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBug"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImBullhorn(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImBullhorn"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCalculator(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCalculator"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCalendar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCalendar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCamera(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCamera"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCancelCircle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCancelCircle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d =
        "M10.5 4l-2.5 2.5-2.5-2.5-1.5 1.5 2.5 2.5-2.5 2.5 1.5 1.5 2.5-2.5 2.5 2.5 1.5-1.5-2.5-2.5 2.5-2.5z"
        /> < / svg >
    }
}
#[cfg(feature = "ImCart")]
...
pub fn ImCart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCheckboxChecked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCheckboxChecked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCheckboxUnchecked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCheckboxUnchecked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCheckmark(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCheckmark"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13.5 2l-7.5 7.5-3.5-3.5-2.5 2.5 6 6 10-10z" /> < / svg >
    }
}
...
pub fn ImCheckmark2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCheckmark2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6.21 14.339l-6.217-6.119 3.084-3.035 3.133 3.083 6.713-6.607 3.084 3.035-9.797 9.643zM1.686 8.22l4.524 4.453 8.104-7.976-1.391-1.369-6.713 6.607-3.133-3.083-1.391 1.369z"
        /> < / svg >
    }
}
...
pub fn ImChrome(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImChrome"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCircleDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCircleDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCircleLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCircleLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCircleRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCircleRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCircleUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCircleUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImClearFormatting(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImClearFormatting"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImClipboard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImClipboard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImClock(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImClock"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImClock2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImClock2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM10.293 11.707l-3.293-3.293v-4.414h2v3.586l2.707 2.707-1.414 1.414z"
        /> < / svg >
    }
}
#[cfg(feature = "ImCloud")]
...
pub fn ImCloud(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCloud"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCloudCheck(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCloudCheck"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCloudDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCloudDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCloudUpload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCloudUpload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImClubs(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImClubs"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCodepen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCodepen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCog(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCog"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCogs(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCogs"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCoinDollar(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCoinDollar"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCoinEuro(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCoinEuro"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCoinPound(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCoinPound"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCoinYen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCoinYen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCommand(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCommand"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCompass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCompass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCompass2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCompass2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImConfused(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImConfused"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImConfused2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImConfused2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImConnection(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImConnection"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 20 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
...
pub fn ImContrast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImContrast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM2 8c0-3.314 2.686-6 6-6v12c-3.314 0-6-2.686-6-6z"
        /> < / svg >
    }
}
#[cfg(feature = "ImCool")]
...
pub fn ImCool(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCool"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCool2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCool2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCopy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCopy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCreditCard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCreditCard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14.5 2h-13c-0.825 0-1.5 0.675-1.5 1.5v9c0 0.825 0.675 1.5 1.5 1.5h13c0.825 0 1.5-0.675 1.5-1.5v-9c0-0.825-0.675-1.5-1.5-1.5zM1.5 3h13c0.271 0 0.5 0.229 0.5 0.5v1.5h-14v-1.5c0-0.271 0.229-0.5 0.5-0.5zM14.5 13h-13c-0.271 0-0.5-0.229-0.5-0.5v-4.5h14v4.5c0 0.271-0.229 0.5-0.5 0.5zM2 10h1v2h-1zM4 10h1v2h-1zM6 10h1v2h-1z"
        /> < / svg >
    }
}
#[cfg(feature = "ImCrop")]
...
pub fn ImCrop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCrop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13 4l3-3-1-1-3 3h-7v-3h-2v3h-3v2h3v8h8v3h2v-3h3v-2h-3v-7zM5 5h5l-5 5v-5zM6 11l5-5v5h-5z"
        /> < / svg >
    }
}
#[cfg(feature = "ImCross")]
...
pub fn ImCross(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCross"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCrying(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCrying"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCrying2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCrying2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCss3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCss3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImCtrl(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImCtrl"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDatabase(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDatabase"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDelicious(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDelicious"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 0v16h16v-16h-16zM8 15v-7h-7v-7h7v7h7v7h-7z" /> < / svg >
    }
}
...
pub fn ImDeviantart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDeviantart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDiamonds(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDiamonds"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M8 0l-5 8 5 8 5-8z" />
        < / svg >
    }
}
#[cfg(feature = "ImDice")]
...
pub fn ImDice(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDice"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDisplay(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDisplay"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1v10h16v-10h-16zM15 10h-14v-8h14v8zM10.5 12h-5l-0.5 2-1 1h8l-1-1z" /> < / svg
        >
    }
}
...
pub fn ImDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 9l4-4h-3v-4h-2v4h-3zM11.636 7.364l-1.121 1.121 4.064 1.515-6.579 2.453-6.579-2.453 4.064-1.515-1.121-1.121-4.364 1.636v4l8 3 8-3v-4z"
        /> < / svg >
    }
}
...
pub fn ImDownload2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDownload2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDownload3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDownload3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDrawer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDrawer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15.89 10.188l-4-5c-0.095-0.119-0.239-0.188-0.39-0.188h-7c-0.152 0-0.296 0.069-0.39 0.188l-4 5c-0.071 0.089-0.11 0.199-0.11 0.312v4.5c0 0.552 0.448 1 1 1h14c0.552 0 1-0.448 1-1v-4.5c0-0.114-0.039-0.224-0.11-0.312zM15 11h-3.5l-2 2h-3l-2-2h-3.5v-0.325l3.74-4.675h6.519l3.74 4.675v0.325z"
        /> < path fill = "#000000" d =
        "M11.5 8h-7c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h7c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"
        /> < path fill = "#000000" d =
        "M12.5 10h-9c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h9c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"
        /> < / svg >
    }
}
...
pub fn ImDrawer2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDrawer2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDribbble(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDribbble"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImDrive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDrive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M3 14h10c1.657 0 3-1.343 3-3h-16c0 1.657 1.343 3 3 3zM13 12h1v1h-1v-1zM15 2h-14l-1 8h16z"
        /> < / svg >
    }
}
...
pub fn ImDropbox(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDropbox"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.5 0.5l-3.5 3 4.5 3 3.5-3z" /> < path fill = "#000000" d =
        "M8 3.5l-3.5-3-4.5 3 3.5 3z" /> < path fill = "#000000" d =
        "M12.5 6.5l3.5 3-4.5 2.5-3.5-3z" /> < path fill = "#000000" d =
        "M8 9l-4.5-2.5-3.5 3 4.5 2.5z" /> < path fill = "#000000" d =
...
pub fn ImDroplet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImDroplet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEarth(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEarth"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEdge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEdge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEject(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEject"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 12h16v2h-16zM8 2l8 8h-16z" /> < / svg >
    }
}
#[cfg(feature = "ImEllo")]
...
pub fn ImEllo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEllo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEmbed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEmbed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 11.5l1.5 1.5 5-5-5-5-1.5 1.5 3.5 3.5z" /> < path fill = "#000000" d =
        "M7 4.5l-1.5-1.5-5 5 5 5 1.5-1.5-3.5-3.5z" /> < / svg >
    }
}
...
pub fn ImEmbed2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEmbed2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 20 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13 11.5l1.5 1.5 5-5-5-5-1.5 1.5 3.5 3.5z" /> < path fill = "#000000" d =
        "M7 4.5l-1.5-1.5-5 5 5 5 1.5-1.5-3.5-3.5z" /> < path fill = "#000000" d =
        "M10.958 2.352l1.085 0.296-3 11-1.085-0.296 3-11z" /> < / svg >
    }
}
...
pub fn ImEnlarge(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEnlarge"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 0h-6.5l2.5 2.5-3 3 1.5 1.5 3-3 2.5 2.5z" /> < path fill = "#000000" d =
        "M16 16v-6.5l-2.5 2.5-3-3-1.5 1.5 3 3-2.5 2.5z" /> < path fill = "#000000" d =
        "M0 16h6.5l-2.5-2.5 3-3-1.5-1.5-3 3-2.5-2.5z" /> < path fill = "#000000" d =
        "M0 0v6.5l2.5-2.5 3 3 1.5-1.5-3-3 2.5-2.5z" /> < / svg >
    }
}
...
pub fn ImEnlarge2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEnlarge2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 0v6.5l-2.5-2.5-3 3-1.5-1.5 3-3-2.5-2.5zM7 10.5l-3 3 2.5 2.5h-6.5v-6.5l2.5 2.5 3-3z"
        /> < / svg >
    }
}
#[cfg(feature = "ImEnter")]
...
pub fn ImEnter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEnter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6 8h-5v-2h5v-2l3 3-3 3zM16 0v13l-6 3v-3h-6v-4h1v3h5v-9l4-2h-9v4h-1v-5z" /> < /
        svg >
    }
}
...
pub fn ImEnvelop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEnvelop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEqualizer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEqualizer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEqualizer2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEqualizer2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEvil(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEvil"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEvil2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEvil2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImExit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImExit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M12 10v-2h-5v-2h5v-2l3 3zM11 9v4h-5v3l-6-3v-13h11v5h-1v-4h-8l4 2v9h4v-3z" /> < /
        svg >
    }
}
#[cfg(feature = "ImEye")]
...
pub fn ImEye(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEye"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEyeBlocked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEyeBlocked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImEyeMinus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEyeMinus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M10 2h6v2h-6v-2z" /> <
        path fill = "#000000" d =
...
pub fn ImEyePlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEyePlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 2h-2v-2h-2v2h-2v2h2v2h2v-2h2z" /> < path fill = "#000000" d =
...
pub fn ImEyedropper(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImEyedropper"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFacebook(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFacebook"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFacebook2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFacebook2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14.5 0h-13c-0.825 0-1.5 0.675-1.5 1.5v13c0 0.825 0.675 1.5 1.5 1.5h6.5v-7h-2v-2h2v-1c0-1.653 1.347-3 3-3h2v2h-2c-0.55 0-1 0.45-1 1v1h3l-0.5 2h-2.5v7h4.5c0.825 0 1.5-0.675 1.5-1.5v-13c0-0.825-0.675-1.5-1.5-1.5z"
        /> < / svg >
    }
}
#[cfg(feature = "ImFeed")]
...
pub fn ImFeed(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFeed"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFileEmpty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileEmpty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFileExcel(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileExcel"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.61 6h-2.114l-1.496 2.204-1.496-2.204h-2.114l2.534 3.788-2.859 4.212h3.935v-1.431h-0.784l0.784-1.172 1.741 2.603h2.194l-2.859-4.212 2.534-3.788z"
        /> < path fill = "#000000" d =
...
pub fn ImFileMusic(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileMusic"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
        /> < path fill = "#000000" d =
        "M11.817 6.113c-0.116-0.095-0.268-0.133-0.415-0.104l-5 1c-0.234 0.047-0.402 0.252-0.402 0.49v3.701c-0.294-0.128-0.636-0.201-1-0.201-1.105 0-2 0.672-2 1.5s0.895 1.5 2 1.5 2-0.672 2-1.5v-3.59l4-0.8v2.091c-0.294-0.128-0.636-0.201-1-0.201-1.105 0-2 0.672-2 1.5s0.895 1.5 2 1.5 2-0.672 2-1.5v-5c0-0.15-0.067-0.292-0.183-0.387z"
        /> < / svg >
    }
}
...
pub fn ImFileOpenoffice(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileOpenoffice"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFilePdf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilePdf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFilePicture(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilePicture"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13 14h-10v-2l3-5 4.109 5 2.891-2v4z" /> < path fill = "#000000" d =
        "M13 7.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5 0.672-1.5 1.5-1.5c0.828 0 1.5 0.672 1.5 1.5z"
        /> < path fill = "#000000" d =
        "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
        /> < / svg >
    }
...
pub fn ImFilePlay(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilePlay"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M6 6l5 3.5-5 3.5v-7z"
        /> < path fill = "#000000" d =
        "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
        /> < / svg >
    }
...
pub fn ImFileText(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileText"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFileText2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileText2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFileVideo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileVideo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M4 8h5v5h-5v-5z" /> < path fill = "#000000" d =
        "M9 10l3-2v5l-3-2z" /> < / svg >
    }
}
...
pub fn ImFileWord(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileWord"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9.997 7.436h0.691l-0.797 3.534-1.036-4.969h-1.665l-1.205 4.969-0.903-4.969h-1.741l1.767 7.998h1.701l1.192-4.73 1.066 4.73h1.568l2.025-7.998h-2.663v1.435z"
        /> < path fill = "#000000" d =
        "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
        /> < / svg >
    }
...
pub fn ImFileZip(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFileZip"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill = "#000000" d =
        "M14.341 3.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-7.75c-0.689 0-1.25 0.561-1.25 1.25v13.5c0 0.689 0.561 1.25 1.25 1.25h11.5c0.689 0 1.25-0.561 1.25-1.25v-9.75c0-0.224-0.068-0.615-0.659-1.421v0 0zM12.271 2.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0 0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-11.5c-0.135 0-0.25-0.114-0.25-0.25v-13.5c0-0.135 0.115-0.25 0.25-0.25 0 0 7.749-0 7.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v9.75z"
        /> < path fill = "#000000" d = "M4 1h2v1h-2v-1z" /> < path fill = "#000000" d =
        "M6 2h2v1h-2v-1z" /> < path fill = "#000000" d = "M4 3h2v1h-2v-1z" /> < path fill
        = "#000000" d = "M6 4h2v1h-2v-1z" /> < path fill = "#000000" d =
        "M4 5h2v1h-2v-1z" /> < path fill = "#000000" d = "M6 6h2v1h-2v-1z" /> < path fill
        = "#000000" d = "M4 7h2v1h-2v-1z" /> < path fill = "#000000" d =
        "M6 8h2v1h-2v-1z" /> < path fill = "#000000" d =
...
pub fn ImFilesEmpty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilesEmpty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14.341 5.579c-0.347-0.473-0.831-1.027-1.362-1.558s-1.085-1.015-1.558-1.362c-0.806-0.591-1.197-0.659-1.421-0.659h-5.75c-0.689 0-1.25 0.561-1.25 1.25v11.5c0 0.689 0.561 1.25 1.25 1.25h9.5c0.689 0 1.25-0.561 1.25-1.25v-7.75c0-0.224-0.068-0.615-0.659-1.421zM12.271 4.729c0.48 0.48 0.856 0.912 1.134 1.271h-2.406v-2.405c0.359 0.278 0.792 0.654 1.271 1.134v0zM14 14.75c0 0.136-0.114 0.25-0.25 0.25h-9.5c-0.136 0-0.25-0.114-0.25-0.25v-11.5c0-0.135 0.114-0.25 0.25-0.25 0 0 5.749-0 5.75 0v3.5c0 0.276 0.224 0.5 0.5 0.5h3.5v7.75z"
        /> < path fill = "#000000" d =
        "M9.421 0.659c-0.806-0.591-1.197-0.659-1.421-0.659h-5.75c-0.689 0-1.25 0.561-1.25 1.25v11.5c0 0.604 0.43 1.109 1 1.225v-12.725c0-0.135 0.115-0.25 0.25-0.25h7.607c-0.151-0.124-0.297-0.238-0.437-0.341z"
        /> < / svg >
    }
}
#[cfg(feature = "ImFilm")]
...
pub fn ImFilm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 2v12h16v-12h-16zM3 13h-2v-2h2v2zM3 9h-2v-2h2v2zM3 5h-2v-2h2v2zM12 13h-8v-10h8v10zM15 13h-2v-2h2v2zM15 9h-2v-2h2v2zM15 5h-2v-2h2v2zM6 5v6l4-3z"
        /> < / svg >
    }
}
...
pub fn ImFilter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFilter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFinder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFinder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8.894 12.16c-0-0.001-0-0.001-0-0.002 0 0.001 0 0.001 0 0.002z" /> < path fill =
        "#000000" d =
        "M8.916 12.727c-0-0.004-0-0.007-0.001-0.011 0 0.004 0 0.007 0.001 0.011z" /> <
        path fill = "#000000" d =
        "M8.903 12.442c-0-0.003-0-0.006-0-0.008 0 0.003 0 0.006 0 0.008z" /> < path fill
        = "#000000" d =
        "M15 0h-14c-0.55 0-1 0.45-1 1v14c0 0.55 0.45 1 1 1h7.716c0.001 0 0.001 0 0.002 0s0.001-0 0.002-0h6.28c0.55 0 1-0.45 1-1v-14c0-0.55-0.45-1-1-1zM3 3.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5v-1zM15 15h-5.86c-0.105-0.658-0.17-1.336-0.209-1.994 0 0.002 0 0.004 0 0.005-0.308 0.034-0.618 0.051-0.931 0.051-2.088 0-4.1-0.76-5.664-2.141-0.233-0.206-0.255-0.561-0.050-0.794s0.561-0.255 0.794-0.050c1.358 1.199 3.105 1.859 4.919 1.859 0.298 0 0.595-0.018 0.888-0.053-0.034-1.847 0.107-3.311 0.11-3.334 0.014-0.141-0.032-0.28-0.127-0.385s-0.229-0.164-0.371-0.164h-1.487c0.022-0.541 0.079-1.466 0.234-2.503 0.295-1.981 0.812-3.528 1.502-4.497h6.251v14z"
        /> < path fill = "#000000" d =
        "M12.5 5c-0.276 0-0.5-0.224-0.5-0.5v-1c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1c0 0.276-0.224 0.5-0.5 0.5z"
        /> < path fill = "#000000" d =
        "M8.445 13.050c-0.057 0.003-0.114 0.005-0.171 0.007 0.057-0.002 0.114-0.004 0.171-0.007z"
        /> < path fill = "#000000" d =
        "M8 13.063c0.073 0 0.146-0.001 0.22-0.003-0.073 0.002-0.146 0.003-0.22 0.003z" />
        < path fill = "#000000" d =
        "M8.423 11.925c0.012-0.001 0.024-0.001 0.037-0.002-0.012 0.001-0.024 0.001-0.037 0.002z"
        /> < path fill = "#000000" d =
        "M8.204 11.934c0.017-0 0.034-0.001 0.050-0.002-0.017 0.001-0.034 0.001-0.050 0.002z"
        /> < path fill = "#000000" d =
        "M13.713 10.128c-0.206-0.233-0.561-0.255-0.794-0.050-1.135 1.002-2.542 1.627-4.032 1.806 0.007 0.364 0.020 0.742 0.043 1.127 1.749-0.191 3.403-0.916 4.733-2.090 0.233-0.206 0.255-0.561 0.050-0.794z"
        /> < path fill = "#000000" d =
        "M8.93 13.012c-0.072 0.008-0.144 0.015-0.216 0.021 0.072-0.006 0.144-0.013 0.216-0.021z"
        /> < path fill = "#000000" d =
        "M8.68 13.035c-0.061 0.005-0.122 0.009-0.183 0.013 0.061-0.004 0.122-0.008 0.183-0.013z"
        /> < / svg >
    }
}
#[cfg(feature = "ImFire")]
...
pub fn ImFire(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFire"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFirefox(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFirefox"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFirst(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFirst"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M2 14v-12h2v5.5l5-5v5l5-5v11l-5-5v5l-5-5v5.5z" /> < / svg >
    }
}
#[cfg(feature = "ImFlag")]
...
pub fn ImFlag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M0 0h2v16h-2v-16z" />
        < path fill = "#000000" d =
...
pub fn ImFlattr(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlattr"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFlickr(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlickr"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFlickr2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlickr2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFlickr3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlickr3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14.5 0h-13c-0.825 0-1.5 0.675-1.5 1.5v13c0 0.825 0.675 1.5 1.5 1.5h13c0.825 0 1.5-0.675 1.5-1.5v-13c0-0.825-0.675-1.5-1.5-1.5zM4.5 10.5c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5zM11.5 10.5c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5c1.381 0 2.5 1.119 2.5 2.5s-1.119 2.5-2.5 2.5z"
        /> < / svg >
    }
}
...
pub fn ImFlickr4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFlickr4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFloppyDisk(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFloppyDisk"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFolder(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolder"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFolderDownload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolderDownload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 4l-2-2h-7v13h16v-11h-7zM8 13.5l-3.5-3.5h2.5v-4h2v4h2.5l-3.5 3.5z" /> < / svg
        >
    }
}
...
pub fn ImFolderMinus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolderMinus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 4l-2-2h-7v13h16v-11h-7zM11 11h-6v-2h6v2z" /> < / svg >
    }
}
...
pub fn ImFolderOpen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolderOpen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13 15l3-8h-13l-3 8zM2 6l-2 9v-13h4.5l2 2h6.5v2z" /> < / svg >
    }
}
...
pub fn ImFolderPlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolderPlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 4l-2-2h-7v13h16v-11h-7zM11 11h-2v2h-2v-2h-2v-2h2v-2h2v2h2v2z" /> < / svg >
    }
}
...
pub fn ImFolderUpload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFolderUpload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 4l-2-2h-7v13h16v-11h-7zM8 7.5l3.5 3.5h-2.5v4h-2v-4h-2.5l3.5-3.5z" /> < / svg
        >
    }
}
#[cfg(feature = "ImFont")]
...
pub fn ImFont(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFont"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFontSize(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFontSize"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M1 8h6v2h-2v6h-2v-6h-2zM15 4h-3.934v12h-2.133v-12h-3.934v-2h10z" /> < / svg >
    }
}
...
pub fn ImForward(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImForward"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4.096 0c-1.777 3.219-2.076 8.13 4.904 7.966v-3.966l6 6-6 6v-3.881c-8.359 0.218-9.29-7.378-4.904-12.119z"
        /> < / svg >
    }
}
...
pub fn ImForward2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImForward2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5zM5 5.5l3.5 2.5-3.5 2.5zM9 5.5l3.5 2.5-3.5 2.5z"
        /> < / svg >
    }
}
...
pub fn ImForward3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImForward3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 13.5v-5l-5 5v-11l5 5v-5l5.5 5.5z" /> < / svg >
    }
}
...
pub fn ImFoursquare(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFoursquare"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFrustrated(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFrustrated"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImFrustrated2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImFrustrated2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGift(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGift"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGithub(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGithub"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGlass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGlass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGlass2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGlass2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGoogle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGoogle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGoogle2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGoogle2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14.5 0h-13c-0.825 0-1.5 0.675-1.5 1.5v13c0 0.825 0.675 1.5 1.5 1.5h13c0.825 0 1.5-0.675 1.5-1.5v-13c0-0.825-0.675-1.5-1.5-1.5zM8.119 14c-3.316 0-6-2.684-6-6s2.684-6 6-6c1.619 0 2.975 0.591 4.019 1.569l-1.628 1.569c-0.447-0.428-1.225-0.925-2.391-0.925-2.050 0-3.719 1.697-3.719 3.787s1.672 3.787 3.719 3.787c2.375 0 3.266-1.706 3.403-2.588h-3.403v-2.056h5.666c0.050 0.3 0.094 0.6 0.094 0.994 0.003 3.428-2.294 5.863-5.759 5.863z"
        /> < / svg >
    }
}
...
pub fn ImGoogle3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGoogle3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGoogleDrive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGoogleDrive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6.844 10l-2.884 5h9.072l2.884-5z" /> < path fill = "#000000" d =
        "M15.506 9l-4.619-8h-5.775l4.619 8z" /> < path fill = "#000000" d =
        "M4.534 2l-4.534 7.856 2.888 5 4.534-7.856z" /> < / svg >
    }
}
...
pub fn ImGooglePlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGooglePlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d =
        "M16 7h-1.5v-1.5h-1.5v1.5h-1.5v1.5h1.5v1.5h1.5v-1.5h1.5z" /> < / svg >
    }
}
...
pub fn ImGooglePlus2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGooglePlus2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGooglePlus3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGooglePlus3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.419 0-8 3.581-8 8s3.581 8 8 8 8-3.581 8-8-3.581-8-8-8zM6 12c-2.212 0-4-1.787-4-4s1.788-4 4-4c1.081 0 1.984 0.394 2.681 1.047l-1.088 1.044c-0.297-0.284-0.816-0.616-1.594-0.616-1.366 0-2.481 1.131-2.481 2.525s1.116 2.525 2.481 2.525c1.584 0 2.178-1.137 2.269-1.725h-2.269v-1.372h3.778c0.034 0.2 0.063 0.4 0.063 0.663 0 2.287-1.531 3.909-3.841 3.909zM13 8v1h-1v-1h-1v-1h1v-1h1v1h1v1h-1z"
        /> < / svg >
    }
}
#[cfg(feature = "ImGrin")]
...
pub fn ImGrin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGrin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImGrin2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImGrin2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHackernews(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHackernews"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 0v16h16v-16h-16zM8.5 9.125v3.375h-1v-3.375l-2.734-5.125h1.134l2.1 3.938 2.1-3.938h1.134l-2.734 5.125z"
        /> < / svg >
    }
}
...
pub fn ImHammer(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHammer"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHammer2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHammer2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHangouts(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHangouts"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHappy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHappy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHappy2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHappy2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHeadphones(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHeadphones"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        fill = "#000000" d =
        "M11.5 9c-0.275 0-0.5 0.225-0.5 0.5v6c0 0.275 0.225 0.5 0.5 0.5h1v-7h-1z" /> <
        path fill = "#000000" d =
        "M16 8c0-4.418-3.582-8-8-8s-8 3.582-8 8c0 0.96 0.169 1.88 0.479 2.732-0.304 0.519-0.479 1.123-0.479 1.768 0 1.763 1.304 3.222 3 3.464v-6.928c-0.499 0.071-0.963 0.248-1.371 0.506-0.084-0.417-0.129-0.849-0.129-1.292 0-3.59 2.91-6.5 6.5-6.5s6.5 2.91 6.5 6.5c0 0.442-0.044 0.874-0.128 1.292-0.408-0.259-0.873-0.435-1.372-0.507v6.929c1.696-0.243 3-1.701 3-3.464 0-0.645-0.175-1.249-0.479-1.768 0.31-0.853 0.479-1.773 0.479-2.732z"
        /> < / svg >
    }
}
#[cfg(feature = "ImHeart")]
...
pub fn ImHeart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHeart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.8 1c-1.682 0-3.129 1.368-3.799 2.797-0.671-1.429-2.118-2.797-3.8-2.797-2.318 0-4.2 1.882-4.2 4.2 0 4.716 4.758 5.953 8 10.616 3.065-4.634 8-6.050 8-10.616 0-2.319-1.882-4.2-4.2-4.2z"
        /> < / svg >
    }
}
...
pub fn ImHeartBroken(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHeartBroken"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHipster(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHipster"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5zM4 5c0-0.552 0.448-1 1-1s1 0.448 1 1-0.448 1-1 1-1-0.448-1-1zM10 5c0-0.552 0.448-1 1-1s1 0.448 1 1-0.448 1-1 1-1-0.448-1-1z"
        /> < path fill = "#000000" d =
        "M10.561 8.439c-0.586-0.586-1.536-0.586-2.121 0s-0.586 1.536 0 2.121c0.019 0.019 0.038 0.037 0.058 0.055 1.352 1.227 4.503-0.029 4.503-1.615-0.969 0.625-1.726 0.153-2.439-0.561z"
        /> < path fill = "#000000" d =
        "M5.439 8.439c0.586-0.586 1.536-0.586 2.121 0s0.586 1.536 0 2.121c-0.019 0.019-0.038 0.037-0.058 0.055-1.352 1.227-4.503-0.029-4.503-1.615 0.969 0.625 1.726 0.153 2.439-0.561z"
        /> < / svg >
    }
}
...
pub fn ImHipster2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHipster2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM11 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1 0.448-1 1-1zM5 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1 0.448-1 1-1zM8.497 10.615c-0.020-0.018-0.039-0.036-0.058-0.055-0.293-0.293-0.439-0.677-0.439-1.060-0 0.384-0.146 0.768-0.439 1.060-0.019 0.019-0.038 0.037-0.058 0.055-1.352 1.227-4.503-0.029-4.503-1.615 0.969 0.625 1.726 0.153 2.439-0.561 0.586-0.586 1.536-0.586 2.121 0 0.293 0.293 0.439 0.677 0.439 1.060 0-0.384 0.146-0.768 0.439-1.060 0.586-0.586 1.536-0.586 2.121 0 0.713 0.714 1.471 1.186 2.439 0.561 0 1.586-3.151 2.842-4.503 1.615z"
        /> < / svg >
    }
}
...
pub fn ImHistory(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHistory"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 17 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
...
pub fn ImHome(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHome"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 9.226l-8-6.21-8 6.21v-2.532l8-6.21 8 6.21zM14 9v6h-4v-4h-4v4h-4v-6l6-4.5z"
        /> < / svg >
    }
}
#[cfg(feature = "ImHome2")]
...
pub fn ImHome2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHome2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHome3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHome3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 9.5l-3-3v-4.5h-2v2.5l-3-3-8 8v0.5h2v5h5v-3h2v3h5v-5h2z" /> < / svg >
    }
}
...
pub fn ImHourGlass(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHourGlass"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImHtmlFive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHtmlFive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0.946 0l1.284 14.4 5.762 1.6 5.777-1.602 1.286-14.398h-14.108zM12.26 4.71h-6.758l0.161 1.809h6.437l-0.485 5.422-3.623 1.004-3.618-1.004-0.247-2.774h1.773l0.126 1.41 1.967 0.53 0.004-0.001 1.968-0.531 0.204-2.29h-6.121l-0.476-5.341h8.847l-0.158 1.766z"
        /> < / svg >
    }
}
...
pub fn ImHtmlFive2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImHtmlFive2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImIcoMoon(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImIcoMoon"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImIe(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImIe"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImImage(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImImage"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M14 13h-12v-2l3.5-6 4 5h1l3.5-3z" /> < / svg >
    }
}
...
pub fn ImImages(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImImages"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M16 14h-12v-2l3.5-6 4 5h1l3.5-3z" /> < / svg >
    }
}
...
pub fn ImIndentDecrease(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImIndentDecrease"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM6 4h10v2h-10zM6 7h10v2h-10zM6 10h10v2h-10zM0 13h16v2h-16zM4 5v6l-4-3z"
        /> < / svg >
    }
}
...
pub fn ImIndentIncrease(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImIndentIncrease"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM6 4h10v2h-10zM6 7h10v2h-10zM6 10h10v2h-10zM0 13h16v2h-16zM0 11v-6l4 3z"
        /> < / svg >
    }
}
...
pub fn ImInfinite(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImInfinite"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImInfo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImInfo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M10 12h-4v-1h1v-3h-1v-1h3v4h1z" /> < path fill =
        "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5z"
        /> < / svg >
    }
...
pub fn ImInsertTemplate(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImInsertTemplate"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImInstagram(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImInstagram"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImItalic(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImItalic"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14 1v1h-2l-5 12h2v1h-7v-1h2l5-12h-2v-1z" /> < / svg >
    }
}
...
pub fn ImJoomla(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImJoomla"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImKey(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImKey"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImKey2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImKey2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImKeyboard(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImKeyboard"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLab(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLab"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLanyrd(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLanyrd"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLaptop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLaptop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14 2v12h-2v-5.5l-5 5v-5l-5 5v-11l5 5v-5l5 5v-5.5z" /> < / svg >
    }
}
...
pub fn ImLastfm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLastfm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLastfm2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLastfm2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLeaf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLeaf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLibrary(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLibrary"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M8 0h1l8 5v1h-17v-1l8-5z" /> < / svg >
    }
}
...
pub fn ImLibreoffice(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLibreoffice"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLifebuoy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLifebuoy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLigature(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLigature"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLigature2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLigature2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLink(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLink"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLinkedin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLinkedin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLinkedin2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLinkedin2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M1 6h3v9h-3v-9z" /> < path fill = "#000000" d =
...
pub fn ImList(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImList"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 0h4v4h-4zM6 1h10v2h-10zM0 6h4v4h-4zM6 7h10v2h-10zM0 12h4v4h-4zM6 13h10v2h-10z"
        /> < / svg >
    }
}
#[cfg(feature = "ImList2")]
...
pub fn ImList2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImList2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImListNumbered(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImListNumbered"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLocation(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLocation"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLocation2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLocation2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLock(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLock"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLoop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLoop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M2 5h10v3l4-4-4-4v3h-12v6h2zM14 11h-10v-3l-4 4 4 4v-3h12v-6h-2z" /> < / svg >
    }
}
#[cfg(feature = "ImLoop2")]
...
pub fn ImLoop2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLoop2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImLtr(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImLtr"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMagicWand(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMagicWand"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMagnet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMagnet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMail(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMail"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13.333 0h-10.666c-1.467 0-2.667 1.2-2.667 2.667v10.666c0 1.467 1.2 2.667 2.667 2.667h10.666c1.468 0 2.667-1.2 2.667-2.667v-10.666c0-1.467-1.199-2.667-2.667-2.667zM4 4h8c0.143 0 0.281 0.031 0.409 0.088l-4.409 5.143-4.409-5.143c0.127-0.058 0.266-0.088 0.409-0.088zM3 11v-6c0-0.021 0.001-0.042 0.002-0.063l2.932 3.421-2.9 2.9c-0.023-0.083-0.034-0.17-0.034-0.258zM12 12h-8c-0.088 0-0.175-0.012-0.258-0.034l2.846-2.846 1.413 1.648 1.413-1.648 2.846 2.846c-0.083 0.023-0.17 0.034-0.258 0.034zM13 11c0 0.088-0.012 0.175-0.034 0.258l-2.9-2.9 2.932-3.421c0.001 0.021 0.002 0.042 0.002 0.063v6z"
        /> < / svg >
    }
}
#[cfg(feature = "ImMail2")]
...
pub fn ImMail2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMail2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMail3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMail3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13.333 0h-10.666c-1.467 0-2.667 1.2-2.667 2.667v10.666c0 1.468 1.2 2.667 2.667 2.667h10.666c1.467 0 2.667-1.199 2.667-2.667v-10.666c0-1.467-1.2-2.667-2.667-2.667zM2.854 13.854l-1.207-1.207 4-4 0.457 0.457-3.25 4.75zM2.396 3.104l0.457-0.457 5.146 4.146 5.146-4.146 0.457 0.457-5.604 6.604-5.604-6.604zM13.146 13.854l-3.25-4.75 0.457-0.457 4 4-1.207 1.207z"
        /> < / svg >
    }
}
#[cfg(feature = "ImMail4")]
...
pub fn ImMail4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMail4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMakeGroup(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMakeGroup"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMan(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMan"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImManWoman(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImManWoman"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5z"
        /> < path fill = "#000000" d =
        "M13 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5z"
        /> < path fill = "#000000" d =
        "M4 4h-3c-0.552 0-1 0.448-1 1v5h1v6h1.25v-6h0.5v6h1.25v-6h1v-5c0-0.552-0.448-1-1-1z"
        /> < path fill = "#000000" d =
        "M15.234 8l0.766-0.555-2.083-3.221c-0.092-0.14-0.249-0.225-0.417-0.225h-4c-0.168 0-0.325 0.084-0.417 0.225l-2.083 3.221 0.766 0.555 1.729-2.244 0.601 1.402-2.095 3.841h1.917l0.333 5h1v-5h0.5v5h1l0.333-5h1.917l-2.095-3.842 0.601-1.402 1.729 2.244z"
        /> < / svg >
    }
}
#[cfg(feature = "ImMap")]
...
pub fn ImMap(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMap"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M0 3l5-2v12l-5 2z" />
        < path fill = "#000000" d = "M6 0.5l5 3v11.5l-5-2.5z" /> < path fill = "#000000"
        d = "M12 3.5l4-3v12l-4 3z" /> < / svg >
    }
}
#[cfg(feature = "ImMap2")]
...
pub fn ImMap2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMap2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMenu(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMenu"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M1 3h14v3h-14zM1 7h14v3h-14zM1 11h14v3h-14z" /> < / svg >
    }
}
#[cfg(feature = "ImMenu2")]
...
pub fn ImMenu2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMenu2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 22 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 3h14v3h-14v-3zM0 7h14v3h-14v-3zM0 11h14v3h-14v-3z" /> < path fill = "#000000"
        d = "M15.5 9l3 3 3-3z" /> < path fill = "#000000" d = "M21.5 8l-3-3-3 3z" /> < /
        svg >
    }
}
#[cfg(feature = "ImMenu3")]
...
pub fn ImMenu3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMenu3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMenu4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMenu4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMeter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMeter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMeter2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMeter2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMic(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMic"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMinus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMinus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMobile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMobile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMobile2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMobile2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMoveDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMoveDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M12 11v-6h-1v6h-2.5l3 3 3-3z" /> < path fill = "#000000" d =
        "M5 4v3h-3v-3h3zM6 3h-5v5h5v-5z" /> < path fill = "#000000" d =
        "M1 10h1.5v1h-1.5v-1z" /> < path fill = "#000000" d = "M3 10h1.5v1h-1.5v-1z" /> <
        path fill = "#000000" d = "M5 10h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
        "M1 13.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d = "M2.5 14h1.5v1h-1.5v-1z"
        /> < path fill = "#000000" d = "M4.5 14h1.5v1h-1.5v-1z" /> < path fill =
        "#000000" d = "M1 11.5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d =
        "M5 12h1v1.5h-1v-1.5z" /> < / svg >
    }
}
...
pub fn ImMoveUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMoveUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11 8v6h1v-6h2.5l-3-3-3 3z" /> < path fill = "#000000" d = "M1 3h1.5v1h-1.5v-1z"
        /> < path fill = "#000000" d = "M3 3h1.5v1h-1.5v-1z" /> < path fill = "#000000" d
        = "M5 3h1v1.5h-1v-1.5z" /> < path fill = "#000000" d = "M1 6.5h1v1.5h-1v-1.5z" />
        < path fill = "#000000" d = "M2.5 7h1.5v1h-1.5v-1z" /> < path fill = "#000000" d
        = "M4.5 7h1.5v1h-1.5v-1z" /> < path fill = "#000000" d = "M1 4.5h1v1.5h-1v-1.5z"
        /> < path fill = "#000000" d = "M5 5h1v1.5h-1v-1.5z" /> < path fill = "#000000" d
        = "M5 11v3h-3v-3h3zM6 10h-5v5h5v-5z" /> < / svg >
    }
}
#[cfg(feature = "ImMug")]
...
pub fn ImMug(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMug"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImMusic(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImMusic"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImNeutral(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNeutral"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 16c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zM8 1.5c3.59 0 6.5 2.91 6.5 6.5s-2.91 6.5-6.5 6.5-6.5-2.91-6.5-6.5 2.91-6.5 6.5-6.5zM4 5c0 0.552 0.448 1 1 1s1-0.448 1-1-0.448-1-1-1-1 0.448-1 1zM10 5c0 0.552 0.448 1 1 1s1-0.448 1-1-0.448-1-1-1-1 0.448-1 1zM6 11h4v1h-4v-1z"
        /> < / svg >
    }
}
...
pub fn ImNeutral2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNeutral2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8c4.418 0 8-3.582 8-8s-3.582-8-8-8zM10 12h-4v-1h4v1zM11 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1c0-0.552 0.448-1 1-1zM5 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1c0-0.552 0.448-1 1-1z"
        /> < / svg >
    }
}
...
pub fn ImNewTab(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNewTab"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M3 1v12h12v-12h-12zM14 12h-10v-10h10v10zM2 14v-10.5l-1-1v12.5h12.5l-1-1h-10.5z"
...
pub fn ImNewspaper(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNewspaper"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImNext(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNext"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M9 8l-4-3v6z" /> < path fill = "#000000" d =
        "M11 5h-2v6h2v-6z" /> < / svg >
    }
}
#[cfg(feature = "ImNext2")]
...
pub fn ImNext2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNext2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M12 2v12h-2v-5.5l-5 5v-11l5 5v-5.5z" /> < / svg >
    }
}
...
pub fn ImNotification(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNotification"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 1.5c-1.736 0-3.369 0.676-4.596 1.904s-1.904 2.86-1.904 4.596c0 1.736 0.676 3.369 1.904 4.596s2.86 1.904 4.596 1.904c1.736 0 3.369-0.676 4.596-1.904s1.904-2.86 1.904-4.596c0-1.736-0.676-3.369-1.904-4.596s-2.86-1.904-4.596-1.904zM8 0v0c4.418 0 8 3.582 8 8s-3.582 8-8 8c-4.418 0-8-3.582-8-8s3.582-8 8-8zM7 11h2v2h-2zM7 3h2v6h-2z"
        /> < / svg >
    }
}
#[cfg(feature = "ImNpm")]
...
pub fn ImNpm(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImNpm"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 0v16h16v-16h-16zM13 13h-2v-8h-3v8h-5v-10h10v10z" /> < / svg >
    }
}
...
pub fn ImOffice(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImOffice"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImOmega(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImOmega"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImOnedrive(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImOnedrive"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImOpera(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImOpera"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImOpt(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImOpt"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPacman(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPacman"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPageBreak(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPageBreak"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPagebreak(
    ...
    view! {
        ...
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4 6v-6h12v6h-1v-5h-10v5zM16 9v7h-12v-7h1v6h10v-6zM8 7h2v1h-2zM5 7h2v1h-2zM11 7h2v1h-2zM14 7h2v1h-2zM0 4.5l3 3-3 3z"
        /> < / svg >
    }
}
...
pub fn ImPaintFormat(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPaintFormat"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImParagraphCenter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImParagraphCenter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM3 4h10v2h-10zM3 10h10v2h-10zM0 7h16v2h-16zM0 13h16v2h-16z" /> < /
        svg >
    }
}
...
pub fn ImParagraphJustify(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImParagraphJustify"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM0 4h16v2h-16zM0 7h16v2h-16zM0 10h16v2h-16zM0 13h16v2h-16z" /> < /
        svg >
    }
}
...
pub fn ImParagraphLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImParagraphLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM0 4h10v2h-10zM0 10h10v2h-10zM0 7h16v2h-16zM0 13h16v2h-16z" /> < /
        svg >
    }
}
...
pub fn ImParagraphRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImParagraphRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 1h16v2h-16zM6 4h10v2h-10zM6 10h10v2h-10zM0 7h16v2h-16zM0 13h16v2h-16z" /> < /
        svg >
    }
}
#[cfg(feature = "ImPaste")]
...
pub fn ImPaste(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPaste"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPause(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPause"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5zM5 5h2v6h-2zM9 5h2v6h-2z"
        /> < / svg >
    }
}
...
pub fn ImPause2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPause2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M2 2h5v12h-5zM9 2h5v12h-5z" /> < / svg >
    }
}
...
pub fn ImPaypal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPaypal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPen(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPen"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPencil(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPencil"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPencil2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPencil2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPhone(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPhone"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPhoneHangUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPhoneHangUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPieChart(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPieChart"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPilcrow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPilcrow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6 0h8v2h-2v14h-2v-14h-2v14h-2v-8c-2.209 0-4-1.791-4-4s1.791-4 4-4z" /> < / svg
        >
    }
}
...
pub fn ImPinterest(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPinterest"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPinterest2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPinterest2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPlay(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPlay"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15.331 2.502c-2.244-0.323-4.724-0.502-7.331-0.502s-5.087 0.179-7.331 0.502c-0.43 1.683-0.669 3.543-0.669 5.498s0.239 3.815 0.669 5.498c2.244 0.323 4.724 0.502 7.331 0.502s5.087-0.179 7.331-0.502c0.43-1.683 0.669-3.543 0.669-5.498s-0.239-3.815-0.669-5.498zM6 11v-6l5 3-5 3z"
        /> < / svg >
    }
}
#[cfg(feature = "ImPlay2")]
...
pub fn ImPlay2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPlay2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5zM6 4.5l6 3.5-6 3.5z"
        /> < / svg >
    }
}
#[cfg(feature = "ImPlay3")]
...
pub fn ImPlay3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPlay3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M3 2l10 6-10 6z" /> <
        / svg >
    }
}
#[cfg(feature = "ImPlus")]
...
pub fn ImPlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPodcast(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPodcast"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPointDown(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPointDown"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPointLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPointLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPointRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPointRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPointUp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPointUp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPower(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPower"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6 0l-6 8h6l-4 8 14-10h-8l6-6z" /> < / svg >
    }
}
...
pub fn ImPowerCord(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPowerCord"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImPrevious(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPrevious"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5z"
        /> < path fill = "#000000" d = "M7 8l4-3v6z" /> < path fill = "#000000" d =
        "M5 5h2v6h-2v-6z" /> < / svg >
    }
}
...
pub fn ImPrevious2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPrevious2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4 14v-12h2v5.5l5-5v11l-5-5v5.5z" /> < / svg >
    }
}
...
pub fn ImPriceTag(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPriceTag"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15.25 0h-6c-0.412 0-0.989 0.239-1.28 0.53l-7.439 7.439c-0.292 0.292-0.292 0.769 0 1.061l6.439 6.439c0.292 0.292 0.769 0.292 1.061 0l7.439-7.439c0.292-0.292 0.53-0.868 0.53-1.28v-6c0-0.412-0.338-0.75-0.75-0.75zM11.5 6c-0.828 0-1.5-0.672-1.5-1.5s0.672-1.5 1.5-1.5 1.5 0.672 1.5 1.5-0.672 1.5-1.5 1.5z"
        /> < / svg >
    }
}
...
pub fn ImPriceTags(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPriceTags"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 20 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M19.25 0h-6c-0.412 0-0.989 0.239-1.28 0.53l-7.439 7.439c-0.292 0.292-0.292 0.769 0 1.061l6.439 6.439c0.292 0.292 0.769 0.292 1.061 0l7.439-7.439c0.292-0.292 0.53-0.868 0.53-1.28v-6c0-0.412-0.337-0.75-0.75-0.75zM15.5 6c-0.828 0-1.5-0.672-1.5-1.5s0.672-1.5 1.5-1.5 1.5 0.672 1.5 1.5-0.672 1.5-1.5 1.5z"
        /> < path fill = "#000000" d =
        "M2 8.5l8.5-8.5h-1.25c-0.412 0-0.989 0.239-1.28 0.53l-7.439 7.439c-0.292 0.292-0.292 0.769 0 1.061l6.439 6.439c0.292 0.292 0.769 0.292 1.061 0l0.47-0.47-6.5-6.5z"
        /> < / svg >
    }
}
...
pub fn ImPrinter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPrinter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M4 1h8v2h-8v-2z" /> <
        path fill = "#000000" d =
...
pub fn ImProfile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImProfile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M13.5 0h-12c-0.825 0-1.5 0.675-1.5 1.5v13c0 0.825 0.675 1.5 1.5 1.5h12c0.825 0 1.5-0.675 1.5-1.5v-13c0-0.825-0.675-1.5-1.5-1.5zM13 14h-11v-12h11v12zM4 9h7v1h-7zM4 11h7v1h-7zM5 4.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM7.5 6h-2c-0.825 0-1.5 0.45-1.5 1v1h5v-1c0-0.55-0.675-1-1.5-1z"
        /> < / svg >
    }
}
...
pub fn ImPushpin(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImPushpin"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImQrcode(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImQrcode"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImQuestion(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImQuestion"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImQuill(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImQuill"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 16c2-6 7.234-16 16-16-4.109 3.297-6 11-9 11s-3 0-3 0l-3 5h-1z" /> < / svg >
    }
}
...
pub fn ImQuotesLeft(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImQuotesLeft"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImQuotesRight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImQuotesRight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRadioChecked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRadioChecked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14c-3.314 0-6-2.686-6-6s2.686-6 6-6c3.314 0 6 2.686 6 6s-2.686 6-6 6zM5 8c0-1.657 1.343-3 3-3s3 1.343 3 3c0 1.657-1.343 3-3 3s-3-1.343-3-3z"
        /> < / svg >
    }
}
...
pub fn ImRadioChecked2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRadioChecked2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 10c-1.105 0-2-0.895-2-2s0.895-2 2-2c1.105 0 2 0.895 2 2s-0.895 2-2 2z"
        /> < / svg >
    }
}
...
pub fn ImRadioUnchecked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRadioUnchecked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14c-3.314 0-6-2.686-6-6s2.686-6 6-6c3.314 0 6 2.686 6 6s-2.686 6-6 6z"
        /> < / svg >
    }
}
...
pub fn ImReddit(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImReddit"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRedo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRedo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRedo2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRedo2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRenren(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRenren"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImReply(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImReply"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M7 12.119v3.881l-6-6 6-6v3.966c6.98 0.164 6.681-4.747 4.904-7.966 4.386 4.741 3.455 12.337-4.904 12.119z"
        /> < / svg >
    }
}
#[cfg(feature = "ImRoad")]
...
pub fn ImRoad(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRoad"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11 16h5l-4-16h-3l0.5 4h-3l0.5-4h-3l-4 16h5l0.5-4h5l0.5 4zM5.75 10l0.5-4h3.5l0.5 4h-4.5z"
        /> < / svg >
    }
}
...
pub fn ImRocket(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRocket"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRss(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRss"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRss2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRss2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImRtl(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImRtl"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSad(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSad"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSad2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSad2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSafari(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSafari"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImScissors(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImScissors"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSearch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSearch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSection(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSection"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShare(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShare"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShare2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShare2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShield(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShield"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShift(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShift"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShocked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShocked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImShocked2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShocked2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM5 7c-0.552 0-1-0.672-1-1.5s0.448-1.5 1-1.5 1 0.672 1 1.5-0.448 1.5-1 1.5zM8 13c-1.105 0-2-0.895-2-2s0.895-2 2-2c1.105 0 2 0.895 2 2s-0.895 2-2 2zM11 7c-0.552 0-1-0.672-1-1.5s0.448-1.5 1-1.5 1 0.672 1 1.5-0.448 1.5-1 1.5z"
        /> < / svg >
    }
}
...
pub fn ImShrink(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShrink"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M9 7h6.5l-2.5-2.5 3-3-1.5-1.5-3 3-2.5-2.5z" /> < path fill = "#000000" d =
        "M9 9v6.5l2.5-2.5 3 3 1.5-1.5-3-3 2.5-2.5z" /> < path fill = "#000000" d =
        "M7 9h-6.5l2.5 2.5-3 3 1.5 1.5 3-3 2.5 2.5z" /> < path fill = "#000000" d =
        "M7 7v-6.5l-2.5 2.5-3-3-1.5 1.5 3 3-2.5 2.5z" /> < / svg >
    }
}
...
pub fn ImShrink2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShrink2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M7 9v6.5l-2.5-2.5-3 3-1.5-1.5 3-3-2.5-2.5zM16 1.5l-3 3 2.5 2.5h-6.5v-6.5l2.5 2.5 3-3z"
        /> < / svg >
    }
}
...
pub fn ImShuffle(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImShuffle"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSigma(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSigma"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSinaWeibo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSinaWeibo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSkype(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSkype"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSleepy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSleepy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSleepy2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSleepy2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSmile(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSmile"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSmile2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSmile2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSortAlphaAsc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortAlphaAsc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d =
...
pub fn ImSortAlphaDesc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortAlphaDesc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSortAmountAsc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortAmountAsc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill = "#000000" d =
        "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d =
        "M7 9h9v2h-9v-2z" /> < path fill = "#000000" d = "M7 6h7v2h-7v-2z" /> < path fill
        = "#000000" d = "M7 3h5v2h-5v-2z" /> < path fill = "#000000" d =
        "M7 0h3v2h-3v-2z" /> < / svg >
    }
}
...
pub fn ImSortAmountDesc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortAmountDesc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill = "#000000" d =
        "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d =
        "M7 0h9v2h-9v-2z" /> < path fill = "#000000" d = "M7 3h7v2h-7v-2z" /> < path fill
        = "#000000" d = "M7 6h5v2h-5v-2z" /> < path fill = "#000000" d =
        "M7 9h3v2h-3v-2z" /> < / svg >
    }
}
...
pub fn ImSortNumbericDesc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortNumbericDesc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        title > { title } < / title > < path fill = "#000000" d =
        "M5 12v-12h-2v12h-2.5l3.5 3.5 3.5-3.5h-2.5z" /> < path fill = "#000000" d =
        "M13.5 16c-0.276 0-0.5-0.224-0.5-0.5v-5.5h-0.5c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h1c0.276 0 0.5 0.224 0.5 0.5v6c0 0.276-0.224 0.5-0.5 0.5z"
        /> < path fill = "#000000" d =
        "M14.5 0h-3c-0.276 0-0.5 0.224-0.5 0.5v3c0 0.276 0.224 0.5 0.5 0.5h2.5v2h-2.5c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h3c0.276 0 0.5-0.224 0.5-0.5v-6c0-0.276-0.224-0.5-0.5-0.5zM12 1h2v2h-2v-2z"
        /> < / svg >
    }
}
...
pub fn ImSortNumericAsc(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSortNumericAsc"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSoundcloud(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSoundcloud"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSoundcloud2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSoundcloud2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpades(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpades"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpellCheck(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpellCheck"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSphere(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSphere"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner10(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner10"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner11(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner11"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 6h-6l2.243-2.243c-1.133-1.133-2.64-1.757-4.243-1.757s-3.109 0.624-4.243 1.757c-1.133 1.133-1.757 2.64-1.757 4.243s0.624 3.109 1.757 4.243c1.133 1.133 2.64 1.757 4.243 1.757s3.109-0.624 4.243-1.757c0.095-0.095 0.185-0.192 0.273-0.292l1.505 1.317c-1.466 1.674-3.62 2.732-6.020 2.732-4.418 0-8-3.582-8-8s3.582-8 8-8c2.209 0 4.209 0.896 5.656 2.344l2.343-2.344v6z"
        /> < / svg >
    }
}
...
pub fn ImSpinner2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 4.736c-0.515 0-0.933-0.418-0.933-0.933v-2.798c0-0.515 0.418-0.933 0.933-0.933s0.933 0.418 0.933 0.933v2.798c0 0.515-0.418 0.933-0.933 0.933z"
        /> < path fill = "#000000" d =
        "M8 15.577c-0.322 0-0.583-0.261-0.583-0.583v-2.798c0-0.322 0.261-0.583 0.583-0.583s0.583 0.261 0.583 0.583v2.798c0 0.322-0.261 0.583-0.583 0.583z"
        /> < path fill = "#000000" d =
        "M5.902 5.24c-0.302 0-0.596-0.157-0.758-0.437l-1.399-2.423c-0.241-0.418-0.098-0.953 0.32-1.194s0.953-0.098 1.194 0.32l1.399 2.423c0.241 0.418 0.098 0.953-0.32 1.194-0.138 0.079-0.288 0.117-0.436 0.117z"
        /> < path fill = "#000000" d =
        "M11.498 14.582c-0.181 0-0.358-0.094-0.455-0.262l-1.399-2.423c-0.145-0.251-0.059-0.572 0.192-0.717s0.572-0.059 0.717 0.192l1.399 2.423c0.145 0.251 0.059 0.572-0.192 0.717-0.083 0.048-0.173 0.070-0.262 0.070z"
        /> < path fill = "#000000" d =
        "M4.365 6.718c-0.138 0-0.279-0.035-0.407-0.109l-2.423-1.399c-0.39-0.225-0.524-0.724-0.299-1.115s0.724-0.524 1.115-0.299l2.423 1.399c0.39 0.225 0.524 0.724 0.299 1.115-0.151 0.262-0.425 0.408-0.707 0.408z"
        /> < path fill = "#000000" d =
        "M14.057 11.964c-0.079 0-0.159-0.020-0.233-0.063l-2.423-1.399c-0.223-0.129-0.299-0.414-0.171-0.637s0.414-0.299 0.637-0.171l2.423 1.399c0.223 0.129 0.299 0.414 0.171 0.637-0.086 0.15-0.243 0.233-0.404 0.233z"
        /> < path fill = "#000000" d =
        "M3.803 8.758h-2.798c-0.418 0-0.758-0.339-0.758-0.758s0.339-0.758 0.758-0.758h2.798c0.419 0 0.758 0.339 0.758 0.758s-0.339 0.758-0.758 0.758z"
        /> < path fill = "#000000" d =
        "M14.995 8.466c-0 0 0 0 0 0h-2.798c-0.258-0-0.466-0.209-0.466-0.466s0.209-0.466 0.466-0.466c0 0 0 0 0 0h2.798c0.258 0 0.466 0.209 0.466 0.466s-0.209 0.466-0.466 0.466z"
        /> < path fill = "#000000" d =
        "M1.943 12.197c-0.242 0-0.477-0.125-0.606-0.35-0.193-0.335-0.079-0.762 0.256-0.955l2.423-1.399c0.335-0.193 0.762-0.079 0.955 0.256s0.079 0.762-0.256 0.955l-2.423 1.399c-0.11 0.064-0.23 0.094-0.349 0.094z"
        /> < path fill = "#000000" d =
        "M11.635 6.368c-0.161 0-0.318-0.084-0.404-0.233-0.129-0.223-0.052-0.508 0.171-0.637l2.423-1.399c0.223-0.129 0.508-0.052 0.637 0.171s0.052 0.508-0.171 0.637l-2.423 1.399c-0.073 0.042-0.154 0.063-0.233 0.063z"
        /> < path fill = "#000000" d =
        "M4.502 14.699c-0.109 0-0.219-0.028-0.32-0.086-0.307-0.177-0.412-0.569-0.235-0.876l1.399-2.423c0.177-0.307 0.569-0.412 0.876-0.235s0.412 0.569 0.235 0.876l-1.399 2.423c-0.119 0.206-0.334 0.321-0.556 0.321z"
        /> < path fill = "#000000" d =
        "M10.098 4.832c-0.079 0-0.159-0.020-0.233-0.063-0.223-0.129-0.299-0.414-0.171-0.637l1.399-2.423c0.129-0.223 0.414-0.299 0.637-0.171s0.299 0.414 0.171 0.637l-1.399 2.423c-0.086 0.15-0.243 0.233-0.404 0.233z"
        /> < / svg >
    }
}
...
pub fn ImSpinner4(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner4"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner5(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner5"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 4c2.209 0 4 1.791 4 4s-1.791 4-4 4-4-1.791-4-4 1.791-4 4-4zM12.773 12.773c-1.275 1.275-2.97 1.977-4.773 1.977s-3.498-0.702-4.773-1.977-1.977-2.97-1.977-4.773c0-1.803 0.702-3.498 1.977-4.773l1.061 1.061c0 0 0 0 0 0-2.047 2.047-2.047 5.378 0 7.425 0.992 0.992 2.31 1.538 3.712 1.538s2.721-0.546 3.712-1.538c2.047-2.047 2.047-5.378 0-7.425l1.061-1.061c1.275 1.275 1.977 2.97 1.977 4.773s-0.702 3.498-1.977 4.773z"
        /> < / svg >
    }
}
...
pub fn ImSpinner6(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner6"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner7(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner7"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M6.5 14.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM0 8c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM13 8c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM1.904 3.404c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM11.096 12.596c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM1.904 12.596c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5zM11.096 3.404c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5z"
        /> < / svg >
    }
}
...
pub fn ImSpinner8(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner8"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpinner9(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpinner9"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpoonKnife(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpoonKnife"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSpotify(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSpotify"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStack(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStack"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 5l-8-4-8 4 8 4 8-4zM8 2.328l5.345 2.672-5.345 2.672-5.345-2.672 5.345-2.672zM14.398 7.199l1.602 0.801-8 4-8-4 1.602-0.801 6.398 3.199zM14.398 10.199l1.602 0.801-8 4-8-4 1.602-0.801 6.398 3.199z"
        /> < / svg >
    }
}
...
pub fn ImStackoverflow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStackoverflow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStarEmpty(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStarEmpty"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStarFull(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStarFull"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStarHalf(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStarHalf"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStatsBars(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStatsBars"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 13h16v2h-16zM2 9h2v3h-2zM5 5h2v7h-2zM8 8h2v4h-2zM11 2h2v10h-2z" /> < / svg >
    }
}
...
pub fn ImStatsBars2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStatsBars2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStatsDots(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStatsDots"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSteam(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSteam"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSteam2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSteam2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStop(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStop"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM8 14.5c-3.59 0-6.5-2.91-6.5-6.5s2.91-6.5 6.5-6.5 6.5 2.91 6.5 6.5-2.91 6.5-6.5 6.5zM5 5h6v6h-6z"
        /> < / svg >
    }
}
#[cfg(feature = "ImStop2")]
...
pub fn ImStop2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStop2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M2 2h12v12h-12z" /> <
        / svg >
    }
}
...
pub fn ImStopwatch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStopwatch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStrikethrough(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStrikethrough"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStumbleupon(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStumbleupon"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImStumbleupon2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImStumbleupon2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSubscript(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSubscript"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSubscript2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSubscript2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSun(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSun"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSuperscript(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSuperscript"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSuperscript2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSuperscript2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSvg(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSvg"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImSwitch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImSwitch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTab(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTab"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M15 0h1v8h-1v-8z" /> <
        path fill = "#000000" d = "M0 8h1v8h-1v-8z" /> < path fill = "#000000" d =
        "M5 11h11v2h-11v2.5l-3.5-3.5 3.5-3.5v2.5z" /> < path fill = "#000000" d =
        "M11 5h-11v-2h11v-2.5l3.5 3.5-3.5 3.5z" /> < / svg >
    }
}
#[cfg(feature = "ImTable")]
...
pub fn ImTable(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTable"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 3v11h16v-11h-16zM6 10v-2h4v2h-4zM10 11v2h-4v-2h4zM10 5v2h-4v-2h4zM5 5v2h-4v-2h4zM1 8h4v2h-4v-2zM11 8h4v2h-4v-2zM11 7v-2h4v2h-4zM1 11h4v2h-4v-2zM11 13v-2h4v2h-4z"
        /> < / svg >
    }
}
...
pub fn ImTable2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTable2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTablet(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTablet"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTarget(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTarget"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTelegram(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTelegram"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTerminal(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTerminal"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTextColor(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTextColor"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M5.032 13l0.9-3h4.137l0.9 3h1.775l-3-10h-3.488l-3 10h1.776zM7.432 5h1.137l0.9 3h-2.937l0.9-3z"
        /> < / svg >
    }
}
...
pub fn ImTextHeight(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTextHeight"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M14 12h2l-2.5 3-2.5-3h2v-8h-2l2.5-3 2.5 3h-2zM10 1v4l-1-2h-3v11h2v1h-6v-1h2v-11h-3l-1 2v-4z"
        /> < / svg >
    }
}
...
pub fn ImTextWidth(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTextWidth"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M4 14v2l-3-2.5 3-2.5v2h8v-2l3 2.5-3 2.5v-2zM13 1v4l-1-2h-3v7h2v1h-6v-1h2v-7h-3l-1 2v-4z"
        /> < / svg >
    }
}
...
pub fn ImTicket(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTicket"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTongue(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTongue"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTongue2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTongue2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM5 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1 0.448-1 1-1zM12 10h-1v1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5v-1.5h-4v-1h8v1zM11 6c-0.552 0-1-0.448-1-1s0.448-1 1-1 1 0.448 1 1-0.448 1-1 1z"
        /> < / svg >
    }
}
#[cfg(feature = "ImTree")]
...
pub fn ImTree(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTree"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTrello(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTrello"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTrophy(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTrophy"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTruck(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTruck"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTumblr(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTumblr"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTumblr2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTumblr2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTux(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTux"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTv(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTv"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImTwitch(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTwitch"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M1.5 0l-1.5 2.5v11.5h4v2h2l2-2h2.5l4.5-4.5v-9.5h-13.5zM13 8.5l-2.5 2.5h-2.5l-2 2v-2h-3v-9h10v6.5z"
        /> < path fill = "#000000" d = "M9.5 4h1.5v4h-1.5v-4z" /> < path fill = "#000000"
        d = "M6.5 4h1.5v4h-1.5v-4z" /> < / svg >
    }
}
...
pub fn ImTwitter(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImTwitter"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUnderline(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUnderline"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUndo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUndo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUndo2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUndo2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.904 16c1.777-3.219 2.076-8.13-4.904-7.966v3.966l-6-6 6-6v3.881c8.359-0.218 9.29 7.378 4.904 12.119z"
        /> < / svg >
    }
}
...
pub fn ImUngroup(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUngroup"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        /> < path fill = "#000000" d = "M0 12h1v2h-1v-2z" /> < path fill = "#000000" d =
        "M0 9h1v2h-1v-2z" /> < path fill = "#000000" d = "M13 7h1v2h-1v-2z" /> < path
        fill = "#000000" d = "M13 13h1v2h-1v-2z" /> < path fill = "#000000" d =
        "M13 10h1v2h-1v-2z" /> < path fill = "#000000" d = "M0 6h1v2h-1v-2z" /> < path
        fill = "#000000" d = "M0 3h1v2h-1v-2z" /> < path fill = "#000000" d =
        "M8 2h2v1h-2v-1z" /> < path fill = "#000000" d = "M5 2h2v1h-2v-1z" /> < path fill
        = "#000000" d = "M2 2h2v1h-2v-1z" /> < path fill = "#000000" d =
        "M7 15h2v1h-2v-1z" /> < path fill = "#000000" d = "M10 15h2v1h-2v-1z" /> < path
        fill = "#000000" d = "M4 15h2v1h-2v-1z" /> < path fill = "#000000" d =
        "M1 15h2v1h-2v-1z" /> < / svg >
    }
}
...
pub fn ImUnlocked(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUnlocked"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M12 1c1.654 0 3 1.346 3 3v3h-2v-3c0-0.551-0.449-1-1-1h-2c-0.551 0-1 0.449-1 1v3h0.25c0.412 0 0.75 0.338 0.75 0.75v7.5c0 0.412-0.338 0.75-0.75 0.75h-8.5c-0.412 0-0.75-0.338-0.75-0.75v-7.5c0-0.412 0.338-0.75 0.75-0.75h6.25v-3c0-1.654 1.346-3 3-3h2z"
        /> < / svg >
    }
}
...
pub fn ImUpload(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUpload"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M7 9h2v-4h3l-4-4-4 4h3zM10 6.75v1.542l4.579 1.708-6.579 2.453-6.579-2.453 4.579-1.708v-1.542l-6 2.25v4l8 3 8-3v-4z"
        /> < / svg >
    }
}
...
pub fn ImUpload2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUpload2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M0 14h16v1h-16zM16 12v1h-16v-1l2-4h4v2h4v-2h4zM3.5 5l4.5-4.5 4.5 4.5h-3.5v4h-2v-4z"
        /> < / svg >
    }
}
...
pub fn ImUpload3(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUpload3"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUser(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUser"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUserCheck(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUserCheck"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15 9.5l-4.5 4.5-1.5-1.5-1 1 2.5 2.5 5.5-5.5z" /> < path fill = "#000000" d =
        "M7 12h5v-1.799c-1.050-0.613-2.442-1.033-4-1.16v-0.825c1.102-0.621 2-2.168 2-3.716 0-2.485 0-4.5-3-4.5s-3 2.015-3 4.5c0 1.548 0.898 3.095 2 3.716v0.825c-3.392 0.277-6 1.944-6 3.959h7v-1z"
        /> < / svg >
    }
}
...
pub fn ImUserMinus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUserMinus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImUserPlus(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUserPlus"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        "M6 11.5c0-2.363 1.498-4.383 3.594-5.159 0.254-0.571 0.406-1.206 0.406-1.841 0-2.485 0-4.5-3-4.5s-3 2.015-3 4.5c0 1.548 0.898 3.095 2 3.716v0.825c-3.392 0.277-6 1.944-6 3.959h6.208c-0.135-0.477-0.208-0.98-0.208-1.5z"
        /> < path fill = "#000000" d =
        "M11.5 7c-2.485 0-4.5 2.015-4.5 4.5s2.015 4.5 4.5 4.5c2.485 0 4.5-2.015 4.5-4.5s-2.015-4.5-4.5-4.5zM14 12h-2v2h-1v-2h-2v-1h2v-2h1v2h2v1z"
        /> < / svg >
    }
}
...
pub fn ImUserTie(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUserTie"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M5 3c0-1.657 1.343-3 3-3s3 1.343 3 3c0 1.657-1.343 3-3 3s-3-1.343-3-3zM12.001 7h-0.553l-3.111 6.316 1.163-5.816-1.5-1.5-1.5 1.5 1.163 5.816-3.111-6.316h-0.554c-1.999 0-1.999 1.344-1.999 3v5h12v-5c0-1.656 0-3-1.999-3z"
        /> < / svg >
    }
}
#[cfg(feature = "ImUsers")]
...
pub fn ImUsers(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImUsers"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVideoCamera(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVideoCamera"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVimeo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVimeo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVimeo2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVimeo2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVine(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVine"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVk(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVk"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVolumeDecrease(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeDecrease"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d = "M8 7h8v2h-8v-2z" /> <
        path fill = "#000000" d =
...
pub fn ImVolumeHigh(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeHigh"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVolumeIncrease(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeIncrease"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M16 9h-3v3h-2v-3h-3v-2h3v-3h2v3h3v2z" /> < path fill = "#000000" d =
        "M6.5 15c-0.13 0-0.258-0.051-0.354-0.146l-3.854-3.854h-1.793c-0.276 0-0.5-0.224-0.5-0.5v-5c0-0.276 0.224-0.5 0.5-0.5h1.793l3.854-3.854c0.143-0.143 0.358-0.186 0.545-0.108s0.309 0.26 0.309 0.462v13c0 0.202-0.122 0.385-0.309 0.462-0.062 0.026-0.127 0.038-0.191 0.038z"
        /> < / svg >
    }
}
...
pub fn ImVolumeLow(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeLow"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVolumeMedium(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeMedium"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M11.243 12.993c-0.192 0-0.384-0.073-0.53-0.22-0.293-0.293-0.293-0.768 0-1.061 2.047-2.047 2.047-5.378 0-7.425-0.293-0.293-0.293-0.768 0-1.061s0.768-0.293 1.061 0c1.275 1.275 1.977 2.97 1.977 4.773s-0.702 3.498-1.977 4.773c-0.146 0.146-0.338 0.22-0.53 0.22v0zM8.578 11.578c-0.192 0-0.384-0.073-0.53-0.22-0.293-0.293-0.293-0.768 0-1.061 1.267-1.267 1.267-3.329 0-4.596-0.293-0.293-0.293-0.768 0-1.061s0.768-0.293 1.061 0c1.852 1.852 1.852 4.865 0 6.718-0.146 0.146-0.338 0.22-0.53 0.22z"
        /> < path fill = "#000000" d =
        "M6.5 15c-0.13 0-0.258-0.051-0.354-0.146l-3.854-3.854h-1.793c-0.276 0-0.5-0.224-0.5-0.5v-5c0-0.276 0.224-0.5 0.5-0.5h1.793l3.854-3.854c0.143-0.143 0.358-0.186 0.545-0.108s0.309 0.26 0.309 0.462v13c0 0.202-0.122 0.385-0.309 0.462-0.062 0.026-0.127 0.038-0.191 0.038z"
        /> < / svg >
    }
...
pub fn ImVolumeMute(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeMute"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImVolumeMute2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImVolumeMute2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWarning(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWarning"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 1.45l6.705 13.363h-13.409l6.705-13.363zM8 0c-0.345 0-0.69 0.233-0.951 0.698l-6.829 13.611c-0.523 0.93-0.078 1.691 0.989 1.691h13.583c1.067 0 1.512-0.761 0.989-1.691h0l-6.829-13.611c-0.262-0.465-0.606-0.698-0.951-0.698v0z"
        /> < path fill = "#000000" d =
        "M9 13c0 0.552-0.448 1-1 1s-1-0.448-1-1c0-0.552 0.448-1 1-1s1 0.448 1 1z" /> <
        path fill = "#000000" d =
        "M8 11c-0.552 0-1-0.448-1-1v-3c0-0.552 0.448-1 1-1s1 0.448 1 1v3c0 0.552-0.448 1-1 1z"
        /> < / svg >
    }
}
...
pub fn ImWhatsapp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWhatsapp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWikipedia(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWikipedia"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWindows(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWindows"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWindows8(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWindows8"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWink(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWink"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWink2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWink2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWoman(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWoman"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        ...
        "M9 1.5c0 0.828-0.672 1.5-1.5 1.5s-1.5-0.672-1.5-1.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5z"
        /> < path fill = "#000000" d =
        "M11.234 8l0.766-0.555-2.083-3.221c-0.092-0.14-0.249-0.225-0.417-0.225h-4c-0.168 0-0.325 0.084-0.417 0.225l-2.083 3.221 0.766 0.555 1.729-2.244 0.601 1.402-2.095 3.841h1.917l0.333 5h1v-5h0.5v5h1l0.333-5h1.917l-2.095-3.842 0.601-1.402 1.729 2.244z"
        /> < / svg >
    }
}
...
pub fn ImWondering(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWondering"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWondering2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWondering2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM11 4c0.552 0 1 0.448 1 1s-0.448 1-1 1-1-0.448-1-1 0.448-1 1-1zM4 5c0-0.552 0.448-1 1-1s1 0.448 1 1-0.448 1-1 1-1-0.448-1-1zM5.176 12.6l-0.351-1.2 6.828-2 0.351 1.2-6.828 2z"
        /> < / svg >
    }
}
...
pub fn ImWordpress(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWordpress"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImWrench(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImWrench"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 16 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
        "M15.671 12.779l-7.196-6.168c0.335-0.63 0.525-1.348 0.525-2.111 0-2.485-2.015-4.5-4.5-4.5-0.455 0-0.893 0.068-1.307 0.193l2.6 2.6c0.389 0.389 0.389 1.025 0 1.414l-1.586 1.586c-0.389 0.389-1.025 0.389-1.414 0l-2.6-2.6c-0.125 0.414-0.193 0.852-0.193 1.307 0 2.485 2.015 4.5 4.5 4.5 0.763 0 1.482-0.19 2.111-0.525l6.168 7.196c0.358 0.418 0.969 0.441 1.358 0.052l1.586-1.586c0.389-0.389 0.365-1-0.052-1.358z"
        /> < / svg >
    }
}
#[cfg(feature = "ImXing")]
...
pub fn ImXing(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImXing"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImXing2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImXing2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImYahoo(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImYahoo"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImYahoo2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImYahoo2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImYelp(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImYelp"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImYoutube(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImYoutube"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
...
pub fn ImYoutube2(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImYoutube2"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
        height viewBox = "0 0 40 16" fill = "currentColor" role = "graphics-symbol" > <
        title > { title } < / title > < path fill = "#000000" d =
...
pub fn ImZoomIn(
    ...
    style: String,
    /// ARIA accessibility title.
    #[prop(into, optional, default = String::from("ImZoomIn"))]
    title: String,
) -> impl IntoView {
    view! {
        cx, < svg class = class style = format!(" {}", style) width = width height =
