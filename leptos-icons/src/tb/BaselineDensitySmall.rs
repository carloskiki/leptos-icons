#[cfg(feature = "TbBaselineDensitySmall")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "TbBaselineDensitySmall")]
/// *This icon requires the feature* `TbBaselineDensitySmall` *to be enabled*.
#[component]
pub fn BaselineDensitySmall(cx: Scope) -> impl IntoView {
   view! { cx,
