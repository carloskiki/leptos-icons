#[cfg(feature = "TbBaselineDensityMedium")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "TbBaselineDensityMedium")]
/// *This icon requires the feature* `TbBaselineDensityMedium` *to be enabled*.
#[component]
pub fn BaselineDensityMedium(cx: Scope) -> impl IntoView {
   view! { cx,
