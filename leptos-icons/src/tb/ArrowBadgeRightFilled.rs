#[cfg(feature = "TbArrowBadgeRightFilled")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "TbArrowBadgeRightFilled")]
/// *This icon requires the feature* `TbArrowBadgeRightFilled` *to be enabled*.
#[component]
pub fn ArrowBadgeRightFilled(cx: Scope) -> impl IntoView {
   view! { cx,
