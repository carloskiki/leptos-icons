#[cfg(feature = "FaSolidUsersBetweenLines")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidUsersBetweenLines")]
/// *This icon requires the feature* `FaSolidUsersBetweenLines` *to be enabled*.
#[component]
pub fn UsersBetweenLines(cx: Scope) -> impl IntoView {
   view! { cx,
