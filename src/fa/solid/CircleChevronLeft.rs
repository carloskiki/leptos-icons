#[cfg(feature = "FaSolidCircleChevronLeft")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidCircleChevronLeft")]
/// *This icon requires the feature* `FaSolidCircleChevronLeft` *to be enabled*.
#[component]
pub fn CircleChevronLeft(cx: Scope) -> impl IntoView {
   view! { cx,
