#[cfg(feature = "FaSolidHeartCircleExclamation")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidHeartCircleExclamation")]
/// *This icon requires the feature* `FaSolidHeartCircleExclamation` *to be enabled*.
#[component]
pub fn HeartCircleExclamation(cx: Scope) -> impl IntoView {
   view! { cx,
