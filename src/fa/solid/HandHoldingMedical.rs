#[cfg(feature = "FaSolidHandHoldingMedical")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidHandHoldingMedical")]
/// *This icon requires the feature* `FaSolidHandHoldingMedical` *to be enabled*.
#[component]
pub fn HandHoldingMedical(cx: Scope) -> impl IntoView {
   view! { cx,
