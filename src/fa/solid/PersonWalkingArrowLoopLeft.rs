#[cfg(feature = "FaSolidPersonWalkingArrowLoopLeft")]
use leptos::*;
#[cfg(feature = "FaSolidPersonWalkingArrowLoopLeft")]
///This icon requires the feature `FaSolidPersonWalkingArrowLoopLeft` to be enabled.
#[component]
pub fn PersonWalkingArrowLoopLeft(
    cx: Scope,
