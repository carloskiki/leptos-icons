#[cfg(feature = "FaSolidClipboardQuestion")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidClipboardQuestion")]
/// *This icon requires the feature* `FaSolidClipboardQuestion` *to be enabled*.
#[component]
pub fn ClipboardQuestion(cx: Scope) -> impl IntoView {
   view! { cx,
