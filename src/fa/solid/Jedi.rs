#[cfg(feature = "FaSolidJedi")]
use leptos::*;
#[cfg(feature = "FaSolidJedi")]
///This icon requires the feature `FaSolidJedi` to be enabled.
#[component]
pub fn Jedi(
    cx: Scope,
