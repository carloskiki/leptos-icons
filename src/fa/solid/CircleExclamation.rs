#[cfg(feature = "FaSolidCircleExclamation")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidCircleExclamation")]
/// *This icon requires the feature* `FaSolidCircleExclamation` *to be enabled*.
#[component]
pub fn CircleExclamation(cx: Scope) -> impl IntoView {
   view! { cx,
