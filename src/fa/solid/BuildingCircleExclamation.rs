#[cfg(feature = "FaSolidBuildingCircleExclamation")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidBuildingCircleExclamation")]
/// *This icon requires the feature* `FaSolidBuildingCircleExclamation` *to be enabled*.
#[component]
pub fn BuildingCircleExclamation(cx: Scope) -> impl IntoView {
   view! { cx,
