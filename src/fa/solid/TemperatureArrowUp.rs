#[cfg(feature = "FaSolidTemperatureArrowUp")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidTemperatureArrowUp")]
/// *This icon requires the feature* `FaSolidTemperatureArrowUp` *to be enabled*.
#[component]
pub fn TemperatureArrowUp(cx: Scope) -> impl IntoView {
   view! { cx,
