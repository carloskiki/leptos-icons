#[cfg(feature = "FaSolidBuildingCircleArrowRight")]
use leptos::*;
#[cfg(feature = "FaSolidBuildingCircleArrowRight")]
///This icon requires the feature `FaSolidBuildingCircleArrowRight` to be enabled.
#[component]
pub fn BuildingCircleArrowRight(
    cx: Scope,
