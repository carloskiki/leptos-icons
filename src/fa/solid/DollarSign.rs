#[cfg(feature = "FaSolidDollarSign")]
use leptos::*;
#[cfg(feature = "FaSolidDollarSign")]
///This icon requires the feature `FaSolidDollarSign` to be enabled.
#[component]
pub fn DollarSign(
    cx: Scope,
