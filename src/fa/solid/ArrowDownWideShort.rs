#[cfg(feature = "FaSolidArrowDownWideShort")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowDownWideShort")]
/// *This icon requires the feature* `FaSolidArrowDownWideShort` *to be enabled*.
#[component]
pub fn ArrowDownWideShort(cx: Scope) -> impl IntoView {
   view! { cx,
