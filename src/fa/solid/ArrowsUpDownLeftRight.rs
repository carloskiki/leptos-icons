#[cfg(feature = "FaSolidArrowsUpDownLeftRight")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowsUpDownLeftRight")]
/// *This icon requires the feature* `FaSolidArrowsUpDownLeftRight` *to be enabled*.
#[component]
pub fn ArrowsUpDownLeftRight(cx: Scope) -> impl IntoView {
   view! { cx,
