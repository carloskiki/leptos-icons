#[cfg(feature = "FaSolidFileCircleExclamation")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidFileCircleExclamation")]
/// *This icon requires the feature* `FaSolidFileCircleExclamation` *to be enabled*.
#[component]
pub fn FileCircleExclamation(cx: Scope) -> impl IntoView {
   view! { cx,
