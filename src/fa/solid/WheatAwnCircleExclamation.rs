#[cfg(feature = "FaSolidWheatAwnCircleExclamation")]
use leptos::*;
#[cfg(feature = "FaSolidWheatAwnCircleExclamation")]
///This icon requires the feature `FaSolidWheatAwnCircleExclamation` to be enabled.
#[component]
pub fn WheatAwnCircleExclamation(
    cx: Scope,
