#[cfg(feature = "FaSolidArrowDownShortWide")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowDownShortWide")]
/// *This icon requires the feature* `FaSolidArrowDownShortWide` *to be enabled*.
#[component]
pub fn ArrowDownShortWide(cx: Scope) -> impl IntoView {
   view! { cx,
