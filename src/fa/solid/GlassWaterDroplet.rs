#[cfg(feature = "FaSolidGlassWaterDroplet")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidGlassWaterDroplet")]
/// *This icon requires the feature* `FaSolidGlassWaterDroplet` *to be enabled*.
#[component]
pub fn GlassWaterDroplet(cx: Scope) -> impl IntoView {
   view! { cx,
