#[cfg(feature = "FaSolidStarOfDavid")]
use leptos::*;
#[cfg(feature = "FaSolidStarOfDavid")]
///This icon requires the feature `FaSolidStarOfDavid` to be enabled.
#[component]
pub fn StarOfDavid(
    cx: Scope,
