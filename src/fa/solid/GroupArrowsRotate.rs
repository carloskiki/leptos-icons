#[cfg(feature = "FaSolidGroupArrowsRotate")]
use leptos::*;
#[cfg(feature = "FaSolidGroupArrowsRotate")]
///This icon requires the feature `FaSolidGroupArrowsRotate` to be enabled.
#[component]
pub fn GroupArrowsRotate(
    cx: Scope,
