#[cfg(feature = "FaSolidMoneyBillTransfer")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidMoneyBillTransfer")]
/// *This icon requires the feature* `FaSolidMoneyBillTransfer` *to be enabled*.
#[component]
pub fn MoneyBillTransfer(cx: Scope) -> impl IntoView {
   view! { cx,
