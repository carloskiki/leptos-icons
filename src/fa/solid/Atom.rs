#[cfg(feature = "FaSolidAtom")]
use leptos::*;
#[cfg(feature = "FaSolidAtom")]
///This icon requires the feature `FaSolidAtom` to be enabled.
#[component]
pub fn Atom(
    cx: Scope,
