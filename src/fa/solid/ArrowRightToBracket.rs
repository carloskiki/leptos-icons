#[cfg(feature = "FaSolidArrowRightToBracket")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowRightToBracket")]
/// *This icon requires the feature* `FaSolidArrowRightToBracket` *to be enabled*.
#[component]
pub fn ArrowRightToBracket(cx: Scope) -> impl IntoView {
   view! { cx,
