#[cfg(feature = "FaSolidArrowsDownToPeople")]
use leptos::*;
#[cfg(feature = "FaSolidArrowsDownToPeople")]
///This icon requires the feature `FaSolidArrowsDownToPeople` to be enabled.
#[component]
pub fn ArrowsDownToPeople(
    cx: Scope,
