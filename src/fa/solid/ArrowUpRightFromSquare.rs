#[cfg(feature = "FaSolidArrowUpRightFromSquare")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowUpRightFromSquare")]
/// *This icon requires the feature* `FaSolidArrowUpRightFromSquare` *to be enabled*.
#[component]
pub fn ArrowUpRightFromSquare(cx: Scope) -> impl IntoView {
   view! { cx,
