#[cfg(feature = "FaSolidUpRightFromSquare")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidUpRightFromSquare")]
/// *This icon requires the feature* `FaSolidUpRightFromSquare` *to be enabled*.
#[component]
pub fn UpRightFromSquare(cx: Scope) -> impl IntoView {
   view! { cx,
