#[cfg(feature = "FaSolidHouseChimneyWindow")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidHouseChimneyWindow")]
/// *This icon requires the feature* `FaSolidHouseChimneyWindow` *to be enabled*.
#[component]
pub fn HouseChimneyWindow(cx: Scope) -> impl IntoView {
   view! { cx,
