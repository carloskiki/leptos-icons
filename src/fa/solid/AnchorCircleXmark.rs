#[cfg(feature = "FaSolidAnchorCircleXmark")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidAnchorCircleXmark")]
/// *This icon requires the feature* `FaSolidAnchorCircleXmark` *to be enabled*.
#[component]
pub fn AnchorCircleXmark(cx: Scope) -> impl IntoView {
   view! { cx,
