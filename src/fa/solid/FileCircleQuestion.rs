#[cfg(feature = "FaSolidFileCircleQuestion")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidFileCircleQuestion")]
/// *This icon requires the feature* `FaSolidFileCircleQuestion` *to be enabled*.
#[component]
pub fn FileCircleQuestion(cx: Scope) -> impl IntoView {
   view! { cx,
