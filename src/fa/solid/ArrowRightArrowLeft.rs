#[cfg(feature = "FaSolidArrowRightArrowLeft")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowRightArrowLeft")]
/// *This icon requires the feature* `FaSolidArrowRightArrowLeft` *to be enabled*.
#[component]
pub fn ArrowRightArrowLeft(cx: Scope) -> impl IntoView {
   view! { cx,
