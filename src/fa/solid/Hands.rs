#[cfg(feature = "FaSolidHands")]
use leptos::*;
#[cfg(feature = "FaSolidHands")]
///This icon requires the feature `FaSolidHands` to be enabled.
#[component]
pub fn Hands(
    cx: Scope,
