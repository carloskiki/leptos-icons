#[cfg(feature = "FaSolidKhanda")]
use leptos::*;
#[cfg(feature = "FaSolidKhanda")]
///This icon requires the feature `FaSolidKhanda` to be enabled.
#[component]
pub fn Khanda(
    cx: Scope,
