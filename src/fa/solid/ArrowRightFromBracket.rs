#[cfg(feature = "FaSolidArrowRightFromBracket")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidArrowRightFromBracket")]
/// *This icon requires the feature* `FaSolidArrowRightFromBracket` *to be enabled*.
#[component]
pub fn ArrowRightFromBracket(cx: Scope) -> impl IntoView {
   view! { cx,
