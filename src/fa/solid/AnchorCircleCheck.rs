#[cfg(feature = "FaSolidAnchorCircleCheck")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidAnchorCircleCheck")]
/// *This icon requires the feature* `FaSolidAnchorCircleCheck` *to be enabled*.
#[component]
pub fn AnchorCircleCheck(cx: Scope) -> impl IntoView {
   view! { cx,
