#[cfg(feature = "FaSolidCircleChevronRight")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidCircleChevronRight")]
/// *This icon requires the feature* `FaSolidCircleChevronRight` *to be enabled*.
#[component]
pub fn CircleChevronRight(cx: Scope) -> impl IntoView {
   view! { cx,
