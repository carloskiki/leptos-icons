#[cfg(feature = "FaSolidHandsBubbles")]
use leptos::*;
#[cfg(feature = "FaSolidHandsBubbles")]
///This icon requires the feature `FaSolidHandsBubbles` to be enabled.
#[component]
pub fn HandsBubbles(
    cx: Scope,
