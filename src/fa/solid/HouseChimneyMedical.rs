#[cfg(feature = "FaSolidHouseChimneyMedical")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaSolidHouseChimneyMedical")]
/// *This icon requires the feature* `FaSolidHouseChimneyMedical` *to be enabled*.
#[component]
pub fn HouseChimneyMedical(cx: Scope) -> impl IntoView {
   view! { cx,
