#[cfg(feature = "FaRegularLightbulb")]
use leptos::*;
#[cfg(feature = "FaRegularLightbulb")]
///This icon requires the feature `FaRegularLightbulb` to be enabled.
#[component]
pub fn Lightbulb(
    cx: Scope,
