#[cfg(feature = "FaRegularHandScissors")]
use leptos::*;
#[cfg(feature = "FaRegularHandScissors")]
///This icon requires the feature `FaRegularHandScissors` to be enabled.
#[component]
pub fn HandScissors(
    cx: Scope,
