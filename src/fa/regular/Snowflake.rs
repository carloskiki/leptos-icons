#[cfg(feature = "FaRegularSnowflake")]
use leptos::*;
#[cfg(feature = "FaRegularSnowflake")]
///This icon requires the feature `FaRegularSnowflake` to be enabled.
#[component]
pub fn Snowflake(
    cx: Scope,
