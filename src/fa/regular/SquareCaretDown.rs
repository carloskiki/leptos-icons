#[cfg(feature = "FaRegularSquareCaretDown")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaRegularSquareCaretDown")]
/// *This icon requires the feature* `FaRegularSquareCaretDown` *to be enabled*.
#[component]
pub fn SquareCaretDown(cx: Scope) -> impl IntoView {
   view! { cx,
