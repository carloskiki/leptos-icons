#[cfg(feature = "FaRegularHandPeace")]
use leptos::*;
#[cfg(feature = "FaRegularHandPeace")]
///This icon requires the feature `FaRegularHandPeace` to be enabled.
#[component]
pub fn HandPeace(
    cx: Scope,
