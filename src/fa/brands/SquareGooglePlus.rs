#[cfg(feature = "FaBrandsSquareGooglePlus")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaBrandsSquareGooglePlus")]
/// *This icon requires the feature* `FaBrandsSquareGooglePlus` *to be enabled*.
#[component]
pub fn SquareGooglePlus(cx: Scope) -> impl IntoView {
   view! { cx,
