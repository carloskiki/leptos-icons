#[cfg(feature = "FaBrandsCreativeCommonsPd")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaBrandsCreativeCommonsPd")]
/// *This icon requires the feature* `FaBrandsCreativeCommonsPd` *to be enabled*.
#[component]
pub fn CreativeCommonsPd(cx: Scope) -> impl IntoView {
   view! { cx,
