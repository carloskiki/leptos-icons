#[cfg(feature = "FaBrandsCreativeCommonsNcJp")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaBrandsCreativeCommonsNcJp")]
/// *This icon requires the feature* `FaBrandsCreativeCommonsNcJp` *to be enabled*.
#[component]
pub fn CreativeCommonsNcJp(cx: Scope) -> impl IntoView {
   view! { cx,
