#[cfg(feature = "FaBrandsSearchengin")]
use leptos::*;
#[cfg(feature = "FaBrandsSearchengin")]
///This icon requires the feature `FaBrandsSearchengin` to be enabled.
#[component]
pub fn Searchengin(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style viewBox = "0 0 460 512" width = size.clone()
