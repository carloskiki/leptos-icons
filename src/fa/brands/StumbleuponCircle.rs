#[cfg(feature = "FaBrandsStumbleuponCircle")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaBrandsStumbleuponCircle")]
/// *This icon requires the feature* `FaBrandsStumbleuponCircle` *to be enabled*.
#[component]
pub fn StumbleuponCircle(cx: Scope) -> impl IntoView {
   view! { cx,
