#[cfg(feature = "FaBrandsSquareHackerNews")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "FaBrandsSquareHackerNews")]
/// *This icon requires the feature* `FaBrandsSquareHackerNews` *to be enabled*.
#[component]
pub fn SquareHackerNews(cx: Scope) -> impl IntoView {
   view! { cx,
