#[cfg(feature = "FaBrandsDropbox")]
use leptos::*;
#[cfg(feature = "FaBrandsDropbox")]
///This icon requires the feature `FaBrandsDropbox` to be enabled.
#[component]
pub fn Dropbox(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style viewBox = "0 0 528 512" width = { size.clone() }
