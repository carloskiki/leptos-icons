#[cfg(feature = "FaBrandsCloudsmith")]
use leptos::*;
#[cfg(feature = "FaBrandsCloudsmith")]
///This icon requires the feature `FaBrandsCloudsmith` to be enabled.
#[component]
pub fn Cloudsmith(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style viewBox = "0 0 332 512" width = { size.clone() }
