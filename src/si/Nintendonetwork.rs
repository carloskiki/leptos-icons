#[cfg(feature = "SiNintendonetwork")]
use leptos::*;
#[cfg(feature = "SiNintendonetwork")]
///This icon requires the feature `SiNintendonetwork` to be enabled.
#[component]
pub fn Nintendonetwork(
    cx: Scope,
