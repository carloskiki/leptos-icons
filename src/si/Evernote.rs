#[cfg(feature = "SiEvernote")]
use leptos::*;
#[cfg(feature = "SiEvernote")]
///This icon requires the feature `SiEvernote` to be enabled.
#[component]
pub fn Evernote(
    cx: Scope,
