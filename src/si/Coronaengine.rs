#[cfg(feature = "SiCoronaengine")]
use leptos::*;
#[cfg(feature = "SiCoronaengine")]
///This icon requires the feature `SiCoronaengine` to be enabled.
#[component]
pub fn Coronaengine(
    cx: Scope,
