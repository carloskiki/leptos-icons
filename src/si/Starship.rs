#[cfg(feature = "SiStarship")]
use leptos::*;
#[cfg(feature = "SiStarship")]
///This icon requires the feature `SiStarship` to be enabled.
#[component]
pub fn Starship(
    cx: Scope,
