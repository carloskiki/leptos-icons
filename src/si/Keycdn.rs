#[cfg(feature = "SiKeycdn")]
use leptos::*;
#[cfg(feature = "SiKeycdn")]
///This icon requires the feature `SiKeycdn` to be enabled.
#[component]
pub fn Keycdn(
    cx: Scope,
