#[cfg(feature = "SiP5dotjs")]
use leptos::*;
#[cfg(feature = "SiP5dotjs")]
///This icon requires the feature `SiP5dotjs` to be enabled.
#[component]
pub fn P5dotjs(
    cx: Scope,
