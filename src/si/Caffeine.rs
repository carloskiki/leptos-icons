#[cfg(feature = "SiCaffeine")]
use leptos::*;
#[cfg(feature = "SiCaffeine")]
///This icon requires the feature `SiCaffeine` to be enabled.
#[component]
pub fn Caffeine(
    cx: Scope,
