#[cfg(feature = "SiTeespring")]
use leptos::*;
#[cfg(feature = "SiTeespring")]
///This icon requires the feature `SiTeespring` to be enabled.
#[component]
pub fn Teespring(
    cx: Scope,
