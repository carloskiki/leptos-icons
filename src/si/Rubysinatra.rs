#[cfg(feature = "SiRubysinatra")]
use leptos::*;
#[cfg(feature = "SiRubysinatra")]
///This icon requires the feature `SiRubysinatra` to be enabled.
#[component]
pub fn Rubysinatra(
    cx: Scope,
