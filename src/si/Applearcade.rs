#[cfg(feature = "SiApplearcade")]
use leptos::*;
#[cfg(feature = "SiApplearcade")]
///This icon requires the feature `SiApplearcade` to be enabled.
#[component]
pub fn Applearcade(
    cx: Scope,
