#[cfg(feature = "SiHitachi")]
use leptos::*;
#[cfg(feature = "SiHitachi")]
///This icon requires the feature `SiHitachi` to be enabled.
#[component]
pub fn Hitachi(
    cx: Scope,
