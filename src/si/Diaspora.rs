#[cfg(feature = "SiDiaspora")]
use leptos::*;
#[cfg(feature = "SiDiaspora")]
///This icon requires the feature `SiDiaspora` to be enabled.
#[component]
pub fn Diaspora(
    cx: Scope,
