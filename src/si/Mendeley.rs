#[cfg(feature = "SiMendeley")]
use leptos::*;
#[cfg(feature = "SiMendeley")]
///This icon requires the feature `SiMendeley` to be enabled.
#[component]
pub fn Mendeley(
    cx: Scope,
