#[cfg(feature = "SiNintendo3ds")]
use leptos::*;
#[cfg(feature = "SiNintendo3ds")]
///This icon requires the feature `SiNintendo3ds` to be enabled.
#[component]
pub fn Nintendo3ds(
    cx: Scope,
