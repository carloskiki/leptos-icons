#[cfg(feature = "SiPhpmyadmin")]
use leptos::*;
#[cfg(feature = "SiPhpmyadmin")]
///This icon requires the feature `SiPhpmyadmin` to be enabled.
#[component]
pub fn Phpmyadmin(
    cx: Scope,
