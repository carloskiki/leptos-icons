#[cfg(feature = "SiMicrosoftexchange")]
use leptos::*;
#[cfg(feature = "SiMicrosoftexchange")]
///This icon requires the feature `SiMicrosoftexchange` to be enabled.
#[component]
pub fn Microsoftexchange(
    cx: Scope,
