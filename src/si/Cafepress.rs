#[cfg(feature = "SiCafepress")]
use leptos::*;
#[cfg(feature = "SiCafepress")]
///This icon requires the feature `SiCafepress` to be enabled.
#[component]
pub fn Cafepress(
    cx: Scope,
