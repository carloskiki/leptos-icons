#[cfg(feature = "SiMdbook")]
use leptos::*;
#[cfg(feature = "SiMdbook")]
///This icon requires the feature `SiMdbook` to be enabled.
#[component]
pub fn Mdbook(
    cx: Scope,
