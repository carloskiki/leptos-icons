#[cfg(feature = "SiCodeproject")]
use leptos::*;
#[cfg(feature = "SiCodeproject")]
///This icon requires the feature `SiCodeproject` to be enabled.
#[component]
pub fn Codeproject(
    cx: Scope,
