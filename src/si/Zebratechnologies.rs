#[cfg(feature = "SiZebratechnologies")]
use leptos::*;
#[cfg(feature = "SiZebratechnologies")]
///This icon requires the feature `SiZebratechnologies` to be enabled.
#[component]
pub fn Zebratechnologies(
    cx: Scope,
