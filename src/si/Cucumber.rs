#[cfg(feature = "SiCucumber")]
use leptos::*;
#[cfg(feature = "SiCucumber")]
///This icon requires the feature `SiCucumber` to be enabled.
#[component]
pub fn Cucumber(
    cx: Scope,
