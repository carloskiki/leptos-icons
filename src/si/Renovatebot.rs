#[cfg(feature = "SiRenovatebot")]
use leptos::*;
#[cfg(feature = "SiRenovatebot")]
///This icon requires the feature `SiRenovatebot` to be enabled.
#[component]
pub fn Renovatebot(
    cx: Scope,
