#[cfg(feature = "SiFerrarinv")]
use leptos::*;
#[cfg(feature = "SiFerrarinv")]
///This icon requires the feature `SiFerrarinv` to be enabled.
#[component]
pub fn Ferrarinv(
    cx: Scope,
