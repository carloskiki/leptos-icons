#[cfg(feature = "SiOctave")]
use leptos::*;
#[cfg(feature = "SiOctave")]
///This icon requires the feature `SiOctave` to be enabled.
#[component]
pub fn Octave(
    cx: Scope,
