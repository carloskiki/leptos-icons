#[cfg(feature = "SiBankofamerica")]
use leptos::*;
#[cfg(feature = "SiBankofamerica")]
///This icon requires the feature `SiBankofamerica` to be enabled.
#[component]
pub fn Bankofamerica(
    cx: Scope,
