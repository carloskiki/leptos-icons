#[cfg(feature = "SiJordan")]
use leptos::*;
#[cfg(feature = "SiJordan")]
///This icon requires the feature `SiJordan` to be enabled.
#[component]
pub fn Jordan(
    cx: Scope,
