#[cfg(feature = "SiTaxbuzz")]
use leptos::*;
#[cfg(feature = "SiTaxbuzz")]
///This icon requires the feature `SiTaxbuzz` to be enabled.
#[component]
pub fn Taxbuzz(
    cx: Scope,
