#[cfg(feature = "SiMakerbot")]
use leptos::*;
#[cfg(feature = "SiMakerbot")]
///This icon requires the feature `SiMakerbot` to be enabled.
#[component]
pub fn Makerbot(
    cx: Scope,
