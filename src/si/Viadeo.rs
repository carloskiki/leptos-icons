#[cfg(feature = "SiViadeo")]
use leptos::*;
#[cfg(feature = "SiViadeo")]
///This icon requires the feature `SiViadeo` to be enabled.
#[component]
pub fn Viadeo(
    cx: Scope,
