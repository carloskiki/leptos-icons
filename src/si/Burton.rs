#[cfg(feature = "SiBurton")]
use leptos::*;
#[cfg(feature = "SiBurton")]
///This icon requires the feature `SiBurton` to be enabled.
#[component]
pub fn Burton(
    cx: Scope,
