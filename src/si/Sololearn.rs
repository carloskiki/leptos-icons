#[cfg(feature = "SiSololearn")]
use leptos::*;
#[cfg(feature = "SiSololearn")]
///This icon requires the feature `SiSololearn` to be enabled.
#[component]
pub fn Sololearn(
    cx: Scope,
