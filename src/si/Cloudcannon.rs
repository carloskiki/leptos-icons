#[cfg(feature = "SiCloudcannon")]
use leptos::*;
#[cfg(feature = "SiCloudcannon")]
///This icon requires the feature `SiCloudcannon` to be enabled.
#[component]
pub fn Cloudcannon(
    cx: Scope,
