#[cfg(feature = "SiPelican")]
use leptos::*;
#[cfg(feature = "SiPelican")]
///This icon requires the feature `SiPelican` to be enabled.
#[component]
pub fn Pelican(
    cx: Scope,
