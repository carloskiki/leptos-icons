#[cfg(feature = "SiVulkan")]
use leptos::*;
#[cfg(feature = "SiVulkan")]
///This icon requires the feature `SiVulkan` to be enabled.
#[component]
pub fn Vulkan(
    cx: Scope,
