#[cfg(feature = "SiSequelize")]
use leptos::*;
#[cfg(feature = "SiSequelize")]
///This icon requires the feature `SiSequelize` to be enabled.
#[component]
pub fn Sequelize(
    cx: Scope,
