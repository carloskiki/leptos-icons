#[cfg(feature = "SiLiberapay")]
use leptos::*;
#[cfg(feature = "SiLiberapay")]
///This icon requires the feature `SiLiberapay` to be enabled.
#[component]
pub fn Liberapay(
    cx: Scope,
