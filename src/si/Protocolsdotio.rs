#[cfg(feature = "SiProtocolsdotio")]
use leptos::*;
#[cfg(feature = "SiProtocolsdotio")]
///This icon requires the feature `SiProtocolsdotio` to be enabled.
#[component]
pub fn Protocolsdotio(
    cx: Scope,
