#[cfg(feature = "SiReactos")]
use leptos::*;
#[cfg(feature = "SiReactos")]
///This icon requires the feature `SiReactos` to be enabled.
#[component]
pub fn Reactos(
    cx: Scope,
