#[cfg(feature = "SiBigbasket")]
use leptos::*;
#[cfg(feature = "SiBigbasket")]
///This icon requires the feature `SiBigbasket` to be enabled.
#[component]
pub fn Bigbasket(
    cx: Scope,
