#[cfg(feature = "SiKonami")]
use leptos::*;
#[cfg(feature = "SiKonami")]
///This icon requires the feature `SiKonami` to be enabled.
#[component]
pub fn Konami(
    cx: Scope,
