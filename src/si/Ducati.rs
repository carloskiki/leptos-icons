#[cfg(feature = "SiDucati")]
use leptos::*;
#[cfg(feature = "SiDucati")]
///This icon requires the feature `SiDucati` to be enabled.
#[component]
pub fn Ducati(
    cx: Scope,
