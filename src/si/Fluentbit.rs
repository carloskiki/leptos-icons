#[cfg(feature = "SiFluentbit")]
use leptos::*;
#[cfg(feature = "SiFluentbit")]
///This icon requires the feature `SiFluentbit` to be enabled.
#[component]
pub fn Fluentbit(
    cx: Scope,
