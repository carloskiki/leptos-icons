#[cfg(feature = "SiActigraph")]
use leptos::*;
#[cfg(feature = "SiActigraph")]
///This icon requires the feature `SiActigraph` to be enabled.
#[component]
pub fn Actigraph(
    cx: Scope,
