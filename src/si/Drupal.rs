#[cfg(feature = "SiDrupal")]
use leptos::*;
#[cfg(feature = "SiDrupal")]
///This icon requires the feature `SiDrupal` to be enabled.
#[component]
pub fn Drupal(
    cx: Scope,
