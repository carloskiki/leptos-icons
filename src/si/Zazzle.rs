#[cfg(feature = "SiZazzle")]
use leptos::*;
#[cfg(feature = "SiZazzle")]
///This icon requires the feature `SiZazzle` to be enabled.
#[component]
pub fn Zazzle(
    cx: Scope,
