#[cfg(feature = "SiAirchina")]
use leptos::*;
#[cfg(feature = "SiAirchina")]
///This icon requires the feature `SiAirchina` to be enabled.
#[component]
pub fn Airchina(
    cx: Scope,
