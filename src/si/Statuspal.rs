#[cfg(feature = "SiStatuspal")]
use leptos::*;
#[cfg(feature = "SiStatuspal")]
///This icon requires the feature `SiStatuspal` to be enabled.
#[component]
pub fn Statuspal(
    cx: Scope,
