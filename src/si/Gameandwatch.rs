#[cfg(feature = "SiGameandwatch")]
use leptos::*;
#[cfg(feature = "SiGameandwatch")]
///This icon requires the feature `SiGameandwatch` to be enabled.
#[component]
pub fn Gameandwatch(
    cx: Scope,
