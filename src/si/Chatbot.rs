#[cfg(feature = "SiChatbot")]
use leptos::*;
#[cfg(feature = "SiChatbot")]
///This icon requires the feature `SiChatbot` to be enabled.
#[component]
pub fn Chatbot(
    cx: Scope,
