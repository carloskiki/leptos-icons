#[cfg(feature = "SiVauxhall")]
use leptos::*;
#[cfg(feature = "SiVauxhall")]
///This icon requires the feature `SiVauxhall` to be enabled.
#[component]
pub fn Vauxhall(
    cx: Scope,
