#[cfg(feature = "SiAliexpress")]
use leptos::*;
#[cfg(feature = "SiAliexpress")]
///This icon requires the feature `SiAliexpress` to be enabled.
#[component]
pub fn Aliexpress(
    cx: Scope,
