#[cfg(feature = "SiStmicroelectronics")]
use leptos::*;
#[cfg(feature = "SiStmicroelectronics")]
///This icon requires the feature `SiStmicroelectronics` to be enabled.
#[component]
pub fn Stmicroelectronics(
    cx: Scope,
