#[cfg(feature = "SiApacheopenoffice")]
use leptos::*;
#[cfg(feature = "SiApacheopenoffice")]
///This icon requires the feature `SiApacheopenoffice` to be enabled.
#[component]
pub fn Apacheopenoffice(
    cx: Scope,
