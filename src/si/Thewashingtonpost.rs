#[cfg(feature = "SiThewashingtonpost")]
use leptos::*;
#[cfg(feature = "SiThewashingtonpost")]
///This icon requires the feature `SiThewashingtonpost` to be enabled.
#[component]
pub fn Thewashingtonpost(
    cx: Scope,
