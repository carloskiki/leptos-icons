#[cfg(feature = "SiAlchemy")]
use leptos::*;
#[cfg(feature = "SiAlchemy")]
///This icon requires the feature `SiAlchemy` to be enabled.
#[component]
pub fn Alchemy(
    cx: Scope,
