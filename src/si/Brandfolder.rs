#[cfg(feature = "SiBrandfolder")]
use leptos::*;
#[cfg(feature = "SiBrandfolder")]
///This icon requires the feature `SiBrandfolder` to be enabled.
#[component]
pub fn Brandfolder(
    cx: Scope,
