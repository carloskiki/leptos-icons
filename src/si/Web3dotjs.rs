#[cfg(feature = "SiWeb3dotjs")]
use leptos::*;
#[cfg(feature = "SiWeb3dotjs")]
///This icon requires the feature `SiWeb3dotjs` to be enabled.
#[component]
pub fn Web3dotjs(
    cx: Scope,
