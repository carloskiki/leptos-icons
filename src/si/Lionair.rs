#[cfg(feature = "SiLionair")]
use leptos::*;
#[cfg(feature = "SiLionair")]
///This icon requires the feature `SiLionair` to be enabled.
#[component]
pub fn Lionair(
    cx: Scope,
