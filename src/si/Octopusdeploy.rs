#[cfg(feature = "SiOctopusdeploy")]
use leptos::*;
#[cfg(feature = "SiOctopusdeploy")]
///This icon requires the feature `SiOctopusdeploy` to be enabled.
#[component]
pub fn Octopusdeploy(
    cx: Scope,
