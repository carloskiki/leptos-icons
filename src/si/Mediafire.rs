#[cfg(feature = "SiMediafire")]
use leptos::*;
#[cfg(feature = "SiMediafire")]
///This icon requires the feature `SiMediafire` to be enabled.
#[component]
pub fn Mediafire(
    cx: Scope,
