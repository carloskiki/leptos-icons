#[cfg(feature = "SiWolfram")]
use leptos::*;
#[cfg(feature = "SiWolfram")]
///This icon requires the feature `SiWolfram` to be enabled.
#[component]
pub fn Wolfram(
    cx: Scope,
