#[cfg(feature = "SiVivaldi")]
use leptos::*;
#[cfg(feature = "SiVivaldi")]
///This icon requires the feature `SiVivaldi` to be enabled.
#[component]
pub fn Vivaldi(
    cx: Scope,
