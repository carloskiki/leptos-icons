#[cfg(feature = "SiApachedruid")]
use leptos::*;
#[cfg(feature = "SiApachedruid")]
///This icon requires the feature `SiApachedruid` to be enabled.
#[component]
pub fn Apachedruid(
    cx: Scope,
