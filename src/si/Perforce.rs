#[cfg(feature = "SiPerforce")]
use leptos::*;
#[cfg(feature = "SiPerforce")]
///This icon requires the feature `SiPerforce` to be enabled.
#[component]
pub fn Perforce(
    cx: Scope,
