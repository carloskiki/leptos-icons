#[cfg(feature = "SiYourtraveldottv")]
use leptos::*;
#[cfg(feature = "SiYourtraveldottv")]
///This icon requires the feature `SiYourtraveldottv` to be enabled.
#[component]
pub fn Yourtraveldottv(
    cx: Scope,
