#[cfg(feature = "SiIcinga")]
use leptos::*;
#[cfg(feature = "SiIcinga")]
///This icon requires the feature `SiIcinga` to be enabled.
#[component]
pub fn Icinga(
    cx: Scope,
