#[cfg(feature = "SiOpenstreetmap")]
use leptos::*;
#[cfg(feature = "SiOpenstreetmap")]
///This icon requires the feature `SiOpenstreetmap` to be enabled.
#[component]
