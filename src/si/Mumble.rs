#[cfg(feature = "SiMumble")]
use leptos::*;
#[cfg(feature = "SiMumble")]
///This icon requires the feature `SiMumble` to be enabled.
#[component]
pub fn Mumble(
    cx: Scope,
