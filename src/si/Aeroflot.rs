#[cfg(feature = "SiAeroflot")]
use leptos::*;
#[cfg(feature = "SiAeroflot")]
///This icon requires the feature `SiAeroflot` to be enabled.
#[component]
pub fn Aeroflot(
    cx: Scope,
