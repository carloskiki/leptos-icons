#[cfg(feature = "SiPulumi")]
use leptos::*;
#[cfg(feature = "SiPulumi")]
///This icon requires the feature `SiPulumi` to be enabled.
#[component]
pub fn Pulumi(
    cx: Scope,
