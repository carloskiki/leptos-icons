#[cfg(feature = "SiSabanci")]
use leptos::*;
#[cfg(feature = "SiSabanci")]
///This icon requires the feature `SiSabanci` to be enabled.
#[component]
pub fn Sabanci(
    cx: Scope,
