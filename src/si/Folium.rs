#[cfg(feature = "SiFolium")]
use leptos::*;
#[cfg(feature = "SiFolium")]
///This icon requires the feature `SiFolium` to be enabled.
#[component]
pub fn Folium(
    cx: Scope,
