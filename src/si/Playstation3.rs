#[cfg(feature = "SiPlaystation3")]
use leptos::*;
#[cfg(feature = "SiPlaystation3")]
///This icon requires the feature `SiPlaystation3` to be enabled.
#[component]
pub fn Playstation3(
    cx: Scope,
