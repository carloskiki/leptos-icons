#[cfg(feature = "SiPostmates")]
use leptos::*;
#[cfg(feature = "SiPostmates")]
///This icon requires the feature `SiPostmates` to be enabled.
#[component]
pub fn Postmates(
    cx: Scope,
