#[cfg(feature = "SiFastify")]
use leptos::*;
#[cfg(feature = "SiFastify")]
///This icon requires the feature `SiFastify` to be enabled.
#[component]
pub fn Fastify(
    cx: Scope,
