#[cfg(feature = "SiConstruct3")]
use leptos::*;
#[cfg(feature = "SiConstruct3")]
///This icon requires the feature `SiConstruct3` to be enabled.
#[component]
pub fn Construct3(
    cx: Scope,
