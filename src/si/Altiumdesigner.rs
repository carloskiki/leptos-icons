#[cfg(feature = "SiAltiumdesigner")]
use leptos::*;
#[cfg(feature = "SiAltiumdesigner")]
///This icon requires the feature `SiAltiumdesigner` to be enabled.
#[component]
pub fn Altiumdesigner(
    cx: Scope,
