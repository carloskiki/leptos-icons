#[cfg(feature = "SiWebmoney")]
use leptos::*;
#[cfg(feature = "SiWebmoney")]
///This icon requires the feature `SiWebmoney` to be enabled.
#[component]
pub fn Webmoney(
    cx: Scope,
