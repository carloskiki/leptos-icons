#[cfg(feature = "SiCoinmarketcap")]
use leptos::*;
#[cfg(feature = "SiCoinmarketcap")]
///This icon requires the feature `SiCoinmarketcap` to be enabled.
#[component]
pub fn Coinmarketcap(
    cx: Scope,
