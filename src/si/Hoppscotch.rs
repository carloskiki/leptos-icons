#[cfg(feature = "SiHoppscotch")]
use leptos::*;
#[cfg(feature = "SiHoppscotch")]
///This icon requires the feature `SiHoppscotch` to be enabled.
#[component]
pub fn Hoppscotch(
    cx: Scope,
