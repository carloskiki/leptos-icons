#[cfg(feature = "SiWeblate")]
use leptos::*;
#[cfg(feature = "SiWeblate")]
///This icon requires the feature `SiWeblate` to be enabled.
#[component]
pub fn Weblate(
    cx: Scope,
