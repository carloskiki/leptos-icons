#[cfg(feature = "SiEnvoyproxy")]
use leptos::*;
#[cfg(feature = "SiEnvoyproxy")]
///This icon requires the feature `SiEnvoyproxy` to be enabled.
#[component]
pub fn Envoyproxy(
    cx: Scope,
