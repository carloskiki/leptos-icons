#[cfg(feature = "SiWindows95")]
use leptos::*;
#[cfg(feature = "SiWindows95")]
///This icon requires the feature `SiWindows95` to be enabled.
#[component]
pub fn Windows95(
    cx: Scope,
