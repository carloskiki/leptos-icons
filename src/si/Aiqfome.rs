#[cfg(feature = "SiAiqfome")]
use leptos::*;
#[cfg(feature = "SiAiqfome")]
///This icon requires the feature `SiAiqfome` to be enabled.
#[component]
pub fn Aiqfome(
    cx: Scope,
