#[cfg(feature = "SiSymfony")]
use leptos::*;
#[cfg(feature = "SiSymfony")]
///This icon requires the feature `SiSymfony` to be enabled.
#[component]
pub fn Symfony(
    cx: Scope,
