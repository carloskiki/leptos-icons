#[cfg(feature = "SiSonarlint")]
use leptos::*;
#[cfg(feature = "SiSonarlint")]
///This icon requires the feature `SiSonarlint` to be enabled.
#[component]
pub fn Sonarlint(
    cx: Scope,
