#[cfg(feature = "SiPagespeedinsights")]
use leptos::*;
#[cfg(feature = "SiPagespeedinsights")]
///This icon requires the feature `SiPagespeedinsights` to be enabled.
#[component]
pub fn Pagespeedinsights(
    cx: Scope,
