#[cfg(feature = "SiSlideshare")]
use leptos::*;
#[cfg(feature = "SiSlideshare")]
///This icon requires the feature `SiSlideshare` to be enabled.
#[component]
pub fn Slideshare(
    cx: Scope,
