#[cfg(feature = "SiFampay")]
use leptos::*;
#[cfg(feature = "SiFampay")]
///This icon requires the feature `SiFampay` to be enabled.
#[component]
pub fn Fampay(
    cx: Scope,
