#[cfg(feature = "SiBoeing")]
use leptos::*;
#[cfg(feature = "SiBoeing")]
///This icon requires the feature `SiBoeing` to be enabled.
#[component]
pub fn Boeing(
    cx: Scope,
