#[cfg(feature = "SiRottentomatoes")]
use leptos::*;
#[cfg(feature = "SiRottentomatoes")]
///This icon requires the feature `SiRottentomatoes` to be enabled.
#[component]
pub fn Rottentomatoes(
    cx: Scope,
