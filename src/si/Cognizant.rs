#[cfg(feature = "SiCognizant")]
use leptos::*;
#[cfg(feature = "SiCognizant")]
///This icon requires the feature `SiCognizant` to be enabled.
#[component]
pub fn Cognizant(
    cx: Scope,
