#[cfg(feature = "SiPlausibleanalytics")]
use leptos::*;
#[cfg(feature = "SiPlausibleanalytics")]
///This icon requires the feature `SiPlausibleanalytics` to be enabled.
#[component]
pub fn Plausibleanalytics(
    cx: Scope,
