#[cfg(feature = "SiJusteat")]
use leptos::*;
#[cfg(feature = "SiJusteat")]
///This icon requires the feature `SiJusteat` to be enabled.
#[component]
pub fn Justeat(
    cx: Scope,
