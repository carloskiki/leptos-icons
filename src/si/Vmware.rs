#[cfg(feature = "SiVmware")]
use leptos::*;
#[cfg(feature = "SiVmware")]
///This icon requires the feature `SiVmware` to be enabled.
#[component]
pub fn Vmware(
    cx: Scope,
