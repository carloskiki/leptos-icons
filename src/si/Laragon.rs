#[cfg(feature = "SiLaragon")]
use leptos::*;
#[cfg(feature = "SiLaragon")]
///This icon requires the feature `SiLaragon` to be enabled.
#[component]
pub fn Laragon(
    cx: Scope,
