#[cfg(feature = "SiSkillshare")]
use leptos::*;
#[cfg(feature = "SiSkillshare")]
///This icon requires the feature `SiSkillshare` to be enabled.
#[component]
pub fn Skillshare(
    cx: Scope,
