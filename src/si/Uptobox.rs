#[cfg(feature = "SiUptobox")]
use leptos::*;
#[cfg(feature = "SiUptobox")]
///This icon requires the feature `SiUptobox` to be enabled.
#[component]
pub fn Uptobox(
    cx: Scope,
