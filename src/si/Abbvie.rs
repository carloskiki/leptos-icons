#[cfg(feature = "SiAbbvie")]
use leptos::*;
#[cfg(feature = "SiAbbvie")]
///This icon requires the feature `SiAbbvie` to be enabled.
#[component]
pub fn Abbvie(
    cx: Scope,
