#[cfg(feature = "SiOkcupid")]
use leptos::*;
#[cfg(feature = "SiOkcupid")]
///This icon requires the feature `SiOkcupid` to be enabled.
#[component]
pub fn Okcupid(
    cx: Scope,
