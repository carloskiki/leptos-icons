#[cfg(feature = "SiThinkpad")]
use leptos::*;
#[cfg(feature = "SiThinkpad")]
///This icon requires the feature `SiThinkpad` to be enabled.
#[component]
pub fn Thinkpad(
    cx: Scope,
