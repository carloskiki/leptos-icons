#[cfg(feature = "SiFanfou")]
use leptos::*;
#[cfg(feature = "SiFanfou")]
///This icon requires the feature `SiFanfou` to be enabled.
#[component]
pub fn Fanfou(
    cx: Scope,
