#[cfg(feature = "SiEsphome")]
use leptos::*;
#[cfg(feature = "SiEsphome")]
///This icon requires the feature `SiEsphome` to be enabled.
#[component]
pub fn Esphome(
    cx: Scope,
