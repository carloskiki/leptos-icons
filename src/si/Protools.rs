#[cfg(feature = "SiProtools")]
use leptos::*;
#[cfg(feature = "SiProtools")]
///This icon requires the feature `SiProtools` to be enabled.
#[component]
pub fn Protools(
    cx: Scope,
