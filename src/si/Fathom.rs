#[cfg(feature = "SiFathom")]
use leptos::*;
#[cfg(feature = "SiFathom")]
///This icon requires the feature `SiFathom` to be enabled.
#[component]
pub fn Fathom(
    cx: Scope,
