#[cfg(feature = "SiBritishairways")]
use leptos::*;
#[cfg(feature = "SiBritishairways")]
///This icon requires the feature `SiBritishairways` to be enabled.
#[component]
pub fn Britishairways(
    cx: Scope,
