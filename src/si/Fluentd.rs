#[cfg(feature = "SiFluentd")]
use leptos::*;
#[cfg(feature = "SiFluentd")]
///This icon requires the feature `SiFluentd` to be enabled.
#[component]
pub fn Fluentd(
    cx: Scope,
