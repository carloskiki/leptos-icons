#[cfg(feature = "SiLufthansa")]
use leptos::*;
#[cfg(feature = "SiLufthansa")]
///This icon requires the feature `SiLufthansa` to be enabled.
#[component]
pub fn Lufthansa(
    cx: Scope,
