#[cfg(feature = "SiCypress")]
use leptos::*;
#[cfg(feature = "SiCypress")]
///This icon requires the feature `SiCypress` to be enabled.
#[component]
pub fn Cypress(
    cx: Scope,
