#[cfg(feature = "SiWayland")]
use leptos::*;
#[cfg(feature = "SiWayland")]
///This icon requires the feature `SiWayland` to be enabled.
#[component]
pub fn Wayland(
    cx: Scope,
