#[cfg(feature = "SiSpyderide")]
use leptos::*;
#[cfg(feature = "SiSpyderide")]
///This icon requires the feature `SiSpyderide` to be enabled.
#[component]
pub fn Spyderide(
    cx: Scope,
