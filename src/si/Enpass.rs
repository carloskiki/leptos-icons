#[cfg(feature = "SiEnpass")]
use leptos::*;
#[cfg(feature = "SiEnpass")]
///This icon requires the feature `SiEnpass` to be enabled.
#[component]
pub fn Enpass(
    cx: Scope,
