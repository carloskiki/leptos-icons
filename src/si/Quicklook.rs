#[cfg(feature = "SiQuicklook")]
use leptos::*;
#[cfg(feature = "SiQuicklook")]
///This icon requires the feature `SiQuicklook` to be enabled.
#[component]
pub fn Quicklook(
    cx: Scope,
