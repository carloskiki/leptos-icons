#[cfg(feature = "SiOpensuse")]
use leptos::*;
#[cfg(feature = "SiOpensuse")]
///This icon requires the feature `SiOpensuse` to be enabled.
#[component]
pub fn Opensuse(
    cx: Scope,
