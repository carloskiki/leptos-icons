#[cfg(feature = "SiMicrosofttranslator")]
use leptos::*;
#[cfg(feature = "SiMicrosofttranslator")]
///This icon requires the feature `SiMicrosofttranslator` to be enabled.
#[component]
pub fn Microsofttranslator(
    cx: Scope,
