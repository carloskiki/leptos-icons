#[cfg(feature = "SiRobotframework")]
use leptos::*;
#[cfg(feature = "SiRobotframework")]
///This icon requires the feature `SiRobotframework` to be enabled.
#[component]
pub fn Robotframework(
    cx: Scope,
