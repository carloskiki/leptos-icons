#[cfg(feature = "SiMicrogenetics")]
use leptos::*;
#[cfg(feature = "SiMicrogenetics")]
///This icon requires the feature `SiMicrogenetics` to be enabled.
#[component]
pub fn Microgenetics(
    cx: Scope,
