#[cfg(feature = "SiPyscaffold")]
use leptos::*;
#[cfg(feature = "SiPyscaffold")]
///This icon requires the feature `SiPyscaffold` to be enabled.
#[component]
pub fn Pyscaffold(
    cx: Scope,
