#[cfg(feature = "SiTypeform")]
use leptos::*;
#[cfg(feature = "SiTypeform")]
///This icon requires the feature `SiTypeform` to be enabled.
#[component]
pub fn Typeform(
    cx: Scope,
