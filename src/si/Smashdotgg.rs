#[cfg(feature = "SiSmashdotgg")]
use leptos::*;
#[cfg(feature = "SiSmashdotgg")]
///This icon requires the feature `SiSmashdotgg` to be enabled.
#[component]
pub fn Smashdotgg(
    cx: Scope,
