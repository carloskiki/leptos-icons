#[cfg(feature = "SiDependabot")]
use leptos::*;
#[cfg(feature = "SiDependabot")]
///This icon requires the feature `SiDependabot` to be enabled.
#[component]
pub fn Dependabot(
    cx: Scope,
