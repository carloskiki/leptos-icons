#[cfg(feature = "SiRedhatopenshift")]
use leptos::*;
#[cfg(feature = "SiRedhatopenshift")]
///This icon requires the feature `SiRedhatopenshift` to be enabled.
#[component]
pub fn Redhatopenshift(
    cx: Scope,
