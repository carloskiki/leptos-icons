#[cfg(feature = "SiTokyometro")]
use leptos::*;
#[cfg(feature = "SiTokyometro")]
///This icon requires the feature `SiTokyometro` to be enabled.
#[component]
pub fn Tokyometro(
    cx: Scope,
