#[cfg(feature = "SiTinyletter")]
use leptos::*;
#[cfg(feature = "SiTinyletter")]
///This icon requires the feature `SiTinyletter` to be enabled.
#[component]
pub fn Tinyletter(
    cx: Scope,
