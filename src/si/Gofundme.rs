#[cfg(feature = "SiGofundme")]
use leptos::*;
#[cfg(feature = "SiGofundme")]
///This icon requires the feature `SiGofundme` to be enabled.
#[component]
pub fn Gofundme(
    cx: Scope,
