#[cfg(feature = "SiI18next")]
use leptos::*;
#[cfg(feature = "SiI18next")]
///This icon requires the feature `SiI18next` to be enabled.
#[component]
pub fn I18next(
    cx: Scope,
