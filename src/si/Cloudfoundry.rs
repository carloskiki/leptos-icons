#[cfg(feature = "SiCloudfoundry")]
use leptos::*;
#[cfg(feature = "SiCloudfoundry")]
///This icon requires the feature `SiCloudfoundry` to be enabled.
#[component]
pub fn Cloudfoundry(
    cx: Scope,
