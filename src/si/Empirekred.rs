#[cfg(feature = "SiEmpirekred")]
use leptos::*;
#[cfg(feature = "SiEmpirekred")]
///This icon requires the feature `SiEmpirekred` to be enabled.
#[component]
pub fn Empirekred(
    cx: Scope,
