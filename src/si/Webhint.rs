#[cfg(feature = "SiWebhint")]
use leptos::*;
#[cfg(feature = "SiWebhint")]
///This icon requires the feature `SiWebhint` to be enabled.
#[component]
pub fn Webhint(
    cx: Scope,
