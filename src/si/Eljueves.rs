#[cfg(feature = "SiEljueves")]
use leptos::*;
#[cfg(feature = "SiEljueves")]
///This icon requires the feature `SiEljueves` to be enabled.
#[component]
pub fn Eljueves(
    cx: Scope,
