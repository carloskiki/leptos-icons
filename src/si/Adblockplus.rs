#[cfg(feature = "SiAdblockplus")]
use leptos::*;
#[cfg(feature = "SiAdblockplus")]
///This icon requires the feature `SiAdblockplus` to be enabled.
#[component]
pub fn Adblockplus(
    cx: Scope,
