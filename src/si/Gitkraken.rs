#[cfg(feature = "SiGitkraken")]
use leptos::*;
#[cfg(feature = "SiGitkraken")]
///This icon requires the feature `SiGitkraken` to be enabled.
#[component]
pub fn Gitkraken(
    cx: Scope,
