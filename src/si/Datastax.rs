#[cfg(feature = "SiDatastax")]
use leptos::*;
#[cfg(feature = "SiDatastax")]
///This icon requires the feature `SiDatastax` to be enabled.
#[component]
pub fn Datastax(
    cx: Scope,
