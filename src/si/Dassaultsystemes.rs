#[cfg(feature = "SiDassaultsystemes")]
use leptos::*;
#[cfg(feature = "SiDassaultsystemes")]
///This icon requires the feature `SiDassaultsystemes` to be enabled.
#[component]
pub fn Dassaultsystemes(
    cx: Scope,
