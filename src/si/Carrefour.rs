#[cfg(feature = "SiCarrefour")]
use leptos::*;
#[cfg(feature = "SiCarrefour")]
///This icon requires the feature `SiCarrefour` to be enabled.
#[component]
pub fn Carrefour(
    cx: Scope,
