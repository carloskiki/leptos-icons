#[cfg(feature = "SiSubaru")]
use leptos::*;
#[cfg(feature = "SiSubaru")]
///This icon requires the feature `SiSubaru` to be enabled.
#[component]
pub fn Subaru(
    cx: Scope,
