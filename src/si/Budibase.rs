#[cfg(feature = "SiBudibase")]
use leptos::*;
#[cfg(feature = "SiBudibase")]
///This icon requires the feature `SiBudibase` to be enabled.
#[component]
pub fn Budibase(
    cx: Scope,
