#[cfg(feature = "SiMacpaw")]
use leptos::*;
#[cfg(feature = "SiMacpaw")]
///This icon requires the feature `SiMacpaw` to be enabled.
#[component]
pub fn Macpaw(
    cx: Scope,
