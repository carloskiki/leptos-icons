#[cfg(feature = "SiApacheairflow")]
use leptos::*;
#[cfg(feature = "SiApacheairflow")]
///This icon requires the feature `SiApacheairflow` to be enabled.
#[component]
pub fn Apacheairflow(
    cx: Scope,
