#[cfg(feature = "SiMicrosoftaccess")]
use leptos::*;
#[cfg(feature = "SiMicrosoftaccess")]
///This icon requires the feature `SiMicrosoftaccess` to be enabled.
#[component]
pub fn Microsoftaccess(
    cx: Scope,
