#[cfg(feature = "SiZingat")]
use leptos::*;
#[cfg(feature = "SiZingat")]
///This icon requires the feature `SiZingat` to be enabled.
#[component]
pub fn Zingat(
    cx: Scope,
