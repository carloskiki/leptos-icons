#[cfg(feature = "SiTreehouse")]
use leptos::*;
#[cfg(feature = "SiTreehouse")]
///This icon requires the feature `SiTreehouse` to be enabled.
#[component]
pub fn Treehouse(
    cx: Scope,
