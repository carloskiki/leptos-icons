#[cfg(feature = "SiPublons")]
use leptos::*;
#[cfg(feature = "SiPublons")]
///This icon requires the feature `SiPublons` to be enabled.
#[component]
pub fn Publons(
    cx: Scope,
