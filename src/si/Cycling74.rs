#[cfg(feature = "SiCycling74")]
use leptos::*;
#[cfg(feature = "SiCycling74")]
///This icon requires the feature `SiCycling74` to be enabled.
#[component]
pub fn Cycling74(
    cx: Scope,
