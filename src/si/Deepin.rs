#[cfg(feature = "SiDeepin")]
use leptos::*;
#[cfg(feature = "SiDeepin")]
///This icon requires the feature `SiDeepin` to be enabled.
#[component]
pub fn Deepin(
    cx: Scope,
