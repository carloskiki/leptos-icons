#[cfg(feature = "SiQubesos")]
use leptos::*;
#[cfg(feature = "SiQubesos")]
///This icon requires the feature `SiQubesos` to be enabled.
#[component]
pub fn Qubesos(
    cx: Scope,
