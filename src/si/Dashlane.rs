#[cfg(feature = "SiDashlane")]
use leptos::*;
#[cfg(feature = "SiDashlane")]
///This icon requires the feature `SiDashlane` to be enabled.
#[component]
pub fn Dashlane(
    cx: Scope,
