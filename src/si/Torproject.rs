#[cfg(feature = "SiTorproject")]
use leptos::*;
#[cfg(feature = "SiTorproject")]
///This icon requires the feature `SiTorproject` to be enabled.
#[component]
pub fn Torproject(
    cx: Scope,
