#[cfg(feature = "SiPhilipshue")]
use leptos::*;
#[cfg(feature = "SiPhilipshue")]
///This icon requires the feature `SiPhilipshue` to be enabled.
#[component]
pub fn Philipshue(
    cx: Scope,
