#[cfg(feature = "SiApacheecharts")]
use leptos::*;
#[cfg(feature = "SiApacheecharts")]
///This icon requires the feature `SiApacheecharts` to be enabled.
#[component]
pub fn Apacheecharts(
    cx: Scope,
