#[cfg(feature = "SiProtondb")]
use leptos::*;
#[cfg(feature = "SiProtondb")]
///This icon requires the feature `SiProtondb` to be enabled.
#[component]
pub fn Protondb(
    cx: Scope,
