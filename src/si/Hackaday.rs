#[cfg(feature = "SiHackaday")]
use leptos::*;
#[cfg(feature = "SiHackaday")]
///This icon requires the feature `SiHackaday` to be enabled.
#[component]
pub fn Hackaday(
    cx: Scope,
