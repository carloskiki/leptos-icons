#[cfg(feature = "SiSumologic")]
use leptos::*;
#[cfg(feature = "SiSumologic")]
///This icon requires the feature `SiSumologic` to be enabled.
#[component]
pub fn Sumologic(
    cx: Scope,
