#[cfg(feature = "SiInternetexplorer")]
use leptos::*;
#[cfg(feature = "SiInternetexplorer")]
///This icon requires the feature `SiInternetexplorer` to be enabled.
#[component]
