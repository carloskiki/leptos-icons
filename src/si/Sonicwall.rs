#[cfg(feature = "SiSonicwall")]
use leptos::*;
#[cfg(feature = "SiSonicwall")]
///This icon requires the feature `SiSonicwall` to be enabled.
#[component]
pub fn Sonicwall(
    cx: Scope,
