#[cfg(feature = "SiKaspersky")]
use leptos::*;
#[cfg(feature = "SiKaspersky")]
///This icon requires the feature `SiKaspersky` to be enabled.
#[component]
pub fn Kaspersky(
    cx: Scope,
