#[cfg(feature = "SiAudiomack")]
use leptos::*;
#[cfg(feature = "SiAudiomack")]
///This icon requires the feature `SiAudiomack` to be enabled.
#[component]
pub fn Audiomack(
    cx: Scope,
