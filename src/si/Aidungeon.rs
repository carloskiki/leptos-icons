#[cfg(feature = "SiAidungeon")]
use leptos::*;
#[cfg(feature = "SiAidungeon")]
///This icon requires the feature `SiAidungeon` to be enabled.
#[component]
pub fn Aidungeon(
    cx: Scope,
