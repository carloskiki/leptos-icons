#[cfg(feature = "SiBehance")]
use leptos::*;
#[cfg(feature = "SiBehance")]
///This icon requires the feature `SiBehance` to be enabled.
#[component]
pub fn Behance(
    cx: Scope,
