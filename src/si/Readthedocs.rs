#[cfg(feature = "SiReadthedocs")]
use leptos::*;
#[cfg(feature = "SiReadthedocs")]
///This icon requires the feature `SiReadthedocs` to be enabled.
#[component]
pub fn Readthedocs(
    cx: Scope,
