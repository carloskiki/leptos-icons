#[cfg(feature = "SiMediatek")]
use leptos::*;
#[cfg(feature = "SiMediatek")]
///This icon requires the feature `SiMediatek` to be enabled.
#[component]
pub fn Mediatek(
    cx: Scope,
