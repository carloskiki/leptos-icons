#[cfg(feature = "SiCesium")]
use leptos::*;
#[cfg(feature = "SiCesium")]
///This icon requires the feature `SiCesium` to be enabled.
#[component]
pub fn Cesium(
    cx: Scope,
