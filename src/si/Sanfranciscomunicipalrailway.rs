#[cfg(feature = "SiSanfranciscomunicipalrailway")]
use leptos::*;
#[cfg(feature = "SiSanfranciscomunicipalrailway")]
///This icon requires the feature `SiSanfranciscomunicipalrailway` to be enabled.
#[component]
pub fn Sanfranciscomunicipalrailway(
    cx: Scope,
