#[cfg(feature = "SiBitcoinsv")]
use leptos::*;
#[cfg(feature = "SiBitcoinsv")]
///This icon requires the feature `SiBitcoinsv` to be enabled.
#[component]
pub fn Bitcoinsv(
    cx: Scope,
