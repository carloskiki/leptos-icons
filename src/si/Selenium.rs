#[cfg(feature = "SiSelenium")]
use leptos::*;
#[cfg(feature = "SiSelenium")]
///This icon requires the feature `SiSelenium` to be enabled.
#[component]
pub fn Selenium(
    cx: Scope,
