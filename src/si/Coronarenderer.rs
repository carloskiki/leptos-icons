#[cfg(feature = "SiCoronarenderer")]
use leptos::*;
#[cfg(feature = "SiCoronarenderer")]
///This icon requires the feature `SiCoronarenderer` to be enabled.
#[component]
pub fn Coronarenderer(
    cx: Scope,
