#[cfg(feature = "SiCodeship")]
use leptos::*;
#[cfg(feature = "SiCodeship")]
///This icon requires the feature `SiCodeship` to be enabled.
#[component]
pub fn Codeship(
    cx: Scope,
