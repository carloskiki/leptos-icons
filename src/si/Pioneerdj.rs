#[cfg(feature = "SiPioneerdj")]
use leptos::*;
#[cfg(feature = "SiPioneerdj")]
///This icon requires the feature `SiPioneerdj` to be enabled.
#[component]
pub fn Pioneerdj(
    cx: Scope,
