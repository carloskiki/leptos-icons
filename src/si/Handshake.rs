#[cfg(feature = "SiHandshake")]
use leptos::*;
#[cfg(feature = "SiHandshake")]
///This icon requires the feature `SiHandshake` to be enabled.
#[component]
pub fn Handshake(
    cx: Scope,
