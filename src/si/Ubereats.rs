#[cfg(feature = "SiUbereats")]
use leptos::*;
#[cfg(feature = "SiUbereats")]
///This icon requires the feature `SiUbereats` to be enabled.
#[component]
pub fn Ubereats(
    cx: Scope,
