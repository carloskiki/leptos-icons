#[cfg(feature = "SiWolframlanguage")]
use leptos::*;
#[cfg(feature = "SiWolframlanguage")]
///This icon requires the feature `SiWolframlanguage` to be enabled.
#[component]
pub fn Wolframlanguage(
    cx: Scope,
