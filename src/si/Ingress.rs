#[cfg(feature = "SiIngress")]
use leptos::*;
#[cfg(feature = "SiIngress")]
///This icon requires the feature `SiIngress` to be enabled.
#[component]
pub fn Ingress(
    cx: Scope,
