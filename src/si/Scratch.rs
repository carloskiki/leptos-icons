#[cfg(feature = "SiScratch")]
use leptos::*;
#[cfg(feature = "SiScratch")]
///This icon requires the feature `SiScratch` to be enabled.
#[component]
pub fn Scratch(
    cx: Scope,
