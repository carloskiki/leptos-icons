#[cfg(feature = "SiOpslevel")]
use leptos::*;
#[cfg(feature = "SiOpslevel")]
///This icon requires the feature `SiOpslevel` to be enabled.
#[component]
pub fn Opslevel(
    cx: Scope,
