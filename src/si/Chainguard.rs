#[cfg(feature = "SiChainguard")]
use leptos::*;
#[cfg(feature = "SiChainguard")]
///This icon requires the feature `SiChainguard` to be enabled.
#[component]
pub fn Chainguard(
    cx: Scope,
