#[cfg(feature = "SiIndeed")]
use leptos::*;
#[cfg(feature = "SiIndeed")]
///This icon requires the feature `SiIndeed` to be enabled.
#[component]
pub fn Indeed(
    cx: Scope,
