#[cfg(feature = "SiSailfishos")]
use leptos::*;
#[cfg(feature = "SiSailfishos")]
///This icon requires the feature `SiSailfishos` to be enabled.
#[component]
pub fn Sailfishos(
    cx: Scope,
