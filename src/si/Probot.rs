#[cfg(feature = "SiProbot")]
use leptos::*;
#[cfg(feature = "SiProbot")]
///This icon requires the feature `SiProbot` to be enabled.
#[component]
pub fn Probot(
    cx: Scope,
