#[cfg(feature = "SiAsciidoctor")]
use leptos::*;
#[cfg(feature = "SiAsciidoctor")]
///This icon requires the feature `SiAsciidoctor` to be enabled.
#[component]
pub fn Asciidoctor(
    cx: Scope,
