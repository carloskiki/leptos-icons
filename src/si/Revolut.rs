#[cfg(feature = "SiRevolut")]
use leptos::*;
#[cfg(feature = "SiRevolut")]
///This icon requires the feature `SiRevolut` to be enabled.
#[component]
pub fn Revolut(
    cx: Scope,
