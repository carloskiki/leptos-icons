#[cfg(feature = "SiPodcastaddict")]
use leptos::*;
#[cfg(feature = "SiPodcastaddict")]
///This icon requires the feature `SiPodcastaddict` to be enabled.
#[component]
pub fn Podcastaddict(
    cx: Scope,
