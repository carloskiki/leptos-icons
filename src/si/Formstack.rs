#[cfg(feature = "SiFormstack")]
use leptos::*;
#[cfg(feature = "SiFormstack")]
///This icon requires the feature `SiFormstack` to be enabled.
#[component]
pub fn Formstack(
    cx: Scope,
