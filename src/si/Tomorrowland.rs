#[cfg(feature = "SiTomorrowland")]
use leptos::*;
#[cfg(feature = "SiTomorrowland")]
///This icon requires the feature `SiTomorrowland` to be enabled.
#[component]
pub fn Tomorrowland(
    cx: Scope,
