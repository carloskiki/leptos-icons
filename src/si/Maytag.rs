#[cfg(feature = "SiMaytag")]
use leptos::*;
#[cfg(feature = "SiMaytag")]
///This icon requires the feature `SiMaytag` to be enabled.
#[component]
pub fn Maytag(
    cx: Scope,
