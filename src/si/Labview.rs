#[cfg(feature = "SiLabview")]
use leptos::*;
#[cfg(feature = "SiLabview")]
///This icon requires the feature `SiLabview` to be enabled.
#[component]
pub fn Labview(
    cx: Scope,
