#[cfg(feature = "SiLinuxcontainers")]
use leptos::*;
#[cfg(feature = "SiLinuxcontainers")]
///This icon requires the feature `SiLinuxcontainers` to be enabled.
#[component]
pub fn Linuxcontainers(
    cx: Scope,
