#[cfg(feature = "SiAldisud")]
use leptos::*;
#[cfg(feature = "SiAldisud")]
///This icon requires the feature `SiAldisud` to be enabled.
#[component]
pub fn Aldisud(
    cx: Scope,
