#[cfg(feature = "SiThealgorithms")]
use leptos::*;
#[cfg(feature = "SiThealgorithms")]
///This icon requires the feature `SiThealgorithms` to be enabled.
#[component]
pub fn Thealgorithms(
    cx: Scope,
