#[cfg(feature = "SiRepublicofgamers")]
use leptos::*;
#[cfg(feature = "SiRepublicofgamers")]
///This icon requires the feature `SiRepublicofgamers` to be enabled.
#[component]
pub fn Republicofgamers(
    cx: Scope,
