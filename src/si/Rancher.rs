#[cfg(feature = "SiRancher")]
use leptos::*;
#[cfg(feature = "SiRancher")]
///This icon requires the feature `SiRancher` to be enabled.
#[component]
pub fn Rancher(
    cx: Scope,
