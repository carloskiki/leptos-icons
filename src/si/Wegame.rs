#[cfg(feature = "SiWegame")]
use leptos::*;
#[cfg(feature = "SiWegame")]
///This icon requires the feature `SiWegame` to be enabled.
#[component]
pub fn Wegame(
    cx: Scope,
