#[cfg(feature = "SiInkdrop")]
use leptos::*;
#[cfg(feature = "SiInkdrop")]
///This icon requires the feature `SiInkdrop` to be enabled.
#[component]
pub fn Inkdrop(
    cx: Scope,
