#[cfg(feature = "SiReduxsaga")]
use leptos::*;
#[cfg(feature = "SiReduxsaga")]
///This icon requires the feature `SiReduxsaga` to be enabled.
#[component]
pub fn Reduxsaga(
    cx: Scope,
