#[cfg(feature = "SiMaserati")]
use leptos::*;
#[cfg(feature = "SiMaserati")]
///This icon requires the feature `SiMaserati` to be enabled.
#[component]
pub fn Maserati(
    cx: Scope,
