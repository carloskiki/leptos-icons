#[cfg(feature = "SiBroadcom")]
use leptos::*;
#[cfg(feature = "SiBroadcom")]
///This icon requires the feature `SiBroadcom` to be enabled.
#[component]
pub fn Broadcom(
    cx: Scope,
