#[cfg(feature = "SiShazam")]
use leptos::*;
#[cfg(feature = "SiShazam")]
///This icon requires the feature `SiShazam` to be enabled.
#[component]
pub fn Shazam(
    cx: Scope,
