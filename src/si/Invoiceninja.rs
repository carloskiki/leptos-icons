#[cfg(feature = "SiInvoiceninja")]
use leptos::*;
#[cfg(feature = "SiInvoiceninja")]
///This icon requires the feature `SiInvoiceninja` to be enabled.
#[component]
pub fn Invoiceninja(
    cx: Scope,
