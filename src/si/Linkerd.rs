#[cfg(feature = "SiLinkerd")]
use leptos::*;
#[cfg(feature = "SiLinkerd")]
///This icon requires the feature `SiLinkerd` to be enabled.
#[component]
pub fn Linkerd(
    cx: Scope,
