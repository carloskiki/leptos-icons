#[cfg(feature = "SiActivision")]
use leptos::*;
#[cfg(feature = "SiActivision")]
///This icon requires the feature `SiActivision` to be enabled.
#[component]
pub fn Activision(
    cx: Scope,
