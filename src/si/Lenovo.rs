#[cfg(feature = "SiLenovo")]
use leptos::*;
#[cfg(feature = "SiLenovo")]
///This icon requires the feature `SiLenovo` to be enabled.
#[component]
pub fn Lenovo(
    cx: Scope,
