#[cfg(feature = "SiSourcegraph")]
use leptos::*;
#[cfg(feature = "SiSourcegraph")]
///This icon requires the feature `SiSourcegraph` to be enabled.
#[component]
pub fn Sourcegraph(
    cx: Scope,
