#[cfg(feature = "SiApacherocketmq")]
use leptos::*;
#[cfg(feature = "SiApacherocketmq")]
///This icon requires the feature `SiApacherocketmq` to be enabled.
#[component]
pub fn Apacherocketmq(
    cx: Scope,
