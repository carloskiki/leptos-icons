#[cfg(feature = "SiAllocine")]
use leptos::*;
#[cfg(feature = "SiAllocine")]
///This icon requires the feature `SiAllocine` to be enabled.
#[component]
pub fn Allocine(
    cx: Scope,
