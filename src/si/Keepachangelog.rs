#[cfg(feature = "SiKeepachangelog")]
use leptos::*;
#[cfg(feature = "SiKeepachangelog")]
///This icon requires the feature `SiKeepachangelog` to be enabled.
#[component]
pub fn Keepachangelog(
    cx: Scope,
