#[cfg(feature = "SiAurelia")]
use leptos::*;
#[cfg(feature = "SiAurelia")]
///This icon requires the feature `SiAurelia` to be enabled.
#[component]
pub fn Aurelia(
    cx: Scope,
