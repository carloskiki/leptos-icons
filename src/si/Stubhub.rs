#[cfg(feature = "SiStubhub")]
use leptos::*;
#[cfg(feature = "SiStubhub")]
///This icon requires the feature `SiStubhub` to be enabled.
#[component]
pub fn Stubhub(
    cx: Scope,
