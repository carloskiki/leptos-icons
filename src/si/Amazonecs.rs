#[cfg(feature = "SiAmazonecs")]
use leptos::*;
#[cfg(feature = "SiAmazonecs")]
///This icon requires the feature `SiAmazonecs` to be enabled.
#[component]
pub fn Amazonecs(
    cx: Scope,
