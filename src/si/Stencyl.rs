#[cfg(feature = "SiStencyl")]
use leptos::*;
#[cfg(feature = "SiStencyl")]
///This icon requires the feature `SiStencyl` to be enabled.
#[component]
pub fn Stencyl(
    cx: Scope,
