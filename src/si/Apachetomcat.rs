#[cfg(feature = "SiApachetomcat")]
use leptos::*;
#[cfg(feature = "SiApachetomcat")]
///This icon requires the feature `SiApachetomcat` to be enabled.
#[component]
pub fn Apachetomcat(
    cx: Scope,
