#[cfg(feature = "SiStartrek")]
use leptos::*;
#[cfg(feature = "SiStartrek")]
///This icon requires the feature `SiStartrek` to be enabled.
#[component]
pub fn Startrek(
    cx: Scope,
