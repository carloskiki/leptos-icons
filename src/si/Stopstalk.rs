#[cfg(feature = "SiStopstalk")]
use leptos::*;
#[cfg(feature = "SiStopstalk")]
///This icon requires the feature `SiStopstalk` to be enabled.
#[component]
pub fn Stopstalk(
    cx: Scope,
