#[cfg(feature = "SiAmazonsqs")]
use leptos::*;
#[cfg(feature = "SiAmazonsqs")]
///This icon requires the feature `SiAmazonsqs` to be enabled.
#[component]
pub fn Amazonsqs(
    cx: Scope,
