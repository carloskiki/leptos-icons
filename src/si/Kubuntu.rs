#[cfg(feature = "SiKubuntu")]
use leptos::*;
#[cfg(feature = "SiKubuntu")]
///This icon requires the feature `SiKubuntu` to be enabled.
#[component]
pub fn Kubuntu(
    cx: Scope,
