#[cfg(feature = "SiOpencv")]
use leptos::*;
#[cfg(feature = "SiOpencv")]
///This icon requires the feature `SiOpencv` to be enabled.
#[component]
pub fn Opencv(
    cx: Scope,
