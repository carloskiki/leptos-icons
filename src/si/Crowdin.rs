#[cfg(feature = "SiCrowdin")]
use leptos::*;
#[cfg(feature = "SiCrowdin")]
///This icon requires the feature `SiCrowdin` to be enabled.
#[component]
pub fn Crowdin(
    cx: Scope,
