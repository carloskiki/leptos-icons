#[cfg(feature = "SiSpringCreators")]
use leptos::*;
#[cfg(feature = "SiSpringCreators")]
///This icon requires the feature `SiSpringCreators` to be enabled.
#[component]
pub fn SpringCreators(
    cx: Scope,
