#[cfg(feature = "SiZomato")]
use leptos::*;
#[cfg(feature = "SiZomato")]
///This icon requires the feature `SiZomato` to be enabled.
#[component]
pub fn Zomato(
    cx: Scope,
