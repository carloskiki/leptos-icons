#[cfg(feature = "SiMagasinsu")]
use leptos::*;
#[cfg(feature = "SiMagasinsu")]
///This icon requires the feature `SiMagasinsu` to be enabled.
#[component]
pub fn Magasinsu(
    cx: Scope,
