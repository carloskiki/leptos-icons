#[cfg(feature = "SiRedmine")]
use leptos::*;
#[cfg(feature = "SiRedmine")]
///This icon requires the feature `SiRedmine` to be enabled.
#[component]
pub fn Redmine(
    cx: Scope,
