#[cfg(feature = "SiCodenewbie")]
use leptos::*;
#[cfg(feature = "SiCodenewbie")]
///This icon requires the feature `SiCodenewbie` to be enabled.
#[component]
pub fn Codenewbie(
    cx: Scope,
