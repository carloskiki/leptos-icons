#[cfg(feature = "SiBlueprint")]
use leptos::*;
#[cfg(feature = "SiBlueprint")]
///This icon requires the feature `SiBlueprint` to be enabled.
#[component]
pub fn Blueprint(
    cx: Scope,
