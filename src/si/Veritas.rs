#[cfg(feature = "SiVeritas")]
use leptos::*;
#[cfg(feature = "SiVeritas")]
///This icon requires the feature `SiVeritas` to be enabled.
#[component]
pub fn Veritas(
    cx: Scope,
