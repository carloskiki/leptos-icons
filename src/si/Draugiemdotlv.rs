#[cfg(feature = "SiDraugiemdotlv")]
use leptos::*;
#[cfg(feature = "SiDraugiemdotlv")]
///This icon requires the feature `SiDraugiemdotlv` to be enabled.
#[component]
pub fn Draugiemdotlv(
    cx: Scope,
