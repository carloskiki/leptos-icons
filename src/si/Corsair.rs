#[cfg(feature = "SiCorsair")]
use leptos::*;
#[cfg(feature = "SiCorsair")]
///This icon requires the feature `SiCorsair` to be enabled.
#[component]
pub fn Corsair(
    cx: Scope,
