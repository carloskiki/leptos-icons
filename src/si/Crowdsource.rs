#[cfg(feature = "SiCrowdsource")]
use leptos::*;
#[cfg(feature = "SiCrowdsource")]
///This icon requires the feature `SiCrowdsource` to be enabled.
#[component]
pub fn Crowdsource(
    cx: Scope,
