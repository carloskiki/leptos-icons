#[cfg(feature = "SiAskubuntu")]
use leptos::*;
#[cfg(feature = "SiAskubuntu")]
///This icon requires the feature `SiAskubuntu` to be enabled.
#[component]
pub fn Askubuntu(
    cx: Scope,
