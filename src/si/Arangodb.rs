#[cfg(feature = "SiArangodb")]
use leptos::*;
#[cfg(feature = "SiArangodb")]
///This icon requires the feature `SiArangodb` to be enabled.
#[component]
pub fn Arangodb(
    cx: Scope,
