#[cfg(feature = "SiInternetarchive")]
use leptos::*;
#[cfg(feature = "SiInternetarchive")]
///This icon requires the feature `SiInternetarchive` to be enabled.
#[component]
pub fn Internetarchive(
    cx: Scope,
