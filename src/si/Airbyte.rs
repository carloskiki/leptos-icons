#[cfg(feature = "SiAirbyte")]
use leptos::*;
#[cfg(feature = "SiAirbyte")]
///This icon requires the feature `SiAirbyte` to be enabled.
#[component]
pub fn Airbyte(
    cx: Scope,
