#[cfg(feature = "SiArchiveofourown")]
use leptos::*;
#[cfg(feature = "SiArchiveofourown")]
///This icon requires the feature `SiArchiveofourown` to be enabled.
#[component]
pub fn Archiveofourown(
    cx: Scope,
