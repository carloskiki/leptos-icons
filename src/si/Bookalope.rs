#[cfg(feature = "SiBookalope")]
use leptos::*;
#[cfg(feature = "SiBookalope")]
///This icon requires the feature `SiBookalope` to be enabled.
#[component]
pub fn Bookalope(
    cx: Scope,
