#[cfg(feature = "SiDevrant")]
use leptos::*;
#[cfg(feature = "SiDevrant")]
///This icon requires the feature `SiDevrant` to be enabled.
#[component]
pub fn Devrant(
    cx: Scope,
