#[cfg(feature = "SiPlangrid")]
use leptos::*;
#[cfg(feature = "SiPlangrid")]
///This icon requires the feature `SiPlangrid` to be enabled.
#[component]
pub fn Plangrid(
    cx: Scope,
