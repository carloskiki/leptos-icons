#[cfg(feature = "SiScrutinizerci")]
use leptos::*;
#[cfg(feature = "SiScrutinizerci")]
///This icon requires the feature `SiScrutinizerci` to be enabled.
#[component]
pub fn Scrutinizerci(
    cx: Scope,
