#[cfg(feature = "SiAiohttp")]
use leptos::*;
#[cfg(feature = "SiAiohttp")]
///This icon requires the feature `SiAiohttp` to be enabled.
#[component]
pub fn Aiohttp(
    cx: Scope,
