#[cfg(feature = "SiExordo")]
use leptos::*;
#[cfg(feature = "SiExordo")]
///This icon requires the feature `SiExordo` to be enabled.
#[component]
pub fn Exordo(
    cx: Scope,
