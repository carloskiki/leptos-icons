#[cfg(feature = "SiHotelsdotcom")]
use leptos::*;
#[cfg(feature = "SiHotelsdotcom")]
///This icon requires the feature `SiHotelsdotcom` to be enabled.
#[component]
pub fn Hotelsdotcom(
    cx: Scope,
