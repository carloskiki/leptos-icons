#[cfg(feature = "SiYamahamotorcorporation")]
use leptos::*;
#[cfg(feature = "SiYamahamotorcorporation")]
///This icon requires the feature `SiYamahamotorcorporation` to be enabled.
#[component]
pub fn Yamahamotorcorporation(
    cx: Scope,
