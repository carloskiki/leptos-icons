#[cfg(feature = "SiWeasyl")]
use leptos::*;
#[cfg(feature = "SiWeasyl")]
///This icon requires the feature `SiWeasyl` to be enabled.
#[component]
pub fn Weasyl(
    cx: Scope,
