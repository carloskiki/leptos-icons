#[cfg(feature = "SiPowervirtualagents")]
use leptos::*;
#[cfg(feature = "SiPowervirtualagents")]
///This icon requires the feature `SiPowervirtualagents` to be enabled.
#[component]
pub fn Powervirtualagents(
    cx: Scope,
