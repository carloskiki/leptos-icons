#[cfg(feature = "SiTacobell")]
use leptos::*;
#[cfg(feature = "SiTacobell")]
///This icon requires the feature `SiTacobell` to be enabled.
#[component]
pub fn Tacobell(
    cx: Scope,
