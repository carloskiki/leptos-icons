#[cfg(feature = "SiGithubpages")]
use leptos::*;
#[cfg(feature = "SiGithubpages")]
///This icon requires the feature `SiGithubpages` to be enabled.
#[component]
pub fn Githubpages(
    cx: Scope,
