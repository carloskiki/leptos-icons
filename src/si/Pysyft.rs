#[cfg(feature = "SiPysyft")]
use leptos::*;
#[cfg(feature = "SiPysyft")]
///This icon requires the feature `SiPysyft` to be enabled.
#[component]
pub fn Pysyft(
    cx: Scope,
