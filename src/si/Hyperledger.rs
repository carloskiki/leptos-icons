#[cfg(feature = "SiHyperledger")]
use leptos::*;
#[cfg(feature = "SiHyperledger")]
///This icon requires the feature `SiHyperledger` to be enabled.
#[component]
pub fn Hyperledger(
    cx: Scope,
