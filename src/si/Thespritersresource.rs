#[cfg(feature = "SiThespritersresource")]
use leptos::*;
#[cfg(feature = "SiThespritersresource")]
///This icon requires the feature `SiThespritersresource` to be enabled.
#[component]
pub fn Thespritersresource(
    cx: Scope,
