#[cfg(feature = "SiJetpackcompose")]
use leptos::*;
#[cfg(feature = "SiJetpackcompose")]
///This icon requires the feature `SiJetpackcompose` to be enabled.
#[component]
pub fn Jetpackcompose(
    cx: Scope,
