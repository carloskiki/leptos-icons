#[cfg(feature = "SiCodecov")]
use leptos::*;
#[cfg(feature = "SiCodecov")]
///This icon requires the feature `SiCodecov` to be enabled.
#[component]
pub fn Codecov(
    cx: Scope,
