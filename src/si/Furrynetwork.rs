#[cfg(feature = "SiFurrynetwork")]
use leptos::*;
#[cfg(feature = "SiFurrynetwork")]
///This icon requires the feature `SiFurrynetwork` to be enabled.
#[component]
pub fn Furrynetwork(
    cx: Scope,
