#[cfg(feature = "SiBugatti")]
use leptos::*;
#[cfg(feature = "SiBugatti")]
///This icon requires the feature `SiBugatti` to be enabled.
#[component]
pub fn Bugatti(
    cx: Scope,
