...
pub fn FormatPainter(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683558243" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "11409" width = "200" height = "200"
        ...
        p - id = "11410" /> < title > { title } < / title > < / svg >
    }
}
