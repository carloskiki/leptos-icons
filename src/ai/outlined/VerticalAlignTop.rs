#[cfg(feature = "AiOutlinedVerticalAlignTop")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "AiOutlinedVerticalAlignTop")]
/// *This icon requires the feature* `AiOutlinedVerticalAlignTop` *to be enabled*.
#[component]
pub fn VerticalAlignTop(cx: Scope) -> impl IntoView {
   view! { cx,
