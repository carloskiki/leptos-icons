#[cfg(feature = "AiOutlinedFieldString")]
use leptos::*;
#[cfg(feature = "AiOutlinedFieldString")]
///This icon requires the feature `AiOutlinedFieldString` to be enabled.
#[component]
pub fn FieldString(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683607277" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "12118" width = "200" height = "200"
        ...
        p - id = "12119" />< path xmlns = "http://www.w3.org/2000/svg" xmlns : xlink =
        "http://www.w3.org/1999/xlink" d =
        "M877 729m-36 0a36 36 0 1 0 72 0 36 36 0 1 0-72 0Z" p - id = "12120" />< path
        xmlns = "http://www.w3.org/2000/svg" xmlns : xlink =
        "http://www.w3.org/1999/xlink" d =
        ...
        p - id = "12121" /> < title > { title } < / title > < / svg >
    }
}
