...
pub fn FieldNumber(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683604581" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "12000" width = "200" height = "200"
        ...
        p - id = "12001" /> < title > { title } < / title > < / svg >
    }
}
