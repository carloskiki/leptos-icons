#[cfg(feature = "AiOutlinedDeleteColumn")]
use leptos::*;
#[cfg(feature = "AiOutlinedDeleteColumn")]
///This icon requires the feature `AiOutlinedDeleteColumn` to be enabled.
#[component]
pub fn DeleteColumn(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683386799" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "10077" width = "200" height = "200"
        ...
        p - id = "10078" /> < title > { title } < / title > < / svg >
    }
}
