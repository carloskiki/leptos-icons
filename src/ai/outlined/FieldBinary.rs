#[cfg(feature = "AiOutlinedFieldBinary")]
use leptos::*;
#[cfg(feature = "AiOutlinedFieldBinary")]
///This icon requires the feature `AiOutlinedFieldBinary` to be enabled.
#[component]
pub fn FieldBinary(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683645783" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "12947" width = "200" height = "200"
        ...
        p - id = "12948" /> < title > { title } < / title > < / svg >
    }
}
