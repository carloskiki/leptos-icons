#[cfg(feature = "AiOutlinedConsoleSql")]
use leptos::*;
#[cfg(feature = "AiOutlinedConsoleSql")]
///This icon requires the feature `AiOutlinedConsoleSql` to be enabled.
#[component]
pub fn ConsoleSql(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683650778" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "13065" width = "200" height = "200"
        ...
        p - id = "13066" />< path xmlns = "http://www.w3.org/2000/svg" xmlns : xlink =
        ...
        p - id = "13067" />< path xmlns = "http://www.w3.org/2000/svg" xmlns : xlink =
        "http://www.w3.org/1999/xlink" d =
        ...
        p - id = "13068" /> < title > { title } < / title > < / svg >
    }
}
