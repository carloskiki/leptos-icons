#[cfg(feature = "AiOutlinedVerified")]
use leptos::*;
#[cfg(feature = "AiOutlinedVerified")]
///This icon requires the feature `AiOutlinedVerified` to be enabled.
#[component]
pub fn Verified(
    cx: Scope,
    ...
    view! {
        ...
        p - id = "14616" />< path xmlns = "http://www.w3.org/2000/svg" xmlns : xlink =
        "http://www.w3.org/1999/xlink" d =
        ...
        p - id = "14617" /> < title > { title } < / title > < / svg >
    }
}
