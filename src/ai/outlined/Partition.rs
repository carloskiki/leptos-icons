...
pub fn Partition(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style t = "1569683632175" class = "icon" viewBox =
        "0 0 1024 1024" version = "1.1" p - id = "12593" width = "200" height = "200"
        ...
        p - id = "12594" /> < title > { title } < / title > < / svg >
    }
}
