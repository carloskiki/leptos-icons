#[cfg(feature = "AiOutlinedLogin")]
use leptos::*;
#[cfg(feature = "AiOutlinedLogin")]
///This icon requires the feature `AiOutlinedLogin` to be enabled.
#[component]
pub fn Login(
    cx: Scope,
    ...
    view! {
        ...
        { size.clone() } height = { size } > < defs xmlns = "http://www.w3.org/2000/svg"
        >< style /></ defs >< path xmlns = "http://www.w3.org/2000/svg" d =
