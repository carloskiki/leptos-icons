#[cfg(feature = "AiTwotoneSound")]
use leptos::*;
#[cfg(feature = "AiTwotoneSound")]
///This icon requires the feature `AiTwotoneSound` to be enabled.
#[component]
pub fn Sound(
    cx: Scope,
    ...
    view! {
        ...
        "M275.4 424H146v176h129.4l18 11.7L586 803V221L293.3 412.3z" />< path xmlns =
