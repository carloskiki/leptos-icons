#[cfg(feature = "AiTwotoneSecurityScan")]
use leptos::*;
#[cfg(feature = "AiTwotoneSecurityScan")]
///This icon requires the feature `AiTwotoneSecurityScan` to be enabled.
#[component]
pub fn SecurityScan(
    cx: Scope,
    ...
    view! {
        ...
        "M460.7 451.1a80.1 80.1 0 1 0 160.2 0 80.1 80.1 0 1 0-160.2 0z" />< path xmlns =
