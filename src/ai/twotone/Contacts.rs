#[cfg(feature = "AiTwotoneContacts")]
use leptos::*;
#[cfg(feature = "AiTwotoneContacts")]
///This icon requires the feature `AiTwotoneContacts` to be enabled.
#[component]
pub fn Contacts(
    cx: Scope,
    ...
    view! {
        ...
        "#D9D9D9" d = "M460.3 526a51.7 52 0 1 0 103.4 0 51.7 52 0 1 0-103.4 0z" />< path
        xmlns = "http://www.w3.org/2000/svg" fill = "#D9D9D9" d =
