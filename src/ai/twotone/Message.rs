#[cfg(feature = "AiTwotoneMessage")]
use leptos::*;
#[cfg(feature = "AiTwotoneMessage")]
///This icon requires the feature `AiTwotoneMessage` to be enabled.
#[component]
pub fn Message(
    cx: Scope,
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M464 512a48 48 0 1 0 96 0 48 48 0 1 0-96 0z" /> < title > { title } < / title >
        < / svg >
    }
}
