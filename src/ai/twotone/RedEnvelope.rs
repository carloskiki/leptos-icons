#[cfg(feature = "AiTwotoneRedEnvelope")]
use leptos::*;
#[cfg(feature = "AiTwotoneRedEnvelope")]
///This icon requires the feature `AiTwotoneRedEnvelope` to be enabled.
#[component]
pub fn RedEnvelope(
    cx: Scope,
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" fill = "#E6E6E6" d =
        "M232 136.7h31.7L512 331.3l248.3-194.6H792v-.7H232z" />< path xmlns =
        "http://www.w3.org/2000/svg" fill = "#333" d =
