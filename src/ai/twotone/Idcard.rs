#[cfg(feature = "AiTwotoneIdcard")]
use leptos::*;
#[cfg(feature = "AiTwotoneIdcard")]
///This icon requires the feature `AiTwotoneIdcard` to be enabled.
#[component]
pub fn Idcard(
    cx: Scope,
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" fill = "#E6E6E6" d =
        "M321.3 463a51.7 52 0 1 0 103.4 0 51.7 52 0 1 0-103.4 0z" />< path xmlns =
