#[cfg(feature = "AiTwotoneInsurance")]
use leptos::*;
#[cfg(feature = "AiTwotoneInsurance")]
///This icon requires the feature `AiTwotoneInsurance` to be enabled.
#[component]
pub fn Insurance(
    cx: Scope,
    ...
    view! {
        ...
        "M521.9 358.8h97.9v41.6h-97.9z" />< path xmlns = "http://www.w3.org/2000/svg"
        fill = "#E6E6E6" d =
