...
use leptos::*;
#[cfg(feature = "BsZoomOut")]
///This icon requires the feature `BsZoomOut` to be enabled.
#[component]
pub fn ZoomOut(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-zoom-out" viewBox = "0 0 16 16" width = size.clone() height = size
        ...
        "M3 6.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z" /> < title > {
        title } < / title > < / svg >
    }
}
