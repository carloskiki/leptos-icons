...
use leptos::*;
#[cfg(feature = "BsPersonSquare")]
///This icon requires the feature `BsPersonSquare` to be enabled.
#[component]
pub fn PersonSquare(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-person-square" viewBox = "0 0 16 16" width = size.clone() height =
        size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />< path
