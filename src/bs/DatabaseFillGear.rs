...
use leptos::*;
#[cfg(feature = "BsDatabaseFillGear")]
///This icon requires the feature `BsDatabaseFillGear` to be enabled.
#[component]
pub fn DatabaseFillGear(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-database-fill-gear" viewBox = "0 0 16 16" width = size.clone()
