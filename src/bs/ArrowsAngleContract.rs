...
use leptos::*;
#[cfg(feature = "BsArrowsAngleContract")]
///This icon requires the feature `BsArrowsAngleContract` to be enabled.
#[component]
pub fn ArrowsAngleContract(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrows-angle-contract" viewBox = "0 0 16 16" width = size.clone()
