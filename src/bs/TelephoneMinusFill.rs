...
use leptos::*;
#[cfg(feature = "BsTelephoneMinusFill")]
///This icon requires the feature `BsTelephoneMinusFill` to be enabled.
#[component]
pub fn TelephoneMinusFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-telephone-minus-fill" viewBox = "0 0 16 16" width = size.clone()
