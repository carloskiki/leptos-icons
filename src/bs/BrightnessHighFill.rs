...
use leptos::*;
#[cfg(feature = "BsBrightnessHighFill")]
///This icon requires the feature `BsBrightnessHighFill` to be enabled.
#[component]
pub fn BrightnessHighFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-brightness-high-fill" viewBox = "0 0 16 16" width = size.clone()
