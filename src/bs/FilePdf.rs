...
use leptos::*;
#[cfg(feature = "BsFilePdf")]
///This icon requires the feature `BsFilePdf` to be enabled.
#[component]
pub fn FilePdf(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-file-pdf" viewBox = "0 0 16 16" width = size.clone() height = size
