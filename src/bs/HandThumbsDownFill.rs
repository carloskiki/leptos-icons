...
use leptos::*;
#[cfg(feature = "BsHandThumbsDownFill")]
///This icon requires the feature `BsHandThumbsDownFill` to be enabled.
#[component]
pub fn HandThumbsDownFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-hand-thumbs-down-fill" viewBox = "0 0 16 16" width = size.clone()
