...
use leptos::*;
#[cfg(feature = "BsArrowUpCircleFill")]
///This icon requires the feature `BsArrowUpCircleFill` to be enabled.
#[component]
pub fn ArrowUpCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-up-circle-fill" viewBox = "0 0 16 16" width = size.clone()
