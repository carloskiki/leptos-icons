...
use leptos::*;
#[cfg(feature = "BsArrowDownCircleFill")]
///This icon requires the feature `BsArrowDownCircleFill` to be enabled.
#[component]
pub fn ArrowDownCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-down-circle-fill" viewBox = "0 0 16 16" width = size.clone()
