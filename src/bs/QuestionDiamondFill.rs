...
use leptos::*;
#[cfg(feature = "BsQuestionDiamondFill")]
///This icon requires the feature `BsQuestionDiamondFill` to be enabled.
#[component]
pub fn QuestionDiamondFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-question-diamond-fill" viewBox = "0 0 16 16" width = size.clone()
