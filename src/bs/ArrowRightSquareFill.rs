...
use leptos::*;
#[cfg(feature = "BsArrowRightSquareFill")]
///This icon requires the feature `BsArrowRightSquareFill` to be enabled.
#[component]
pub fn ArrowRightSquareFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-right-square-fill" viewBox = "0 0 16 16" width = size
