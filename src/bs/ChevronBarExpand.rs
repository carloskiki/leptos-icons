...
use leptos::*;
#[cfg(feature = "BsChevronBarExpand")]
///This icon requires the feature `BsChevronBarExpand` to be enabled.
#[component]
pub fn ChevronBarExpand(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-chevron-bar-expand" viewBox = "0 0 16 16" width = { size.clone() }
