...
use leptos::*;
#[cfg(feature = "BsSkipBackwardFill")]
///This icon requires the feature `BsSkipBackwardFill` to be enabled.
#[component]
pub fn SkipBackwardFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-skip-backward-fill" viewBox = "0 0 16 16" width = size.clone()
