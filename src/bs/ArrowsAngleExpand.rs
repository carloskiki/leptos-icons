...
use leptos::*;
#[cfg(feature = "BsArrowsAngleExpand")]
///This icon requires the feature `BsArrowsAngleExpand` to be enabled.
#[component]
pub fn ArrowsAngleExpand(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrows-angle-expand" viewBox = "0 0 16 16" width = size.clone()
