...
use leptos::*;
#[cfg(feature = "BsExclamationCircleFill")]
///This icon requires the feature `BsExclamationCircleFill` to be enabled.
#[component]
pub fn ExclamationCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-exclamation-circle-fill" viewBox = "0 0 16 16" width = size
