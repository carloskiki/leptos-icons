...
use leptos::*;
#[cfg(feature = "BsQuestionCircleFill")]
///This icon requires the feature `BsQuestionCircleFill` to be enabled.
#[component]
pub fn QuestionCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-question-circle-fill" viewBox = "0 0 16 16" width = size.clone()
