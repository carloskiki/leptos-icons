...
use leptos::*;
#[cfg(feature = "BsBrowserFirefox")]
///This icon requires the feature `BsBrowserFirefox` to be enabled.
#[component]
pub fn BrowserFirefox(
    cx: Scope,
