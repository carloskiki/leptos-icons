...
use leptos::*;
#[cfg(feature = "BsFileEarmarkMedical")]
///This icon requires the feature `BsFileEarmarkMedical` to be enabled.
#[component]
pub fn FileEarmarkMedical(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-file-earmark-medical" viewBox = "0 0 16 16" width = size.clone()
