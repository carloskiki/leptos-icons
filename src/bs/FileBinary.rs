...
use leptos::*;
#[cfg(feature = "BsFileBinary")]
///This icon requires the feature `BsFileBinary` to be enabled.
#[component]
pub fn FileBinary(
    cx: Scope,
