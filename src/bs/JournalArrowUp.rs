...
use leptos::*;
#[cfg(feature = "BsJournalArrowUp")]
///This icon requires the feature `BsJournalArrowUp` to be enabled.
#[component]
pub fn JournalArrowUp(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-journal-arrow-up" viewBox = "0 0 16 16" width = { size.clone() }
        height = { size } > < path xmlns = "http://www.w3.org/2000/svg" fill - rule =
        "evenodd" d =
        "M8 11a.5.5 0 0 0 .5-.5V6.707l1.146 1.147a.5.5 0 0 0 .708-.708l-2-2a.5.5 0 0 0-.708 0l-2 2a.5.5 0 1 0 .708.708L7.5 6.707V10.5a.5.5 0 0 0 .5.5z"
