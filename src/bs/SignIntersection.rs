...
pub fn SignIntersection(
    ...
    view! {
        ...
        class = "bi bi-sign-intersection" viewBox = "0 0 16 16" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M7.25 4v3.25H4v1.5h3.25V12h1.5V8.75H12v-1.5H8.75V4h-1.5Z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
