...
use leptos::*;
#[cfg(feature = "BsHandThumbsUpFill")]
///This icon requires the feature `BsHandThumbsUpFill` to be enabled.
#[component]
pub fn HandThumbsUpFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-hand-thumbs-up-fill" viewBox = "0 0 16 16" width = { size.clone()
