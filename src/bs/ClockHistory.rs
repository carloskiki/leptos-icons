...
use leptos::*;
#[cfg(feature = "BsClockHistory")]
///This icon requires the feature `BsClockHistory` to be enabled.
#[component]
pub fn ClockHistory(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-clock-history" viewBox = "0 0 16 16" width = size.clone() height =
        ...
        "M8 1a7 7 0 1 0 4.95 11.95l.707.707A8.001 8.001 0 1 1 8 0v1z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
