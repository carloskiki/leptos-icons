...
use leptos::*;
#[cfg(feature = "BsArrowsFullscreen")]
///This icon requires the feature `BsArrowsFullscreen` to be enabled.
#[component]
pub fn ArrowsFullscreen(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrows-fullscreen" viewBox = "0 0 16 16" width = size.clone()
