...
use leptos::*;
#[cfg(feature = "BsExclamationDiamond")]
///This icon requires the feature `BsExclamationDiamond` to be enabled.
#[component]
pub fn ExclamationDiamond(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-exclamation-diamond" viewBox = "0 0 16 16" width = { size.clone()
