...
use leptos::*;
#[cfg(feature = "BsQuestionOctagonFill")]
///This icon requires the feature `BsQuestionOctagonFill` to be enabled.
#[component]
pub fn QuestionOctagonFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-question-octagon-fill" viewBox = "0 0 16 16" width = size.clone()
