...
use leptos::*;
#[cfg(feature = "BsExclamationSquare")]
///This icon requires the feature `BsExclamationSquare` to be enabled.
#[component]
pub fn ExclamationSquare(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-exclamation-square" viewBox = "0 0 16 16" width = size.clone()
