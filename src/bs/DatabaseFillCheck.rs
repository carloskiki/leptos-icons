...
use leptos::*;
#[cfg(feature = "BsDatabaseFillCheck")]
///This icon requires the feature `BsDatabaseFillCheck` to be enabled.
#[component]
pub fn DatabaseFillCheck(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-database-fill-check" viewBox = "0 0 16 16" width = size.clone()
