...
use leptos::*;
#[cfg(feature = "BsPostcardHeartFill")]
///This icon requires the feature `BsPostcardHeartFill` to be enabled.
#[component]
pub fn PostcardHeartFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-postcard-heart-fill" viewBox = "0 0 16 16" width = size.clone()
