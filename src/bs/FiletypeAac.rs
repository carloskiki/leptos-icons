...
use leptos::*;
#[cfg(feature = "BsFiletypeAac")]
///This icon requires the feature `BsFiletypeAac` to be enabled.
#[component]
pub fn FiletypeAac(
    cx: Scope,
