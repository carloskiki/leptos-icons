...
use leptos::*;
#[cfg(feature = "BsFileRichtextFill")]
///This icon requires the feature `BsFileRichtextFill` to be enabled.
#[component]
pub fn FileRichtextFill(
    cx: Scope,
