...
use leptos::*;
#[cfg(feature = "BsBrowserSafari")]
///This icon requires the feature `BsBrowserSafari` to be enabled.
#[component]
pub fn BrowserSafari(
    cx: Scope,
