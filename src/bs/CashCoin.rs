...
use leptos::*;
#[cfg(feature = "BsCashCoin")]
///This icon requires the feature `BsCashCoin` to be enabled.
#[component]
pub fn CashCoin(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-cash-coin" viewBox = "0 0 16 16" width = { size.clone() } height =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z" /> < title
        > { title } < / title > < / svg >
    }
}
