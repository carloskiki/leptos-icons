...
use leptos::*;
#[cfg(feature = "BsEvFront")]
///This icon requires the feature `BsEvFront` to be enabled.
#[component]
pub fn EvFront(
    cx: Scope,
