...
use leptos::*;
#[cfg(feature = "BsInputCursor")]
///This icon requires the feature `BsInputCursor` to be enabled.
#[component]
pub fn InputCursor(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-input-cursor" viewBox = "0 0 16 16" width = size.clone() height =
        ...
        "M8 1a.5.5 0 0 1 .5.5v13a.5.5 0 0 1-1 0v-13A.5.5 0 0 1 8 1z" /> < title > { title
        } < / title > < / svg >
    }
}
