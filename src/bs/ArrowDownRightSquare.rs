...
use leptos::*;
#[cfg(feature = "BsArrowDownRightSquare")]
///This icon requires the feature `BsArrowDownRightSquare` to be enabled.
#[component]
pub fn ArrowDownRightSquare(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-down-right-square" viewBox = "0 0 16 16" width = { size
