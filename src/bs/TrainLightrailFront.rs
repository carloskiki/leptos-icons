...
use leptos::*;
#[cfg(feature = "BsTrainLightrailFront")]
///This icon requires the feature `BsTrainLightrailFront` to be enabled.
#[component]
pub fn TrainLightrailFront(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-train-lightrail-front" viewBox = "0 0 16 16" width = size.clone()
