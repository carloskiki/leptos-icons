...
use leptos::*;
#[cfg(feature = "BsChatRightDotsFill")]
///This icon requires the feature `BsChatRightDotsFill` to be enabled.
#[component]
pub fn ChatRightDotsFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-chat-right-dots-fill" viewBox = "0 0 16 16" width = size.clone()
