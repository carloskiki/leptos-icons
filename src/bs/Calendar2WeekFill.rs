...
use leptos::*;
#[cfg(feature = "BsCalendar2WeekFill")]
///This icon requires the feature `BsCalendar2WeekFill` to be enabled.
#[component]
pub fn Calendar2WeekFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calendar2-week-fill" viewBox = "0 0 16 16" width = { size.clone()
