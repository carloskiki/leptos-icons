...
use leptos::*;
#[cfg(feature = "BsCardImage")]
///This icon requires the feature `BsCardImage` to be enabled.
#[component]
pub fn CardImage(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-card-image" viewBox = "0 0 16 16" width = size.clone() height =
        size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
