...
use leptos::*;
#[cfg(feature = "BsMarkdown")]
///This icon requires the feature `BsMarkdown` to be enabled.
#[component]
pub fn Markdown(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-markdown" viewBox = "0 0 16 16" width = size.clone() height = size
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" fill - rule = "evenodd" d =
        "M11.5 5a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 1 .5-.5z" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
