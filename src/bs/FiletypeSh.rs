...
use leptos::*;
#[cfg(feature = "BsFiletypeSh")]
///This icon requires the feature `BsFiletypeSh` to be enabled.
#[component]
pub fn FiletypeSh(
    cx: Scope,
