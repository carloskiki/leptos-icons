...
use leptos::*;
#[cfg(feature = "BsEnvelopeCheckFill")]
///This icon requires the feature `BsEnvelopeCheckFill` to be enabled.
#[component]
pub fn EnvelopeCheckFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-envelope-check-fill" viewBox = "0 0 16 16" width = size.clone()
