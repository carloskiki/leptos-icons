...
use leptos::*;
#[cfg(feature = "BsShieldFillExclamation")]
///This icon requires the feature `BsShieldFillExclamation` to be enabled.
#[component]
pub fn ShieldFillExclamation(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-shield-fill-exclamation" viewBox = "0 0 16 16" width = { size
