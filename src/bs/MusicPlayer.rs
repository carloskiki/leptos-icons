...
use leptos::*;
#[cfg(feature = "BsMusicPlayer")]
///This icon requires the feature `BsMusicPlayer` to be enabled.
#[component]
pub fn MusicPlayer(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-music-player" viewBox = "0 0 16 16" width = size.clone() height =
        ...
        "M11 11a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-3 2a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />< path
