...
use leptos::*;
#[cfg(feature = "BsFiletypePsd")]
///This icon requires the feature `BsFiletypePsd` to be enabled.
#[component]
pub fn FiletypePsd(
    cx: Scope,
