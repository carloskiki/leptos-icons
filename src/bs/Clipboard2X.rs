...
pub fn Clipboard2X(
    ...
    view! {
        ...
        class = "bi bi-clipboard2-x" viewBox = "0 0 16 16" width = size.clone() height =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M8 8.293 6.854 7.146a.5.5 0 1 0-.708.708L7.293 9l-1.147 1.146a.5.5 0 0 0 .708.708L8 9.707l1.146 1.147a.5.5 0 0 0 .708-.708L8.707 9l1.147-1.146a.5.5 0 0 0-.708-.708L8 8.293Z"
