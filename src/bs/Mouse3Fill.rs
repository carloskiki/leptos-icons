...
use leptos::*;
#[cfg(feature = "BsMouse3Fill")]
///This icon requires the feature `BsMouse3Fill` to be enabled.
#[component]
pub fn Mouse3Fill(
    cx: Scope,
