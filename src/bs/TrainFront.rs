...
use leptos::*;
#[cfg(feature = "BsTrainFront")]
///This icon requires the feature `BsTrainFront` to be enabled.
#[component]
pub fn TrainFront(
    cx: Scope,
