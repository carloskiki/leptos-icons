...
use leptos::*;
#[cfg(feature = "BsBarChartLineFill")]
///This icon requires the feature `BsBarChartLineFill` to be enabled.
#[component]
pub fn BarChartLineFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-bar-chart-line-fill" viewBox = "0 0 16 16" width = size.clone()
