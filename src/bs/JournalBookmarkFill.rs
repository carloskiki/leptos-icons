...
use leptos::*;
#[cfg(feature = "BsJournalBookmarkFill")]
///This icon requires the feature `BsJournalBookmarkFill` to be enabled.
#[component]
pub fn JournalBookmarkFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-journal-bookmark-fill" viewBox = "0 0 16 16" width = { size
        .clone() } height = { size } > < path xmlns = "http://www.w3.org/2000/svg" fill -
        rule = "evenodd" d =
        "M6 1h6v7a.5.5 0 0 1-.757.429L9 7.083 6.757 8.43A.5.5 0 0 1 6 8V1z" />< path
