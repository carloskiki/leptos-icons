...
use leptos::*;
#[cfg(feature = "BsPatchMinus")]
///This icon requires the feature `BsPatchMinus` to be enabled.
#[component]
pub fn PatchMinus(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-patch-minus" viewBox = "0 0 16 16" width = { size.clone() } height
        = { size } > < path xmlns = "http://www.w3.org/2000/svg" fill - rule = "evenodd"
        d = "M5.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1-.5-.5z" />< path xmlns
