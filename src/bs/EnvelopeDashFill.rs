...
use leptos::*;
#[cfg(feature = "BsEnvelopeDashFill")]
///This icon requires the feature `BsEnvelopeDashFill` to be enabled.
#[component]
pub fn EnvelopeDashFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-envelope-dash-fill" viewBox = "0 0 16 16" width = size.clone()
