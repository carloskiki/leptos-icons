...
use leptos::*;
#[cfg(feature = "BsCalendar2MonthFill")]
///This icon requires the feature `BsCalendar2MonthFill` to be enabled.
#[component]
pub fn Calendar2MonthFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calendar2-month-fill" viewBox = "0 0 16 16" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M4.104 7.805 4.9 10.18H3.284l.8-2.375h.02zm9.074 2.297c0-.832-.414-1.36-1.062-1.36-.692 0-1.098.492-1.098 1.36v.253c0 .852.406 1.364 1.098 1.364.671 0 1.062-.516 1.062-1.364v-.253z"
