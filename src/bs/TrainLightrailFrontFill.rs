...
use leptos::*;
#[cfg(feature = "BsTrainLightrailFrontFill")]
///This icon requires the feature `BsTrainLightrailFrontFill` to be enabled.
#[component]
pub fn TrainLightrailFrontFill(
    cx: Scope,
