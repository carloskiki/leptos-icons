...
use leptos::*;
#[cfg(feature = "BsSuitClub")]
///This icon requires the feature `BsSuitClub` to be enabled.
#[component]
pub fn SuitClub(
    cx: Scope,
