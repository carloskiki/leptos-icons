...
use leptos::*;
#[cfg(feature = "BsTruckFrontFill")]
///This icon requires the feature `BsTruckFrontFill` to be enabled.
#[component]
pub fn TruckFrontFill(
    cx: Scope,
