...
use leptos::*;
#[cfg(feature = "BsChevronBarContract")]
///This icon requires the feature `BsChevronBarContract` to be enabled.
#[component]
pub fn ChevronBarContract(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-chevron-bar-contract" viewBox = "0 0 16 16" width = size.clone()
