...
use leptos::*;
#[cfg(feature = "BsRepeat1")]
///This icon requires the feature `BsRepeat1` to be enabled.
#[component]
pub fn Repeat1(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-repeat-1" viewBox = "0 0 16 16" width = size.clone() height = size
        ...
        "M9 5.5a.5.5 0 0 0-.854-.354l-1.75 1.75a.5.5 0 1 0 .708.708L8 6.707V10.5a.5.5 0 0 0 1 0v-5Z"
