...
use leptos::*;
#[cfg(feature = "BsCalendarDateFill")]
///This icon requires the feature `BsCalendarDateFill` to be enabled.
#[component]
pub fn CalendarDateFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calendar-date-fill" viewBox = "0 0 16 16" width = size.clone()
