...
use leptos::*;
#[cfg(feature = "BsCalendar2CheckFill")]
///This icon requires the feature `BsCalendar2CheckFill` to be enabled.
#[component]
pub fn Calendar2CheckFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calendar2-check-fill" viewBox = "0 0 16 16" width = { size.clone()
