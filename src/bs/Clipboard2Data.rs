...
use leptos::*;
#[cfg(feature = "BsClipboard2Data")]
///This icon requires the feature `BsClipboard2Data` to be enabled.
#[component]
pub fn Clipboard2Data(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-clipboard2-data" viewBox = "0 0 16 16" width = size.clone() height
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M10 7a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7Zm-6 4a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1Zm4-3a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1Z"
