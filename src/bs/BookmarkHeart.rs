...
use leptos::*;
#[cfg(feature = "BsBookmarkHeart")]
///This icon requires the feature `BsBookmarkHeart` to be enabled.
#[component]
pub fn BookmarkHeart(
    ...
    view! {
        ...
        class = "bi bi-bookmark-heart" viewBox = "0 0 16 16" width = size.clone() height
        = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" d =
        "M8 4.41c1.387-1.425 4.854 1.07 0 4.277C3.146 5.48 6.613 2.986 8 4.412z" />< path
