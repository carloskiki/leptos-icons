...
use leptos::*;
#[cfg(feature = "BsSignDoNotEnter")]
///This icon requires the feature `BsSignDoNotEnter` to be enabled.
#[component]
pub fn SignDoNotEnter(
    cx: Scope,
