...
use leptos::*;
#[cfg(feature = "BsEmojiSmileUpsideDownFill")]
///This icon requires the feature `BsEmojiSmileUpsideDownFill` to be enabled.
#[component]
pub fn EmojiSmileUpsideDownFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-emoji-smile-upside-down-fill" viewBox = "0 0 16 16" width = { size
