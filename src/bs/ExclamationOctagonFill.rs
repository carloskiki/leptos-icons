...
use leptos::*;
#[cfg(feature = "BsExclamationOctagonFill")]
///This icon requires the feature `BsExclamationOctagonFill` to be enabled.
#[component]
pub fn ExclamationOctagonFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-exclamation-octagon-fill" viewBox = "0 0 16 16" width = size
