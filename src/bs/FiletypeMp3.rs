...
use leptos::*;
#[cfg(feature = "BsFiletypeMp3")]
///This icon requires the feature `BsFiletypeMp3` to be enabled.
#[component]
pub fn FiletypeMp3(
    cx: Scope,
