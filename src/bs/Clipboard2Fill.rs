...
use leptos::*;
#[cfg(feature = "BsClipboard2Fill")]
///This icon requires the feature `BsClipboard2Fill` to be enabled.
#[component]
pub fn Clipboard2Fill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-clipboard2-fill" viewBox = "0 0 16 16" width = size.clone() height
