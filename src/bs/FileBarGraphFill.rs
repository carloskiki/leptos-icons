...
use leptos::*;
#[cfg(feature = "BsFileBarGraphFill")]
///This icon requires the feature `BsFileBarGraphFill` to be enabled.
#[component]
pub fn FileBarGraphFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-file-bar-graph-fill" viewBox = "0 0 16 16" width = size.clone()
