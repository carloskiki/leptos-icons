...
use leptos::*;
#[cfg(feature = "BsZoomIn")]
///This icon requires the feature `BsZoomIn` to be enabled.
#[component]
pub fn ZoomIn(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-zoom-in" viewBox = "0 0 16 16" width = size.clone() height = size
        ...
        "M6.5 3a.5.5 0 0 1 .5.5V6h2.5a.5.5 0 0 1 0 1H7v2.5a.5.5 0 0 1-1 0V7H3.5a.5.5 0 0 1 0-1H6V3.5a.5.5 0 0 1 .5-.5z"
