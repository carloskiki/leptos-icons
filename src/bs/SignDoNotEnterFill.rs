...
use leptos::*;
#[cfg(feature = "BsSignDoNotEnterFill")]
///This icon requires the feature `BsSignDoNotEnterFill` to be enabled.
#[component]
pub fn SignDoNotEnterFill(
    cx: Scope,
