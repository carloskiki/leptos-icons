...
use leptos::*;
#[cfg(feature = "BsVolumeUp")]
///This icon requires the feature `BsVolumeUp` to be enabled.
#[component]
pub fn VolumeUp(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-volume-up" viewBox = "0 0 16 16" width = { size.clone() } height =
