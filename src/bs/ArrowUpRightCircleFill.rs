...
use leptos::*;
#[cfg(feature = "BsArrowUpRightCircleFill")]
///This icon requires the feature `BsArrowUpRightCircleFill` to be enabled.
#[component]
pub fn ArrowUpRightCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-up-right-circle-fill" viewBox = "0 0 16 16" width = size
