...
use leptos::*;
#[cfg(feature = "BsFullscreenExit")]
///This icon requires the feature `BsFullscreenExit` to be enabled.
#[component]
pub fn FullscreenExit(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-fullscreen-exit" viewBox = "0 0 16 16" width = size.clone() height
