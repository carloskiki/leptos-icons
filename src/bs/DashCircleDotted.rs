...
use leptos::*;
#[cfg(feature = "BsDashCircleDotted")]
///This icon requires the feature `BsDashCircleDotted` to be enabled.
#[component]
pub fn DashCircleDotted(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-dash-circle-dotted" viewBox = "0 0 16 16" width = { size.clone() }
