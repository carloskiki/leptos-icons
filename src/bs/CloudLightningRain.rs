...
use leptos::*;
#[cfg(feature = "BsCloudLightningRain")]
///This icon requires the feature `BsCloudLightningRain` to be enabled.
#[component]
pub fn CloudLightningRain(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-cloud-lightning-rain" viewBox = "0 0 16 16" width = size.clone()
