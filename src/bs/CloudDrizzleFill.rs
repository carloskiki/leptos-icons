...
use leptos::*;
#[cfg(feature = "BsCloudDrizzleFill")]
///This icon requires the feature `BsCloudDrizzleFill` to be enabled.
#[component]
pub fn CloudDrizzleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-cloud-drizzle-fill" viewBox = "0 0 16 16" width = size.clone()
