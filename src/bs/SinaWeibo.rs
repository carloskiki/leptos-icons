...
use leptos::*;
#[cfg(feature = "BsSinaWeibo")]
///This icon requires the feature `BsSinaWeibo` to be enabled.
#[component]
pub fn SinaWeibo(
    cx: Scope,
