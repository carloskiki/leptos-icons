...
use leptos::*;
#[cfg(feature = "BsBrightnessAltHighFill")]
///This icon requires the feature `BsBrightnessAltHighFill` to be enabled.
#[component]
pub fn BrightnessAltHighFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-brightness-alt-high-fill" viewBox = "0 0 16 16" width = { size
