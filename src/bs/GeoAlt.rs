...
use leptos::*;
#[cfg(feature = "BsGeoAlt")]
///This icon requires the feature `BsGeoAlt` to be enabled.
#[component]
pub fn GeoAlt(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-geo-alt" viewBox = "0 0 16 16" width = size.clone() height = size
        ...
        "M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /> < title >
        { title } < / title > < / svg >
    }
}
