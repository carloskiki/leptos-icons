...
use leptos::*;
#[cfg(feature = "BsMicMuteFill")]
///This icon requires the feature `BsMicMuteFill` to be enabled.
#[component]
pub fn MicMuteFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-mic-mute-fill" viewBox = "0 0 16 16" width = size.clone() height =
        ...
        "M9.486 10.607 5 6.12V8a3 3 0 0 0 4.486 2.607zm-7.84-9.253 12 12 .708-.708-12-12-.708.708z"
