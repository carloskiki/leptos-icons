...
use leptos::*;
#[cfg(feature = "BsClipboardMinus")]
///This icon requires the feature `BsClipboardMinus` to be enabled.
#[component]
pub fn ClipboardMinus(
    ...
    view! {
        ...
        class = "bi bi-clipboard-minus" viewBox = "0 0 16 16" width = size.clone() height
        = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" fill - rule = "evenodd" d =
        "M5.5 9.5A.5.5 0 0 1 6 9h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1-.5-.5z" />< path xmlns =
