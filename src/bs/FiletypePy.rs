...
use leptos::*;
#[cfg(feature = "BsFiletypePy")]
///This icon requires the feature `BsFiletypePy` to be enabled.
#[component]
pub fn FiletypePy(
    cx: Scope,
