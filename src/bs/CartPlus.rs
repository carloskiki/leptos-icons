...
use leptos::*;
#[cfg(feature = "BsCartPlus")]
///This icon requires the feature `BsCartPlus` to be enabled.
#[component]
pub fn CartPlus(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-cart-plus" viewBox = "0 0 16 16" width = { size.clone() } height =
        { size } > < path xmlns = "http://www.w3.org/2000/svg" d =
        "M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z"
