...
use leptos::*;
#[cfg(feature = "BsBrightnessAltHigh")]
///This icon requires the feature `BsBrightnessAltHigh` to be enabled.
#[component]
pub fn BrightnessAltHigh(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-brightness-alt-high" viewBox = "0 0 16 16" width = size.clone()
