...
use leptos::*;
#[cfg(feature = "BsCalendar2EventFill")]
///This icon requires the feature `BsCalendar2EventFill` to be enabled.
#[component]
pub fn Calendar2EventFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calendar2-event-fill" viewBox = "0 0 16 16" width = size.clone()
