...
use leptos::*;
#[cfg(feature = "BsEnvelopePlusFill")]
///This icon requires the feature `BsEnvelopePlusFill` to be enabled.
#[component]
pub fn EnvelopePlusFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-envelope-plus-fill" viewBox = "0 0 16 16" width = size.clone()
