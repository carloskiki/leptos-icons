...
use leptos::*;
#[cfg(feature = "BsArrowUpSquareFill")]
///This icon requires the feature `BsArrowUpSquareFill` to be enabled.
#[component]
pub fn ArrowUpSquareFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-up-square-fill" viewBox = "0 0 16 16" width = size.clone()
