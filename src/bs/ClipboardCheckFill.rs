...
use leptos::*;
#[cfg(feature = "BsClipboardCheckFill")]
///This icon requires the feature `BsClipboardCheckFill` to be enabled.
#[component]
pub fn ClipboardCheckFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-clipboard-check-fill" viewBox = "0 0 16 16" width = { size.clone()
