...
use leptos::*;
#[cfg(feature = "BsArrowRightCircleFill")]
///This icon requires the feature `BsArrowRightCircleFill` to be enabled.
#[component]
pub fn ArrowRightCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-right-circle-fill" viewBox = "0 0 16 16" width = size
