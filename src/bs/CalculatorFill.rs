...
use leptos::*;
#[cfg(feature = "BsCalculatorFill")]
///This icon requires the feature `BsCalculatorFill` to be enabled.
#[component]
pub fn CalculatorFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-calculator-fill" viewBox = "0 0 16 16" width = size.clone() height
