...
use leptos::*;
#[cfg(feature = "BsChevronCompactDown")]
///This icon requires the feature `BsChevronCompactDown` to be enabled.
#[component]
pub fn ChevronCompactDown(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-chevron-compact-down" viewBox = "0 0 16 16" width = size.clone()
