...
use leptos::*;
#[cfg(feature = "BsLayoutTextWindowReverse")]
///This icon requires the feature `BsLayoutTextWindowReverse` to be enabled.
#[component]
pub fn LayoutTextWindowReverse(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-layout-text-window-reverse" viewBox = "0 0 16 16" width = { size
