...
use leptos::*;
#[cfg(feature = "BsFiletypeCs")]
///This icon requires the feature `BsFiletypeCs` to be enabled.
#[component]
pub fn FiletypeCs(
    cx: Scope,
