...
use leptos::*;
#[cfg(feature = "BsFileEarmarkLock2Fill")]
///This icon requires the feature `BsFileEarmarkLock2Fill` to be enabled.
#[component]
pub fn FileEarmarkLock2Fill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-file-earmark-lock2-fill" viewBox = "0 0 16 16" width = { size
        .clone() } height = { size } > < path xmlns = "http://www.w3.org/2000/svg" d =
        "M7 7a1 1 0 0 1 2 0v1H7V7z" />< path xmlns = "http://www.w3.org/2000/svg" d =
