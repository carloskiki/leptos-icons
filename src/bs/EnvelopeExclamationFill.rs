...
use leptos::*;
#[cfg(feature = "BsEnvelopeExclamationFill")]
///This icon requires the feature `BsEnvelopeExclamationFill` to be enabled.
#[component]
pub fn EnvelopeExclamationFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-envelope-exclamation-fill" viewBox = "0 0 16 16" width = size
