...
use leptos::*;
#[cfg(feature = "BsJournalArrowDown")]
///This icon requires the feature `BsJournalArrowDown` to be enabled.
#[component]
pub fn JournalArrowDown(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-journal-arrow-down" viewBox = "0 0 16 16" width = { size.clone() }
