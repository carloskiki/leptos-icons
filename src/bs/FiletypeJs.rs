...
use leptos::*;
#[cfg(feature = "BsFiletypeJs")]
///This icon requires the feature `BsFiletypeJs` to be enabled.
#[component]
pub fn FiletypeJs(
    cx: Scope,
