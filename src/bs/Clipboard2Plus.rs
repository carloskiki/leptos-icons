...
pub fn Clipboard2Plus(
    ...
    view! {
        ...
        class = "bi bi-clipboard2-plus" viewBox = "0 0 16 16" width = size.clone() height
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M8.5 6.5a.5.5 0 0 0-1 0V8H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V9H10a.5.5 0 0 0 0-1H8.5V6.5Z"
