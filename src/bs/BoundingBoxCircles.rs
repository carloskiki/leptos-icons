...
use leptos::*;
#[cfg(feature = "BsBoundingBoxCircles")]
///This icon requires the feature `BsBoundingBoxCircles` to be enabled.
#[component]
pub fn BoundingBoxCircles(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-bounding-box-circles" viewBox = "0 0 16 16" width = size.clone()
