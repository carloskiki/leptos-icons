...
use leptos::*;
#[cfg(feature = "BsBrightnessLowFill")]
///This icon requires the feature `BsBrightnessLowFill` to be enabled.
#[component]
pub fn BrightnessLowFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-brightness-low-fill" viewBox = "0 0 16 16" width = size.clone()
