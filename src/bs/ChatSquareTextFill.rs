...
use leptos::*;
#[cfg(feature = "BsChatSquareTextFill")]
///This icon requires the feature `BsChatSquareTextFill` to be enabled.
#[component]
pub fn ChatSquareTextFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-chat-square-text-fill" viewBox = "0 0 16 16" width = size.clone()
