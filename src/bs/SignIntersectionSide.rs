...
pub fn SignIntersectionSide(
    ...
    view! {
        ...
        class = "bi bi-sign-intersection-side" viewBox = "0 0 16 16" width = size.clone()
        height = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d = "M6.25 4v8h1.5V8.75H11v-1.5H7.75V4h-1.5Z" /><
