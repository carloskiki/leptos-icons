...
use leptos::*;
#[cfg(feature = "BsClipboardData")]
///This icon requires the feature `BsClipboardData` to be enabled.
#[component]
pub fn ClipboardData(
    ...
    view! {
        ...
        class = "bi bi-clipboard-data" viewBox = "0 0 16 16" width = size.clone() height
        = size xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0V9z"
