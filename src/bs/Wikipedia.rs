...
use leptos::*;
#[cfg(feature = "BsWikipedia")]
///This icon requires the feature `BsWikipedia` to be enabled.
#[component]
pub fn Wikipedia(
    cx: Scope,
