...
use leptos::*;
#[cfg(feature = "BsFiletypeOtf")]
///This icon requires the feature `BsFiletypeOtf` to be enabled.
#[component]
pub fn FiletypeOtf(
    cx: Scope,
