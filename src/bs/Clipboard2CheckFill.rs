...
use leptos::*;
#[cfg(feature = "BsClipboard2CheckFill")]
///This icon requires the feature `BsClipboard2CheckFill` to be enabled.
#[component]
pub fn Clipboard2CheckFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-clipboard2-check-fill" viewBox = "0 0 16 16" width = size.clone()
