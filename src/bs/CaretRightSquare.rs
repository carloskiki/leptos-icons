...
use leptos::*;
#[cfg(feature = "BsCaretRightSquare")]
///This icon requires the feature `BsCaretRightSquare` to be enabled.
#[component]
pub fn CaretRightSquare(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-caret-right-square" viewBox = "0 0 16 16" width = size.clone()
