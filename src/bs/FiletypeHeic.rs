...
use leptos::*;
#[cfg(feature = "BsFiletypeHeic")]
///This icon requires the feature `BsFiletypeHeic` to be enabled.
#[component]
pub fn FiletypeHeic(
    cx: Scope,
