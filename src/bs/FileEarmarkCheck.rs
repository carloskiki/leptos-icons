...
use leptos::*;
#[cfg(feature = "BsFileEarmarkCheck")]
///This icon requires the feature `BsFileEarmarkCheck` to be enabled.
#[component]
pub fn FileEarmarkCheck(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-file-earmark-check" viewBox = "0 0 16 16" width = size.clone()
