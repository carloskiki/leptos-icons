...
use leptos::*;
#[cfg(feature = "BsFiletypeMov")]
///This icon requires the feature `BsFiletypeMov` to be enabled.
#[component]
pub fn FiletypeMov(
    cx: Scope,
