...
use leptos::*;
#[cfg(feature = "BsPatchQuestion")]
///This icon requires the feature `BsPatchQuestion` to be enabled.
#[component]
pub fn PatchQuestion(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-patch-question" viewBox = "0 0 16 16" width = size.clone() height
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0z" /> < title > { title } < / title > < /
        svg >
    }
}
