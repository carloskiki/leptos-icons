...
use leptos::*;
#[cfg(feature = "BsSignIntersectionT")]
///This icon requires the feature `BsSignIntersectionT` to be enabled.
#[component]
pub fn SignIntersectionT(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-sign-intersection-t" viewBox = "0 0 16 16" width = { size.clone()
        } height = { size } > < path xmlns = "http://www.w3.org/2000/svg" d =
        "M5 5v1.5h2.25V12h1.5V6.5H11V5H5Z" />< path xmlns = "http://www.w3.org/2000/svg"
        d =
