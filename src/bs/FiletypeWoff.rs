...
use leptos::*;
#[cfg(feature = "BsFiletypeWoff")]
///This icon requires the feature `BsFiletypeWoff` to be enabled.
#[component]
pub fn FiletypeWoff(
    cx: Scope,
