...
use leptos::*;
#[cfg(feature = "BsBookmarkCheckFill")]
///This icon requires the feature `BsBookmarkCheckFill` to be enabled.
#[component]
pub fn BookmarkCheckFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-bookmark-check-fill" viewBox = "0 0 16 16" width = size.clone()
