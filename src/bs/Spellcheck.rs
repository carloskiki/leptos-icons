...
use leptos::*;
#[cfg(feature = "BsSpellcheck")]
///This icon requires the feature `BsSpellcheck` to be enabled.
#[component]
pub fn Spellcheck(
    cx: Scope,
