...
use leptos::*;
#[cfg(feature = "BsDashSquareDotted")]
///This icon requires the feature `BsDashSquareDotted` to be enabled.
#[component]
pub fn DashSquareDotted(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-dash-square-dotted" viewBox = "0 0 16 16" width = size.clone()
