...
use leptos::*;
#[cfg(feature = "BsDeviceSsdFill")]
///This icon requires the feature `BsDeviceSsdFill` to be enabled.
#[component]
pub fn DeviceSsdFill(
    cx: Scope,
