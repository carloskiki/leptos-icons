...
use leptos::*;
#[cfg(feature = "BsDatabaseLock")]
///This icon requires the feature `BsDatabaseLock` to be enabled.
#[component]
pub fn DatabaseLock(
    cx: Scope,
