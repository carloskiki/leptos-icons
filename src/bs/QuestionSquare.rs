...
use leptos::*;
#[cfg(feature = "BsQuestionSquare")]
///This icon requires the feature `BsQuestionSquare` to be enabled.
#[component]
pub fn QuestionSquare(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-question-square" viewBox = "0 0 16 16" width = size.clone() height
