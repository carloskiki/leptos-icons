...
use leptos::*;
#[cfg(feature = "BsEmojiKiss")]
///This icon requires the feature `BsEmojiKiss` to be enabled.
#[component]
pub fn EmojiKiss(
    cx: Scope,
