...
use leptos::*;
#[cfg(feature = "BsFiletypeBmp")]
///This icon requires the feature `BsFiletypeBmp` to be enabled.
#[component]
pub fn FiletypeBmp(
    cx: Scope,
