...
use leptos::*;
#[cfg(feature = "BsArrowLeftCircleFill")]
///This icon requires the feature `BsArrowLeftCircleFill` to be enabled.
#[component]
pub fn ArrowLeftCircleFill(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-arrow-left-circle-fill" viewBox = "0 0 16 16" width = size.clone()
