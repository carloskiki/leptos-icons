...
use leptos::*;
#[cfg(feature = "BsExclamationOctagon")]
///This icon requires the feature `BsExclamationOctagon` to be enabled.
#[component]
pub fn ExclamationOctagon(
    cx: Scope,
    ...
    view! {
        ...
        class = "bi bi-exclamation-octagon" viewBox = "0 0 16 16" width = size.clone()
