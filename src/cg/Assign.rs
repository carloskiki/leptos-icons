...
pub fn Assign(
    ...
    view! {
        ...
        "http://www.w3.org/2000/svg" d = "M6 6H10V4H4V10H6V6Z" fill = "currentColor" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M10 18H6V14H4V20H10V18Z" fill =
        "currentColor" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M14 6H18V10H20V4H14V6Z" fill = "currentColor" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M14 18H18V14H20V20H14V18Z" fill =
        "currentColor" />< path xmlns = "http://www.w3.org/2000/svg" d =
