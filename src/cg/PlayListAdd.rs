...
pub fn PlayListAdd(
    ...
    view! {
        ...
        "http://www.w3.org/2000/svg" d = "M2 5H14V7H2V5Z" fill = "currentColor" />< path
        xmlns = "http://www.w3.org/2000/svg" d = "M2 9H14V11H2V9Z" fill = "currentColor"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M10 13H2V15H10V13Z" fill =
