...
pub fn Copy(
    ...
    view! {
        ...
        "M13 7H7V5H13V7Z" fill = "currentColor" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M13 11H7V9H13V11Z" fill = "currentColor" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M7 15H13V13H7V15Z" fill =
