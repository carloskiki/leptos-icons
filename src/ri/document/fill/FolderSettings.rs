#[cfg(feature = "RiDocumentFillFolderSettings")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "RiDocumentFillFolderSettings")]
/// *This icon requires the feature* `RiDocumentFillFolderSettings` *to be enabled*.
#[component]
pub fn FolderSettings(cx: Scope) -> impl IntoView {
   view! { cx,
