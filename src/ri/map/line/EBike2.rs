#[cfg(feature = "RiMapLineEBike2")]
use leptos::*;
#[cfg(feature = "RiMapLineEBike2")]
///This icon requires the feature `RiMapLineEBike2` to be enabled.
#[component]
pub fn EBike2(
    cx: Scope,
