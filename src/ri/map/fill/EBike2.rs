#[cfg(feature = "RiMapFillEBike2")]
use leptos::*;
#[cfg(feature = "RiMapFillEBike2")]
///This icon requires the feature `RiMapFillEBike2` to be enabled.
#[component]
pub fn EBike2(
    cx: Scope,
