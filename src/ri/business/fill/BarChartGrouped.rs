#[cfg(feature = "RiBusinessFillBarChartGrouped")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "RiBusinessFillBarChartGrouped")]
/// *This icon requires the feature* `RiBusinessFillBarChartGrouped` *to be enabled*.
#[component]
pub fn BarChartGrouped(cx: Scope) -> impl IntoView {
   view! { cx,
