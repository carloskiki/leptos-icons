#[cfg(feature = "RiLogosFillCoreos")]
use leptos::*;
#[cfg(feature = "RiLogosFillCoreos")]
///This icon requires the feature `RiLogosFillCoreos` to be enabled.
#[component]
pub fn Coreos(
    cx: Scope,
