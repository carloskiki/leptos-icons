#[cfg(feature = "RiLogosFillEvernote")]
use leptos::*;
#[cfg(feature = "RiLogosFillEvernote")]
///This icon requires the feature `RiLogosFillEvernote` to be enabled.
#[component]
pub fn Evernote(
    cx: Scope,
