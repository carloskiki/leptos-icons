#[cfg(feature = "RiLogosFillInvision")]
use leptos::*;
#[cfg(feature = "RiLogosFillInvision")]
///This icon requires the feature `RiLogosFillInvision` to be enabled.
#[component]
pub fn Invision(
    cx: Scope,
