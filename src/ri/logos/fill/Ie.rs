#[cfg(feature = "RiLogosFillIe")]
use leptos::*;
#[cfg(feature = "RiLogosFillIe")]
///This icon requires the feature `RiLogosFillIe` to be enabled.
#[component]
pub fn Ie(
    cx: Scope,
