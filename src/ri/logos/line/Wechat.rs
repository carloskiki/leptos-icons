#[cfg(feature = "RiLogosLineWechat")]
use leptos::*;
#[cfg(feature = "RiLogosLineWechat")]
///This icon requires the feature `RiLogosLineWechat` to be enabled.
#[component]
pub fn Wechat(
    cx: Scope,
