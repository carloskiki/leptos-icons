#[cfg(feature = "RiLogosLineIe")]
use leptos::*;
#[cfg(feature = "RiLogosLineIe")]
///This icon requires the feature `RiLogosLineIe` to be enabled.
#[component]
pub fn Ie(
    cx: Scope,
