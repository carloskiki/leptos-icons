#[cfg(feature = "RiLogosLineUbuntu")]
use leptos::*;
#[cfg(feature = "RiLogosLineUbuntu")]
///This icon requires the feature `RiLogosLineUbuntu` to be enabled.
#[component]
pub fn Ubuntu(
    cx: Scope,
