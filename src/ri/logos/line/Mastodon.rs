#[cfg(feature = "RiLogosLineMastodon")]
use leptos::*;
#[cfg(feature = "RiLogosLineMastodon")]
///This icon requires the feature `RiLogosLineMastodon` to be enabled.
#[component]
pub fn Mastodon(
    cx: Scope,
