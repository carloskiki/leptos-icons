#[cfg(feature = "RiOthersLineCake2")]
use leptos::*;
#[cfg(feature = "RiOthersLineCake2")]
///This icon requires the feature `RiOthersLineCake2` to be enabled.
#[component]
pub fn Cake2(
    cx: Scope,
