#[cfg(feature = "RiOthersLineLightbulb")]
use leptos::*;
#[cfg(feature = "RiOthersLineLightbulb")]
///This icon requires the feature `RiOthersLineLightbulb` to be enabled.
#[component]
pub fn Lightbulb(
    cx: Scope,
