...
use leptos::*;
#[cfg(feature = "IoLogoSass")]
///This icon requires the feature `IoLogoSass` to be enabled.
#[component]
pub fn LogoSass(
    cx: Scope,
