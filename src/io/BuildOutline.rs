...
use leptos::*;
#[cfg(feature = "IoBuildOutline")]
///This icon requires the feature `IoBuildOutline` to be enabled.
#[component]
pub fn BuildOutline(
    cx: Scope,
