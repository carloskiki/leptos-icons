...
pub fn AccessibilityOutline(
    ...
    view! {
        ...
        stroke = "#000" stroke - linejoin = "round" stroke - width = "32" cx = "256" cy =
        "56" r = "40" />< path xmlns = "http://www.w3.org/2000/svg" fill = "none" stroke
        = "#000" stroke - linejoin = "round" stroke - width = "32" d =
