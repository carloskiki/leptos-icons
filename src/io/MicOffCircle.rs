...
use leptos::*;
#[cfg(feature = "IoMicOffCircle")]
///This icon requires the feature `IoMicOffCircle` to be enabled.
#[component]
pub fn MicOffCircle(
    cx: Scope,
