...
use leptos::*;
#[cfg(feature = "IoLogoPlaystation")]
///This icon requires the feature `IoLogoPlaystation` to be enabled.
#[component]
pub fn LogoPlaystation(
    cx: Scope,
