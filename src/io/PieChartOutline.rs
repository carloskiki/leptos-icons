...
use leptos::*;
#[cfg(feature = "IoPieChartOutline")]
///This icon requires the feature `IoPieChartOutline` to be enabled.
#[component]
pub fn PieChartOutline(
    cx: Scope,
    ...
    view! {
        ...
        "M256,48C141.12,48,48,141.12,48,256a207.29,207.29,0,0,0,18.09,85L256,256Z" style
        =
