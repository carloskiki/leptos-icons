...
use leptos::*;
#[cfg(feature = "IoLogoSnapchat")]
///This icon requires the feature `IoLogoSnapchat` to be enabled.
#[component]
pub fn LogoSnapchat(
    cx: Scope,
