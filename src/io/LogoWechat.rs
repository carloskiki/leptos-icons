...
use leptos::*;
#[cfg(feature = "IoLogoWechat")]
///This icon requires the feature `IoLogoWechat` to be enabled.
#[component]
pub fn LogoWechat(
    cx: Scope,
