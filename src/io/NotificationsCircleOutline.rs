...
use leptos::*;
#[cfg(feature = "IoNotificationsCircleOutline")]
///This icon requires the feature `IoNotificationsCircleOutline` to be enabled.
#[component]
pub fn NotificationsCircleOutline(
    cx: Scope,
    ...
    view! {
        ...
        "M220.24,352a4,4,0,0,0-4,4.42C218.49,375.14,235.11,384,256,384c20.67,0,37.14-9.15,39.66-27.52a4,4,0,0,0-4-4.48Z"
