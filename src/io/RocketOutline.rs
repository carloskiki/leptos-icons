...
use leptos::*;
#[cfg(feature = "IoRocketOutline")]
///This icon requires the feature `IoRocketOutline` to be enabled.
#[component]
pub fn RocketOutline(
    cx: Scope,
    ...
    view! {
        ...
        "M109.64,352a45.06,45.06,0,0,0-26.35,12.84C65.67,382.52,64,448,64,448s65.52-1.67,83.15-19.31A44.73,44.73,0,0,0,160,402.32"
        style =
        "fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"
