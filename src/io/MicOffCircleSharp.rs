...
use leptos::*;
#[cfg(feature = "IoMicOffCircleSharp")]
///This icon requires the feature `IoMicOffCircleSharp` to be enabled.
#[component]
pub fn MicOffCircleSharp(
    cx: Scope,
