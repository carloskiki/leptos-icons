...
use leptos::*;
#[cfg(feature = "IoLogoAppleAppstore")]
///This icon requires the feature `IoLogoAppleAppstore` to be enabled.
#[component]
pub fn LogoAppleAppstore(
    cx: Scope,
