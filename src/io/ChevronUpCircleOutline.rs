...
use leptos::*;
#[cfg(feature = "IoChevronUpCircleOutline")]
///This icon requires the feature `IoChevronUpCircleOutline` to be enabled.
#[component]
pub fn ChevronUpCircleOutline(
    cx: Scope,
    ...
    view! {
        ...
        "http://www.w3.org/2000/svg" points = "352 296 256 200 160 296" style =
