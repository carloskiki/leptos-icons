...
pub fn IdCardOutline(
    ...
    view! {
        ...
        "http://www.w3.org/2000/svg" x = "96" y = "32" width = "320" height = "448" rx =
        "48" fill = "none" stroke = "#000" stroke - linejoin = "round" stroke - width =
        "32" />< line xmlns = "http://www.w3.org/2000/svg" x1 = "208" y1 = "80" x2 =
        "304" y2 = "80" fill = "none" stroke = "#000" stroke - linecap = "round" stroke -
        linejoin = "round" stroke - width = "32" />< path xmlns =
