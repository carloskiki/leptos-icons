...
use leptos::*;
#[cfg(feature = "IoEarthSharp")]
///This icon requires the feature `IoEarthSharp` to be enabled.
#[component]
pub fn EarthSharp(
    cx: Scope,
