...
use leptos::*;
#[cfg(feature = "IoLogoIonitron")]
///This icon requires the feature `IoLogoIonitron` to be enabled.
#[component]
pub fn LogoIonitron(
    cx: Scope,
