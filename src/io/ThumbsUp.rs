...
use leptos::*;
#[cfg(feature = "IoThumbsUp")]
///This icon requires the feature `IoThumbsUp` to be enabled.
#[component]
pub fn ThumbsUp(
    cx: Scope,
    ...
    view! {
        ...
        "M133.55,238.06A15.85,15.85,0,0,1,126,240h0a15.82,15.82,0,0,0,7.51-1.92Z" style =
