...
use leptos::*;
#[cfg(feature = "IoMailUnreadSharp")]
///This icon requires the feature `IoMailUnreadSharp` to be enabled.
#[component]
pub fn MailUnreadSharp(
    cx: Scope,
