...
pub fn BagRemoveOutline(
    ...
    view! {
        ...
        "round" stroke - linejoin = "round" stroke - width = "32" x1 = "320" y1 = "320"
        x2 = "192" y2 = "320" />< path xmlns = "http://www.w3.org/2000/svg" fill = "none"
        stroke = "#000" stroke - linecap = "round" stroke - linejoin = "round" stroke -
        width = "32" fill - rule = "evenodd" d =
