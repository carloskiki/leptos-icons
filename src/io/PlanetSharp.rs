...
use leptos::*;
#[cfg(feature = "IoPlanetSharp")]
///This icon requires the feature `IoPlanetSharp` to be enabled.
#[component]
pub fn PlanetSharp(
    cx: Scope,
