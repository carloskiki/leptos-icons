...
use leptos::*;
#[cfg(feature = "IoLogoSkype")]
///This icon requires the feature `IoLogoSkype` to be enabled.
#[component]
pub fn LogoSkype(
    cx: Scope,
