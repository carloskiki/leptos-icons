...
pub fn MaleOutline(
    ...
    view! {
        ...
        "http://www.w3.org/2000/svg" cx = "216" cy = "296" r = "152" fill = "none" stroke
        = "#000" stroke - linecap = "round" stroke - linejoin = "round" stroke - width =
        "32" />< polyline xmlns = "http://www.w3.org/2000/svg" points =
        "448 160 448 64 352 64" fill = "none" stroke = "#000" stroke - linecap = "round"
        stroke - linejoin = "round" stroke - width = "32" />< line xmlns =
        "http://www.w3.org/2000/svg" x1 = "324" y1 = "188" x2 = "448" y2 = "64" fill =
