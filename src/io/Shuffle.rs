...
use leptos::*;
#[cfg(feature = "IoShuffle")]
///This icon requires the feature `IoShuffle` to be enabled.
#[component]
pub fn Shuffle(
    cx: Scope,
    ...
    view! {
        ...
        "fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M416,160H362.81a80,80,0,0,0-66.56,35.62L288,208" style =
        "fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"
