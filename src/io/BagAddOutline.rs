...
pub fn BagAddOutline(
    ...
    view! {
        ...
        size.clone() } height = { size } > < line xmlns = "http://www.w3.org/2000/svg" x1
        = "256" y1 = "256" x2 = "256" y2 = "384" fill = "none" stroke = "#000" stroke -
        linecap = "round" stroke - linejoin = "round" stroke - width = "32" />< line
        xmlns = "http://www.w3.org/2000/svg" x1 = "320" y1 = "320" x2 = "192" y2 = "320"
