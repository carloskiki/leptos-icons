...
use leptos::*;
#[cfg(feature = "IoEarthOutline")]
///This icon requires the feature `IoEarthOutline` to be enabled.
#[component]
pub fn EarthOutline(
    cx: Scope,
