...
use leptos::*;
#[cfg(feature = "IoSkullSharp")]
///This icon requires the feature `IoSkullSharp` to be enabled.
#[component]
pub fn SkullSharp(
    cx: Scope,
