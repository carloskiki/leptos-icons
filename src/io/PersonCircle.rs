...
use leptos::*;
#[cfg(feature = "IoPersonCircle")]
///This icon requires the feature `IoPersonCircle` to be enabled.
#[component]
pub fn PersonCircle(
    cx: Scope,
