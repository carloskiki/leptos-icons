...
use leptos::*;
#[cfg(feature = "IoRocketSharp")]
///This icon requires the feature `IoRocketSharp` to be enabled.
#[component]
pub fn RocketSharp(
    cx: Scope,
