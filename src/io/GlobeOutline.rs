...
use leptos::*;
#[cfg(feature = "IoGlobeOutline")]
///This icon requires the feature `IoGlobeOutline` to be enabled.
#[component]
pub fn GlobeOutline(
    cx: Scope,
    ...
    view! {
        ...
        = "464" style = "fill:none;stroke:#000;stroke-miterlimit:10;stroke-width:32px"
        />< line xmlns = "http://www.w3.org/2000/svg" x1 = "464" y1 = "256" x2 = "48" y2
        = "256" style = "fill:none;stroke:#000;stroke-miterlimit:10;stroke-width:32px" />
