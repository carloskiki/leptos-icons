...
use leptos::*;
#[cfg(feature = "IoCallSharp")]
///This icon requires the feature `IoCallSharp` to be enabled.
#[component]
pub fn CallSharp(
    cx: Scope,
