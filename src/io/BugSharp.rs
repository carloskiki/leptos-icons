...
use leptos::*;
#[cfg(feature = "IoBugSharp")]
///This icon requires the feature `IoBugSharp` to be enabled.
#[component]
pub fn BugSharp(
    cx: Scope,
