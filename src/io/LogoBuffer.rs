...
use leptos::*;
#[cfg(feature = "IoLogoBuffer")]
///This icon requires the feature `IoLogoBuffer` to be enabled.
#[component]
pub fn LogoBuffer(
    cx: Scope,
