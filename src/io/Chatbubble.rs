...
use leptos::*;
#[cfg(feature = "IoChatbubble")]
///This icon requires the feature `IoChatbubble` to be enabled.
#[component]
pub fn Chatbubble(
    cx: Scope,
