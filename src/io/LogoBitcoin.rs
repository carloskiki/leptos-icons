...
use leptos::*;
#[cfg(feature = "IoLogoBitcoin")]
///This icon requires the feature `IoLogoBitcoin` to be enabled.
#[component]
pub fn LogoBitcoin(
    cx: Scope,
