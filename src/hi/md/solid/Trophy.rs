#[cfg(feature = "HiMdSolidTrophy")]
use leptos::*;
#[cfg(feature = "HiMdSolidTrophy")]
///This icon requires the feature `HiMdSolidTrophy` to be enabled.
#[component]
pub fn Trophy(
    cx: Scope,
