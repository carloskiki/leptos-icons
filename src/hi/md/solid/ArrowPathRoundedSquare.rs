#[cfg(feature = "HiMdSolidArrowPathRoundedSquare")]
use leptos::*;
#[cfg(feature = "HiMdSolidArrowPathRoundedSquare")]
///This icon requires the feature `HiMdSolidArrowPathRoundedSquare` to be enabled.
#[component]
