#[cfg(feature = "HiMdSolidGlobeAsiaAustralia")]
use leptos::*;
#[cfg(feature = "HiMdSolidGlobeAsiaAustralia")]
///This icon requires the feature `HiMdSolidGlobeAsiaAustralia` to be enabled.
#[component]
