#[cfg(feature = "HiMdSolidSparkles")]
use leptos::*;
#[cfg(feature = "HiMdSolidSparkles")]
///This icon requires the feature `HiMdSolidSparkles` to be enabled.
#[component]
pub fn Sparkles(
    cx: Scope,
