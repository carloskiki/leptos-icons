#[cfg(feature = "HiMdSolidCpuChip")]
use leptos::*;
#[cfg(feature = "HiMdSolidCpuChip")]
///This icon requires the feature `HiMdSolidCpuChip` to be enabled.
#[component]
pub fn CpuChip(
    cx: Scope,
    ...
    view! {
        ...
        "M14 6H6V14H14V6Z" fill = "#0F172A" />< path xmlns = "http://www.w3.org/2000/svg"
