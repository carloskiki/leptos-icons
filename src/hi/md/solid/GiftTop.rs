#[cfg(feature = "HiMdSolidGiftTop")]
use leptos::*;
#[cfg(feature = "HiMdSolidGiftTop")]
///This icon requires the feature `HiMdSolidGiftTop` to be enabled.
#[component]
pub fn GiftTop(
    cx: Scope,
