#[cfg(feature = "HiMdSolidFingerPrint")]
use leptos::*;
#[cfg(feature = "HiMdSolidFingerPrint")]
///This icon requires the feature `HiMdSolidFingerPrint` to be enabled.
#[component]
pub fn FingerPrint(
    cx: Scope,
