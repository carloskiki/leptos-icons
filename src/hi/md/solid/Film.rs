#[cfg(feature = "HiMdSolidFilm")]
use leptos::*;
#[cfg(feature = "HiMdSolidFilm")]
///This icon requires the feature `HiMdSolidFilm` to be enabled.
#[component]
pub fn Film(
    cx: Scope,
