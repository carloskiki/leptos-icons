#[cfg(feature = "HiMdSolidArrowsRightLeft")]
use leptos::*;
#[cfg(feature = "HiMdSolidArrowsRightLeft")]
///This icon requires the feature `HiMdSolidArrowsRightLeft` to be enabled.
#[component]
