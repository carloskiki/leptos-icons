#[cfg(feature = "HiMdSolidPhoneArrowDownLeft")]
use leptos::*;
#[cfg(feature = "HiMdSolidPhoneArrowDownLeft")]
///This icon requires the feature `HiMdSolidPhoneArrowDownLeft` to be enabled.
#[component]
