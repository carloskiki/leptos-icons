#[cfg(feature = "HiMdSolidGif")]
use leptos::*;
#[cfg(feature = "HiMdSolidGif")]
///This icon requires the feature `HiMdSolidGif` to be enabled.
#[component]
pub fn Gif(
    cx: Scope,
