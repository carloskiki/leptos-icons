#[cfg(feature = "HiMdSolidBellSnooze")]
use leptos::*;
#[cfg(feature = "HiMdSolidBellSnooze")]
///This icon requires the feature `HiMdSolidBellSnooze` to be enabled.
#[component]
pub fn BellSnooze(
    cx: Scope,
