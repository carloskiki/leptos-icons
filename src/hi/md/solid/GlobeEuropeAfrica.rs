#[cfg(feature = "HiMdSolidGlobeEuropeAfrica")]
use leptos::*;
#[cfg(feature = "HiMdSolidGlobeEuropeAfrica")]
///This icon requires the feature `HiMdSolidGlobeEuropeAfrica` to be enabled.
#[component]
