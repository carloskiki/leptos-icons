#[cfg(feature = "HiMdSolidPhoneArrowUpRight")]
use leptos::*;
#[cfg(feature = "HiMdSolidPhoneArrowUpRight")]
///This icon requires the feature `HiMdSolidPhoneArrowUpRight` to be enabled.
#[component]
pub fn PhoneArrowUpRight(
    ...
    view! {
        ...
        "M16.5 4.56066L13.2803 7.78033C12.9874 8.07322 12.5126 8.07322 12.2197 7.78033C11.9268 7.48744 11.9268 7.01256 12.2197 6.71967L15.4393 3.5H12.75C12.3358 3.5 12 3.16421 12 2.75C12 2.33579 12.3358 2 12.75 2H17.25C17.6642 2 18 2.33579 18 2.75V7.25C18 7.66421 17.6642 8 17.25 8C16.8358 8 16.5 7.66421 16.5 7.25V4.56066Z"
