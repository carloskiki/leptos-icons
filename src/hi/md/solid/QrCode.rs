#[cfg(feature = "HiMdSolidQrCode")]
use leptos::*;
#[cfg(feature = "HiMdSolidQrCode")]
///This icon requires the feature `HiMdSolidQrCode` to be enabled.
#[component]
pub fn QrCode(
    cx: Scope,
