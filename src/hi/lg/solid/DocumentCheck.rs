#[cfg(feature = "HiLgSolidDocumentCheck")]
use leptos::*;
#[cfg(feature = "HiLgSolidDocumentCheck")]
///This icon requires the feature `HiLgSolidDocumentCheck` to be enabled.
#[component]
