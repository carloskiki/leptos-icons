#[cfg(feature = "HiLgSolidTableCells")]
use leptos::*;
#[cfg(feature = "HiLgSolidTableCells")]
///This icon requires the feature `HiLgSolidTableCells` to be enabled.
#[component]
pub fn TableCells(
    cx: Scope,
