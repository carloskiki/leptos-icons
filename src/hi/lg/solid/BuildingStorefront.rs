#[cfg(feature = "HiLgSolidBuildingStorefront")]
use leptos::*;
#[cfg(feature = "HiLgSolidBuildingStorefront")]
///This icon requires the feature `HiLgSolidBuildingStorefront` to be enabled.
#[component]
