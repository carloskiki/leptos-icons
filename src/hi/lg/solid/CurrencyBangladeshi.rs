#[cfg(feature = "HiLgSolidCurrencyBangladeshi")]
use leptos::*;
#[cfg(feature = "HiLgSolidCurrencyBangladeshi")]
///This icon requires the feature `HiLgSolidCurrencyBangladeshi` to be enabled.
#[component]
