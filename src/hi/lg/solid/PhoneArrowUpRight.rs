#[cfg(feature = "HiLgSolidPhoneArrowUpRight")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "HiLgSolidPhoneArrowUpRight")]
/// *This icon requires the feature* `HiLgSolidPhoneArrowUpRight` *to be enabled*.
#[component]
pub fn PhoneArrowUpRight(cx: Scope) -> impl IntoView {
   view! { cx,
