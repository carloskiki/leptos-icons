#[cfg(feature = "HiLgSolidBanknotes")]
use leptos::*;
#[cfg(feature = "HiLgSolidBanknotes")]
///This icon requires the feature `HiLgSolidBanknotes` to be enabled.
#[component]
pub fn Banknotes(
    cx: Scope,
    ...
    view! {
        ...
        "M12 7.5C10.7574 7.5 9.75 8.50736 9.75 9.75C9.75 10.9926 10.7574 12 12 12C13.2426 12 14.25 10.9926 14.25 9.75C14.25 8.50736 13.2426 7.5 12 7.5Z"
        ...
        "M2.25 18C1.83579 18 1.5 18.3358 1.5 18.75C1.5 19.1642 1.83579 19.5 2.25 19.5C7.65005 19.5 12.8802 20.2222 17.8498 21.5749C19.0404 21.899 20.25 21.0168 20.25 19.7551V18.75C20.25 18.3358 19.9142 18 19.5 18H2.25Z"
