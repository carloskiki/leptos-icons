#[cfg(feature = "HiLgSolidMegaphone")]
use leptos::*;
#[cfg(feature = "HiLgSolidMegaphone")]
///This icon requires the feature `HiLgSolidMegaphone` to be enabled.
#[component]
pub fn Megaphone(
    cx: Scope,
