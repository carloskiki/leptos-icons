#[cfg(feature = "HiLgSolidArrowsPointingIn")]
use leptos::*;
#[cfg(feature = "HiLgSolidArrowsPointingIn")]
///This icon requires the feature `HiLgSolidArrowsPointingIn` to be enabled.
#[component]
