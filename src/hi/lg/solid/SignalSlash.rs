#[cfg(feature = "HiLgSolidSignalSlash")]
use leptos::*;
#[cfg(feature = "HiLgSolidSignalSlash")]
///This icon requires the feature `HiLgSolidSignalSlash` to be enabled.
#[component]
pub fn SignalSlash(
    cx: Scope,
