#[cfg(feature = "HiLgSolidFilm")]
use leptos::*;
#[cfg(feature = "HiLgSolidFilm")]
///This icon requires the feature `HiLgSolidFilm` to be enabled.
#[component]
pub fn Film(
    cx: Scope,
