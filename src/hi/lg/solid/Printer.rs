#[cfg(feature = "HiLgSolidPrinter")]
use leptos::*;
#[cfg(feature = "HiLgSolidPrinter")]
///This icon requires the feature `HiLgSolidPrinter` to be enabled.
#[component]
pub fn Printer(
    cx: Scope,
