#[cfg(feature = "HiLgSolidAcademicCap")]
use leptos::*;
#[cfg(feature = "HiLgSolidAcademicCap")]
///This icon requires the feature `HiLgSolidAcademicCap` to be enabled.
#[component]
pub fn AcademicCap(
    cx: Scope,
