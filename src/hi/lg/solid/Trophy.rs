#[cfg(feature = "HiLgSolidTrophy")]
use leptos::*;
#[cfg(feature = "HiLgSolidTrophy")]
///This icon requires the feature `HiLgSolidTrophy` to be enabled.
#[component]
pub fn Trophy(
    cx: Scope,
