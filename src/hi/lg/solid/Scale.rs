#[cfg(feature = "HiLgSolidScale")]
use leptos::*;
#[cfg(feature = "HiLgSolidScale")]
///This icon requires the feature `HiLgSolidScale` to be enabled.
#[component]
pub fn Scale(
    cx: Scope,
