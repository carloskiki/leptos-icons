#[cfg(feature = "HiLgSolidArrowPath")]
use leptos::*;
#[cfg(feature = "HiLgSolidArrowPath")]
///This icon requires the feature `HiLgSolidArrowPath` to be enabled.
#[component]
pub fn ArrowPath(
    cx: Scope,
