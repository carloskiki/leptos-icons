#[cfg(feature = "HiLgSolidBuildingOffice")]
use leptos::*;
#[cfg(feature = "HiLgSolidBuildingOffice")]
///This icon requires the feature `HiLgSolidBuildingOffice` to be enabled.
#[component]
