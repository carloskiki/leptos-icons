#[cfg(feature = "HiLgSolidPuzzlePiece")]
use leptos::*;
#[cfg(feature = "HiLgSolidPuzzlePiece")]
///This icon requires the feature `HiLgSolidPuzzlePiece` to be enabled.
#[component]
pub fn PuzzlePiece(
    cx: Scope,
