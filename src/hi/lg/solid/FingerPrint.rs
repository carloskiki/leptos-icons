#[cfg(feature = "HiLgSolidFingerPrint")]
use leptos::*;
#[cfg(feature = "HiLgSolidFingerPrint")]
///This icon requires the feature `HiLgSolidFingerPrint` to be enabled.
#[component]
pub fn FingerPrint(
    cx: Scope,
