#[cfg(feature = "HiLgSolidGift")]
use leptos::*;
#[cfg(feature = "HiLgSolidGift")]
///This icon requires the feature `HiLgSolidGift` to be enabled.
#[component]
pub fn Gift(
    cx: Scope,
