#[cfg(feature = "HiLgSolidBeaker")]
use leptos::*;
#[cfg(feature = "HiLgSolidBeaker")]
///This icon requires the feature `HiLgSolidBeaker` to be enabled.
#[component]
pub fn Beaker(
    cx: Scope,
