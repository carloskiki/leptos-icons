#[cfg(feature = "HiLgSolidInboxArrowDown")]
use leptos::*;
#[cfg(feature = "HiLgSolidInboxArrowDown")]
///This icon requires the feature `HiLgSolidInboxArrowDown` to be enabled.
#[component]
