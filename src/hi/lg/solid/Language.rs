#[cfg(feature = "HiLgSolidLanguage")]
use leptos::*;
#[cfg(feature = "HiLgSolidLanguage")]
///This icon requires the feature `HiLgSolidLanguage` to be enabled.
#[component]
pub fn Language(
    cx: Scope,
