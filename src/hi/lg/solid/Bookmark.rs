#[cfg(feature = "HiLgSolidBookmark")]
use leptos::*;
#[cfg(feature = "HiLgSolidBookmark")]
///This icon requires the feature `HiLgSolidBookmark` to be enabled.
#[component]
pub fn Bookmark(
    cx: Scope,
