#[cfg(feature = "HiLgSolidClipboardDocumentCheck")]
use leptos::*;
#[cfg(feature = "HiLgSolidClipboardDocumentCheck")]
///This icon requires the feature `HiLgSolidClipboardDocumentCheck` to be enabled.
#[component]
