#[cfg(feature = "HiLgSolidFire")]
use leptos::*;
#[cfg(feature = "HiLgSolidFire")]
///This icon requires the feature `HiLgSolidFire` to be enabled.
#[component]
pub fn Fire(
    cx: Scope,
