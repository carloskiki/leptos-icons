#[cfg(feature = "HiLgOutlinePuzzlePiece")]
use leptos::*;
#[cfg(feature = "HiLgOutlinePuzzlePiece")]
///This icon requires the feature `HiLgOutlinePuzzlePiece` to be enabled.
#[component]
pub fn PuzzlePiece(
    cx: Scope,
