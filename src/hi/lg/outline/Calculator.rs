#[cfg(feature = "HiLgOutlineCalculator")]
use leptos::*;
#[cfg(feature = "HiLgOutlineCalculator")]
///This icon requires the feature `HiLgOutlineCalculator` to be enabled.
#[component]
pub fn Calculator(
    cx: Scope,
