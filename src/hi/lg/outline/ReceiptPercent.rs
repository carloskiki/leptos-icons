#[cfg(feature = "HiLgOutlineReceiptPercent")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "HiLgOutlineReceiptPercent")]
/// *This icon requires the feature* `HiLgOutlineReceiptPercent` *to be enabled*.
#[component]
pub fn ReceiptPercent(cx: Scope) -> impl IntoView {
   view! { cx,
