#[cfg(feature = "HiLgOutlinePhoneArrowDownLeft")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "HiLgOutlinePhoneArrowDownLeft")]
/// *This icon requires the feature* `HiLgOutlinePhoneArrowDownLeft` *to be enabled*.
#[component]
pub fn PhoneArrowDownLeft(cx: Scope) -> impl IntoView {
   view! { cx,
