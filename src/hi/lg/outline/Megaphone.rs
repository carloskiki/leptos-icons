#[cfg(feature = "HiLgOutlineMegaphone")]
use leptos::*;
#[cfg(feature = "HiLgOutlineMegaphone")]
///This icon requires the feature `HiLgOutlineMegaphone` to be enabled.
#[component]
pub fn Megaphone(
    cx: Scope,
