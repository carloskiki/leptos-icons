#[cfg(feature = "HiLgOutlineUsers")]
use leptos::*;
#[cfg(feature = "HiLgOutlineUsers")]
///This icon requires the feature `HiLgOutlineUsers` to be enabled.
#[component]
pub fn Users(
    cx: Scope,
