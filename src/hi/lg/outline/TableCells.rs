#[cfg(feature = "HiLgOutlineTableCells")]
use leptos::*;
#[cfg(feature = "HiLgOutlineTableCells")]
///This icon requires the feature `HiLgOutlineTableCells` to be enabled.
#[component]
pub fn TableCells(
    cx: Scope,
