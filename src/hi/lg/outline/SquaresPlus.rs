#[cfg(feature = "HiLgOutlineSquaresPlus")]
use leptos::*;
#[cfg(feature = "HiLgOutlineSquaresPlus")]
///This icon requires the feature `HiLgOutlineSquaresPlus` to be enabled.
#[component]
pub fn SquaresPlus(
    cx: Scope,
