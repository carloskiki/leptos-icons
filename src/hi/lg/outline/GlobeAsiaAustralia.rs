#[cfg(feature = "HiLgOutlineGlobeAsiaAustralia")]
use leptos::*;
#[cfg(feature = "HiLgOutlineGlobeAsiaAustralia")]
///This icon requires the feature `HiLgOutlineGlobeAsiaAustralia` to be enabled.
#[component]
