#[cfg(feature = "HiLgOutlineAdjustmentsVertical")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "HiLgOutlineAdjustmentsVertical")]
/// *This icon requires the feature* `HiLgOutlineAdjustmentsVertical` *to be enabled*.
#[component]
pub fn AdjustmentsVertical(cx: Scope) -> impl IntoView {
   view! { cx,
