#[cfg(feature = "HiLgOutlineRocketLaunch")]
use leptos::*;
#[cfg(feature = "HiLgOutlineRocketLaunch")]
///This icon requires the feature `HiLgOutlineRocketLaunch` to be enabled.
#[component]
pub fn RocketLaunch(
    cx: Scope,
