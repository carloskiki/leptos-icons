#[cfg(feature = "HiLgOutlineChatBubbleOvalLeftEllipsis")]
use leptos::*;
#[cfg(feature = "HiLgOutlineChatBubbleOvalLeftEllipsis")]
///This icon requires the feature `HiLgOutlineChatBubbleOvalLeftEllipsis` to be enabled.
#[component]
