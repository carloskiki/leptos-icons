#[cfg(feature = "HiLgOutlineTrash")]
use leptos::*;
#[cfg(feature = "HiLgOutlineTrash")]
///This icon requires the feature `HiLgOutlineTrash` to be enabled.
#[component]
pub fn Trash(
    cx: Scope,
