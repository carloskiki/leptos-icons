#[cfg(feature = "HiLgOutlineScissors")]
use leptos::*;
#[cfg(feature = "HiLgOutlineScissors")]
///This icon requires the feature `HiLgOutlineScissors` to be enabled.
#[component]
pub fn Scissors(
    cx: Scope,
