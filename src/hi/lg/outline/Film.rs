#[cfg(feature = "HiLgOutlineFilm")]
use leptos::*;
#[cfg(feature = "HiLgOutlineFilm")]
///This icon requires the feature `HiLgOutlineFilm` to be enabled.
#[component]
pub fn Film(
    cx: Scope,
