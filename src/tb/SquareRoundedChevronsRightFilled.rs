...
#[component]
pub fn SquareRoundedChevronsRightFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-chevrons-right-filled" width = "24"
        height = "24" viewBox = "0 0 24 24" stroke - width = "2" stroke = "currentColor"
        fill = "none" stroke - linecap = "round" stroke - linejoin = "round" width = size
