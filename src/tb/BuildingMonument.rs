...
pub fn BuildingMonument(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M8 18l2 -13l2 -2l2 2l2 13" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M5 21v-3h14v3" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M3 21l18 0" /> < title > { title } < / title >
        < / svg >
    }
}
