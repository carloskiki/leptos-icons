#[cfg(feature = "TbCloudLock")]
use leptos::*;
#[cfg(feature = "TbCloudLock")]
///This icon requires the feature `TbCloudLock` to be enabled.
#[component]
pub fn CloudLock(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-cloud-lock" width = "24" height = "24" viewBox =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M10 15v-2a2 2 0 1 1 4 0v2" />
