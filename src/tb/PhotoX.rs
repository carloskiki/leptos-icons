#[cfg(feature = "TbPhotoX")]
use leptos::*;
#[cfg(feature = "TbPhotoX")]
///This icon requires the feature `TbPhotoX` to be enabled.
#[component]
pub fn PhotoX(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-photo-x"
        ...
        "M13 20h-6a3 3 0 0 1 -3 -3v-10a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6" />< path xmlns
