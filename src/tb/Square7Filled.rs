#[cfg(feature = "TbSquare7Filled")]
use leptos::*;
#[cfg(feature = "TbSquare7Filled")]
///This icon requires the feature `TbSquare7Filled` to be enabled.
#[component]
pub fn Square7Filled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-7-filled" width = "24" height = "24" viewBox
