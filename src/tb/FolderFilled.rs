#[cfg(feature = "TbFolderFilled")]
use leptos::*;
#[cfg(feature = "TbFolderFilled")]
///This icon requires the feature `TbFolderFilled` to be enabled.
#[component]
pub fn FolderFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-folder-filled" width = "24" height = "24" viewBox =
