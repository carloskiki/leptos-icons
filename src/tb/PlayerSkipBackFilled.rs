#[cfg(feature = "TbPlayerSkipBackFilled")]
use leptos::*;
#[cfg(feature = "TbPlayerSkipBackFilled")]
///This icon requires the feature `TbPlayerSkipBackFilled` to be enabled.
#[component]
pub fn PlayerSkipBackFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-player-skip-back-filled" width = "24" height = "24"
