...
pub fn BrandFirebase(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-brand-firebase" width = "24" height = "24" viewBox
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M4.57 17.18l10.93 -10.68" /> <
