...
pub fn FileMusic(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-file-music" width = "24" height = "24" viewBox =
        ...
        "M11 16m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M12 16l0 -5l2 1" /> < title > { title } < /
        title > < / svg >
    }
}
