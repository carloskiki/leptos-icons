#[cfg(feature = "TbAccessibleOffFilled")]
use leptos::*;
#[cfg(feature = "TbAccessibleOffFilled")]
///This icon requires the feature `TbAccessibleOffFilled` to be enabled.
#[component]
pub fn AccessibleOffFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-accessible-off-filled" width = "24" height = "24"
