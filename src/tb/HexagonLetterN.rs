#[cfg(feature = "TbHexagonLetterN")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterN")]
///This icon requires the feature `TbHexagonLetterN` to be enabled.
#[component]
pub fn HexagonLetterN(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-n" width = "24" height = "24"
