#[cfg(feature = "TbWashTemperature2")]
use leptos::*;
#[cfg(feature = "TbWashTemperature2")]
///This icon requires the feature `TbWashTemperature2` to be enabled.
#[component]
pub fn WashTemperature2(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-wash-temperature-2" width = "24" height = "24"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M14 13h.01" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M10 13h.01" /> < title > { title } < / title >
        < / svg >
    }
}
