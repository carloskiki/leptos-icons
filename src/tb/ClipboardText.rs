#[cfg(feature = "TbClipboardText")]
use leptos::*;
#[cfg(feature = "TbClipboardText")]
///This icon requires the feature `TbClipboardText` to be enabled.
#[component]
pub fn ClipboardText(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-clipboard-text" width = "24" height = "24" viewBox
        ...
        "http://www.w3.org/2000/svg" d = "M9 16h6" /> < title > { title } < / title > < /
        svg >
    }
}
