#[cfg(feature = "TbHexagonNumber6")]
use leptos::*;
#[cfg(feature = "TbHexagonNumber6")]
///This icon requires the feature `TbHexagonNumber6` to be enabled.
#[component]
pub fn HexagonNumber6(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-number-6" width = "24" height = "24"
