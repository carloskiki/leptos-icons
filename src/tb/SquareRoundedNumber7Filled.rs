#[cfg(feature = "TbSquareRoundedNumber7Filled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedNumber7Filled")]
///This icon requires the feature `TbSquareRoundedNumber7Filled` to be enabled.
#[component]
pub fn SquareRoundedNumber7Filled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-number-7-filled" width = "24" height
