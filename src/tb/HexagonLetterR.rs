#[cfg(feature = "TbHexagonLetterR")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterR")]
///This icon requires the feature `TbHexagonLetterR` to be enabled.
#[component]
pub fn HexagonLetterR(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-r" width = "24" height = "24"
