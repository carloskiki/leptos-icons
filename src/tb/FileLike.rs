#[cfg(feature = "TbFileLike")]
use leptos::*;
#[cfg(feature = "TbFileLike")]
///This icon requires the feature `TbFileLike` to be enabled.
#[component]
pub fn FileLike(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-file-like"
        ...
        path xmlns = "http://www.w3.org/2000/svg" d =
        "M5 12.1v-7.1a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2h-2.3" /> < title > { title }
        < / title > < / svg >
    }
}
