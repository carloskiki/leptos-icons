#[cfg(feature = "TbAlarmFilled")]
use leptos::*;
#[cfg(feature = "TbAlarmFilled")]
///This icon requires the feature `TbAlarmFilled` to be enabled.
#[component]
pub fn AlarmFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-alarm-filled" width = "24" height = "24" viewBox =
