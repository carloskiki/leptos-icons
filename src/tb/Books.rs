...
use leptos::*;
#[cfg(feature = "TbBooks")]
///This icon requires the feature `TbBooks` to be enabled.
#[component]
pub fn Books(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-books"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M5 8h4" />< path xmlns =
        ...
        "http://www.w3.org/2000/svg" d = "M16 16l3.923 -.98" /> < title > { title } < /
        title > < / svg >
    }
}
