...
use leptos::*;
#[cfg(feature = "TbPlug")]
///This icon requires the feature `TbPlug` to be enabled.
#[component]
pub fn Plug(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-plug"
        ...
        "http://www.w3.org/2000/svg" d = "M20 9l-3.5 3.5" /> < title > { title } < /
        title > < / svg >
    }
}
