#[cfg(feature = "TbTopologyStarRing")]
use leptos::*;
#[cfg(feature = "TbTopologyStarRing")]
///This icon requires the feature `TbTopologyStarRing` to be enabled.
#[component]
pub fn TopologyStarRing(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-topology-star-ring" width = "24" height = "24"
        ...
        "http://www.w3.org/2000/svg" d = "M10.5 5.5l-5 5" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M12 6v4" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M12 14v4" /> < title > { title } < / title > <
        / svg >
    }
}
