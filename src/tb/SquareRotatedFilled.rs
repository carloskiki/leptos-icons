#[cfg(feature = "TbSquareRotatedFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRotatedFilled")]
///This icon requires the feature `TbSquareRotatedFilled` to be enabled.
#[component]
pub fn SquareRotatedFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rotated-filled" width = "24" height = "24"
