...
pub fn MedicineSyrup(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-medicine-syrup" width = "24" height = "24" viewBox
        ...
        "http://www.w3.org/2000/svg" d = "M10 7v-3a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v3" /> <
