...
pub fn ArrowsRandom(
    ...
    view! {
        ...
        "M20 21h-4v-4" />< path xmlns = "http://www.w3.org/2000/svg" d = "M16 21l5 -5"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M6.5 9.504l-3.5 -2l2 -3.504"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M3 7.504l6.83 -1.87" />< path
        xmlns = "http://www.w3.org/2000/svg" d = "M4 16l4 -1l1 4" />< path xmlns =
