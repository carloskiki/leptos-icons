#[cfg(feature = "TbHexagonNumber2")]
use leptos::*;
#[cfg(feature = "TbHexagonNumber2")]
///This icon requires the feature `TbHexagonNumber2` to be enabled.
#[component]
pub fn HexagonNumber2(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-number-2" width = "24" height = "24"
