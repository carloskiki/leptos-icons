...
pub fn CurrencyDogecoin(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M6 12h6" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M9 6v12" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 18h6a6 6 0 1 0 0 -12h-6" /> < title > {
        title } < / title > < / svg >
    }
}
