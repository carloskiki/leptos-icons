...
pub fn AppsOff(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-apps-off"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M14 7h6" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M17 4v6" />< path xmlns =
