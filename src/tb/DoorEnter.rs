...
pub fn DoorEnter(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M13 12v.01" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M3 21h18" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M5 21v-16a2 2 0 0 1 2 -2h6m4 10.5v7.5" />< path
        xmlns = "http://www.w3.org/2000/svg" d = "M21 7h-7m3 -3l-3 3l3 3" /> < title > {
        title } < / title > < / svg >
    }
}
