#[cfg(feature = "TbTiltShiftOff")]
use leptos::*;
#[cfg(feature = "TbTiltShiftOff")]
///This icon requires the feature `TbTiltShiftOff` to be enabled.
#[component]
pub fn TiltShiftOff(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-tilt-shift-off" width = "24" height = "24" viewBox
        = "0 0 24 24" stroke - width = "2" stroke = "currentColor" fill = "none" stroke -
        linecap = "round" stroke - linejoin = "round" width = size.clone() height = size
        xmlns = "http://www.w3.org/2000/svg" > < path xmlns =
        "http://www.w3.org/2000/svg" stroke = "none" d = "M0 0h24v24H0z" fill = "none"
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M8.56 3.69a9 9 0 0 0 -.577 .263" />< path xmlns = "http://www.w3.org/2000/svg" d
        ...
        d = "M10.57 10.602a2 2 0 0 0 2.862 2.795" />< path xmlns =
