#[cfg(feature = "TbHexagonLetterL")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterL")]
///This icon requires the feature `TbHexagonLetterL` to be enabled.
#[component]
pub fn HexagonLetterL(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-l" width = "24" height = "24"
