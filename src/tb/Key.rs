...
use leptos::*;
#[cfg(feature = "TbKey")]
///This icon requires the feature `TbKey` to be enabled.
#[component]
pub fn Key(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-key" width
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M15 9h.01" /> < title > {
        title } < / title > < / svg >
    }
}
