#[cfg(feature = "TbCircleCheckFilled")]
use leptos::*;
#[cfg(feature = "TbCircleCheckFilled")]
///This icon requires the feature `TbCircleCheckFilled` to be enabled.
#[component]
pub fn CircleCheckFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-circle-check-filled" width = "24" height = "24"
