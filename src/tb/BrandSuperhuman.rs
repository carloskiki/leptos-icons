...
pub fn BrandSuperhuman(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M16 12l4 3l-8 7l-8 -7l4 -3"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M12 3l-8 6l8 6l8 -6z" />< path
        xmlns = "http://www.w3.org/2000/svg" d = "M12 15h8" /> < title > { title } < /
        title > < / svg >
    }
}
