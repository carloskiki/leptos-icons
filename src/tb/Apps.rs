...
use leptos::*;
#[cfg(feature = "TbApps")]
///This icon requires the feature `TbApps` to be enabled.
#[component]
pub fn Apps(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-apps"
        ...
        "http://www.w3.org/2000/svg" d = "M17 4l0 6" /> < title > { title } < / title > <
        / svg >
    }
}
