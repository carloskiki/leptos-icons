...
pub fn RippleOff(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-ripple-off" width = "24" height = "24" viewBox =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M3 17c3 -2 6 -2 9 0c2.092 1.395 4.184 1.817 6.276 1.266" />< path xmlns =
        "http://www.w3.org/2000/svg" d =
        "M3 12c3 -2 6 -2 9 0m5.482 1.429c1.173 -.171 2.345 -.647 3.518 -1.429" />< path
