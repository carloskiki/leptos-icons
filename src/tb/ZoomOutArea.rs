#[cfg(feature = "TbZoomOutArea")]
use leptos::*;
#[cfg(feature = "TbZoomOutArea")]
///This icon requires the feature `TbZoomOutArea` to be enabled.
#[component]
pub fn ZoomOutArea(
    cx: Scope,
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M13 15h4" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M15 15m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M22 22l-3 -3" />< path xmlns =
