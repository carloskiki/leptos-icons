#[cfg(feature = "TbHexagonLetterC")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterC")]
///This icon requires the feature `TbHexagonLetterC` to be enabled.
#[component]
pub fn HexagonLetterC(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-c" width = "24" height = "24"
