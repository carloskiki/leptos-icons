#[cfg(feature = "TbSquareRoundedChevronsLeftFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedChevronsLeftFilled")]
///This icon requires the feature `TbSquareRoundedChevronsLeftFilled` to be enabled.
#[component]
pub fn SquareRoundedChevronsLeftFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-chevrons-left-filled" width = "24"
