#[cfg(feature = "TbClockFilled")]
use leptos::*;
#[cfg(feature = "TbClockFilled")]
///This icon requires the feature `TbClockFilled` to be enabled.
#[component]
pub fn ClockFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-clock-filled" width = "24" height = "24" viewBox =
