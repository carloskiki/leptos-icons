#[cfg(feature = "TbHandThreeFingers")]
use leptos::*;
#[cfg(feature = "TbHandThreeFingers")]
///This icon requires the feature `TbHandThreeFingers` to be enabled.
#[component]
pub fn HandThreeFingers(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hand-three-fingers" width = "24" height = "24"
        ...
        "M11 5.5v-2a1.5 1.5 0 1 1 3 0v8.5" />< path xmlns = "http://www.w3.org/2000/svg"
        d = "M14 5.5a1.5 1.5 0 0 1 3 0v6.5" /> < title > { title } < / title > < / svg >
    }
}
