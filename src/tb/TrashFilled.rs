#[cfg(feature = "TbTrashFilled")]
use leptos::*;
#[cfg(feature = "TbTrashFilled")]
///This icon requires the feature `TbTrashFilled` to be enabled.
#[component]
pub fn TrashFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-trash-filled" width = "24" height = "24" viewBox =
