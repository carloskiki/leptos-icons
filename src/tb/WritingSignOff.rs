#[cfg(feature = "TbWritingSignOff")]
use leptos::*;
#[cfg(feature = "TbWritingSignOff")]
///This icon requires the feature `TbWritingSignOff` to be enabled.
#[component]
pub fn WritingSignOff(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-writing-sign-off" width = "24" height = "24"
        ...
        path xmlns = "http://www.w3.org/2000/svg" d = "M16 7h4" />< path xmlns =
