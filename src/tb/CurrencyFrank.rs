...
pub fn CurrencyFrank(
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M17 5h-6a2 2 0 0 0 -2 2v12"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M7 15h4" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M9 11h7" /> < title > { title } < / title > < /
        svg >
    }
}
