...
use leptos::*;
#[cfg(feature = "TbSalad")]
///This icon requires the feature `TbSalad` to be enabled.
#[component]
pub fn Salad(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-salad"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M8 8l1 -4l4 2.5" />< path
        xmlns = "http://www.w3.org/2000/svg" d = "M13 11v-.5a2.5 2.5 0 1 0 -5 0v.5" /> <
