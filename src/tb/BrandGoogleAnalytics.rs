...
pub fn BrandGoogleAnalytics(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-brand-google-analytics" width = "24" height = "24"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M5 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /> < title > { title } < / title > < /
        svg >
    }
}
