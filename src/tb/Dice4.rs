...
use leptos::*;
#[cfg(feature = "TbDice4")]
///This icon requires the feature `TbDice4` to be enabled.
#[component]
pub fn Dice4(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-dice-4"
        ...
        "15.5" r = ".5" fill = "currentColor" /> < title > { title } < / title > < / svg
        >
    }
}
