...
pub fn ZoomQuestion(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-zoom-question" width = "24" height = "24" viewBox =
        ...
        "http://www.w3.org/2000/svg" d = "M10 13l0 .01" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M10 10a1.5 1.5 0 1 0 -1.14 -2.474" /> < title >
        { title } < / title > < / svg >
    }
}
