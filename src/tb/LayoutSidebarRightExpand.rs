...
#[component]
pub fn LayoutSidebarRightExpand(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-layout-sidebar-right-expand" width = "24" height =
        ...
        "http://www.w3.org/2000/svg" d = "M10 10l-2 2l2 2" /> < title > { title } < /
        title > < / svg >
    }
}
