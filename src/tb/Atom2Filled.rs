#[cfg(feature = "TbAtom2Filled")]
use leptos::*;
#[cfg(feature = "TbAtom2Filled")]
///This icon requires the feature `TbAtom2Filled` to be enabled.
#[component]
pub fn Atom2Filled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-atom-2-filled" width = "24" height = "24" viewBox =
