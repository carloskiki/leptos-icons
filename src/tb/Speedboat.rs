...
pub fn Speedboat(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-speedboat"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M6 13l1.5 -5" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M6 8h8l2 3" /> < title > { title } < / title >
        < / svg >
    }
}
