#[cfg(feature = "TbSignature")]
use leptos::*;
#[cfg(feature = "TbSignature")]
///This icon requires the feature `TbSignature` to be enabled.
#[component]
pub fn Signature(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-signature"
