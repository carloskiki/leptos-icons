...
pub fn AugmentedReality(
    ...
    view! {
        ...
        "M12 12.5l4 -2.5" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M8 10l4 2.5v4.5l4 -2.5v-4.5l-4 -2.5z" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M8 10v4.5l4 2.5" /> < title > { title } < /
        title > < / svg >
    }
}
