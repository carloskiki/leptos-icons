#[cfg(feature = "TbHandClick")]
use leptos::*;
#[cfg(feature = "TbHandClick")]
///This icon requires the feature `TbHandClick` to be enabled.
#[component]
pub fn HandClick(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hand-click" width = "24" height = "24" viewBox =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M5 3l-1 -1" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M4 7h-1" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M14 3l1 -1" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M15 6h1" /> < title > { title } < / title > < /
        svg >
    }
}
