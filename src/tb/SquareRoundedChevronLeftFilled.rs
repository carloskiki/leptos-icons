#[cfg(feature = "TbSquareRoundedChevronLeftFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedChevronLeftFilled")]
///This icon requires the feature `TbSquareRoundedChevronLeftFilled` to be enabled.
#[component]
pub fn SquareRoundedChevronLeftFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-chevron-left-filled" width = "24"
