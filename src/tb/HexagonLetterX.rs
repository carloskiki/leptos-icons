#[cfg(feature = "TbHexagonLetterX")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterX")]
///This icon requires the feature `TbHexagonLetterX` to be enabled.
#[component]
pub fn HexagonLetterX(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-x" width = "24" height = "24"
