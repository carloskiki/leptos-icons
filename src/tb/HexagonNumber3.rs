#[cfg(feature = "TbHexagonNumber3")]
use leptos::*;
#[cfg(feature = "TbHexagonNumber3")]
///This icon requires the feature `TbHexagonNumber3` to be enabled.
#[component]
pub fn HexagonNumber3(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-number-3" width = "24" height = "24"
