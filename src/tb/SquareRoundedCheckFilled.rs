#[cfg(feature = "TbSquareRoundedCheckFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedCheckFilled")]
///This icon requires the feature `TbSquareRoundedCheckFilled` to be enabled.
#[component]
pub fn SquareRoundedCheckFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-check-filled" width = "24" height =
