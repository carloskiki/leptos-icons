...
pub fn BorderRadius(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-border-radius" width = "24" height = "24" viewBox =
        "0 0 24 24" stroke - width = "2" stroke = "currentColor" fill = "none" stroke -
        linecap = "round" stroke - linejoin = "round" width = { size.clone() } height = {
        size } > < path xmlns = "http://www.w3.org/2000/svg" stroke = "none" d =
        "M0 0h24v24H0z" fill = "none" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M4 12v-4a4 4 0 0 1 4 -4h4" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M16 4l0 .01" />< path xmlns = "http://www.w3.org/2000/svg" d = "M20 4l0 .01" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M20 8l0 .01" />< path xmlns =
