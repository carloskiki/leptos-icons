#[cfg(feature = "TbSquareRoundedChevronRightFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedChevronRightFilled")]
///This icon requires the feature `TbSquareRoundedChevronRightFilled` to be enabled.
#[component]
pub fn SquareRoundedChevronRightFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-chevron-right-filled" width = "24"
