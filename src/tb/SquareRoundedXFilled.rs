#[cfg(feature = "TbSquareRoundedXFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedXFilled")]
///This icon requires the feature `TbSquareRoundedXFilled` to be enabled.
#[component]
pub fn SquareRoundedXFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-x-filled" width = "24" height = "24"
