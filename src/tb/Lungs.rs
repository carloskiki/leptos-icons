...
use leptos::*;
#[cfg(feature = "TbLungs")]
///This icon requires the feature `TbLungs` to be enabled.
#[component]
pub fn Lungs(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-lungs"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M9 12a3 3 0 0 0 3 -3a3 3 0 0 0 3 3" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M12 4v5" /> < title > { title } < / title > < /
        svg >
    }
}
