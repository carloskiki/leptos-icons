#[cfg(feature = "TbHexagonLetterJ")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterJ")]
///This icon requires the feature `TbHexagonLetterJ` to be enabled.
#[component]
pub fn HexagonLetterJ(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-j" width = "24" height = "24"
