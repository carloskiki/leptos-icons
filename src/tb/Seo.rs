...
use leptos::*;
#[cfg(feature = "TbSeo")]
///This icon requires the feature `TbSeo` to be enabled.
#[component]
pub fn Seo(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-seo" width
        ...
        path xmlns = "http://www.w3.org/2000/svg" d = "M14 16h-4v-8h4" />< path xmlns =
