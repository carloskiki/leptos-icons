#[cfg(feature = "TbCircleDashed")]
use leptos::*;
#[cfg(feature = "TbCircleDashed")]
///This icon requires the feature `TbCircleDashed` to be enabled.
#[component]
pub fn CircleDashed(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-circle-dashed" width = "24" height = "24" viewBox =
