...
pub fn InnerShadowBottomLeft(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-inner-shadow-bottom-left" width = "24" height =
        ...
        path xmlns = "http://www.w3.org/2000/svg" d = "M6 12a6 6 0 0 0 6 6" /> < title >
        { title } < / title > < / svg >
    }
}
