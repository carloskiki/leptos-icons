#[cfg(feature = "TbWashTemperature4")]
use leptos::*;
#[cfg(feature = "TbWashTemperature4")]
///This icon requires the feature `TbWashTemperature4` to be enabled.
#[component]
pub fn WashTemperature4(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-wash-temperature-4" width = "24" height = "24"
        ...
        "http://www.w3.org/2000/svg" d = "M14 15h.01" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M14 12h.01" />< path xmlns =
