...
pub fn InnerShadowLeft(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-inner-shadow-left" width = "24" height = "24"
        ...
        = "http://www.w3.org/2000/svg" d = "M7.757 16.243a6 6 0 0 1 0 -8.486" /> < title
        > { title } < / title > < / svg >
    }
}
