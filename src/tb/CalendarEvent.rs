#[cfg(feature = "TbCalendarEvent")]
use leptos::*;
#[cfg(feature = "TbCalendarEvent")]
///This icon requires the feature `TbCalendarEvent` to be enabled.
#[component]
pub fn CalendarEvent(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-calendar-event" width = "24" height = "24" viewBox
        ...
        "http://www.w3.org/2000/svg" d = "M8 15h2v2h-2z" /> < title > { title } < / title
        > < / svg >
    }
}
