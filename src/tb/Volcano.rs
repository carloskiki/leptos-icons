#[cfg(feature = "TbVolcano")]
use leptos::*;
#[cfg(feature = "TbVolcano")]
///This icon requires the feature `TbVolcano` to be enabled.
#[component]
pub fn Volcano(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-volcano"
        width = "24" height = "24" viewBox = "0 0 24 24" stroke - width = "2" stroke =
        "currentColor" fill = "none" stroke - linecap = "round" stroke - linejoin =
        "round" width = { size.clone() } height = { size } > < path xmlns =
        "http://www.w3.org/2000/svg" stroke = "none" d = "M0 0h24v24H0z" fill = "none"
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M9 8v-1a2 2 0 1 0 -4 0" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M15 8v-1a2 2 0 1 1 4 0" />< path
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M12 8v-4" /> < title > { title
        } < / title > < / svg >
    }
}
