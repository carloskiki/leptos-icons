...
pub fn Butterfly(
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-butterfly"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M12 19v-10" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M9 3l3 2l3 -2" /> < title > { title } < / title
        > < / svg >
    }
}
