#[cfg(feature = "TbThumbDownFilled")]
use leptos::*;
#[cfg(feature = "TbThumbDownFilled")]
///This icon requires the feature `TbThumbDownFilled` to be enabled.
#[component]
pub fn ThumbDownFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-thumb-down-filled" width = "24" height = "24"
