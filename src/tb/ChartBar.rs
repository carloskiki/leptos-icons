#[cfg(feature = "TbChartBar")]
use leptos::*;
#[cfg(feature = "TbChartBar")]
///This icon requires the feature `TbChartBar` to be enabled.
#[component]
pub fn ChartBar(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-chart-bar"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M4 20l14 0" /> < title > {
        title } < / title > < / svg >
    }
}
