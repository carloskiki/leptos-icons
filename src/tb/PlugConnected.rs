#[cfg(feature = "TbPlugConnected")]
use leptos::*;
#[cfg(feature = "TbPlugConnected")]
///This icon requires the feature `TbPlugConnected` to be enabled.
#[component]
pub fn PlugConnected(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-plug-connected" width = "24" height = "24" viewBox
        ...
        "http://www.w3.org/2000/svg" d = "M13 14l-2 2" /> < title > { title } < / title >
        < / svg >
    }
}
