...
use leptos::*;
#[cfg(feature = "TbGavel")]
///This icon requires the feature `TbGavel` to be enabled.
#[component]
pub fn Gavel(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-gavel"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M6 9l4 4" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M13 10l-4 -4" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M3 21h7" />< path xmlns =
