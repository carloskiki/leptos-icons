...
#[component]
pub fn KeyframeAlignHorizontal(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-keyframe-align-horizontal" width = "24" height =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M3 12h2" />< path xmlns =
