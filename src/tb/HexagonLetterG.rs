#[cfg(feature = "TbHexagonLetterG")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterG")]
///This icon requires the feature `TbHexagonLetterG` to be enabled.
#[component]
pub fn HexagonLetterG(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-g" width = "24" height = "24"
