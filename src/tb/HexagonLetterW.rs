#[cfg(feature = "TbHexagonLetterW")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterW")]
///This icon requires the feature `TbHexagonLetterW` to be enabled.
#[component]
pub fn HexagonLetterW(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-w" width = "24" height = "24"
