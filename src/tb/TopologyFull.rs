#[cfg(feature = "TbTopologyFull")]
use leptos::*;
#[cfg(feature = "TbTopologyFull")]
///This icon requires the feature `TbTopologyFull` to be enabled.
#[component]
pub fn TopologyFull(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-topology-full" width = "24" height = "24" viewBox =
        ...
        "http://www.w3.org/2000/svg" d = "M7.5 7.5l9 9" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M7.5 16.5l9 -9" /> < title > { title } < /
        title > < / svg >
    }
}
