#[cfg(feature = "TbHexagonLetterM")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterM")]
///This icon requires the feature `TbHexagonLetterM` to be enabled.
#[component]
pub fn HexagonLetterM(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-m" width = "24" height = "24"
