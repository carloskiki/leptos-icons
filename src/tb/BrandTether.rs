...
use leptos::*;
#[cfg(feature = "TbBrandTether")]
///This icon requires the feature `TbBrandTether` to be enabled.
#[component]
pub fn BrandTether(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-brand-tether" width = "24" height = "24" viewBox =
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M12 15v-7" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M8 8h8" /> < title > { title } < / title > < /
        svg >
    }
}
