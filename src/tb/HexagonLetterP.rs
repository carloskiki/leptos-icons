#[cfg(feature = "TbHexagonLetterP")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterP")]
///This icon requires the feature `TbHexagonLetterP` to be enabled.
#[component]
pub fn HexagonLetterP(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-p" width = "24" height = "24"
