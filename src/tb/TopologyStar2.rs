#[cfg(feature = "TbTopologyStar2")]
use leptos::*;
#[cfg(feature = "TbTopologyStar2")]
///This icon requires the feature `TbTopologyStar2` to be enabled.
#[component]
pub fn TopologyStar2(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-topology-star-2" width = "24" height = "24" viewBox
