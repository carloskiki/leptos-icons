#[cfg(feature = "TbSquare1Filled")]
use leptos::*;
#[cfg(feature = "TbSquare1Filled")]
///This icon requires the feature `TbSquare1Filled` to be enabled.
#[component]
pub fn Square1Filled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-1-filled" width = "24" height = "24" viewBox
