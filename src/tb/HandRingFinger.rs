#[cfg(feature = "TbHandRingFinger")]
use leptos::*;
#[cfg(feature = "TbHandRingFinger")]
///This icon requires the feature `TbHandRingFinger` to be enabled.
#[component]
pub fn HandRingFinger(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hand-ring-finger" width = "24" height = "24"
        ...
        "M11 11.5v-2a1.5 1.5 0 1 1 3 0v2.5" />< path xmlns = "http://www.w3.org/2000/svg"
        d = "M14 12v-6.5a1.5 1.5 0 0 1 3 0v6.5" /> < title > { title } < / title > < /
        svg >
    }
}
