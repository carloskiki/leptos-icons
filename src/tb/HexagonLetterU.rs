#[cfg(feature = "TbHexagonLetterU")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterU")]
///This icon requires the feature `TbHexagonLetterU` to be enabled.
#[component]
pub fn HexagonLetterU(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-u" width = "24" height = "24"
