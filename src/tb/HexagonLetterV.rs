#[cfg(feature = "TbHexagonLetterV")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterV")]
///This icon requires the feature `TbHexagonLetterV` to be enabled.
#[component]
pub fn HexagonLetterV(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-v" width = "24" height = "24"
