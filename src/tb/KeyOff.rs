#[cfg(feature = "TbKeyOff")]
use leptos::*;
#[cfg(feature = "TbKeyOff")]
///This icon requires the feature `TbKeyOff` to be enabled.
#[component]
pub fn KeyOff(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-key-off"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M15 9h.01" />< path xmlns =
