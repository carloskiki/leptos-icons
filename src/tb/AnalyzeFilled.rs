...
pub fn AnalyzeFilled(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-analyze-filled" width = "24" height = "24" viewBox
        ...
        "M12 8a4 4 0 1 1 -3.995 4.2l-.005 -.2l.005 -.2a4 4 0 0 1 3.995 -3.8z" stroke -
