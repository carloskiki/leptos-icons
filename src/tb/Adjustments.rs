#[cfg(feature = "TbAdjustments")]
use leptos::*;
#[cfg(feature = "TbAdjustments")]
///This icon requires the feature `TbAdjustments` to be enabled.
#[component]
pub fn Adjustments(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-adjustments" width = "24" height = "24" viewBox =
