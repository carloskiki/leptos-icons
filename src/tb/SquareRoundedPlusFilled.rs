#[cfg(feature = "TbSquareRoundedPlusFilled")]
use leptos::*;
#[cfg(feature = "TbSquareRoundedPlusFilled")]
///This icon requires the feature `TbSquareRoundedPlusFilled` to be enabled.
#[component]
pub fn SquareRoundedPlusFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-square-rounded-plus-filled" width = "24" height =
