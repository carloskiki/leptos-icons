#[cfg(feature = "TbBrandGithub")]
use leptos::*;
#[cfg(feature = "TbBrandGithub")]
///This icon requires the feature `TbBrandGithub` to be enabled.
#[component]
pub fn BrandGithub(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-brand-github" width = "24" height = "24" viewBox =
