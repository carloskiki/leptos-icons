...
pub fn KeyframeAlignVertical(
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-keyframe-align-vertical" width = "24" height = "24"
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d = "M12 20v2" /> < title > { title
        } < / title > < / svg >
    }
}
