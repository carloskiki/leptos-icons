#[cfg(feature = "TbHexagonLetterZ")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterZ")]
///This icon requires the feature `TbHexagonLetterZ` to be enabled.
#[component]
pub fn HexagonLetterZ(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-z" width = "24" height = "24"
