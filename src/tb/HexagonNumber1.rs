#[cfg(feature = "TbHexagonNumber1")]
use leptos::*;
#[cfg(feature = "TbHexagonNumber1")]
///This icon requires the feature `TbHexagonNumber1` to be enabled.
#[component]
pub fn HexagonNumber1(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-number-1" width = "24" height = "24"
