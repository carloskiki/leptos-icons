#[cfg(feature = "TbContainer")]
use leptos::*;
#[cfg(feature = "TbContainer")]
///This icon requires the feature `TbContainer` to be enabled.
#[component]
pub fn Container(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-container"
        width = "24" height = "24" viewBox = "0 0 24 24" stroke - width = "2" stroke =
        "currentColor" fill = "none" stroke - linecap = "round" stroke - linejoin =
        "round" width = size.clone() height = size xmlns = "http://www.w3.org/2000/svg" >
        < path xmlns = "http://www.w3.org/2000/svg" stroke = "none" d = "M0 0h24v24H0z"
        fill = "none" />< path xmlns = "http://www.w3.org/2000/svg" d = "M20 4v.01" /><
        path xmlns = "http://www.w3.org/2000/svg" d = "M20 20v.01" />< path xmlns =
