#[cfg(feature = "TbHexagonLetterD")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterD")]
///This icon requires the feature `TbHexagonLetterD` to be enabled.
#[component]
pub fn HexagonLetterD(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-d" width = "24" height = "24"
