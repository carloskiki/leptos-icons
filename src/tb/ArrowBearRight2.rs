...
pub fn ArrowBearRight2(
    ...
    view! {
        ...
        "M15 3h5v5" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M20 3l-7.536 7.536a5 5 0 0 0 -1.464 3.534v6.93" />< path xmlns =
        "http://www.w3.org/2000/svg" d = "M4 5l4.5 4.5" /> < title > { title } < / title
        > < / svg >
    }
}
