#[cfg(feature = "TbHeartFilled")]
use leptos::*;
#[cfg(feature = "TbHeartFilled")]
///This icon requires the feature `TbHeartFilled` to be enabled.
#[component]
pub fn HeartFilled(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-heart-filled" width = "24" height = "24" viewBox =
