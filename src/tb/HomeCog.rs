#[cfg(feature = "TbHomeCog")]
use leptos::*;
#[cfg(feature = "TbHomeCog")]
///This icon requires the feature `TbHomeCog` to be enabled.
#[component]
pub fn HomeCog(
    cx: Scope,
    ...
    view! {
        ...
        stroke_witdh = "0" style = style class = "icon icon-tabler icon-tabler-home-cog"
        width = "24" height = "24" viewBox = "0 0 24 24" stroke - width = "2" stroke =
        "currentColor" fill = "none" stroke - linecap = "round" stroke - linejoin =
        "round" width = size.clone() height = size xmlns = "http://www.w3.org/2000/svg" >
        < path xmlns = "http://www.w3.org/2000/svg" stroke = "none" d = "M0 0h24v24H0z"
        fill = "none" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M9 21v-6a2 2 0 0 1 2 -2h1.6" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M20 11l-8 -8l-9 9h2v7a2 2 0 0 0 2 2h4.159" />< path xmlns =
        ...
        "http://www.w3.org/2000/svg" d = "M19.733 19l1.3 .75" /> < title > { title } < /
        title > < / svg >
    }
}
