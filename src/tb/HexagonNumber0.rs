#[cfg(feature = "TbHexagonNumber0")]
use leptos::*;
#[cfg(feature = "TbHexagonNumber0")]
///This icon requires the feature `TbHexagonNumber0` to be enabled.
#[component]
pub fn HexagonNumber0(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-number-0" width = "24" height = "24"
