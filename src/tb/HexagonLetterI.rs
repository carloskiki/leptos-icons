#[cfg(feature = "TbHexagonLetterI")]
use leptos::*;
#[cfg(feature = "TbHexagonLetterI")]
///This icon requires the feature `TbHexagonLetterI` to be enabled.
#[component]
pub fn HexagonLetterI(
    cx: Scope,
    ...
    view! {
        ...
        "icon icon-tabler icon-tabler-hexagon-letter-i" width = "24" height = "24"
