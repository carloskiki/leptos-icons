#[cfg(feature = "BiSolidCookie")]
use leptos::*;
#[cfg(feature = "BiSolidCookie")]
///This icon requires the feature `BiSolidCookie` to be enabled.
#[component]
pub fn Cookie(
    cx: Scope,
