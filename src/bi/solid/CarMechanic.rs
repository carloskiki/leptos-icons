#[cfg(feature = "BiSolidCarMechanic")]
use leptos::*;
#[cfg(feature = "BiSolidCarMechanic")]
///This icon requires the feature `BiSolidCarMechanic` to be enabled.
#[component]
pub fn CarMechanic(
    cx: Scope,
