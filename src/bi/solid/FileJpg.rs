#[cfg(feature = "BiSolidFileJpg")]
use leptos::*;
#[cfg(feature = "BiSolidFileJpg")]
///This icon requires the feature `BiSolidFileJpg` to be enabled.
#[component]
pub fn FileJpg(
    cx: Scope,
    ...
    view! {
        ...
        "M11.285 14.552c-.186 0-.312.018-.377.036v1.193c.077.018.174.023.307.023.484 0 .784-.246.784-.659 0-.372-.257-.593-.714-.593z"
