#[cfg(feature = "BiSolidFileJson")]
use leptos::*;
#[cfg(feature = "BiSolidFileJson")]
///This icon requires the feature `BiSolidFileJson` to be enabled.
#[component]
pub fn FileJson(
    cx: Scope,
    ...
    view! {
        ...
        "M12.823 15.122c-.517 0-.816.491-.816 1.146 0 .661.311 1.126.82 1.126.517 0 .812-.49.812-1.146 0-.604-.291-1.126-.816-1.126z"
