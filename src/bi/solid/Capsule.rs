#[cfg(feature = "BiSolidCapsule")]
use leptos::*;
#[cfg(feature = "BiSolidCapsule")]
///This icon requires the feature `BiSolidCapsule` to be enabled.
#[component]
pub fn Capsule(
    cx: Scope,
