#[cfg(feature = "BiSolidColor")]
use leptos::*;
#[cfg(feature = "BiSolidColor")]
///This icon requires the feature `BiSolidColor` to be enabled.
#[component]
pub fn Color(
    cx: Scope,
