#[cfg(feature = "BiSolidFaceMask")]
use leptos::*;
#[cfg(feature = "BiSolidFaceMask")]
///This icon requires the feature `BiSolidFaceMask` to be enabled.
#[component]
pub fn FaceMask(
    cx: Scope,
