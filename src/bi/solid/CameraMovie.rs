#[cfg(feature = "BiSolidCameraMovie")]
use leptos::*;
#[cfg(feature = "BiSolidCameraMovie")]
///This icon requires the feature `BiSolidCameraMovie` to be enabled.
#[component]
pub fn CameraMovie(
    cx: Scope,
