#[cfg(feature = "BiSolidParty")]
use leptos::*;
#[cfg(feature = "BiSolidParty")]
///This icon requires the feature `BiSolidParty` to be enabled.
#[component]
pub fn Party(
    cx: Scope,
