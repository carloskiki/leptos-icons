#[cfg(feature = "BiSolidBaseball")]
use leptos::*;
#[cfg(feature = "BiSolidBaseball")]
///This icon requires the feature `BiSolidBaseball` to be enabled.
#[component]
pub fn Baseball(
    cx: Scope,
