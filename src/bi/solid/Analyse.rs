#[cfg(feature = "BiSolidAnalyse")]
use leptos::*;
#[cfg(feature = "BiSolidAnalyse")]
///This icon requires the feature `BiSolidAnalyse` to be enabled.
#[component]
pub fn Analyse(
    cx: Scope,
