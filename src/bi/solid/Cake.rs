#[cfg(feature = "BiSolidCake")]
use leptos::*;
#[cfg(feature = "BiSolidCake")]
///This icon requires the feature `BiSolidCake` to be enabled.
#[component]
pub fn Cake(
    cx: Scope,
