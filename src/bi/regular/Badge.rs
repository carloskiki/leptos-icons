#[cfg(feature = "BiRegularBadge")]
use leptos::*;
#[cfg(feature = "BiRegularBadge")]
///This icon requires the feature `BiRegularBadge` to be enabled.
#[component]
pub fn Badge(
    cx: Scope,
