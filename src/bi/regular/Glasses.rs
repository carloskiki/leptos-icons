#[cfg(feature = "BiRegularGlasses")]
use leptos::*;
#[cfg(feature = "BiRegularGlasses")]
///This icon requires the feature `BiRegularGlasses` to be enabled.
#[component]
pub fn Glasses(
    cx: Scope,
