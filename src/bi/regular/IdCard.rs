#[cfg(feature = "BiRegularIdCard")]
use leptos::*;
#[cfg(feature = "BiRegularIdCard")]
///This icon requires the feature `BiRegularIdCard` to be enabled.
#[component]
pub fn IdCard(
    cx: Scope,
    ...
    view! {
        ...
        "M9.715 12c1.151 0 2-.849 2-2s-.849-2-2-2-2 .849-2 2 .848 2 2 2z" />< path xmlns
