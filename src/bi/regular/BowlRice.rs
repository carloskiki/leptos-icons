#[cfg(feature = "BiRegularBowlRice")]
use leptos::*;
#[cfg(feature = "BiRegularBowlRice")]
///This icon requires the feature `BiRegularBowlRice` to be enabled.
#[component]
pub fn BowlRice(
    cx: Scope,
