#[cfg(feature = "BiRegularParty")]
use leptos::*;
#[cfg(feature = "BiRegularParty")]
///This icon requires the feature `BiRegularParty` to be enabled.
#[component]
pub fn Party(
    cx: Scope,
