#[cfg(feature = "BiRegularBellPlus")]
use leptos::*;
#[cfg(feature = "BiRegularBellPlus")]
///This icon requires the feature `BiRegularBellPlus` to be enabled.
#[component]
pub fn BellPlus(
    cx: Scope,
    ...
    view! {
        ...
        "M13 7.037h-2V10H8.037v2H11v2.963h2V12h2.963v-2H13z" />< path xmlns =
