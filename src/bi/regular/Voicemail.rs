#[cfg(feature = "BiRegularVoicemail")]
use leptos::*;
#[cfg(feature = "BiRegularVoicemail")]
///This icon requires the feature `BiRegularVoicemail` to be enabled.
#[component]
pub fn Voicemail(
    cx: Scope,
