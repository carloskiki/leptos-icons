#[cfg(feature = "BiRegularCommand")]
use leptos::*;
#[cfg(feature = "BiRegularCommand")]
///This icon requires the feature `BiRegularCommand` to be enabled.
#[component]
pub fn Command(
    cx: Scope,
