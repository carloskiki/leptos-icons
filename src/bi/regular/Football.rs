#[cfg(feature = "BiRegularFootball")]
use leptos::*;
#[cfg(feature = "BiRegularFootball")]
///This icon requires the feature `BiRegularFootball` to be enabled.
#[component]
pub fn Football(
    cx: Scope,
