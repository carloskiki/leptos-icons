#[cfg(feature = "BiRegularRun")]
use leptos::*;
#[cfg(feature = "BiRegularRun")]
///This icon requires the feature `BiRegularRun` to be enabled.
#[component]
pub fn Run(
    cx: Scope,
