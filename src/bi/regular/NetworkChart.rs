#[cfg(feature = "BiRegularNetworkChart")]
use leptos::*;
#[cfg(feature = "BiRegularNetworkChart")]
///This icon requires the feature `BiRegularNetworkChart` to be enabled.
#[component]
pub fn NetworkChart(
    cx: Scope,
