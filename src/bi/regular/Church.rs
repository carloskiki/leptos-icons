#[cfg(feature = "BiRegularChurch")]
use leptos::*;
#[cfg(feature = "BiRegularChurch")]
///This icon requires the feature `BiRegularChurch` to be enabled.
#[component]
pub fn Church(
    cx: Scope,
