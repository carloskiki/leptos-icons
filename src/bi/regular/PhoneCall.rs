#[cfg(feature = "BiRegularPhoneCall")]
use leptos::*;
#[cfg(feature = "BiRegularPhoneCall")]
///This icon requires the feature `BiRegularPhoneCall` to be enabled.
#[component]
pub fn PhoneCall(
    cx: Scope,
    ...
    view! {
        ...
        "M13 8c2.1 0 3 .9 3 3h2c0-3.22-1.78-5-5-5z" /> < title > { title } < / title > <
        / svg >
    }
}
