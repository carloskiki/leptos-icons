#[cfg(feature = "BiRegularConfused")]
use leptos::*;
#[cfg(feature = "BiRegularConfused")]
///This icon requires the feature `BiRegularConfused` to be enabled.
#[component]
pub fn Confused(
    cx: Scope,
    ...
    view! {
        ...
        "1.493" />< path xmlns = "http://www.w3.org/2000/svg" d =
        "m8.124 16.992-.248-1.984 8-1 .248 1.984z" /> < title > { title } < / title > < /
        svg >
    }
}
