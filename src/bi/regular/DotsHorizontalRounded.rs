#[cfg(feature = "BiRegularDotsHorizontalRounded")]
use leptos::{component, Scope, IntoView, view};

#[cfg(feature = "BiRegularDotsHorizontalRounded")]
/// *This icon requires the feature* `BiRegularDotsHorizontalRounded` *to be enabled*.
#[component]
pub fn DotsHorizontalRounded(cx: Scope) -> impl IntoView {
   view! { cx,
