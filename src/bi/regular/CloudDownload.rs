#[cfg(feature = "BiRegularCloudDownload")]
use leptos::*;
#[cfg(feature = "BiRegularCloudDownload")]
///This icon requires the feature `BiRegularCloudDownload` to be enabled.
#[component]
pub fn CloudDownload(
    ...
    view! {
        ...
        "M13.004 14v-4h-2v4h-3l4 5 4-5z" /> < title > { title } < / title > < / svg >
    }
}
