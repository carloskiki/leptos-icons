#[cfg(feature = "BiRegularBugAlt")]
use leptos::*;
#[cfg(feature = "BiRegularBugAlt")]
///This icon requires the feature `BiRegularBugAlt` to be enabled.
#[component]
pub fn BugAlt(
    cx: Scope,
