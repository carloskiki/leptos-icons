#[cfg(feature = "BiRegularRocket")]
use leptos::*;
#[cfg(feature = "BiRegularRocket")]
///This icon requires the feature `BiRegularRocket` to be enabled.
#[component]
pub fn Rocket(
    cx: Scope,
    ...
    view! {
        ...
        />< circle xmlns = "http://www.w3.org/2000/svg" cx = "15.73" cy = "8.3" r = "2"
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M5 16c-2 1-2 5-2 5a7.81 7.81 0 0 0 5-2z" /> < title > { title } < / title > < /
        svg >
    }
}
