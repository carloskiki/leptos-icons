#[cfg(feature = "BiLogosBaidu")]
use leptos::*;
#[cfg(feature = "BiLogosBaidu")]
///This icon requires the feature `BiLogosBaidu` to be enabled.
#[component]
pub fn Baidu(
    cx: Scope,
