#[cfg(feature = "BiLogosAmazon")]
use leptos::*;
#[cfg(feature = "BiLogosAmazon")]
///This icon requires the feature `BiLogosAmazon` to be enabled.
#[component]
pub fn Amazon(
    cx: Scope,
