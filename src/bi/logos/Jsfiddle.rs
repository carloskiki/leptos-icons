#[cfg(feature = "BiLogosJsfiddle")]
use leptos::*;
#[cfg(feature = "BiLogosJsfiddle")]
///This icon requires the feature `BiLogosJsfiddle` to be enabled.
#[component]
pub fn Jsfiddle(
    cx: Scope,
