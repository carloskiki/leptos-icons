#[cfg(feature = "BiLogosImdb")]
use leptos::*;
#[cfg(feature = "BiLogosImdb")]
///This icon requires the feature `BiLogosImdb` to be enabled.
#[component]
pub fn Imdb(
    cx: Scope,
