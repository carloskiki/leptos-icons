#[cfg(feature = "BiLogosGit")]
use leptos::*;
#[cfg(feature = "BiLogosGit")]
///This icon requires the feature `BiLogosGit` to be enabled.
#[component]
pub fn Git(
    cx: Scope,
