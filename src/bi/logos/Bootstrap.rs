#[cfg(feature = "BiLogosBootstrap")]
use leptos::*;
#[cfg(feature = "BiLogosBootstrap")]
///This icon requires the feature `BiLogosBootstrap` to be enabled.
#[component]
pub fn Bootstrap(
    cx: Scope,
