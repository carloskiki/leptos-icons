#[cfg(feature = "BiLogosWhatsappSquare")]
use leptos::*;
#[cfg(feature = "BiLogosWhatsappSquare")]
///This icon requires the feature `BiLogosWhatsappSquare` to be enabled.
#[component]
pub fn WhatsappSquare(
    cx: Scope,
