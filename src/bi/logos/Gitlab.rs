#[cfg(feature = "BiLogosGitlab")]
use leptos::*;
#[cfg(feature = "BiLogosGitlab")]
///This icon requires the feature `BiLogosGitlab` to be enabled.
#[component]
pub fn Gitlab(
    cx: Scope,
