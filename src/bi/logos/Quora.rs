#[cfg(feature = "BiLogosQuora")]
use leptos::*;
#[cfg(feature = "BiLogosQuora")]
///This icon requires the feature `BiLogosQuora` to be enabled.
#[component]
pub fn Quora(
    cx: Scope,
