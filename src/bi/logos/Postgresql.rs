#[cfg(feature = "BiLogosPostgresql")]
use leptos::*;
#[cfg(feature = "BiLogosPostgresql")]
///This icon requires the feature `BiLogosPostgresql` to be enabled.
#[component]
pub fn Postgresql(
    cx: Scope,
