#[cfg(feature = "BiLogosReact")]
use leptos::*;
#[cfg(feature = "BiLogosReact")]
///This icon requires the feature `BiLogosReact` to be enabled.
#[component]
pub fn React(
    cx: Scope,
