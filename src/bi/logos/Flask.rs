#[cfg(feature = "BiLogosFlask")]
use leptos::*;
#[cfg(feature = "BiLogosFlask")]
///This icon requires the feature `BiLogosFlask` to be enabled.
#[component]
pub fn Flask(
    cx: Scope,
    ...
    view! {
        ...
        />< path xmlns = "http://www.w3.org/2000/svg" d =
        "M8.3 10.23c.24.34-.26-.64 0 0zm-.06 1.15c-.13-1-.42.45 0 .69.13.34.25.2.3-.19-.32 0 .08-.62-.3-.5z"
