#[cfg(feature = "BiLogosDiscord")]
use leptos::*;
#[cfg(feature = "BiLogosDiscord")]
///This icon requires the feature `BiLogosDiscord` to be enabled.
#[component]
pub fn Discord(
    cx: Scope,
