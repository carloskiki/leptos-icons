#[cfg(feature = "BiLogosUpwork")]
use leptos::*;
#[cfg(feature = "BiLogosUpwork")]
///This icon requires the feature `BiLogosUpwork` to be enabled.
#[component]
pub fn Upwork(
    cx: Scope,
