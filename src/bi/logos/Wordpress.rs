#[cfg(feature = "BiLogosWordpress")]
use leptos::*;
#[cfg(feature = "BiLogosWordpress")]
///This icon requires the feature `BiLogosWordpress` to be enabled.
#[component]
pub fn Wordpress(
    cx: Scope,
