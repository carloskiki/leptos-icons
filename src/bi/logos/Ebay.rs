#[cfg(feature = "BiLogosEbay")]
use leptos::*;
#[cfg(feature = "BiLogosEbay")]
///This icon requires the feature `BiLogosEbay` to be enabled.
#[component]
pub fn Ebay(
    cx: Scope,
