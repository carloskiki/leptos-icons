#[cfg(feature = "BiLogosSoundcloud")]
use leptos::*;
#[cfg(feature = "BiLogosSoundcloud")]
///This icon requires the feature `BiLogosSoundcloud` to be enabled.
#[component]
pub fn Soundcloud(
    cx: Scope,
