#[cfg(feature = "BiLogosCPlusPlus")]
use leptos::*;
#[cfg(feature = "BiLogosCPlusPlus")]
///This icon requires the feature `BiLogosCPlusPlus` to be enabled.
#[component]
pub fn CPlusPlus(
    cx: Scope,
