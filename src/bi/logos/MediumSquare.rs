#[cfg(feature = "BiLogosMediumSquare")]
use leptos::*;
#[cfg(feature = "BiLogosMediumSquare")]
///This icon requires the feature `BiLogosMediumSquare` to be enabled.
#[component]
pub fn MediumSquare(
    cx: Scope,
