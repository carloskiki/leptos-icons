...
pub fn Trello(
    ...
    view! {
        ...
        "18" rx = "2" ry = "2" />< rect xmlns = "http://www.w3.org/2000/svg" x = "7" y =
        "7" width = "3" height = "9" />< rect xmlns = "http://www.w3.org/2000/svg" x =
        "14" y = "7" width = "3" height = "5" /> < title > { title } < / title > < / svg
        >
    }
}
